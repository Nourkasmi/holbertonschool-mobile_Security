...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM6692trySendImplMj0NB7M = conflatedBufferedChannel.m6692trySendImplMj0NB7M(e, true);
        if (objM6692trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m6678exceptionOrNullimpl(objM6692trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM6692trySendImplMj0NB7M = conflatedBufferedChannel.m6692trySendImplMj0NB7M(e, true);
        if (!(objM6692trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    private final Object m6690trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        ...
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo6664trySendJP2dKIU = super.mo6664trySendJP2dKIU(element);
        if (ChannelResult.m6684isSuccessimpl(objMo6664trySendJP2dKIU) || ChannelResult.m6682isClosedimpl(objMo6664trySendJP2dKIU)) {
            return objMo6664trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo6664trySendJP2dKIU = mo6664trySendJP2dKIU(element);
        if (!(objMo6664trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo6664trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m6678exceptionOrNullimpl(objMo6664trySendJP2dKIU);

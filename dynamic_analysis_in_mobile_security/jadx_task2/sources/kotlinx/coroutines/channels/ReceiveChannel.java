...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo6669tryReceivePtdJZtk = receiveChannel.mo6669tryReceivePtdJZtk();
            if (ChannelResult.m6684isSuccessimpl(objMo6669tryReceivePtdJZtk)) {
                return (E) ChannelResult.m6680getOrThrowimpl(objMo6669tryReceivePtdJZtk);
            }
            Throwable thM6678exceptionOrNullimpl = ChannelResult.m6678exceptionOrNullimpl(objMo6669tryReceivePtdJZtk);
            if (thM6678exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM6678exceptionOrNullimpl);
        }

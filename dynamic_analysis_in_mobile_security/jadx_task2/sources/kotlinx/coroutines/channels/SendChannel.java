...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m6684isSuccessimpl(objMo6664trySendJP2dKIU)) {
                return true;
            }
            Throwable thM6678exceptionOrNullimpl = ChannelResult.m6678exceptionOrNullimpl(objMo6664trySendJP2dKIU);

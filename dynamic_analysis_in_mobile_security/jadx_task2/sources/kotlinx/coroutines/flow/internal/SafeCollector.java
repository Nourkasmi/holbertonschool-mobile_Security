...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM5163exceptionOrNullimpl = Result.m5163exceptionOrNullimpl(result);
        if (thM5163exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM5163exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;

...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM5160constructorimpl = Result.m5160constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5166isFailureimpl(objM5160constructorimpl) ? null : objM5160constructorimpl);
        if (bool != null) {

...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM5160constructorimpl = Result.m5160constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM5160constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM5160constructorimpl = Result.m5160constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m5166isFailureimpl(objM5160constructorimpl) ? null : objM5160constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM5160constructorimpl = Result.m5160constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5166isFailureimpl(objM5160constructorimpl)) {
            objM5160constructorimpl = numValueOf;
        }
        return ((Number) objM5160constructorimpl).intValue();
    }

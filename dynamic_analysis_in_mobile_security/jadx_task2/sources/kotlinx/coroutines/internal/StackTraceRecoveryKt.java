...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM5160constructorimpl2;
        ...
        try {
            ...
            objM5160constructorimpl = Result.m5160constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5163exceptionOrNullimpl(objM5160constructorimpl) == null) {
            obj2 = objM5160constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM5160constructorimpl2 = Result.m5160constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM5160constructorimpl2 = Result.m5160constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5163exceptionOrNullimpl(objM5160constructorimpl2) == null) {
            obj = objM5160constructorimpl2;
        }

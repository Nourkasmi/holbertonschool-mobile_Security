...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iM2636hashCodeimpl = Color.m2636hashCodeimpl(this.color) * 31;
        Brush brush = this.brush;
        return ((((iM2636hashCodeimpl + (brush != null ? brush.hashCode() : 0)) * 31) + Float.hashCode(this.alpha)) * 31) + this.shape.hashCode();
    }

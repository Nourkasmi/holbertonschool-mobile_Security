...
public final class TextLayoutResultProxy {
    ...
    public final boolean m836isPositionOnTextk4lQ0M(long offset) {
        long jM834relativeToInputTextMKHz9U = m834relativeToInputTextMKHz9U(m832coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m2391getYimpl(jM834relativeToInputTextMKHz9U));
        return Offset.m2390getXimpl(jM834relativeToInputTextMKHz9U) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m2390getXimpl(jM834relativeToInputTextMKHz9U) <= this.value.getLineRight(lineForVerticalPosition);
    }
    ...
    private final long m834relativeToInputTextMKHz9U(long j) {
        ...
        if (layoutCoordinates2 != null) {
            offsetM2379boximpl = Offset.m2379boximpl((layoutCoordinates.isAttached() && layoutCoordinates2.isAttached()) ? layoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates2, j) : j);
        } else {
            offsetM2379boximpl = null;
        }
        return offsetM2379boximpl != null ? offsetM2379boximpl.getPackedValue() : j;
    }

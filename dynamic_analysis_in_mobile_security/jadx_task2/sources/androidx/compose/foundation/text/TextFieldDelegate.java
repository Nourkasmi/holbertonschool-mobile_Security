...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public final Triple<Integer, Integer, TextLayoutResult> m808layout_EkL_Y$foundation_release(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            ...
            TextLayoutResult textLayoutResultM798layoutNN6EwU = textDelegate.m798layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf(IntSize.m5033getWidthimpl(textLayoutResultM798layoutNN6EwU.getSize())), Integer.valueOf(IntSize.m5032getHeightimpl(textLayoutResultM798layoutNN6EwU.getSize())), textLayoutResultM798layoutNN6EwU);
        }
        ...
        public final void draw$foundation_release(Canvas canvas, TextFieldValue value, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint selectionPaint) {
            ...
            if (!TextRange.m4398getCollapsedimpl(value.getSelection()) && (iOriginalToTransformed = offsetMapping.originalToTransformed(TextRange.m4402getMinimpl(value.getSelection()))) != (iOriginalToTransformed2 = offsetMapping.originalToTransformed(TextRange.m4401getMaximpl(value.getSelection())))) {
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            ...
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            if (hasFocus) {
                int iOriginalToTransformed = offsetMapping.originalToTransformed(TextRange.m4401getMaximpl(value.getSelection()));
                ...
                long jMo3875localToRootMKHz9U = layoutCoordinates.mo3875localToRootMKHz9U(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                textInputSession.notifyFocusedRect(RectKt.m2430Recttz77jQw(OffsetKt.Offset(Offset.m2390getXimpl(jMo3875localToRootMKHz9U), Offset.m2391getYimpl(jMo3875localToRootMKHz9U)), SizeKt.Size(rect.getWidth(), rect.getHeight())));
            }
        }

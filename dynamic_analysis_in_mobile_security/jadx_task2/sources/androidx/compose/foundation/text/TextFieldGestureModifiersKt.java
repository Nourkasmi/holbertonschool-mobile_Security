...
public final class TextFieldGestureModifiersKt {
    ...
    static final class C02351 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ MouseSelectionObserver $observer;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02351(MouseSelectionObserver mouseSelectionObserver, Continuation<? super C02351> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02351 c02351 = new C02351(this.$observer, continuation);
            c02351.L$0 = obj;
            return c02351;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C02351) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Modifier mouseDragGestureDetector(Modifier modifier, MouseSelectionObserver observer, boolean z) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        Intrinsics.checkNotNullParameter(observer, "observer");
        return z ? SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, observer, new C02351(observer, null)) : modifier;
    }
}

        ...
        return z ? ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                if (state.getHasFocus() && TextRange.m4398getCollapsedimpl(value.getSelection()) && z2) {
                    EffectsKt.LaunchedEffect(value.getAnnotatedString(), TextRange.m4392boximpl(value.getSelection()), new C00271(animatable, null), composer, 512);
                    ...
                    companionDrawWithContent = DrawModifierKt.drawWithContent(composed, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1.2
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            int iOriginalToTransformed = offsetMapping2.originalToTransformed(TextRange.m4404getStartimpl(textFieldValue.getSelection()));
                            ...
                            float f2 = f / 2;
                            float fCoerceAtMost = RangesKt.coerceAtMost(rect.getLeft() + f2, Size.m2459getWidthimpl(drawWithContent.mo3172getSizeNHjbRc()) - f2);
                            DrawScope.m3158drawLine1RTmtNc$default(drawWithContent, brush2, OffsetKt.Offset(fCoerceAtMost, rect.getTop()), OffsetKt.Offset(fCoerceAtMost, rect.getBottom()), f, 0, null, fCoerceIn, null, 0, 432, null);
                        }
                    });
                } else {

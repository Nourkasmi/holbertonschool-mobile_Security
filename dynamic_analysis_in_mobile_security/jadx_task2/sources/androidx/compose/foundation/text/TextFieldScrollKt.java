...
public final class TextFieldScrollKt {
    ...
    public static final Modifier textFieldScroll(Modifier modifier, TextFieldScrollerPosition scrollerPosition, TextFieldValue textFieldValue, VisualTransformation visualTransformation, Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        ...
        int iM821getOffsetToFollow5zctL8 = scrollerPosition.m821getOffsetToFollow5zctL8(textFieldValue.getSelection());
        ...
        if (i == 1) {
            verticalScrollLayoutModifier = new VerticalScrollLayoutModifier(scrollerPosition, iM821getOffsetToFollow5zctL8, transformedTextFilterWithValidation, textLayoutResultProvider);
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            verticalScrollLayoutModifier = new HorizontalScrollLayoutModifier(scrollerPosition, iM821getOffsetToFollow5zctL8, transformedTextFilterWithValidation, textLayoutResultProvider);
        }
    ...
    public static final Rect getCursorRectInScroller(Density density, int i, TransformedText transformedText, TextLayoutResult textLayoutResult, boolean z, int i2) {
        ...
        Rect rect = zero;
        int iMo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (z) {
            left = (i2 - rect.getLeft()) - iMo319roundToPx0680j_4;
        } else {
            left = rect.getLeft();
        }
        float f = left;
        if (z) {
            ...
            left2 = rect.getLeft() + iMo319roundToPx0680j_4;
        }

...
public final class TextDelegate {
    ...
    private final MultiParagraph m796layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        int iM4831getMinWidthimpl = Constraints.m4831getMinWidthimpl(constraints);
        int iM4829getMaxWidthimpl = ((this.softWrap || TextOverflow.m4807equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4815getEllipsisgIe3tQ8())) && Constraints.m4825getHasBoundedWidthimpl(constraints)) ? Constraints.m4829getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        ...
        if (iM4831getMinWidthimpl != iM4829getMaxWidthimpl) {
            iM4829getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM4831getMinWidthimpl, iM4829getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, iM4829getMaxWidthimpl, 0, Constraints.m4828getMaxHeightimpl(constraints), 5, null), i, TextOverflow.m4807equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4815getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m798layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        ...
        MultiParagraph multiParagraphM796layoutTextK40F9xA = m796layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM796layoutTextK40F9xA, ConstraintsKt.m4840constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraphM796layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraphM796layoutTextK40F9xA.getHeight()))), null);
    }

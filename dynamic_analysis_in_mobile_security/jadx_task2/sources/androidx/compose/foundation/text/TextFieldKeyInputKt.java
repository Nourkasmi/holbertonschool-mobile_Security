    ...
    public static final Modifier m815textFieldKeyInput2WJ9YEU(Modifier textFieldKeyInput, final TextFieldState state, final TextFieldSelectionManager manager, final TextFieldValue value, final Function1<? super TextFieldValue, Unit> onValueChange, final boolean z, final boolean z2, final OffsetMapping offsetMapping, final UndoManager undoManager, final int i) {
        ...
        return ComposedModifierKt.composed$default(textFieldKeyInput, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldKeyInputKt$textFieldKeyInput$2
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i2) {
                ...
                composer.endReplaceableGroup();
                Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new AnonymousClass1(new TextFieldKeyInput(state, manager, value, z, z2, textPreparedSelectionState, offsetMapping, undoManager, (DeadKeyCombiner) objRememberedValue2, null, onValueChange, i, 512, null)));
                if (ComposerKt.isTraceInProgress()) {

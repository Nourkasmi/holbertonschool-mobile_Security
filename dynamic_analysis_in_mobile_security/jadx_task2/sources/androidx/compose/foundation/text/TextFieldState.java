...
public final class TextFieldState {
    ...
    public TextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope) {
        ...
        this.minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m4871boximpl(Dp.m4873constructorimpl(0)), null, 2, null);
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.TextFieldState$onImeActionPerformed$1
            ...
            public final void m830invokeKlQnJC8(int i) {
                this.this$0.keyboardActionRunner.m761runActionKlQnJC8(i);
            }
        };
    ...
    public final void m829updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate textDelegateM799updateTextDelegaterm0N8CA = TextDelegateKt.m799updateTextDelegaterm0N8CA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (448 & 32) != 0 ? true : softWrap, (448 & 64) != 0 ? TextOverflow.INSTANCE.m4814getClipgIe3tQ8() : 0, (448 & 128) != 0 ? Integer.MAX_VALUE : 0, (448 & 256) != 0 ? 1 : 0, CollectionsKt.emptyList());
        if (this.textDelegate != textDelegateM799updateTextDelegaterm0N8CA) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM799updateTextDelegaterm0N8CA;
    }

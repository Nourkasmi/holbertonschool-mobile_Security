        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i3) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM4427getFontStyle4Lr2A7w = textStyle3.m4427getFontStyle4Lr2A7w();
                    int iM4503unboximpl = fontStyleM4427getFontStyle4Lr2A7w != null ? fontStyleM4427getFontStyle4Lr2A7w.m4503unboximpl() : FontStyle.INSTANCE.m4505getNormal_LCdwA();
                    FontSynthesis fontSynthesisM4428getFontSynthesisZQGJjVo = textStyle3.m4428getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo4475resolveDPcqOEQ(fontFamily, fontWeight, iM4503unboximpl, fontSynthesisM4428getFontSynthesisZQGJjVo != null ? fontSynthesisM4428getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4515getAllGVVA2EU());
                ...
                if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue3 = Integer.valueOf(IntSize.m5032getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (zChanged4 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = Integer.valueOf(IntSize.m5032getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier modifierM514heightInVpY3zN4 = SizeKt.m514heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo322toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo322toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m4893getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM514heightInVpY3zN4;
            }
        });
    }
}

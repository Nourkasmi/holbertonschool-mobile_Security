...
public final class LayoutUtilsKt {
    ...
    public static final int m841finalMaxWidthtfFHcEY(long j, boolean z, int i, float f) {
        int iM4829getMaxWidthimpl = ((z || TextOverflow.m4807equalsimpl0(i, TextOverflow.INSTANCE.m4815getEllipsisgIe3tQ8())) && Constraints.m4825getHasBoundedWidthimpl(j)) ? Constraints.m4829getMaxWidthimpl(j) : Integer.MAX_VALUE;
        return Constraints.m4831getMinWidthimpl(j) == iM4829getMaxWidthimpl ? iM4829getMaxWidthimpl : RangesKt.coerceIn(TextDelegateKt.ceilToIntPx(f), Constraints.m4831getMinWidthimpl(j), iM4829getMaxWidthimpl);
    }

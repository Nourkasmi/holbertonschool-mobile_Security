...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean zM848layoutWithConstraintsK40F9xA = layoutCache.m848layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (zM848layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(IntSize.m5033getWidthimpl(textLayoutResult.getSize()), IntSize.m5032getHeightimpl(textLayoutResult.getSize())));
        int iM5033getWidthimpl = IntSize.m5033getWidthimpl(textLayoutResult.getSize());
        int iM5032getHeightimpl = IntSize.m5032getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(iM5033getWidthimpl, iM5032getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo3866measureBRTryo0, 0, 0, 0.0f, 4, null);
            }
        });
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (z) {
            Rect rectM2430Recttz77jQw = RectKt.m2430Recttz77jQw(Offset.INSTANCE.m2406getZeroF1C5BW0(), SizeKt.Size(IntSize.m5033getWidthimpl(textLayoutResult.getSize()), IntSize.m5032getHeightimpl(textLayoutResult.getSize())));
            canvas.save();
            Canvas.m2602clipRectmtrdDE$default(canvas, rectM2430Recttz77jQw, 0, 2, null);
        }
        try {
            ...
            if (brush == null) {
                ...
                long jM2706invoke0d7_KjU = colorProducer != null ? colorProducer.m2706invoke0d7_KjU() : Color.INSTANCE.m2665getUnspecified0d7_KjU();
                if (jM2706invoke0d7_KjU == Color.INSTANCE.m2665getUnspecified0d7_KjU()) {
                    if (this.style.m4425getColor0d7_KjU() != Color.INSTANCE.m2665getUnspecified0d7_KjU()) {
                        jM2706invoke0d7_KjU = this.style.m4425getColor0d7_KjU();
                    } else {
                        jM2706invoke0d7_KjU = Color.INSTANCE.m2655getBlack0d7_KjU();
                    }
                }
                multiParagraph.m4294paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m2665getUnspecified0d7_KjU() : jM2706invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m3173getDefaultBlendMode0nO6VwU() : 0);
            } else {
                multiParagraph.m4296painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (64 & 8) != 0 ? null : shadow2, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m3173getDefaultBlendMode0nO6VwU() : 0);
            }

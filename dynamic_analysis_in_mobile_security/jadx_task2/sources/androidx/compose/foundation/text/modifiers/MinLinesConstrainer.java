...
public final class MinLinesConstrainer {
    ...
    public final long m842coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m4302ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? false : false).getHeight();
            height2 = ParagraphKt.m4302ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? false : false).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        if (minLines != 1) {
            iM4830getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(height + (height2 * (minLines - 1))), 0), Constraints.m4828getMaxHeightimpl(inConstraints));
        } else {
            iM4830getMinHeightimpl = Constraints.m4830getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m4831getMinWidthimpl(inConstraints), Constraints.m4829getMaxWidthimpl(inConstraints), iM4830getMinHeightimpl, Constraints.m4828getMaxHeightimpl(inConstraints));
    }
}

...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean zM853layoutWithConstraintsK40F9xA = layoutCache.m853layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (zM853layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(IntSize.m5033getWidthimpl(layoutSize), IntSize.m5032getHeightimpl(layoutSize)));
        int iM5033getWidthimpl = IntSize.m5033getWidthimpl(layoutSize);
        int iM5032getHeightimpl = IntSize.m5032getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(iM5033getWidthimpl, iM5032getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (didOverflow) {
            Rect rectM2430Recttz77jQw = RectKt.m2430Recttz77jQw(Offset.INSTANCE.m2406getZeroF1C5BW0(), SizeKt.Size(IntSize.m5033getWidthimpl(getLayoutCache().getLayoutSize()), IntSize.m5032getHeightimpl(getLayoutCache().getLayoutSize())));
            canvas.save();
        ...
        try {
            ...
            if (brush != null) {
                ...
                Paragraph.m4297paintLG529CI$default(paragraph, canvas, jM2706invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
            }
        } finally {
            if (didOverflow) {
                canvas.restore();

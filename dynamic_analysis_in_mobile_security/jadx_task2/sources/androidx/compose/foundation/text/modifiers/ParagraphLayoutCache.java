...
public final class ParagraphLayoutCache {
    ...
    public final boolean m853layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m842coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        ...
        Paragraph paragraphM850layoutTextK40F9xA = m850layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m4840constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM850layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM850layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m4807equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4816getVisiblegIe3tQ8()) && (IntSize.m5033getWidthimpl(r9) < paragraphM850layoutTextK40F9xA.getWidth() || IntSize.m5032getHeightimpl(r9) < paragraphM850layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = paragraphM850layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int iCeilToIntPx = TextDelegateKt.ceilToIntPx(m850layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long jM4820copyZbe2FdA$default = Constraints.m4820copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, this.style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM4820copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, this.style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM4820copyZbe2FdA$default, this.maxLines, TextOverflow.m4807equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4815getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }

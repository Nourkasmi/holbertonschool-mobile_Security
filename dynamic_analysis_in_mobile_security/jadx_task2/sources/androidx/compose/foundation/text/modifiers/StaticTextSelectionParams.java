...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow textOverflowM4804boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m4804boximpl(layoutInput.getOverflow());
        int iM4816getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m4816getVisiblegIe3tQ8();
        if (textOverflowM4804boximpl == null) {
            return false;
        }
        return TextOverflow.m4807equalsimpl0(textOverflowM4804boximpl.getValue(), iM4816getVisiblegIe3tQ8);
    }

...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m813typedCommandZmokQxo(KeyEvent event) {
        Integer numM757consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m818isTypedEventZmokQxo(event) || (numM757consumeZmokQxo = this.keyCombiner.m757consumeZmokQxo(event)) == null) {
            return null;
        }
        String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), numM757consumeZmokQxo.intValue()).toString();
    ...
    public final boolean m814processZmokQxo(KeyEvent event) {
        final KeyCommand keyCommandMo759mapZmokQxo;
        Intrinsics.checkNotNullParameter(event, "event");
        CommitTextCommand commitTextCommandM813typedCommandZmokQxo = m813typedCommandZmokQxo(event);
        if (commitTextCommandM813typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(commitTextCommandM813typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m3608equalsimpl0(KeyEvent_androidKt.m3616getTypeZmokQxo(event), KeyEventType.INSTANCE.m3612getKeyDownCS__XNY()) || (keyCommandMo759mapZmokQxo = this.keyMapping.mo759mapZmokQxo(event)) == null || (keyCommandMo759mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
        ...
        commandExecutionContext(new Function1<TextFieldPreparedSelection, Unit>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2
            ...
            public final void invoke2(TextFieldPreparedSelection commandExecutionContext) {
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo759mapZmokQxo.ordinal()]) {
                    case 1:
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m4399getEndimpl(deleteIfSelectedOr.getSelection()) - deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m4399getEndimpl(deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr3 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (previousWordOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4399getEndimpl(deleteIfSelectedOr.getSelection()) - previousWordOffset.intValue(), 0);
                                } else {
                    ...
                    case 23:
                        List<EditCommand> listDeleteIfSelectedOr4 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m4399getEndimpl(deleteIfSelectedOr.getSelection())) : null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr5 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (lineStartByOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4399getEndimpl(deleteIfSelectedOr.getSelection()) - lineStartByOffset.intValue(), 0);
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 25:
                        List<EditCommand> listDeleteIfSelectedOr6 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m4399getEndimpl(deleteIfSelectedOr.getSelection())) : null;
                            }
                        });
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            this.getState().getOnImeActionPerformed().invoke(ImeAction.m4548boximpl(this.imeAction));
                        }
                        break;
                    case 27:
                        if (!this.getSingleLine()) {

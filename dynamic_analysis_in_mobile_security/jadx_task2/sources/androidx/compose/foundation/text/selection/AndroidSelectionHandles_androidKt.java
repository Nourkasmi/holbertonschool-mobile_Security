...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m870SelectionHandle8fL75g(final long j, final boolean z, final ResolvedTextDirection direction, final boolean z2, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((374491 & i3) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            m869HandlePopupULxng0E(j, handleReferencePoint, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function2 == null) {
                            ...
                            Offset offsetM2379boximpl = Offset.m2379boximpl(j);
                            final boolean z3 = z;
                            final long j2 = j;
                            composer2.startReplaceableGroup(511388516);
                            ComposerKt.sourceInformation(composer2, "CC(remember)P(1,2):Composables.kt#9igjgp");
                            boolean zChanged = composer2.changed(boolValueOf) | composer2.changed(offsetM2379boximpl);
    ...
    public static final void DefaultSelectionHandle(final Modifier modifier, final boolean z, final ResolvedTextDirection direction, final boolean z2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m529sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), z, direction, z2), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, Size.m2459getWidthimpl(drawWithCache.m2296getSizeNHjbRc()) / 2.0f);
                            final ColorFilter colorFilterM2670tintxETnrds$default = ColorFilter.Companion.m2670tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            final boolean z5 = z3;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    if (AndroidSelectionHandles_androidKt.isLeft(z5, resolvedTextDirection2, z6)) {
                                        ...
                                        ColorFilter colorFilter = colorFilterM2670tintxETnrds$default;
                                        long jMo3171getCenterF1C5BW0 = contentDrawScope.mo3171getCenterF1C5BW0();
                                        DrawContext drawContext = contentDrawScope.getDrawContext();
                                        long jMo3097getSizeNHjbRc = drawContext.mo3097getSizeNHjbRc();
                                        drawContext.getCanvas().save();
                                        drawContext.getTransform().mo3104scale0AR0LA0(-1.0f, 1.0f, jMo3171getCenterF1C5BW0);
                                    ...
                                    DrawScope.m3157drawImagegbVJVH8$default(onDrawWithContent, imageBitmapCreateHandleImage, 0L, 0.0f, null, colorFilterM2670tintxETnrds$default, 0, 46, null);
                                }
                            });
                        }
                    };
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2851ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m2845getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m3096setSizeuvyYCjk(jSize);
        canvas2.save();
    ...
    public static final void m869HandlePopupULxng0E(final long j, final HandleReferencePoint handleReferencePoint, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(HandlePopup)P(2:c#ui.geometry.Offset,1)230@8022L113,234@8141L217:AndroidSelectionHandles.android.kt#eksfi3");
        if ((i & 14) == 0) {
            i2 = (composerStartRestartGroup.changed(j) ? 4 : 2) | i;
        } else {
            i2 = i;
        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            long jIntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2390getXimpl(j)), MathKt.roundToInt(Offset.m2391getYimpl(j)));
            ...
            boolean zChanged = composerStartRestartGroup.changed(intOffsetM4982boximpl) | composerStartRestartGroup.changed(handleReferencePoint);

...
public final class SelectionContainerKt {
    ...
    public static final void SelectionContainer(final Modifier modifier, final Selection selection, final Function1<? super Selection, Unit> onSelectionChange, final Function2<? super Composer, ? super Integer, Unit> children, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(SelectionContainer)P(1,3,2)84@2963L37,85@3019L44,87@3114L7,88@3175L7,89@3226L7,94@3361L1952,137@5319L132:SelectionContainer.kt#eksfi3");
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
        ...
        if ((i3 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1279221159, "C95@3396L1911:SelectionContainer.kt#eksfi3");
                    ...
                    if ((i5 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        SimpleLayoutKt.SimpleLayout(modifierThen, ComposableLambdaKt.composableLambda(composer2, 1375295262, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1.1
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                Offset offsetM918getEndHandlePosition_m7T9E;
                                ...
                                if ((i7 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (TouchMode_androidKt.isInTouchMode() && selectionManager2.getHasFocus() && (selection2 = selectionManager2.getSelection()) != null) {
                                        ...
                                        for (int i8 = 0; i8 < size; i8++) {
                                            ...
                                            if (zBooleanValue) {
                                                offsetM918getEndHandlePosition_m7T9E = selectionManager3.m919getStartHandlePosition_m7T9E();
                                            } else {
                                                offsetM918getEndHandlePosition_m7T9E = selectionManager3.m918getEndHandlePosition_m7T9E();
                                            }
                                            if (zBooleanValue) {
                                            ...
                                            if (offsetM918getEndHandlePosition_m7T9E != null) {
                                                AndroidSelectionHandles_androidKt.m870SelectionHandle8fL75g(offsetM918getEndHandlePosition_m7T9E.getPackedValue(), zBooleanValue, direction, selection2.getHandlesCrossed(), SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, textDragObserver, new SelectionContainerKt$SelectionContainer$3$1$1$1$1$1(textDragObserver, null)), null, composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                                            }
                                        }
                                    }
                                    if (ComposerKt.isTraceInProgress()) {

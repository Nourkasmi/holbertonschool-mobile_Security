...
public final class SelectionManagerKt {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null) {
            ...
            Offset offsetM915getCurrentDragPosition_m7T9E = selectionManager.m915getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(offsetM915getCurrentDragPosition_m7T9E);
            float fM2390getXimpl = Offset.m2390getXimpl(layoutCoordinates.mo3874localPositionOfR5De75A(containerLayoutCoordinates, offsetM915getCurrentDragPosition_m7T9E.getPackedValue()));
            long jMo876getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo876getRangeOfLineContainingjx7JFs(offset);
            Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m4402getMinimpl(jMo876getRangeOfLineContainingjx7JFs));
            Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m4401getMaximpl(jMo876getRangeOfLineContainingjx7JFs) - 1, TextRange.m4402getMinimpl(jMo876getRangeOfLineContainingjx7JFs)));
            float fCoerceIn = RangesKt.coerceIn(fM2390getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
            if (Math.abs(fM2390getXimpl - fCoerceIn) > IntSize.m5033getWidthimpl(j) / 2) {
                return Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(fCoerceIn, Offset.m2391getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m2420getCenterF1C5BW0())));
        }
        return Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
    }
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m2428Rect0a9Yr6o(layoutCoordinates.mo3878windowToLocalMKHz9U(rectBoundsInWindow.m2425getTopLeftF1C5BW0()), layoutCoordinates.mo3878windowToLocalMKHz9U(rectBoundsInWindow.m2419getBottomRightF1C5BW0()));
    }

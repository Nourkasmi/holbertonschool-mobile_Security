...
final class SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$2$emit$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Animatable.animateTo$default(this.$animatable, Offset.m2379boximpl(this.$targetValue), SelectionMagnifierKt.MagnifierSpringSpec, null, null, this, 12, null) == coroutine_suspended) {

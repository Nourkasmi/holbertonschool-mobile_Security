...
public interface SelectionAdjustment {
    ...
    public static final class Companion {
        ...
        private static final SelectionAdjustment Word = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Word$1
            ...
            public long mo885adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                return SelectionAdjustment.Companion.$$INSTANCE.m887adjustByBoundaryDvylE(textLayoutResult, newRawSelectionRange, new SelectionAdjustment$Companion$Word$1$adjust$1(textLayoutResult));
            }
        };
        private static final SelectionAdjustment Paragraph = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$Paragraph$1
            ...
            public long mo885adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
                return SelectionAdjustment.Companion.$$INSTANCE.m887adjustByBoundaryDvylE(textLayoutResult, newRawSelectionRange, new SelectionAdjustment$Companion$Paragraph$1$adjust$boundaryFun$1(textLayoutResult.getLayoutInput().getText()));
            }
        };
        private static final SelectionAdjustment CharacterWithWordAccelerate = new SelectionAdjustment() { // from class: androidx.compose.foundation.text.selection.SelectionAdjustment$Companion$CharacterWithWordAccelerate$1
            ...
            public long mo885adjustZXO7KMw(TextLayoutResult textLayoutResult, long newRawSelectionRange, int previousHandleOffset, boolean isStartHandle, TextRange previousSelectionRange) {
                ...
                if (isStartHandle) {
                    iUpdateSelectionBoundary2 = updateSelectionBoundary(textLayoutResult, TextRange.m4404getStartimpl(newRawSelectionRange), previousHandleOffset, TextRange.m4404getStartimpl(previousSelectionRange.getPackedValue()), TextRange.m4399getEndimpl(newRawSelectionRange), true, TextRange.m4403getReversedimpl(newRawSelectionRange));
                    iUpdateSelectionBoundary = TextRange.m4399getEndimpl(newRawSelectionRange);
                } else {
                    int iM4404getStartimpl = TextRange.m4404getStartimpl(newRawSelectionRange);
                    ...
                    iUpdateSelectionBoundary2 = iM4404getStartimpl;
                }
            ...
            private final int snapToWordBoundary(TextLayoutResult textLayoutResult, int newRawOffset, int currentLine, int otherBoundaryOffset, boolean isStart, boolean isReversed) {
                int lineStart;
                int lineEnd$default;
                long jM4378getWordBoundaryjx7JFs = textLayoutResult.m4378getWordBoundaryjx7JFs(newRawOffset);
                if (textLayoutResult.getLineForOffset(TextRange.m4404getStartimpl(jM4378getWordBoundaryjx7JFs)) == currentLine) {
                    lineStart = TextRange.m4404getStartimpl(jM4378getWordBoundaryjx7JFs);
                } else {
                    lineStart = textLayoutResult.getLineStart(currentLine);
                }
                if (textLayoutResult.getLineForOffset(TextRange.m4399getEndimpl(jM4378getWordBoundaryjx7JFs)) == currentLine) {
                    lineEnd$default = TextRange.m4399getEndimpl(jM4378getWordBoundaryjx7JFs);
                } else {
            ...
            private final boolean isAtWordBoundary(TextLayoutResult textLayoutResult, int i) {
                long jM4378getWordBoundaryjx7JFs = textLayoutResult.m4378getWordBoundaryjx7JFs(i);
                return i == TextRange.m4404getStartimpl(jM4378getWordBoundaryjx7JFs) || i == TextRange.m4399getEndimpl(jM4378getWordBoundaryjx7JFs);
            }
        };

        ...
        if (!this.sorted) {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl.sort.1
                ...
                public final Integer invoke(Selectable a, Selectable b) {
                    long jM2406getZeroF1C5BW0;
                    long jM2406getZeroF1C5BW02;
                    int iCompareValues;
                    ...
                    if (layoutCoordinates != null) {
                        jM2406getZeroF1C5BW0 = containerLayoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m2406getZeroF1C5BW0());
                    } else {
                        jM2406getZeroF1C5BW0 = Offset.INSTANCE.m2406getZeroF1C5BW0();
                    }
                    if (layoutCoordinates2 != null) {
                        jM2406getZeroF1C5BW02 = containerLayoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m2406getZeroF1C5BW0());
                    } else {
                        jM2406getZeroF1C5BW02 = Offset.INSTANCE.m2406getZeroF1C5BW0();
                    }
                    if (Offset.m2391getYimpl(jM2406getZeroF1C5BW0) == Offset.m2391getYimpl(jM2406getZeroF1C5BW02)) {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m2390getXimpl(jM2406getZeroF1C5BW0)), Float.valueOf(Offset.m2390getXimpl(jM2406getZeroF1C5BW02)));
                    } else {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m2391getYimpl(jM2406getZeroF1C5BW0)), Float.valueOf(Offset.m2391getYimpl(jM2406getZeroF1C5BW02)));
                    }

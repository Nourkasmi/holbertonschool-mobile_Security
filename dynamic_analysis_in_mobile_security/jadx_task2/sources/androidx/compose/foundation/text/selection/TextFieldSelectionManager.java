...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo803onStartk4lQ0M(long startPoint) {
                ...
                if ((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m836isPositionOnTextk4lQ0M(startPoint)) && (state = this.this$0.getState()) != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                    int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult, layoutResult.getLineForVerticalPosition(Offset.m2391getYimpl(startPoint)), false, 2, null));
                    ...
                    TextFieldValue textFieldValueM940createTextFieldValueFDrldGo = textFieldSelectionManager.m940createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM940createTextFieldValueFDrldGo);
                    return;
                }
                ...
                if (state3 != null && (layoutResult2 = state3.getLayoutResult()) != null) {
                    ...
                    int iM833getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m833getOffsetForPosition3MmeM6k$default(layoutResult2, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iM833getOffsetForPosition3MmeM6k$default, iM833getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(iM833getOffsetForPosition3MmeM6k$default);
                }
                this.this$0.dragBeginPosition = startPoint;
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                textFieldSelectionManager3.m942setCurrentDragPosition_kEHs6E(Offset.m2379boximpl(textFieldSelectionManager3.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m2406getZeroF1C5BW0();
            }
            ...
            public void mo802onDragk4lQ0M(long delta) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m2395plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                    textFieldSelectionManager2.m942setCurrentDragPosition_kEHs6E(Offset.m2379boximpl(Offset.m2395plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                    Integer num = textFieldSelectionManager2.dragBeginOffsetInText;
                    int iIntValue = num != null ? num.intValue() : layoutResult.m835getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                    Offset offsetM945getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m945getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM945getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iIntValue, layoutResult.m835getOffsetForPosition3MmeM6k(offsetM945getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
            ...
            public void onStop() {
                ...
                this.this$0.m942setCurrentDragPosition_kEHs6E(null);
                TextFieldState state = this.this$0.getState();
                if (state != null) {
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo865onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                int iM833getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m833getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), iM833getOffsetForPosition3MmeM6k$default, iM833getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }
            ...
            public boolean mo862onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                int iM835getOffsetForPosition3MmeM6k = layoutResult.m835getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), iM835getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
        };
    }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo803onStartk4lQ0M(long startPoint) {
                ...
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m942setCurrentDragPosition_kEHs6E(Offset.m2379boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m2406getZeroF1C5BW0();
                this.this$0.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state = this.this$0.getState();
                if (state == null) {
            ...
            public void mo802onDragk4lQ0M(long delta) {
                ...
                int iM4376getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m2395plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset offsetM945getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m945getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM945getCurrentDragPosition_m7T9E);
                        iOriginalToTransformed = value.m4376getOffsetForPositionk4lQ0M(offsetM945getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        iOriginalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4404getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i = iOriginalToTransformed;
                    if (z) {
                        iM4376getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4399getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset offsetM945getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m945getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM945getCurrentDragPosition_m7T9E2);
                        iM4376getOffsetForPositionk4lQ0M = value.m4376getOffsetForPositionk4lQ0M(offsetM945getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, iM4376getOffsetForPositionk4lQ0M, z, SelectionAdjustment.INSTANCE.getCharacter());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo802onDragk4lQ0M(long delta) {
                ...
                Offset offsetM945getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m945getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM945getCurrentDragPosition_m7T9E);
                int iTransformedToOriginal = offsetMapping.transformedToOriginal(value.m4376getOffsetForPositionk4lQ0M(offsetM945getCurrentDragPosition_m7T9E.getPackedValue()));
                long jTextRange = TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal);
                if (TextRange.m4397equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m940createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), jTextRange));
            }
    ...
    public final void m944deselect_kEHs6E$foundation_release(Offset position) {
        ...
        if (!TextRange.m4398getCollapsedimpl(getValue$foundation_release().getSelection())) {
            ...
            if (position != null && layoutResult != null) {
                iM4401getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m833getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null));
            } else {
                iM4401getMaximpl = TextRange.m4401getMaximpl(getValue$foundation_release().getSelection());
            }
            this.onValueChange.invoke(TextFieldValue.m4618copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(iM4401getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int iM4401getMaximpl = TextRange.m4401getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m940createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iM4401getMaximpl, iM4401getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int iM4402getMinimpl = TextRange.m4402getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m940createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM4402getMinimpl, iM4402getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int iM4402getMinimpl = TextRange.m4402getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m940createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM4402getMinimpl, iM4402getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM940createTextFieldValueFDrldGo = m940createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM940createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m4618copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM940createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m947getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        ...
        int iM4404getStartimpl = isStartHandle ? TextRange.m4404getStartimpl(selection) : TextRange.m4399getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(iM4404getStartimpl), isStartHandle, TextRange.m4403getReversedimpl(getValue$foundation_release().getSelection()));
    }
    ...
    public final long m946getCursorPositiontuRUvjQ$foundation_release(Density density) {
        ...
        int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4404getStartimpl(getValue$foundation_release().getSelection()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
    ...
    public final void m943contextMenuOpenAdjustmentk4lQ0M(long position) {
        ...
        int iM833getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m833getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m4395containsimpl(getValue$foundation_release().getSelection(), iM833getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), iM833getOffsetForPosition3MmeM6k$default, iM833getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4404getStartimpl(getValue$foundation_release().getSelection()));
                int iOriginalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m4399getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState2 = this.state;
                long jM2406getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2406getZeroF1C5BW0() : layoutCoordinates4.mo3875localToRootMKHz9U(m947getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long jM2406getZeroF1C5BW02 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2406getZeroF1C5BW0() : layoutCoordinates3.mo3875localToRootMKHz9U(m947getHandlePositiontuRUvjQ$foundation_release(false));
                TextFieldState textFieldState4 = this.state;
                float fM2391getYimpl2 = 0.0f;
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    fM2391getYimpl = 0.0f;
                } else {
                    TextLayoutResultProxy layoutResult = textFieldState.getLayoutResult();
                    fM2391getYimpl = Offset.m2391getYimpl(layoutCoordinates2.mo3875localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(iOriginalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    fM2391getYimpl2 = Offset.m2391getYimpl(layoutCoordinates.mo3875localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(iOriginalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m2390getXimpl(jM2406getZeroF1C5BW0), Offset.m2390getXimpl(jM2406getZeroF1C5BW02)), Math.min(fM2391getYimpl, fM2391getYimpl2), Math.max(Offset.m2390getXimpl(jM2406getZeroF1C5BW0), Offset.m2390getXimpl(jM2406getZeroF1C5BW02)), Math.max(Offset.m2391getYimpl(jM2406getZeroF1C5BW0), Offset.m2391getYimpl(jM2406getZeroF1C5BW02)) + (Dp.m4873constructorimpl(25) * textFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m4404getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m4399getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long jM937getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m937getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m4398getCollapsedimpl(jTextRange) ? null : TextRange.m4392boximpl(jTextRange), isStartHandle, adjustment);
        long jTextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m4404getStartimpl(jM937getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m4399getEndimpl(jM937getTextFieldSelectionbb3KNj8)));
        if (TextRange.m4397equalsimpl0(jTextRange2, value.getSelection())) {
            return;
        }
        ...
        this.onValueChange.invoke(m940createTextFieldValueFDrldGo(value.getAnnotatedString(), jTextRange2));
        TextFieldState textFieldState2 = this.state;
        if (textFieldState2 != null) {

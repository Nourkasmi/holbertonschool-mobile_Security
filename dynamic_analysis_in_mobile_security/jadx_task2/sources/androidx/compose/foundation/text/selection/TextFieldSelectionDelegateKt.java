...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m937getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int i, int i2, TextRange textRange, boolean z, SelectionAdjustment adjustment) {
        ...
        if (textLayoutResult != null) {
            ...
            return (textRange == null && Intrinsics.areEqual(adjustment, SelectionAdjustment.INSTANCE.getCharacter())) ? jTextRange : adjustment.mo885adjustZXO7KMw(textLayoutResult, jTextRange, -1, z, textRange);
        }

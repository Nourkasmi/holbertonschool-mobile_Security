...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    public Pair<Selection, Boolean> mo877updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection) {
        ...
        if (layoutCoordinates != null && (textLayoutResultInvoke = this.layoutResultCallback.invoke()) != null) {
            long jMo3874localPositionOfR5De75A = containerLayoutCoordinates.mo3874localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m2406getZeroF1C5BW0());
            return MultiWidgetSelectionDelegateKt.m881getTextSelectionInfoyM0VcXU(textLayoutResultInvoke, Offset.m2394minusMKHz9U(startHandlePosition, jMo3874localPositionOfR5De75A), Offset.m2394minusMKHz9U(endHandlePosition, jMo3874localPositionOfR5De75A), previousHandlePosition != null ? Offset.m2379boximpl(Offset.m2394minusMKHz9U(previousHandlePosition.getPackedValue(), jMo3874localPositionOfR5De75A)) : null, getSelectableId(), adjustment, previousSelection, isStartHandle);
        }
    ...
    public Selection getSelectAllSelection() {
        ...
        return MultiWidgetSelectionDelegateKt.m879getAssembledSelectionInfovJH6DeI(TextRangeKt.TextRange(0, textLayoutResultInvoke.getLayoutInput().getText().length()), false, getSelectableId(), textLayoutResultInvoke);
    }

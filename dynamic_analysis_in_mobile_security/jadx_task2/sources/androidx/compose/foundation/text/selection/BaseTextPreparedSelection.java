...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            long jM4378getWordBoundaryjx7JFs = textLayoutResult.m4378getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4399getEndimpl(jM4378getWordBoundaryjx7JFs) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m4399getEndimpl(jM4378getWordBoundaryjx7JFs));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long jM4378getWordBoundaryjx7JFs = textLayoutResult.m4378getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4404getStartimpl(jM4378getWordBoundaryjx7JFs) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m4404getStartimpl(jM4378getWordBoundaryjx7JFs));
            }
            i--;
        }
        return 0;

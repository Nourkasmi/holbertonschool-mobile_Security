...
public final class SelectionMagnifierKt {
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m2379boximpl(jOffset), 3, null);
    }
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue2 = new Animatable(Offset.m2379boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m2379boximpl(OffsetDisplacementThreshold), null, 8, null);
            composer.updateRememberedValue(objRememberedValue2);
        }
        composer.endReplaceableGroup();
        Animatable animatable = (Animatable) objRememberedValue2;
        EffectsKt.LaunchedEffect(Unit.INSTANCE, new C02371(state, animatable, null), composer, 70);
    ...
    static final class C02371 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02371(State<Offset> state, Animatable<Offset, AnimationVector2D> animatable, Continuation<? super C02371> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02371 c02371 = new C02371(this.$targetValue$delegate, this.$animatable, continuation);
            c02371.L$0 = obj;
            return c02371;
        }
            ...
            if (i == 0) {
                ...
                if (flowSnapshotFlow.collect(new FlowCollector<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt.rememberAnimatedMagnifierPosition.1.2
                    ...
                    public final Object m899emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        ...
                        Object objSnapTo = animatable.snapTo(Offset.m2379boximpl(j), continuation);

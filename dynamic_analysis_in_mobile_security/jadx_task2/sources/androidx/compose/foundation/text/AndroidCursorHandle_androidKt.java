...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m736CursorHandleULxng0E(final long j, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m869HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m529sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawCursorHandle(Modifier modifier) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Color colorM2619boximpl = Color.m2619boximpl(handleColor);
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final float fM2459getWidthimpl = Size.m2459getWidthimpl(drawWithCache.m2296getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, fM2459getWidthimpl);
    ...
    static {
        float fM4873constructorimpl = Dp.m4873constructorimpl(25);
        CursorHandleHeight = fM4873constructorimpl;
        CursorHandleWidth = Dp.m4873constructorimpl(Dp.m4873constructorimpl(fM4873constructorimpl * 2.0f) / 2.4142137f);
    }
}

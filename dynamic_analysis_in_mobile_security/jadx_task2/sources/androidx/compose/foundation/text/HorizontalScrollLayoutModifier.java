...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m4828getMaxHeightimpl(j)) < Constraints.m4829getMaxWidthimpl(j) ? j : Constraints.m4820copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(placeableMo3866measureBRTryo0.getWidth(), Constraints.m4829getMaxWidthimpl(j));
        return MeasureScope.layout$default(measure, iMin, placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measure.getLayoutDirection() == LayoutDirection.Rtl, placeableMo3866measureBRTryo0.getWidth()), iMin, placeableMo3866measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, placeableMo3866measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}

...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(ConstraintsKt.m4845offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measure, ConstraintsKt.m4843constrainWidthK40F9xA(j, placeableMo3866measureBRTryo0.getWidth() + right), ConstraintsKt.m4842constrainHeightK40F9xA(j, placeableMo3866measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo3866measureBRTryo0, left, top, 0.0f, 4, null);
            }
        }, 4, null);
    }

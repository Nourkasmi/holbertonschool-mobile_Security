...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeableMo3866measureBRTryo0, IntOffset.m4991getXimpl(packedValue), IntOffset.m4992getYimpl(packedValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, placeableMo3866measureBRTryo0, IntOffset.m4991getXimpl(packedValue), IntOffset.m4992getYimpl(packedValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }

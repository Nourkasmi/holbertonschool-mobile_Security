...
public final class BoxKt {
    ...
    public static final void Box(Modifier modifier, Alignment alignment, boolean z, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i, int i2) {
        ...
        function3ModifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer)), composer, Integer.valueOf((i4 >> 3) & 112));
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt.boxMeasurePolicy.1
            ...
            public final MeasureResult mo11measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j) {
                ...
                long jM4820copyZbe2FdA$default = z ? j : Constraints.m4820copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    if (!BoxKt.getMatchesParentSize(measurable)) {
                        Placeable placeableMo3866measureBRTryo02 = measurable.mo3866measureBRTryo0(jM4820copyZbe2FdA$default);
                        int iMax2 = Math.max(Constraints.m4831getMinWidthimpl(j), placeableMo3866measureBRTryo02.getWidth());
                        iMax = Math.max(Constraints.m4830getMinHeightimpl(j), placeableMo3866measureBRTryo02.getHeight());
                        placeableMo3866measureBRTryo0 = placeableMo3866measureBRTryo02;
                        iM4831getMinWidthimpl = iMax2;
                    } else {
                        iM4831getMinWidthimpl = Constraints.m4831getMinWidthimpl(j);
                        int iM4830getMinHeightimpl = Constraints.m4830getMinHeightimpl(j);
                        placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.INSTANCE.m4837fixedJhjzzOo(Constraints.m4831getMinWidthimpl(j), Constraints.m4830getMinHeightimpl(j)));
                        iMax = iM4830getMinHeightimpl;
                    }
                    final Alignment alignment2 = alignment;
                    final int i = iM4831getMinWidthimpl;
                    final int i2 = iMax;
                    return MeasureScope.layout$default(MeasurePolicy, iM4831getMinWidthimpl, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            BoxKt.placeInBox(layout, placeableMo3866measureBRTryo0, measurable, MeasurePolicy.getLayoutDirection(), i, i2, alignment2);
                        }
                    }, 4, null);
                }
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (BoxKt.getMatchesParentSize(measurable2)) {
                        ...
                        Placeable placeableMo3866measureBRTryo03 = measurable2.mo3866measureBRTryo0(jM4820copyZbe2FdA$default);
                        placeableArr[i3] = placeableMo3866measureBRTryo03;
                        intRef.element = Math.max(intRef.element, placeableMo3866measureBRTryo03.getWidth());
                        intRef2.element = Math.max(intRef2.element, placeableMo3866measureBRTryo03.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        if (BoxKt.getMatchesParentSize(measurable3)) {
                            placeableArr[i4] = measurable3.mo3866measureBRTryo0(jConstraints);
                        }
                    }
                }
    ...
    public static final void Box(final Modifier modifier, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Box)199@7940L70:Box.kt#2w3rfo");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            function3ModifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composerStartRestartGroup)), composerStartRestartGroup, Integer.valueOf((i3 >> 3) & 112));
            composerStartRestartGroup.startReplaceableGroup(2058660585);
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1253624724, "C:Box.kt#2w3rfo");

...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(ConstraintsKt.m4845offsetNN6EwU(j, -i, -i2));
        return MeasureScope.layout$default(measure, ConstraintsKt.m4843constrainWidthK40F9xA(j, placeableMo3866measureBRTryo0.getWidth() + i), ConstraintsKt.m4842constrainHeightK40F9xA(j, placeableMo3866measureBRTryo0.getHeight() + i2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeableMo3866measureBRTryo0, measure.mo319roundToPx0680j_4(this.this$0.getStart()), measure.mo319roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeableMo3866measureBRTryo0, measure.mo319roundToPx0680j_4(this.this$0.getStart()), measure.mo319roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }

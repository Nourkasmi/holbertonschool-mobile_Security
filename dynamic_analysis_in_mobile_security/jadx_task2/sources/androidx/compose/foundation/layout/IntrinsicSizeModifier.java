...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    default MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long jMo434calculateContentConstraintsl58MMJ0 = mo434calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            jMo434calculateContentConstraintsl58MMJ0 = ConstraintsKt.m4841constrainN9IONVI(j, jMo434calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(jMo434calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3924placeRelative70tqf50$default(layout, placeableMo3866measureBRTryo0, IntOffset.INSTANCE.m5001getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }

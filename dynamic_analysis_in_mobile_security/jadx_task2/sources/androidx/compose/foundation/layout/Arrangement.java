...
public final class Arrangement {
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public int hashCode() {
            int iM4879hashCodeimpl = Dp.m4879hashCodeimpl(this.space) * 31;
            boolean z = this.rtlMirror;
            ?? r1 = z;
            if (z) {
                r1 = 1;
            }
            int i = (iM4879hashCodeimpl + r1) * 31;
        ...
        public void arrange(Density density, int i, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int iMo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(this.space);
            ...
            if (!z) {
                ...
                while (i3 < length) {
                    ...
                    int iMin3 = Math.min(iMo319roundToPx0680j_4, (i - iMin2) - i5);
                ...
                for (int length2 = sizes.length - 1; -1 < length2; length2--) {
                    ...
                    iMin = Math.min(iMo319roundToPx0680j_4, (i - iMin4) - i7);

...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m4831getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m4829getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m4830getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m4828getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo3866measureBRTryo0.getWidth(), Constraints.m4831getMinWidthimpl(j), Constraints.m4829getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo3866measureBRTryo0.getHeight(), Constraints.m4830getMinHeightimpl(j), Constraints.m4828getMaxHeightimpl(j));
        return MeasureScope.layout$default(measure, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3923place70tqf50$default(layout, placeableMo3866measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m5025boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo3866measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo3866measureBRTryo0.getHeight())), measure.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}

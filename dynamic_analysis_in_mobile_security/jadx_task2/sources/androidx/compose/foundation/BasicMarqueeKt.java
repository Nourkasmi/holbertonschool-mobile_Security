...
public final class BasicMarqueeKt {
    ...
    public static final AnimationSpec<Float> m166createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> tweenSpecVelocityBasedTween = velocityBasedTween(Math.abs(density.mo325toPx0680j_4(f2)), f, i3);
        long jM111constructorimpl$default = StartOffset.m111constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, jM111constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m93repeatable91I0pcU$default(i, tweenSpecVelocityBasedTween, null, jM111constructorimpl$default, 4, null);
    }

    ...
    static final class AnonymousClass4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public final Modifier invoke(Modifier composed, Composer composer, int i) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2379boximpl(Offset.INSTANCE.m2405getUnspecifiedF1C5BW0()), null, 2, null);
            ...
            if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$sourceCenterInRoot$2$1
                    ...
                    public final long m217invokeF1C5BW0() {
                        ...
                        if (OffsetKt.m2409isSpecifiedk4lQ0M(MagnifierKt.AnonymousClass4.invoke$lambda$1(mutableState)) && OffsetKt.m2409isSpecifiedk4lQ0M(packedValue)) {
                            return Offset.m2395plusMKHz9U(MagnifierKt.AnonymousClass4.invoke$lambda$1(mutableState), packedValue);
                        }
                        return Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
                    }
                });
            ...
            if (objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue3 = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$isMagnifierShown$2$1
                    ...
                    public final Boolean invoke() {
                        return Boolean.valueOf(OffsetKt.m2409isSpecifiedk4lQ0M(MagnifierKt.AnonymousClass4.invoke$lambda$8(state)));
                    }
                });
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                long jMo241getSizeYbymL2g = platformMagnifierCreate.mo241getSizeYbymL2g();
                ...
                if (function1Invoke$lambda$6 != null) {
                    function1Invoke$lambda$6.invoke(DpSize.m4959boximpl(density.mo323toDpSizekrfVVM(IntSizeKt.m5043toSizeozmzZPI(jMo241getSizeYbymL2g))));
                }
                longRef.element = jMo241getSizeYbymL2g;
                FlowKt.launchIn(FlowKt.onEach(this.$onNeedsUpdate, new C00021(platformMagnifierCreate, null)), coroutineScope);
                try {
                    ...
                    if (FlowKt.collect(SnapshotStateKt.snapshotFlow(new Function0<Unit>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.4.1.2
                        ...
                        public final void invoke2() {
                            long jM2405getUnspecifiedF1C5BW0;
                            if (AnonymousClass4.invoke$lambda$10(state)) {
                                ...
                                if (OffsetKt.m2409isSpecifiedk4lQ0M(packedValue)) {
                                    jM2405getUnspecifiedF1C5BW0 = Offset.m2395plusMKHz9U(AnonymousClass4.invoke$lambda$1(mutableState2), packedValue);
                                } else {
                                    jM2405getUnspecifiedF1C5BW0 = Offset.INSTANCE.m2405getUnspecifiedF1C5BW0();
                                }
                                platformMagnifier2.mo242updateWko1d7g(jInvoke$lambda$8, jM2405getUnspecifiedF1C5BW0, AnonymousClass4.invoke$lambda$5(state4));
                                long jMo241getSizeYbymL2g2 = platformMagnifierCreate.mo241getSizeYbymL2g();
                                Ref.LongRef longRef2 = longRef;
                                Density density3 = density2;
                                State<Function1<DpSize, Unit>> state6 = state5;
                                if (IntSize.m5031equalsimpl0(jMo241getSizeYbymL2g2, longRef2.element)) {
                                    return;
                                }
                                longRef2.element = jMo241getSizeYbymL2g2;
                                Function1 function1Invoke$lambda$62 = AnonymousClass4.invoke$lambda$6(state6);
                                if (function1Invoke$lambda$62 != null) {
                                    function1Invoke$lambda$62.invoke(DpSize.m4959boximpl(density3.mo323toDpSizekrfVVM(IntSizeKt.m5043toSizeozmzZPI(jMo241getSizeYbymL2g2))));
                                    return;
                                }
                                return;
                            }

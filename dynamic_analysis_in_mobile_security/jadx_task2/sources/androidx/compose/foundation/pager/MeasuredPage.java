...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long jM687getOffsetBjo55l4 = m687getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    iM4991getXimpl = (this.mainAxisLayoutSize - IntOffset.m4991getXimpl(jM687getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM4991getXimpl = IntOffset.m4991getXimpl(jM687getOffsetBjo55l4);
                }
                if (this.isVertical) {
                    iM4992getYimpl = (this.mainAxisLayoutSize - IntOffset.m4992getYimpl(jM687getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM4992getYimpl = IntOffset.m4992getYimpl(jM687getOffsetBjo55l4);
                }
                jM687getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM4991getXimpl, iM4992getYimpl);
            }
            long j = this.visualOffset;
            long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jM687getOffsetBjo55l4) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(jM687getOffsetBjo55l4) + IntOffset.m4992getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3926placeWithLayeraW9wM$default(scope, placeable, jIntOffset, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3925placeRelativeWithLayeraW9wM$default(scope, placeable, jIntOffset, 0.0f, null, 6, null);
            }
        }
    }

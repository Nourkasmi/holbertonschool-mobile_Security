...
public final class PagerStateKt {
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> pageCount, Composer composer, int i2, int i3) {
        ...
        PagerStateImpl pagerStateImpl = (PagerStateImpl) RememberSaveableKt.m2276rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, Composer composer, int i2, int i3) {
        ...
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function0) new Function0<PagerStateImpl>() { // from class: androidx.compose.foundation.pager.PagerStateKt$rememberPagerState$3$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }

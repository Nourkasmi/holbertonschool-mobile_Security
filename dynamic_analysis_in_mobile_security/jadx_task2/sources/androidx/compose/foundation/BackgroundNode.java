...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline outlineMo208createOutlinePq9zytI;
        if (Size.m2454equalsimpl(contentDrawScope.mo3172getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outlineMo208createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(outlineMo208createOutlinePq9zytI);
        } else {
            outlineMo208createOutlinePq9zytI = this.shape.mo208createOutlinePq9zytI(contentDrawScope.mo3172getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m2630equalsimpl0(this.color, Color.INSTANCE.m2665getUnspecified0d7_KjU())) {
            OutlineKt.m2881drawOutlinewDX37Ww(contentDrawScope, outlineMo208createOutlinePq9zytI, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m3173getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m2880drawOutlinehn5TExg$default(contentDrawScope, outlineMo208createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = outlineMo208createOutlinePq9zytI;

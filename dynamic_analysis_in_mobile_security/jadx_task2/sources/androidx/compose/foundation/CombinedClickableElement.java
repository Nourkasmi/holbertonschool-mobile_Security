...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int iM4243hashCodeimpl = (((iHashCode2 + (role != null ? Role.m4243hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int iHashCode3 = (iM4243hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;

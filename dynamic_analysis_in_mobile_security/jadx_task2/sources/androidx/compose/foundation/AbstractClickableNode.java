...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    protected final void m144updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public boolean mo141onKeyEventZmokQxo(KeyEvent event) {
        ...
        if (this.enabled && Clickable_androidKt.m207isPressZmokQxo(event)) {
            ...
            PressInteraction.Press pressRemove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3304boximpl(KeyEvent_androidKt.m3615getKeyZmokQxo(event)));
            if (pressRemove != null) {

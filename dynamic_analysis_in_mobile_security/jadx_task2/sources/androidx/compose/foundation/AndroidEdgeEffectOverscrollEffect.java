...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfig) {
        ...
        for (int i = 0; i < size; i++) {
            listListOf.get(i).setColor(ColorKt.m2683toArgb8_81llA(this.overscrollConfig.getGlowColor()));
        }
        ...
        Function1<IntSize, Unit> function1 = new Function1<IntSize, Unit>() { // from class: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect$onNewSize$1
            ...
            public final void m155invokeozmzZPI(long j) {
                boolean z = !Size.m2455equalsimpl0(IntSizeKt.m5043toSizeozmzZPI(j), this.this$0.containerSize);
                this.this$0.containerSize = IntSizeKt.m5043toSizeozmzZPI(j);
                if (z) {
                    this.this$0.topEffect.setSize(IntSize.m5033getWidthimpl(j), IntSize.m5032getHeightimpl(j));
                    this.this$0.bottomEffect.setSize(IntSize.m5033getWidthimpl(j), IntSize.m5032getHeightimpl(j));
                    this.this$0.leftEffect.setSize(IntSize.m5032getHeightimpl(j), IntSize.m5033getWidthimpl(j));
                    this.this$0.rightEffect.setSize(IntSize.m5032getHeightimpl(j), IntSize.m5033getWidthimpl(j));
                    this.this$0.topEffectNegation.setSize(IntSize.m5033getWidthimpl(j), IntSize.m5032getHeightimpl(j));
                    this.this$0.bottomEffectNegation.setSize(IntSize.m5033getWidthimpl(j), IntSize.m5032getHeightimpl(j));
                    this.this$0.leftEffectNegation.setSize(IntSize.m5032getHeightimpl(j), IntSize.m5033getWidthimpl(j));
                    this.this$0.rightEffectNegation.setSize(IntSize.m5032getHeightimpl(j), IntSize.m5033getWidthimpl(j));
                }
                if (z) {
    ...
    */
    ...
    private final boolean stopOverscrollAnimation() {
        boolean z;
        long jM2469getCenteruvyYCjk = SizeKt.m2469getCenteruvyYCjk(this.containerSize);
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f) {
            z = false;
        } else {
            m149pullLeft0a9Yr6o(Offset.INSTANCE.m2406getZeroF1C5BW0(), jM2469getCenteruvyYCjk);
            z = true;
        }
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) != 0.0f) {
            m150pullRight0a9Yr6o(Offset.INSTANCE.m2406getZeroF1C5BW0(), jM2469getCenteruvyYCjk);
            z = true;
        }
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) != 0.0f) {
            m151pullTop0a9Yr6o(Offset.INSTANCE.m2406getZeroF1C5BW0(), jM2469getCenteruvyYCjk);
            z = true;
        }
        if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f) {
            return z;
        }
        m148pullBottom0a9Yr6o(Offset.INSTANCE.m2406getZeroF1C5BW0(), jM2469getCenteruvyYCjk);
        return true;
    }
    ...
    private final boolean drawRight(DrawScope drawScope, EdgeEffect edgeEffect, android.graphics.Canvas canvas) {
        int iSave = canvas.save();
        int iRoundToInt = MathKt.roundToInt(Size.m2459getWidthimpl(this.containerSize));
        float fMo432calculateRightPaddingu2uoSUM = this.overscrollConfig.getDrawPadding().mo432calculateRightPaddingu2uoSUM(drawScope.getLayoutDirection());
        canvas.rotate(90.0f);
        canvas.translate(0.0f, (-iRoundToInt) + drawScope.mo325toPx0680j_4(fMo432calculateRightPaddingu2uoSUM));
        boolean zDraw = edgeEffect.draw(canvas);
        canvas.restoreToCount(iSave);
        return zDraw;
    }

    ...
    public static final Modifier m710toggleableXHw0xAI(Modifier toggleable, final boolean z, final boolean z2, final Role role, final Function1<? super Boolean, Unit> onValueChange) {
        ...
        return ComposedModifierKt.composed(toggleable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Modifier modifierM708toggleableO2vRcR0 = ToggleableKt.m708toggleableO2vRcR0(companion, z3, mutableInteractionSource, (Indication) objConsume, z2, role, onValueChange);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM708toggleableO2vRcR0;
            }
        });
    }
    ...
    public static final Modifier m714triStateToggleableXHw0xAI(Modifier triStateToggleable, final ToggleableState state, final boolean z, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(triStateToggleable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$triStateToggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Object objConsume = composer.consume(localIndication);
                ComposerKt.sourceInformationMarkerEnd(composer);
                Modifier modifierM712triStateToggleableO2vRcR0 = ToggleableKt.m712triStateToggleableO2vRcR0(companion, toggleableState, mutableInteractionSource, (Indication) objConsume, z, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM712triStateToggleableO2vRcR0;
            }
        });
    }

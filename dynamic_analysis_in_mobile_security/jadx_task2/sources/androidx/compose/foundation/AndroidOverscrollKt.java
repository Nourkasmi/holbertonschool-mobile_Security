        ...
        if (Build.VERSION.SDK_INT >= 31) {
            companionLayout = LayoutModifierKt.layout(LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1
                ...
                public final MeasureResult m156invoke3p2s80s(MeasureScope layout, Measurable measurable, long j) {
                    ...
                    return MeasureScope.layout$default(layout, placeableMo3866measureBRTryo0.getMeasuredWidth() - i, placeableMo3866measureBRTryo0.getMeasuredHeight() - i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1.1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout2) {
                            ...
                            Placeable.PlacementScope.placeWithLayer$default(layout2, placeable, ((-i) / 2) - ((placeable.getWidth() - placeableMo3866measureBRTryo0.getMeasuredWidth()) / 2), ((-i) / 2) - ((placeableMo3866measureBRTryo0.getHeight() - placeableMo3866measureBRTryo0.getMeasuredHeight()) / 2), 0.0f, null, 12, null);
                        }
                    }, 4, null);
                }
                ...
                public final MeasureResult m157invoke3p2s80s(MeasureScope layout, Measurable measurable, long j) {
                    ...
                    final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(j);
                    final int i = layout.mo319roundToPx0680j_4(Dp.m4873constructorimpl(ClipScrollableContainerKt.getMaxSupportedElevation() * 2));
                    return MeasureScope.layout$default(layout, placeableMo3866measureBRTryo0.getWidth() + i, placeableMo3866measureBRTryo0.getHeight() + i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }

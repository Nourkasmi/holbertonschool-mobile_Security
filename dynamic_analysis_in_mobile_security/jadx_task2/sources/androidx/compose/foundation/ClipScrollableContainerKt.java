...
public final class ClipScrollableContainerKt {
    ...
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo208createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            float fMo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -fMo319roundToPx0680j_4, Size.m2459getWidthimpl(size), Size.m2456getHeightimpl(size) + fMo319roundToPx0680j_4));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo208createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float fMo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-fMo319roundToPx0680j_4, 0.0f, Size.m2459getWidthimpl(size) + fMo319roundToPx0680j_4, Size.m2456getHeightimpl(size)));
        }
    });

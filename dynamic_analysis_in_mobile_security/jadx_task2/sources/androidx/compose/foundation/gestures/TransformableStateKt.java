...
public final class TransformableStateKt {
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public final void m357invoked4ec7I(float f, long j, float f2) {
                    stateRememberUpdatedState.getValue().invoke(Float.valueOf(f), Offset.m2379boximpl(j), Float.valueOf(f2));
                }
            });
            ...
            if (i == 0) {
                ...
                if (SuspendAnimationKt.animateTo$default(animationStateAnimationState$default, fBoxFloat, animationSpec, false, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt.animateZoomBy.3.1
                    ...
                    public final void invoke2(AnimationScope<Float, AnimationVector1D> animateTo) {
                        ...
                        TransformScope.m352transformByd4ec7I$default(transformScope, floatRef.element == 0.0f ? 1.0f : animateTo.getValue().floatValue() / floatRef.element, 0L, 0.0f, 6, null);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (SuspendAnimationKt.animateTo$default(animationStateAnimationState$default, fBoxFloat, animationSpec, false, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt.animateRotateBy.2.1
                    ...
                    public final void invoke2(AnimationScope<Float, AnimationVector1D> animateTo) {
                        Intrinsics.checkNotNullParameter(animateTo, "$this$animateTo");
                        TransformScope.m352transformByd4ec7I$default(transformScope, 0.0f, 0L, animateTo.getValue().floatValue() - floatRef.element, 3, null);
                        floatRef.element = animateTo.getValue().floatValue();
                    }
                }, this, 4, null) == coroutine_suspended) {
                    return coroutine_suspended;
    ...
    static final class C01722 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $zoomFactor;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01722(float f, Continuation<? super C01722> continuation) {
            super(2, continuation);
            this.$zoomFactor = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01722 c01722 = new C01722(this.$zoomFactor, continuation);
            c01722.L$0 = obj;
            return c01722;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C01722) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object zoomBy(TransformableState transformableState, float f, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.transform$default(transformableState, null, new C01722(f, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }
    ...
    static final class C01702 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $degrees;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01702(float f, Continuation<? super C01702> continuation) {
            super(2, continuation);
            this.$degrees = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01702 c01702 = new C01702(this.$degrees, continuation);
            c01702.L$0 = obj;
            return c01702;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C01702) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object rotateBy(TransformableState transformableState, float f, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.transform$default(transformableState, null, new C01702(f, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }
    ...
    static final class C01712 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        int label;

        C01712(Continuation<? super C01712> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01712(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C01712) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object stopTransformation(TransformableState transformableState, MutatePriority mutatePriority, Continuation<? super Unit> continuation) {
        Object objTransform = transformableState.transform(mutatePriority, new C01712(null), continuation);

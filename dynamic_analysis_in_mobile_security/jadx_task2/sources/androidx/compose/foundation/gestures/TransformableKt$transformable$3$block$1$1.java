    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                try {
                    try {
                        if (i == 0) {
                            ...
                            this.label = 1;
                            if (TransformableKt.detectZoom(awaitPointerEventScope, this.$updatePanZoomLock, this.$channel, this.$updatedCanPan, this) == coroutine_suspended) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (ForEachGestureKt.awaitEachGesture(this.$$this$null, new C00161(this.$updatePanZoomLock, this.$channel, this.$updatedCanPan, coroutineScope, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {

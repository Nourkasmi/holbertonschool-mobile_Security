...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo243calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long j) {
        ...
        Offset offsetM2379boximpl = Offset.m2379boximpl(Offset.INSTANCE.m2406getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM2379boximpl = Offset.m2379boximpl(Offset.m2395plusMKHz9U(offsetM2379boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m2397timestuRUvjQ(offsetM2379boximpl.getPackedValue(), -calculateMouseWheelScroll.mo325toPx0680j_4(Dp.m4873constructorimpl(64)));
    }
}

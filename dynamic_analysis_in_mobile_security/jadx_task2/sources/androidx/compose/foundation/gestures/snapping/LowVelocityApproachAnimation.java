...
final class LowVelocityApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public Object approachAnimation(ScrollScope scrollScope, float f, float f2, Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        Object objAnimateSnap = SnapFlingBehaviorKt.animateSnap(scrollScope, (Math.abs(f) + this.layoutInfoProvider.calculateSnapStepSize(this.density)) * Math.signum(f2), f, AnimationStateKt.AnimationState$default(0.0f, f2, 0L, 0L, false, 28, null), this.lowVelocityAnimationSpec, function1, continuation);
        return objAnimateSnap == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateSnap : (AnimationResult) objAnimateSnap;
    }
}

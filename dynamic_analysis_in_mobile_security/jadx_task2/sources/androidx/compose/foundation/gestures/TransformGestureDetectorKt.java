...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM2394minusMKHz9U = Offset.m2394minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM2394minusMKHz9U2 = Offset.m2394minusMKHz9U(position, jCalculateCentroid);
                float fM351anglek4lQ0M = m351anglek4lQ0M(jM2394minusMKHz9U2) - m351anglek4lQ0M(jM2394minusMKHz9U);
                float fM2388getDistanceimpl = Offset.m2388getDistanceimpl(Offset.m2395plusMKHz9U(jM2394minusMKHz9U2, jM2394minusMKHz9U)) / 2.0f;
                if (fM351anglek4lQ0M > 180.0f) {
                    fM351anglek4lQ0M -= 360.0f;
                } else if (fM351anglek4lQ0M < -180.0f) {
                    fM351anglek4lQ0M += 360.0f;
                }
                f2 += fM351anglek4lQ0M * fM2388getDistanceimpl;
                f += fM2388getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long jCalculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m2387equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m2405getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m2406getZeroF1C5BW0();
        }
        return Offset.m2394minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        float fM2388getDistanceimpl = 0.0f;
        if (Offset.m2387equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m2405getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                fM2388getDistanceimpl += Offset.m2388getDistanceimpl(Offset.m2394minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid));
                i++;
            }
        }
        return fM2388getDistanceimpl / i;
    }
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        Intrinsics.checkNotNullParameter(pointerEvent, "<this>");
        long jM2406getZeroF1C5BW0 = Offset.INSTANCE.m2406getZeroF1C5BW0();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM2406getZeroF1C5BW0 = Offset.m2395plusMKHz9U(jM2406getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m2385divtuRUvjQ(jM2406getZeroF1C5BW0, i);
    }
}

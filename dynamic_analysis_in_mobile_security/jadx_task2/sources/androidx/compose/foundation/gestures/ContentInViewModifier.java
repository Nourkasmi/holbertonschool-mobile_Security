...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    public Object bringChildIntoView(Function0<Rect> function0, Continuation<? super Unit> continuation) {
        ...
        if (rectInvoke == null || m248isMaxVisibleO0kMr_c$default(this, rectInvoke, 0L, 1, null)) {
            return Unit.INSTANCE;
        }
            ...
            try {
                try {
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (ScrollableState.scroll$default(ContentInViewModifier.this.scrollState, null, new C00051(ContentInViewModifier.this, job, null), this, 1, null) == coroutine_suspended) {
                ...
                if (i == 0) {
                    ...
                    if (updatableAnimationState.animateToZero(function1, new Function0<Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewModifier.launchAnimation.1.1.2
                        ...
                        public final void invoke2() {
                            ...
                            while (bringIntoViewRequestPriorityQueue.requests.isNotEmpty() && ((rectInvoke = ((Request) bringIntoViewRequestPriorityQueue.requests.last()).getCurrentBounds().invoke()) == null || ContentInViewModifier.m248isMaxVisibleO0kMr_c$default(contentInViewModifier3, rectInvoke, 0L, 1, null))) {
                            ...
                            if (contentInViewModifier2.trackingFocusedChild && (focusedChildBounds = contentInViewModifier2.getFocusedChildBounds()) != null && ContentInViewModifier.m248isMaxVisibleO0kMr_c$default(contentInViewModifier2, focusedChildBounds, 0L, 1, null)) {
    ...
    public final float calculateScrollDelta() {
        ...
        long jM5043toSizeozmzZPI = IntSizeKt.m5043toSizeozmzZPI(this.viewportSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return relocationDistance(rectFindBringIntoViewRequest.getTop(), rectFindBringIntoViewRequest.getBottom(), Size.m2456getHeightimpl(jM5043toSizeozmzZPI));
        }
        if (i == 2) {
            return relocationDistance(rectFindBringIntoViewRequest.getLeft(), rectFindBringIntoViewRequest.getRight(), Size.m2459getWidthimpl(jM5043toSizeozmzZPI));
        }
    ...
    static /* synthetic */ boolean m248isMaxVisibleO0kMr_c$default(ContentInViewModifier contentInViewModifier, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    private final long m249relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long jM5043toSizeozmzZPI = IntSizeKt.m5043toSizeozmzZPI(containerSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return OffsetKt.Offset(0.0f, relocationDistance(childBounds.getTop(), childBounds.getBottom(), Size.m2456getHeightimpl(jM5043toSizeozmzZPI)));
        }
        if (i == 2) {
            return OffsetKt.Offset(relocationDistance(childBounds.getLeft(), childBounds.getRight(), Size.m2459getWidthimpl(jM5043toSizeozmzZPI)), 0.0f);
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final Rect findBringIntoViewRequest() {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (rectInvoke != null) {
                    if (m245compareToiLBOSCw(rectInvoke.m2423getSizeNHjbRc(), IntSizeKt.m5043toSizeozmzZPI(this.viewportSize)) > 0) {
                        return rect;
                    }
                    rect = rectInvoke;
                }

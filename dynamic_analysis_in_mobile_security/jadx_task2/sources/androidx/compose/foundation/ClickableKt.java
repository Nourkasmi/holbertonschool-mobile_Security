...
public final class ClickableKt {
    ...
    private static final Modifier genericClickableWithoutGesture_Kqv_Bsg$detectPressAndClickFromKey(Modifier modifier, final boolean z, final Map<Key, PressInteraction.Press> map, final State<Offset> state, final CoroutineScope coroutineScope, final Function0<Unit> function0, final MutableInteractionSource mutableInteractionSource) {
        return KeyInputModifierKt.onKeyEvent(modifier, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1
            ...
            */
            public final java.lang.Boolean m200invokeZmokQxo(android.view.KeyEvent r11) {
                /*
                    r10 = this;
                    ...
                    r3 = 0
                    if (r0 == 0) goto L54
                    boolean r0 = androidx.compose.foundation.Clickable_androidKt.m207isPressZmokQxo(r11)
                    if (r0 == 0) goto L54
                    java.util.Map<androidx.compose.ui.input.key.Key, androidx.compose.foundation.interaction.PressInteraction$Press> r0 = r2
                    long r4 = androidx.compose.ui.input.key.KeyEvent_androidKt.m3615getKeyZmokQxo(r11)
                    androidx.compose.ui.input.key.Key r4 = androidx.compose.ui.input.key.Key.m3304boximpl(r4)
                    ...
                    long r4 = androidx.compose.ui.input.key.KeyEvent_androidKt.m3615getKeyZmokQxo(r11)
                    androidx.compose.ui.input.key.Key r11 = androidx.compose.ui.input.key.Key.m3304boximpl(r4)
                    r2.put(r11, r0)
                ...
                L54:
                    boolean r0 = r1
                    if (r0 == 0) goto L89
                    boolean r0 = androidx.compose.foundation.Clickable_androidKt.m205isClickZmokQxo(r11)
                    if (r0 == 0) goto L89
                    java.util.Map<androidx.compose.ui.input.key.Key, androidx.compose.foundation.interaction.PressInteraction$Press> r0 = r2
                    long r4 = androidx.compose.ui.input.key.KeyEvent_androidKt.m3615getKeyZmokQxo(r11)
                    androidx.compose.ui.input.key.Key r11 = androidx.compose.ui.input.key.Key.m3304boximpl(r4)
                ...
                L8a:
                    ...
                    return r11
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1.m200invokeZmokQxo(android.view.KeyEvent):java.lang.Boolean");
            }
    ...
    public static final Modifier m191clickableXHw0xAI(Modifier clickable, final boolean z, final String str, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(clickable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ClickableKt$clickable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Modifier modifierM189clickableO2vRcR0 = ClickableKt.m189clickableO2vRcR0(companion, (MutableInteractionSource) objRememberedValue, indication, z, str, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM189clickableO2vRcR0;
            }
        });
    }
    ...
    public static final Modifier m195combinedClickablecJG_KMw(Modifier combinedClickable, final boolean z, final String str, final Role role, final String str2, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(combinedClickable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable-cJG_KMw$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                composer.endReplaceableGroup();
                Modifier modifierM193combinedClickableXVZzFYc = ClickableKt.m193combinedClickableXVZzFYc(companion, (MutableInteractionSource) objRememberedValue, indication, z, str, role, str2, function0, function02, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM193combinedClickableXVZzFYc;
            }
        });
    }

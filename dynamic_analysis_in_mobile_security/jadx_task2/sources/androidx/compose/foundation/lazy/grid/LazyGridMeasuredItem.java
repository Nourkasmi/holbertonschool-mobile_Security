    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(offset) + IntOffset.m4991getXimpl(jM625getPlacementDeltanOccac), IntOffset.m4992getYimpl(offset) + IntOffset.m4992getYimpl(jM625getPlacementDeltanOccac));
                if ((m617getMainAxisgyyYBs(offset) <= mainAxisSize && m617getMainAxisgyyYBs(jIntOffset) <= mainAxisSize) || (m617getMainAxisgyyYBs(offset) >= i2 && m617getMainAxisgyyYBs(jIntOffset) >= i2)) {
            ...
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    iM4991getXimpl = (this.mainAxisLayoutSize - IntOffset.m4991getXimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    iM4991getXimpl = IntOffset.m4991getXimpl(offset);
                }
                if (this.isVertical) {
                    iM4992getYimpl = (this.mainAxisLayoutSize - IntOffset.m4992getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    iM4992getYimpl = IntOffset.m4992getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(iM4991getXimpl, iM4992getYimpl);
            }
            long j = this.visualOffset;
            long jIntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(offset) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(offset) + IntOffset.m4992getYimpl(j));
            if (this.isVertical) {

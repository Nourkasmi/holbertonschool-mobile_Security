...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public final LazyGridMeasuredItem m619getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo638measure0kLqBqw = this.measureScope.mo638measure0kLqBqw(index, constraints);
        if (Constraints.m4827getHasFixedWidthimpl(constraints)) {
            iM4830getMinHeightimpl = Constraints.m4831getMinWidthimpl(constraints);
        } else {
        ...
        return createItem(index, key, contentType, iM4830getMinHeightimpl, mainAxisSpacing, listMo638measure0kLqBqw);
    }

...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m620childConstraintsJhjzzOo$foundation_release(int startSlot, int span) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m4839fixedWidthOenEA2s(iCoerceAtLeast);
        }
        return Constraints.INSTANCE.m4838fixedHeightOenEA2s(iCoerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int iM599getCurrentLineSpanimpl = GridItemSpan.m599getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem lazyGridMeasuredItemM619getAndMeasure3p2s80s = this.measuredItemProvider.m619getAndMeasure3p2s80s(lineConfiguration.getFirstItemIndex() + i3, i, m620childConstraintsJhjzzOo$foundation_release(i2, iM599getCurrentLineSpanimpl));
            i2 += iM599getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = lazyGridMeasuredItemM619getAndMeasure3p2s80s;
        }

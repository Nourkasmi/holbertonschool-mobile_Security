...
public interface GridCells {
    ...
    public static final class Adaptive implements GridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            return LazyGridDslKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.mo319roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }
    ...
    public static final class FixedSize implements GridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            int iMo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(this.size);
            int i3 = iMo319roundToPx0680j_4 + i2;
            int i4 = i2 + i;
            if (i3 < i4) {
                int i5 = i4 / i3;
                ArrayList arrayList = new ArrayList(i5);
                for (int i6 = 0; i6 < i5; i6++) {
                    arrayList.add(Integer.valueOf(iMo319roundToPx0680j_4));
                }
                return arrayList;
            }

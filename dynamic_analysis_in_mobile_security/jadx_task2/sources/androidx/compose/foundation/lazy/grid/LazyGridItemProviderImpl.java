...
final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public void Item(final int i, final Object key, Composer composer, final int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.state.getPinnedItems(), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item.1

...
public final class LazyLayoutItemContentFactoryKt {
    ...
    public static final void m635SkippableItemJVlU9Rs(final LazyLayoutItemProvider lazyLayoutItemProvider, final Object obj, final int i, final Object obj2, Composer composer, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(SkippableItem)P(1,3:c#foundation.lazy.layout.StableValue!,2:c#foundation.lazy.layout.StableValue)133@4709L84:LazyLayoutItemContentFactory.kt#wow0x6");
        if ((i2 & 14) == 0) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactoryKt$SkippableItem$2
            ...
            public final void invoke(Composer composer2, int i4) {
                LazyLayoutItemContentFactoryKt.m635SkippableItemJVlU9Rs(lazyLayoutItemProvider, obj, i, obj2, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
}

        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public final LazyListMeasureResult m584invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    ...
                    final long jM4845offsetNN6EwU = ConstraintsKt.m4845offsetNN6EwU(j, -i10, -i9);
                    ...
                    lazyListItemProviderInvoke.getItemScope().setMaxSize(Constraints.m4829getMaxWidthimpl(jM4845offsetNN6EwU), Constraints.m4828getMaxHeightimpl(jM4845offsetNN6EwU));
                    if (z2) {
                    ...
                    final boolean z6 = z;
                    final int i16 = i12;
                    LazyListMeasuredItemProvider lazyListMeasuredItemProvider = new LazyListMeasuredItemProvider(jM4845offsetNN6EwU, z5, lazyListItemProviderInvoke, lazyLayoutMeasureScope, itemCount, i14, horizontal7, vertical7, z6, i16, i13, j2) { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measuredItemProvider$1
                    ...
                    try {
                        ...
                        try {
                            ...
                            LazyListMeasureResult lazyListMeasureResultM587measureLazyListCD5nmq0 = LazyListMeasureKt.m587measureLazyListCD5nmq0(itemCount, lazyListMeasuredItemProvider, i15, i12, i13, i14, iUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, lazyListState.getScrollToBeConsumed(), jM4845offsetNN6EwU, z2, lazyListItemProviderInvoke.getHeaderIndexes(), vertical5, horizontal5, z, lazyLayoutMeasureScope2, lazyListState.getPlacementAnimator(), i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyListItemProviderInvoke, lazyListState.getPinnedItems(), lazyListState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                                ...
                                public final MeasureResult invoke(int i17, int i18, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                    ...
                                    return lazyLayoutMeasureScope.layout(ConstraintsKt.m4843constrainWidthK40F9xA(j, i17 + i10), ConstraintsKt.m4842constrainHeightK40F9xA(j, i18 + i9), MapsKt.emptyMap(), placement);
                                }
                            });
                            lazyListState.applyMeasureResult$foundation_release(lazyListMeasureResultM587measureLazyListCD5nmq0);
                            return lazyListMeasureResultM587measureLazyListCD5nmq0;
                        } finally {

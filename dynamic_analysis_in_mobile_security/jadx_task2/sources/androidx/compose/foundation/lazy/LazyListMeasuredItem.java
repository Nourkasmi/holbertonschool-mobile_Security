...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long jM590getOffsetBjo55l4 = m590getOffsetBjo55l4(i);
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                long jM625getPlacementDeltanOccac = lazyLayoutAnimateItemModifierNode.m625getPlacementDeltanOccac();
                long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jM590getOffsetBjo55l4) + IntOffset.m4991getXimpl(jM625getPlacementDeltanOccac), IntOffset.m4992getYimpl(jM590getOffsetBjo55l4) + IntOffset.m4992getYimpl(jM625getPlacementDeltanOccac));
                if ((m589getMainAxisgyyYBs(jM590getOffsetBjo55l4) <= mainAxisSize && m589getMainAxisgyyYBs(jIntOffset) <= mainAxisSize) || (m589getMainAxisgyyYBs(jM590getOffsetBjo55l4) >= i2 && m589getMainAxisgyyYBs(jIntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                jM590getOffsetBjo55l4 = jIntOffset;
            }
            if (this.reverseLayout) {
                if (!this.isVertical) {
                    iM4991getXimpl = (this.mainAxisLayoutSize - IntOffset.m4991getXimpl(jM590getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM4991getXimpl = IntOffset.m4991getXimpl(jM590getOffsetBjo55l4);
                }
                if (this.isVertical) {
                    iM4992getYimpl = (this.mainAxisLayoutSize - IntOffset.m4992getYimpl(jM590getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM4992getYimpl = IntOffset.m4992getYimpl(jM590getOffsetBjo55l4);
                }
                jM590getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM4991getXimpl, iM4992getYimpl);
            }
            long j = this.visualOffset;
            long jIntOffset2 = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jM590getOffsetBjo55l4) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(jM590getOffsetBjo55l4) + IntOffset.m4992getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m3926placeWithLayeraW9wM$default(scope, placeable, jIntOffset2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3925placeRelativeWithLayeraW9wM$default(scope, placeable, jIntOffset2, 0.0f, null, 6, null);
            }
        }
    }
    ...
    private final long m588copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int iM4991getXimpl = this.isVertical ? IntOffset.m4991getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m4991getXimpl(j))).intValue();
        boolean z = this.isVertical;
        int iM4992getYimpl = IntOffset.m4992getYimpl(j);
        if (z) {
            iM4992getYimpl = function1.invoke(Integer.valueOf(iM4992getYimpl)).intValue();
        }
        return IntOffsetKt.IntOffset(iM4991getXimpl, iM4992getYimpl);
    }

...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int iM4831getMinWidthimpl = iRoundToInt != Integer.MAX_VALUE ? iRoundToInt : Constraints.m4831getMinWidthimpl(j);
        int iM4830getMinHeightimpl = iRoundToInt2 != Integer.MAX_VALUE ? iRoundToInt2 : Constraints.m4830getMinHeightimpl(j);
        if (iRoundToInt == Integer.MAX_VALUE) {
            iRoundToInt = Constraints.m4829getMaxWidthimpl(j);
        }
        if (iRoundToInt2 == Integer.MAX_VALUE) {
            iRoundToInt2 = Constraints.m4828getMaxHeightimpl(j);
        }
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(ConstraintsKt.Constraints(iM4831getMinWidthimpl, iRoundToInt, iM4830getMinHeightimpl, iRoundToInt2));
        return MeasureScope.layout$default(measure, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }

...
final class LazyStaggeredGridItemProviderImpl implements LazyStaggeredGridItemProvider {
    ...
    public void Item(final int i, final Object key, Composer composer, final int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.state.getPinnedItems(), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 608834466, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridItemProviderImpl.Item.1

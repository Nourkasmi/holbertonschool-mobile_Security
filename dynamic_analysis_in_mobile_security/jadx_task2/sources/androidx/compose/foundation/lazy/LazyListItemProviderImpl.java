...
final class LazyListItemProviderImpl implements LazyListItemProvider {
    ...
    public void Item(final int i, final Object key, Composer composer, final int i2) {
        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, i, this.state.getPinnedItems(), ComposableLambdaKt.composableLambda(composerStartRestartGroup, -824725566, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImpl.Item.1

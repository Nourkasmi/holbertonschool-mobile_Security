...
public final class ImageKt {
    ...
    public static final void m214Image5hnEew(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        ...
        int iM3174getDefaultFilterQualityfv9h1I = (i3 & 128) != 0 ? DrawScope.INSTANCE.m3174getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = BitmapPainterKt.m3244BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, iM3174getDefaultFilterQualityfv9h1I, 6, null);
    ...
    public static final void Image(final Painter painter, final String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, final int i, final int i2) {
        ...
        Updater.m2270setimpl(composerM2263constructorimpl, anonymousClass2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        ...
        ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -820198676, "C:Image.kt#71ulvw");

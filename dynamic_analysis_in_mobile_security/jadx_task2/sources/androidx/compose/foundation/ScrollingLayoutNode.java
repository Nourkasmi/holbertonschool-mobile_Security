...
final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m4829getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m4828getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo3866measureBRTryo0.getWidth(), Constraints.m4829getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo3866measureBRTryo0.getHeight(), Constraints.m4828getMaxHeightimpl(j));
        final int height = placeableMo3866measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo3866measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.layout$default(measure, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeableMo3866measureBRTryo0, this.this$0.getIsVertical() ? 0 : i, this.this$0.getIsVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }

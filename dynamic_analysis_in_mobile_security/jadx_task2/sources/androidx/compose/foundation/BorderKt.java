...
public final class BorderKt {
    ...
    public static final DrawResult m173drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM2406getZeroF1C5BW0 = z ? Offset.INSTANCE.m2406getZeroF1C5BW0() : j;
        final long jM2296getSizeNHjbRc = z ? cacheDrawScope.m2296getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.m3166drawRectAsUm42w$default(onDrawWithContent, brush, jM2406getZeroF1C5BW0, jM2296getSizeNHjbRc, 0.0f, stroke, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }

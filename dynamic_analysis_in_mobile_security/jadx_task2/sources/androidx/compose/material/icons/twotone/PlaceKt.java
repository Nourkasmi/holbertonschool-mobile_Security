...
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(Icons.TwoTone twoTone) {
        ...
        pathBuilder.close();
        ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 0.3f, null, 1.0f, 1.0f, iM2975getButtKaPHkGw, iM2985getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);

...
public final class FaceKt {
    ...
    public static final ImageVector getFace(Icons.TwoTone twoTone) {
        ...
        pathBuilder2.close();
        ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder2.getNodes(), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM2975getButtKaPHkGw2, iM2985getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilder3.arcToRelative(1.25f, 1.25f, 0.0f, true, true, -2.5f, 0.0f);
        ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM2975getButtKaPHkGw3, iM2985getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);

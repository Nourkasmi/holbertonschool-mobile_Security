...
public final class ShareKt {
    ...
    public static final ImageVector getShare(Icons.TwoTone twoTone) {
        ...
        pathBuilder2.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder2.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM2975getButtKaPHkGw2, iM2985getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(Color.INSTANCE.m2655getBlack0d7_KjU(), null);
        int iM2975getButtKaPHkGw3 = StrokeCap.INSTANCE.m2975getButtKaPHkGw();
        int iM2985getBevelLxFBmk83 = StrokeJoin.INSTANCE.m2985getBevelLxFBmk8();
        ...
        pathBuilder3.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 0.3f, null, 0.3f, 1.0f, iM2975getButtKaPHkGw3, iM2985getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType4 = VectorKt.getDefaultFillType();
        SolidColor solidColor4 = new SolidColor(Color.INSTANCE.m2655getBlack0d7_KjU(), null);
        int iM2975getButtKaPHkGw4 = StrokeCap.INSTANCE.m2975getButtKaPHkGw();
        int iM2985getBevelLxFBmk84 = StrokeJoin.INSTANCE.m2985getBevelLxFBmk8();
        ...
        pathBuilder4.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder4.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder4.getNodes(), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM2975getButtKaPHkGw4, iM2985getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

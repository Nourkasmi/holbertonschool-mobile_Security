...
public final class HomeKt {
    ...
    public static final ImageVector getHome(Icons.TwoTone twoTone) {
        ...
        pathBuilder.close();
        ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM2975getButtKaPHkGw, iM2985getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilder2.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3253addPathoIyEayM$default(builder, pathBuilder2.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM2975getButtKaPHkGw2, iM2985getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

...
public final class IconsKt {
    ...
    public static /* synthetic */ ImageVector.Builder m955materialPathYwgOQQI$default(ImageVector.Builder materialPath, float f, float f2, int i, Function1 pathBuilder, int i2, Object obj) {
        ...
        return ImageVector.Builder.m3253addPathoIyEayM$default(materialPath, pathBuilder2.getNodes(), defaultFillType, "", solidColor, f3, null, f4, 1.0f, iM2975getButtKaPHkGw, iM2985getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }
    ...
    public static final ImageVector.Builder m954materialPathYwgOQQI(ImageVector.Builder materialPath, float f, float f2, int i, Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        PathBuilder pathBuilder2 = new PathBuilder();
        pathBuilder.invoke(pathBuilder2);
        return ImageVector.Builder.m3253addPathoIyEayM$default(materialPath, pathBuilder2.getNodes(), i, "", solidColor, f, null, f2, 1.0f, iM2975getButtKaPHkGw, iM2985getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}

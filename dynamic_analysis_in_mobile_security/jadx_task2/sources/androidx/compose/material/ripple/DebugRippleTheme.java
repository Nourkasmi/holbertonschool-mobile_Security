...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo958defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM968defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m968defaultRippleColor5vOe2sY(Color.INSTANCE.m2655getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM968defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM967defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m967defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2655getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleAlphaM967defaultRippleAlphaDxMtmZc;
    }
}

...
final class StateLayer {
    ...
    public final void m969drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float fM960getRippleEndRadiuscSwnlzA;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            fM960getRippleEndRadiuscSwnlzA = RippleAnimationKt.m960getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3172getSizeNHjbRc());
        } else {
            fM960getRippleEndRadiuscSwnlzA = drawStateLayer.mo325toPx0680j_4(f);
        }
        float f2 = fM960getRippleEndRadiuscSwnlzA;
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m3154drawCircleVaOC9Bg$default(drawStateLayer, jM2628copywmQWz5c$default, f2, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float fM2459getWidthimpl = Size.m2459getWidthimpl(drawStateLayer.mo3172getSizeNHjbRc());
            float fM2456getHeightimpl = Size.m2456getHeightimpl(drawStateLayer.mo3172getSizeNHjbRc());

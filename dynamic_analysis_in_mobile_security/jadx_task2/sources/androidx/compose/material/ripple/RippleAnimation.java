...
public final class RippleAnimation {
    ...
    */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00412(RippleAnimation.this, null), 3, null);
        ...
        static final class C00412 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00412(RippleAnimation rippleAnimation, Continuation<? super C00412> continuation) {
                super(2, continuation);
                this.this$0 = rippleAnimation;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00412(this.this$0, continuation);
            }
    ...
    static final class C02412 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02412 c02412 = RippleAnimation.this.new C02412(continuation);
            c02412.L$0 = obj;
            return c02412;
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C02412(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m959draw4WTKRHQ(DrawScope draw, long j) {
        ...
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                fValueOf = Float.valueOf(RippleAnimationKt.m960getRippleEndRadiuscSwnlzA(draw, this.bounded, draw.mo3172getSizeNHjbRc()));
            } else {
                fValueOf = Float.valueOf(draw.mo325toPx0680j_4(this.radius));
            }
        ...
        float fM2390getXimpl = Offset.m2390getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp2 = MathHelpersKt.lerp(fM2390getXimpl, Offset.m2390getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM2391getYimpl = Offset.m2391getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long jOffset = OffsetKt.Offset(fLerp2, MathHelpersKt.lerp(fM2391getYimpl, Offset.m2391getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long jM2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(j, Color.m2631getAlphaimpl(j) * fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m3154drawCircleVaOC9Bg$default(draw, jM2628copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            return;
        }
        float fM2459getWidthimpl = Size.m2459getWidthimpl(draw.mo3172getSizeNHjbRc());
        float fM2456getHeightimpl = Size.m2456getHeightimpl(draw.mo3172getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3100clipRectN_I0leg(0.0f, 0.0f, fM2459getWidthimpl, fM2456getHeightimpl, iM2618getIntersectrtfAjoo);
        DrawScope.m3154drawCircleVaOC9Bg$default(draw, jM2628copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);

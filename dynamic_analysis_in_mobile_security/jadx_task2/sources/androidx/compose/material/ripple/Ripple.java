...
public abstract class Ripple implements Indication {
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long jMo958defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m2639unboximpl() != Color.INSTANCE.m2665getUnspecified0d7_KjU()) {
            jMo958defaultColorWaAFU9c = this.color.getValue().m2639unboximpl();
        } else {
            jMo958defaultColorWaAFU9c = rippleTheme.mo958defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance rippleIndicationInstanceMo956rememberUpdatedRippleInstance942rkJo = mo956rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(jMo958defaultColorWaAFU9c), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(rippleIndicationInstanceMo956rememberUpdatedRippleInstance942rkJo, interactionSource, new AnonymousClass1(interactionSource, rippleIndicationInstanceMo956rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleIndicationInstanceMo956rememberUpdatedRippleInstance942rkJo;
    }

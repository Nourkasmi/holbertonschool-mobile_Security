...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m971setColorDxMtmZc(long color, float alpha) {
        long jM970calculateRippleColor5vOe2sY = m970calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 != null && Color.m2630equalsimpl0(color2.m2639unboximpl(), jM970calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2619boximpl(jM970calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2683toArgb8_81llA(jM970calculateRippleColor5vOe2sY)));
    }

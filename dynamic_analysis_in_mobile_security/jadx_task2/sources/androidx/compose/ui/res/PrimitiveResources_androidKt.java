...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        float fM4873constructorimpl = Dp.m4873constructorimpl(((Context) objConsume).getResources().getDimension(i) / ((Density) objConsume2).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return fM4873constructorimpl;
    }
}

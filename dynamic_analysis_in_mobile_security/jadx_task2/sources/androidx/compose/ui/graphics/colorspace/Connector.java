...
public class Connector {
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb mSource, Rgb mDestination, int i) {
            ...
            this.mTransform = m3046computeTransformYBCOT_4(mSource, mDestination, i);
        }
    ...
    public static final class Companion {
        ...
        public final float[] m3045computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            ...
            boolean zM3029equalsimpl0 = ColorModel.m3029equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw());
            boolean zM3029equalsimpl02 = ColorModel.m3029equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3036getRgbxdoWZVw());
            if (zM3029equalsimpl0 && zM3029equalsimpl02) {
                return null;
            }
            if (!zM3029equalsimpl0 && !zM3029equalsimpl02) {
                return null;
            }
            if (!zM3029equalsimpl0) {
                source = destination;
            }
            Intrinsics.checkNotNull(source, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = zM3029equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = zM3029equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            Intrinsics.checkNotNullParameter(source, "source");
            final int iM3056getRelativeuksYyKA = RenderIntent.INSTANCE.m3056getRelativeuksYyKA();
            return new Connector(source, iM3056getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(source, source, iM3056getRelativeuksYyKA, null);
                }

...
public final class Lab extends ColorSpace {
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        return (((long) Float.floatToIntBits(f * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[0])) << 32) | (((long) Float.floatToIntBits(f2 * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[1])) & 4294967295L);
    }
    ...
    public long mo3039xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        ...
        return ColorKt.Color(RangesKt.coerceIn((116.0f * fPow2) - 16.0f, 0.0f, 100.0f), RangesKt.coerceIn((fPow - fPow2) * 500.0f, -128.0f, 128.0f), RangesKt.coerceIn((fPow2 - (f3 > A ? (float) Math.pow(f3, 0.33333334f) : (f3 * B) + C)) * 200.0f, -128.0f, 128.0f), a, colorSpace);
    }

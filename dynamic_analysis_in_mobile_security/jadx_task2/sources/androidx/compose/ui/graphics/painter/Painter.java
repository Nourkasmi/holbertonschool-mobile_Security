...
public abstract class Painter {
    ...
    public final void m3247drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        ...
        float fM2459getWidthimpl = Size.m2459getWidthimpl(draw.mo3172getSizeNHjbRc()) - Size.m2459getWidthimpl(j);
        float fM2456getHeightimpl = Size.m2456getHeightimpl(draw.mo3172getSizeNHjbRc()) - Size.m2456getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, fM2459getWidthimpl, fM2456getHeightimpl);
        if (f > 0.0f && Size.m2459getWidthimpl(j) > 0.0f && Size.m2456getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect rectM2430Recttz77jQw = RectKt.m2430Recttz77jQw(Offset.INSTANCE.m2406getZeroF1C5BW0(), SizeKt.Size(Size.m2459getWidthimpl(j), Size.m2456getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(rectM2430Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }

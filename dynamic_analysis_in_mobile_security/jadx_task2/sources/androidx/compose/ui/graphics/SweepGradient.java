...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2598createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2411isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m2469getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset(Offset.m2390getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2459getWidthimpl(size) : Offset.m2390getXimpl(this.center), Offset.m2391getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2456getHeightimpl(size) : Offset.m2391getYimpl(this.center));
        }
        return ShaderKt.m2941SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public int hashCode() {
        int iM2392hashCodeimpl = ((Offset.m2392hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM2392hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

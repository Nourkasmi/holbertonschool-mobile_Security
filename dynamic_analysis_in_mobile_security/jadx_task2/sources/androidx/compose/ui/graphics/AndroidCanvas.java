...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo2490drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m2390getXimpl(p1), Offset.m2391getYimpl(p1), Offset.m2390getXimpl(p2), Offset.m2391getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo2487drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m2390getXimpl(center), Offset.m2391getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo2488drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        ...
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m2390getXimpl(topLeftOffset), Offset.m2391getYimpl(topLeftOffset), paint.getInternalPaint());
    }
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m2390getXimpl(packedValue), Offset.m2391getYimpl(packedValue), Offset.m2390getXimpl(packedValue2), Offset.m2391getYimpl(packedValue2), internalPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo2493drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        ...
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m2537toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int i = 0; i < size; i++) {
            long packedValue = points.get(i).getPackedValue();
            this.internalCanvas.drawPoint(Offset.m2390getXimpl(packedValue), Offset.m2391getYimpl(packedValue), paint.getInternalPaint());
        }
    }
}

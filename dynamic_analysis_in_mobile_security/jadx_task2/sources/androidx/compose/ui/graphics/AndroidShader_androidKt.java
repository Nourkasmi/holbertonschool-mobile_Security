...
public final class AndroidShader_androidKt {
    ...
    public static final Shader m2532ActualLinearGradientShaderVjE6UOU(long j, long j2, List<Color> colors, List<Float> list, int i) {
        ...
        return new android.graphics.LinearGradient(Offset.m2390getXimpl(j), Offset.m2391getYimpl(j), Offset.m2390getXimpl(j2), Offset.m2391getYimpl(j2), makeTransparentColors(colors, iCountTransparentColors), makeTransparentStops(list, colors, iCountTransparentColors), AndroidTileMode_androidKt.m2536toAndroidTileMode0vamqd0(i));
    }
    ...
    public static final Shader m2533ActualRadialGradientShader8uybcMk(long j, float f, List<Color> colors, List<Float> list, int i) {
        ...
        validateColorStops(colors, list);
        int iCountTransparentColors = countTransparentColors(colors);
        return new android.graphics.RadialGradient(Offset.m2390getXimpl(j), Offset.m2391getYimpl(j), f, makeTransparentColors(colors, iCountTransparentColors), makeTransparentStops(list, colors, iCountTransparentColors), AndroidTileMode_androidKt.m2536toAndroidTileMode0vamqd0(i));
    }
    ...
    public static final Shader m2534ActualSweepGradientShader9KIMszo(long j, List<Color> colors, List<Float> list) {
        ...
        validateColorStops(colors, list);
        int iCountTransparentColors = countTransparentColors(colors);
        return new android.graphics.SweepGradient(Offset.m2390getXimpl(j), Offset.m2391getYimpl(j), makeTransparentColors(colors, iCountTransparentColors), makeTransparentStops(list, colors, iCountTransparentColors));
    }
    ...
    public static final int[] makeTransparentColors(List<Color> colors, int i) {
        ...
        int i4 = 0;
        while (i3 < size2) {
            long jM2639unboximpl = colors.get(i3).m2639unboximpl();
            if (Color.m2631getAlphaimpl(jM2639unboximpl) == 0.0f) {
                if (i3 == 0) {
                    i2 = i4 + 1;
                ...
                iArr2[i4] = ColorKt.m2683toArgb8_81llA(jM2639unboximpl);
                i4++;
            }
            i3++;
        }

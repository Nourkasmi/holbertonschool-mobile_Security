...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2447boximpl(Size.INSTANCE.m2468getZeroNHjbRc()), null, 2, null);
    ...
    public final void RenderVector$ui_release(final String name, final float f, final float f2, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(RenderVector)P(1,3,2)233@8813L28,237@8882L117:VectorPainter.kt#huu6hf");
        if (ComposerKt.isTraceInProgress()) {

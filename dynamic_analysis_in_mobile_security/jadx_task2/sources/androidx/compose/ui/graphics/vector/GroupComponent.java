...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        float[] fArrM2854constructorimpl$default = this.groupMatrix;
        if (fArrM2854constructorimpl$default == null) {
            fArrM2854constructorimpl$default = Matrix.m2854constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM2854constructorimpl$default;
        } else {
            Matrix.m2863resetimpl(fArrM2854constructorimpl$default);
        }
        Matrix.m2874translateimpl$default(fArrM2854constructorimpl$default, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2866rotateZimpl(fArrM2854constructorimpl$default, this.rotation);
        Matrix.m2867scaleimpl(fArrM2854constructorimpl$default, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2874translateimpl$default(fArrM2854constructorimpl$default, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }

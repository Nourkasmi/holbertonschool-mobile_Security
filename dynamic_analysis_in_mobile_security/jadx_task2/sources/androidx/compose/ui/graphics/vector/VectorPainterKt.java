...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3269rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        long jM2665getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m2665getUnspecified0d7_KjU() : j;
        int iM2571getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m2571getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM3270rememberVectorPaintervIP8VLU = m3270rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM2665getUnspecified0d7_KjU, iM2571getSrcIn0nO6VwU, false, content, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return vectorPainterM3270rememberVectorPaintervIP8VLU;
    }
    ...
    public static final VectorPainter m3270rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        float fMo325toPx0680j_4 = density.mo325toPx0680j_4(f);
        float fMo325toPx0680j_42 = density.mo325toPx0680j_4(f2);
        if (Float.isNaN(f5)) {
            f5 = fMo325toPx0680j_4;
        }
        if (Float.isNaN(f6)) {
            f6 = fMo325toPx0680j_42;
        }
        Color colorM2619boximpl = Color.m2619boximpl(jM2665getUnspecified0d7_KjU);
        BlendMode blendModeM2539boximpl = BlendMode.m2539boximpl(iM2571getSrcIn0nO6VwU);
        int i4 = i2 >> 15;
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(colorM2619boximpl) | composer.changed(blendModeM2539boximpl);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = !Color.m2630equalsimpl0(jM2665getUnspecified0d7_KjU, Color.INSTANCE.m2665getUnspecified0d7_KjU()) ? ColorFilter.INSTANCE.m2673tintxETnrds(jM2665getUnspecified0d7_KjU, iM2571getSrcIn0nO6VwU) : null;
        ...
        vectorPainter.m3268setSizeuvyYCjk$ui_release(SizeKt.Size(fMo325toPx0680j_4, fMo325toPx0680j_42));
        ...
        if (i4 != 2 || (i3 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            while (it.hasNext()) {
                ...
                if (next instanceof VectorPath) {
                    ...
                    ComposerKt.sourceInformation(composerStartRestartGroup, "334@12154L1719");
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        long jMo3171getCenterF1C5BW0 = drawScope.mo3171getCenterF1C5BW0();

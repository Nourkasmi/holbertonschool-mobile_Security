...
public final class ImageVectorKt {
    ...
    public static /* synthetic */ ImageVector.Builder m3256pathR_LF3I$default(ImageVector.Builder path, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1 pathBuilder, int i4, Object obj) {
        ...
        return ImageVector.Builder.m3253addPathoIyEayM$default(path, pathBuilder2.getNodes(), defaultFillType, name, brush3, f5, brush4, f6, f7, defaultStrokeLineCap, defaultStrokeLineJoin, f8, 0.0f, 0.0f, 0.0f, 14336, null);
    }
    ...
    public static final ImageVector.Builder m3255pathR_LF3I(ImageVector.Builder path, String name, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        PathBuilder pathBuilder2 = new PathBuilder();
        pathBuilder.invoke(pathBuilder2);
        return ImageVector.Builder.m3253addPathoIyEayM$default(path, pathBuilder2.getNodes(), i3, name, brush, f, brush2, f2, f3, i, i2, f4, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}

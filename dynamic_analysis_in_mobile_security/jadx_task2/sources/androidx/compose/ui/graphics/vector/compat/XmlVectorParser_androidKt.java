...
public final class XmlVectorParser_androidKt {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) throws XmlPullParserException {
        long jM2665getUnspecified0d7_KjU;
        int iM2571getSrcIn0nO6VwU;
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM2665getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
                jM2665getUnspecified0d7_KjU = Color.INSTANCE.m2665getUnspecified0d7_KjU();
            }
        } else {
            jM2665getUnspecified0d7_KjU = Color.INSTANCE.m2665getUnspecified0d7_KjU();
        }
        long j = jM2665getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2571getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2573getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2571getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2570getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2562getModulate0nO6VwU();
                    break;
                case 15:
                    iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2567getScreen0nO6VwU();
                    break;
                case 16:
                    iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2565getPlus0nO6VwU();
                    break;
                default:
                    iM2571getSrcIn0nO6VwU = BlendMode.INSTANCE.m2571getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM2571getSrcIn0nO6VwU;
        float fM4873constructorimpl = Dp.m4873constructorimpl(dimension / res.getDisplayMetrics().density);
        float fM4873constructorimpl2 = Dp.m4873constructorimpl(dimension2 / res.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM4873constructorimpl, fM4873constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM3274getStrokeLineCapCSYIeUk = m3274getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m2975getButtKaPHkGw());
        int iM3276getStrokeLineJoinkLtJ_vA = m3276getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m2985getBevelLxFBmk8());
        ...
        builder.m3254addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m2906getNonZeroRgk1Os() : companion.m2905getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM3274getStrokeLineCapCSYIeUk, iM3276getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }

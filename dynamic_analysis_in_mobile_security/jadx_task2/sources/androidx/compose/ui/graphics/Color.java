...
public final class Color {
    ...
    public static final long m2626convertvNxB06k(long j, ColorSpace colorSpace) {
        ...
        ColorSpace colorSpaceM2633getColorSpaceimpl = m2633getColorSpaceimpl(j);
        return Intrinsics.areEqual(colorSpace, colorSpaceM2633getColorSpaceimpl) ? j : ColorSpaceKt.m3041connectYBCOT_4$default(colorSpaceM2633getColorSpaceimpl, colorSpace, 0, 2, null).mo3043transformToColorwmQWz5c$ui_graphics_release(m2635getRedimpl(j), m2634getGreenimpl(j), m2632getBlueimpl(j), m2631getAlphaimpl(j));
    }
    ...
    public static final float m2631getAlphaimpl(long j) {
        ...
        float f;
        if (ULong.m5335constructorimpl(63 & j) == 0) {
            fUlongToDouble = (float) UnsignedKt.ulongToDouble(ULong.m5335constructorimpl(ULong.m5335constructorimpl(j >>> 56) & 255));
            f = 255.0f;
        } else {
            fUlongToDouble = (float) UnsignedKt.ulongToDouble(ULong.m5335constructorimpl(ULong.m5335constructorimpl(j >>> 6) & 1023));
            f = 1023.0f;
        }

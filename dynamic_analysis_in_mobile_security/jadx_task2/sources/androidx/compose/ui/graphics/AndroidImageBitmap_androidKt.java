...
public final class AndroidImageBitmap_androidKt {
    ...
    public static final ImageBitmap m2499ActualImageBitmapx__hDU(int i, int i2, int i3, boolean z, ColorSpace colorSpace) {
        ...
        Bitmap.Config configM2500toBitmapConfig1JJdX4A = m2500toBitmapConfig1JJdX4A(i3);
        if (Build.VERSION.SDK_INT >= 26) {
            bitmapCreateBitmap = Api26Bitmap.m2538createBitmapx__hDU$ui_graphics_release(i, i2, i3, z, colorSpace);
        } else {
            bitmapCreateBitmap = Bitmap.createBitmap((DisplayMetrics) null, i, i2, configM2500toBitmapConfig1JJdX4A);

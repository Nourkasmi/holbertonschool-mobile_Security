...
public final class SolidColor extends Brush {
    ...
    public void mo2576applyToPq9zytI(long size, Paint p, float alpha) {
        ...
        p.setAlpha(1.0f);
        if (alpha == 1.0f) {
            jM2628copywmQWz5c$default = this.value;
        } else {
            long j = this.value;
            jM2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(j, Color.m2631getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        }
        p.mo2510setColor8_81llA(jM2628copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }

...
public final class ParagraphStyle {
    ...
    public int hashCode() {
        ...
        int iM4764hashCodeimpl = (textAlign != null ? TextAlign.m4764hashCodeimpl(textAlign.getValue()) : 0) * 31;
        TextDirection textDirection = this.textDirection;
        int iM4777hashCodeimpl = (((iM4764hashCodeimpl + (textDirection != null ? TextDirection.m4777hashCodeimpl(textDirection.getValue()) : 0)) * 31) + TextUnit.m5055hashCodeimpl(this.lineHeight)) * 31;
        TextIndent textIndent = this.textIndent;
        int iHashCode = (iM4777hashCodeimpl + (textIndent != null ? textIndent.hashCode() : 0)) * 31;
        ...
        int iM4698hashCodeimpl = (iHashCode3 + (lineBreak != null ? LineBreak.m4698hashCodeimpl(lineBreak.getMask()) : 0)) * 31;
        Hyphens hyphens = this.hyphens;
        int iM4683hashCodeimpl = (iM4698hashCodeimpl + (hyphens != null ? Hyphens.m4683hashCodeimpl(hyphens.getValue()) : 0)) * 31;
        TextMotion textMotion = this.textMotion;
        return iM4683hashCodeimpl + (textMotion != null ? textMotion.hashCode() : 0);
    }

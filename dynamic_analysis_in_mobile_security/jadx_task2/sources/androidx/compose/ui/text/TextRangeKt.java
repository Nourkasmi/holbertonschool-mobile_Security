...
public final class TextRangeKt {
    ...
    public static final long m4410coerceIn8ffj60Q(long j, int i, int i2) {
        int iCoerceIn = RangesKt.coerceIn(TextRange.m4404getStartimpl(j), i, i2);
        int iCoerceIn2 = RangesKt.coerceIn(TextRange.m4399getEndimpl(j), i, i2);
        return (iCoerceIn == TextRange.m4404getStartimpl(j) && iCoerceIn2 == TextRange.m4399getEndimpl(j)) ? j : TextRange(iCoerceIn, iCoerceIn2);
    }

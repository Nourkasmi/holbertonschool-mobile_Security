...
public final class SpanStyleKt {
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float f) {
        ...
        long jM4369lerpTextUnitInheritableC3pnCVY = m4369lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), f);
        ...
        long jM4369lerpTextUnitInheritableC3pnCVY2 = m4369lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), f);
        BaselineShift baselineShift = start.getBaselineShift();
        float fM4666unboximpl = baselineShift != null ? baselineShift.m4666unboximpl() : BaselineShift.m4661constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float fM4673lerpjWV1Mfo = BaselineShiftKt.m4673lerpjWV1Mfo(fM4666unboximpl, baselineShift2 != null ? baselineShift2.m4666unboximpl() : BaselineShift.m4661constructorimpl(0.0f), f);
        ...
        long jM2680lerpjxsXWHM = ColorKt.m2680lerpjxsXWHM(start.getBackground(), stop.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM4369lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM4369lerpTextUnitInheritableC3pnCVY2, BaselineShift.m4660boximpl(fM4673lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM2680lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        TextForegroundStyle textForegroundStyleTakeOrElse = style.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt.resolveSpanStyleDefaults.1
            ...
            public final TextForegroundStyle invoke() {
                return TextForegroundStyle.INSTANCE.m4786from8_81llA(SpanStyleKt.DefaultColor);
            }
        });
        ...
        FontSynthesis fontSynthesisM4506boximpl = FontSynthesis.m4506boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4515getAllGVVA2EU());
        ...
        BaselineShift baselineShiftM4660boximpl = BaselineShift.m4660boximpl(baselineShift != null ? baselineShift.m4666unboximpl() : BaselineShift.INSTANCE.m4670getNoney9eOQZs());
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM4497boximpl, fontSynthesisM4506boximpl, fontFamily2, str, letterSpacing, baselineShiftM4660boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }

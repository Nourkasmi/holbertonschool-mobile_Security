...
public final class EditProcessor {
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder sbAppend = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m4545getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m4407toStringimpl(this.mBuffer.m4546getSelectiond9O1mEE$ui_text_release())) + "):");

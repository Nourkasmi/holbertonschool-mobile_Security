    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.createInputConnection.1
            ...
            public void mo4577onImeActionKlQnJC8(int imeAction) {
                TextInputServiceAndroid.this.onImeActionPerformed.invoke(ImeAction.m4548boximpl(imeAction));
            }
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z) {
                ...
                int iM4402getMinimpl = TextRange.m4402getMinimpl(newValue.getSelection());
                int iM4401getMaximpl = TextRange.m4401getMaximpl(newValue.getSelection());
                ...
                inputMethodManager.updateSelection(iM4402getMinimpl, iM4401getMaximpl, iM4402getMinimpl2, composition2 != null ? TextRange.m4401getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }

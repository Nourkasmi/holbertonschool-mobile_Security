...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int iM4402getMinimpl = composition != null ? TextRange.m4402getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m4402getMinimpl(state.getSelection()), TextRange.m4401getMaximpl(state.getSelection()), iM4402getMinimpl, composition2 != null ? TextRange.m4401getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM4563getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4563getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4565getGoeUduSuo();
                    break;
                case 3:
                    iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4569getSearcheUduSuo();
                    break;
                case 4:
                    iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4570getSendeUduSuo();
                    break;
                case 5:
                    iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4566getNexteUduSuo();
                    break;
                case 6:
                    iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4564getDoneeUduSuo();
                    break;
                case 7:
                    iM4563getDefaulteUduSuo = ImeAction.INSTANCE.m4568getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo4577onImeActionKlQnJC8(iM4563getDefaulteUduSuo);
        return true;
    }

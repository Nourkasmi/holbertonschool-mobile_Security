...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
        ...
        int iM4274toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4274toLayoutAlignAMY3VfE(style.m4433getTextAlignbuA522U());
        TextAlign textAlignM4433getTextAlignbuA522U = style.m4433getTextAlignbuA522U();
        boolean zM4763equalsimpl0 = textAlignM4433getTextAlignbuA522U == null ? false : TextAlign.m4763equalsimpl0(textAlignM4433getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m4769getJustifye0LSkKk());
        int iM4276toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m4276toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak lineBreakM4431getLineBreakLgCVezo = style.m4431getLineBreakLgCVezo();
        int iM4275toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m4275toLayoutBreakStrategyu6PBz3U(lineBreakM4431getLineBreakLgCVezo != null ? LineBreak.Strategy.m4704boximpl(LineBreak.m4695getStrategyfcGXIks(lineBreakM4431getLineBreakLgCVezo.getMask())) : null);
        LineBreak lineBreakM4431getLineBreakLgCVezo2 = style.m4431getLineBreakLgCVezo();
        int iM4277toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m4277toLayoutLineBreakStyle4a2g8L8(lineBreakM4431getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4714boximpl(LineBreak.m4696getStrictnessusljTpc(lineBreakM4431getLineBreakLgCVezo2.getMask())) : null);
        LineBreak lineBreakM4431getLineBreakLgCVezo3 = style.m4431getLineBreakLgCVezo();
        int iM4278toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m4278toLayoutLineBreakWordStylegvcdTPQ(lineBreakM4431getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4725boximpl(LineBreak.m4697getWordBreakjp8hJ3c(lineBreakM4431getLineBreakLgCVezo3.getMask())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout textLayoutConstructTextLayout = constructTextLayout(iM4274toLayoutAlignAMY3VfE, zM4763equalsimpl0 ? 1 : 0, truncateAt, i, iM4276toLayoutHyphenationFrequency0_XeFpE, iM4275toLayoutBreakStrategyu6PBz3U, iM4277toLayoutLineBreakStyle4a2g8L8, iM4278toLayoutLineBreakWordStylegvcdTPQ);
        if (!z || textLayoutConstructTextLayout.getHeight() <= Constraints.m4828getMaxHeightimpl(j) || i <= 1) {
            this.layout = textLayoutConstructTextLayout;
        } else {
            int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m4828getMaxHeightimpl(j));
            if (iNumberOfLinesThatFitMaxHeight >= 0 && iNumberOfLinesThatFitMaxHeight != i) {
                textLayoutConstructTextLayout = constructTextLayout(iM4274toLayoutAlignAMY3VfE, zM4763equalsimpl0 ? 1 : 0, truncateAt, RangesKt.coerceAtLeast(iNumberOfLinesThatFitMaxHeight, 1), iM4276toLayoutHyphenationFrequency0_XeFpE, iM4275toLayoutBreakStrategyu6PBz3U, iM4277toLayoutLineBreakStyle4a2g8L8, iM4278toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = textLayoutConstructTextLayout;
        }
    ...
    public void mo4266paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int iM4638getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4638getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4641setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        ...
        paint(canvas);
        getTextPaint$ui_text_release().m4639setBlendModes9anfk8(iM4638getBlendMode0nO6VwU);
    }

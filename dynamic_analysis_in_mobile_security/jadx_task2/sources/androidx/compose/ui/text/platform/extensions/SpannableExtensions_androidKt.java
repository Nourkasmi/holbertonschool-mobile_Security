...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        ...
        if (textIndent != null) {
            ...
            long jM5053getTypeUIouoOA = TextUnit.m5053getTypeUIouoOA(textIndent.getFirstLine());
            float fM5054getValueimpl2 = 0.0f;
            if (TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA, TextUnitType.INSTANCE.m5087getSpUIouoOA())) {
                fM5054getValueimpl = density.mo324toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM5054getValueimpl = TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA, TextUnitType.INSTANCE.m5086getEmUIouoOA()) ? TextUnit.m5054getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM5053getTypeUIouoOA2 = TextUnit.m5053getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA2, TextUnitType.INSTANCE.m5087getSpUIouoOA())) {
                fM5054getValueimpl2 = density.mo324toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA2, TextUnitType.INSTANCE.m5086getEmUIouoOA())) {
                fM5054getValueimpl2 = TextUnit.m5054getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM5054getValueimpl), (int) Math.ceil(fM5054getValueimpl2)), 0, spannable.length());
        }
    }
    ...
    public static final void m4654setLineHeightr9BaKPg(Spannable setLineHeight, long j, float f, Density density) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(fM4648resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }
    ...
    private static final float m4648resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long jM5053getTypeUIouoOA = TextUnit.m5053getTypeUIouoOA(j);
        if (TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA, TextUnitType.INSTANCE.m5087getSpUIouoOA())) {
            return density.mo324toPxR2X_6o(j);
        }
        if (TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA, TextUnitType.INSTANCE.m5086getEmUIouoOA())) {
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        MetricAffectingSpan metricAffectingSpanM4647createLetterSpacingSpaneAf_CNQ;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM4647createLetterSpacingSpaneAf_CNQ = m4647createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM4647createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    public static final void m4652setFontSizeKmRG4DE(Spannable setFontSize, long j, Density density, int i, int i2) {
        ...
        } else if (TextUnitType.m5082equalsimpl0(jM5053getTypeUIouoOA, TextUnitType.INSTANCE.m5086getEmUIouoOA())) {
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m4427getFontStyle4Lr2A7w(), textStyle.m4428getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                FontStyle fontStyleM4497boximpl = FontStyle.m4497boximpl(fontStyle != null ? fontStyle.m4503unboximpl() : FontStyle.INSTANCE.m4505getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM4497boximpl, FontSynthesis.m4506boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4515getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

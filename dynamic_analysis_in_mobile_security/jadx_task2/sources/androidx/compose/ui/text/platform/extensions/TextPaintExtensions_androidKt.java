...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, Density density, boolean z) {
        ...
        long jM5053getTypeUIouoOA = TextUnit.m5053getTypeUIouoOA(style.getFontSize());
        ...
        if (hasFontAttributes(style)) {
            ...
            androidTextPaint.setTypeface(resolveTypeface.invoke(fontFamily, fontWeight, fontStyleM4497boximpl, FontSynthesis.m4506boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4515getAllGVVA2EU())));
        }
        ...
        if (TextUnitType.m5082equalsimpl0(TextUnit.m5053getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m5087getSpUIouoOA()) && TextUnit.m5054getValueimpl(style.getLetterSpacing()) != 0.0f) {
            ...
            float fMo324toPxR2X_6o = density.mo324toPxR2X_6o(style.getLetterSpacing());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(fMo324toPxR2X_6o / textSize);
            }

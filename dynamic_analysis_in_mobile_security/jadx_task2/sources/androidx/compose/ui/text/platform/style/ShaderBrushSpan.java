...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        Shader shaderMo2598createShaderuvyYCjk;
        ...
        if (pair == null || !Size.m2455equalsimpl0(pair.getFirst().getPackedValue(), this.size)) {
            shaderMo2598createShaderuvyYCjk = this.shaderBrush.mo2598createShaderuvyYCjk(this.size);
        } else {
            shaderMo2598createShaderuvyYCjk = pair.getSecond();
        }
        textPaint.setShader(shaderMo2598createShaderuvyYCjk);
        this.cachedShader = TuplesKt.to(Size.m2447boximpl(this.size), shaderMo2598createShaderuvyYCjk);
    }
}

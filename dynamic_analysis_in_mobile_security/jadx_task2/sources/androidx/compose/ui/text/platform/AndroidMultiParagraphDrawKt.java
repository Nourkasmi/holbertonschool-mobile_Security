...
public final class AndroidMultiParagraphDrawKt {
    ...
    public static final void m4628drawMultiParagraph7AXcY_I(MultiParagraph drawMultiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        ...
        if (drawMultiParagraph.getParagraphInfoList$ui_text_release().size() <= 1 || (brush instanceof SolidColor)) {
            ...
            Shader shaderMo2598createShaderuvyYCjk = ((ShaderBrush) brush).mo2598createShaderuvyYCjk(SizeKt.Size(fMax, height));
            Matrix matrix = new Matrix();
            shaderMo2598createShaderuvyYCjk.getLocalMatrix(matrix);
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                paragraphInfo2.getParagraph().mo4268painthn5TExg(canvas, BrushKt.ShaderBrush(shaderMo2598createShaderuvyYCjk), f, shadow, textDecoration, drawStyle, i);
                ...
                shaderMo2598createShaderuvyYCjk.setLocalMatrix(matrix);
            }
        }
        canvas.restore();
    }

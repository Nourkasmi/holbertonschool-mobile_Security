    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public final Typeface m4631invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
                ...
                State<Object> stateMo4475resolveDPcqOEQ = this.this$0.getFontFamilyResolver().mo4475resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
                if (!(stateMo4475resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
                    TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(stateMo4475resolveDPcqOEQ, this.this$0.resolvedTypefaces);
                    this.this$0.resolvedTypefaces = typefaceDirtyTrackerLinkedList;
                    return typefaceDirtyTrackerLinkedList.getTypeface();
                }
                Object value = stateMo4475resolveDPcqOEQ.getValue();
                Intrinsics.checkNotNull(value, "null cannot be cast to non-null type android.graphics.Typeface");
                return (Typeface) value;
            }
        };
        TextPaintExtensions_androidKt.setTextMotion(androidTextPaint, style.getTextMotion());
        SpanStyle spanStyleApplySpanStyle = TextPaintExtensions_androidKt.applySpanStyle(androidTextPaint, style.toSpanStyle(), function4, density, !spanStyles.isEmpty());
        ...
        CharSequence charSequenceCreateCharSequence = AndroidParagraphHelper_androidKt.createCharSequence(this.text, this.textPaint.getTextSize(), this.style, spanStyles, this.placeholders, this.density, function4, this.emojiCompatProcessed);

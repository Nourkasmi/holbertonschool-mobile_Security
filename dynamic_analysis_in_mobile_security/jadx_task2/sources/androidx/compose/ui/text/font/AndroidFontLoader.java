    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (FontLoadingStrategy.m4487equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4492getBlockingPKNRLFQ())) {
            ...
            try {
                ...
                objM5160constructorimpl = Result.m5160constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, context3));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM5160constructorimpl = Result.m5160constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m5166isFailureimpl(objM5160constructorimpl) ? null : objM5160constructorimpl);
        } else {

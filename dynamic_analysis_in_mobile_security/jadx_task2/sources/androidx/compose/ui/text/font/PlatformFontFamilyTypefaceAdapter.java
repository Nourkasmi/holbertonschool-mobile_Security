...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo4525createDefaultFO1MlWM;
        ...
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            typefaceMo4525createDefaultFO1MlWM = this.platformTypefaceResolver.mo4525createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4543getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo4525createDefaultFO1MlWM = this.platformTypefaceResolver.mo4526createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4543getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo4525createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo4626getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4543getFontStyle_LCdwA(), typefaceRequest.m4544getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo4525createDefaultFO1MlWM, false, 2, null);
    }
}

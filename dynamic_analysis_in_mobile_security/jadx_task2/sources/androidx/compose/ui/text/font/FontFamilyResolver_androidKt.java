...
public final class FontFamilyResolver_androidKt {
    ...
    public static final State<android.graphics.Typeface> m4476resolveAsTypefaceWqqsr6A(FontFamily.Resolver resolveAsTypeface, FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        ...
        State stateMo4475resolveDPcqOEQ = resolveAsTypeface.mo4475resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        Intrinsics.checkNotNull(stateMo4475resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return stateMo4475resolveDPcqOEQ;
    }
}

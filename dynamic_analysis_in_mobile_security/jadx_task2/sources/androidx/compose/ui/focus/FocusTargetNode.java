...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int iM4081constructorimpl = NodeKind.m4081constructorimpl(2048);
        int iM4081constructorimpl2 = NodeKind.m4081constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = iM4081constructorimpl | iM4081constructorimpl2;
            ...
            if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & iM4081constructorimpl2) != 0) {
                            break loop0;
                        }
                        if ((node2.getKindSet() & iM4081constructorimpl) != 0) {
    ...
    public final void m2336fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        ...
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2306boximpl(focusDirection));
    ...
    public final void m2337fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        ...
        try {
            FocusRequester focusRequesterInvoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2306boximpl(focusDirection));
            if (focusRequesterInvoke != FocusRequester.INSTANCE.getDefault()) {
                block.invoke(focusRequesterInvoke);
            }
        } finally {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int iM4081constructorimpl = NodeKind.m4081constructorimpl(4096);
        MutableVector mutableVector = null;
        while (node != 0) {
        ...
        FocusTargetNode focusTargetNode = this;
        int iM4081constructorimpl2 = NodeKind.m4081constructorimpl(4096) | NodeKind.m4081constructorimpl(1024);
        if (!focusTargetNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
        ...
        while (layoutNodeRequireLayoutNode != null) {
            if ((layoutNodeRequireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & iM4081constructorimpl2) != 0) {
                while (parent != null) {
                    if ((parent.getKindSet() & iM4081constructorimpl2) != 0 && (NodeKind.m4081constructorimpl(1024) & parent.getKindSet()) == 0 && parent.getIsAttached()) {
                        int iM4081constructorimpl3 = NodeKind.m4081constructorimpl(4096);
                        ...
                        while (nodePop != 0) {
                            ...
                            } else if ((nodePop.getKindSet() & iM4081constructorimpl3) != 0 && (nodePop instanceof DelegatingNode)) {
                                Modifier.Node delegate$ui_release2 = ((DelegatingNode) nodePop).getDelegate();
                                int i2 = 0;
                                nodePop = nodePop;
                                while (delegate$ui_release2 != null) {
                                    if ((delegate$ui_release2.getKindSet() & iM4081constructorimpl3) != 0) {
                                        i2++;
                                        if (i2 == 1) {

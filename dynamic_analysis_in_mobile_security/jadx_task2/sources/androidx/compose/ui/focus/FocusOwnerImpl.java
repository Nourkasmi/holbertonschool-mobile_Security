...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    public boolean mo2327moveFocus3ESFkO8(final int focusDirection) {
        ...
        FocusRequester focusRequesterM2342customFocusSearchOMvw8 = FocusTraversalKt.m2342customFocusSearchOMvw8(focusTargetNodeFindActiveFocusNode, focusDirection, getLayoutDirection());
        if (focusRequesterM2342customFocusSearchOMvw8 != FocusRequester.INSTANCE.getDefault()) {
            return focusRequesterM2342customFocusSearchOMvw8 != FocusRequester.INSTANCE.getCancel() && focusRequesterM2342customFocusSearchOMvw8.focus$ui_release();
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        boolean zM2343focusSearchsMXa3k8 = FocusTraversalKt.m2343focusSearchsMXa3k8(this.rootFocusNode, focusDirection, getLayoutDirection(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$foundNextItem$1
        ...
        return zM2343focusSearchsMXa3k8 || m2331wrapAroundFocus3ESFkO8(focusDirection);
    }
    ...
    public boolean mo2329dispatchKeyEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (nodeLastLocalKeyInputNode == null) {
            int iM4081constructorimpl = NodeKind.m4081constructorimpl(8192);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent = focusTargetNode.getNode().getParent();
                    ...
                    while (parent != null) {
                        if ((parent.getKindSet() & iM4081constructorimpl) != 0) {
                            ...
                            while (Pop != 0) {
                                ...
                                if ((Pop.getKindSet() & iM4081constructorimpl) != 0 && (Pop instanceof DelegatingNode)) {
        ...
        if (nodeLastLocalKeyInputNode != null) {
            ...
            int iM4081constructorimpl2 = NodeKind.m4081constructorimpl(8192);
                    ...
                    while (parent2 != null) {
                        if ((parent2.getKindSet() & iM4081constructorimpl2) != 0) {
                            ...
                            while (nodePop != null) {
                                ...
                                } else if ((nodePop.getKindSet() & iM4081constructorimpl2) != 0 && (nodePop instanceof DelegatingNode)) {
                                    int i2 = 0;
            ...
            while (node2 != 0) {
                if (node2 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node2).mo143onPreKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
            ...
            while (node3 != 0) {
                if (node3 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node3).mo141onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node3.getKindSet() & iM4081constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
    ...
    public boolean mo2328dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (focusTargetNodeFindActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = focusTargetNodeFindActiveFocusNode;
            int iM4081constructorimpl = NodeKind.m4081constructorimpl(131072);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent = focusTargetNode.getNode().getParent();
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            ...
            int iM4081constructorimpl2 = NodeKind.m4081constructorimpl(131072);
            ...
            while (node != 0) {
                if (node instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node).mo3303onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node.getKindSet() & iM4081constructorimpl2) != 0 && (node instanceof DelegatingNode)) {
            ...
            while (node2 != 0) {
                if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node2).mo3302onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node2.getKindSet() & iM4081constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent event) {
        ...
        if (focusTargetNodeFindActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = focusTargetNodeFindActiveFocusNode;
            int iM4081constructorimpl = NodeKind.m4081constructorimpl(16384);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent = focusTargetNode.getNode().getParent();
        ...
        if (rotaryInputModifierNode != null) {
            ...
            int iM4081constructorimpl2 = NodeKind.m4081constructorimpl(16384);
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int iM4081constructorimpl = NodeKind.m4081constructorimpl(1024) | NodeKind.m4081constructorimpl(8192);
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitLocalDescendants called on an unattached node".toString());
        }
        Modifier.Node node = delegatableNode.getNode();
        Modifier.Node node2 = null;
        if ((node.getAggregateChildKindSet() & iM4081constructorimpl) != 0) {

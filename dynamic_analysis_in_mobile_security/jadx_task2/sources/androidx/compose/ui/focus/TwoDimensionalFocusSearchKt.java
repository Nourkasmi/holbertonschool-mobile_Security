...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m2355twoDimensionalFocusSearchOMvw8(FocusTargetNode twoDimensionalFocusSearch, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        if (i3 == 1) {
            Boolean boolM2355twoDimensionalFocusSearchOMvw8 = m2355twoDimensionalFocusSearchOMvw8(activeChild, i, onFound);
            return !Intrinsics.areEqual((Object) boolM2355twoDimensionalFocusSearchOMvw8, (Object) false) ? boolM2355twoDimensionalFocusSearchOMvw8 : Boolean.valueOf(m2352generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(activeChild), i, onFound));
        }
        if (i3 == 2 || i3 == 3) {
    ...
    private static final boolean m2352generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2305searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                ...
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m2354searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1));
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m2353isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    public static final boolean m2351findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode findChildCorrespondingToFocusEnter, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        FocusTargetNode focusTargetNodeM2350findBestCandidate4WY_MpI = m2350findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM2350findBestCandidate4WY_MpI != null) {
            return onFound.invoke(focusTargetNodeM2350findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m2354searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM2350findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector.isNotEmpty() && (focusTargetNodeM2350findBestCandidate4WY_MpI = m2350findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetNode2), i)) != null) {
            if (focusTargetNodeM2350findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetNodeM2350findBestCandidate4WY_MpI).booleanValue();
            }
            if (m2352generateAndSearchChildren4C6V_qg(focusTargetNodeM2350findBestCandidate4WY_MpI, focusTargetNode2, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM2350findBestCandidate4WY_MpI);
        }
        return false;
    }

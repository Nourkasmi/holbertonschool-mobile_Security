...
public final class MeasureAndLayoutDelegate {
    ...
    private final boolean m4035doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM4004lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM4004lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4008lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM4004lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4004lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM4004lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM4004lookaheadRemeasure_Sx5XlM$ui_release$default;
    }
    ...
    private final boolean m4036doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM4005remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM4005remeasure_Sx5XlM$ui_release$default = layoutNode.m4009remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM4005remeasure_Sx5XlM$ui_release$default = LayoutNode.m4005remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM4005remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM4005remeasure_Sx5XlM$ui_release$default;
    }
        ...
        if (!this.duringMeasureLayout) {
            if (this.rootConstraints != null) {
                ...
                try {
                    ...
                    boolean zM4035doLookaheadRemeasuresdFAvZA = m4035doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4817boximpl(constraints));
                    m4036doRemeasuresdFAvZA(layoutNode, Constraints.m4817boximpl(constraints));
                    if ((zM4035doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        boolean zM4035doLookaheadRemeasuresdFAvZA;
        boolean zM4036doRemeasuresdFAvZA;
        int i = 0;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            zM4035doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) ? m4035doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            zM4036doRemeasuresdFAvZA = m4036doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            zM4036doRemeasuresdFAvZA = false;
            zM4035doLookaheadRemeasuresdFAvZA = false;
        }
        if ((zM4035doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && affectsLookahead) {
            layoutNode.lookaheadReplace$ui_release();
        }
        if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
            if (layoutNode == this.root) {
        ...
        return zM4036doRemeasuresdFAvZA;
    }

...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void drawContent() {
        ...
        if (nodeNextDrawNode == 0) {
            NodeCoordinator nodeCoordinatorM3979requireCoordinator64DMado = DelegatableNodeKt.m3979requireCoordinator64DMado(drawModifierNode2, NodeKind.m4081constructorimpl(4));
            if (nodeCoordinatorM3979requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                nodeCoordinatorM3979requireCoordinator64DMado = nodeCoordinatorM3979requireCoordinator64DMado.getWrapped();
                Intrinsics.checkNotNull(nodeCoordinatorM3979requireCoordinator64DMado);
            }
            nodeCoordinatorM3979requireCoordinator64DMado.performDraw(canvas);
            return;
        }
        ...
        while (nodeNextDrawNode != 0) {
            ...
            } else if ((nodeNextDrawNode.getKindSet() & iM4081constructorimpl) != 0 && (nodeNextDrawNode instanceof DelegatingNode)) {
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas) {
        ...
        NodeCoordinator nodeCoordinatorM3979requireCoordinator64DMado = DelegatableNodeKt.m3979requireCoordinator64DMado(drawModifierNode, NodeKind.m4081constructorimpl(4));
        nodeCoordinatorM3979requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m4017drawDirectx_KDEd0$ui_release(canvas, IntSizeKt.m5043toSizeozmzZPI(nodeCoordinatorM3979requireCoordinator64DMado.mo3873getSizeYbymL2g()), nodeCoordinatorM3979requireCoordinator64DMado, drawModifierNode);
    }
    ...
    public final void m4017drawDirectx_KDEd0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode) {
        ...
        long jM3093component4NHjbRc = drawParams.getSize();
        ...
        drawParams3.m3096setSizeuvyYCjk(jM3093component4NHjbRc);
    ...
    public final void m4016drawx_KDEd0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode) {
        ...
        while (drawNode != null) {
            if (drawNode instanceof DrawModifierNode) {
                m4017drawDirectx_KDEd0$ui_release(canvas, size, coordinator, (DrawModifierNode) drawNode);
            } else if ((drawNode.getKindSet() & iM4081constructorimpl) != 0 && (drawNode instanceof DelegatingNode)) {
                int i = 0;

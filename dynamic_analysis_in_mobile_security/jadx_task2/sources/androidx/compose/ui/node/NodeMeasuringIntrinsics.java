    ...
    private static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public Placeable mo3866measureBRTryo0(long constraints) {
            ...
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                ...
                return new EmptyPlaceable(iMinIntrinsicWidth, Constraints.m4828getMaxHeightimpl(constraints));
            }
            if (this.minMax == IntrinsicMinMax.Max) {
            ...
            return new EmptyPlaceable(Constraints.m4829getMaxWidthimpl(constraints), iMinIntrinsicHeight);
        }

...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    public final void attach$ui_release(Owner owner) {
        ...
        if (layoutNode2 != null) {
            if (!Intrinsics.areEqual(layoutNode2 != null ? layoutNode2.owner : null, owner)) {
                ...
                throw new IllegalStateException(sbAppend2.append(layoutNode3 != null ? debugTreeToString$default(layoutNode3, 0, 1, null) : null).toString().toString());
            }
        }
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM4065getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m4065getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m4827getHasFixedWidthimpl(jM4065getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m4826getHasFixedHeightimpl(jM4065getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public void setDensity(Density value) {
        ...
        if ((nodeChain.getAggregateChildKindSet() & iM4081constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4081constructorimpl) != 0) {
                ...
                if ((head.getAggregateChildKindSet() & iM4081constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        NodeChain nodeChain = this.nodes;
        int iM4081constructorimpl = NodeKind.m4081constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & iM4081constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4081constructorimpl) != 0) {
                    Modifier.Node nodePop = head;
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int iM4081constructorimpl = NodeKind.m4081constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & iM4081constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4081constructorimpl) != 0) {
                    Modifier.Node nodePop = head;
                ...
                if ((head.getKindSet() & iM4081constructorimpl) != 0) {
                    ...
                    while (nodePop != 0) {
                        if (nodePop instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m3979requireCoordinator64DMado((LayoutModifierNode) nodePop, NodeKind.m4081constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((nodePop.getKindSet() & iM4081constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints constraintsM4022getLastConstraintsDWUhwKw = this.layoutDelegate.m4022getLastConstraintsDWUhwKw();
        if (constraintsM4022getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4136measureAndLayout0kLqBqw(this, constraintsM4022getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node nodeHeadNode = innerCoordinator$ui_release.headNode(zM4090getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM4081constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int iM4081constructorimpl = NodeKind.m4081constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                if ((nodes.getAggregateChildKindSet() & iM4081constructorimpl) != 0) {
                    for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                        if ((tail.getKindSet() & iM4081constructorimpl) != 0) {

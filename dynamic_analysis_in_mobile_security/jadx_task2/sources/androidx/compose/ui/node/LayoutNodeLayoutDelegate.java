...
public final class LayoutNodeLayoutDelegate {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public final boolean m4029remeasureBRTryo0(long constraints) {
            ...
            this.measuredOnce = true;
            long jMo3873getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3873getSizeYbymL2g();
            m3922setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m4021performMeasureBRTryo0(constraints);
            if (IntSize.m5031equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3873getSizeYbymL2g(), jMo3873getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public final boolean m4026remeasureBRTryo0(long constraints) {
            ...
            return (IntSize.m5033getWidthimpl(jIntSize) == lookaheadDelegate.getWidth() && IntSize.m5032getHeightimpl(jIntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
    ...
    public final void m4021performMeasureBRTryo0(final long constraints) {
        ...
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                this.this$0.getOuterCoordinator().mo3866measureBRTryo0(constraints);
            }
        });

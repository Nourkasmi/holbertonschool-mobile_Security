...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long jM3999findBestHitDistanceptXAw2c = m3999findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m3994getDistanceimpl(jM3999findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m3996isInLayerimpl(jM3999findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndInLayer.m3990compareToS_HNhKs(m3999findBestHitDistanceptXAw2c(), HitTestResultKt.DistanceAndInLayer(distanceFromEdge, isInLayer)) > 0;
    }
    ...
    private final long m3999findBestHitDistanceptXAw2c() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long jM3991constructorimpl = DistanceAndInLayer.m3991constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m3990compareToS_HNhKs(jM3991constructorimpl, jDistanceAndInLayer) < 0) {
                    jDistanceAndInLayer = jM3991constructorimpl;
                }
                if (DistanceAndInLayer.m3994getDistanceimpl(jDistanceAndInLayer) < 0.0f && DistanceAndInLayer.m3996isInLayerimpl(jDistanceAndInLayer)) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(node, distanceFromEdge, isInLayer, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndInLayer.m3990compareToS_HNhKs(jM3999findBestHitDistanceptXAw2c, m3999findBestHitDistanceptXAw2c()) > 0) {

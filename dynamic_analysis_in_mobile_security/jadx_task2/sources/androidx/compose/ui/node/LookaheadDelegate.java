...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public final long m4033positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        ...
        long jM5001getZeronOccac = IntOffset.INSTANCE.m5001getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            long position = lookaheadDelegate.getPosition();
            jM5001getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jM5001getZeronOccac) + IntOffset.m4991getXimpl(position), IntOffset.m4992getYimpl(jM5001getZeronOccac) + IntOffset.m4992getYimpl(position));

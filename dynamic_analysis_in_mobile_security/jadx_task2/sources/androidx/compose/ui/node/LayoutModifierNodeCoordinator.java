...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo3866measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m3922setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo237measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    /* JADX INFO: renamed from: measure-BRTryo0 */
    public Placeable mo3866measureBRTryo0(long constraints) {
        MeasureResult measureResultMo237measure3p2s80s;
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            measureResultMo237measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m3868intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, jIntSize, constraints2.getValue());
        } else {
            measureResultMo237measure3p2s80s = layoutModifierNode.mo237measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(measureResultMo237measure3p2s80s);
    ...
    protected void mo3867placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int iM5033getWidthimpl = IntSize.m5033getWidthimpl(getMeasuredSize());
        ...
        Placeable.PlacementScope.parentWidth = iM5033getWidthimpl;

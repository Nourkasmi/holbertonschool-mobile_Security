...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((((iHashCode + r1) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.hashCode(this.alpha)) * 31;
    ...
    public void update(PainterNode node) {
        ...
        boolean z = this.sizeToIntrinsics;
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m2455equalsimpl0(node.getPainter().mo3241getIntrinsicSizeNHjbRc(), this.painter.mo3241getIntrinsicSizeNHjbRc()));

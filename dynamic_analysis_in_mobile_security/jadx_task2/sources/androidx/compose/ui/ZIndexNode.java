...
public final class ZIndexNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.ZIndexNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                layout.place(placeableMo3866measureBRTryo0, 0, 0, this.getZIndex());
            }
        }, 4, null);
    }

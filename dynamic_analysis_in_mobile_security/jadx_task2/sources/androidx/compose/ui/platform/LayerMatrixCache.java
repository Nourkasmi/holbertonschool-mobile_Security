...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4198calculateMatrixGrdbGEg(T target) {
        float[] fArrM2854constructorimpl$default = this.matrixCache;
        if (fArrM2854constructorimpl$default == null) {
            fArrM2854constructorimpl$default = androidx.compose.ui.graphics.Matrix.m2854constructorimpl$default(null, 1, null);
            this.matrixCache = fArrM2854constructorimpl$default;
        }
        if (!this.isDirty) {
            return fArrM2854constructorimpl$default;
        }
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m2502setFromtUYjHk(fArrM2854constructorimpl$default, matrix);
    ...
    public final float[] m4197calculateInverseMatrixbWbORWo(T target) {
        float[] fArrM2854constructorimpl$default = this.inverseMatrixCache;
        if (fArrM2854constructorimpl$default == null) {
            fArrM2854constructorimpl$default = androidx.compose.ui.graphics.Matrix.m2854constructorimpl$default(null, 1, null);
            this.inverseMatrixCache = fArrM2854constructorimpl$default;
        }
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4195invertToJiSxe2E(m4198calculateMatrixGrdbGEg(target), fArrM2854constructorimpl$default);

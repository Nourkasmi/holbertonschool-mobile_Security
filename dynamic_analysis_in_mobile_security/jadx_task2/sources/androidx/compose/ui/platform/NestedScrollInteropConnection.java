...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo334onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m4216getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m4218toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2390getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2391getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m4218toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m4217toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo333onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m4216getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m4218toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2390getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2391getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2390getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2391getYimpl(available)), null, NestedScrollInteropConnectionKt.m4218toViewTypeGyEprt8(source), this.consumedScrollCache);
            return NestedScrollInteropConnectionKt.m4217toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
        return Offset.INSTANCE.m2406getZeroF1C5BW0();
    }
    ...
    public Object mo557onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5098getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5099getYimpl(j)))) {
    ...
    public Object mo332onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5098getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5099getYimpl(j2)), true)) {

...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public final Boolean m4161invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection focusDirectionMo4135getFocusDirectionP8AzH3I = this.this$0.mo4135getFocusDirectionP8AzH3I(it);
                if (focusDirectionMo4135getFocusDirectionP8AzH3I == null || !KeyEventType.m3608equalsimpl0(KeyEvent_androidKt.m3616getTypeZmokQxo(it), KeyEventType.INSTANCE.m3612getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(this.this$0.getFocusOwner().mo2327moveFocus3ESFkO8(focusDirectionMo4135getFocusDirectionP8AzH3I.getValue()));
            }
        });
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m3298getTouchaOaMEAU() : InputMode.INSTANCE.m3297getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            ...
            public final Boolean m4160invokeiuPiT84(int i) {
                ...
                if (InputMode.m3293equalsimpl0(i, InputMode.INSTANCE.m3298getTouchaOaMEAU())) {
                    ...
                    zRequestFocusFromTouch = InputMode.m3293equalsimpl0(i, InputMode.INSTANCE.m3297getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false;
                }
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int iM4983component1impl = IntOffset.m4983component1impl(j);
        int iM4984component2impl = IntOffset.m4984component2impl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (iM4983component1impl != i || iM4984component2impl != iArr[1]) {
            this.globalPosition = IntOffsetKt.IntOffset(i, iArr[1]);
            if (iM4983component1impl != Integer.MAX_VALUE && iM4984component2impl != Integer.MAX_VALUE) {
    ...
    public FocusDirection mo4135getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long jM3615getKeyZmokQxo = KeyEvent_androidKt.m3615getKeyZmokQxo(keyEvent);
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3543getTabEK5gGoQ())) {
        ...
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3384getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2325getRightdhqQ8s());
        }
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3383getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2321getLeftdhqQ8s());
        }
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3385getDirectionUpEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2326getUpdhqQ8s());
        }
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3380getDirectionDownEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2317getDowndhqQ8s());
        }
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3379getDirectionCenterEK5gGoQ()) || Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3393getEnterEK5gGoQ()) || Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3485getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2306boximpl(FocusDirection.INSTANCE.m2318getEnterdhqQ8s());
        }
        if (Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3322getBackEK5gGoQ()) || Key.m3307equalsimpl0(jM3615getKeyZmokQxo, Key.INSTANCE.m3396getEscapeEK5gGoQ())) {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int iM4157handleMotionEvent8iAsVTc = m4157handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m3834getAnyMovementConsumedimpl(iM4157handleMotionEvent8iAsVTc)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m3835getDispatchedToAPointerInputModifierimpl(iM4157handleMotionEvent8iAsVTc);
    }
    ...
    private final int m4159sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        if (pointerInputEventConvertToPointerInputEvent$ui_release != null) {
            ...
            int iM3767processBIzXfog = this.pointerInputEventProcessor.m3767processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked != 0 && actionMasked != 5) || ProcessResult.m3835getDispatchedToAPointerInputModifierimpl(iM3767processBIzXfog)) {
                return iM3767processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long jMo3828localToScreenMKHz9U = mo3828localToScreenMKHz9U(OffsetKt.Offset(pointerCoords.x, pointerCoords.y));
            pointerCoords.x = Offset.m2390getXimpl(jMo3828localToScreenMKHz9U);
            pointerCoords.y = Offset.m2391getYimpl(jMo3828localToScreenMKHz9U);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m3767processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, androidComposeView, true);
        event.recycle();
    }
    ...
    public long mo3828localToScreenMKHz9U(long localPosition) {
        ...
        long jM2860mapMKHz9U = Matrix.m2860mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m2390getXimpl(jM2860mapMKHz9U) + Offset.m2390getXimpl(this.windowPosition), Offset.m2391getYimpl(jM2860mapMKHz9U) + Offset.m2391getYimpl(this.windowPosition));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long jM2860mapMKHz9U = Matrix.m2860mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m2390getXimpl(jM2860mapMKHz9U), motionEvent.getRawY() - Offset.m2391getYimpl(jM2860mapMKHz9U));
    }
    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long jM4156convertMeasureSpecI7RO_PI = m4156convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int iM5335constructorimpl = (int) ULong.m5335constructorimpl(jM4156convertMeasureSpecI7RO_PI >>> 32);
            int iM5335constructorimpl2 = (int) ULong.m5335constructorimpl(jM4156convertMeasureSpecI7RO_PI & 4294967295L);
            long jM4156convertMeasureSpecI7RO_PI2 = m4156convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long jConstraints = ConstraintsKt.Constraints(iM5335constructorimpl, iM5335constructorimpl2, (int) ULong.m5335constructorimpl(jM4156convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m5335constructorimpl(4294967295L & jM4156convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m4817boximpl(jConstraints);
                this.wasMeasuredWithMultipleConstraints = false;
            } else if (constraints == null || !Constraints.m4822equalsimpl0(constraints.getValue(), jConstraints)) {
                this.wasMeasuredWithMultipleConstraints = true;
            }
            this.measureAndLayoutDelegate.m4038updateRootConstraintsBRTryo0(jConstraints);

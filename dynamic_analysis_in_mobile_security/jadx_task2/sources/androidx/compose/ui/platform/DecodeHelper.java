...
public final class DecodeHelper {
    ...
    public final long m4181decodeTextUnitXSAIIZE() {
        long jM5088getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM5088getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5087getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM5088getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5086getEmUIouoOA();
        } else {
            jM5088getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5088getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5082equalsimpl0(jM5088getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m5088getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m5065getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5066TextUnitanM5pPY(decodeFloat(), jM5088getUnspecifiedUIouoOA);
    }

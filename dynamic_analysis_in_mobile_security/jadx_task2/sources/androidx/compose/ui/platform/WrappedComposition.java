                    ...
                    original.setContent(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition.setContent.1.1
                        ...
                        public final void invoke(Composer composer, int i) {
                            ...
                            if ((i & 11) != 2 || !composer.getSkipping()) {
                                ...
                                EffectsKt.LaunchedEffect(wrappedComposition.getOwner(), new C00821(wrappedComposition, null), composer, 72);
                        ...
                        static final class C00821 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            C00821(WrappedComposition wrappedComposition, Continuation<? super C00821> continuation) {

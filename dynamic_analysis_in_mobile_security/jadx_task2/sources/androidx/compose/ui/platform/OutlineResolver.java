...
public final class OutlineResolver {
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (this.outlineNeeded && Size.m2459getWidthimpl(j) > 0.0f && Size.m2456getHeightimpl(this.size) > 0.0f) {
                this.isSupportedOutline = true;
                androidx.compose.ui.graphics.Outline outlineMo208createOutlinePq9zytI = this.shape.mo208createOutlinePq9zytI(this.size, this.layoutDirection, this.density);
                this.calculatedOutline = outlineMo208createOutlinePq9zytI;
                if (outlineMo208createOutlinePq9zytI instanceof Outline.Rectangle) {
                    updateCacheWithRect(((Outline.Rectangle) outlineMo208createOutlinePq9zytI).getRect());
                    return;
                } else if (outlineMo208createOutlinePq9zytI instanceof Outline.Rounded) {
                    updateCacheWithRoundRect(((Outline.Rounded) outlineMo208createOutlinePq9zytI).getRoundRect());
                    return;
                } else {
                    if (outlineMo208createOutlinePq9zytI instanceof Outline.Generic) {
                        updateCacheWithPath(((Outline.Generic) outlineMo208createOutlinePq9zytI).getPath());
                        return;
                    }
                    return;
                }
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float fM2365getXimpl = CornerRadius.m2365getXimpl(roundRect.m2440getTopLeftCornerRadiuskKHJgLs());
        ...
        if (RoundRectKt.isSimple(roundRect)) {
            this.cachedOutline.setRoundRect(MathKt.roundToInt(roundRect.getLeft()), MathKt.roundToInt(roundRect.getTop()), MathKt.roundToInt(roundRect.getRight()), MathKt.roundToInt(roundRect.getBottom()), fM2365getXimpl);
            this.roundedCornerRadius = fM2365getXimpl;
            return;
        }

...
public final class PointerEventKt {
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long jM2394minusMKHz9U = Offset.m2394minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? jM2394minusMKHz9U : Offset.INSTANCE.m2406getZeroF1C5BW0();
    }
    ...
    public static final boolean m3693isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long j) {
        ...
        long jM3748getPositionF1C5BW0 = isOutOfBounds.getPosition();
        float fM2390getXimpl = Offset.m2390getXimpl(jM3748getPositionF1C5BW0);
        float fM2391getYimpl = Offset.m2391getYimpl(jM3748getPositionF1C5BW0);
        return fM2390getXimpl < 0.0f || fM2390getXimpl > ((float) IntSize.m5033getWidthimpl(j)) || fM2391getYimpl < 0.0f || fM2391getYimpl > ((float) IntSize.m5032getHeightimpl(j));
    }
    ...
    public static final boolean m3694isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long j, long j2) {
        ...
        float fM2390getXimpl = Offset.m2390getXimpl(jM3748getPositionF1C5BW0);
        float fM2391getYimpl = Offset.m2391getYimpl(jM3748getPositionF1C5BW0);
        return fM2390getXimpl < (-Size.m2459getWidthimpl(j2)) || fM2390getXimpl > ((float) IntSize.m5033getWidthimpl(j)) + Size.m2459getWidthimpl(j2) || fM2391getYimpl < (-Size.m2456getHeightimpl(j2)) || fM2391getYimpl > ((float) IntSize.m5032getHeightimpl(j)) + Size.m2456getHeightimpl(j2);
    }
}

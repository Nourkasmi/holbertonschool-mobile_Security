...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long jMo3829screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (pointerInputData == null) {
                ...
                jMo3829screenToLocalMKHz9U = pointerInputEventData.m3762getPositionF1C5BW0();
                down = false;
            } else {
                long uptime2 = pointerInputData.getUptime();
                uptime = uptime2;
                down = pointerInputData.getDown();
                jMo3829screenToLocalMKHz9U = positionCalculator.mo3829screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            linkedHashMap.put(PointerId.m3728boximpl(pointerInputEventData.m3761getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3761getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3762getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, jMo3829screenToLocalMKHz9U, down, false, pointerInputEventData.m3765getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3764getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));

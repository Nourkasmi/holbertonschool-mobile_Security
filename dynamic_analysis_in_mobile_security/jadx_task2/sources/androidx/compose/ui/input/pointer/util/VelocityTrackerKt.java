...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange event) {
        ...
        while (i < size) {
            ...
            long jM2394minusMKHz9U = Offset.m2394minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m3842setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2395plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), jM2394minusMKHz9U));
    ...
    public static final float[] polyFitLeastSquares(float[] x, float[] y, int i, int i2, float[] coefficients) {
        ...
        while (i10 < i4) {
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                float fDot = dot(fArr4, fArr6);
                for (int i13 = 0; i13 < i; i13++) {
                    fArr4[i13] = fArr4[i13] - (fArr6[i13] * fDot);
                }
            }
            float fSqrt = (float) Math.sqrt(dot(fArr4, fArr4));
            if (fSqrt < 1.0E-6f) {

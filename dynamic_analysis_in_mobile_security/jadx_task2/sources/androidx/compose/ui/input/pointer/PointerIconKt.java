    ...
    public static final Modifier pointerHoverIcon(Modifier modifier, final PointerIcon icon, final boolean z) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerIconKt$pointerHoverIcon$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                final PointerIconService pointerIconService = (PointerIconService) objConsume;
                if (pointerIconService == null) {
                    ...
                    if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.ui.input.pointer.PointerIconKt$pointerHoverIcon$2$1$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    ...
                    if (pointerIconModifierLocal.shouldUpdatePointerIcon()) {
                        ...
                        if (zChanged2 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue3 = (Function2) new PointerIconKt$pointerHoverIcon$2$pointerInputModifier$1$1(pointerIconModifierLocal, null);
                            composer.updateRememberedValue(objRememberedValue3);
                        }
                        composer.endReplaceableGroup();
                        companionPointerInput = SuspendingPointerInputFilterKt.pointerInput(composed, pointerIconModifierLocal, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue3);
                    } else {
                        companionPointerInput = Modifier.INSTANCE;
                    }
                    companionThen = pointerIconModifierLocal.then(companionPointerInput);
                }
                if (ComposerKt.isTraceInProgress()) {

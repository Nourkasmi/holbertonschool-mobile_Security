...
public final /* data */ class PointerInputEventData {
    ...
    public int hashCode() {
        int iM3732hashCodeimpl = ((((((PointerId.m3732hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m2392hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2392hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        }
        int iHashCode = (((((iM3732hashCodeimpl + r1) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m3820hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((iHashCode + (z2 ? 1 : z2)) * 31) + this.historical.hashCode()) * 31) + Offset.m2392hashCodeimpl(this.scrollDelta);
    }

...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2280alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        long jIntSize = IntSizeKt.IntSize(IntSize.m5033getWidthimpl(space) - IntSize.m5033getWidthimpl(size), IntSize.m5032getHeightimpl(space) - IntSize.m5032getHeightimpl(size));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5033getWidthimpl(jIntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5032getHeightimpl(jIntSize) / 2.0f) * (f + this.verticalBias)));
    }

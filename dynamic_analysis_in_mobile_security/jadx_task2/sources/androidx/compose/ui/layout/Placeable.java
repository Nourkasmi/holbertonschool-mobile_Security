...
public abstract class Placeable implements Measured {
    ...
    protected final void m3921setMeasuredSizeozmzZPI(long j) {
    ...
    public static abstract class PlacementScope {
        ...
        public final void placeRelative(Placeable placeable, int i, int i2, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(jIntOffset) + IntOffset.m4992getYimpl(j)), f, null);
            } else {
                long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m4991getXimpl(jIntOffset), IntOffset.m4992getYimpl(jIntOffset));
                long j2 = placeable.apparentToRealOffset;
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset2) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(jIntOffset2) + IntOffset.m4992getYimpl(j2)), f, null);
            }
        }
        ...
        public final void placeRelativeWithLayer(Placeable placeable, int i, int i2, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j = placeable.apparentToRealOffset;
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset) + IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(jIntOffset) + IntOffset.m4992getYimpl(j)), f, layerBlock);
            } else {
                long jIntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m4991getXimpl(jIntOffset), IntOffset.m4992getYimpl(jIntOffset));
                long j2 = placeable.apparentToRealOffset;
                placeable.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset2) + IntOffset.m4991getXimpl(j2), IntOffset.m4992getYimpl(jIntOffset2) + IntOffset.m4992getYimpl(j2)), f, layerBlock);
            }
        }
        ...
        public final void m3929placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j));
                long j3 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset) + IntOffset.m4991getXimpl(j3), IntOffset.m4992getYimpl(jIntOffset) + IntOffset.m4992getYimpl(j3)), f, function1);
            }
        }
        ...
        public final void m3930placeRelative70tqf50(Placeable placeRelative, long j, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j));
                long j3 = placeRelative.apparentToRealOffset;
                placeRelative.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset) + IntOffset.m4991getXimpl(j3), IntOffset.m4992getYimpl(jIntOffset) + IntOffset.m4992getYimpl(j3)), f, null);
            }
        }
        ...
        public final void m3931placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                long jIntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m4991getXimpl(j), IntOffset.m4992getYimpl(j));
                long j3 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3867placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m4991getXimpl(jIntOffset) + IntOffset.m4991getXimpl(j3), IntOffset.m4992getYimpl(jIntOffset) + IntOffset.m4992getYimpl(j3)), f, layerBlock);
            }
        }

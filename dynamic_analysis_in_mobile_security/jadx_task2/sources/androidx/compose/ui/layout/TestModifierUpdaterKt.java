...
public final class TestModifierUpdaterKt {
    ...
    public static final void TestModifierUpdaterLayout(final Function1<? super TestModifierUpdater, Unit> onAttached, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TestModifierUpdaterLayout)49@1728L23,53@1883L330:TestModifierUpdater.kt#80mrfh");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m2270setimpl(composerM2263constructorimpl, testModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            Updater.m2267initimpl(composerM2263constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$1$1

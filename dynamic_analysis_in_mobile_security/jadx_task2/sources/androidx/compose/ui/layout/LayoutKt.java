...
public final class LayoutKt {
    public static final void Layout(Function2<? super Composer, ? super Integer, Unit> content, Modifier modifier, MeasurePolicy measurePolicy, Composer composer, int i, int i2) {
        ...
        function3ModifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer)), composer, Integer.valueOf((i3 >> 3) & 112));
    ...
    public static final void Layout(List<? extends Function2<? super Composer, ? super Integer, Unit>> contents, Modifier modifier, MultiContentMeasurePolicy measurePolicy, Composer composer, int i, int i2) {
        ...
        Composer composerM2263constructorimpl = Updater.m2263constructorimpl(composer);
        Updater.m2270setimpl(composerM2263constructorimpl, measurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m2270setimpl(composerM2263constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
        if (composerM2263constructorimpl.getInserting() || !Intrinsics.areEqual(composerM2263constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            composerM2263constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
        ...
        composer.startReplaceableGroup(2058660585);
        function2CombineAsVirtualLayouts.invoke(composer, Integer.valueOf((i4 >> 9) & 14));
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
    ...
    public static final Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf(final Modifier modifier) {
        ...
        return ComposableLambdaKt.composableLambdaInstance(-55743822, true, new Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt$materializerOfWithCompositionLocalInjection$1
            ...
            public final void m3881invokeDeg8D_g(Composer composer, Composer composer2, int i) {
                ...
                composer.startReplaceableGroup(509942095);
                Composer composerM2263constructorimpl = Updater.m2263constructorimpl(composer);
                Updater.m2270setimpl(composerM2263constructorimpl, modifierMaterializeWithCompositionLocalInjectionInternal, ComposeUiNode.INSTANCE.getSetModifier());
                Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
                if (composerM2263constructorimpl.getInserting() || !Intrinsics.areEqual(composerM2263constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                    composerM2263constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                    composerM2263constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash);
    ...
    public static final void MultiMeasureLayout(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> content, final MeasurePolicy measurePolicy, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(MultiMeasureLayout)P(2)246@9516L23,250@9668L491:Layout.kt#80mrfh");
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
        ...
        if ((i3 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m2270setimpl(composerM2263constructorimpl, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2270setimpl(composerM2263constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
            Updater.m2267initimpl(composerM2263constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LayoutKt$MultiMeasureLayout$1$1

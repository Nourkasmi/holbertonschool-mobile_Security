        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                if ((LayoutNodeSubcompositionsState.this.root.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring || LayoutNodeSubcompositionsState.this.root.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) && LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() != null) {
                    return LayoutNodeSubcompositionsState.this.getIntermediateMeasurePolicy$ui_release().invoke(LayoutNodeSubcompositionsState.this.intermediateMeasureScope, Constraints.m4817boximpl(j));
                }
                LayoutNodeSubcompositionsState.this.currentIndex = 0;
                LayoutNodeSubcompositionsState.this.intermediateMeasureScope.m3884setLookaheadConstraintsBRTryo0(j);
                final MeasureResult measureResultInvoke = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m4817boximpl(j));
                final int i = LayoutNodeSubcompositionsState.this.currentIndex;
                LayoutNodeSubcompositionsState.this.intermediateMeasureScope.m3885setLookaheadSizeozmzZPI(IntSizeKt.IntSize(measureResultInvoke.getWidth(), measureResultInvoke.getHeight()));
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precompose.1
            ...
            public void mo3887premeasure0kLqBqw(int index, long constraints) {
                ...
                if (!layoutNode.isPlaced()) {
                    ...
                    layoutNode2.ignoreRemeasureRequests = true;
                    LayoutNodeKt.requireOwner(layoutNode).mo4136measureAndLayout0kLqBqw(layoutNode.getChildren$ui_release().get(index), constraints);
                    layoutNode2.ignoreRemeasureRequests = false;
                    return;
                }

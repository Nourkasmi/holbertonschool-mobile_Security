...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadLayout(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, final Modifier modifier, final MeasurePolicy measurePolicy, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(LookaheadLayout)P(!1,2)51@1893L160:LookaheadScope.kt#80mrfh");
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
            ...
            LookaheadScope(ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1705879204, true, new Function3<LookaheadScope, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadLayout.1
                ...
                public final void invoke(LookaheadScope LookaheadScope, Composer composer2, int i5) {
                    ...
                    if ((i5 & 91) != 18 || !composer2.getSkipping()) {
                        ...
                        function3ModifierMaterializerOf.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer2)), composer2, Integer.valueOf((i7 >> 3) & 112));
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            C04271 c04271 = new Function0<LayoutNode>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadScope.1
            ...
            if (composerStartRestartGroup.getInserting()) {
                composerStartRestartGroup.createNode(c04271);
            } else {
                composerStartRestartGroup.useNode();
            }
            Composer composerM2263constructorimpl = Updater.m2263constructorimpl(composerStartRestartGroup);
            Updater.m2267initimpl(composerM2263constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m2270setimpl(composerM2263constructorimpl, lookaheadScopeImpl, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2

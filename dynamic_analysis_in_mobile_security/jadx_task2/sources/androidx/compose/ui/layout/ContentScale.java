    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3863computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3863computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3863computeFillMaxDimensioniLBOSCw, fM3863computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3864computeFillMinDimensioniLBOSCw = ContentScaleKt.m3864computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3864computeFillMinDimensioniLBOSCw, fM3864computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3862computeFillHeightiLBOSCw = ContentScaleKt.m3862computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3862computeFillHeightiLBOSCw, fM3862computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3865computeFillWidthiLBOSCw = ContentScaleKt.m3865computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3865computeFillWidthiLBOSCw, fM3865computeFillWidthiLBOSCw);
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3857computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3865computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m3862computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };

...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (lookaheadRoot != null && lookaheadRoot.getIsVirtualLookaheadRoot()) {
            ...
            int iM4081constructorimpl = NodeKind.m4081constructorimpl(512);
    ...
    public MeasureResult mo237measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            public final MeasureResult mo3871measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long j) {
                ...
                return this.this$0.getMeasureBlock$ui_release().invoke(this.this$0.intermediateMeasureScope, intrinsicMeasurable, Constraints.m4817boximpl(j));
            }
    ...
    private final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo3866measureBRTryo0(long constraints) {
            ...
            if (!this.this$0.getIsIntermediateChangeActive()) {
                ...
                placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(constraints2.getValue());
                ...
                if (!intermediateLayoutModifierNode.getIsIntermediateChangeActive()) {
                    ...
                    lookaheadSize = IntSizeKt.IntSize(placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight());
                }
                m3921setMeasuredSizeozmzZPI(lookaheadSize);
            } else {
                placeableMo3866measureBRTryo0 = this.wrappedMeasurable.mo3866measureBRTryo0(constraints);
                m3922setMeasurementConstraintsBRTryo0(constraints);
                m3921setMeasuredSizeozmzZPI(IntSizeKt.IntSize(placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight()));
            }
            this.wrappedPlaceable = placeableMo3866measureBRTryo0;
            return this;
        }
        ...
        public MeasureResult layout(final int width, final int height, final Map<AlignmentLine, Integer> alignmentLines, final Function1<? super Placeable.PlacementScope, Unit> placementBlock) {
            ...
            return new MeasureResult(width, height, alignmentLines, this, intermediateLayoutModifierNode, placementBlock) { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$IntermediateMeasureScopeImpl$layout$1
                ...
                public void placeChildren() {
                    ...
                    boolean zConfigureForPlacingForAlignment = companion.configureForPlacingForAlignment(coordinator$ui_release);
                    function1.invoke(companion);
                    if (coordinator$ui_release != null) {
                        coordinator$ui_release.setPlacingForAlignment$ui_release(zConfigureForPlacingForAlignment);
                    }

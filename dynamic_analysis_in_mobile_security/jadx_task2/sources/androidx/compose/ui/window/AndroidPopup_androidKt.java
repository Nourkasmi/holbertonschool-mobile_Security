...
public final class AndroidPopup_androidKt {
    ...
    */
    ...
    public static final class C04511 implements MeasurePolicy {
        ...
        public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.layout$default(Layout, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m2270setimpl(composerM2263constructorimpl, c04511, ComposeUiNode.INSTANCE.getSetMeasurePolicy());

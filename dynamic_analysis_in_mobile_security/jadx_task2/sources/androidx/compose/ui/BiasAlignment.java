...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2280alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float fM5033getWidthimpl = (IntSize.m5033getWidthimpl(space) - IntSize.m5033getWidthimpl(size)) / 2.0f;
        float fM5032getHeightimpl = (IntSize.m5032getHeightimpl(space) - IntSize.m5032getHeightimpl(size)) / 2.0f;
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(fM5033getWidthimpl * ((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias) + f)), MathKt.roundToInt(fM5032getHeightimpl * (f + this.verticalBias)));
    }

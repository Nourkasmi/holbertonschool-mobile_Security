...
public final class Constraints {
    ...
    public static final int m4830getMinHeightimpl(long j) {
        int iM4823getFocusIndeximpl = m4823getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[iM4823getFocusIndeximpl])) & HeightMask[iM4823getFocusIndeximpl];
    }

    /* JADX INFO: renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m4828getMaxHeightimpl(long j) {
        int iM4823getFocusIndeximpl = m4823getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[iM4823getFocusIndeximpl] + 31))) & HeightMask[iM4823getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m4824getHasBoundedHeightimpl(long j) {
        int iM4823getFocusIndeximpl = m4823getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[iM4823getFocusIndeximpl] + 31))) & HeightMask[iM4823getFocusIndeximpl]) != 0;
    }
    ...
    public static String m4834toStringimpl(long j) {
        int iM4829getMaxWidthimpl = m4829getMaxWidthimpl(j);
        String strValueOf = iM4829getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(iM4829getMaxWidthimpl);
        int iM4828getMaxHeightimpl = m4828getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m4831getMinWidthimpl(j) + ", maxWidth = " + strValueOf + ", minHeight = " + m4830getMinHeightimpl(j) + ", maxHeight = " + (iM4828getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(iM4828getMaxHeightimpl) : "Infinity") + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4836createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            ...
            return Constraints.m4818constructorimpl((((long) i3) << 33) | j | (((long) minWidth) << Constraints.MinFocusHeight) | (((long) minHeight) << i5) | (((long) i4) << (i5 + 31)));
        }

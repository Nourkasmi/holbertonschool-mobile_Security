...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T value, final Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        int i3 = i & 8;
        EffectsKt.LaunchedEffect(value, mutableState.getValue(), new C03441(value, swipeableState, null), composer, (i & 14) | i3 | 512);
    ...
    */
    ...
    public static final <T> Modifier m1486swipeablepPrIpRY(Modifier swipeable, final SwipeableState<T> state, final Map<Float, ? extends T> anchors, final Orientation orientation, final boolean z, final boolean z2, final MutableInteractionSource mutableInteractionSource, final Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, final ResistanceConfig resistanceConfig, final float f) {
        ...
        return ComposedModifierKt.composed(swipeable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                composer.endReplaceableGroup();
                Modifier modifierDraggable = DraggableKt.draggable(companion2, draggableState, orientation2, (188 & 4) != 0 ? true : z3, (188 & 8) != 0 ? null : mutableInteractionSource2, (188 & 16) != 0 ? false : zIsAnimationRunning, (188 & 32) != 0 ? new DraggableKt.C01541(null) : null, (188 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : (Function3) objRememberedValue, (188 & 128) != 0 ? false : z2);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
    ...
    static final class C03441 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03441(T t, SwipeableState<T> swipeableState, Continuation<? super C03441> continuation) {
            super(2, continuation);
            this.$value = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03441(this.$value, this.$swipeableState, continuation);
        }

...
public final class SuggestionChipDefaults {
    ...
    public final ChipColors m1472suggestionChipColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 16) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long jM2628copywmQWz5c$default2 = (i2 & 32) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        ...
        ChipColors chipColors = new ChipColors(jM2664getTransparent0d7_KjU, color, color2, Color.INSTANCE.m2665getUnspecified0d7_KjU(), jM2664getTransparent0d7_KjU2, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, Color.INSTANCE.m2665getUnspecified0d7_KjU(), null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m1473suggestionChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM2134getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? SuggestionChipTokens.INSTANCE.m2134getFlatContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? fM2134getFlatContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? fM2134getFlatContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? fM2134getFlatContainerElevationD9Ej5fM : f4;
        float fM2128getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? SuggestionChipTokens.INSTANCE.m2128getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? fM2134getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(fM2134getFlatContainerElevationD9Ej5fM, f7, f8, f9, fM2128getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipBorder m1471suggestionChipBorderd_3_b6Q(long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 2) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float fM2135getFlatOutlineWidthD9Ej5fM = (i2 & 4) != 0 ? SuggestionChipTokens.INSTANCE.m2135getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipBorder chipBorder = new ChipBorder(color, jM2628copywmQWz5c$default, fM2135getFlatOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipColors m1467elevatedSuggestionChipColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM1048getOnSurfaceVariant0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1048getOnSurfaceVariant0d7_KjU() : j3;
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long jM2628copywmQWz5c$default2 = (i2 & 16) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long jM2628copywmQWz5c$default3 = (i2 & 32) != 0 ? Color.m2628copywmQWz5c$default(MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1047getOnSurface0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipColors chipColors = new ChipColors(color, color2, jM1048getOnSurfaceVariant0d7_KjU, Color.INSTANCE.m2665getUnspecified0d7_KjU(), jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, jM2628copywmQWz5c$default3, Color.INSTANCE.m2665getUnspecified0d7_KjU(), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m1468elevatedSuggestionChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM2129getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? SuggestionChipTokens.INSTANCE.m2129getElevatedContainerElevationD9Ej5fM() : f;
        float fM2133getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? SuggestionChipTokens.INSTANCE.m2133getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float fM2131getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? SuggestionChipTokens.INSTANCE.m2131getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float fM2132getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? SuggestionChipTokens.INSTANCE.m2132getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float fM2128getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? SuggestionChipTokens.INSTANCE.m2128getDraggedContainerElevationD9Ej5fM() : f5;
        float fM2130getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? SuggestionChipTokens.INSTANCE.m2130getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(fM2129getElevatedContainerElevationD9Ej5fM, fM2133getElevatedPressedContainerElevationD9Ej5fM, fM2131getElevatedFocusContainerElevationD9Ej5fM, fM2132getElevatedHoverContainerElevationD9Ej5fM, fM2128getDraggedContainerElevationD9Ej5fM, fM2130getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();

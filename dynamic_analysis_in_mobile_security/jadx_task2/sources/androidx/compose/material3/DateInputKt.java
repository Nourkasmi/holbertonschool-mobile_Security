...
public final class DateInputKt {
    ...
    public static final void DateInputContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> dateValidator, Composer composer, final int i) {
        ...
        if ((i4 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                DateInputValidator dateInputValidator = new DateInputValidator(stateData, dateInputFormat2, dateFormatter, dateValidator, strM1465getStringNWtq28, strM1465getStringNWtq282, strM1465getStringNWtq283, "");
            ...
            final String strM1465getStringNWtq284 = Strings_androidKt.m1465getStringNWtq28(Strings.INSTANCE.m1414getDateInputLabeladMyvUU(), composerStartRestartGroup, i3);
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, -438341159, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.1
                ...
                public final void invoke(Composer composer3, int i5) {
                    ...
                    String str2 = strM1465getStringNWtq284;
                    Modifier.Companion companion = Modifier.INSTANCE;
                    final String str3 = strM1465getStringNWtq284;
            ...
            m1132DateInputTextFieldzm97o8M(modifierPadding, composableLambda, composableLambda2, stateData, value, (Function1) objRememberedValue3, InputIdentifier.INSTANCE.m1252getSingleDateInputJ2x2o4M(), dateInputValidator2, dateInputFormat, localeDefaultLocale, composerStartRestartGroup, ((i4 << 9) & 7168) | 1075315126);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1132DateInputTextFieldzm97o8M(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final StateData stateData, final CalendarDate calendarDate, final Function1<? super CalendarDate, Unit> onDateChanged, final int i, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, Composer composer, final int i2) {
            ...
            public final void invoke2(TextFieldValue input) {
                ...
                if (input.getText().length() <= dateInputFormat.getPatternWithoutDelimiters().length()) {
                    ...
                    if (string.length() == 0 || string.length() < dateInputFormat.getPatternWithoutDelimiters().length()) {
                        ...
                        mutableState.setValue(dateInputValidator.m1133validateXivgLIo(calendarDate2, i, locale));
                        onDateChanged.invoke(mutableState.getValue().length() == 0 ? calendarDate2 : null);
                    }
                }
            }
        };
        Modifier modifierM484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, StringsKt.isBlank((CharSequence) mutableState.getValue()) ^ true ? Dp.m4873constructorimpl(0) : InputTextNonErroneousBottomPadding, 7, null);
        composerStartRestartGroup.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
        ...
        composerStartRestartGroup.endReplaceableGroup();
        int i3 = i2 << 15;
        OutlinedTextFieldKt.OutlinedTextField(textFieldValueDateInputTextField_zm97o8M$lambda$3, (Function1<? super TextFieldValue, Unit>) function1, SemanticsModifierKt.semantics$default(modifierM484paddingqDBjuR0$default, false, (Function1) objRememberedValue, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composerStartRestartGroup, 785795078, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
            ...
            public final void invoke(Composer composer2, int i4) {
                DateInputKt.m1132DateInputTextFieldzm97o8M(modifier, function2, function22, stateData, calendarDate, onDateChanged, i, dateInputValidator, dateInputFormat, locale, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }

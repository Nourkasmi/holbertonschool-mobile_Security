...
public final class ButtonDefaults {
    ...
    public final ButtonColors m1002buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-339300779, i, -1, "androidx.compose.material3.ButtonDefaults.buttonColors (Button.kt:552)");
        }
        ButtonColors buttonColors = new ButtonColors(color, color2, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m1004elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1006filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonColors m1012outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2664getTransparent0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j;
        long color = (i2 & 2) != 0 ? ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getLabelTextColor(), composer, 6) : j2;
        long jM2664getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j3;
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1778526249, i, -1, "androidx.compose.material3.ButtonDefaults.outlinedButtonColors (Button.kt:629)");
        }
        ButtonColors buttonColors = new ButtonColors(jM2664getTransparent0d7_KjU, color, jM2664getTransparent0d7_KjU2, jM2628copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors m1013textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2664getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j3;
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(TextButtonTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1003buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float fM1885getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledButtonTokens.INSTANCE.m1885getContainerElevationD9Ej5fM() : f;
        float fM1891getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledButtonTokens.INSTANCE.m1891getPressedContainerElevationD9Ej5fM() : f2;
        float fM1888getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledButtonTokens.INSTANCE.m1888getFocusContainerElevationD9Ej5fM() : f3;
        float fM1889getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledButtonTokens.INSTANCE.m1889getHoverContainerElevationD9Ej5fM() : f4;
        float fM1887getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledButtonTokens.INSTANCE.m1887getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, i, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:679)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(fM1885getContainerElevationD9Ej5fM, fM1891getPressedContainerElevationD9Ej5fM, fM1888getFocusContainerElevationD9Ej5fM, fM1889getHoverContainerElevationD9Ej5fM, fM1887getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1005elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float fM1801getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m1801getContainerElevationD9Ej5fM() : f;
        float fM1807getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m1807getPressedContainerElevationD9Ej5fM() : f2;
        float fM1804getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m1804getFocusContainerElevationD9Ej5fM() : f3;
        float fM1805getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m1805getHoverContainerElevationD9Ej5fM() : f4;
        float fM1803getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m1803getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(fM1801getContainerElevationD9Ej5fM, fM1807getPressedContainerElevationD9Ej5fM, fM1804getFocusContainerElevationD9Ej5fM, fM1805getHoverContainerElevationD9Ej5fM, fM1803getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1007filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float fM1908getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m1908getContainerElevationD9Ej5fM() : f;
        float fM1914getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m1914getPressedContainerElevationD9Ej5fM() : f2;
        float fM1911getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m1911getFocusContainerElevationD9Ej5fM() : f3;
        float fM1912getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m1912getHoverContainerElevationD9Ej5fM() : f4;
        float fM4873constructorimpl = (i2 & 16) != 0 ? Dp.m4873constructorimpl(0) : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(fM1908getContainerElevationD9Ej5fM, fM1914getPressedContainerElevationD9Ej5fM, fM1911getFocusContainerElevationD9Ej5fM, fM1912getHoverContainerElevationD9Ej5fM, fM4873constructorimpl, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke borderStrokeM186BorderStrokecXLIe8U = BorderStrokeKt.m186BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m1993getOutlineWidthD9Ej5fM(), ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return borderStrokeM186BorderStrokecXLIe8U;
    }

    static {
        float fM4873constructorimpl = Dp.m4873constructorimpl(24);
        ButtonHorizontalPadding = fM4873constructorimpl;
        float f = 8;
        float fM4873constructorimpl2 = Dp.m4873constructorimpl(f);
        ButtonVerticalPadding = fM4873constructorimpl2;
        PaddingValues paddingValuesM476PaddingValuesa9UjIt4 = PaddingKt.m476PaddingValuesa9UjIt4(fM4873constructorimpl, fM4873constructorimpl2, fM4873constructorimpl, fM4873constructorimpl2);
        ContentPadding = paddingValuesM476PaddingValuesa9UjIt4;
        float f2 = 16;
        float fM4873constructorimpl3 = Dp.m4873constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = fM4873constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m476PaddingValuesa9UjIt4(fM4873constructorimpl3, fM4873constructorimpl2, fM4873constructorimpl, fM4873constructorimpl2);
        float fM4873constructorimpl4 = Dp.m4873constructorimpl(12);
        TextButtonHorizontalPadding = fM4873constructorimpl4;
        TextButtonContentPadding = PaddingKt.m476PaddingValuesa9UjIt4(fM4873constructorimpl4, paddingValuesM476PaddingValuesa9UjIt4.getTop(), fM4873constructorimpl4, paddingValuesM476PaddingValuesa9UjIt4.getBottom());
        float fM4873constructorimpl5 = Dp.m4873constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = fM4873constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m476PaddingValuesa9UjIt4(fM4873constructorimpl4, paddingValuesM476PaddingValuesa9UjIt4.getTop(), fM4873constructorimpl5, paddingValuesM476PaddingValuesa9UjIt4.getBottom());

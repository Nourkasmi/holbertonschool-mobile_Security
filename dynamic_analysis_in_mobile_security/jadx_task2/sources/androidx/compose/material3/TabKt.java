    ...
    */
    ...
    public static final void m1502TabTransitionKlgxPg(final long j, final long j2, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            ColorSpace colorSpaceM2633getColorSpaceimpl = Color.m2633getColorSpaceimpl(j3);
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(composerStartRestartGroup, "C(remember)P(1):Composables.kt#9igjgp");
            boolean zChanged = composerStartRestartGroup.changed(colorSpaceM2633getColorSpaceimpl);
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(colorSpaceM2633getColorSpaceimpl);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Color colorM2619boximpl = Color.m2619boximpl(j4);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            State stateCreateTransitionAnimation = TransitionKt.createTransitionAnimation(transitionUpdateTransition, colorM2619boximpl, Color.m2619boximpl(j5), tabKt$TabTransition$color$2.invoke(transitionUpdateTransition.getSegment(), composerStartRestartGroup, 0), twoWayConverter, "ColorAnimation", composerStartRestartGroup, 32768);
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(TabTransition_Klgx_Pg$lambda$5(stateCreateTransitionAnimation)))}, function2, composerStartRestartGroup, (i3 & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if ((i2 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt.TabBaselineLayout.2
                ...
                public final MeasureResult mo11measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    final Placeable placeableMo3866measureBRTryo02;
                    float f;
                    ...
                    if (function2 != null) {
                        for (Measurable measurable : measurables) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "text")) {
                                placeableMo3866measureBRTryo0 = measurable.mo3866measureBRTryo0(Constraints.m4820copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                            }
                        }
                    ...
                    if (function22 != null) {
                        for (Measurable measurable2 : measurables) {
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "icon")) {
                                placeableMo3866measureBRTryo02 = measurable2.mo3866measureBRTryo0(j);
                            }
                        }
                        throw new NoSuchElementException("Collection contains no element matching the predicate.");
                    }
                    placeableMo3866measureBRTryo02 = null;
                    final int iMax = Math.max(placeableMo3866measureBRTryo0 != null ? placeableMo3866measureBRTryo0.getWidth() : 0, placeableMo3866measureBRTryo02 != null ? placeableMo3866measureBRTryo02.getWidth() : 0);
                    if (placeableMo3866measureBRTryo0 != null && placeableMo3866measureBRTryo02 != null) {
                        f = TabKt.LargeTabHeight;
                    } else {
                        f = TabKt.SmallTabHeight;
                    }
                    final int iMax2 = Math.max(Layout.mo319roundToPx0680j_4(f), (placeableMo3866measureBRTryo02 != null ? placeableMo3866measureBRTryo02.getHeight() : 0) + (placeableMo3866measureBRTryo0 != null ? placeableMo3866measureBRTryo0.getHeight() : 0) + Layout.mo318roundToPxR2X_6o(TabKt.IconDistanceFromBaseline));
                    final Integer numValueOf = placeableMo3866measureBRTryo0 != null ? Integer.valueOf(placeableMo3866measureBRTryo0.get(AlignmentLineKt.getFirstBaseline())) : null;
                    final Integer numValueOf2 = placeableMo3866measureBRTryo0 != null ? Integer.valueOf(placeableMo3866measureBRTryo0.get(AlignmentLineKt.getLastBaseline())) : null;
                    return MeasureScope.layout$default(Layout, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2$measure$1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Placeable placeable;
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            Placeable placeable2 = placeableMo3866measureBRTryo0;
                            if (placeable2 == null || (placeable = placeableMo3866measureBRTryo02) == null) {
                                if (placeable2 != null) {
            ...
            if (function2 != null) {
                Modifier modifierM482paddingVpY3zN4$default = PaddingKt.m482paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, "text"), HorizontalTextPadding, 0.0f, 2, null);
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        int iMo319roundToPx0680j_4 = density.mo319roundToPx0680j_4(i3 == i4 ? SingleLineTextBaselineWithIcon : DoubleLineTextBaselineWithIcon) + density.mo319roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2092getActiveIndicatorHeightD9Ej5fM());
        int height = (placeable2.getHeight() + density.mo318roundToPxR2X_6o(IconDistanceFromBaseline)) - i3;
        int i5 = (i2 - i4) - iMo319roundToPx0680j_4;

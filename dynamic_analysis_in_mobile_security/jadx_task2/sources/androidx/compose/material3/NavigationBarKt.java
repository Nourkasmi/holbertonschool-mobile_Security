    ...
    */
    ...
    public static final void NavigationBarItemBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean z, final float f, Composer composer, final int i) {
        ...
        if ((374491 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), NavigationBarKt.IconLayoutIdTag)) {
                            ...
                            float f2 = 2;
                            int width = placeableMo3866measureBRTryo02.getWidth() + Layout.mo319roundToPx0680j_4(Dp.m4873constructorimpl(NavigationBarKt.IndicatorHorizontalPadding * f2));
                            int iRoundToInt = MathKt.roundToInt(width * f);
                            int height = placeableMo3866measureBRTryo02.getHeight() + Layout.mo319roundToPx0680j_4(Dp.m4873constructorimpl(NavigationBarKt.IndicatorVerticalPadding * f2));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), NavigationBarKt.IndicatorRippleLayoutIdTag)) {
                                    ...
                                    if (function24 == null) {
                                        return NavigationBarKt.m1294placeIconX9ElhV4(Layout, placeableMo3866measureBRTryo02, placeableMo3866measureBRTryo03, placeableMo3866measureBRTryo04, j);
                                    }
                                    Intrinsics.checkNotNull(placeableMo3866measureBRTryo0);
                                    return NavigationBarKt.m1295placeLabelAndIconzUg2_y0(Layout, placeableMo3866measureBRTryo0, placeableMo3866measureBRTryo02, placeableMo3866measureBRTryo03, placeableMo3866measureBRTryo04, j, z, f);
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
            ...
            if (function24 != null) {
                Modifier modifierM482paddingVpY3zN4$default = PaddingKt.m482paddingVpY3zN4$default(AlphaKt.alpha(LayoutIdKt.layoutId(Modifier.INSTANCE, LabelLayoutIdTag), z ? 1.0f : f), Dp.m4873constructorimpl(NavigationBarItemHorizontalPadding / 2), 0.0f, 2, null);
                composerStartRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf3 = LayoutKt.materializerOf(modifierM482paddingVpY3zN4$default);
                if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                composerStartRestartGroup.startReusableNode();
    ...
    public static final MeasureResult m1294placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        ...
        final int width = (iM4829getMaxWidthimpl - placeable.getWidth()) / 2;
        final int height = (iM4828getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (iM4829getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int height2 = (iM4828getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, iM4829getMaxWidthimpl, iM4828getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (iM4829getMaxWidthimpl - placeable4.getWidth()) / 2, (iM4828getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1295placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        ...
        final int width = (iM4829getMaxWidthimpl - placeable.getWidth()) / 2;
        final int width2 = (iM4829getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int width3 = (iM4829getMaxWidthimpl - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo319roundToPx0680j_4(IndicatorVerticalPadding);
        return MeasureScope.layout$default(measureScope, iM4829getMaxWidthimpl, iM4828getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable5 != null) {
                    int i4 = iM4829getMaxWidthimpl;
                    int i5 = i2;
                    MeasureScope measureScope2 = measureScope;
                    Placeable.PlacementScope.placeRelative$default(layout, placeable5, (i4 - placeable5.getWidth()) / 2, iRoundToInt + (i5 - measureScope2.mo319roundToPx0680j_4(NavigationBarKt.IndicatorVerticalPadding)), 0.0f, 4, null);
                }
                if (z || f != 0.0f) {

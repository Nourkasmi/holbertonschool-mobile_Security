...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState state, Composer composer, int i) {
        ...
        State<Color> stateM68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(state == ToggleableState.Off ? this.uncheckedCheckmarkColor : this.checkedCheckmarkColor, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean z, ToggleableState state, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {

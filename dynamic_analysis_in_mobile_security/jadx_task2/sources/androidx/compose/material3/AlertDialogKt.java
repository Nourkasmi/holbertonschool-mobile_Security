        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                ...
                public final MeasureResult mo11measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    while (it.hasNext()) {
                        Placeable placeableMo3866measureBRTryo0 = it.next().mo3866measureBRTryo0(j);
                        Ref.IntRef intRef7 = intRef6;
                        if (measure_3p2s80s$canAddToCurrentSequence(arrayList6, intRef5, Layout, f, j, placeableMo3866measureBRTryo0)) {
                            intRef = intRef5;
                            intRef2 = intRef4;
                        ...
                        arrayList2.add(placeableMo3866measureBRTryo0);
                        intRef8.element += placeableMo3866measureBRTryo0.getWidth();
                        intRef6 = intRef7;
                        intRef6.element = Math.max(intRef6.element, placeableMo3866measureBRTryo0.getHeight());
                        intRef5 = intRef8;
                    ...
                    final int iMax = Math.max(intRef3.element, Constraints.m4831getMinWidthimpl(j));
                    int iMax2 = Math.max(intRef9.element, Constraints.m4830getMinHeightimpl(j));
                    final float f3 = f;
                    return MeasureScope.layout$default(Layout, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$measure$1

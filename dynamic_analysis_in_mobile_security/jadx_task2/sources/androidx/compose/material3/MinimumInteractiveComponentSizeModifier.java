...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo3866measureBRTryo0.getWidth(), measure.mo319roundToPx0680j_4(DpSize.m4971getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo3866measureBRTryo0.getHeight(), measure.mo319roundToPx0680j_4(DpSize.m4969getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measure, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo3866measureBRTryo0, MathKt.roundToInt((iMax - placeableMo3866measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo3866measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }

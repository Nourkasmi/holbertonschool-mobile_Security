...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(Function0<Unit> function0, String testTag, View composeView, Density density, PopupPositionProvider initialPositionProvider, UUID popupId) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material3.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m1679getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        ...
        this.dismissOnOutsideClick = new Function2<Offset, IntRect, Boolean>() { // from class: androidx.compose.material3.internal.PopupLayout$dismissOnOutsideClick$1
            ...
            public final Boolean invoke(Offset offset, IntRect bounds) {
                ...
                boolean z = false;
                if (offset != null && (Offset.m2390getXimpl(offset.getPackedValue()) < bounds.getLeft() || Offset.m2390getXimpl(offset.getPackedValue()) > bounds.getRight() || Offset.m2391getYimpl(offset.getPackedValue()) < bounds.getTop() || Offset.m2391getYimpl(offset.getPackedValue()) > bounds.getBottom())) {
                    z = true;
                }
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopupKt.INSTANCE.m1677getLambda1$material3_release(), null, 2, null);
    }
    ...
    public final void updatePosition() {
        IntSize intSizeM1679getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM1679getPopupContentSizebOM6tXw = m1679getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long packedValue = intSizeM1679getPopupContentSizebOM6tXw.getPackedValue();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long jMo874calculatePositionllwVHH4 = this.positionProvider.mo874calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, packedValue);

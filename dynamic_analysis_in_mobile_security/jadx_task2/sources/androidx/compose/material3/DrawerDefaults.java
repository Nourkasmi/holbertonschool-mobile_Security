...
public final class DrawerDefaults {
    ...
    public final long getScrimColor(Composer composer, int i) {
        ...
        long jM2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(ScrimTokens.INSTANCE.getContainerColor(), composer, 6), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM2628copywmQWz5c$default;
    }

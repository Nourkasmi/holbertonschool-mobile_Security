...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public long mo874calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        int iMo319roundToPx0680j_4 = this.density.mo319roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
        int iMo319roundToPx0680j_42 = this.density.mo319roundToPx0680j_4(DpOffset.m4934getXD9Ej5fM(this.contentOffset));
        int iMo319roundToPx0680j_43 = this.density.mo319roundToPx0680j_4(DpOffset.m4936getYD9Ej5fM(this.contentOffset));
        int left = anchorBounds.getLeft() + iMo319roundToPx0680j_42;
        int right = (anchorBounds.getRight() - iMo319roundToPx0680j_42) - IntSize.m5033getWidthimpl(popupContentSize);
        int iM5033getWidthimpl = IntSize.m5033getWidthimpl(windowSize) - IntSize.m5033getWidthimpl(popupContentSize);
        if (layoutDirection == LayoutDirection.Ltr) {
            ...
            numArr[2] = Integer.valueOf(iM5033getWidthimpl);
            ...
            numArr2[2] = Integer.valueOf(iM5033getWidthimpl);
        ...
        while (true) {
            ...
            if (iIntValue >= 0 && iIntValue + IntSize.m5033getWidthimpl(popupContentSize) <= IntSize.m5033getWidthimpl(windowSize)) {
                break;
            }
        }
        ...
        int iMax = Math.max(anchorBounds.getBottom() + iMo319roundToPx0680j_43, iMo319roundToPx0680j_4);
        int top = (anchorBounds.getTop() - iMo319roundToPx0680j_43) - IntSize.m5032getHeightimpl(popupContentSize);
        Iterator it2 = SequencesKt.sequenceOf(Integer.valueOf(iMax), Integer.valueOf(top), Integer.valueOf(anchorBounds.getTop() - (IntSize.m5032getHeightimpl(popupContentSize) / 2)), Integer.valueOf((IntSize.m5032getHeightimpl(windowSize) - IntSize.m5032getHeightimpl(popupContentSize)) - iMo319roundToPx0680j_4)).iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
            ...
            if (iIntValue2 >= iMo319roundToPx0680j_4 && iIntValue2 + IntSize.m5032getHeightimpl(popupContentSize) <= IntSize.m5032getHeightimpl(windowSize) - iMo319roundToPx0680j_4) {
                obj = next2;
                break;
            }
        }

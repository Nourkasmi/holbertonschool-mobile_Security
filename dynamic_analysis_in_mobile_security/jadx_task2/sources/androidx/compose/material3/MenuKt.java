    ...
    */
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> text, final Function0<Unit> onClick, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final boolean z, final MenuItemColors colors, final PaddingValues contentPadding, final MutableInteractionSource interactionSource, Composer composer, final int i) {
        ...
        if ((191739611 & i3) != 38347922 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierPadding = PaddingKt.padding(SizeKt.m531sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m190clickableO2vRcR0$default(modifier, interactionSource, RippleKt.m966rememberRipple9IZ8Weo(true, 0.0f, 0L, composerStartRestartGroup, 6, 6), z, null, null, onClick, 24, null), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuTokens.INSTANCE.m1960getListItemContainerHeightD9Ej5fM(), DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), contentPadding);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer3, 2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer4, int i7) {
                                    ...
                                    if ((i7 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier modifierM512defaultMinSizeVpY3zN4$default = SizeKt.m512defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m1961getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf2 = LayoutKt.materializerOf(modifierM512defaultMinSizeVpY3zN4$default);
                                        ...
                                        Composer composerM2263constructorimpl2 = Updater.m2263constructorimpl(composer4);
                                        ...
                                        function3MaterializerOf2.invoke(SkippableUpdater.m2254boximpl(SkippableUpdater.m2255constructorimpl(composer4)), composer4, 0);
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr2, ComposableLambdaKt.composableLambda(composer3, -1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer4, int i9) {
                                ...
                                if ((i9 & 11) != 2 || !composer4.getSkipping()) {
                                    ...
                                    if (function24 != null) {
                                        fM4873constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        fM4873constructorimpl = Dp.m4873constructorimpl(0);
                                    }
                                    float f = fM4873constructorimpl;
                                    if (function25 != null) {
                                        fM4873constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        fM4873constructorimpl2 = Dp.m4873constructorimpl(0);
                                    }
                                    Modifier modifierM484paddingqDBjuR0$default = PaddingKt.m484paddingqDBjuR0$default(modifierWeight$default, f, 0.0f, fM4873constructorimpl2, 0.0f, 10, null);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr3, ComposableLambdaKt.composableLambda(composer3, 580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer4, int i11) {
                                    ...
                                    if ((i11 & 11) != 2 || !composer4.getSkipping()) {
                                        ...
                                        Modifier modifierM512defaultMinSizeVpY3zN4$default = SizeKt.m512defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m1962getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);

...
public final class DragGestureDetectorCopyKt {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:46:0x011c -> B:57:0x0168). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:52:0x015b -> B:53:0x015e). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:62:0x0182 -> B:57:0x0168). Please report as a decompilation issue!!! */
    ...
    */
    ...
    private static final Object m1178awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        ...
        float fM1180pointerSlopE8SPZFQ = m1180pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float fFloatValue = f + (function1.invoke(Offset.m2379boximpl(pointerInputChange3.getPosition())).floatValue() - function1.invoke(Offset.m2379boximpl(pointerInputChange3.getPreviousPosition())).floatValue());
                if (Math.abs(fFloatValue) < fM1180pointerSlopE8SPZFQ) {
                    ...
                    function2.invoke(pointerInputChange3, Float.valueOf(fFloatValue - (Math.signum(fFloatValue) * fM1180pointerSlopE8SPZFQ)));
                    if (pointerInputChange3.isConsumed()) {

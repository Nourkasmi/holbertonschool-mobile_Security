...
public final class DateRangePickerKt {
    ...
    */
    ...
    public static final DateRangePickerState m1153rememberDateRangePickerStatepMw4iz8(Long l, Long l2, Long l3, IntRange intRange, int i, Composer composer, int i2, int i3) {
        ...
        final int iM1174getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.INSTANCE.m1174getPickerjFl4v0() : i;
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2276rememberSaveable(new Object[0], (Saver) DateRangePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            ...
            public final DateRangePickerState invoke() {
                return new DateRangePickerState(l4, l5, l6, yearRange, iM1174getPickerjFl4v0, null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            int iM1156getDisplayModejFl4v0 = dateRangePickerState.m1156getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1166boximpl(iM1156getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.SwitchableDateEntryContent.1
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM482paddingVpY3zN4$default = PaddingKt.m482paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM482paddingVpY3zN4$default);
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        composer2.endReplaceableGroup();
                        final String strM1465getStringNWtq28 = Strings_androidKt.m1465getStringNWtq28(Strings.INSTANCE.m1437getDateRangePickerScrollToShowPreviousMonthadMyvUU(), composer2, 6);
                        final String strM1465getStringNWtq282 = Strings_androidKt.m1465getStringNWtq28(Strings.INSTANCE.m1436getDateRangePickerScrollToShowNextMonthadMyvUU(), composer2, 6);
                                ...
                                LazyListScope.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int i7, Composer composer3, int i8) {
                                        ...
                                        if ((i9 & 731) != 146 || !composer3.getSkipping()) {
                                            ...
                                            TextKt.m1552Text4IGK_g(monthYear$material3_release, SemanticsModifierKt.semantics$default(ClickableKt.m192clickableXHw0xAI$default(PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1
                                                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
    ...
    public static final void m1152drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long j) {
        ...
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float fM2459getWidthimpl2 = (Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc()) - (f6 * f)) / f6;
        long packedValue = selectedRangeInfo.getGridCoordinates().getFirst().getPackedValue();
        int iM4983component1impl = IntOffset.m4983component1impl(packedValue);
        int iM4984component2impl = IntOffset.m4984component2impl(packedValue);
        long packedValue2 = selectedRangeInfo.getGridCoordinates().getSecond().getPackedValue();
        int iM4983component1impl2 = IntOffset.m4983component1impl(packedValue2);
        int iM4984component2impl2 = IntOffset.m4984component2impl(packedValue2);
        float f7 = f + fM2459getWidthimpl2;
        float f8 = fM2459getWidthimpl2 / f4;
        float fM2459getWidthimpl3 = (iM4983component1impl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f9 = (iM4984component2impl * f2) + f5;
        float f10 = iM4983component1impl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float fM2459getWidthimpl4 = f10 + f + f8;
        float f11 = (iM4984component2impl2 * f2) + f5;
        boolean z = drawRangeBackground.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            fM2459getWidthimpl3 = Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc()) - fM2459getWidthimpl3;
            fM2459getWidthimpl4 = Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc()) - fM2459getWidthimpl4;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long jOffset = OffsetKt.Offset(fM2459getWidthimpl3, f9);
        if (iM4984component2impl == iM4984component2impl2) {
            fM2459getWidthimpl = fM2459getWidthimpl4 - fM2459getWidthimpl3;
        } else {
            fM2459getWidthimpl = z ? -fM2459getWidthimpl3 : Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc()) - fM2459getWidthimpl3;
        }
        DrawScope.m3167drawRectnJ9OG0$default(contentDrawScope, j, jOffset, SizeKt.Size(fM2459getWidthimpl, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        if (iM4984component2impl != iM4984component2impl2) {
            for (int i = (iM4984component2impl2 - iM4984component2impl) - 1; i > 0; i--) {
                DrawScope.m3167drawRectnJ9OG0$default(contentDrawScope, j, OffsetKt.Offset(0.0f, (i * f2) + f9), SizeKt.Size(Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc()), f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            }
            long jOffset2 = OffsetKt.Offset(drawRangeBackground.getLayoutDirection() != LayoutDirection.Ltr ? Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc()) : 0.0f, f11);
            if (z) {
                fM2459getWidthimpl4 -= Size.m2459getWidthimpl(drawRangeBackground.mo3172getSizeNHjbRc());
            }
            DrawScope.m3167drawRectnJ9OG0$default(contentDrawScope, j, jOffset2, SizeKt.Size(fM2459getWidthimpl4, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }

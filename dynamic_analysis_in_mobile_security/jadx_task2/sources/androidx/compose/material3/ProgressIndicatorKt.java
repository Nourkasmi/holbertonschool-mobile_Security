...
public final class ProgressIndicatorKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:83:0x0139 A[LOOP:0: B:82:0x0137->B:83:0x0139, LOOP_END] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:76:0x01e8 A[LOOP:0: B:74:0x01e5->B:76:0x01e8, LOOP_END] */
    ...
    */
    ...
    public static final /* synthetic */ void m1337LinearProgressIndicatorRIQooxk(Modifier modifier, long j, long j2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            m1336LinearProgressIndicator2cYBFYY(companion, j3, j4, ProgressIndicatorDefaults.INSTANCE.m1331getLinearStrokeCapKaPHkGw(), composerStartRestartGroup, (i5 & 14) | 3072 | (i5 & 112) | (i5 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ProgressIndicatorKt$LinearProgressIndicator$6
            ...
            public final void invoke(Composer composer2, int i6) {
                ProgressIndicatorKt.m1337LinearProgressIndicatorRIQooxk(modifier3, j5, j6, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public static final void m1349drawLinearIndicatorqYKTg0g(DrawScope drawScope, float f, float f2, long j, float f3, int i) {
        float fM2459getWidthimpl = Size.m2459getWidthimpl(drawScope.mo3172getSizeNHjbRc());
        float fM2456getHeightimpl = Size.m2456getHeightimpl(drawScope.mo3172getSizeNHjbRc());
        float f4 = 2;
        float f5 = fM2456getHeightimpl / f4;
        boolean z = drawScope.getLayoutDirection() == LayoutDirection.Ltr;
        float f6 = (z ? f : 1.0f - f2) * fM2459getWidthimpl;
        float f7 = (z ? f2 : 1.0f - f) * fM2459getWidthimpl;
        if (StrokeCap.m2971equalsimpl0(i, StrokeCap.INSTANCE.m2975getButtKaPHkGw()) || fM2456getHeightimpl > fM2459getWidthimpl) {
        ...
        float f8 = f3 / f4;
        ClosedFloatingPointRange<Float> closedFloatingPointRangeRangeTo = RangesKt.rangeTo(f8, fM2459getWidthimpl - f8);
        ...
        if (Math.abs(f2 - f) > 0.0f) {
            DrawScope.m3159drawLineNGM6Ib0$default(drawScope, j, OffsetKt.Offset(fFloatValue, f5), OffsetKt.Offset(fFloatValue2, f5), f3, i, null, 0.0f, null, 0, 480, null);
        }
    }
    ...
    */
    ...
    private static final void m1345drawCircularIndicator42QJj7c(DrawScope drawScope, float f, float f2, long j, Stroke stroke) {
        ...
        float fM2459getWidthimpl = Size.m2459getWidthimpl(drawScope.mo3172getSizeNHjbRc()) - (f3 * width);
        DrawScope.m3152drawArcyD3GUKo$default(drawScope, j, f, f2, false, OffsetKt.Offset(width, width), SizeKt.Size(fM2459getWidthimpl, fM2459getWidthimpl), 0.0f, stroke, null, 0, 832, null);
    }

...
public final class MaterialThemeKt {
    ...
    */
    ...
    public static final TextSelectionColors rememberTextSelectionColors(ColorScheme colorScheme, Composer composer, int i) {
        ...
        long jM1053getPrimary0d7_KjU = colorScheme.m1053getPrimary0d7_KjU();
        Color colorM2619boximpl = Color.m2619boximpl(jM1053getPrimary0d7_KjU);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(colorM2619boximpl);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new TextSelectionColors(jM1053getPrimary0d7_KjU, Color.m2628copywmQWz5c$default(jM1053getPrimary0d7_KjU, 0.4f, 0.0f, 0.0f, 0.0f, 14, null), null);

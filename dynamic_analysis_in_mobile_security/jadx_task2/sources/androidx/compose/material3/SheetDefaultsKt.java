...
public final class SheetDefaultsKt {
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> onFling) {
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection.1
            ...
            public long mo334onPreScrollOzD1aCk(long available, int source) {
                ...
                if (fOffsetToFloat < 0.0f && NestedScrollSource.m3640equalsimpl0(source, NestedScrollSource.INSTANCE.m3645getDragWNlRxjI())) {
    ...
    public static final SheetState rememberSheetState(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, Composer composer, int i, int i2) {
        ...
        final C03211 c03211 = (i2 & 2) != 0 ? new Function1<SheetValue, Boolean>() { // from class: androidx.compose.material3.SheetDefaultsKt.rememberSheetState.1
        ...
        Object[] objArr = {Boolean.valueOf(z3), c03211};
        Saver<SheetState, SheetValue> Saver = SheetState.INSTANCE.Saver(z3, c03211);
        Object[] objArr2 = {Boolean.valueOf(z3), sheetValue2, c03211, Boolean.valueOf(z4)};
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function0) new Function0<SheetState>() { // from class: androidx.compose.material3.SheetDefaultsKt$rememberSheetState$2$1
                ...
                public final SheetState invoke() {
                    return new SheetState(z3, sheetValue2, c03211, z4);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        SheetState sheetState = (SheetState) RememberSaveableKt.m2276rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {

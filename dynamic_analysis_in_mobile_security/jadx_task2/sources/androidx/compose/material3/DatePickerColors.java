...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        State<Color> stateM68animateColorAsStateeuL9pac;
        ...
        if (z3) {
            ...
            stateM68animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(379006329);
            ComposerKt.sourceInformation(composer, "596@26492L134");
            stateM68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        composer.endReplaceableGroup();
        return stateM68animateColorAsStateeuL9pac;
    }
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            jM2664getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            jM2664getTransparent0d7_KjU = Color.INSTANCE.m2664getTransparent0d7_KjU();
        }
        long j = jM2664getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceableGroup(1577406023);
            ComposerKt.sourceInformation(composer, "622@27316L134");
            stateRememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1577406187);
            ComposerKt.sourceInformation(composer, "627@27480L28");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2619boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> stateM68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(z2 ? this.selectedYearContentColor : z ? this.currentYearContentColor : this.yearContentColor, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> stateM68animateColorAsStateeuL9pac = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(z ? this.selectedYearContainerColor : Color.INSTANCE.m2664getTransparent0d7_KjU(), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();

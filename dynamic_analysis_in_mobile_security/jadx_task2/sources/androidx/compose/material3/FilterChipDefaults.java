...
public final class FilterChipDefaults {
    ...
    public final SelectableChipColors m1209filterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long jM2664getTransparent0d7_KjU = (i3 & 1) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j;
        ...
        long jM2664getTransparent0d7_KjU2 = (i3 & 8) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j4;
        long jM2628copywmQWz5c$default = (i3 & 16) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long jM2628copywmQWz5c$default2 = (i3 & 32) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long j13 = (i3 & 64) != 0 ? jM2628copywmQWz5c$default2 : j7;
        long color3 = (i3 & 128) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatSelectedContainerColor(), composer, 6) : j8;
        long jM2628copywmQWz5c$default3 = (i3 & 256) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j9;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(jM2664getTransparent0d7_KjU, color, color2, color2, jM2664getTransparent0d7_KjU2, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, j13, color3, jM2628copywmQWz5c$default3, color4, color5, j14, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipElevation m1210filterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM1924getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilterChipTokens.INSTANCE.m1924getFlatContainerElevationD9Ej5fM() : f;
        float fM1928getFlatSelectedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilterChipTokens.INSTANCE.m1928getFlatSelectedPressedContainerElevationD9Ej5fM() : f2;
        float fM1925getFlatSelectedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilterChipTokens.INSTANCE.m1925getFlatSelectedFocusContainerElevationD9Ej5fM() : f3;
        float fM1926getFlatSelectedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilterChipTokens.INSTANCE.m1926getFlatSelectedHoverContainerElevationD9Ej5fM() : f4;
        float fM1918getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1918getDraggedContainerElevationD9Ej5fM() : f5;
        float f7 = (i2 & 32) != 0 ? fM1924getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-757972185, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipElevation (Chip.kt:866)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(fM1924getFlatContainerElevationD9Ej5fM, fM1928getFlatSelectedPressedContainerElevationD9Ej5fM, fM1925getFlatSelectedFocusContainerElevationD9Ej5fM, fM1926getFlatSelectedHoverContainerElevationD9Ej5fM, fM1918getDraggedContainerElevationD9Ej5fM, f7, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m1208filterChipBordergHcDVlo(long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long jM2664getTransparent0d7_KjU = (i2 & 2) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j2;
        long jM2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM2664getTransparent0d7_KjU2 = (i2 & 8) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j4;
        float fM1931getFlatUnselectedOutlineWidthD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1931getFlatUnselectedOutlineWidthD9Ej5fM() : f;
        float fM1927getFlatSelectedOutlineWidthD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m1927getFlatSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1884534961, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipBorder (Chip.kt:896)");
        }
        SelectableChipBorder selectableChipBorder = new SelectableChipBorder(color, jM2664getTransparent0d7_KjU, jM2628copywmQWz5c$default, jM2664getTransparent0d7_KjU2, fM1931getFlatUnselectedOutlineWidthD9Ej5fM, fM1927getFlatSelectedOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipColors m1206elevatedFilterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long jM2628copywmQWz5c$default = (i3 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long jM2628copywmQWz5c$default2 = (i3 & 16) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long jM2628copywmQWz5c$default3 = (i3 & 32) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long j13 = (i3 & 64) != 0 ? jM2628copywmQWz5c$default3 : j7;
        long color4 = (i3 & 128) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedSelectedContainerColor(), composer, 6) : j8;
        long j14 = (i3 & 256) != 0 ? jM2628copywmQWz5c$default : j9;
        ...
        SelectableChipColors selectableChipColors = new SelectableChipColors(color, color2, color3, color3, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, jM2628copywmQWz5c$default3, j13, color4, j14, color5, color6, j15, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipElevation m1207elevatedFilterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM1919getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilterChipTokens.INSTANCE.m1919getElevatedContainerElevationD9Ej5fM() : f;
        float fM1923getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilterChipTokens.INSTANCE.m1923getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float fM1921getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilterChipTokens.INSTANCE.m1921getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float fM1922getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilterChipTokens.INSTANCE.m1922getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float fM1918getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m1918getDraggedContainerElevationD9Ej5fM() : f5;
        float fM1920getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m1920getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(fM1919getElevatedContainerElevationD9Ej5fM, fM1923getElevatedPressedContainerElevationD9Ej5fM, fM1921getElevatedFocusContainerElevationD9Ej5fM, fM1922getElevatedHoverContainerElevationD9Ej5fM, fM1918getDraggedContainerElevationD9Ej5fM, fM1920getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();

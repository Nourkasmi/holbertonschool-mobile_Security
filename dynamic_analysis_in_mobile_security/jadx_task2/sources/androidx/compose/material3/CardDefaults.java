...
public final class CardDefaults {
    ...
    public final CardElevation m1015cardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM1892getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledCardTokens.INSTANCE.m1892getContainerElevationD9Ej5fM() : f;
        float fM1898getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledCardTokens.INSTANCE.m1898getPressedContainerElevationD9Ej5fM() : f2;
        float fM1895getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledCardTokens.INSTANCE.m1895getFocusContainerElevationD9Ej5fM() : f3;
        float fM1896getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledCardTokens.INSTANCE.m1896getHoverContainerElevationD9Ej5fM() : f4;
        float fM1894getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledCardTokens.INSTANCE.m1894getDraggedContainerElevationD9Ej5fM() : f5;
        float fM1893getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilledCardTokens.INSTANCE.m1893getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-574898487, i, -1, "androidx.compose.material3.CardDefaults.cardElevation (Card.kt:373)");
        }
        CardElevation cardElevation = new CardElevation(fM1892getContainerElevationD9Ej5fM, fM1898getPressedContainerElevationD9Ej5fM, fM1895getFocusContainerElevationD9Ej5fM, fM1896getHoverContainerElevationD9Ej5fM, fM1894getDraggedContainerElevationD9Ej5fM, fM1893getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardElevation m1017elevatedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM1808getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedCardTokens.INSTANCE.m1808getContainerElevationD9Ej5fM() : f;
        float fM1814getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedCardTokens.INSTANCE.m1814getPressedContainerElevationD9Ej5fM() : f2;
        float fM1811getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedCardTokens.INSTANCE.m1811getFocusContainerElevationD9Ej5fM() : f3;
        float fM1812getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedCardTokens.INSTANCE.m1812getHoverContainerElevationD9Ej5fM() : f4;
        float fM1810getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedCardTokens.INSTANCE.m1810getDraggedContainerElevationD9Ej5fM() : f5;
        float fM1809getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? ElevatedCardTokens.INSTANCE.m1809getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1154241939, i, -1, "androidx.compose.material3.CardDefaults.elevatedCardElevation (Card.kt:401)");
        }
        CardElevation cardElevation = new CardElevation(fM1808getContainerElevationD9Ej5fM, fM1814getPressedContainerElevationD9Ej5fM, fM1811getFocusContainerElevationD9Ej5fM, fM1812getHoverContainerElevationD9Ej5fM, fM1810getDraggedContainerElevationD9Ej5fM, fM1809getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardElevation m1019outlinedCardElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM1994getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? OutlinedCardTokens.INSTANCE.m1994getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? fM1994getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? fM1994getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? fM1994getContainerElevationD9Ej5fM : f4;
        float fM1996getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? OutlinedCardTokens.INSTANCE.m1996getDraggedContainerElevationD9Ej5fM() : f5;
        float fM1995getDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? OutlinedCardTokens.INSTANCE.m1995getDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-97678773, i, -1, "androidx.compose.material3.CardDefaults.outlinedCardElevation (Card.kt:429)");
        }
        CardElevation cardElevation = new CardElevation(fM1994getContainerElevationD9Ej5fM, f7, f8, f9, fM1996getDraggedContainerElevationD9Ej5fM, fM1995getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardColors m1014cardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM1094contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, i & 14) : j2;
        long jM2674compositeOverOWjLjI = (i2 & 4) != 0 ? ColorKt.m2674compositeOverOWjLjI(Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1099surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), FilledCardTokens.INSTANCE.m1893getDisabledContainerElevationD9Ej5fM())) : j3;
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, i & 14), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1589582123, i, -1, "androidx.compose.material3.CardDefaults.cardColors (Card.kt:455)");
        }
        CardColors cardColors = new CardColors(color, jM1094contentColorForek8zF_U, jM2674compositeOverOWjLjI, jM2628copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final CardColors m1016elevatedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM1094contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, i & 14) : j2;
        long jM2674compositeOverOWjLjI = (i2 & 4) != 0 ? ColorKt.m2674compositeOverOWjLjI(Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(ElevatedCardTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1099surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), ElevatedCardTokens.INSTANCE.m1809getDisabledContainerElevationD9Ej5fM())) : j3;
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(jM1094contentColorForek8zF_U, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m1018outlinedCardColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        CardColors cardColors = new CardColors(color, jM1094contentColorForek8zF_U, j5, jM2628copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedCardBorder(boolean z, Composer composer, int i, int i2) {
        long jM2674compositeOverOWjLjI;
        ...
        if (z) {
            ...
            jM2674compositeOverOWjLjI = ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-31428766);
            ComposerKt.sourceInformation(composer, "537@25023L9,540@25172L11");
            jM2674compositeOverOWjLjI = ColorKt.m2674compositeOverOWjLjI(Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.m1099surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), OutlinedCardTokens.INSTANCE.m1995getDisabledContainerElevationD9Ej5fM()));
            composer.endReplaceableGroup();
        }
        Color colorM2619boximpl = Color.m2619boximpl(jM2674compositeOverOWjLjI);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(colorM2619boximpl);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = BorderStrokeKt.m186BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m2000getOutlineWidthD9Ej5fM(), jM2674compositeOverOWjLjI);

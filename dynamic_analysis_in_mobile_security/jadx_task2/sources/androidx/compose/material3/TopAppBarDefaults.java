...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1676topAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        long jM1092applyTonalElevationHht5A8o = (i2 & 2) != 0 ? ColorSchemeKt.m1092applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer, 6), color, TopAppBarSmallTokens.INSTANCE.m2190getOnScrollContainerElevationD9Ej5fM()) : j2;
        ...
        TopAppBarColors topAppBarColors = new TopAppBarColors(color, jM1092applyTonalElevationHht5A8o, color2, color3, color4, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m1675smallTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors topAppBarColorsM1676topAppBarColorszjMxDiM = m1676topAppBarColorszjMxDiM(color, jM1092applyTonalElevationHht5A8o, color2, color3, color4, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (i & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return topAppBarColorsM1676topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets windowInsetsM553onlybOOhFvg = WindowInsetsKt.m553onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 8), WindowInsetsSides.m564plusgK_yJZ4(WindowInsetsSides.INSTANCE.m574getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m578getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return windowInsetsM553onlybOOhFvg;
    }

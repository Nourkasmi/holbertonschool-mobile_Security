...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);

...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m4871boximpl(f2), new AnonymousClass2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1373769675);
            ComposerKt.sourceInformation(composer, "1552@74943L570");
            EffectsKt.LaunchedEffect(Dp.m4871boximpl(f2), new AnonymousClass3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }

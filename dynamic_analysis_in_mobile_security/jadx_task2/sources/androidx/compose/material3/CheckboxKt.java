...
public final class CheckboxKt {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:112:0x02b3 A[LOOP:0: B:110:0x02b0->B:112:0x02b3, LOOP_END] */
    ...
    */
    ...
    public static final void m1023drawBox1wkBAMs(DrawScope drawScope, long j, long j2, float f, float f2) {
        ...
        if (Color.m2630equalsimpl0(j, j2)) {
            DrawScope.m3169drawRoundRectuAw5IA$default(drawScope, j, 0L, SizeKt.Size(fM2459getWidthimpl, fM2459getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f4 = fM2459getWidthimpl - (2 * f2);
        ...
        float f5 = fM2459getWidthimpl - f2;
    ...
    public static final void m1024drawCheck3IgeMak(DrawScope drawScope, long j, float f, float f2, float f3, CheckDrawingCache checkDrawingCache) {
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * fM2459getWidthimpl, fLerp3 * fM2459getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(fLerp * fM2459getWidthimpl, fLerp2 * fM2459getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * fM2459getWidthimpl, fM2459getWidthimpl * fLerp4);

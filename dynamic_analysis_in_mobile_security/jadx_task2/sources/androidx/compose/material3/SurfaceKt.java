...
public final class SurfaceKt {
    ...
    public static final void m1474SurfaceT9BRK9s(Modifier modifier, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, int i2) {
        ...
        final long jM1058getSurface0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1058getSurface0d7_KjU() : j;
        long jM1094contentColorForek8zF_U = (i2 & 8) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(jM1058getSurface0d7_KjU, composer, (i >> 6) & 14) : j2;
        float fM4873constructorimpl = (i2 & 16) != 0 ? Dp.m4873constructorimpl(0) : f;
        float fM4873constructorimpl2 = (i2 & 32) != 0 ? Dp.m4873constructorimpl(0) : f2;
        ...
        final float fM4873constructorimpl3 = Dp.m4873constructorimpl(((Dp) objConsume).m4887unboximpl() + fM4873constructorimpl);
        ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m2619boximpl(jM1094contentColorForek8zF_U)), providableCompositionLocal.provides(Dp.m4871boximpl(fM4873constructorimpl3))};
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = fM4873constructorimpl2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -70914509, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final void invoke(Composer composer2, int i3) {
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierPointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(SurfaceKt.m1480surface8ww4TTg(companion, rectangleShape, SurfaceKt.m1481surfaceColorAtElevationCLU3JFs(jM1058getSurface0d7_KjU, fM4873constructorimpl3, composer2, (i >> 6) & 14), borderStroke3, f3), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.1
    ...
    public static final void m1477Surfaceo_FOJdg(final Function0<Unit> onClick, Modifier modifier, boolean z, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        ...
        long jM1058getSurface0d7_KjU = (i3 & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1058getSurface0d7_KjU() : j;
        long jM1094contentColorForek8zF_U = (i3 & 32) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(jM1058getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        float fM4873constructorimpl = (i3 & 64) != 0 ? Dp.m4873constructorimpl(0) : f;
        float fM4873constructorimpl2 = (i3 & 128) != 0 ? Dp.m4873constructorimpl(0) : f2;
        ...
        final long j3 = jM1058getSurface0d7_KjU;
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = fM4873constructorimpl2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, 1279702876, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierM190clickableO2vRcR0$default = ClickableKt.m190clickableO2vRcR0$default(SurfaceKt.m1480surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), shape2, SurfaceKt.m1481surfaceColorAtElevationCLU3JFs(j3, fM4873constructorimpl3, composer2, (i >> 12) & 14), borderStroke3, f3), mutableInteractionSource3, RippleKt.m966rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z2, null, null, onClick, 24, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM190clickableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final void m1475Surfaced85dljk(final boolean z, final Function0<Unit> onClick, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        ...
        long jM1058getSurface0d7_KjU = (i3 & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1058getSurface0d7_KjU() : j;
        long jM1094contentColorForek8zF_U = (i3 & 64) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(jM1058getSurface0d7_KjU, composer, (i >> 15) & 14) : j2;
        float fM4873constructorimpl = (i3 & 128) != 0 ? Dp.m4873constructorimpl(0) : f;
        float fM4873constructorimpl2 = (i3 & 256) != 0 ? Dp.m4873constructorimpl(0) : f2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -1164547968, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$5
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierM705selectableO2vRcR0$default = SelectableKt.m705selectableO2vRcR0$default(SurfaceKt.m1480surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), shape2, SurfaceKt.m1481surfaceColorAtElevationCLU3JFs(j3, fM4873constructorimpl3, composer2, (i >> 15) & 14), borderStroke3, f3), z, mutableInteractionSource3, RippleKt.m966rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onClick, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM705selectableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, 712720927, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$7
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier modifierM709toggleableO2vRcR0$default = ToggleableKt.m709toggleableO2vRcR0$default(SurfaceKt.m1480surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), shape2, SurfaceKt.m1481surfaceColorAtElevationCLU3JFs(j3, fM4873constructorimpl3, composer2, (i >> 15) & 14), borderStroke3, f3), z, mutableInteractionSource3, RippleKt.m966rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onCheckedChange, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) objConsume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3MaterializerOf = LayoutKt.materializerOf(modifierM709toggleableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();

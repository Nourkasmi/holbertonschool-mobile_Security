...
public final class TopAppBarColors {
    ...
    public final long m1668containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long jM2680lerpjxsXWHM = ColorKt.m2680lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM2680lerpjxsXWHM;
    }

...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            iM1590getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m1589getHorizontalQJTpgSE();
        } else {
            iM1590getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m1590getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return iM1590getVerticalQJTpgSE;
    }
}

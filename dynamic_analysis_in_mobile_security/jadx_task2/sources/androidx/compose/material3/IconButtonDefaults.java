...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors m1230iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(jM2639unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(jM2664getTransparent0d7_KjU, jM2639unboximpl, jM2664getTransparent0d7_KjU2, jM2628copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1231iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM2664getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j3;
        long jM2628copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(jM2639unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long jM2664getTransparent0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m2664getTransparent0d7_KjU() : j5;
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(jM2664getTransparent0d7_KjU, jM2639unboximpl, jM2664getTransparent0d7_KjU2, jM2628copywmQWz5c$default, jM2664getTransparent0d7_KjU3, color, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1226filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(color, jM1094contentColorForek8zF_U, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1227filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM1094contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, color2, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, color3, jM1094contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1228filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM1094contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, i & 14) : j2;
        long jM2628copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM2628copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2628copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1229filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, jM1094contentColorForek8zF_U, jM2628copywmQWz5c$default, jM2628copywmQWz5c$default2, color2, color3, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1233outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long jM1094contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1094contentColorForek8zF_U(color, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(jM2664getTransparent0d7_KjU, jM2639unboximpl, jM2664getTransparent0d7_KjU2, jM2628copywmQWz5c$default, color, jM1094contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object objConsume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            jM2628copywmQWz5c$default = ((Color) objConsume).m2639unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            jM2628copywmQWz5c$default = Color.m2628copywmQWz5c$default(((Color) objConsume2).m2639unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceableGroup();
        }
        Color colorM2619boximpl = Color.m2619boximpl(jM2628copywmQWz5c$default);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(colorM2619boximpl);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = BorderStrokeKt.m186BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m2004getUnselectedOutlineWidthD9Ej5fM(), jM2628copywmQWz5c$default);

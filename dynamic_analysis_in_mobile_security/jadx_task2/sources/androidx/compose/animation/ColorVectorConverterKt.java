        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            ...
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public final AnimationVector4D m40invoke8_81llA(long j) {
                    long jM2626convertvNxB06k = Color.m2626convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m2623component4impl(jM2626convertvNxB06k), Color.m2620component1impl(jM2626convertvNxB06k), Color.m2621component2impl(jM2626convertvNxB06k), Color.m2622component3impl(jM2626convertvNxB06k));
                }
                ...
                public final long m41invokevNxB06k(AnimationVector4D vector) {
                    ...
                    return Color.m2626convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(vector.getV2(), 0.0f, 1.0f), RangesKt.coerceIn(vector.getV3(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV4(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };

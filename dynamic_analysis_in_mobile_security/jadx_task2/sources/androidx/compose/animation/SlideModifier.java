...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m76targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long jM5001getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5001getZeronOccac() : slideOffset2.invoke(IntSize.m5025boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long jM5001getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5001getZeronOccac() : slideOffset.invoke(IntSize.m5025boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m5001getZeronOccac();
        }
        if (i == 2) {
            return jM5001getZeronOccac;
        }
        if (i == 3) {
            return jM5001getZeronOccac2;
        }
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final long jIntSize = IntSizeKt.IntSize(placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight());
        return MeasureScope.layout$default(measure, placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3926placeWithLayeraW9wM$default(layout, placeableMo3866measureBRTryo0, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final long m77invokeBjo55l4(EnterExitState it) {
                        ...
                        return slideModifier.m76targetValueByStateoFUgxo0(it, j2);
                    }

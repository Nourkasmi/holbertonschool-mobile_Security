        ...
        return MeasureScope.layout$default(measure, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long jMo2280alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo2280alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i3, i4), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m4991getXimpl(jMo2280alignKFBX0sM), IntOffset.m4992getYimpl(jMo2280alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);

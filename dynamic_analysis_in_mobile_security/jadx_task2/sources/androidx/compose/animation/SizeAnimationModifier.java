...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long jM69animateTomzRDjE0 = m69animateTomzRDjE0(IntSizeKt.IntSize(placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight()));
        return MeasureScope.layout$default(measure, IntSize.m5033getWidthimpl(jM69animateTomzRDjE0), IntSize.m5032getHeightimpl(jM69animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            {
                super(1);
            }

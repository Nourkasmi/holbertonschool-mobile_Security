...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.layoutDirection = layoutDirection;
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5025boximpl(IntSize.INSTANCE.m5038getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo14slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        ...
        return m33isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m5033getWidthimpl(this.m32getCurrentSizeYbymL2g()) - IntOffset.m4991getXimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m32getCurrentSizeYbymL2g()))));
            }
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m4991getXimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m32getCurrentSizeYbymL2g()))) - i));
            }
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m5032getHeightimpl(this.m32getCurrentSizeYbymL2g()) - IntOffset.m4992getYimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m32getCurrentSizeYbymL2g()))));
            }
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m4992getYimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m32getCurrentSizeYbymL2g()))) - i));
            }
    ...
    public ExitTransition mo15slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        ...
        return m33isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m4991getXimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g()))) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m4991getXimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m5033getWidthimpl(packedValue)));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m4992getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g()))) - i));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5038getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m4992getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m5032getHeightimpl(packedValue)));
            }
        ...
        public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo75createAnimationSpecTemP2vQ;
                    ...
                    return (value == null || (finiteAnimationSpecMo75createAnimationSpecTemP2vQ = value.mo75createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo75createAnimationSpecTemP2vQ;
                }
            };
            ...
            final long jMo2280alignKFBX0sM = this.this$0.getContentAlignment().mo2280alignKFBX0sM(IntSizeKt.IntSize(placeableMo3866measureBRTryo0.getWidth(), placeableMo3866measureBRTryo0.getHeight()), stateAnimate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m5033getWidthimpl(stateAnimate.getValue().getPackedValue()), IntSize.m5032getHeightimpl(stateAnimate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m3923place70tqf50$default(layout, placeableMo3866measureBRTryo0, jMo2280alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }

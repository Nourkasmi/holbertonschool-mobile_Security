...
public final class LongSaturatedMathKt {
    ...
    public static final long m6615saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        ...
        long jM6532toLongimpl = Duration.m6532toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m6614checkInfiniteSumDefinedPjuGub4(j, j2, jM6532toLongimpl);
        }
        if ((1 | (jM6532toLongimpl - 1)) == Long.MAX_VALUE) {
            return m6616saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM6532toLongimpl;
        return ((j ^ j3) & (jM6532toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }
    ...
    private static final long m6616saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM6489divUwyO8pc = Duration.m6489divUwyO8pc(j2, 2);
        long jM6532toLongimpl = Duration.m6532toLongimpl(jM6489divUwyO8pc, durationUnit);
        return (1 | (jM6532toLongimpl - 1)) == Long.MAX_VALUE ? jM6532toLongimpl : m6615saturatingAddNuflL3o(m6615saturatingAddNuflL3o(j, durationUnit, jM6489divUwyO8pc), durationUnit, Duration.m6521minusLRDsOJo(j2, jM6489divUwyO8pc));
    }

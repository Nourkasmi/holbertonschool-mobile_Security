...
public final class DurationKt {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM6589getZEROUwyO8pc = Duration.INSTANCE.m6589getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM6522plusLRDsOJo = Duration.m6522plusLRDsOJo(jM6589getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM6589getZEROUwyO8pc = Duration.m6522plusLRDsOJo(jM6522plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM6589getZEROUwyO8pc = Duration.m6522plusLRDsOJo(jM6589getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM6589getZEROUwyO8pc = Duration.INSTANCE.m6587getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM6522plusLRDsOJo2 = Duration.m6522plusLRDsOJo(jM6589getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        String str6 = str4;
                        Intrinsics.checkNotNullExpressionValue(strSubstring7, str6);
                        jM6589getZEROUwyO8pc = Duration.m6522plusLRDsOJo(jM6522plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                        str4 = str6;
                    } else {
                        jM6589getZEROUwyO8pc = Duration.m6522plusLRDsOJo(jM6589getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m6539unaryMinusUwyO8pc(jM6589getZEROUwyO8pc) : jM6589getZEROUwyO8pc;
    }
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m6486constructorimpl((j << 1) + ((long) i));
    }

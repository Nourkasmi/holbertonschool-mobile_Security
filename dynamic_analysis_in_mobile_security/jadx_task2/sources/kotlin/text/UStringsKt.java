...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5256constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5256constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM5256constructorimpl = UInt.m5256constructorimpl(i);
        int iM$1 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                if (iM$1 == 119304647) {
                    iM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1, iM5256constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM5256constructorimpl2 = UInt.m5256constructorimpl(i3 * iM5256constructorimpl);
            int iM5256constructorimpl3 = UInt.m5256constructorimpl(UInt.m5256constructorimpl(iDigitOf) + iM5256constructorimpl2);
            if (Integer.compare(iM5256constructorimpl3 ^ Integer.MIN_VALUE, iM5256constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM5256constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM5335constructorimpl = ULong.m5335constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM5335constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM5335constructorimpl2 = ULong.m5335constructorimpl(j * jM5335constructorimpl);
            long jM5335constructorimpl3 = ULong.m5335constructorimpl(ULong.m5335constructorimpl(((long) UInt.m5256constructorimpl(iDigitOf)) & 4294967295L) + jM5335constructorimpl2);
            if (Long.compare(jM5335constructorimpl3 ^ Long.MIN_VALUE, jM5335constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM5335constructorimpl3;
        }

...
public class URangesKt___URangesKt {
    ...
    public static final boolean m6419containsULbyJY(ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m6398containsVKZWuLQ(ULong.m5335constructorimpl(((long) b) & 255));
    }
    ...
    public static final boolean m6418containsGab390E(ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m6398containsVKZWuLQ(ULong.m5335constructorimpl(((long) i) & 4294967295L));
    }
    ...
    public static final boolean m6423containsuhHAxoY(ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m6398containsVKZWuLQ(ULong.m5335constructorimpl(((long) s) & 65535));
    }
    ...
    public static final UIntProgression step(UIntProgression uIntProgression, int i) {
        ...
        int iM6384getFirstpVg5ArA = uIntProgression.getFirst();
        int iM6385getLastpVg5ArA = uIntProgression.getLast();
        if (uIntProgression.getStep() <= 0) {
            i = -i;
        }
        return companion.m6386fromClosedRangeNkh28Cs(iM6384getFirstpVg5ArA, iM6385getLastpVg5ArA, i);
    }
    ...
    public static final ULongProgression step(ULongProgression uLongProgression, long j) {
        ...
        long jM6393getFirstsVKNKU = uLongProgression.getFirst();
        long jM6394getLastsVKNKU = uLongProgression.getLast();
        if (uLongProgression.getStep() <= 0) {
            j = -j;
        }
        return companion.m6395fromClosedRange7ftBX0g(jM6393getFirstsVKNKU, jM6394getLastsVKNKU, j);
    }
    ...
    public static final UIntRange m6429untilJ1ME1BU(int i, int i2) {
        return Integer.compare(i2 ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m5256constructorimpl(i2 - 1), null);
    }
    ...
    public static final ULongRange m6431untileb3DHEI(long j, long j2) {
        return Long.compare(j2 ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m5335constructorimpl(j2 - ULong.m5335constructorimpl(((long) 1) & 4294967295L)), null);
    }

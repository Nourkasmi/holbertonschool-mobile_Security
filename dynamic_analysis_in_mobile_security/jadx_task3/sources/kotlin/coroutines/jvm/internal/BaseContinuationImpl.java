    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM5499constructorimpl = Result.m5499constructorimpl(outcome);
            Object outcome2 = objM5499constructorimpl;

...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m6707getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM5673constructorimpl = ((int) ULong.m5673constructorimpl(j ^ ULong.m5673constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM5673constructorimpl2 = (iM5673constructorimpl + ((int) ULong.m5673constructorimpl(j2 ^ ULong.m5673constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM5673constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m5719toStringimpl(this.first)).append("..").append((Object) ULong.m5719toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m5719toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m5719toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m6733fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {

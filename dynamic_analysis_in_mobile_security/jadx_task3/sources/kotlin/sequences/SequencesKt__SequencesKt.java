...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C05831<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C05831(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C05831> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05831 c05831 = new C05831(this.$this_ifEmpty, this.$defaultValue, continuation);
            c05831.L$0 = obj;
            return c05831;
        }
        ...
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C05831) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C05831(sequence, defaultValue, null));
    }
    ...
    static final class C05841<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05841(Sequence<? extends T> sequence, Random random, Continuation<? super C05841> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05841 c05841 = new C05841(this.$this_shuffled, this.$random, continuation);
            c05841.L$0 = obj;
            return c05841;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C05841) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c05841 = this;
                    sequenceScope = (SequenceScope) c05841.L$0;
                    mutableList = SequencesKt.toMutableList(c05841.$this_shuffled);
                    break;
                case 1:
                    c05841 = this;
                    mutableList = (List) c05841.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c05841.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c05841.$random.nextInt(mutableList.size());
                ...
                c05841.L$0 = sequenceScope;
                c05841.L$1 = mutableList;
                c05841.label = 1;
                if (sequenceScope.yield(objRemoveLast, c05841) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C05841(sequence, random, null));
    }
    ...
    static final class C05791<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05791(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C05791> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05791 c05791 = new C05791(this.$source, this.$transform, this.$iterator, continuation);
            c05791.L$0 = obj;
            return c05791;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c05791 = this;
                    sequenceScope = (SequenceScope) c05791.L$0;
                    i = 0;
                    it = c05791.$source.iterator();
                    break;
                case 1:
                    c05791 = this;
                    i = c05791.I$0;
                    it = (Iterator) c05791.L$1;
                    sequenceScope = (SequenceScope) c05791.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c05791.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c05791.L$0 = sequenceScope;
                c05791.L$1 = it;
                c05791.I$0 = i2;
                c05791.label = 1;
                if (sequenceScope.yieldAll(c05791.$iterator.invoke((C) objInvoke), c05791) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C05791(source, transform, iterator, null));
    }

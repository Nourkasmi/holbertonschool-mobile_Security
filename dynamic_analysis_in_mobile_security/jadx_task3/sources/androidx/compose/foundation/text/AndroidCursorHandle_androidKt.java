...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m5212constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m5212constructorimpl(Dp.m5212constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m737CursorHandleULxng0E(final long handlePosition, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m870HandlePopupULxng0E(handlePosition, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda($composer2, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(Composer composer, int i) {
                AndroidCursorHandle_androidKt.m737CursorHandleULxng0E(handlePosition, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m530sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.DefaultCursorHandle.1
            ...
            public final void invoke(Composer composer, int i) {
                AndroidCursorHandle_androidKt.DefaultCursorHandle(modifier, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final Modifier drawCursorHandle(Modifier $this$drawCursorHandle) {
        ...
        return ComposedModifierKt.composed$default($this$drawCursorHandle, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Object key1$iv = Color.m2937boximpl(handleColor);
                ...
                if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final float radius = Size.m2777getWidthimpl(drawWithCache.m2614getSizeNHjbRc()) / 2.0f;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    $this$invoke_u24lambda_u240.mo3420rotateUv8p0NA(45.0f, Offset.INSTANCE.m2724getZeroF1C5BW0());
                                    DrawScope.m3474drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);

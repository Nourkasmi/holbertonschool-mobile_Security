...
public final class TextFieldCursorKt {
    ...
    private static final float DefaultCursorThickness = Dp.m5212constructorimpl(2);
        ...
        return enabled ? ComposedModifierKt.composed$default($this$cursor, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (brush instanceof SolidColor) {
                    ...
                    if ($this$isUnspecified$iv == Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                        z = false;
                    }
                }
                boolean isBrushSpecified = z;
                if (state.getHasFocus() && TextRange.m4715getCollapsedimpl(value.getSelection()) && isBrushSpecified) {
                    EffectsKt.LaunchedEffect(value.getText(), TextRange.m4709boximpl(value.getSelection()), new C00261(cursorAlpha, null), $composer, 512);
                    ...
                    companionDrawWithContent = DrawModifierKt.drawWithContent(composed, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt.cursor.1.2
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            if (!(cursorAlphaValue == 0.0f)) {
                                int transformedOffset = offsetMapping2.originalToTransformed(TextRange.m4721getStartimpl(textFieldValue.getSelection()));
                                ...
                                float cursorWidth = drawWithContent.mo326toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                                float f = 2;
                                float cursorX = RangesKt.coerceAtMost(cursorRect.getLeft() + (cursorWidth / f), Size.m2777getWidthimpl(drawWithContent.mo3489getSizeNHjbRc()) - (cursorWidth / f));
                                DrawScope.m3475drawLine1RTmtNc$default(drawWithContent, brush2, OffsetKt.Offset(cursorX, cursorRect.getTop()), OffsetKt.Offset(cursorX, cursorRect.getBottom()), cursorWidth, 0, null, cursorAlphaValue, null, 0, 432, null);
                            }
                        }
                    });
                } else {
                    ...
                    */
                    public final java.lang.Object invokeSuspend(java.lang.Object r12) {
                        ...
                        L52:
                            ...
                            return r1
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextFieldCursorKt.AnonymousClass1.C00261.C00271.invokeSuspend(java.lang.Object):java.lang.Object");
                    }
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.label = 1;
                            if (BuildersKt.withContext(FixedMotionDurationScale.INSTANCE, new C00271(this.$cursorAlpha, null), this) == coroutine_suspended) {

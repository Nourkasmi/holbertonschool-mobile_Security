...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m4726getZerod9O1mEE();
    ...
    public final void m824setPreviousSelection5zctL8(long j) {
    ...
    */
    ...
    public final int m822getOffsetToFollow5zctL8(long selection) {
        return TextRange.m4721getStartimpl(selection) != TextRange.m4721getStartimpl(this.previousSelection) ? TextRange.m4721getStartimpl(selection) : TextRange.m4716getEndimpl(selection) != TextRange.m4716getEndimpl(this.previousSelection) ? TextRange.m4716getEndimpl(selection) : TextRange.m4719getMinimpl(selection);
    }

...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m4907getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m4933getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m4880getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m763copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m764copy3m2b7yw(i, z, i2, i3);
    }

    /* JADX INFO: renamed from: copy-3m2b7yw, reason: not valid java name */
    public final KeyboardOptions m764copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m4898equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && this.autoCorrect == ((KeyboardOptions) other).autoCorrect && KeyboardType.m4913equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m4868equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m4899hashCodeimpl(this.capitalization);
        return (((((result * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4914hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4869hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4900toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4915toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4870toStringimpl(this.imeAction)) + ')';
    }
}

...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo38measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        long jM5158copyZbe2FdA;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m5167getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth >= Constraints.m5168getMaxWidthimpl(constraints)) {
            jM5158copyZbe2FdA = Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : 0);
        } else {
            jM5158copyZbe2FdA = constraints;
        }
        long childConstraints = jM5158copyZbe2FdA;
        final Placeable placeable = measurable.mo4183measureBRTryo0(childConstraints);
        final int width = Math.min(placeable.getWidth(), Constraints.m5168getMaxWidthimpl(constraints));
        return MeasureScope.layout$default(measure, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Rect cursorRect = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measure.getLayoutDirection() == LayoutDirection.Rtl, placeable.getWidth());

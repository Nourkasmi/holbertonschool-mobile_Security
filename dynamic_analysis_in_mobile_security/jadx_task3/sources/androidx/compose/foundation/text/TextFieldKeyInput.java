...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m814typedCommandZmokQxo(KeyEvent event) {
        Integer numM758consumeZmokQxo;
        if (!TextFieldKeyInput_androidKt.m819isTypedEventZmokQxo(event) || (numM758consumeZmokQxo = this.keyCombiner.m758consumeZmokQxo(event)) == null) {
            return null;
        }
        int codePoint = numM758consumeZmokQxo.intValue();
    ...
    public final boolean m815processZmokQxo(KeyEvent event) {
        final KeyCommand command;
        Intrinsics.checkNotNullParameter(event, "event");
        CommitTextCommand it = m814typedCommandZmokQxo(event);
        if (it != null) {
            if (!this.editable) {
                return false;
            }
        ...
        if (!KeyEventType.m3925equalsimpl0(KeyEvent_androidKt.m3933getTypeZmokQxo(event), KeyEventType.INSTANCE.m3929getKeyDownCS__XNY()) || (command = this.keyMapping.mo760mapZmokQxo(event)) == null || (command.getEditsText() && !this.editable)) {
            return false;
        }
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[command.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m4716getEndimpl(deleteIfSelectedOr.getSelection()) - deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m4716getEndimpl(deleteIfSelectedOr.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr3 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (previousWordOffset != null) {
                                    ...
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4716getEndimpl(deleteIfSelectedOr.getSelection()) - it4, 0);
                                } else {
                        ...
                        List<EditCommand> listDeleteIfSelectedOr4 = commandExecutionContext.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
                                ...
                                if (nextWordOffset != null) {
                                    ...
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(0, it4 - TextRange.m4716getEndimpl(deleteIfSelectedOr.getSelection()));
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            this.getState().getOnImeActionPerformed().invoke(ImeAction.m4865boximpl(this.imeAction));
                        }
                        break;
                    case 27:
                        if (!this.getSingleLine()) {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (!TextRange.m4714equalsimpl0(preparedSelection.getSelection(), this.value.getSelection()) || !Intrinsics.areEqual(preparedSelection.getAnnotatedString(), this.value.getText())) {

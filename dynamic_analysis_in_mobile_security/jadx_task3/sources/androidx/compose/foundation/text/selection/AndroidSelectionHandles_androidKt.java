...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m871SelectionHandle8fL75g(final long position, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m870HandlePopupULxng0E(position, handleReferencePoint, ComposableLambdaKt.composableLambda($composer3, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        if (function2 == null) {
                            ...
                            Object key2$iv = Offset.m2697boximpl(position);
                            ...
                            if (!invalid$iv$iv) {
                                ...
                                Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(modifier2, false, (Function1) value$iv$iv, 1, null);
                                boolean z2 = isStartHandle;
                                ResolvedTextDirection resolvedTextDirection = direction;
                                boolean z3 = handlesCrossed;
                                int i3 = $dirty2;
                                AndroidSelectionHandles_androidKt.DefaultSelectionHandle(modifierSemantics$default, z2, resolvedTextDirection, z3, $composer4, (i3 & 112) | (i3 & 896) | (i3 & 7168));
                                $composer4.endReplaceableGroup();
                            }
                            ...
                            $composer4.endReplaceableGroup();
                            Modifier modifierSemantics$default2 = SemanticsModifierKt.semantics$default(modifier2, false, (Function1) value$iv$iv, 1, null);
                            boolean z22 = isStartHandle;
                            ResolvedTextDirection resolvedTextDirection2 = direction;
                            boolean z32 = handlesCrossed;
                            int i32 = $dirty2;
                            AndroidSelectionHandles_androidKt.DefaultSelectionHandle(modifierSemantics$default2, z22, resolvedTextDirection2, z32, $composer4, (i32 & 112) | (i32 & 896) | (i32 & 7168));
                            $composer4.endReplaceableGroup();
                        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(Composer composer, int i) {
                AndroidSelectionHandles_androidKt.m871SelectionHandle8fL75g(position, isStartHandle, direction, handlesCrossed, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DefaultSelectionHandle(final Modifier modifier, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m530sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), isStartHandle, direction, handlesCrossed), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.DefaultSelectionHandle.1
            ...
            public final void invoke(Composer composer, int i) {
                AndroidSelectionHandles_androidKt.DefaultSelectionHandle(modifier, isStartHandle, direction, handlesCrossed, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final Modifier drawSelectionHandle(Modifier $this$drawSelectionHandle, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed) {
        ...
        return ComposedModifierKt.composed$default($this$drawSelectionHandle, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.drawSelectionHandle.1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Object[] keys$iv = {Color.m2937boximpl(handleColor), Boolean.valueOf(isStartHandle), direction, Boolean.valueOf(handlesCrossed)};
                final boolean z = isStartHandle;
                ...
                if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            float radius = Size.m2777getWidthimpl(drawWithCache.m2614getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap handleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, radius);
                            final ColorFilter colorFilter = ColorFilter.Companion.m2988tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            final boolean z3 = z;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    boolean isLeft = AndroidSelectionHandles_androidKt.isLeft(z3, resolvedTextDirection2, z4);
                                    if (isLeft) {
                                        ContentDrawScope $this$scale_u2dFgt4K4Q_u24default$iv = onDrawWithContent;
                                        ImageBitmap imageBitmap = handleImage;
                                        ColorFilter colorFilter2 = colorFilter;
                                        long pivot$iv = $this$scale_u2dFgt4K4Q_u24default$iv.mo3488getCenterF1C5BW0();
                                        ...
                                        $this$scale_Fgt4K4Q_u24lambda_u242$iv.mo3421scale0AR0LA0(-1.0f, 1.0f, pivot$iv);
                                        DrawScope.m3474drawImagegbVJVH8$default($this$scale_u2dFgt4K4Q_u24default$iv, imageBitmap, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
                                        $this$withTransform_u24lambda_u246$iv$iv.mo3415setSizeuvyYCjk(previousSize$iv$iv);
                                        return;
                                    }
                                    DrawScope.m3474drawImagegbVJVH8$default(onDrawWithContent, handleImage, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                }
                            });
                        }
                    };
                ...
                Modifier modifierThen = composed.then(DrawModifierKt.drawWithCache(companion, (Function1) value$iv$iv));
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge > imageBitmap2.getWidth() || edge > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m3168ImageBitmapx__hDU$default(edge, edge, ImageBitmapConfig.INSTANCE.m3162getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv.m3413setSizeuvyYCjk(size$iv);
        canvas.save();
        CanvasDrawScope $this$createHandleImage_u24lambda_u240 = this_$iv;
        DrawScope.m3484drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, Color.INSTANCE.m2973getBlack0d7_KjU(), 0L, $this$createHandleImage_u24lambda_u240.mo3489getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m2864getClear0nO6VwU(), 58, null);
        DrawScope.m3484drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), Offset.INSTANCE.m2724getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(radius, radius), 0.0f, null, null, 0, 120, null);
        DrawScope.m3471drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), radius, OffsetKt.Offset(radius, radius), 0.0f, null, null, 0, 120, null);
        canvas.restore();

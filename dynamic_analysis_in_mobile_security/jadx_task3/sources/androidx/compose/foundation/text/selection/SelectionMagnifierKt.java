...
public final class SelectionMagnifierKt {
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect(Unit.INSTANCE, new C02661(targetValue$delegate, animatable, null), $composer, 70);
    ...
    static final class C02661 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02661(State<Offset> state, Animatable<Offset, AnimationVector2D> animatable, Continuation<? super C02661> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02661 c02661 = new C02661(this.$targetValue$delegate, this.$animatable, continuation);
            c02661.L$0 = obj;
            return c02661;
        }

...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m4935copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (TextRange.m4715getCollapsedimpl(getSelection())) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m4719getMinimpl(getSelection()), TextRange.m4719getMinimpl(getSelection()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r10, int r11) {
        ...
        L1c:
            ...
            int r2 = androidx.compose.ui.text.TextRange.m4716getEndimpl(r2)
            ...
            float r3 = r2.getLeft()
            float r4 = r2.getTop()
            long r5 = r0.m2741getSizeNHjbRc()
            float r5 = androidx.compose.ui.geometry.Size.m2774getHeightimpl(r5)
            float r6 = (float) r11
            float r5 = r5 * r6
            float r4 = r4 + r5
            ...
            int r6 = r6.m4693getOffsetForPositionk4lQ0M(r7)

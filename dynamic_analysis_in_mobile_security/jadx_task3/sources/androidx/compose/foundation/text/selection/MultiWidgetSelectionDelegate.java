...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult $this$lastVisibleOffset) {
        ...
        if (this._previousTextLayoutResult != $this$lastVisibleOffset) {
            if (!$this$lastVisibleOffset.getDidOverflowHeight() || $this$lastVisibleOffset.getMultiParagraph().getDidExceedMaxLines()) {
                ...
                finalVisibleLine = RangesKt.coerceAtMost($this$lastVisibleOffset.getLineForVerticalPosition(IntSize.m5371getHeightimpl($this$lastVisibleOffset.getSize())), $this$lastVisibleOffset.getLineCount() - 1);
                while ($this$lastVisibleOffset.getLineTop(finalVisibleLine) >= IntSize.m5371getHeightimpl($this$lastVisibleOffset.getSize())) {
                    finalVisibleLine--;
                }
            }
    ...
    public Pair<Selection, Boolean> mo878updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection) {
        ...
        Offset offsetM2697boximpl = null;
        if (layoutCoordinates != null && (textLayoutResult = this.layoutResultCallback.invoke()) != null) {
            long relativePosition = containerLayoutCoordinates.mo4191localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m2724getZeroF1C5BW0());
            long localStartPosition = Offset.m2712minusMKHz9U(startHandlePosition, relativePosition);
            long localEndPosition = Offset.m2712minusMKHz9U(endHandlePosition, relativePosition);
            if (previousHandlePosition != null) {
                long it = previousHandlePosition.getPackedValue();
                offsetM2697boximpl = Offset.m2697boximpl(Offset.m2712minusMKHz9U(it, relativePosition));
            }
            Offset localPreviousHandlePosition = offsetM2697boximpl;
            return MultiWidgetSelectionDelegateKt.m882getTextSelectionInfoyM0VcXU(textLayoutResult, localStartPosition, localEndPosition, localPreviousHandlePosition, getSelectableId(), adjustment, previousSelection, isStartHandle);
        }
    ...
    public Selection getSelectAllSelection() {
        ...
        return MultiWidgetSelectionDelegateKt.m880getAssembledSelectionInfovJH6DeI(newSelectionRange, false, getSelectableId(), textLayoutResult);
    }

    @Override // androidx.compose.foundation.text.selection.Selectable
    /* JADX INFO: renamed from: getHandlePosition-dBAh8RU, reason: not valid java name */
    public long mo876getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResult;
    ...
    public long mo877getRangeOfLineContainingjx7JFs(int offset) {

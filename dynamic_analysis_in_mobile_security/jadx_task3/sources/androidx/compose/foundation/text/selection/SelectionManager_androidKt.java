...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m929isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo760mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
    ...
    static final class AnonymousClass1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
            ...
            if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
                value$iv$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5364boximpl(IntSize.INSTANCE.m5377getZeroYbymL2g()), null, 2, null);
            ...
            Function0<Offset> function0 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m2697boximpl(m930invokeF1C5BW0());
                }

                /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m930invokeF1C5BW0() {
                    return SelectionManagerKt.m927calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, AnonymousClass1.invoke$lambda$1(magnifierSize$delegate));
                }
            };
                    ...
                    public final Modifier invoke2(final Function0<Offset> center) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m2697boximpl(m931invoketuRUvjQ(density2));
                            }

                            /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m931invoketuRUvjQ(Density magnifier) {
                        ...
                        return MagnifierKt.magnifier(companion2, function1, (6 & 2) != 0 ? new Function1<Density, Offset>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density3) {
                                return Offset.m2697boximpl(m216invoketuRUvjQ(density3));
                            }

                            /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m216invoketuRUvjQ(Density $this$null) {
                                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                                return Offset.INSTANCE.m2723getUnspecifiedF1C5BW0();
                            }
                        } : null, (6 & 4) != 0 ? Float.NaN : 0.0f, (6 & 8) != 0 ? MagnifierStyle.INSTANCE.getDefault() : textDefault, (6 & 16) != 0 ? null : new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                                m932invokeEaSLcWc(dpSize.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
                            public final void m932invokeEaSLcWc(long size) {
                                MutableState<IntSize> mutableState2 = mutableState;
                                Density $this$invoke_EaSLcWc_u24lambda_u240 = density2;
                                SelectionManager_androidKt.AnonymousClass1.invoke$lambda$2(mutableState2, IntSizeKt.IntSize($this$invoke_EaSLcWc_u24lambda_u240.mo320roundToPx0680j_4(DpSize.m5310getWidthD9Ej5fM(size)), $this$invoke_EaSLcWc_u24lambda_u240.mo320roundToPx0680j_4(DpSize.m5308getHeightD9Ej5fM(size))));
                            }
                        });
                    }
                };
        ...
        public static final void invoke$lambda$2(MutableState<IntSize> mutableState, long value) {
            mutableState.setValue(IntSize.m5364boximpl(value));
        }
    }
}

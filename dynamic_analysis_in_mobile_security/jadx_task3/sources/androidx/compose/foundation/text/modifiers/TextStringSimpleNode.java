...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m5131getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m869updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        ...
        if (!TextOverflow.m5124equalsimpl0(this.overflow, overflow)) {
            this.overflow = overflow;
            return true;
        }
        return changed;
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        ...
        if (textChanged || layoutChanged) {
            getLayoutCache().m856updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode.applySemantics.1
                ...
                public final Boolean invoke(List<TextLayoutResult> textLayoutResult) {
                    ...
                    TextLayoutResult it = TextStringSimpleNode.this.getLayoutCache().slowCreateTextLayoutResultOrNull();
                    if (it != null) {
    ...
    public MeasureResult mo238measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m854layoutWithConstraintsK40F9xA(constraints, measure.getLayoutDirection());
        ...
        if (didChangeLayout) {
            ...
            if (map == null) {
                Map cache = new LinkedHashMap(2);
                map = cache;
            }
            map.put(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(MathKt.roundToInt(paragraph.getFirstBaseline())));
            map.put(AlignmentLineKt.getLastBaseline(), Integer.valueOf(MathKt.roundToInt(paragraph.getLastBaseline())));
            this.baselineCache = map;
        }
        final Placeable placeable = measurable.mo4183measureBRTryo0(Constraints.INSTANCE.m5176fixedJhjzzOo(IntSize.m5372getWidthimpl(layoutSize), IntSize.m5371getHeightimpl(layoutSize)));
        int iM5372getWidthimpl = IntSize.m5372getWidthimpl(layoutSize);
        int iM5371getHeightimpl = IntSize.m5371getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map2 = this.baselineCache;
        Intrinsics.checkNotNull(map2);
        return measure.layout(iM5372getWidthimpl, iM5371getHeightimpl, map2, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0079 A[Catch: all -> 0x006c, TRY_ENTER, TRY_LEAVE, TryCatch #2 {all -> 0x006c, blocks: (B:10:0x0065, B:17:0x0079, B:21:0x0088, B:26:0x0097, B:30:0x00b5, B:44:0x00ec), top: B:67:0x0065 }] */
    /* JADX WARN: Removed duplicated region for block: B:21:0x0088 A[Catch: all -> 0x006c, TRY_ENTER, TRY_LEAVE, TryCatch #2 {all -> 0x006c, blocks: (B:10:0x0065, B:17:0x0079, B:21:0x0088, B:26:0x0097, B:30:0x00b5, B:44:0x00ec), top: B:67:0x0065 }] */
    /* JADX WARN: Removed duplicated region for block: B:26:0x0097 A[Catch: all -> 0x006c, TRY_ENTER, TRY_LEAVE, TryCatch #2 {all -> 0x006c, blocks: (B:10:0x0065, B:17:0x0079, B:21:0x0088, B:26:0x0097, B:30:0x00b5, B:44:0x00ec), top: B:67:0x0065 }] */
    /* JADX WARN: Removed duplicated region for block: B:28:0x00b1 A[Catch: all -> 0x0122, TRY_ENTER, TRY_LEAVE, TryCatch #1 {all -> 0x0122, blocks: (B:8:0x005d, B:15:0x0071, B:19:0x0080, B:23:0x008d, B:28:0x00b1, B:33:0x00c0, B:39:0x00d7, B:46:0x00f5, B:32:0x00ba), top: B:65:0x005d }] */
    ...
    */
    public void draw(androidx.compose.ui.graphics.drawscope.ContentDrawScope r29) throws java.lang.Throwable {
        /*

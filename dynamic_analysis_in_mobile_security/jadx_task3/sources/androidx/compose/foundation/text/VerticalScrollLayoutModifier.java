...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo38measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final int height = Math.min(placeable.getHeight(), Constraints.m5167getMaxHeightimpl(constraints));
        return MeasureScope.layout$default(measure, placeable.getWidth(), height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Rect cursorRect = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, false, placeable.getWidth());

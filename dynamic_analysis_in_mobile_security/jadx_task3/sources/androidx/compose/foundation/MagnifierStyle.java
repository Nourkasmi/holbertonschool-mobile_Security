...
public final class MagnifierStyle {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.INSTANCE.m5319getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof MagnifierStyle) && this.useTextDefault == ((MagnifierStyle) other).useTextDefault && DpSize.m5307equalsimpl0(this.size, ((MagnifierStyle) other).size) && Dp.m5217equalsimpl0(this.cornerRadius, ((MagnifierStyle) other).cornerRadius) && Dp.m5217equalsimpl0(this.elevation, ((MagnifierStyle) other).elevation) && this.clippingEnabled == ((MagnifierStyle) other).clippingEnabled && this.fishEyeEnabled == ((MagnifierStyle) other).fishEyeEnabled;
    }

    public int hashCode() {
        int result = Boolean.hashCode(this.useTextDefault);
        return (((((((((result * 31) + DpSize.m5312hashCodeimpl(this.size)) * 31) + Dp.m5218hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5218hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }

    public String toString() {
        return this.useTextDefault ? "MagnifierStyle.TextDefault" : "MagnifierStyle(size=" + ((Object) DpSize.m5317toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m5223toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m5223toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }

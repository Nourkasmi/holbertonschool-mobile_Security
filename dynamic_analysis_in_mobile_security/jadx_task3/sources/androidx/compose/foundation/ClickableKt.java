...
public final class ClickableKt {
    ...
    public static final Modifier m192clickableXHw0xAI(Modifier clickable, final boolean enabled, final String onClickLabel, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(clickable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ClickableKt$clickable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Modifier modifierM190clickableO2vRcR0 = ClickableKt.m190clickableO2vRcR0(companion, (MutableInteractionSource) value$iv$iv, indication, enabled, onClickLabel, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return modifierM190clickableO2vRcR0;
            }
        });
    }
    ...
    public static final Modifier m190clickableO2vRcR0(Modifier clickable, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final String onClickLabel, final Role role, final Function0<Unit> onClick) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        return InspectableValueKt.inspectableWrapper(clickable, noInspectorInfo, FocusableKt.focusableInNonTouchMode(HoverableKt.hoverable(IndicationKt.indication(Modifier.INSTANCE, interactionSource, indication), interactionSource, enabled), enabled, interactionSource).then(new ClickableElement(interactionSource, enabled, onClickLabel, role, onClick, null)));
    }
    ...
    public static final Modifier m196combinedClickablecJG_KMw(Modifier combinedClickable, final boolean enabled, final String onClickLabel, final Role role, final String onLongClickLabel, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(combinedClickable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable-cJG_KMw$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                $composer.endReplaceableGroup();
                Modifier modifierM194combinedClickableXVZzFYc = ClickableKt.m194combinedClickableXVZzFYc(companion, (MutableInteractionSource) value$iv$iv, indication, enabled, onClickLabel, role, onLongClickLabel, function0, function02, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return modifierM194combinedClickableXVZzFYc;
            }
        });
    }
    ...
    public static final Modifier m194combinedClickableXVZzFYc(Modifier combinedClickable, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final String onClickLabel, final Role role, final String onLongClickLabel, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> onClick) {
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        return InspectableValueKt.inspectableWrapper(combinedClickable, noInspectorInfo, FocusableKt.focusableInNonTouchMode(HoverableKt.hoverable(IndicationKt.indication(Modifier.INSTANCE, interactionSource, indication), interactionSource, enabled), enabled, interactionSource).then(new CombinedClickableElement(interactionSource, enabled, onClickLabel, role, onClick, onLongClickLabel, function0, function02, null)));
    }
    ...
    private static final Modifier genericClickableWithoutGesture_Kqv_Bsg$detectPressAndClickFromKey(Modifier $this$genericClickableWithoutGesture_Kqv_Bsg_u24detectPressAndClickFromKey, final boolean $enabled, final Map<Key, PressInteraction.Press> map, final State<Offset> state, final CoroutineScope $indicationScope, final Function0<Unit> function0, final MutableInteractionSource $interactionSource) {
        return KeyInputModifierKt.onKeyEvent($this$genericClickableWithoutGesture_Kqv_Bsg_u24detectPressAndClickFromKey, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.foundation.ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m201invokeZmokQxo(keyEvent.m3921unboximpl());
            }
            ...
            public final Boolean m201invokeZmokQxo(android.view.KeyEvent keyEvent) {
                ...
                if ($enabled && Clickable_androidKt.m208isPressZmokQxo(keyEvent)) {
                    if (!map.containsKey(Key.m3621boximpl(KeyEvent_androidKt.m3932getKeyZmokQxo(keyEvent)))) {
                        PressInteraction.Press press = new PressInteraction.Press(state.getValue().getPackedValue(), null);
                        map.put(Key.m3621boximpl(KeyEvent_androidKt.m3932getKeyZmokQxo(keyEvent)), press);
                    ...
                    PressInteraction.Press it = map.remove(Key.m3621boximpl(KeyEvent_androidKt.m3932getKeyZmokQxo(keyEvent)));
                    if (it != null) {

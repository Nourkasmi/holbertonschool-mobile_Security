...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if ((before >= 0.0f || Dp.m5217equalsimpl0(before, Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM())) && (after >= 0.0f || Dp.m5217equalsimpl0(after, Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM()))) {
        } else {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m375setBefore0680j_4(this.before);
        node.m374setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m5217equalsimpl0(this.before, otherModifier.before) && Dp.m5217equalsimpl0(this.after, otherModifier.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m5218hashCodeimpl(this.before)) * 31) + Dp.m5218hashCodeimpl(this.after);
    }
}

...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        ...
        node.m445setX0680j_4(this.x);
        node.m446setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5217equalsimpl0(this.x, otherModifierElement.x) && Dp.m5217equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m5218hashCodeimpl(this.x);
        return (((result * 31) + Dp.m5218hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5223toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5223toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }

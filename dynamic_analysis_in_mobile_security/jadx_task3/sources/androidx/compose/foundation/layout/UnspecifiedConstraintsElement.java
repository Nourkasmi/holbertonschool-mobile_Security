...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("minWidth", Dp.m5210boximpl(this.minWidth));
        $this$inspectableProperties.getProperties().set("minHeight", Dp.m5210boximpl(this.minHeight));
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        return (other instanceof UnspecifiedConstraintsElement) && Dp.m5217equalsimpl0(this.minWidth, ((UnspecifiedConstraintsElement) other).minWidth) && Dp.m5217equalsimpl0(this.minHeight, ((UnspecifiedConstraintsElement) other).minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5218hashCodeimpl(this.minWidth) * 31) + Dp.m5218hashCodeimpl(this.minHeight);
    }
}

    ...
    public MeasureResult mo238measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                long offsetValue = this.this$0.getOffset().invoke(measure).getPackedValue();
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeable, IntOffset.m5330getXimpl(offsetValue), IntOffset.m5331getYimpl(offsetValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, placeable, IntOffset.m5330getXimpl(offsetValue), IntOffset.m5331getYimpl(offsetValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }

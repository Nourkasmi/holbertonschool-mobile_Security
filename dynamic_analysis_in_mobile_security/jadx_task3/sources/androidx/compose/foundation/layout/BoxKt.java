...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo12measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long constraints) {
            Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
            Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
            return MeasureScope.layout$default(MeasurePolicy, Constraints.m5170getMinWidthimpl(constraints), Constraints.m5169getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean propagateMinConstraints) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt.boxMeasurePolicy.1
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo12measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long constraints) {
                long jM5158copyZbe2FdA;
                int boxWidth;
                int boxHeight;
                Placeable placeable;
                Intrinsics.checkNotNullParameter(MeasurePolicy, "$this$MeasurePolicy");
                ...
                if (measurables.isEmpty()) {
                    return MeasureScope.layout$default(MeasurePolicy, Constraints.m5170getMinWidthimpl(constraints), Constraints.m5169getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        @Override // kotlin.jvm.functions.Function1
                        public /* bridge */ /* synthetic */ Unit invoke(Placeable.PlacementScope placementScope) {
                            invoke2(placementScope);
                            return Unit.INSTANCE;
                ...
                if (propagateMinConstraints) {
                    jM5158copyZbe2FdA = constraints;
                } else {
                    jM5158copyZbe2FdA = Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : 0);
                }
                long contentConstraints = jM5158copyZbe2FdA;
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    if (!BoxKt.getMatchesParentSize(measurable)) {
                        placeable = measurable.mo4183measureBRTryo0(contentConstraints);
                        boxWidth = Math.max(Constraints.m5170getMinWidthimpl(constraints), placeable.getWidth());
                        boxHeight = Math.max(Constraints.m5169getMinHeightimpl(constraints), placeable.getHeight());
                    } else {
                        boxWidth = Constraints.m5170getMinWidthimpl(constraints);
                        boxHeight = Constraints.m5169getMinHeightimpl(constraints);
                        placeable = measurable.mo4183measureBRTryo0(Constraints.INSTANCE.m5176fixedJhjzzOo(Constraints.m5170getMinWidthimpl(constraints), Constraints.m5169getMinHeightimpl(constraints)));
                    }
                    ...
                    return MeasureScope.layout$default(MeasurePolicy, boxWidth, boxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            BoxKt.placeInBox(layout, placeable2, measurable, MeasurePolicy.getLayoutDirection(), i, i2, alignment2);
                        }
                    }, 4, null);
                }
                final Placeable[] placeables = new Placeable[measurables.size()];
                final Ref.IntRef boxWidth2 = new Ref.IntRef();
                boxWidth2.element = Constraints.m5170getMinWidthimpl(constraints);
                final Ref.IntRef boxHeight2 = new Ref.IntRef();
                boxHeight2.element = Constraints.m5169getMinHeightimpl(constraints);
                ...
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    ...
                    if (BoxKt.getMatchesParentSize(measurable2)) {
                        ...
                        Placeable placeable3 = measurable2.mo4183measureBRTryo0(contentConstraints);
                ...
                if (hasMatchParentSizeChildren) {
                    ...
                    for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                        ...
                        if (BoxKt.getMatchesParentSize(measurable3)) {
                            placeables[index2] = measurable3.mo4183measureBRTryo0(matchParentSizeConstraints);
                        }
                    }
                }
    ...
    public static final void placeInBox(Placeable.PlacementScope $this$placeInBox, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int boxWidth, int boxHeight, Alignment alignment) {
        ...
        long position = childAlignment.mo2598alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(boxWidth, boxHeight), layoutDirection);
        Placeable.PlacementScope.m4240place70tqf50$default($this$placeInBox, placeable, position, 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Box)199@7940L70:Box.kt#2w3rfo");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-211209833, $dirty, -1, "androidx.compose.foundation.layout.Box (Box.kt:198)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, -1253624724, "C:Box.kt#2w3rfo");

...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public /* synthetic */ CombinedClickableElement(MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, String str2, Function0 function02, Function0 function03, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(mutableInteractionSource, z, str, role2, function0, str2, function02, function03, null);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int result4 = (((result3 + (role != null ? Role.m4560hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;

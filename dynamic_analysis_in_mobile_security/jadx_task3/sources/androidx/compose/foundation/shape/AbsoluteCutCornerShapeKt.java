...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m718AbsoluteCutCornerShape0680j_4(float size) {
        return AbsoluteCutCornerShape(CornerSizeKt.m726CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ AbsoluteCutCornerShape m720AbsoluteCutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m719AbsoluteCutCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: AbsoluteCutCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteCutCornerShape m719AbsoluteCutCornerShapea9UjIt4(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m726CornerSize0680j_4(topLeft), CornerSizeKt.m726CornerSize0680j_4(topRight), CornerSizeKt.m726CornerSize0680j_4(bottomRight), CornerSizeKt.m726CornerSize0680j_4(bottomLeft));
    }

...
public final class AbsoluteRoundedCornerShapeKt {
    ...
    public static final AbsoluteRoundedCornerShape m722AbsoluteRoundedCornerShape0680j_4(float size) {
        return AbsoluteRoundedCornerShape(CornerSizeKt.m726CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ AbsoluteRoundedCornerShape m724AbsoluteRoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m723AbsoluteRoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: AbsoluteRoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteRoundedCornerShape m723AbsoluteRoundedCornerShapea9UjIt4(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        return new AbsoluteRoundedCornerShape(CornerSizeKt.m726CornerSize0680j_4(topLeft), CornerSizeKt.m726CornerSize0680j_4(topRight), CornerSizeKt.m726CornerSize0680j_4(bottomRight), CornerSizeKt.m726CornerSize0680j_4(bottomLeft));
    }

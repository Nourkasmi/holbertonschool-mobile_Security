...
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m727CutCornerShape0680j_4(float size) {
        return CutCornerShape(CornerSizeKt.m726CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ CutCornerShape m729CutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m728CutCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: CutCornerShape-a9UjIt4, reason: not valid java name */
    public static final CutCornerShape m728CutCornerShapea9UjIt4(float topStart, float topEnd, float bottomEnd, float bottomStart) {
        return new CutCornerShape(CornerSizeKt.m726CornerSize0680j_4(topStart), CornerSizeKt.m726CornerSize0680j_4(topEnd), CornerSizeKt.m726CornerSize0680j_4(bottomEnd), CornerSizeKt.m726CornerSize0680j_4(bottomStart));
    }

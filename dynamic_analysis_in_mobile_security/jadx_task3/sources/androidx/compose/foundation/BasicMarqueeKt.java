...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5212constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m166basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        ...
        int iM231getImmediatelyZbEOnfQ = (i5 & 2) != 0 ? MarqueeAnimationMode.INSTANCE.m231getImmediatelyZbEOnfQ() : i2;
        int i7 = (i5 & 4) != 0 ? DefaultMarqueeDelayMillis : i3;
        if ((i5 & 8) != 0) {
            i6 = MarqueeAnimationMode.m225equalsimpl0(iM231getImmediatelyZbEOnfQ, MarqueeAnimationMode.INSTANCE.m231getImmediatelyZbEOnfQ()) ? i7 : 0;
        } else {
            i6 = i4;
        }
        return m165basicMarquee1Mj1MLw(modifier, i, iM231getImmediatelyZbEOnfQ, i7, i6, (i5 & 16) != 0 ? DefaultMarqueeSpacing : marqueeSpacing, (i5 & 32) != 0 ? DefaultMarqueeVelocity : f);
    }
    ...
    public static final AnimationSpec<Float> m167createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        float pxPerSec = density.mo326toPx0680j_4(velocity);
        ...
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m92infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, startOffset, 2, null);
        }
        return AnimationSpecKt.m94repeatable91I0pcU$default(iterations, tweenSpecVelocityBasedTween, null, startOffset, 4, null);
    }
    ...
    public static final MarqueeSpacing m163MarqueeSpacing0680j_4(final float spacing) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$MarqueeSpacing$1
            ...
            public final int calculateSpacing(Density MarqueeSpacing, int i, int i2) {
                ...
                return MarqueeSpacing.mo320roundToPx0680j_4(spacing);
            }
        };
    }
}

...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m2724getZeroF1C5BW0();
    ...
    public boolean mo142onKeyEventZmokQxo(KeyEvent event) {
        ...
        if (this.enabled && Clickable_androidKt.m208isPressZmokQxo(event)) {
            if (this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3621boximpl(KeyEvent_androidKt.m3932getKeyZmokQxo(event)))) {
                return false;
            }
            PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
            this.interactionData.getCurrentKeyPressInteractions().put(Key.m3621boximpl(KeyEvent_androidKt.m3932getKeyZmokQxo(event)), press);
        ...
        PressInteraction.Press it = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3621boximpl(KeyEvent_androidKt.m3932getKeyZmokQxo(event)));
        if (it != null) {

...
abstract class AbstractClickablePointerInputNode extends DelegatingNode implements ModifierLocalModifierNode, CompositionLocalConsumerModifierNode, PointerInputModifierNode {
    ...
    protected final Object m148handlePressInteractiond4ec7I(PressGestureScope $this$handlePressInteraction_u2dd_u2d4ec7I, long offset, Continuation<? super Unit> continuation) {
        Object objM200handlePressInteractionEPk0efs;
        MutableInteractionSource interactionSource = this.interactionSource;
        return (interactionSource == null || (objM200handlePressInteractionEPk0efs = ClickableKt.m200handlePressInteractionEPk0efs($this$handlePressInteraction_u2dd_u2d4ec7I, offset, interactionSource, this.interactionData, this.delayPressInteraction, continuation)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) ? Unit.INSTANCE : objM200handlePressInteractionEPk0efs;
    }

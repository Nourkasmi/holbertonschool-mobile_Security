...
public final class LazyLayoutItemContentFactoryKt {
    ...
    public static final void m636SkippableItemJVlU9Rs(final LazyLayoutItemProvider itemProvider, final Object saveableStateHolder, final int index, final Object key, Composer $composer, final int $changed) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactoryKt$SkippableItem$2
            ...
            public final void invoke(Composer composer, int i) {
                LazyLayoutItemContentFactoryKt.m636SkippableItemJVlU9Rs(itemProvider, saveableStateHolder, index, key, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
}

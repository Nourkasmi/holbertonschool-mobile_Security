                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        if (active$iv) {
                            ...
                            LazyLayoutItemContentFactoryKt.m636SkippableItemJVlU9Rs(itemProvider, StableValue.m644constructorimpl(lazyLayoutItemContentFactory2.saveableStateHolder), index, StableValue.m644constructorimpl(cachedItemContent.getKey()), $composer, 0);

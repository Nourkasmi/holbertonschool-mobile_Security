...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo641schedulePrefetch0kLqBqw(int index, long constraints);
    }
    ...
    /* JADX INFO: renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m640schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle prefetchHandleMo641schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (prefetchHandleMo641schedulePrefetch0kLqBqw = prefetcher.mo641schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : prefetchHandleMo641schedulePrefetch0kLqBqw;
    }
}

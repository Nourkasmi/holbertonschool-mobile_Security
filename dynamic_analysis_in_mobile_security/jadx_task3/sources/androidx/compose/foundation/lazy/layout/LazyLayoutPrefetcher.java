...
public final class LazyLayoutPrefetcher implements RememberObserver, LazyLayoutPrefetchState.Prefetcher, Runnable, Choreographer.FrameCallback {
                            ...
                            try {
                                ...
                                try {
                                    if (enoughTimeLeft(beforeTimeNs, nextFrameNs, this.averagePrecomposeTimeNs)) {
                                        ...
                                        request.setPrecomposeHandle(this.subcomposeLayoutState.precompose(key, this.itemContentFactory.getContent(request.getIndex(), key, contentType)));
                            ...
                            try {
                                ...
                                if (enoughTimeLeft(beforeTimeNs2, nextFrameNs, this.averagePremeasureTimeNs)) {
                                    ...
                                    for (int i = 0; i < placeablesCount; i++) {
                                        ...
                                        handle.mo4204premeasure0kLqBqw(placeableIndex, request.getConstraints());
                                    }
    ...
    public LazyLayoutPrefetchState.PrefetchHandle mo641schedulePrefetch0kLqBqw(int index, long constraints) {

...
public final class LazyLayoutSemanticsKt {
    public static final Modifier lazyLayoutSemantics(Modifier $this$lazyLayoutSemantics, final Function0<? extends LazyLayoutItemProvider> itemProviderLambda, final LazyLayoutSemanticState state, Orientation orientation, boolean userScrollEnabled, boolean reverseScrolling, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            final Function2<Float, Float, Boolean> function2 = userScrollEnabled ? new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$scrollByAction$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
            ...
            final Function1<Integer, Boolean> function12 = userScrollEnabled ? new Function1<Integer, Boolean>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$scrollToIndexAction$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
        ...
        $composer.endReplaceableGroup();
        Modifier modifierThen = $this$lazyLayoutSemantics.then((Modifier) value$iv$iv);
        if (ComposerKt.isTraceInProgress()) {

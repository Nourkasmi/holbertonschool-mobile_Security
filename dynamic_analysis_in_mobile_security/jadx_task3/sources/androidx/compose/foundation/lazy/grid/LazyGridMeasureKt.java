...
public final class LazyGridMeasureKt {
    ...
    public static final LazyGridMeasureResult m616measureLazyGridZRKPzZ8(int itemsCount, LazyGridMeasuredLineProvider measuredLineProvider, LazyGridMeasuredItemProvider measuredItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenLines, int firstVisibleLineIndex, int firstVisibleLineScrollOffset, float scrollToBeConsumed, long constraints, boolean isVertical, Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, boolean reverseLayout, Density density, LazyGridItemPlacementAnimator placementAnimator, LazyGridSpanLayoutProvider spanLayoutProvider, List<Integer> pinnedItems, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (itemsCount <= 0) {
            return new LazyGridMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m5170getMinWidthimpl(constraints)), Integer.valueOf(Constraints.m5169getMinHeightimpl(constraints)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$1
        ...
        while (index$iv$iv3 < size) {
            ...
            Object item$iv$iv = list5.get(index$iv$iv3);
            int index$iv = ((Number) item$iv$iv).intValue();
            int scrollDelta4 = scrollDelta;
            int it2 = (index$iv < 0 || index$iv >= firstItemIndex2) ? 0 : 1;
            if (it2 != 0) {
                long constraints$iv = measuredLineProvider.m622itemConstraintsOenEA2s(index$iv);
                ...
                i2 = i3;
                LazyGridMeasuredItem measuredItem$iv = LazyGridMeasuredItemProvider.m619getAndMeasure3p2s80s$default(measuredItemProvider, index$iv, 0, constraints$iv, 2, null);
                if (arrayList3 != null) {
        ...
        List<Integer> list6 = pinnedItems;
        int size2 = list6.size();
        ArrayList arrayList4 = null;
        int index$iv$iv4 = 0;
        while (index$iv$iv4 < size2) {
            Object item$iv$iv2 = list6.get(index$iv$iv4);
            ...
            if (it3 != 0) {
                long constraints$iv2 = measuredLineProvider.m622itemConstraintsOenEA2s(index$iv2);
                lastItemIndex = lastItemIndex3;
                index$iv$iv = index$iv$iv4;
                i = size2;
                list2 = list6;
                LazyGridMeasuredItem measuredItem$iv2 = LazyGridMeasuredItemProvider.m619getAndMeasure3p2s80s$default(measuredItemProvider, index$iv2, 0, constraints$iv2, 2, null);
                if (arrayList4 != null) {
        ...
        if (isVertical) {
            layoutWidth = Constraints.m5168getMaxWidthimpl(constraints);
        } else {
            layoutWidth = ConstraintsKt.m5182constrainWidthK40F9xA(constraints, currentMainAxisOffset);
        }
        if (isVertical) {
            layoutHeight = ConstraintsKt.m5181constrainHeightK40F9xA(constraints, currentMainAxisOffset);
        } else {
            layoutHeight = Constraints.m5167getMaxHeightimpl(constraints);
        }
        final List<LazyGridMeasuredItem> listCalculateItemsOffsets = calculateItemsOffsets(visibleLines, extraItemsBefore, extraItemsAfter, layoutWidth, layoutHeight, currentMainAxisOffset, mainAxisAvailableSize, visibleLinesScrollOffset3, isVertical, verticalArrangement, horizontalArrangement, reverseLayout, density);
        int currentMainAxisOffset10 = currentMainAxisOffset;
        placementAnimator.onMeasured((int) consumedScroll3, layoutWidth, layoutHeight, listCalculateItemsOffsets, measuredItemProvider, spanLayoutProvider, isVertical);
        boolean z = lastItemIndex4 != itemsCount + (-1) || currentMainAxisOffset10 > mainAxisAvailableSize;
        MeasureResult measureResultInvoke = layout.invoke(Integer.valueOf(layoutWidth), Integer.valueOf(layoutHeight), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$3
            ...
            public final void invoke2(Placeable.PlacementScope invoke) {
                ...
                for (int index$iv3 = 0; index$iv3 < size5; index$iv3++) {
                    Object item$iv2 = list7.get(index$iv3);
        ...
        if (extraItemsBefore.isEmpty() && extraItemsAfter.isEmpty()) {
            ...
            ArrayList target$iv = new ArrayList(listCalculateItemsOffsets.size());
            List<LazyGridMeasuredItem> list7 = listCalculateItemsOffsets;
            int size5 = list7.size();
            int $i$f$fastFilter = 0;
            while ($i$f$fastFilter < size5) {
                LazyGridMeasuredItem lazyGridMeasuredItem3 = list7.get($i$f$fastFilter);
                int i6 = size5;
        ...
        return new LazyGridMeasureResult(firstLine, currentFirstLineScrollOffset8, z, consumedScroll3, measureResultInvoke, list, i5, index5, itemsCount, reverseLayout, isVertical ? Orientation.Vertical : Orientation.Horizontal, afterContentPadding, spaceBetweenLines);
    }
    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(List<Integer> list, LazyGridMeasuredItemProvider measuredItemProvider, Function1<? super Integer, Constraints> function1, Function1<? super Integer, Boolean> function12) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (function12.invoke(Integer.valueOf(index)).booleanValue()) {
                ...
                LazyGridMeasuredItem measuredItem = LazyGridMeasuredItemProvider.m619getAndMeasure3p2s80s$default(measuredItemProvider, index, 0, constraints, 2, null);
                if (arrayList == null) {
        ...
        if (hasSpareSpace) {
            ...
            if ((step > 0 && index <= last) || (step < 0 && last <= index)) {
                while (true) {
                    ...
                    if (reverseLayout) {
                        mainAxisSize = (mainAxisLayoutSize - absoluteOffset) - line.getMainAxisSize();
                    } else {
                        mainAxisSize = absoluteOffset;
                    }
                    int relativeOffset = mainAxisSize;
            ...
            List<LazyGridMeasuredLine> list6 = list;
            int index$iv2 = 0;
            ...
            List<LazyGridMeasuredItem> list7 = list3;
            int size4 = list7.size();
            int currentMainAxis4 = currentMainAxis3;
            int index$iv3 = 0;
            while (index$iv3 < size4) {
                Object item$iv3 = list7.get(index$iv3);

...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m668childConstraintsJhjzzOo(int requestedSlot, int requestedSpan) {
        int end;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m5178fixedWidthOenEA2s(end);
        }
        return Constraints.INSTANCE.m5177fixedHeightOenEA2s(end);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m669getAndMeasurejy6DScQ(int index, long span) {
        ...
        return createItem(index, (int) (span >> 32), ((int) (4294967295L & span)) - ((int) (span >> 32)), key, contentType, this.measureScope.mo639measure0kLqBqw(index, m668childConstraintsJhjzzOo((int) (span >> 32), $i$f$unpackInt2 - ((int) (span >> 32)))));
    }

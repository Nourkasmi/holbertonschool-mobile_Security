...
public final class LazyStaggeredGridKt {
    ...
    public static final void m657LazyStaggeredGridLJWHXA8(final LazyStaggeredGridState state, final Orientation orientation, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Modifier modifier, PaddingValues contentPadding, boolean reverseLayout, FlingBehavior flingBehavior, boolean userScrollEnabled, float mainAxisSpacing, float crossAxisSpacing, final Function1<? super LazyStaggeredGridScope, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        PaddingValues contentPadding2 = (i & 16) != 0 ? PaddingKt.m474PaddingValues0680j_4(Dp.m5212constructorimpl(0)) : contentPadding;
        ...
        float mainAxisSpacing2 = (i & 256) != 0 ? Dp.m5212constructorimpl(0) : mainAxisSpacing;
        float crossAxisSpacing2 = (i & 512) != 0 ? Dp.m5212constructorimpl(0) : crossAxisSpacing;
        ...
        Function0<LazyStaggeredGridItemProvider> function0RememberStaggeredGridItemProviderLambda = LazyStaggeredGridItemProviderKt.rememberStaggeredGridItemProviderLambda(state, content, $composer2, (($changed1 << 3) & 112) | 8);
        int $dirty4 = $dirty;
        final boolean reverseLayout3 = reverseLayout2;
        final Modifier modifier3 = modifier2;
        Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> function2M666rememberStaggeredGridMeasurePolicynbWgWpA = LazyStaggeredGridMeasurePolicyKt.m666rememberStaggeredGridMeasurePolicynbWgWpA(state, function0RememberStaggeredGridItemProviderLambda, contentPadding2, reverseLayout2, orientation, mainAxisSpacing2, crossAxisSpacing2, slots, $composer2, (($dirty >> 6) & 896) | 8 | (($dirty >> 6) & 7168) | (($dirty << 9) & 57344) | (($dirty >> 9) & 458752) | (($dirty >> 9) & 3670016) | (($dirty << 15) & 29360128));
        ...
        ScrollPositionUpdater(function0RememberStaggeredGridItemProviderLambda, state, $composer2, 64);
        ...
        LazyLayoutKt.LazyLayout(function0RememberStaggeredGridItemProviderLambda, ScrollableKt.scrollable(modifierOverscroll, state, orientation, overscrollEffect, userScrollEnabled2, scrollableDefaults.reverseDirection((LayoutDirection) objConsume, orientation, reverseLayout3), flingBehavior2, state.getMutableInteractionSource()), state.getPrefetchState(), function2M666rememberStaggeredGridMeasurePolicynbWgWpA, $composer2, 0, 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(Composer composer, int i2) {
                LazyStaggeredGridKt.m657LazyStaggeredGridLJWHXA8(state, orientation, slots, modifier3, paddingValues, reverseLayout3, flingBehavior4, z, f, f2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m666rememberStaggeredGridMeasurePolicynbWgWpA(final LazyStaggeredGridState state, final Function0<? extends LazyStaggeredGridItemProvider> itemProviderLambda, final PaddingValues contentPadding, final boolean reverseLayout, final Orientation orientation, final float mainAxisSpacing, float crossAxisSpacing, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Composer $composer, int $changed) {
        ...
        Object[] keys$iv = {state, itemProviderLambda, contentPadding, Boolean.valueOf(reverseLayout), orientation, Dp.m5210boximpl(mainAxisSpacing), Dp.m5210boximpl(crossAxisSpacing), slots};
        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final LazyStaggeredGridMeasureResult m667invoke0kLqBqw(LazyLayoutMeasureScope $this$null, long constraints) {
                    Intrinsics.checkNotNullParameter($this$null, "$this$null");
                    CheckScrollableContainerConstraintsKt.m188checkScrollableContainerConstraintsK40F9xA(constraints, orientation);
                    LazyStaggeredGridSlots resolvedSlots = slots.invoke($this$null, Constraints.m5156boximpl(constraints));
                    ...
                    int beforeContentPadding = $this$null.mo320roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(contentPadding, orientation, reverseLayout, $this$null.getLayoutDirection()));
                    int afterContentPadding = $this$null.mo320roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(contentPadding, orientation, reverseLayout, $this$null.getLayoutDirection()));
                    int startContentPadding = $this$null.mo320roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(contentPadding, orientation, $this$null.getLayoutDirection()));
                    int maxMainAxisSize = isVertical ? Constraints.m5167getMaxHeightimpl(constraints) : Constraints.m5168getMaxWidthimpl(constraints);
                    ...
                    int horizontalPadding = $this$null.mo320roundToPx0680j_4(Dp.m5212constructorimpl(arg0$iv + other$iv));
                    ...
                    int verticalPadding = $this$null.mo320roundToPx0680j_4(Dp.m5212constructorimpl(arg0$iv2 + other$iv2));
                    ...
                    int iM5182constrainWidthK40F9xA = ConstraintsKt.m5182constrainWidthK40F9xA(constraints, horizontalPadding);
                    int horizontalPadding2 = ConstraintsKt.m5181constrainHeightK40F9xA(constraints, verticalPadding);
                    LazyStaggeredGridMeasureResult it = LazyStaggeredGridMeasureKt.m665measureStaggeredGriddSVRQoE($this$null, state, listCalculateLazyLayoutPinnedIndices, itemProvider, resolvedSlots, Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : iM5182constrainWidthK40F9xA, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : horizontalPadding2, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : 0), isVertical, reverseLayout, contentOffset, mainAxisAvailableSize, $this$null.mo320roundToPx0680j_4(mainAxisSpacing), beforeContentPadding, afterContentPadding);

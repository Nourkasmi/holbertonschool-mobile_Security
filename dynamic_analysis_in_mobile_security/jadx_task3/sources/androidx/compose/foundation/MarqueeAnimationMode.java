...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m223constructorimpl(0);
    private static final int WhileFocused = m223constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m222boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m223constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m224equalsimpl(int i, Object obj) {
    ...
    public static int m226hashCodeimpl(int i) {
    ...
    public static String m227toStringimpl(int arg0) {
        if (m225equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m225equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m229getImmediatelyZbEOnfQ$annotations() {
        }

        /* JADX INFO: renamed from: getWhileFocused-ZbEOnfQ$annotations, reason: not valid java name */
        public static /* synthetic */ void m230getWhileFocusedZbEOnfQ$annotations() {
        }

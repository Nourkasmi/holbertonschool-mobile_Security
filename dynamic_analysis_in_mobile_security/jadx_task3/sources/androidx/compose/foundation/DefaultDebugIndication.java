...
final class DefaultDebugIndication implements Indication {
    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope $this$drawIndication) {
            ...
            if (!this.isPressed.getValue().booleanValue()) {
                ...
                long jM2973getBlack0d7_KjU = Color.INSTANCE.m2973getBlack0d7_KjU();
                DrawScope.m3484drawRectnJ9OG0$default($this$drawIndication, Color.m2945copywmQWz5c(jM2973getBlack0d7_KjU, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM2973getBlack0d7_KjU) : 0.1f, (14 & 2) != 0 ? Color.m2953getRedimpl(jM2973getBlack0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM2973getBlack0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM2973getBlack0d7_KjU) : 0.0f), 0L, $this$drawIndication.mo3489getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
                return;
            }
            long jM2973getBlack0d7_KjU2 = Color.INSTANCE.m2973getBlack0d7_KjU();
            DrawScope.m3484drawRectnJ9OG0$default($this$drawIndication, Color.m2945copywmQWz5c(jM2973getBlack0d7_KjU2, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM2973getBlack0d7_KjU2) : 0.3f, (14 & 2) != 0 ? Color.m2953getRedimpl(jM2973getBlack0d7_KjU2) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM2973getBlack0d7_KjU2) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM2973getBlack0d7_KjU2) : 0.0f), 0L, $this$drawIndication.mo3489getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
        }
    }
    ...
    public IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        State<Boolean> stateCollectIsPressedAsState = PressInteractionKt.collectIsPressedAsState(interactionSource, $composer, $changed & 14);
        State<Boolean> stateCollectIsHoveredAsState = HoverInteractionKt.collectIsHoveredAsState(interactionSource, $composer, $changed & 14);
        State<Boolean> stateCollectIsFocusedAsState = FocusInteractionKt.collectIsFocusedAsState(interactionSource, $composer, $changed & 14);
        int i = $changed & 14;
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new DefaultDebugIndicationInstance(stateCollectIsPressedAsState, stateCollectIsHoveredAsState, stateCollectIsFocusedAsState);

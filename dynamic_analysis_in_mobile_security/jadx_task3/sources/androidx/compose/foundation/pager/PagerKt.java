...
public final class PagerKt {
    ...
    public static final void m692HorizontalPagerxYaah8o(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i17 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty13 & 731) == 146 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                contentPadding2 = i10 != 0 ? PaddingKt.m474PaddingValues0680j_4(Dp.m5212constructorimpl(0)) : contentPadding;
                PageSize pageSize4 = i11 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                int beyondBoundsPageCount3 = i12 != 0 ? 0 : i2;
                float pageSpacing3 = i13 != 0 ? Dp.m5212constructorimpl(0) : pageSpacing;
                Alignment.Vertical verticalAlignment3 = i14 != 0 ? Alignment.INSTANCE.getCenterVertically() : vertical;
                if ((i & 128) != 0) {
                    $dirty1 = $dirty13;
                    $composer2 = $composer3;
                    i5 = i3;
                    ...
                    i7 = 1491175841;
                    i8 = i17;
                    flingBehavior2 = PagerDefaults.INSTANCE.m690flingBehaviorPfoAEA0(state, null, null, null, null, 0.0f, 0.0f, $composer3, ($dirty & 14) | 12582912, 126);
                    $dirty &= -29360129;
                } else {
                    $dirty1 = $dirty13;
                    $composer2 = $composer3;
            ...
            LazyLayoutPagerKt.m686Pagerfs30GE4(modifier3, state, contentPadding2, reverseLayout2, Orientation.Horizontal, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function12, Alignment.INSTANCE.getCenterHorizontally(), verticalAlignment2, pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), (($dirty12 << 3) & 112) | 392 | (($dirty2 >> 9) & 7168) | (($dirty12 << 6) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        final int i19 = beyondBoundsPageCount2;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$1
            ...
            public final void invoke(Composer composer, int i20) {
                PagerKt.m692HorizontalPagerxYaah8o(state, modifier5, paddingValues, pageSize5, i19, f, vertical2, snapFlingBehavior, z, z2, function14, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m691HorizontalPagerAlbwjTQ(final int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed & 896) == 0) {
            if ((i & 4) == 0) {
                state2 = state;
                int i12 = $composer2.changed(state2) ? 256 : 128;
                $dirty4 |= i12;
            } else {
                state2 = state;
            }
        ...
        if (($changed & 234881024) == 0) {
            if ((i & 256) == 0) {
                ...
                int i18 = $composer2.changed(snapFlingBehavior) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
                $dirty4 |= i18;
            } else {
                snapFlingBehavior = flingBehavior;
            }
        ...
        if (i22 == 4096 && (1533916891 & $dirty4) == 306783378 && ($dirty13 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                contentPadding2 = i13 != 0 ? PaddingKt.m474PaddingValues0680j_4(Dp.m5212constructorimpl(0)) : contentPadding;
                pageSize3 = i14 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                beyondBoundsPageCount2 = i15 != 0 ? 0 : beyondBoundsPageCount;
                pageSpacing2 = i16 != 0 ? Dp.m5212constructorimpl(0) : pageSpacing;
                verticalAlignment2 = i7 != 0 ? Alignment.INSTANCE.getCenterVertically() : verticalAlignment;
                if ((i & 256) != 0) {
                    flingBehavior2 = PagerDefaults.INSTANCE.m690flingBehaviorPfoAEA0(state3, null, null, null, null, 0.0f, 0.0f, $composer2, (($dirty >> 6) & 14) | 12582912, 126);
                    $dirty &= -234881025;
                } else {
                    flingBehavior2 = flingBehavior;
                }
            ...
            LazyLayoutPagerKt.m686Pagerfs30GE4(modifier2, state2, contentPadding2, reverseLayout2, Orientation.Horizontal, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function12, Alignment.INSTANCE.getCenterHorizontally(), verticalAlignment2, pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 >> 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty1 << 9) & 7168) | (($dirty2 >> 9) & 458752) | (($dirty2 >> 9) & 3670016) | (($dirty2 << 6) & 29360128) | (($dirty2 << 6) & 234881024) | (($dirty2 << 15) & 1879048192), ($dirty1 & 112) | 392 | (($dirty2 >> 12) & 7168) | (($dirty1 << 3) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        final Function1<? super Integer, ? extends Object> function14 = function12;
        final NestedScrollConnection nestedScrollConnection = pageNestedScrollConnection2;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer composer, int i25) {
                PagerKt.m691HorizontalPagerAlbwjTQ(pageCount, modifier4, pagerState, paddingValues, pageSize5, i24, f, vertical, snapFlingBehavior2, z, z2, function14, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

    /* JADX INFO: renamed from: VerticalPager-xYaah8o, reason: not valid java name */
    public static final void m694VerticalPagerxYaah8o(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PageSize pageSize2;
        int i2;
        ...
        if (i17 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty13 & 731) == 146 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                int beyondBoundsPageCount3 = i12 != 0 ? 0 : i2;
                float pageSpacing3 = i13 != 0 ? Dp.m5212constructorimpl(0) : pageSpacing;
                Alignment.Horizontal horizontalAlignment3 = i14 != 0 ? Alignment.INSTANCE.getCenterHorizontally() : horizontal;
                if ((i & 128) != 0) {
                    $dirty1 = $dirty13;
                    $composer2 = $composer3;
                    i5 = i3;
            ...
            LazyLayoutPagerKt.m686Pagerfs30GE4(modifier3, state, contentPadding2, reverseLayout2, Orientation.Vertical, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function12, horizontalAlignment2, Alignment.INSTANCE.getCenterVertically(), pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), (($dirty12 << 3) & 112) | 3080 | (($dirty2 >> 12) & 896) | (($dirty12 << 6) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$1
            ...
            public final void invoke(Composer composer, int i20) {
                PagerKt.m694VerticalPagerxYaah8o(state, modifier5, paddingValues, pageSize5, i19, f, horizontal2, snapFlingBehavior, z, z2, function14, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m693VerticalPagerAlbwjTQ(final int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        Modifier modifier2;
        PagerState state2;
        PageSize pageSize2;
        int i2;
        ...
        if (i22 == 4096 && (1533916891 & $dirty4) == 306783378 && ($dirty13 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            LazyLayoutPagerKt.m686Pagerfs30GE4(modifier2, state2, contentPadding2, reverseLayout2, Orientation.Vertical, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function12, horizontalAlignment2, Alignment.INSTANCE.getCenterVertically(), pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 >> 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty1 << 9) & 7168) | (($dirty2 >> 9) & 458752) | (($dirty2 >> 9) & 3670016) | (($dirty2 << 6) & 29360128) | (($dirty2 << 6) & 234881024) | (($dirty2 << 15) & 1879048192), ($dirty1 & 112) | 3080 | (($dirty2 >> 15) & 896) | (($dirty1 << 3) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            flingBehavior4 = flingBehavior3;
        ...
        final Function1<? super Integer, ? extends Object> function14 = function12;
        final NestedScrollConnection nestedScrollConnection = pageNestedScrollConnection2;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer composer, int i25) {
                PagerKt.m693VerticalPagerAlbwjTQ(pageCount, modifier4, pagerState, paddingValues, pageSize5, i24, f, horizontal, snapFlingBehavior2, z, z2, function14, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
        ...
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.pager.PagerKt.SnapLayoutInfoProvider.1
            ...
            */
            public float calculateSnappingOffset(androidx.compose.ui.unit.Density r21, float r22) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.pager.PagerKt.AnonymousClass1.calculateSnappingOffset(androidx.compose.ui.unit.Density, float):float");
            }
            ...
            public float calculateApproachOffset(Density $this$calculateApproachOffset, float initialVelocity) {
                ...
                if (initialVelocity > 0.0f) {
                    fFloor = (float) Math.ceil(targetPageValue);
                } else {
                    fFloor = (float) Math.floor(targetPageValue);
                }
                int targetPage = RangesKt.coerceIn((int) fFloor, 0, pagerState.getPageCount());
    ...
    public static final float dragGestureDelta(PagerState $this$dragGestureDelta) {
        if ($this$dragGestureDelta.getLayoutInfo$foundation_release().getOrientation() == Orientation.Horizontal) {
            return Offset.m2708getXimpl($this$dragGestureDelta.m702getUpDownDifferenceF1C5BW0$foundation_release());
        }
        return Offset.m2709getYimpl($this$dragGestureDelta.m702getUpDownDifferenceF1C5BW0$foundation_release());
    }
}

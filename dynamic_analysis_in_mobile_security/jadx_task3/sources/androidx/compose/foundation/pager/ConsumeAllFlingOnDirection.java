...
final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m685consumeOnOrientationQWom1Mo(long $this$consumeOnOrientation_u2dQWom1Mo, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Velocity.m5433copyOhffZ5M$default($this$consumeOnOrientation_u2dQWom1Mo, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m5433copyOhffZ5M$default($this$consumeOnOrientation_u2dQWom1Mo, 0.0f, 0.0f, 1, null);
    }

    /* JADX INFO: renamed from: consumeOnOrientation-8S9VItk, reason: not valid java name */
    public final long m684consumeOnOrientation8S9VItk(long $this$consumeOnOrientation_u2d8S9VItk, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Offset.m2702copydBAh8RU$default($this$consumeOnOrientation_u2d8S9VItk, 0.0f, 0.0f, 2, null);
        }
        return Offset.m2702copydBAh8RU$default($this$consumeOnOrientation_u2d8S9VItk, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m3957equalsimpl0(source, NestedScrollSource.INSTANCE.m3963getFlingWNlRxjI()) ? m684consumeOnOrientation8S9VItk(available, this.orientation) : Offset.INSTANCE.m2724getZeroF1C5BW0();
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo333onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return Velocity.m5428boximpl(m685consumeOnOrientationQWom1Mo(available, this.orientation));
    }
}

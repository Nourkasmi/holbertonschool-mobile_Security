...
public final class TransformableStateKt {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (SuspendAnimationKt.animateTo(animationStateAnimationState$default, fBoxFloat, (4 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : animationSpec, (4 & 4) != 0 ? false : false, (4 & 8) != 0 ? SuspendAnimationKt.C01572.INSTANCE : function1, this) == coroutine_suspended) {
    ...
    static final class C02012 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ float $zoomFactor;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02012(float f, Continuation<? super C02012> continuation) {
            super(2, continuation);
            this.$zoomFactor = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02012 c02012 = new C02012(this.$zoomFactor, continuation);
            c02012.L$0 = obj;
            return c02012;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(TransformScope transformScope, Continuation<? super Unit> continuation) {
            return ((C02012) create(transformScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object zoomBy(TransformableState $this$zoomBy, float zoomFactor, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.transform$default($this$zoomBy, null, new C02012(zoomFactor, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }
    ...
    static final class C01992 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01992(float f, Continuation<? super C01992> continuation) {
            super(2, continuation);
            this.$degrees = f;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01992 c01992 = new C01992(this.$degrees, continuation);
            c01992.L$0 = obj;
            return c01992;
        }
    ...
    public static final Object rotateBy(TransformableState $this$rotateBy, float degrees, Continuation<? super Unit> continuation) {
        Object objTransform$default = TransformableState.transform$default($this$rotateBy, null, new C01992(degrees, null), continuation, 1, null);
        return objTransform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objTransform$default : Unit.INSTANCE;
    }
    ...
    static final class C02002 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
        ...
        C02002(Continuation<? super C02002> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02002(continuation);
        }
    ...
    public static final Object stopTransformation(TransformableState $this$stopTransformation, MutatePriority terminationPriority, Continuation<? super Unit> continuation) {
        Object objTransform = $this$stopTransformation.transform(terminationPriority, new C02002(null), continuation);

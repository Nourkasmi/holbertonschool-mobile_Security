...
final class ScrollableKt$pointerScrollable$3$1 extends SuspendLambda implements Function3<CoroutineScope, Velocity, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Velocity velocity, Continuation<? super Unit> continuation) {
        return m332invokeLuvzFrg(coroutineScope, velocity.getPackedValue(), continuation);
    }

    /* JADX INFO: renamed from: invoke-LuvzFrg, reason: not valid java name */
    public final Object m332invokeLuvzFrg(CoroutineScope coroutineScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (this.$scrollLogic.getValue().m338onDragStoppedsFctU(this.$velocity, this) == coroutine_suspended) {

...
final class TransformableKt$transformable$3$block$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00151 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00151(State<Boolean> state, Channel<TransformEvent> channel, State<? extends Function0<Boolean>> state2, CoroutineScope coroutineScope, Continuation<? super C00151> continuation) {
                super(2, continuation);
                this.$updatePanZoomLock = state;
                this.$channel = channel;
                this.$updatedCanPan = state2;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00151 c00151 = new C00151(this.$updatePanZoomLock, this.$channel, this.$updatedCanPan, this.$$this$coroutineScope, continuation);
                c00151.L$0 = obj;
                return c00151;
            }
            ...
            /* JADX WARN: Multi-variable type inference failed */
            /* JADX WARN: Removed duplicated region for block: B:28:0x0054 A[Catch: all -> 0x0016, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x0016, blocks: (B:7:0x0012, B:23:0x0048, B:28:0x0054), top: B:31:0x0006 }] */
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r10) {
                ...
                L55:
                    ...
                    r2.mo7001trySendJP2dKIU(r3)
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.TransformableKt$transformable$3$block$1$1.AnonymousClass1.C00151.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(this.$$this$null, new C00151(this.$updatePanZoomLock, this.$channel, this.$updatedCanPan, $this$coroutineScope, null), this) == coroutine_suspended) {

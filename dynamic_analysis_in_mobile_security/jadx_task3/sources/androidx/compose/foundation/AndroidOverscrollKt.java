        ...
        if (Build.VERSION.SDK_INT >= 31) {
            companionLayout = LayoutModifierKt.layout(LayoutModifierKt.layout(Modifier.INSTANCE, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1
                ...
                public final MeasureResult m157invoke3p2s80s(MeasureScope layout, Measurable measurable, long constraints) {
                    ...
                    final int extraSizePx = layout.mo320roundToPx0680j_4(Dp.m5212constructorimpl(2 * arg0$iv));
                    return MeasureScope.layout$default(layout, placeable.getMeasuredWidth() - extraSizePx, placeable.getMeasuredHeight() - extraSizePx, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1.1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout2) {
                            ...
                            Placeable.PlacementScope.placeWithLayer$default(layout2, placeable2, ((-extraSizePx) / 2) - ((placeable2.getWidth() - placeable.getMeasuredWidth()) / 2), ((-extraSizePx) / 2) - ((placeable.getHeight() - placeable.getMeasuredHeight()) / 2), 0.0f, null, 12, null);
                        }
                    }, 4, null);
                }

...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BorderStroke) && Dp.m5217equalsimpl0(this.width, ((BorderStroke) other).width) && Intrinsics.areEqual(this.brush, ((BorderStroke) other).brush);
    }

    public int hashCode() {
        int result = Dp.m5218hashCodeimpl(this.width);
        return (result * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m5223toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }

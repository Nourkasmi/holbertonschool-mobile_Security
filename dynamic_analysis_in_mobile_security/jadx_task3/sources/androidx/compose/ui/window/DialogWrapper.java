...
final class DialogWrapper extends ComponentDialog implements ViewRootForInspector {
    ...
    public DialogWrapper(Function0<Unit> onDismissRequest, DialogProperties properties, View composeView, LayoutDirection layoutDirection, Density density, UUID dialogId) {
        ...
        DialogLayout $this$_init__u24lambda_u241 = new DialogLayout(context2, window);
        ...
        $this$_init__u24lambda_u241.setElevation(density.mo326toPx0680j_4(fM5212constructorimpl));
        ...
        setContentView($this$_init__u24lambda_u241);
        ViewTreeLifecycleOwner.set($this$_init__u24lambda_u241, ViewTreeLifecycleOwner.get(composeView));
        ViewTreeViewModelStoreOwner.set($this$_init__u24lambda_u241, ViewTreeViewModelStoreOwner.get(composeView));
        ViewTreeSavedStateRegistryOwner.set($this$_init__u24lambda_u241, ViewTreeSavedStateRegistryOwner.get(composeView));

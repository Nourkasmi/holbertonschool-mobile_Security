...
public final class SlotTreeKt {
    ...
    */
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = node.getCoordinates().mo4190getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m2708getXimpl(position));
        int top = MathKt.roundToInt(Offset.m2709getYimpl(position));
        int right = IntSize.m5372getWidthimpl(size) + left;
        int bottom = IntSize.m5371getHeightimpl(size) + top;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:114:0x010e A[SYNTHETIC] */

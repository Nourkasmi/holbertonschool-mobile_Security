...
/* JADX INFO: compiled from: TransitionClock.kt */
...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    public TransitionClock(TransitionBasedAnimation<T> animation) {
        ...
        this.state = new TargetState<>(getAnimation().m5139getAnimationObject().getCurrentState(), getAnimation().m5139getAnimationObject().getTargetState());
    }
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        TargetState<T> parametersToValue = UtilsKt.parseParametersToValue(getState().getInitial(), par1, par2);
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = UtilsKt.allAnimations(getAnimation().m5139getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return UtilsKt.nanosToMillis(getAnimation().m5139getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Iterable $this$map$iv = UtilsKt.allAnimations(getAnimation().m5139getAnimationObject());
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m5139getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}

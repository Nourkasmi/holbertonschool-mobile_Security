...
/* JADX INFO: compiled from: AnimatedVisibilityComposeAnimation.kt */
...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String label) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m5147boximpl(AnimatedVisibilityState.INSTANCE.m5154getEnterjXw82LU()), AnimatedVisibilityState.m5147boximpl(AnimatedVisibilityState.INSTANCE.m5155getExitjXw82LU())});
    }

    /* JADX INFO: renamed from: getAnimationObject, reason: merged with bridge method [inline-methods] */
    public Transition<Boolean> m5140getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m5140getAnimationObject().getTransitions(), 0);

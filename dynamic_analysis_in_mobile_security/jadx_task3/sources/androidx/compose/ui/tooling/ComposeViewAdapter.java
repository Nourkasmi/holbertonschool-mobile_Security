...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    public ComposeViewAdapter(Context context, AttributeSet attrs) {
        ...
        this.previewComposition = ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5135getLambda2$ui_tooling_release();
        ...
        $this$debugBoundsPaint_u24lambda_u240.setColor(ColorKt.m3001toArgb8_81llA(Color.INSTANCE.m2981getRed0d7_KjU()));
    ...
    private final void processViewInfos() {
        ...
        List<ViewInfo> list = CollectionsKt.toList((List) destination$iv$iv);
        if (this.stitchTrees) {
            listStitchTrees = ShadowViewInfoKt.stitchTrees(list);
        } else {
            listStitchTrees = list;
        }
        this.viewInfos = listStitchTrees;
        if (this.debugViewInfos) {
            String debugString = ViewInfoUtilKt.toDebugString$default(listStitchTrees, 0, null, 3, null);
    ...
    /* JADX INFO: renamed from: androidx.compose.ui.tooling.ComposeViewAdapter$findAndTrackAnimations$2, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: ComposeViewAdapter.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* synthetic */ class C05322 extends FunctionReferenceImpl implements Function0<Unit> {
        C05322(Object obj) {
    ...
    private final void invalidateComposition() {
        this.content.setValue(ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5136getLambda3$ui_tooling_release());
        this.content.setValue((Function2<Composer, Integer, Unit>) this.previewComposition);
        invalidate();
    }
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{localFontLoader.provides(new LayoutlibFontResourceLoader(context)), localFontFamilyResolver.provides(FontFamilyResolver_androidKt.createFontFamilyResolver(context2)), LocalOnBackPressedDispatcherOwner.INSTANCE.provides(this.FakeOnBackPressedDispatcherOwner), LocalActivityResultRegistryOwner.INSTANCE.provides(this.FakeActivityResultRegistryOwner)}, ComposableLambdaKt.composableLambda($composer2, -1966112531, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter.WrapPreview.1
            ...
            public final void invoke(Composer $composer3, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                    ...
                    InspectableKt.Inspectable(ComposeViewAdapter.this.slotTableRecord, function2, $composer3, ($changed << 3) & 112);
                    if (ComposerKt.isTraceInProgress()) {
    ...
    private final void init(AttributeSet attrs) {
        ...
        Class<? extends PreviewParameterProvider<?>> clsAsPreviewProviderClass = attributeValue != null ? PreviewUtilsKt.asPreviewProviderClass(attributeValue) : null;
        try {
        ...
        init$ui_tooling_release$default(this, className, methodName, clsAsPreviewProviderClass, parameterProviderIndex, attrs.getAttributeBooleanValue("http://schemas.android.com/tools", "paintBounds", this.debugPaintBounds), attrs.getAttributeBooleanValue("http://schemas.android.com/tools", "printViewInfos", this.debugViewInfos), animationClockStartTime, forceCompositionInvalidation, attrs.getAttributeBooleanValue("http://schemas.android.com/tools", "findDesignInfoProviders", this.lookForDesignInfoProviders), attrs.getAttributeValue("http://schemas.android.com/tools", "designInfoProvidersArgument"), null, null, 3072, null);
    }
}

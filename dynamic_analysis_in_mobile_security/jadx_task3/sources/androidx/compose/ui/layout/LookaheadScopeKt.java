...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            C05121 c05121 = new Function0<LayoutNode>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadScope.1
            ...
            if (composerStartRestartGroup.getInserting()) {
                composerStartRestartGroup.createNode(c05121);
            } else {

...
public final class SubcomposeLayoutState {
    ...
    public SubcomposeLayoutState(SubcomposeSlotReusePolicy slotReusePolicy) {
        ...
        this.setRoot = new Function2<LayoutNode, SubcomposeLayoutState, Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutState$setRoot$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutNode layoutNode, SubcomposeLayoutState subcomposeLayoutState) throws Throwable {
                invoke2(layoutNode, subcomposeLayoutState);
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(LayoutNode $this$null, SubcomposeLayoutState it) throws Throwable {
    ...
    public interface PrecomposedSlotHandle {
        ...
        default void mo4204premeasure0kLqBqw(int index, long constraints) {
        }
    }
}

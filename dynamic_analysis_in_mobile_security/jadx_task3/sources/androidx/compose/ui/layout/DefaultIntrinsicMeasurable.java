...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4183measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(width, Constraints.m5167getMaxHeightimpl(constraints));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m5168getMaxWidthimpl(constraints), height);
    }

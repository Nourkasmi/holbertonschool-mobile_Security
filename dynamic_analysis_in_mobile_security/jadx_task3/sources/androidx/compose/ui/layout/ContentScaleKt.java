...
public final class ContentScaleKt {
    ...
    public static final float m4180computeFillMaxDimensioniLBOSCw(long srcSize, long dstSize) {
        float widthScale = m4182computeFillWidthiLBOSCw(srcSize, dstSize);
        float heightScale = m4179computeFillHeightiLBOSCw(srcSize, dstSize);
        return Math.max(widthScale, heightScale);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: computeFillMinDimension-iLBOSCw, reason: not valid java name */
    public static final float m4181computeFillMinDimensioniLBOSCw(long srcSize, long dstSize) {
        float widthScale = m4182computeFillWidthiLBOSCw(srcSize, dstSize);
        float heightScale = m4179computeFillHeightiLBOSCw(srcSize, dstSize);
    ...
    public static final float m4182computeFillWidthiLBOSCw(long srcSize, long dstSize) {
    ...
    public static final float m4179computeFillHeightiLBOSCw(long srcSize, long dstSize) {

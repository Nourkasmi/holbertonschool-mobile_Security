...
public interface MeasurePolicy {
    ...
    MeasureResult mo12measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        MeasureResult layoutResult = mo12measure3p2s80s(layoutReceiver, mapped, constraints);

...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.layout$default(measure, Constraints.m5170getMinWidthimpl(constraints), Constraints.m5169getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (measurables.size() == 1) {
            ...
            return MeasureScope.layout$default(measure, ConstraintsKt.m5182constrainWidthK40F9xA(constraints, placeable.getWidth()), ConstraintsKt.m5181constrainHeightK40F9xA(constraints, placeable.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    Intrinsics.checkNotNullParameter(layout, "$this$layout");
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeable, 0, 0, 0.0f, null, 12, null);
                }
            }, 4, null);
        }
        ...
        return MeasureScope.layout$default(measure, ConstraintsKt.m5182constrainWidthK40F9xA(constraints, maxWidth), ConstraintsKt.m5181constrainHeightK40F9xA(constraints, maxHeight), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4

...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int type$iv4 = NodeKind.m4398constructorimpl(2048);
        int untilType$iv3 = NodeKind.m4398constructorimpl(1024);
        int i4 = 0;
    ...
    public final void m2654fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (!this.isProcessingCustomEnter) {
            this.isProcessingCustomEnter = true;
            try {
                FocusRequester it = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2624boximpl(focusDirection));
    ...
    public final void m2655fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (!this.isProcessingCustomExit) {
            this.isProcessingCustomExit = true;
            try {
                FocusRequester it = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2624boximpl(focusDirection));
                if (it != FocusRequester.INSTANCE.getDefault()) {
                    block.invoke(it);
                }
            } finally {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int iM4398constructorimpl = NodeKind.m4398constructorimpl(4096);
        MutableVector mutableVector2 = null;
            ...
            if (nodePop instanceof FocusEventModifierNode) {
                ...
                if (((this_$iv$iv.getKindSet() & iM4398constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
                    ...
                    while (node$iv$iv != null) {
                        ...
                        if (((next$iv.getKindSet() & iM4398constructorimpl) != 0 ? i : 0) != 0) {
                            count$iv++;
                            if (count$iv == i) {
                                nodePop = next$iv;
                            } else {
        ...
        int i2 = 1024;
        int mask$iv4 = NodeKind.m4398constructorimpl(4096) | NodeKind.m4398constructorimpl(1024);
            ...
            if ((head$iv.getAggregateChildKindSet() & mask$iv4) != 0) {
                while (node$iv != null) {
                    if ((node$iv.getKindSet() & mask$iv4) != 0) {
                        ...
                        if (((it.getKindSet() & NodeKind.m4398constructorimpl(i2)) != 0 ? 1 : $this$visitAncestors_u24default$iv) == 0 && it.getIsAttached()) {
                            int iM4398constructorimpl2 = NodeKind.m4398constructorimpl(4096);
                            ...
                            while (nodePop2 != null) {
                                if (nodePop2 instanceof FocusEventModifierNode) {
                                    ...
                                    if (((this_$iv$iv3.getKindSet() & iM4398constructorimpl2) != 0 ? 1 : $this$visitAncestors_u24default$iv) == 0 || !(nodePop2 instanceof DelegatingNode)) {
                                        $this$visitAncestors_u24default$iv4 = $this$visitAncestors_u24default$iv8;
                                        mask$iv2 = mask$iv4;
                                        includeSelf$iv2 = includeSelf$iv4;
                                        $this$visitAncestors_u24default$iv5 = $this$visitAncestors_u24default$iv;
                                        ...
                                        while (node$iv$iv2 != null) {
                                            ...
                                            if (((next$iv2.getKindSet() & iM4398constructorimpl2) != 0 ? 1 : $this$visitAncestors_u24default$iv) != 0) {
                                                count$iv2++;
                                                if (count$iv2 == 1) {
                                                    nodePop2 = next$iv2;

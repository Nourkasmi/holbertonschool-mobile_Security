...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m2622shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        if ((i & 4) != 0) {
            int $this$dp$iv = Dp.m5211compareTo0680j_4(f, Dp.m5212constructorimpl(0));
            z = $this$dp$iv > 0;
        }
        return m2621shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m2621shadowziNgDLE(Modifier shadow, float elevation, Shape shape, boolean clip) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m2619shadows4CzXII(shadow, elevation, shape, clip, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* JADX INFO: renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m2619shadows4CzXII(Modifier shadow, final float elevation, final Shape shape, final boolean clip, final long ambientColor, final long spotColor) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m5211compareTo0680j_4(elevation, Dp.m5212constructorimpl(0)) <= 0 && !clip) {
            return shadow;
        }
        Function1<InspectorInfo, Unit> noInspectorInfo = InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow-s4CzXII$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("elevation", Dp.m5210boximpl(elevation));
                $this$null.getProperties().set("shape", shape);
                $this$null.getProperties().set("clip", Boolean.valueOf(clip));
                $this$null.getProperties().set("ambientColor", Color.m2937boximpl(ambientColor));
                $this$null.getProperties().set("spotColor", Color.m2937boximpl(spotColor));
            }
        } : InspectableValueKt.getNoInspectorInfo();
        Modifier $this$shadow_s4CzXII_u24lambda_u241 = Modifier.INSTANCE;
        Modifier $this$inspectable$iv = InspectableValueKt.inspectableWrapper(shadow, noInspectorInfo, GraphicsLayerModifierKt.graphicsLayer($this$shadow_s4CzXII_u24lambda_u241, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow$2$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayer) {
                ...
                graphicsLayer.setShadowElevation(graphicsLayer.mo326toPx0680j_4(elevation));
                graphicsLayer.setShape(shape);
                graphicsLayer.setClip(clip);
                graphicsLayer.mo3132setAmbientShadowColor8_81llA(ambientColor);
                graphicsLayer.mo3134setSpotShadowColor8_81llA(spotColor);
            }
        }));

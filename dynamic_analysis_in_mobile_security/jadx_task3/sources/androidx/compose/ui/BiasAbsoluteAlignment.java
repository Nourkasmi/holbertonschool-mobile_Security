...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2598alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long remaining = IntSizeKt.IntSize(IntSize.m5372getWidthimpl(space) - IntSize.m5372getWidthimpl(size), IntSize.m5371getHeightimpl(space) - IntSize.m5371getHeightimpl(size));
        float centerX = IntSize.m5372getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m5371getHeightimpl(remaining) / 2.0f;
        float f = 1;

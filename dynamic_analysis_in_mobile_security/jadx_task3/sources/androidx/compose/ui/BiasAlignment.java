...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2598alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m5372getWidthimpl(space) - IntSize.m5372getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m5371getHeightimpl(space) - IntSize.m5371getHeightimpl(size)) / 2.0f;

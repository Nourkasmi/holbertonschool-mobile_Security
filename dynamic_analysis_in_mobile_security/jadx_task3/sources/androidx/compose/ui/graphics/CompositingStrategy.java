...
public final class CompositingStrategy {
    ...
    private static final int Auto = m3025constructorimpl(0);
    private static final int Offscreen = m3025constructorimpl(1);
    private static final int ModulateAlpha = m3025constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m3024boximpl(int i) {

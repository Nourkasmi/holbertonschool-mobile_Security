...
public final class PaintingStyle {
    ...
    private static final int Fill = m3201constructorimpl(0);
    private static final int Stroke = m3201constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m3200boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3201constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3202equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3203equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3204hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3202equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3204hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3207getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* JADX INFO: renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m3208getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3205toStringimpl(int arg0) {
        return m3203equalsimpl0(arg0, Fill) ? "Fill" : m3203equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }

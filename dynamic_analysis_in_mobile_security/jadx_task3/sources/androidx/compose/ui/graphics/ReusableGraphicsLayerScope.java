...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3330getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3031getAutoNrFUSI();
    private long size = Size.INSTANCE.m2785getUnspecifiedNHjbRc();
    ...
    public void mo3132setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo3134setSpotShadowColor8_81llA(long j) {
    ...
    public void mo3135setTransformOrigin__ExYCQ(long j) {
    ...
    public void mo3133setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m3251setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3132setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3134setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3135setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3330getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3133setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3031getAutoNrFUSI());
        m3251setSizeuvyYCjk(Size.INSTANCE.m2785getUnspecifiedNHjbRc());
    }
}

...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m3276constructorimpl(0);
    private static final int Rotate = m3276constructorimpl(1);
    private static final int Morph = m3276constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3275boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3276constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3277equalsimpl(int i, Object obj) {
    ...
    public static int m3279hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3277equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3279hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3284getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* JADX INFO: renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m3283getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* JADX INFO: renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m3282getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3280toStringimpl(int arg0) {
        return m3278equalsimpl0(arg0, Translate) ? "Translate" : m3278equalsimpl0(arg0, Rotate) ? "Rotate" : m3278equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }

    public String toString() {
        return m3280toStringimpl(this.value);
    }
}

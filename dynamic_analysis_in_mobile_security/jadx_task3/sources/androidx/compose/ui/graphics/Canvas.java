...
public interface Canvas {
    ...
    void mo2802clipPathmtrdDE(Path path, int clipOp);

    /* JADX INFO: renamed from: clipRect-N_I0leg */
    void mo2803clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* JADX INFO: renamed from: concat-58bKbWc */
    void mo2804concat58bKbWc(float[] matrix);
    ...
    void mo2805drawCircle9KIMszo(long center, float radius, Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo2806drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo2807drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo2808drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo2809drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo2810drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo2811drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2925clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Canvas.super.m2922clipRectmtrdDE(rect, clipOp);
        }
    ...
    static /* synthetic */ void m2920clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
        }
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m2936getIntersectrtfAjoo();
        }
        canvas.m2922clipRectmtrdDE(rect, i);
    }

    /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m2922clipRectmtrdDE(Rect rect, int clipOp) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        mo2803clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m2919clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        int iM2936getIntersectrtfAjoo;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-N_I0leg");
        }
        if ((i2 & 16) == 0) {
            iM2936getIntersectrtfAjoo = i;
        } else {
            iM2936getIntersectrtfAjoo = ClipOp.INSTANCE.m2936getIntersectrtfAjoo();
        }
        canvas.mo2803clipRectN_I0leg(f, f2, f3, f4, iM2936getIntersectrtfAjoo);
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m2918clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2802clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m2921drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM5340getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m5340getZeronOccac() : j;
        long jIntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo2807drawImageRectHPBpro0(imageBitmap, jM5340getZeronOccac, jIntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m5340getZeronOccac() : j3, (i & 16) != 0 ? jIntSize : j4, paint);
    }
}

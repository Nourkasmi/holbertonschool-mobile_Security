...
public final class PathOperation {
    ...
    private static final int Difference = m3225constructorimpl(0);
    private static final int Intersect = m3225constructorimpl(1);
    private static final int Union = m3225constructorimpl(2);
    private static final int Xor = m3225constructorimpl(3);
    private static final int ReverseDifference = m3225constructorimpl(4);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m3224boximpl(int i) {
        return new PathOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3225constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3226equalsimpl(int i, Object obj) {
        return (obj instanceof PathOperation) && i == ((PathOperation) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3227equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3228hashCodeimpl(int i) {
    ...
    public static String m3229toStringimpl(int arg0) {
        return m3227equalsimpl0(arg0, Difference) ? "Difference" : m3227equalsimpl0(arg0, Intersect) ? "Intersect" : m3227equalsimpl0(arg0, Union) ? "Union" : m3227equalsimpl0(arg0, Xor) ? "Xor" : m3227equalsimpl0(arg0, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }

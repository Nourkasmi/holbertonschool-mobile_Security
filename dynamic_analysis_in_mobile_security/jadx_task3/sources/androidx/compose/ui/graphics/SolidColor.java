...
public final class SolidColor extends Brush {
    ...
    public void mo2894applyToPq9zytI(long size, Paint p, float alpha) {
        long jM2945copywmQWz5c;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            long j = this.value;
            jM2945copywmQWz5c = Color.m2945copywmQWz5c(j, (14 & 1) != 0 ? Color.m2949getAlphaimpl(j) : Color.m2949getAlphaimpl(j) * alpha, (14 & 2) != 0 ? Color.m2953getRedimpl(j) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(j) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(j) : 0.0f);
        } else {
            jM2945copywmQWz5c = this.value;
        }
        p.mo2828setColor8_81llA(jM2945copywmQWz5c);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m2948equalsimpl0(this.value, ((SolidColor) other).value);
    }

    public int hashCode() {
        return Color.m2954hashCodeimpl(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m2955toStringimpl(this.value)) + ')';
    }
}

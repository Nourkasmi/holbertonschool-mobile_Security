...
public final class ShadowKt {
    public static final Shadow lerp(Shadow start, Shadow stop, float fraction) {
        ...
        return new Shadow(ColorKt.m2998lerpjxsXWHM(start.getColor(), stop.getColor(), fraction), OffsetKt.m2731lerpWko1d7g(start.getOffset(), stop.getOffset(), fraction), MathHelpersKt.lerp(start.getBlurRadius(), stop.getBlurRadius(), fraction), null);
    }
}

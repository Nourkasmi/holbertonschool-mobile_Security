...
public abstract class ColorSpace {
    ...
    public final int getComponentCount() {
        return ColorModel.m3347getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] xyz = new float[ColorModel.m3347getComponentCountimpl(this.model)];
        xyz[0] = x;
        xyz[1] = y;
        xyz[2] = z;
        return fromXyz(xyz);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m3349toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == that.id && Intrinsics.areEqual(this.name, that.name)) {
            return ColorModel.m3346equalsimpl0(this.model, that.model);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + ColorModel.m3348hashCodeimpl(this.model)) * 31) + this.id;
    }
}

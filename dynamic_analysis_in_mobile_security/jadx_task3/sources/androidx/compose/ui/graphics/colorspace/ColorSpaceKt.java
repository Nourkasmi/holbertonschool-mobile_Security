...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m3358connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m3372getPerceptualuksYyKA();
        }
        return m3357connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* JADX INFO: renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m3357connectYBCOT_4(ColorSpace connect, ColorSpace destination, int intent) {
        ...
        if (connect == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m3367equalsimpl0(intent, RenderIntent.INSTANCE.m3372getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m3367equalsimpl0(intent, RenderIntent.INSTANCE.m3372getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3346equalsimpl0(connect.getModel(), ColorModel.INSTANCE.m3353getRgbxdoWZVw()) && ColorModel.m3346equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3353getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace $this$adapt, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m3346equalsimpl0($this$adapt.getModel(), ColorModel.INSTANCE.m3353getRgbxdoWZVw())) {

...
public final class Float16Kt {
    ...
    public static final short m3089minAoSsdG0(short x, short y) {
        if (Float16.m3061isNaNimpl(x) || Float16.m3061isNaNimpl(y)) {
            return Float16.INSTANCE.m3083getNaNslo4al4();
        }
        return Float16.m3048compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* JADX INFO: renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m3088maxAoSsdG0(short x, short y) {
        if (Float16.m3061isNaNimpl(x) || Float16.m3061isNaNimpl(y)) {
            return Float16.INSTANCE.m3083getNaNslo4al4();
        }
        return Float16.m3048compareTo41bOqos(x, y) >= 0 ? x : y;

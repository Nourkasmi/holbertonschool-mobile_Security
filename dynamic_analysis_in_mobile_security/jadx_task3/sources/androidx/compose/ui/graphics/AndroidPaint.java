...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2891getSrcOver0nO6VwU();
    }
    ...
    public long mo2822getColor0d7_KjU() {
    ...
    public void mo2828setColor8_81llA(long color) {
        AndroidPaint_androidKt.m2834setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo2827setBlendModes9anfk8(int value) {
        if (!BlendMode.m2860equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m2833setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2826getStyleTiuSbCo() {
    ...
    public void mo2832setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m2838setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo2824getStrokeCapKaPHkGw() {
    ...
    public void mo2830setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m2836setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2825getStrokeJoinLxFBmk8() {
    ...
    public void mo2831setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m2837setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo2823getFilterQualityfv9h1I() {
    ...
    public void mo2829setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m2835setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }

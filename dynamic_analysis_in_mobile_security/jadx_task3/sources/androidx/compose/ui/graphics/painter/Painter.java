...
public abstract class Painter {
    ...
    public abstract long mo3558getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3563drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        float f2;
        ...
        painter.m3564drawx_KDEd0(drawScope, j, f2, colorFilter2);
    }

    /* JADX INFO: renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m3564drawx_KDEd0(DrawScope draw, long size, float alpha, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float right$iv = Size.m2777getWidthimpl(draw.mo3489getSizeNHjbRc()) - Size.m2777getWidthimpl(size);
        float bottom$iv = Size.m2774getHeightimpl(draw.mo3489getSizeNHjbRc()) - Size.m2774getHeightimpl(size);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, right$iv, bottom$iv);
        if (alpha > 0.0f && Size.m2777getWidthimpl(size) > 0.0f && Size.m2774getHeightimpl(size) > 0.0f) {
            if (this.useLayer) {
                Rect layerRect = RectKt.m2748Recttz77jQw(Offset.INSTANCE.m2724getZeroF1C5BW0(), SizeKt.Size(Size.m2777getWidthimpl(size), Size.m2774getHeightimpl(size)));

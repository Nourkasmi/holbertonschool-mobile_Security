...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3592getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3292getButtKaPHkGw();
        }
        return m3591getStrokeLineCapCSYIeUk(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m3591getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m3292getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m3293getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m3294getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m3594getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3303getMiterLxFBmk8();
        }
        return m3593getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3593getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m3303getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m3304getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m3302getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) throws XmlPullParserException {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type != 2 && (tintColorStateList = $this$createVectorImageBuilder.getNamedColorStateList(vectorAttrs, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                ...
                tintColor = Color.INSTANCE.m2983getUnspecified0d7_KjU();
            }
        } else {
            tintColor = Color.INSTANCE.m2983getUnspecified0d7_KjU();
        }
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.INSTANCE.m2891getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.INSTANCE.m2889getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.INSTANCE.m2888getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.INSTANCE.m2880getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.INSTANCE.m2885getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.INSTANCE.m2883getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.INSTANCE.m2889getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m5212constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m5212constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        List<PathNode> listAddPathNodes = VectorKt.addPathNodes(pathStr);
        ...
        int strokeLineCap = m3591getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m3292getButtKaPHkGw());
        ...
        int strokeLineJoin = m3593getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m3302getBevelLxFBmk8());
        ...
        int lineJoin2 = fillRule == 0 ? companion.m3223getNonZeroRgk1Os() : companion.m3222getEvenOddRgk1Os();
        builder.m3571addPathoIyEayM(listAddPathNodes, lineJoin2, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
    ...
    public static final void parseClipPath(AndroidVectorParser $this$parseClipPath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) {
        ...
        List<PathNode> listAddPathNodes = VectorKt.addPathNodes($this$parseClipPath.getString(a, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_CLIP_PATH_PATH_DATA()));
        a.recycle();
        builder.addGroup((254 & 1) != 0 ? "" : name, (254 & 2) != 0 ? 0.0f : 0.0f, (254 & 4) != 0 ? 0.0f : 0.0f, (254 & 8) != 0 ? 0.0f : 0.0f, (254 & 16) != 0 ? 1.0f : 0.0f, (254 & 32) == 0 ? 0.0f : 1.0f, (254 & 64) != 0 ? 0.0f : 0.0f, (254 & 128) == 0 ? 0.0f : 0.0f, (254 & 256) != 0 ? VectorKt.getEmptyPath() : listAddPathNodes);
    }

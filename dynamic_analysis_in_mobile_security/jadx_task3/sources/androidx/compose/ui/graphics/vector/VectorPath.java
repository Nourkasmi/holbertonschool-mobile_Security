...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(Object other) {
        ...
        if (!z3 || !StrokeCap.m3288equalsimpl0(this.strokeLineCap, ((VectorPath) other).strokeLineCap) || !StrokeJoin.m3298equalsimpl0(this.strokeLineJoin, ((VectorPath) other).strokeLineJoin)) {
            return false;
        }
        ...
        if (z7 && PathFillType.m3218equalsimpl0(this.pathFillType, ((VectorPath) other).pathFillType) && Intrinsics.areEqual(this.pathData, ((VectorPath) other).pathData)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((result3 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m3289hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m3299hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m3219hashCodeimpl(this.pathFillType);
    }
}

    ...
    public static final class Companion {
        ...
        public final int nextFloat(String s, int start, int end, FloatResult result) {
            ...
            if (isNegative2) {
                ...
                c4 = s.charAt(index);
                char $this$isDigit$iv = ((char) (c4 + 65488)) < '\n' ? (char) 1 : (char) 0;
                if ($this$isDigit$iv == 0 && c4 != '.') {
                    return index;
                }
            }
            long significand4 = 0;
            int significandStartIndex2 = index;
            while (true) {
                if (index == end) {
                    isNegative = isNegative2;
                    break;
                }
                char $this$isDigit$iv2 = c4;
                if (!(((char) ($this$isDigit$iv2 + 65488)) < '\n')) {
                    isNegative = isNegative2;
                    break;
                }
                boolean isNegative3 = isNegative2;
                significand4 = (10 * significand4) + ((long) (c4 - '0'));
                index++;
                c4 = index < s.length() ? s.charAt(index) : (char) 0;
            ...
            if (index == end || c4 != '.') {
                ...
                while (true) {
                    if (end - index < 4) {
                        significandEndIndex = significandEndIndex2;
                        significand3 = significand4;
                        break;
                    }
                    significand3 = significand4;
                    significandEndIndex = significandEndIndex2;
                    long v$iv = (((long) s.charAt(index + 1)) << 16) | ((long) s.charAt(index)) | (((long) s.charAt(index + 2)) << 32) | (((long) s.charAt(index + 3)) << 48);
                    long base$iv = v$iv - 13511005043687472L;
                    long predicate$iv = (v$iv + 19703549022044230L) | base$iv;
                    if ((predicate$iv & (-35747867511423104L)) != 0) {
                        i = -1;
                        c3 = c4;
                    } else {
                        c3 = c4;
                    ...
                    significand4 = (significand3 * 10000) + ((long) digits);
                    index += 4;
                    significandEndIndex2 = significandEndIndex;
                    c4 = c3;
                }
                c = index < s.length() ? s.charAt(index) : (char) 0;
                significand4 = significand3;
                while (index != end) {
                    char $this$isDigit$iv3 = c;
                    char $this$isDigit$iv4 = ((char) ($this$isDigit$iv3 + 65488)) < '\n' ? (char) 1 : (char) 0;
                    if ($this$isDigit$iv4 == 0) {
                        break;
                    }
                    significand4 = (significand4 * 10) + ((long) (c - '0'));
                    index++;
                    c = index < s.length() ? s.charAt(index) : (char) 0;
                }
            ...
            if ((c | ' ') == 101) {
                index++;
                char c6 = index < s.length() ? s.charAt(index) : (char) 0;
                ...
                while (true) {
                    ...
                    char $this$isDigit$iv5 = c2;
                    significand = significand4;
                    char $this$isDigit$iv6 = ((char) ($this$isDigit$iv5 + 65488)) < '\n' ? (char) 1 : (char) 0;
                    if ($this$isDigit$iv6 == 0) {
                        break;
                    }
                    ...
                    index++;
                    c2 = index < s.length() ? s.charAt(index) : (char) 0;
            ...
            if (digitCount2 > 19) {
                ...
                c2 = s.charAt(retryIndex);
                while (index != end && (c2 == '0' || c2 == '.')) {
                    if (c2 == '0') {
                        digitCount2--;
                    }
                    retryIndex++;
                    c2 = retryIndex < s.length() ? s.charAt(retryIndex) : (char) 0;
                }
                if (digitCount2 > 19) {
                    boolean tooManyDigits3 = true;
                    int retryIndex2 = significandStartIndex2;
                    c2 = s.charAt(retryIndex2);
                    significand2 = 0;
                    while (true) {
                        int exponent2 = exponent;
                        tooManyDigits = tooManyDigits3;
                        j = 1000000000000000000L;
                        if (retryIndex2 == significandEndIndex || Long.compare(ULong.m5673constructorimpl(significand2) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                            break;
                        }
                        significand2 = (significand2 * 10) + ((long) (c2 - '0'));
                        retryIndex2++;
                        c2 = retryIndex2 < s.length() ? s.charAt(retryIndex2) : (char) 0;
                        exponent = exponent2;
                        tooManyDigits3 = tooManyDigits;
                    }
                    if (Long.compare(ULong.m5673constructorimpl(significand2) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                        ...
                        c2 = s.charAt(retryIndex3);
                        while (true) {
                            if (retryIndex3 == exponentEndIndex) {
                                significandStartIndex = significandStartIndex2;
                                break;
                            }
                            significandStartIndex = significandStartIndex2;
                            int significandEndIndex3 = significandEndIndex;
                            if (Long.compare(ULong.m5673constructorimpl(significand2) ^ Long.MIN_VALUE, j ^ Long.MIN_VALUE) >= 0) {
                                break;
                            }
                            significand2 = (significand2 * 10) + ((long) (c2 - '0'));
                            retryIndex3++;
                            c2 = retryIndex3 < s.length() ? s.charAt(retryIndex3) : (char) 0;
            ...
            if ((FastFloatParser.FloatMinExponent <= exponent && exponent < 11) && !tooManyDigits2 && Long.compare(ULong.m5673constructorimpl(significand2) ^ Long.MIN_VALUE, ULong.m5673constructorimpl(16777216L) ^ Long.MIN_VALUE) <= 0) {
                float f = significand2;
                float f2 = exponent < 0 ? f / FastFloatParser.PowersOfTen[-exponent] : f * FastFloatParser.PowersOfTen[exponent];
                result.setValue(isNegative ? -f2 : f2);
                return index;
            }
            if (significand2 == 0) {
                result.setValue(isNegative ? -0.0f : 0.0f);
                return index;
            }
            if (!(-126 <= exponent && exponent < 128)) {
                try {
                    ...
                    result.setValue(Float.parseFloat(strSubstring));
                    return index;
                } finally {
                }
            }
            long significandFactor = ULongArray.m5733getsVKNKU(FastFloatParser.Mantissa64, exponent + 325);
            int lz = Long.numberOfLeadingZeros(significand2);
            long significand5 = significand2 << lz;
            long xLo$iv = significand5 & 4294967295L;
            long xHi$iv = significand5 >>> 32;
            ...
            long carry$iv = yTimesXMid$iv + (xTimesYLo$iv >>> 32) + (xTimesYMid$iv & 4294967295L);
            long upper = xTimesYHi$iv + (carry$iv >>> 32) + (xTimesYMid$iv >>> 32);
            ...
            if ((upper & 511) == 511 || ((upper & 511) == 0 && (mantissa & 3) == 1)) {
                try {
                    ...
                    result.setValue(Float.parseFloat(strSubstring2));
                    return index;
                } finally {
                }
            }
            ...
            if (realExponent < 1 || realExponent > 2046) {
                try {
                    ...
                    result.setValue(Float.parseFloat(strSubstring3));
                    return index;
                } finally {
                }
            }
            long mantissa4 = mantissa3 | (realExponent << 52);
            long j2 = isNegative ? Long.MIN_VALUE : 0L;
            result.setValid(true);
            DoubleCompanionObject doubleCompanionObject = DoubleCompanionObject.INSTANCE;
            result.setValue((float) Double.longBitsToDouble(mantissa4 | j2));
            return index;
        }
    }
}

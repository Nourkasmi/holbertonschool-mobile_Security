...
public final class PathComponent extends VNode {
    ...
    public final void m3577setPathFillTypeoQ8Xj4U(int value) {
        this.pathFillType = value;
        this.renderPath.mo2842setFillTypeoQ8Xj4U(value);
        invalidate();
    }
    ...
    public final void m3578setStrokeLineCapBeK7IIE(int value) {
    ...
    public final void m3579setStrokeLineJoinWw9F2mQ(int value) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int fillType = this.renderPath.mo2840getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo2842setFillTypeoQ8Xj4U(fillType);
        }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        Brush it = this.fill;
        if (it != null) {
            DrawScope.m3479drawPathGBMwjPU$default($this$draw, this.renderPath, it, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (it2 != null) {
            ...
            DrawScope.m3479drawPathGBMwjPU$default($this$draw, this.renderPath, it2, this.strokeAlpha, targetStroke, null, 0, 48, null);
        }
    }

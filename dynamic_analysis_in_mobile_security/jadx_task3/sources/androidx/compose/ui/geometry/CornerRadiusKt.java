...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m2677constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m2694lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2683getXimpl(start), CornerRadius.m2683getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m2684getYimpl(start), CornerRadius.m2684getYimpl(stop), fraction));
    }
}

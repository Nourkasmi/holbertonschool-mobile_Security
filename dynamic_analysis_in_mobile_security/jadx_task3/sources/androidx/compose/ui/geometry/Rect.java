...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m2733getSizeNHjbRc$annotations() {
    }
    ...
    public final long m2741getSizeNHjbRc() {
    ...
    public final Rect m2745translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m2708getXimpl(offset), this.top + Offset.m2709getYimpl(offset), this.right + Offset.m2708getXimpl(offset), this.bottom + Offset.m2709getYimpl(offset));
    }
    ...
    public final long m2740getCenterRightF1C5BW0() {
    ...
    public final long m2737getBottomRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains-k-4lQ0M, reason: not valid java name */
    public final boolean m2734containsk4lQ0M(long offset) {
        return Offset.m2708getXimpl(offset) >= this.left && Offset.m2708getXimpl(offset) < this.right && Offset.m2709getYimpl(offset) >= this.top && Offset.m2709getYimpl(offset) < this.bottom;
    }

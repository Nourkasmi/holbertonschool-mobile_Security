...
public final class RoundRectKt {
    ...
    public static final RoundRect m2762RoundRectgG7oq9Y(float left, float top, float right, float bottom, long cornerRadius) {
        return RoundRect(left, top, right, bottom, CornerRadius.m2683getXimpl(cornerRadius), CornerRadius.m2684getYimpl(cornerRadius));
    }
    ...
    public static final RoundRect m2763RoundRectsniSvfs(Rect rect, long cornerRadius) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        return RoundRect(rect, CornerRadius.m2683getXimpl(cornerRadius), CornerRadius.m2684getYimpl(cornerRadius));
    }

    /* JADX INFO: renamed from: RoundRect-ZAM2FJo, reason: not valid java name */
    public static final RoundRect m2760RoundRectZAM2FJo(Rect rect, long topLeft, long topRight, long bottomRight, long bottomLeft) {
        Intrinsics.checkNotNullParameter(rect, "rect");
    ...
    public static final RoundRect m2764translateUv8p0NA(RoundRect translate, long offset) {
        Intrinsics.checkNotNullParameter(translate, "$this$translate");
        return new RoundRect(Offset.m2708getXimpl(offset) + translate.getLeft(), Offset.m2709getYimpl(offset) + translate.getTop(), Offset.m2708getXimpl(offset) + translate.getRight(), Offset.m2709getYimpl(offset) + translate.getBottom(), translate.m2758getTopLeftCornerRadiuskKHJgLs(), translate.m2759getTopRightCornerRadiuskKHJgLs(), translate.m2757getBottomRightCornerRadiuskKHJgLs(), translate.m2756getBottomLeftCornerRadiuskKHJgLs(), null);
    }
    ...
    public static final Rect getSafeInnerRect(RoundRect $this$safeInnerRect) {
        ...
        float leftRadius = Math.max(CornerRadius.m2683getXimpl($this$safeInnerRect.m2756getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m2683getXimpl($this$safeInnerRect.m2758getTopLeftCornerRadiuskKHJgLs()));
        float topRadius = Math.max(CornerRadius.m2684getYimpl($this$safeInnerRect.m2758getTopLeftCornerRadiuskKHJgLs()), CornerRadius.m2684getYimpl($this$safeInnerRect.m2759getTopRightCornerRadiuskKHJgLs()));
        float rightRadius = Math.max(CornerRadius.m2683getXimpl($this$safeInnerRect.m2759getTopRightCornerRadiuskKHJgLs()), CornerRadius.m2683getXimpl($this$safeInnerRect.m2757getBottomRightCornerRadiuskKHJgLs()));
        float bottomRadius = Math.max(CornerRadius.m2684getYimpl($this$safeInnerRect.m2757getBottomRightCornerRadiuskKHJgLs()), CornerRadius.m2684getYimpl($this$safeInnerRect.m2756getBottomLeftCornerRadiuskKHJgLs()));
    ...
    */
    public static final boolean isRect(androidx.compose.ui.geometry.RoundRect r6) {
        /*
            ...
            long r0 = r6.m2758getTopLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r0)
            r1 = 0
        ...
        L17:
            if (r0 != 0) goto L2a
            long r4 = r6.m2758getTopLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2684getYimpl(r4)
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r0 != 0) goto L27
            r0 = r2
            goto L28
        ...
        L28:
            if (r0 == 0) goto L91
        L2a:
            long r4 = r6.m2759getTopRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r4)
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r0 != 0) goto L38
            r0 = r2
            goto L39
        ...
        L4a:
            if (r0 == 0) goto L91
        L4c:
            long r4 = r6.m2756getBottomLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r4)
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r0 != 0) goto L5a
            r0 = r2
        ...
        L6c:
            if (r0 == 0) goto L91
        L6e:
            long r4 = r6.m2757getBottomRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r4)
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r0 != 0) goto L7c
            r0 = r2
    ...
    public static final boolean isEllipse(RoundRect $this$isEllipse) {
        ...
        if (CornerRadius.m2683getXimpl($this$isEllipse.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2683getXimpl($this$isEllipse.m2759getTopRightCornerRadiuskKHJgLs())) {
            if (CornerRadius.m2684getYimpl($this$isEllipse.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isEllipse.m2759getTopRightCornerRadiuskKHJgLs())) {
                if (CornerRadius.m2683getXimpl($this$isEllipse.m2759getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2683getXimpl($this$isEllipse.m2757getBottomRightCornerRadiuskKHJgLs())) {
                    if (CornerRadius.m2684getYimpl($this$isEllipse.m2759getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isEllipse.m2757getBottomRightCornerRadiuskKHJgLs())) {
                        if (CornerRadius.m2683getXimpl($this$isEllipse.m2757getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2683getXimpl($this$isEllipse.m2756getBottomLeftCornerRadiuskKHJgLs())) {
                            if ((CornerRadius.m2684getYimpl($this$isEllipse.m2757getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isEllipse.m2756getBottomLeftCornerRadiuskKHJgLs())) && $this$isEllipse.getWidth() <= ((double) CornerRadius.m2683getXimpl($this$isEllipse.m2758getTopLeftCornerRadiuskKHJgLs())) * 2.0d && $this$isEllipse.getHeight() <= ((double) CornerRadius.m2684getYimpl($this$isEllipse.m2758getTopLeftCornerRadiuskKHJgLs())) * 2.0d) {
                                return true;
                            }
                        }
                    }
    ...
    public static final boolean isSimple(RoundRect $this$isSimple) {
        ...
        if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs())) {
            if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2683getXimpl($this$isSimple.m2759getTopRightCornerRadiuskKHJgLs())) {
                if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isSimple.m2759getTopRightCornerRadiuskKHJgLs())) {
                    if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2683getXimpl($this$isSimple.m2757getBottomRightCornerRadiuskKHJgLs())) {
                        if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isSimple.m2757getBottomRightCornerRadiuskKHJgLs())) {
                            if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2683getXimpl($this$isSimple.m2756getBottomLeftCornerRadiuskKHJgLs())) {
                                if (CornerRadius.m2683getXimpl($this$isSimple.m2758getTopLeftCornerRadiuskKHJgLs()) == CornerRadius.m2684getYimpl($this$isSimple.m2756getBottomLeftCornerRadiuskKHJgLs())) {
                                    return true;
                                }
                            }
                        }
    ...
    public static final RoundRect lerp(RoundRect start, RoundRect stop, float fraction) {
        ...
        return new RoundRect(MathHelpersKt.lerp(start.getLeft(), stop.getLeft(), fraction), MathHelpersKt.lerp(start.getTop(), stop.getTop(), fraction), MathHelpersKt.lerp(start.getRight(), stop.getRight(), fraction), MathHelpersKt.lerp(start.getBottom(), stop.getBottom(), fraction), CornerRadiusKt.m2694lerp3Ry4LBc(start.m2758getTopLeftCornerRadiuskKHJgLs(), stop.m2758getTopLeftCornerRadiuskKHJgLs(), fraction), CornerRadiusKt.m2694lerp3Ry4LBc(start.m2759getTopRightCornerRadiuskKHJgLs(), stop.m2759getTopRightCornerRadiuskKHJgLs(), fraction), CornerRadiusKt.m2694lerp3Ry4LBc(start.m2757getBottomRightCornerRadiuskKHJgLs(), stop.m2757getBottomRightCornerRadiuskKHJgLs(), fraction), CornerRadiusKt.m2694lerp3Ry4LBc(start.m2756getBottomLeftCornerRadiuskKHJgLs(), stop.m2756getBottomLeftCornerRadiuskKHJgLs(), fraction), null);
    }
}

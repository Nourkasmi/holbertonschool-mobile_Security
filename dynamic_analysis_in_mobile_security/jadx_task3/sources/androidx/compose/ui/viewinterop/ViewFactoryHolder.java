...
public final class ViewFactoryHolder<T extends View> extends AndroidViewHolder implements ViewRootForInspector {
    ...
    /* synthetic */ ViewFactoryHolder(Context context, CompositionContext compositionContext, View view, NestedScrollDispatcher nestedScrollDispatcher, SaveableStateRegistry saveableStateRegistry, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(context, compositionContext2, view, nestedScrollDispatcher2, saveableStateRegistry, i);
    }
    ...
    private ViewFactoryHolder(Context context, CompositionContext parentContext, T t, NestedScrollDispatcher dispatcher, SaveableStateRegistry saveStateRegistry, int compositeKeyHash) {
        ...
        String strValueOf = String.valueOf(compositeKeyHash);
        this.saveStateKey = strValueOf;
        Object objConsumeRestored = saveStateRegistry != null ? saveStateRegistry.consumeRestored(strValueOf) : null;
    ...
    public /* synthetic */ ViewFactoryHolder(Context context, Function1 function1, CompositionContext compositionContext, SaveableStateRegistry saveableStateRegistry, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(context, function1, compositionContext2, saveableStateRegistry, i);
    }

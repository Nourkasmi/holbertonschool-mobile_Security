...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
    ...
    public AndroidViewHolder(Context context, CompositionContext parentContext, int compositeKeyHash, NestedScrollDispatcher dispatcher, View view) {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                Intrinsics.checkNotNullParameter(measure, "$this$measure");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (this.$this_run.getChildCount() == 0) {
                    return MeasureScope.layout$default(measure, Constraints.m5170getMinWidthimpl(constraints), Constraints.m5169getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        @Override // kotlin.jvm.functions.Function1
                ...
                if (Constraints.m5170getMinWidthimpl(constraints) != 0) {
                    this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m5170getMinWidthimpl(constraints));
                }
                if (Constraints.m5169getMinHeightimpl(constraints) != 0) {
                    this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m5169getMinHeightimpl(constraints));
                }
                AndroidViewHolder androidViewHolder = this.$this_run;
                int iM5170getMinWidthimpl = Constraints.m5170getMinWidthimpl(constraints);
                ...
                int iObtainMeasureSpec = androidViewHolder.obtainMeasureSpec(iM5170getMinWidthimpl, iM5168getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder2 = this.$this_run;
                int iM5169getMinHeightimpl = Constraints.m5169getMinHeightimpl(constraints);
                int iM5167getMaxHeightimpl = Constraints.m5167getMaxHeightimpl(constraints);
                ViewGroup.LayoutParams layoutParams2 = this.$this_run.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams2);
                androidViewHolder.measure(iObtainMeasureSpec, androidViewHolder2.obtainMeasureSpec(iM5169getMinHeightimpl, iM5167getMaxHeightimpl, layoutParams2.height));
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        Intrinsics.checkNotNullParameter(target, "target");
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m3951dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxConsumed), AndroidViewHolder_androidKt.toComposeOffset(dyConsumed)), OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dxUnconsumed), AndroidViewHolder_androidKt.toComposeOffset(dyUnconsumed)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        Intrinsics.checkNotNullParameter(consumed, "consumed");
        if (isNestedScrollingEnabled()) {
            long consumedByParent = this.dispatcher.m3953dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.toComposeOffset(dx), AndroidViewHolder_androidKt.toComposeOffset(dy)), AndroidViewHolder_androidKt.toNestedScrollSource(type));
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(consumedByParent));
        }
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (!this.$consumed) {
                        this.label = 1;
                        if (this.this$0.dispatcher.m3950dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m5448getZero9UxMQ8M(), this.$viewVelocity, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        this.label = 2;
                        if (this.this$0.dispatcher.m3950dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m5448getZero9UxMQ8M(), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                    break;
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C05461(toBeConsumed, null), 3, null);
        return false;
    }
    ...
    static final class C05461 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $toBeConsumed;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05461(long j, Continuation<? super C05461> continuation) {
            super(2, continuation);
            this.$toBeConsumed = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidViewHolder.this.new C05461(this.$toBeConsumed, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    this.label = 1;
                    if (AndroidViewHolder.this.dispatcher.m3952dispatchPreFlingQWom1Mo(this.$toBeConsumed, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:

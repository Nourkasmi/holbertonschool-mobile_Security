...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View $this$layoutAccordingTo, LayoutNode layoutNode) {
        ...
        int x = MathKt.roundToInt(Offset.m2708getXimpl(position));
        int y = MathKt.roundToInt(Offset.m2709getYimpl(position));
    ...
    public static final int toNestedScrollSource(int type) {
        return type == 0 ? NestedScrollSource.INSTANCE.m3962getDragWNlRxjI() : NestedScrollSource.INSTANCE.m3963getFlingWNlRxjI();
    }
}

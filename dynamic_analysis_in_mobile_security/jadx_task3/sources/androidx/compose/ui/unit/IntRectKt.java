...
public final class IntRectKt {
    ...
    public static final IntRect m5362IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m5330getXimpl(offset), IntOffset.m5331getYimpl(offset), IntOffset.m5330getXimpl(offset) + IntSize.m5372getWidthimpl(size), IntOffset.m5331getYimpl(offset) + IntSize.m5371getHeightimpl(size));
    }

    /* JADX INFO: renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5361IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m5330getXimpl(topLeft), IntOffset.m5331getYimpl(topLeft), IntOffset.m5330getXimpl(bottomRight), IntOffset.m5331getYimpl(bottomRight));
    }

    /* JADX INFO: renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5363IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m5330getXimpl(center) - radius, IntOffset.m5331getYimpl(center) - radius, IntOffset.m5330getXimpl(center) + radius, IntOffset.m5331getYimpl(center) + radius);
    }

...
public final class IntSizeKt {
    ...
    public static /* synthetic */ void m5379getCenterozmzZPI$annotations(long j) {
    }

    public static final long IntSize(int width, int height) {
        return IntSize.m5367constructorimpl((((long) width) << 32) | (((long) height) & 4294967295L));
    }

    /* JADX INFO: renamed from: times-O0kMr_c, reason: not valid java name */
    public static final long m5380timesO0kMr_c(int $this$times_u2dO0kMr_c, long size) {
        return IntSize.m5374timesYEO4UFw(size, $this$times_u2dO0kMr_c);
    }

    /* JADX INFO: renamed from: toIntRect-ozmzZPI, reason: not valid java name */
    public static final IntRect m5381toIntRectozmzZPI(long $this$toIntRect_u2dozmzZPI) {
        return IntRectKt.m5362IntRectVbeCjmY(IntOffset.INSTANCE.m5340getZeronOccac(), $this$toIntRect_u2dozmzZPI);
    }

    /* JADX INFO: renamed from: getCenter-ozmzZPI, reason: not valid java name */
    public static final long m5378getCenterozmzZPI(long $this$center) {
        return IntOffsetKt.IntOffset(IntSize.m5372getWidthimpl($this$center) / 2, IntSize.m5371getHeightimpl($this$center) / 2);
    }

    /* JADX INFO: renamed from: toSize-ozmzZPI, reason: not valid java name */
    public static final long m5382toSizeozmzZPI(long $this$toSize_u2dozmzZPI) {
        return SizeKt.Size(IntSize.m5372getWidthimpl($this$toSize_u2dozmzZPI), IntSize.m5371getHeightimpl($this$toSize_u2dozmzZPI));
    }
}

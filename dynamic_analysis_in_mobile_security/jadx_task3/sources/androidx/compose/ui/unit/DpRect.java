...
public final /* data */ class DpRect {
    ...
    public static /* synthetic */ DpRect m5284copya9UjIt4$default(DpRect dpRect, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpRect.left;
        }
        if ((i & 2) != 0) {
    ...
    public final DpRect m5293copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5217equalsimpl0(this.left, dpRect.left) && Dp.m5217equalsimpl0(this.top, dpRect.top) && Dp.m5217equalsimpl0(this.right, dpRect.right) && Dp.m5217equalsimpl0(this.bottom, dpRect.bottom);
    }

    public int hashCode() {
        return (((((Dp.m5218hashCodeimpl(this.left) * 31) + Dp.m5218hashCodeimpl(this.top)) * 31) + Dp.m5218hashCodeimpl(this.right)) * 31) + Dp.m5218hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m5223toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5223toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5223toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5223toStringimpl(this.bottom)) + ')';
    }
    ...
    public final float m5295getLeftD9Ej5fM() {
        return this.left;
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM, reason: not valid java name */
    public final float m5297getTopD9Ej5fM() {
        return this.top;
    }

    /* JADX INFO: renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m5296getRightD9Ej5fM() {
        return this.right;
    }

    /* JADX INFO: renamed from: getBottom-D9Ej5fM, reason: not valid java name */
    public final float m5294getBottomD9Ej5fM() {
        return this.bottom;
    }

    /* JADX WARN: Illegal instructions before constructor call */
    private DpRect(long origin, long size) {
        float fM5273getXD9Ej5fM = DpOffset.m5273getXD9Ej5fM(origin);
        float fM5275getYD9Ej5fM = DpOffset.m5275getYD9Ej5fM(origin);
        float arg0$iv = DpOffset.m5273getXD9Ej5fM(origin);
        float other$iv = DpSize.m5310getWidthD9Ej5fM(size);
        float other$iv2 = Dp.m5212constructorimpl(arg0$iv + other$iv);
        float arg0$iv2 = DpOffset.m5275getYD9Ej5fM(origin);
        float other$iv3 = DpSize.m5308getHeightD9Ej5fM(size);
        this(fM5273getXD9Ej5fM, fM5275getYD9Ej5fM, other$iv2, Dp.m5212constructorimpl(arg0$iv2 + other$iv3), null);
    }
}

...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m5169getMinHeightimpl(constraints) == 0 && Constraints.m5170getMinWidthimpl(constraints) == 0)) {
        ...
        if (AndroidParagraph_androidKt.shouldAttachIndentationFixSpan(style, ellipsis)) {
        ...
        int alignment = AndroidParagraph_androidKt.m4591toLayoutAlignAMY3VfE(style.m4750getTextAlignbuA522U());
        TextAlign textAlignM4750getTextAlignbuA522U = style.m4750getTextAlignbuA522U();
        int justificationMode = textAlignM4750getTextAlignbuA522U == null ? false : TextAlign.m5080equalsimpl0(textAlignM4750getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m5086getJustifye0LSkKk()) ? 1 : 0;
        int hyphens = AndroidParagraph_androidKt.m4593toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak lineBreakM4748getLineBreakLgCVezo = style.m4748getLineBreakLgCVezo();
        int breakStrategy = AndroidParagraph_androidKt.m4592toLayoutBreakStrategyu6PBz3U(lineBreakM4748getLineBreakLgCVezo != null ? LineBreak.Strategy.m5021boximpl(LineBreak.m5012getStrategyfcGXIks(lineBreakM4748getLineBreakLgCVezo.getMask())) : null);
        LineBreak lineBreakM4748getLineBreakLgCVezo2 = style.m4748getLineBreakLgCVezo();
        int lineBreakStyle = AndroidParagraph_androidKt.m4594toLayoutLineBreakStyle4a2g8L8(lineBreakM4748getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m5031boximpl(LineBreak.m5013getStrictnessusljTpc(lineBreakM4748getLineBreakLgCVezo2.getMask())) : null);
        LineBreak lineBreakM4748getLineBreakLgCVezo3 = style.m4748getLineBreakLgCVezo();
        int lineBreakWordStyle = AndroidParagraph_androidKt.m4595toLayoutLineBreakWordStylegvcdTPQ(lineBreakM4748getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m5042boximpl(LineBreak.m5014getWordBreakjp8hJ3c(lineBreakM4748getLineBreakLgCVezo3.getMask())) : null);
        if (ellipsis) {
        ...
        if (ellipsis && firstLayout.getHeight() > Constraints.m5167getMaxHeightimpl(constraints) && maxLines > 1) {
            int calculatedMaxLines = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m5167getMaxHeightimpl(constraints));
            if (calculatedMaxLines < 0 || calculatedMaxLines == maxLines) {
                i = 0;
                textLayoutConstructTextLayout = firstLayout;
            } else {
                i = 0;
                textLayoutConstructTextLayout = constructTextLayout(alignment, justificationMode, ellipsize, RangesKt.coerceAtLeast(calculatedMaxLines, 1), hyphens, breakStrategy, lineBreakStyle, lineBreakWordStyle);
            }
        ...
        getTextPaint$ui_text_release().m4957setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ShaderBrushSpan[] shaderBrushSpans = getShaderBrushSpans(this.layout);
        int length = shaderBrushSpans.length;
        for (int i3 = i; i3 < length; i3++) {
            shaderBrushSpans[i3].m4976setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m5168getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4581getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m2709getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m2708getXimpl(position));
    }
    ...
    public final void m4579fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4719getMinimpl(range), TextRange.m4718getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4582getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4584paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u248 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u248.m4958setColor8_81llA(color);
    ...
    public void mo4583paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int currBlendMode = getTextPaint$ui_text_release().m4955getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u249 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u249.m4958setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u249.m4956setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4956setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo4585painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int currBlendMode = getTextPaint$ui_text_release().m4955getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2410.m4957setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2410.m4956setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4956setBlendModes9anfk8(currBlendMode);
    }

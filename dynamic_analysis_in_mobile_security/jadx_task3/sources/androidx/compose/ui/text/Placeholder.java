...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (!(!TextUnitKt.m5411isUnspecifiedR2X_6o(width))) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (!(!TextUnitKt.m5411isUnspecifiedR2X_6o(height))) {
    ...
    public final Placeholder m4641copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Placeholder) && TextUnit.m5390equalsimpl0(this.width, ((Placeholder) other).width) && TextUnit.m5390equalsimpl0(this.height, ((Placeholder) other).height) && PlaceholderVerticalAlign.m4648equalsimpl0(this.placeholderVerticalAlign, ((Placeholder) other).placeholderVerticalAlign);
    }

    public int hashCode() {
        int result = TextUnit.m5394hashCodeimpl(this.width);
        return (((result * 31) + TextUnit.m5394hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m4649hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m5400toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m5400toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m4650toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}

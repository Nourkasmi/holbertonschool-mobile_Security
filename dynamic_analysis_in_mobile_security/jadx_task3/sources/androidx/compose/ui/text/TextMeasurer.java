...
public final class TextMeasurer {
    ...
    public final TextLayoutResult m4699measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (cacheResult != null) {
            return cacheResult.m4692copyO0kMr_c(requestedTextLayoutInput, ConstraintsKt.m5179constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(cacheResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(cacheResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m4698measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m4697measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int minWidth = Constraints.m5170getMinWidthimpl(textLayoutInput.getConstraints());
            boolean overwriteMaxLines = false;
            boolean widthMatters = textLayoutInput.getSoftWrap() || TextOverflow.m5124equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5132getEllipsisgIe3tQ8());
            if (widthMatters && Constraints.m5164getHasBoundedWidthimpl(textLayoutInput.getConstraints())) {
                maxWidth = Constraints.m5168getMaxWidthimpl(textLayoutInput.getConstraints());
            } else {
                maxWidth = Integer.MAX_VALUE;
            }
            if (!textLayoutInput.getSoftWrap() && TextOverflow.m5124equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5132getEllipsisgIe3tQ8())) {
            ...
            MultiParagraph multiParagraph = new MultiParagraph(nonNullIntrinsics, ConstraintsKt.Constraints$default(0, width, 0, Constraints.m5167getMaxHeightimpl(textLayoutInput.getConstraints()), 5, null), finalMaxLines, TextOverflow.m5124equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5132getEllipsisgIe3tQ8()), null);
            return new TextLayoutResult(textLayoutInput, multiParagraph, ConstraintsKt.m5179constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(multiParagraph.getWidth()), (int) Math.ceil(multiParagraph.getHeight()))), null);
        }
    }
}

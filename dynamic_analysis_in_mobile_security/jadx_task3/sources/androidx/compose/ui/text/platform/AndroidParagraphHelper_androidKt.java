...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, boolean useEmojiCompat) {
        ...
        if (spanStyles.isEmpty() && placeholders.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m5411isUnspecifiedR2X_6o(contextTextStyle.m4749getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m4971setLineHeightr9BaKPg(spannableString, contextTextStyle.m4749getLineHeightXSAIIZE(), contextFontSize, density);
        } else {
            ...
            SpannableExtensions_androidKt.m4970setLineHeightKmRG4DE(spannableString, contextTextStyle.m4749getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }

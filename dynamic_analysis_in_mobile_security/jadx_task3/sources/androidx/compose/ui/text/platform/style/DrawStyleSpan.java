...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
        ...
        if (textPaint != null) {
            ...
            if (!Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                if (drawStyle instanceof Stroke) {
                    ...
                    textPaint.setStrokeJoin(m4974toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                    textPaint.setStrokeCap(m4973toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m4974toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        return StrokeJoin.m3298equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3303getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3298equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3304getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3298equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3302getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* JADX INFO: renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m4973toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        return StrokeCap.m3288equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3292getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3288equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3293getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3288equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3294getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}

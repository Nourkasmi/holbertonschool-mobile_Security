...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        this.emojiCompatProcessed = !AndroidParagraphIntrinsics_androidKt.getHasEmojiCompat(style) ? false : EmojiCompatStatus.INSTANCE.getFontLoaded().getValue().booleanValue();
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m4949resolveTextDirectionHeuristics9GRLPo0(style.m4751getTextDirectionmmuk1to(), style.getLocaleList());
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m4948invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m4820unboximpl(), fontSynthesis.getValue());
            }

            /* JADX INFO: renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m4948invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
                Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
                State<Object> stateMo4792resolveDPcqOEQ = this.this$0.getFontFamilyResolver().mo4792resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
                if (!(stateMo4792resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
                    TypefaceDirtyTrackerLinkedList newHead = new TypefaceDirtyTrackerLinkedList(stateMo4792resolveDPcqOEQ, this.this$0.resolvedTypefaces);
                    this.this$0.resolvedTypefaces = newHead;
                    return newHead.getTypeface();
                }
                Object value = stateMo4792resolveDPcqOEQ.getValue();
                Intrinsics.checkNotNull(value, "null cannot be cast to non-null type android.graphics.Typeface");
                return (Typeface) value;
            }
        };
        TextPaintExtensions_androidKt.setTextMotion(androidTextPaint, style.getTextMotion());
        SpanStyle notAppliedStyle = TextPaintExtensions_androidKt.applySpanStyle(androidTextPaint, style.toSpanStyle(), function4, density, !spanStyles.isEmpty());

...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo4943getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        Typeface typefaceM4944buildStyledTypefaceFO1MlWM = m4944buildStyledTypefaceFO1MlWM(fontWeight, fontStyle);
        Intrinsics.checkNotNullExpressionValue(typefaceM4944buildStyledTypefaceFO1MlWM, "buildStyledTypeface(fontWeight, fontStyle)");
        return typefaceM4944buildStyledTypefaceFO1MlWM;
    }

    /* JADX INFO: renamed from: buildStyledTypeface-FO1MlWM, reason: not valid java name */
    private final Typeface m4944buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int fontStyle) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m4771getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m4817equalsimpl0(fontStyle, FontStyle.INSTANCE.m4821getItalic_LCdwA()));
    }
}

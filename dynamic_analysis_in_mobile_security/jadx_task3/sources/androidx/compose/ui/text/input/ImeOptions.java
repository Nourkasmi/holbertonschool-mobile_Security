...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m4907getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m4933getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m4880getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ ImeOptions m4888copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            z = imeOptions.singleLine;
        }
        return imeOptions.m4889copyuxg59PA(z, (i4 & 2) != 0 ? imeOptions.capitalization : i, (i4 & 4) != 0 ? imeOptions.autoCorrect : z2, (i4 & 8) != 0 ? imeOptions.keyboardType : i2, (i4 & 16) != 0 ? imeOptions.imeAction : i3);
    }

    /* JADX INFO: renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m4889copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ImeOptions) && this.singleLine == ((ImeOptions) other).singleLine && KeyboardCapitalization.m4898equalsimpl0(this.capitalization, ((ImeOptions) other).capitalization) && this.autoCorrect == ((ImeOptions) other).autoCorrect && KeyboardType.m4913equalsimpl0(this.keyboardType, ((ImeOptions) other).keyboardType) && ImeAction.m4868equalsimpl0(this.imeAction, ((ImeOptions) other).imeAction);
    }

    public int hashCode() {
        int result = Boolean.hashCode(this.singleLine);
        return (((((((result * 31) + KeyboardCapitalization.m4899hashCodeimpl(this.capitalization)) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4914hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4869hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m4900toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4915toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4870toStringimpl(this.imeAction)) + ')';
    }
}

...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        this.minIntrinsicWidth = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$minIntrinsicWidth$2
            ...
            public final Float invoke() {
                ...
                if (infoList$ui_text_release.isEmpty()) {
                    ...
                    maxElem$iv = infoList$ui_text_release.get(0);
                    ...
                    if (1 <= lastIndex) {
                        while (true) {
                            Object e$iv = infoList$ui_text_release.get(i$iv);
        ...
        List<AnnotatedString.Range<ParagraphStyle>> list = listNormalizedParagraphStyles;
        int size = list.size();
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        ...
        return style.m4628copyNH1kkwU((509 & 1) != 0 ? style.textAlign : null, (509 & 2) != 0 ? style.textDirection : defaultStyle.getTextDirection(), (509 & 4) != 0 ? style.lineHeight : 0L, (509 & 8) != 0 ? style.textIndent : null, (509 & 16) != 0 ? style.platformStyle : null, (509 & 32) != 0 ? style.lineHeightStyle : null, (509 & 64) != 0 ? style.lineBreak : null, (509 & 128) != 0 ? style.hyphens : null, (509 & 256) != 0 ? style.textMotion : null);
    }
}

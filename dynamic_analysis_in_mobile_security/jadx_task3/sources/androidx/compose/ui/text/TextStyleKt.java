...
public final class TextStyleKt {
    ...
    public static final int m4753resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m5093equalsimpl0(textDirection.getValue(), TextDirection.INSTANCE.m5097getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m5098getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m5099getContentOrRtls_7Xco();
                default:
        ...
        if (textDirection == null) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.INSTANCE.m5100getLtrs_7Xco();
                case 2:
                    return TextDirection.INSTANCE.m5101getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }

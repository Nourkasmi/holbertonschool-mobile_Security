...
public final class TextRangeKt {
    ...
    public static final String m4728substringFDrldGo(CharSequence substring, long range) {
        Intrinsics.checkNotNullParameter(substring, "$this$substring");
        return substring.subSequence(TextRange.m4719getMinimpl(range), TextRange.m4718getMaximpl(range)).toString();
    }

    public static final long TextRange(int start, int end) {
        return TextRange.m4710constructorimpl(packWithCheck(start, end));
    }
    ...
    public static final long m4727coerceIn8ffj60Q(long $this$coerceIn_u2d8ffj60Q, int minimumValue, int maximumValue) {
        int newStart = RangesKt.coerceIn(TextRange.m4721getStartimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        int newEnd = RangesKt.coerceIn(TextRange.m4716getEndimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        if (newStart != TextRange.m4721getStartimpl($this$coerceIn_u2d8ffj60Q) || newEnd != TextRange.m4716getEndimpl($this$coerceIn_u2d8ffj60Q)) {

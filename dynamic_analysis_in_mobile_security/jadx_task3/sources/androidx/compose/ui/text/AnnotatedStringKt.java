...
public final class AnnotatedStringKt {
    ...
    public static final List<AnnotatedString.Range<ParagraphStyle>> normalizedParagraphStyles(AnnotatedString $this$normalizedParagraphStyles, ParagraphStyle defaultParagraphStyle) {
        ...
        List<AnnotatedString.Range<ParagraphStyle>> paragraphStylesOrNull$ui_text_release = $this$normalizedParagraphStyles.getParagraphStylesOrNull$ui_text_release();
    ...
    public static final List<AnnotatedString.Range<SpanStyle>> getLocalSpanStyles(AnnotatedString $this$getLocalSpanStyles, int start, int end) {
        ...
        while (index$iv$iv < size) {
            ...
            if (intersect(start, end, range2.getStart(), range2.getEnd())) {
                target$iv.add(range);
            }
            index$iv$iv++;
            list = list2;
        ...
        while (index$iv$iv2 < size2) {
            ...
            int $i$f$fastMap3 = it.getStart();
            target$iv2.add(new AnnotatedString.Range(item, RangesKt.coerceIn($i$f$fastMap3, start, end) - start, RangesKt.coerceIn(it.getEnd(), start, end) - start));
            index$iv$iv2++;
    ...
    public static final List<AnnotatedString.Range<ParagraphStyle>> getLocalParagraphStyles(AnnotatedString $this$getLocalParagraphStyles, int start, int end) {
        ...
        int size = list.size();
        while (index$iv$iv < size) {
            AnnotatedString.Range<ParagraphStyle> range = list.get(index$iv$iv);
    ...
    public static final List<AnnotatedString.Range<? extends Object>> getLocalAnnotations(AnnotatedString $this$getLocalAnnotations, int start, int end) {
        ...
        List<AnnotatedString.Range<? extends Object>> list = annotations$ui_text_release;
        ...
        int size = list.size();
        while (index$iv$iv < size) {
            AnnotatedString.Range<? extends Object> range = list.get(index$iv$iv);
            AnnotatedString.Range<? extends Object> range2 = range;
            List<AnnotatedString.Range<? extends Object>> list2 = list;
            if (intersect(i, end, range2.getStart(), range2.getEnd())) {
                target$iv.add(range);
            }
            index$iv$iv++;
            list = list2;
        ...
        while (index$iv$iv2 < size2) {
            ...
            int $i$f$fastMap2 = $i$f$fastMap;
            int $i$f$fastMap3 = it.getStart();
            target$iv2.add(new AnnotatedString.Range(item, RangesKt.coerceIn($i$f$fastMap3, i, end) - i, RangesKt.coerceIn(it.getEnd(), i, end) - i, tag));
            index$iv$iv2++;
            i = start;
            $this$fastMap$iv = $this$fastMap$iv2;
            $i$f$fastMap = $i$f$fastMap2;
    ...
    public static final AnnotatedString substringWithoutParagraphStyles(AnnotatedString $this$substringWithoutParagraphStyles, int start, int end) {
        ...
        return new AnnotatedString(strSubstring, getLocalSpanStyles($this$substringWithoutParagraphStyles, start, end), null, null, 12, null);
    }
    ...
    public static final <T> List<T> mapEachParagraphStyle(AnnotatedString $this$mapEachParagraphStyle, ParagraphStyle defaultParagraphStyle, Function2<? super AnnotatedString, ? super AnnotatedString.Range<ParagraphStyle>, ? extends T> block) {
        ...
        ArrayList target$iv = new ArrayList(listNormalizedParagraphStyles.size());
        int index$iv$iv = 0;
        ...
        while (index$iv$iv < size) {
            ...
            int $i$f$mapEachParagraphStyle3 = range.getStart();
            AnnotatedString annotatedString = substringWithoutParagraphStyles($this$mapEachParagraphStyle, $i$f$mapEachParagraphStyle3, range.getEnd());
            target$iv.add(block.invoke(annotatedString, range));
            index$iv$iv++;
    ...
    public static final <T> List<AnnotatedString.Range<T>> filterRanges(List<? extends AnnotatedString.Range<? extends T>> list, int start, int end) {
        ...
        List<? extends AnnotatedString.Range<? extends T>> list2 = list;
        List target$iv = new ArrayList(list2.size());
        int index$iv$iv = 0;
        int size = list2.size();
        while (index$iv$iv < size) {
            AnnotatedString.Range<? extends T> range = list2.get(index$iv$iv);
            AnnotatedString.Range<? extends T> range2 = range;
            List<? extends AnnotatedString.Range<? extends T>> list3 = list2;
            if (intersect(start, end, range2.getStart(), range2.getEnd())) {
                target$iv.add(range);
            }
            index$iv$iv++;
        ...
        while (index$iv$iv2 < size2) {
            ...
            int $i$f$fastMap2 = $i$f$fastMap;
            int $i$f$fastMap3 = it.getStart();
            target$iv2.add(new AnnotatedString.Range(item, Math.max(start, $i$f$fastMap3) - start, Math.min(end, it.getEnd()) - start, it.getTag()));
            index$iv$iv2++;
            $this$fastMap$iv = $this$fastMap$iv2;
            $i$f$fastMap = $i$f$fastMap2;
            $this$fastForEach$iv$iv = $this$fastForEach$iv$iv;

...
public final class FontStyle {
    ...
    public static final /* synthetic */ FontStyle m4814boximpl(int i) {
    ...
    public static boolean m4816equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m4820unboximpl();
    }
    ...
    public static String m4819toStringimpl(int arg0) {
        return m4817equalsimpl0(arg0, Normal) ? "Normal" : m4817equalsimpl0(arg0, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4822getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* JADX INFO: renamed from: getItalic-_-LCdwA, reason: not valid java name */
        public final int m4821getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m4814boximpl(m4822getNormal_LCdwA()), FontStyle.m4814boximpl(m4821getItalic_LCdwA())});
        }
    }
}

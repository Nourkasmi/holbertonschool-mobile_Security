...
public final class FontMatcher {
    ...
    public final List<Font> m4813matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        List list;
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            Font it = font;
            if (Intrinsics.areEqual(it.getWeight(), fontWeight) && FontStyle.m4817equalsimpl0(it.getStyle(), fontStyle)) {
                target$iv.add(font);
            }
        }
        List it2 = target$iv;
        ...
        for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
            ...
            if (FontStyle.m4817equalsimpl0(it3.getStyle(), fontStyle)) {
                target$iv2.add(it3);
            }
        }
    ...
    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m4811matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m4812matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m4812matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m4813matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }
}

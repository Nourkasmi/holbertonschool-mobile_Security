...
final class TypefaceBuilderCompat {
    ...
    private final FontVariationAxis[] toVariationSettings(FontVariation.Settings $this$toVariationSettings, Context context) {
        ...
        List<FontVariation.Setting> settings = $this$toVariationSettings.getSettings();
        Collection target$iv = new ArrayList(settings.size());
        int index$iv$iv = 0;
        int size = settings.size();
        while (index$iv$iv < size) {
            Object item$iv$iv = settings.get(index$iv$iv);

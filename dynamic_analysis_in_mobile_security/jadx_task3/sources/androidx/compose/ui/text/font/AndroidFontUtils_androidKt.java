...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4771getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0;
        boolean isItalic = FontStyle.m4817equalsimpl0(fontStyle, FontStyle.INSTANCE.m4821getItalic_LCdwA());

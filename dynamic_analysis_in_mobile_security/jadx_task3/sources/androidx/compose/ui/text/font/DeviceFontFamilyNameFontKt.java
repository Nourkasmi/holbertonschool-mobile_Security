...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static /* synthetic */ Font m4790Fontvxs03AY$default(String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return m4789Fontvxs03AY(str, fontWeight, i, settings);
    }

    /* JADX INFO: renamed from: Font-vxs03AY, reason: not valid java name */
    public static final Font m4789Fontvxs03AY(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings) {

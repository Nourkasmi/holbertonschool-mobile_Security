...
public final class FontListFontFamilyTypefaceAdapterKt {
    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        Object result;
        Object it$iv;
        Object objM4781unboximpl;
        int size = list.size();
        List asyncFontsToLoad = null;
        for (int idx = 0; idx < size; idx++) {
            Font font = list.get(idx);
            int loadingStrategy = font.getLoadingStrategy();
            if (!FontLoadingStrategy.m4804equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4809getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m4804equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4810getOptionalLocalPKNRLFQ())) {
                    if (!FontLoadingStrategy.m4804equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4808getAsyncPKNRLFQ())) {
                        throw new IllegalStateException("Unknown font type " + font);
                    }
                    AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m4773get1ASDuI8(font, platformFontLoader);
                    if (cacheResult == null) {
                    ...
                    } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m4779isPermanentFailureimpl(cacheResult.m4781unboximpl()) && cacheResult.m4781unboximpl() != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4836synthesizeTypefaceFxwP2eA(typefaceRequest.m4861getFontSynthesisGVVA2EU(), cacheResult.m4781unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m4860getFontStyle_LCdwA()));
                    }
                } else {
                    ...
                    synchronized (lock$iv$iv) {
                        ...
                        if (priorResult$iv == null) {
                            ...
                            try {
                                ...
                                it$iv = Result.m5499constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                it$iv = Result.m5499constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m5505isFailureimpl(it$iv)) {
                                it$iv = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, it$iv, false, 8, null);
                            objM4781unboximpl = it$iv;
                        } else {
                            objM4781unboximpl = priorResult$iv.m4781unboximpl();
                        }
                    }
                    Object result2 = objM4781unboximpl;
                    if (result2 != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4836synthesizeTypefaceFxwP2eA(typefaceRequest.m4861getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m4860getFontStyle_LCdwA()));
                    }
                }
            } else {
                ...
                synchronized (lock$iv$iv2) {
                    ...
                    if (priorResult$iv2 == null) {
                        ...
                        result = priorResult$iv2.m4781unboximpl();
                    }
                }
                if (result == null) {
                    throw new IllegalStateException("Unable to load font " + font);
                }
                return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4836synthesizeTypefaceFxwP2eA(typefaceRequest.m4861getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m4860getFontStyle_LCdwA()));
            }
        }

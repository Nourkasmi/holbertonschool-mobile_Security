...
public final class FontLoadingStrategy {
    ...
    private static final int Blocking = m4802constructorimpl(0);
    private static final int OptionalLocal = m4802constructorimpl(1);
    private static final int Async = m4802constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontLoadingStrategy m4801boximpl(int i) {
        return new FontLoadingStrategy(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m4802constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4803equalsimpl(int i, Object obj) {
        return (obj instanceof FontLoadingStrategy) && i == ((FontLoadingStrategy) obj).m4807unboximpl();
    }
    ...
    public static String m4806toStringimpl(int arg0) {
        return m4804equalsimpl0(arg0, Blocking) ? "Blocking" : m4804equalsimpl0(arg0, OptionalLocal) ? "Optional" : m4804equalsimpl0(arg0, Async) ? "Async" : "Invalid(value=" + arg0 + ')';
    }

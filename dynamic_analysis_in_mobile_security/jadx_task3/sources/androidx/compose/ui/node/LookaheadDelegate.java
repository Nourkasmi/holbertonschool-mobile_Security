...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4351setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult result) {
        Unit unit;
        if (result != null) {
            m4238setMeasuredSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            $this$_set__measureResult__u24lambda_u241.m4238setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5377getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4184placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public final void mo4184placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m5329equalsimpl0(getPosition(), position)) {
            m4351setPositiongyyYBs(position);
    ...
    public final Placeable m4349performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4350positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long aggregatedOffset = IntOffset.INSTANCE.m5340getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            aggregatedOffset = IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(aggregatedOffset) + IntOffset.m5330getXimpl(other$iv), IntOffset.m5331getYimpl(aggregatedOffset) + IntOffset.m5331getYimpl(other$iv));

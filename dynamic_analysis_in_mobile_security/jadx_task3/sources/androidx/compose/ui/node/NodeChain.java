    ...
    */
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        for (Modifier.Node node = start.getParent(); node != null; node = node.getParent()) {
            if (node == NodeChainKt.SentinelHead) {
                ...
                if (!((this_$iv.getKindSet() & NodeKind.m4398constructorimpl(2)) != 0)) {
                    node.updateCoordinator$ui_release(coordinator);
                } else {
                    return;
                }
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((toRemove.getKindSet() & NodeKind.m4398constructorimpl(2)) != 0) {
    ...
    public final /* synthetic */ <T> T m4360firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
        int i;
        NodeChain nodeChain;
        int i2;
    ...
    public final /* synthetic */ <T> void m4363headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int i;
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> void m4365tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> T m4364tailH91voCI$ui_release(int type) {
        int i;
        int i2;
        NodeChain nodeChain;
        int i3;
    ...
    public final /* synthetic */ <T> T m4362headH91voCI$ui_release(int type) {
        int i;
        NodeChain nodeChain;
        int i2;
        NodeChain nodeChain2;
    ...
    public final boolean m4361hasH91voCI$ui_release(int type) {

...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4355updateRootConstraintsBRTryo0(long constraints) {
        ...
        if (!(constraints2 == null ? false : Constraints.m5161equalsimpl0(constraints2.getValue(), constraints))) {
            ...
            this.rootConstraints = Constraints.m5156boximpl(constraints);
    ...
    private final boolean m4352doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean lookaheadSizeChanged;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints == null) {
            lookaheadSizeChanged = LayoutNode.m4321lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        } else {
            lookaheadSizeChanged = layoutNode.m4325lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    private final boolean m4353doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean sizeChanged;
        if (constraints == null) {
            sizeChanged = LayoutNode.m4322remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        } else {
            sizeChanged = layoutNode.m4326remeasure_Sx5XlM$ui_release(constraints);
        }
        LayoutNode parent = layoutNode.getParent$ui_release();
    ...
    public final void m4354measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean lookaheadSizeChanged = m4352doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m5156boximpl(constraints));
                m4353doRemeasuresdFAvZA(layoutNode, Constraints.m5156boximpl(constraints));
        ...
        if (layoutNode.isPlaced() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
                ...
                if (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) {
                    lookaheadSizeChanged = m4352doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                }
                sizeChanged = m4353doRemeasuresdFAvZA(layoutNode, constraints);
            }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release()) {
            m4352doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        }
        m4353doRemeasuresdFAvZA(layoutNode, constraints);
    }
    ...
    public final void forceMeasureTheSubtree(LayoutNode layoutNode, final boolean affectsLookahead) {
        ...
        if (size$iv$iv > 0) {
            ...
            do {
                LayoutNode child = (LayoutNode) content$iv$iv[i$iv$iv];
                if (function1.invoke(child).booleanValue() && this.relayoutNodes.remove(child, affectsLookahead)) {

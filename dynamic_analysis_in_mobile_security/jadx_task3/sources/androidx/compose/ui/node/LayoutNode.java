...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo12measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List measurables, long constraints) {
            return (MeasureResult) m4328measure3p2s80s($this$measure_u2d3p2s80s, (List<? extends Measurable>) measurables, constraints);
        }

        /* JADX INFO: renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m4328measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4327getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m5320getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (!this.nodes.m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int type$iv3 = NodeKind.m4398constructorimpl(8);
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (this.nodes.m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long innerContentConstraints = getInnerCoordinator$ui_release().m4382getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m5166getHasFixedWidthimpl(innerContentConstraints) && Constraints.m5165getHasFixedHeightimpl(innerContentConstraints);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List measurables, int width) {
            return ((Number) m4329maxIntrinsicHeight($this$maxIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List measurables, int height) {
            return ((Number) m4330maxIntrinsicWidth($this$maxIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List measurables, int width) {
            return ((Number) m4331minIntrinsicHeight($this$minIntrinsicHeight, (List<? extends IntrinsicMeasurable>) measurables, width)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List measurables, int height) {
            return ((Number) m4332minIntrinsicWidth($this$minIntrinsicWidth, (List<? extends IntrinsicMeasurable>) measurables, height)).intValue();
        }

        /* JADX INFO: renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m4332minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        public Void m4331minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
        ...
        public Void m4330maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
        ...
        public Void m4329maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
    ...
    public void setDensity(Density value) {
        ...
        if (!Intrinsics.areEqual(this.density, value)) {
            ...
            int type$iv4 = NodeKind.m4398constructorimpl(16);
            int i4 = 0;
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        int type$iv4 = NodeKind.m4398constructorimpl(32768);
    ...
    public void setModifier(Modifier value) {
        ...
        if (this.nodes.m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(512)) && this.lookaheadRoot == null) {
    ...
    public static /* synthetic */ void m4319hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        boolean z3;
        boolean z4;
        if ((i & 4) == 0) {
            z3 = z;
        ...
        layoutNode.m4323hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z4);
    }

    /* JADX INFO: renamed from: hitTest-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4323hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        long positionInWrapped = getOuterCoordinator$ui_release().m4381fromParentPositionMKHz9U(pointerPosition);
        getOuterCoordinator$ui_release().m4385hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
    }

    /* JADX INFO: renamed from: hitTestSemantics-M_7yMNQ$ui_release$default, reason: not valid java name */
    public static /* synthetic */ void m4320hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        boolean z3;
        boolean z4;
        if ((i & 4) == 0) {
            z3 = z;
        ...
        layoutNode.m4324hitTestSemanticsM_7yMNQ$ui_release(j, hitTestResult, z3, z4);
    }

    /* JADX INFO: renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4324hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitSemanticsEntities, "hitSemanticsEntities");
        long positionInWrapped = getOuterCoordinator$ui_release().m4381fromParentPositionMKHz9U(pointerPosition);
        getOuterCoordinator$ui_release().m4385hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), positionInWrapped, hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        ...
        int $this$or_u2d64DMado$iv = NodeKind.m4398constructorimpl(1024) | NodeKind.m4398constructorimpl(2048);
        if (nodeChain.has$ui_release($this$or_u2d64DMado$iv | NodeKind.m4398constructorimpl(4096))) {
            NodeChain this_$iv = this.nodes;
            for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
                Modifier.Node it = node$iv;
                int kind$iv = (it.getKindSet() & NodeKind.m4398constructorimpl(1024)) != 0 ? 1 : 0;
                int kind$iv2 = (it.getKindSet() & NodeKind.m4398constructorimpl(2048)) != 0 ? 1 : 0;
                if ((kind$iv | kind$iv2 | ((it.getKindSet() & NodeKind.m4398constructorimpl(4096)) == 0 ? 0 : 1)) != 0) {
    ...
    private final void invalidateFocusOnDetach() {
        ...
        MutableVector mutableVector;
        NodeChain this_$iv = this.nodes;
        int type$iv3 = NodeKind.m4398constructorimpl(1024);
        int i = 0;
        int mask$iv$iv2 = type$iv3;
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        char c2 = 256;
        int type$iv4 = NodeKind.m4398constructorimpl(256);
        int i3 = 0;
            ...
            if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                ...
                while (nodePop != null) {
                    if (nodePop instanceof GlobalPositionAwareModifierNode) {
                        ...
                        this_$iv2 = this_$iv3;
                        i2 = i3;
                        it.onGloballyPositioned(DelegatableNodeKt.m4296requireCoordinator64DMado(it, NodeKind.m4398constructorimpl(256)));
                        type$iv2 = type$iv4;
                    } else {
                        this_$iv2 = this_$iv3;
                        i2 = i3;
    ...
    public static /* synthetic */ boolean m4321lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4340getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4325lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* JADX INFO: renamed from: lookaheadRemeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4325lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null && this.lookaheadRoot != null) {
            LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
            Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
            return lookaheadPassDelegate$ui_release.m4343remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }

    /* JADX INFO: renamed from: remeasure-_Sx5XlM$ui_release$default, reason: not valid java name */
    public static /* synthetic */ boolean m4322remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4339getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4326remeasure_Sx5XlM$ui_release(constraints);
    }

    /* JADX INFO: renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4326remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null) {
            if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
                clearSubtreeIntrinsicsUsage$ui_release();
            }
            return getMeasurePassDelegate$ui_release().m4346remeasureBRTryo0(constraints.getValue());
        }
        return false;
    }
    ...
    public final void invalidateSubtree(boolean isRootOfInvalidation) {
        ...
        NodeChain this_$iv4 = this.nodes;
        char c3 = 2;
        int type$iv4 = NodeKind.m4398constructorimpl(2);
        if ((this_$iv4.getAggregateChildKindSet() & type$iv4) != 0) {
            Modifier.Node node$iv$iv$iv = this_$iv4.getHead();
            while (node$iv$iv$iv != null) {
                Modifier.Node it$iv$iv = node$iv$iv$iv;
                if ((it$iv$iv.getKindSet() & type$iv4) == 0) {
                    ...
                    while (nodePop != null) {
                        if (nodePop instanceof LayoutModifierNode) {
                            ...
                            c2 = 2;
                            OwnedLayer layer = DelegatableNodeKt.m4296requireCoordinator64DMado(it, NodeKind.m4398constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                            this_$iv2 = this_$iv4;
    ...
    public void forceRemeasure() {
        ...
        Constraints lastConstraints = this.layoutDelegate.m4339getLastConstraintsDWUhwKw();
        if (lastConstraints != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4453measureAndLayout0kLqBqw(this, lastConstraints.getValue());
                return;
            }
            return;
        }
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(4)) && !this.nodes.m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(2))) {
            return true;
        }
        NodeChain this_$iv = this.nodes;
        for (Modifier.Node node$iv = this_$iv.getHead(); node$iv != null; node$iv = node$iv.getChild()) {
            Modifier.Node it = node$iv;
            int kind$iv = (it.getKindSet() & NodeKind.m4398constructorimpl(2)) != 0 ? 1 : 0;
            if (kind$iv != 0 && DelegatableNodeKt.m4296requireCoordinator64DMado(it, NodeKind.m4398constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((it.getKindSet() & NodeKind.m4398constructorimpl(4)) != 0) {
                return true;
            }
        }
        return true;

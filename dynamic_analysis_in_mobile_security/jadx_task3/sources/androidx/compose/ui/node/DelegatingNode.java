...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    */
    ...
    protected final void undelegate(DelegatableNode instance) {
        ...
        if (getIsAttached()) {
            int value$iv = (beforeKindSet & NodeKind.m4398constructorimpl(2)) != 0 ? 1 : 0;
            if (value$iv != 0) {
                if ((afterKindSet & NodeKind.m4398constructorimpl(2)) != 0) {
                    return;
                }
    ...
    private final void validateDelegateKindSet(int delegateKindSet, Modifier.Node delegateNode) {
        ...
        int value$iv = (delegateKindSet & NodeKind.m4398constructorimpl(2)) != 0 ? 1 : 0;
        if (value$iv != 0) {
            if (((current & NodeKind.m4398constructorimpl(2)) != 0) && !(this instanceof LayoutModifierNode)) {

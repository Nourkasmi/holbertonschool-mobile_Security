...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        ...
        if (!useMinimumTouchTarget) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4296requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m4398constructorimpl(8)));
        }
        return DelegatableNodeKt.m4296requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m4398constructorimpl(8)).touchBoundsInRoot();
    }
}

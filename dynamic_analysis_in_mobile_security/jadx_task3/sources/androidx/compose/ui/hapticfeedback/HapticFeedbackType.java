...
public final class HapticFeedbackType {
    ...
    public static final /* synthetic */ HapticFeedbackType m3596boximpl(int i) {
        return new HapticFeedbackType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3597constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3598equalsimpl(int i, Object obj) {
        return (obj instanceof HapticFeedbackType) && i == ((HapticFeedbackType) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3599equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3600hashCodeimpl(int i) {
    ...
    public static String m3601toStringimpl(int arg0) {
        Companion companion = INSTANCE;
        return m3599equalsimpl0(arg0, companion.m3603getLongPress5zf0vsI()) ? "LongPress" : m3599equalsimpl0(arg0, companion.m3604getTextHandleMove5zf0vsI()) ? "TextHandleMove" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m3603getLongPress5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m3605getLongPress5zf0vsI();
        }

        /* JADX INFO: renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
        public final int m3604getTextHandleMove5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m3606getTextHandleMove5zf0vsI();
        }

        public final List<HapticFeedbackType> values() {
            return CollectionsKt.listOf((Object[]) new HapticFeedbackType[]{HapticFeedbackType.m3596boximpl(m3603getLongPress5zf0vsI()), HapticFeedbackType.m3596boximpl(m3604getTextHandleMove5zf0vsI())});
        }
    }
}

...
public final class ModifierLocalProviderKt {
    public static final <T> Modifier modifierLocalProvider(Modifier $this$modifierLocalProvider, final ProvidableModifierLocal<T> key, final Function0<? extends T> value) {
        ...
        return $this$modifierLocalProvider.then(new AnonymousClass1(key, value, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.modifier.ModifierLocalProviderKt$modifierLocalProvider$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("key", key);

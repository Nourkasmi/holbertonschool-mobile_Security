...
public final class SemanticsNode {
    ...
    public final long m4573getSizeYbymL2g() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null ? nodeCoordinatorFindCoordinatorToGetBounds$ui_release.mo4190getSizeYbymL2g() : IntSize.INSTANCE.m5377getZeroYbymL2g();
    }
    ...
    public final long m4571getPositionInRootF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    public final Rect getBoundsInWindow() {
        ...
        if (it != null) {
            ...
            if (it != null && (rectBoundsInWindow = LayoutCoordinatesKt.boundsInWindow(it)) != null) {
    ...
    public final long m4572getPositionInWindowF1C5BW0() {
        NodeCoordinator it = findCoordinatorToGetBounds$ui_release();
        if (it != null) {
            if (!it.isAttached()) {
                it = null;
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode $this$fillOneLayerOfSemanticsWrappers, List<SemanticsNode> list) {
        ...
        do {
            ...
            if (child.getNodes().m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(8))) {
    ...
    public final SemanticsNode getParent() {
        ...
        if (node == null) {
            node = SemanticsNodeKt.findClosestParentNode(this.layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.semantics.SemanticsNode$parent$2
                ...
                public final Boolean invoke(LayoutNode it) {
                    Intrinsics.checkNotNullParameter(it, "it");
                    return Boolean.valueOf(it.getNodes().m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(8)));
                }
            });
        }
        if (node == null) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m4296requireCoordinator64DMado(semanticsModifierNode, NodeKind.m4398constructorimpl(8));
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> unmergedChildren) {
        ...
        if (nodeRole != null && this.unmergedConfig.getIsMergingSemanticsOfDescendants() && (!unmergedChildren.isEmpty())) {
            SemanticsNode fakeNode = m4570fakeSemanticsNodeypyhhiA(nodeRole, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver fakeSemanticsNode) {
                    ...
                    SemanticsPropertiesKt.m4577setRolekuIjeqM(fakeSemanticsNode, nodeRole.getValue());
                }
            });
        ...
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && (!unmergedChildren.isEmpty()) && this.unmergedConfig.getIsMergingSemanticsOfDescendants()) {
            ...
            if (contentDescription != null) {
                SemanticsNode fakeNode2 = m4570fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m4570fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> properties) {

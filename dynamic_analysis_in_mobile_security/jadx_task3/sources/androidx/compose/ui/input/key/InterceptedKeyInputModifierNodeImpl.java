...
final class InterceptedKeyInputModifierNodeImpl extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean mo3619onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m3915boximpl(event)).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo3620onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");

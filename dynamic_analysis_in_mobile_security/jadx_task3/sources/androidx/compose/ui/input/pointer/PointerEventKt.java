...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        ...
        return !Offset.m2705equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m2724getZeroF1C5BW0());
    }
    ...
    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        ...
        return true ^ Offset.m2705equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m2724getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        long offset = Offset.m2712minusMKHz9U(currentPosition, previousPosition);
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m2724getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        ...
        if (!Offset.m2705equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m2724getZeroF1C5BW0())) {
    ...
    public static final boolean m4010isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long size) {
    ...
    public static final boolean m4011isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long size, long extendedTouchPadding) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m4136equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m4143getTouchT8wyACA())) {
            return m4010isOutOfBoundsO0kMr_c(isOutOfBounds, size);
        }
        long position = isOutOfBounds.getPosition();
        float x = Offset.m2708getXimpl(position);
        float y = Offset.m2709getYimpl(position);
        float minX = -Size.m2777getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m5372getWidthimpl(size) + Size.m2777getWidthimpl(extendedTouchPadding);
        float minY = -Size.m2774getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m5371getHeightimpl(size) + Size.m2774getHeightimpl(extendedTouchPadding);

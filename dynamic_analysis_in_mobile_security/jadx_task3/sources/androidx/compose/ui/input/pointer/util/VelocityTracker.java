...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m2724getZeroF1C5BW0();
    ...
    public final void m4159setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
        this.currentPointerPositionAccumulator = j;
    }

    /* JADX INFO: renamed from: addPosition-Uv8p0NA, reason: not valid java name */
    public final void m4156addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m2708getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m2709getYimpl(position));
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m4157calculateVelocity9UxMQ8M() {

...
public final class MotionEventAdapter {
    ...
    private final long m3996getComposePointerId_I2yYro(int motionEventPointerId) {
        long newId;
        ...
        return PointerId.m4046constructorimpl(newId);
    }
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int index, boolean pressed) {
        ...
        long pointerId = m3996getComposePointerId_I2yYro(motionEventPointerId);
        ...
        if (index == 0) {
            ...
            position = positionCalculator.mo4146screenToLocalMKHz9U(rawPosition2);
            rawPosition = rawPosition2;
        } else if (Build.VERSION.SDK_INT >= 29) {
            long rawPosition3 = MotionEventHelper.INSTANCE.m3997toRawOffsetdBAh8RU(motionEvent, index);
            position = positionCalculator.mo4146screenToLocalMKHz9U(rawPosition3);
            rawPosition = rawPosition3;
        } else {
            long rawPosition4 = positionCalculator.mo4145localToScreenMKHz9U(position2);
            position = position2;
            rawPosition = rawPosition4;
        }
        switch (motionEvent.getToolType(index)) {
            case 0:
                toolType = PointerType.INSTANCE.m4144getUnknownT8wyACA();
                break;
            case 1:
                toolType = PointerType.INSTANCE.m4143getTouchT8wyACA();
                break;
            case 2:
                toolType = PointerType.INSTANCE.m4142getStylusT8wyACA();
                break;
            case 3:
                toolType = PointerType.INSTANCE.m4141getMouseT8wyACA();
                break;
            case 4:
                toolType = PointerType.INSTANCE.m4140getEraserT8wyACA();
                break;
            default:
                toolType = PointerType.INSTANCE.m4144getUnknownT8wyACA();
                break;
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            scrollDelta = Offset.INSTANCE.m2724getZeroF1C5BW0();
        }

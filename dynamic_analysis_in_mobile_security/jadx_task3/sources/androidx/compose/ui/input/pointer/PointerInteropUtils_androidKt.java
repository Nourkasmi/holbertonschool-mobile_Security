...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m4124toMotionEventScoped4ec7I(PointerEvent toMotionEventScope, long offset, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m4125toMotionEventScopeubNVwUQ(toMotionEventScope, offset, block, false);
    }

    /* JADX INFO: renamed from: toCancelMotionEventScope-d-4ec7I, reason: not valid java name */
    public static final void m4123toCancelMotionEventScoped4ec7I(PointerEvent toCancelMotionEventScope, long offset, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m4125toMotionEventScopeubNVwUQ(toCancelMotionEventScope, offset, block, true);
    }
    ...
    private static final void m4125toMotionEventScopeubNVwUQ(PointerEvent $this$toMotionEventScope_u2dubNVwUQ, long offset, Function1<? super MotionEvent, Unit> function1, boolean cancel) {
        ...
        motionEvent.offsetLocation(-Offset.m2708getXimpl(offset), -Offset.m2709getYimpl(offset));

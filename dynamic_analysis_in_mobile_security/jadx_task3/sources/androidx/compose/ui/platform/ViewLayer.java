...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m3330getCenterSzJe1aQ();
    ...
    */
    ...
    public void mo4447resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m3325getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m3326getPivotFractionYimpl(this.mTransformOrigin) * height);
    ...
    public void mo4446movegyyYBs(long position) {
        int left = IntOffset.m5330getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m5331getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo4445mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM4514calculateInverseMatrixbWbORWo = this.matrixCache.m4514calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m3177mapMKHz9U(this.matrixCache.m4515calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        if (inverse) {
            float[] matrix = this.matrixCache.m4514calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m3179mapimpl(this.matrixCache.m4515calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4448transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m3188timesAssign58bKbWc(matrix, this.matrixCache.m4515calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo4443inverseTransform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] inverse = this.matrixCache.m4514calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {

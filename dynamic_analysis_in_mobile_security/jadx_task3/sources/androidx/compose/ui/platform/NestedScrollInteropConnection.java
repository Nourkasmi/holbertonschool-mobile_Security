...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo335onPreScrollOzD1aCk(long available, int source) {
        if (!this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m4533getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m4535toViewTypeGyEprt8(source))) {
            return Offset.INSTANCE.m2724getZeroF1C5BW0();
        }
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m4535toViewTypeGyEprt8(source));
        return NestedScrollInteropConnectionKt.m4534toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
    ...
    public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2708getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2709getYimpl(available)), null, NestedScrollInteropConnectionKt.m4535toViewTypeGyEprt8(source), this.consumedScrollCache);
        return NestedScrollInteropConnectionKt.m4534toOffsetUv8p0NA(this.consumedScrollCache, available);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPreFling-QWom1Mo */
    public Object mo558onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        long result;
        if (this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5437getXimpl(available)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5438getYimpl(available)))) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m5448getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m5428boximpl(result);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo333onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        long result;
        if (this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5437getXimpl(available)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5438getYimpl(available)), true)) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m5448getZero9UxMQ8M();
        }

...
public final class AndroidComposeView_androidKt {
    ...
    public static final void m4487preTransformJiSxe2E(float[] $this$preTransform_u2dJiSxe2E, float[] other) {
        float v00 = m4486dotp89u6pk(other, 0, $this$preTransform_u2dJiSxe2E, 0);
        float v01 = m4486dotp89u6pk(other, 0, $this$preTransform_u2dJiSxe2E, 1);
        float v02 = m4486dotp89u6pk(other, 0, $this$preTransform_u2dJiSxe2E, 2);
        float v03 = m4486dotp89u6pk(other, 0, $this$preTransform_u2dJiSxe2E, 3);
        float v10 = m4486dotp89u6pk(other, 1, $this$preTransform_u2dJiSxe2E, 0);
        float v11 = m4486dotp89u6pk(other, 1, $this$preTransform_u2dJiSxe2E, 1);
        float v12 = m4486dotp89u6pk(other, 1, $this$preTransform_u2dJiSxe2E, 2);
        float v13 = m4486dotp89u6pk(other, 1, $this$preTransform_u2dJiSxe2E, 3);
        float v20 = m4486dotp89u6pk(other, 2, $this$preTransform_u2dJiSxe2E, 0);
        float v21 = m4486dotp89u6pk(other, 2, $this$preTransform_u2dJiSxe2E, 1);
        float v22 = m4486dotp89u6pk(other, 2, $this$preTransform_u2dJiSxe2E, 2);
        float v23 = m4486dotp89u6pk(other, 2, $this$preTransform_u2dJiSxe2E, 3);
        float v30 = m4486dotp89u6pk(other, 3, $this$preTransform_u2dJiSxe2E, 0);
        float v31 = m4486dotp89u6pk(other, 3, $this$preTransform_u2dJiSxe2E, 1);
        float v32 = m4486dotp89u6pk(other, 3, $this$preTransform_u2dJiSxe2E, 2);
        float v33 = m4486dotp89u6pk(other, 3, $this$preTransform_u2dJiSxe2E, 3);
    ...
    private static final float m4486dotp89u6pk(float[] m1, int row, float[] m2, int column) {

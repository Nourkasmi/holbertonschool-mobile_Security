...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = Offset.INSTANCE.m2723getUnspecifiedF1C5BW0();
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.INSTANCE, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m4478invokeZmokQxo(keyEvent.m3921unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m4478invokeZmokQxo(android.view.KeyEvent it) {
                Intrinsics.checkNotNullParameter(it, "it");
                FocusDirection focusDirection = this.this$0.mo4452getFocusDirectionP8AzH3I(it);
                if (focusDirection == null || !KeyEventType.m3925equalsimpl0(KeyEvent_androidKt.m3933getTypeZmokQxo(it), KeyEventType.INSTANCE.m3929getKeyDownCS__XNY())) {
                    return false;
                }
                return Boolean.valueOf(this.this$0.getFocusOwner().mo2645moveFocus3ESFkO8(focusDirection.getValue()));
            }
        });
        ...
        this.viewToWindowMatrix = Matrix.m3171constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m3171constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m2722getInfiniteF1C5BW0();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m3615getTouchaOaMEAU() : InputMode.INSTANCE.m3614getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m4477invokeiuPiT84(inputMode.getValue());
            }

            /* JADX INFO: renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m4477invokeiuPiT84(int it) {
                boolean zRequestFocusFromTouch;
                if (InputMode.m3610equalsimpl0(it, InputMode.INSTANCE.m3615getTouchaOaMEAU())) {
                    zRequestFocusFromTouch = this.this$0.isInTouchMode();
                } else if (InputMode.m3610equalsimpl0(it, InputMode.INSTANCE.m3614getKeyboardaOaMEAU())) {
    ...
    public static final void touchModeChangeListener$lambda$3(AndroidComposeView this$0, boolean touchMode) {
        ...
        inputModeManagerImpl.m3618setInputModeiuPiT84(touchMode ? companion.m3615getTouchaOaMEAU() : companion.m3614getKeyboardaOaMEAU());
    }
    ...
    public static final void sendHoverExitEvent$lambda$5(AndroidComposeView this$0) {
        ...
        this$0.m4476sendMotionEvent8iAsVTc(lastEvent);
    }
    ...
    public boolean mo4454sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return getFocusOwner().mo2646dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || getFocusOwner().mo2647dispatchKeyEventZmokQxo(keyEvent);
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (isFocused()) {
            this._windowInfo.m4545setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4127constructorimpl(event.getMetaState()));
            return getFocusOwner().mo2647dispatchKeyEventZmokQxo(KeyEvent.m3916constructorimpl(event)) || super.dispatchKeyEvent(event);
        }
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        return (isFocused() && getFocusOwner().mo2646dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m3916constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public void mo4453measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m4354measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) throws Throwable {
        ...
        try {
            ...
            long $this$component2_u2dVKZWuLQ$iv = m4473convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int minWidth = (int) ULong.m5673constructorimpl($this$component2_u2dVKZWuLQ$iv >>> 32);
            int maxWidth = (int) ULong.m5673constructorimpl($this$component2_u2dVKZWuLQ$iv & 4294967295L);
            try {
                long $this$component2_u2dVKZWuLQ$iv2 = m4473convertMeasureSpecI7RO_PI(heightMeasureSpec);
                int minHeight = (int) ULong.m5673constructorimpl($this$component2_u2dVKZWuLQ$iv2 >>> 32);
                int maxHeight = (int) ULong.m5673constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ$iv2);
                ...
                if (constraints2 == null) {
                    this.onMeasureConstraints = Constraints.m5156boximpl(constraints);
                    this.wasMeasuredWithMultipleConstraints = false;
                } else {
                    if (!(constraints2 != null ? Constraints.m5161equalsimpl0(constraints2.getValue(), constraints) : false)) {
                        this.wasMeasuredWithMultipleConstraints = true;
                    }
                }
                this.measureAndLayoutDelegate.m4355updateRootConstraintsBRTryo0(constraints);
    ...
    private final int m4471component1VKZWuLQ(long $this$component1_u2dVKZWuLQ) {
        return (int) ULong.m5673constructorimpl($this$component1_u2dVKZWuLQ >>> 32);
    }

    /* JADX INFO: renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m4472component2VKZWuLQ(long $this$component2_u2dVKZWuLQ) {
        return (int) ULong.m5673constructorimpl(4294967295L & $this$component2_u2dVKZWuLQ);
    }

    /* JADX INFO: renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m4475packZIaKswc(int a, int b) {
        return ULong.m5673constructorimpl(ULong.m5673constructorimpl(ULong.m5673constructorimpl(a) << 32) | ULong.m5673constructorimpl(b));
    }

    /* JADX INFO: renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m4473convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        switch (mode) {
            case Integer.MIN_VALUE:
                return m4475packZIaKswc(0, size);
            case 0:
                return m4475packZIaKswc(0, Integer.MAX_VALUE);
            case 1073741824:
                return m4475packZIaKswc(size, size);
            default:
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int globalX = IntOffset.m5322component1impl(j);
        int globalY = IntOffset.m5323component2impl(j);
    ...
    public FocusDirection mo4452getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        long jM3932getKeyZmokQxo = KeyEvent_androidKt.m3932getKeyZmokQxo(keyEvent);
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3860getTabEK5gGoQ())) {
            return FocusDirection.m2624boximpl(KeyEvent_androidKt.m3938isShiftPressedZmokQxo(keyEvent) ? FocusDirection.INSTANCE.m2642getPreviousdhqQ8s() : FocusDirection.INSTANCE.m2640getNextdhqQ8s());
        }
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3701getDirectionRightEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2643getRightdhqQ8s());
        }
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3700getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2639getLeftdhqQ8s());
        }
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3702getDirectionUpEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2644getUpdhqQ8s());
        }
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3697getDirectionDownEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2635getDowndhqQ8s());
        }
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3696getDirectionCenterEK5gGoQ()) ? true : Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3710getEnterEK5gGoQ()) ? true : Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3802getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2636getEnterdhqQ8s());
        }
        if (Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3639getBackEK5gGoQ()) ? true : Key.m3624equalsimpl0(jM3932getKeyZmokQxo, Key.INSTANCE.m3713getEscapeEK5gGoQ())) {
            return FocusDirection.m2624boximpl(FocusDirection.INSTANCE.m2637getExitdhqQ8s());
        }
        return null;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._inputModeManager.m3618setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m3615getTouchaOaMEAU() : InputMode.INSTANCE.m3614getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == 8) {
            ...
            return ProcessResult.m4152getDispatchedToAPointerInputModifierimpl(m4474handleMotionEvent8iAsVTc(event));
        }
        return super.dispatchGenericMotionEvent(event);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int processResult = m4474handleMotionEvent8iAsVTc(motionEvent);
        if (ProcessResult.m4151getAnyMovementConsumedimpl(processResult)) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return ProcessResult.m4152getDispatchedToAPointerInputModifierimpl(processResult);
    }
    ...
    private final int m4474handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        boolean z;
        int i;
        ...
        try {
            ...
            try {
                ...
                if (lastEvent2 == null || !hasChangedDevices(motionEvent, lastEvent2)) {
                    i = 3;
                ...
                return m4476sendMotionEvent8iAsVTc(motionEvent);
            } finally {
                Trace.endSection();
            }
        } finally {
    ...
    private final int m4476sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        Object item$iv;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m4545setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m4127constructorimpl(motionEvent.getMetaState()));
        }
        ...
        if (pointerInputEventData != null) {
            long it2 = pointerInputEventData.m4079getPositionF1C5BW0();
            this.lastDownPointerPosition = it2;
        }
        int result = this.pointerInputEventProcessor.m4084processBIzXfog(pointerInputEvent, this, isInBounds(motionEvent));
        int action = motionEvent.getActionMasked();
        if ((action != 0 && action != 5) || ProcessResult.m4152getDispatchedToAPointerInputModifierimpl(result)) {
            return result;
        }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long screenPosition = mo4145localToScreenMKHz9U(localPosition);
            coords.x = Offset.m2708getXimpl(screenPosition);
            coords.y = Offset.m2709getYimpl(screenPosition);
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m4084processBIzXfog(pointerInputEvent, this, true);
        event.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.accessibilityDelegate.m4481canScroll0AR0LA0$ui_release(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.accessibilityDelegate.m4481canScroll0AR0LA0$ui_release(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo4145localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long local = Matrix.m3177mapMKHz9U(this.viewToWindowMatrix, localPosition);
        return OffsetKt.Offset(Offset.m2708getXimpl(local) + Offset.m2708getXimpl(this.windowPosition), Offset.m2709getYimpl(local) + Offset.m2709getYimpl(this.windowPosition));
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U */
    public long mo4146screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        float x = Offset.m2708getXimpl(positionOnScreen) - Offset.m2708getXimpl(this.windowPosition);
        float y = Offset.m2709getYimpl(positionOnScreen) - Offset.m2709getYimpl(this.windowPosition);
        return Matrix.m3177mapMKHz9U(this.windowToViewMatrix, OffsetKt.Offset(x, y));
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        recalculateWindowViewTransforms();
        long positionInWindow = Matrix.m3177mapMKHz9U(this.viewToWindowMatrix, OffsetKt.Offset(motionEvent.getX(), motionEvent.getY()));
        this.windowPosition = OffsetKt.Offset(motionEvent.getRawX() - Offset.m2708getXimpl(positionInWindow), motionEvent.getRawY() - Offset.m2709getYimpl(positionInWindow));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo4488calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m4512invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public long mo4450calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m3177mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo4451calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m3177mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        int result = m4474handleMotionEvent8iAsVTc(event);
        return ProcessResult.m4152getDispatchedToAPointerInputModifierimpl(result);
    }

    /* JADX WARN: Removed duplicated region for block: B:32:0x0059  */
    /* JADX WARN: Removed duplicated region for block: B:61:0x00a6  */
    /* JADX WARN: Removed duplicated region for block: B:64:0x00aa A[LOOP:0: B:36:0x0062->B:64:0x00aa, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:67:0x00ad A[EDGE_INSN: B:67:0x00ad->B:65:0x00ad BREAK  A[LOOP:0: B:36:0x0062->B:64:0x00aa], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */

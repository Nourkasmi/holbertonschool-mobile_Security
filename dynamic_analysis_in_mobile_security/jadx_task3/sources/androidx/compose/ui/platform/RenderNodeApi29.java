...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    public RenderNodeApi29(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3031getAutoNrFUSI();
    }
    ...
    public void mo4500setCompositingStrategyaDBOjCE(int value) {
        RenderNode $this$setCompositingStrategy_aDBOjCE_u24lambda_u240 = this.renderNode;
        if (CompositingStrategy.m3027equalsimpl0(value, CompositingStrategy.INSTANCE.m3033getOffscreenNrFUSI())) {
        ...
        } else if (CompositingStrategy.m3027equalsimpl0(value, CompositingStrategy.INSTANCE.m3032getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        android.graphics.Canvas canvasBeginRecording = this.renderNode.beginRecording();
        Intrinsics.checkNotNullExpressionValue(canvasBeginRecording, "renderNode.beginRecording()");
        android.graphics.Canvas targetCanvas$iv = canvasBeginRecording;
        ...
        if (clipPath != null) {
            ...
            Canvas.m2918clipPathmtrdDE$default($this$record_u24lambda_u241, clipPath, 0, 2, null);
        }

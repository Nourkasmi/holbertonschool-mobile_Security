...
public final class DividerKt {
    ...
    public static final void m1069DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        float f2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    long jM1033getOnSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer2, 6).m1033getOnSurface0d7_KjU();
                    color2 = Color.m2945copywmQWz5c(jM1033getOnSurface0d7_KjU, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM1033getOnSurface0d7_KjU) : 0.12f, (14 & 2) != 0 ? Color.m2953getRedimpl(jM1033getOnSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM1033getOnSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM1033getOnSurface0d7_KjU) : 0.0f);
                    $dirty &= -113;
                } else {
                    color2 = j;
                }
                thickness2 = i5 != 0 ? Dp.m5212constructorimpl(1) : f;
                startIndent2 = i6 != 0 ? Dp.m5212constructorimpl(0) : f2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
                    $dirty &= -113;
            ...
            if (startIndent2 == 0.0f) {
                ...
                i2 = 0;
                indentMod = PaddingKt.m485paddingqDBjuR0$default(Modifier.INSTANCE, startIndent2, 0.0f, 0.0f, 0.0f, 14, null);
            }
            $composer2.startReplaceableGroup(1228914189);
            ComposerKt.sourceInformation($composer2, "*55@2139L7");
            if (Dp.m5217equalsimpl0(thickness2, Dp.INSTANCE.m5230getHairlineD9Ej5fM())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart($composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object objConsume = $composer2.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                float $this$dp$iv = 1.0f / ((Density) objConsume).getDensity();
                targetThickness = Dp.m5212constructorimpl($this$dp$iv);
            } else {
                targetThickness = thickness2;
            }
            $composer2.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m160backgroundbw27NRU$default(SizeKt.m514height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, 1, null), targetThickness), color2, null, 2, null), $composer2, i2);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer, int i7) {
                DividerKt.m1069DivideroMI9zvI(modifier5, j2, f3, f4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}

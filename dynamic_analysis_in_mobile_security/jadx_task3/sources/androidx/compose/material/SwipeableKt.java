...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T value, final Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        EffectsKt.LaunchedEffect(value, forceAnimationCheck.getValue(), new C03141(value, swipeableState, null), $composer, ($changed & 8) | 512 | ($changed & 14));
    ...
    static final class C03141 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03141(T t, SwipeableState<T> swipeableState, Continuation<? super C03141> continuation) {
            super(2, continuation);
            this.$value = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03141(this.$value, this.$swipeableState, continuation);
        }

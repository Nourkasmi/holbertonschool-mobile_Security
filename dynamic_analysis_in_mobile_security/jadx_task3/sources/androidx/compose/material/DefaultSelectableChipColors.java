...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.contentColor)) * 31) + Color.m2954hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m2954hashCodeimpl(this.selectedContentColor)) * 31) + Color.m2954hashCodeimpl(this.selectedLeadingIconColor);
    }
}

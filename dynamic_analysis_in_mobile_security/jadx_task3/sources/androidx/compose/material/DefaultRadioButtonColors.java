...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public State<Color> radioColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2948equalsimpl0(this.selectedColor, ((DefaultRadioButtonColors) other).selectedColor) && Color.m2948equalsimpl0(this.unselectedColor, ((DefaultRadioButtonColors) other).unselectedColor) && Color.m2948equalsimpl0(this.disabledColor, ((DefaultRadioButtonColors) other).disabledColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + Color.m2954hashCodeimpl(this.unselectedColor)) * 31) + Color.m2954hashCodeimpl(this.disabledColor);
    }
}

...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m528size3ABfNKs(Modifier.INSTANCE, Dp.m5212constructorimpl(24));

    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1115Iconww6aTOc(ImageVector imageVector, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            tint2 = Color.m2945copywmQWz5c(jM2957unboximpl, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM2957unboximpl) : ((Number) objConsume2).floatValue(), (14 & 2) != 0 ? Color.m2953getRedimpl(jM2957unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM2957unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM2957unboximpl) : 0.0f);
        } else {
            tint2 = tint;
        }
        ...
        m1114Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, $composer, $changed & 14), contentDescription, modifier2, tint2, $composer, VectorPainter.$stable | ($changed & 112) | ($changed & 896) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1113Iconww6aTOc(ImageBitmap bitmap, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        ...
        m1114Iconww6aTOc(painter, contentDescription, modifier2, tint2, $composer, ($changed & 112) | 8 | ($changed & 896) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    /* JADX INFO: renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1114Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        final long tint2;
        int $dirty;
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            long tint3 = Color.m2945copywmQWz5c(jM2957unboximpl, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM2957unboximpl) : ((Number) objConsume2).floatValue(), (14 & 2) != 0 ? Color.m2953getRedimpl(jM2957unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM2957unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM2957unboximpl) : 0.0f);
        ...
        ColorFilter colorFilter = Color.m2948equalsimpl0(tint2, Color.INSTANCE.m2983getUnspecified0d7_KjU()) ? null : ColorFilter.Companion.m2988tintxETnrds$default(ColorFilter.INSTANCE, tint2, 0, 2, null);
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                value$iv$iv = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.IconKt$Icon$semantics$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        SemanticsPropertiesKt.m4577setRolekuIjeqM(semantics, Role.INSTANCE.m4566getImageo7Vup1c());
                    }
                };
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.IconKt$Icon$1
            ...
            public final void invoke(Composer composer, int i3) {
                IconKt.m1114Iconww6aTOc(painter, contentDescription, modifier3, tint2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        ...
        if (Size.m2773equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m2785getUnspecifiedNHjbRc()) || m1116isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
    ...
    private static final boolean m1116isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
        return Float.isInfinite(Size.m2777getWidthimpl($this$isInfinite_u2duvyYCjk)) && Float.isInfinite(Size.m2774getHeightimpl($this$isInfinite_u2duvyYCjk));
    }
}

...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(Function0<Unit> function0, String testTag, View composeView, Density density, PopupPositionProvider initialPositionProvider, UUID popupId) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m1264getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopupKt.INSTANCE.m1262getLambda1$material_release(), null, 2, null);
    }
    ...
    public final IntSize m1264getPopupContentSizebOM6tXw() {
        State $this$getValue$iv = this.popupContentSize;
        return (IntSize) $this$getValue$iv.getValue();
    }

    /* JADX INFO: renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m1265setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize intSizeM1264getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM1264getPopupContentSizebOM6tXw = m1264getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = intSizeM1264getPopupContentSizebOM6tXw.getPackedValue();

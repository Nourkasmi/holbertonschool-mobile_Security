...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m5212constructorimpl(56);
    private static final float HeaderHeight = Dp.m5212constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m5212constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* JADX INFO: renamed from: getPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m970getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }

    /* JADX INFO: renamed from: getHeaderHeight-D9Ej5fM, reason: not valid java name */
    public final float m969getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl(16)), CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m968getFrontLayerElevationD9Ej5fM() {

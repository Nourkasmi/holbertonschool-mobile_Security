...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1289setColorDxMtmZc(long color, float alpha) {
        long newColor = m1288calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m2948equalsimpl0(color2.m2957unboximpl(), newColor))) {
            this.rippleColor = Color.m2937boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m3001toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1288calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        return Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : transformedAlpha, (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
    }

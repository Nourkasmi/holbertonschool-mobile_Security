...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1119defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1286defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1286defaultRippleColor5vOe2sY(Color.INSTANCE.m2973getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha rippleAlphaM1285defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1285defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2973getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

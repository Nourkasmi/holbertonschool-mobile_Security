...
public abstract class Ripple implements Indication {
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer $composer, int $changed) {
        long jMo1119defaultColorWaAFU9c;
        ...
        if ($this$isSpecified$iv != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
            jMo1119defaultColorWaAFU9c = this.color.getValue().m2957unboximpl();
        } else {
            jMo1119defaultColorWaAFU9c = theme.mo1119defaultColorWaAFU9c($composer, 0);
        }
        $composer.endReplaceableGroup();
        RippleIndicationInstance instance = mo1275rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(jMo1119defaultColorWaAFU9c), $composer, 0), SnapshotStateKt.rememberUpdatedState(theme.rippleAlpha($composer, 0), $composer, 0), $composer, ($changed & 14) | (($changed << 12) & 458752));
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Ripple) && this.bounded == ((Ripple) other).bounded && Dp.m5217equalsimpl0(this.radius, ((Ripple) other).radius) && Intrinsics.areEqual(this.color, ((Ripple) other).color);
    }

    public int hashCode() {
        int result = Boolean.hashCode(this.bounded);
        return (((result * 31) + Dp.m5218hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }

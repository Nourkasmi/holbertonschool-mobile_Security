...
public final class PullRefreshIndicatorKt {
    ...
    private static final float IndicatorSize = Dp.m5212constructorimpl(40);
    private static final RoundedCornerShape SpinnerShape = RoundedCornerShapeKt.getCircleShape();
    private static final float ArcRadius = Dp.m5212constructorimpl((float) 7.5d);
    private static final float StrokeWidth = Dp.m5212constructorimpl((float) 2.5d);
    private static final float ArrowWidth = Dp.m5212constructorimpl(10);
    private static final float ArrowHeight = Dp.m5212constructorimpl(5);
    private static final float Elevation = Dp.m5212constructorimpl(6);
    ...
    */
    public static final void m1270PullRefreshIndicatorjB83MbM(final boolean r42, final androidx.compose.material.pullrefresh.PullRefreshState r43, androidx.compose.ui.Modifier r44, long r45, long r47, boolean r49, androidx.compose.runtime.Composer r50, final int r51, final int r52) {
        /*
            Method dump skipped, instruction units count: 765
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt.m1270PullRefreshIndicatorjB83MbM(boolean, androidx.compose.material.pullrefresh.PullRefreshState, androidx.compose.ui.Modifier, long, long, boolean, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1269CircularArrowIndicatoriJQMabo(final PullRefreshState state, final long color, final Modifier modifier, Composer $composer, final int $changed) {
        Object value$iv$iv;
        Object value$iv$iv2;
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            $this$CircularArrowIndicator_iJQMabo_u24lambda_u244_u24lambda_u243.mo2842setFillTypeoQ8Xj4U(PathFillType.INSTANCE.m3222getEvenOddRgk1Os());
        ...
        CanvasKt.Canvas(SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$1
            ...
            public final void invoke2(DrawScope Canvas) {
                ...
                long j = color;
                Path path2 = path;
                long pivot$iv = Canvas.mo3488getCenterF1C5BW0();
                ...
                $this$rotate_Rg1IO4c_u24lambda_u240$iv.mo3420rotateUv8p0NA(degrees$iv, pivot$iv);
                float arcRadius = Canvas.mo326toPx0680j_4(PullRefreshIndicatorKt.ArcRadius) + (Canvas.mo326toPx0680j_4(PullRefreshIndicatorKt.StrokeWidth) / 2.0f);
                Rect arcBounds = new Rect(Offset.m2708getXimpl(SizeKt.m2787getCenteruvyYCjk(Canvas.mo3489getSizeNHjbRc())) - arcRadius, Offset.m2709getYimpl(SizeKt.m2787getCenteruvyYCjk(Canvas.mo3489getSizeNHjbRc())) - arcRadius, Offset.m2708getXimpl(SizeKt.m2787getCenteruvyYCjk(Canvas.mo3489getSizeNHjbRc())) + arcRadius, Offset.m2709getYimpl(SizeKt.m2787getCenteruvyYCjk(Canvas.mo3489getSizeNHjbRc())) + arcRadius);
                DrawScope.m3469drawArcyD3GUKo$default(Canvas, j, values.getStartAngle(), values.getEndAngle() - values.getStartAngle(), false, arcBounds.m2743getTopLeftF1C5BW0(), arcBounds.m2741getSizeNHjbRc(), alpha, new Stroke(Canvas.mo326toPx0680j_4(PullRefreshIndicatorKt.StrokeWidth), 0.0f, StrokeCap.INSTANCE.m3294getSquareKaPHkGw(), 0, null, 26, null), null, 0, 768, null);
                PullRefreshIndicatorKt.m1273drawArrowBx497Mc(Canvas, path2, arcBounds, j, alpha, values);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$3
            ...
            public final void invoke(Composer composer, int i) {
                PullRefreshIndicatorKt.m1269CircularArrowIndicatoriJQMabo(state, color, modifier, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void m1273drawArrowBx497Mc(DrawScope $this$drawArrow_u2dBx497Mc, Path arrow, Rect bounds, long color, float alpha, ArrowValues values) {
        arrow.reset();
        arrow.moveTo(0.0f, 0.0f);
        float f = ArrowWidth;
        arrow.lineTo($this$drawArrow_u2dBx497Mc.mo326toPx0680j_4(f) * values.getScale(), 0.0f);
        arrow.lineTo(($this$drawArrow_u2dBx497Mc.mo326toPx0680j_4(f) * values.getScale()) / 2, $this$drawArrow_u2dBx497Mc.mo326toPx0680j_4(ArrowHeight) * values.getScale());
        float radius = Math.min(bounds.getWidth(), bounds.getHeight()) / 2.0f;
        float inset = ($this$drawArrow_u2dBx497Mc.mo326toPx0680j_4(f) * values.getScale()) / 2.0f;
        arrow.mo2844translatek4lQ0M(OffsetKt.Offset((Offset.m2708getXimpl(bounds.m2738getCenterF1C5BW0()) + radius) - inset, Offset.m2709getYimpl(bounds.m2738getCenterF1C5BW0()) + ($this$drawArrow_u2dBx497Mc.mo326toPx0680j_4(StrokeWidth) / 2.0f)));
        arrow.close();
        float degrees$iv = values.getEndAngle();
        long pivot$iv = $this$drawArrow_u2dBx497Mc.mo3488getCenterF1C5BW0();
        DrawContext $this$withTransform_u24lambda_u246$iv$iv = $this$drawArrow_u2dBx497Mc.getDrawContext();
        long previousSize$iv$iv = $this$withTransform_u24lambda_u246$iv$iv.mo3414getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().save();
        DrawTransform $this$rotate_Rg1IO4c_u24lambda_u240$iv = $this$withTransform_u24lambda_u246$iv$iv.getTransform();
        $this$rotate_Rg1IO4c_u24lambda_u240$iv.mo3420rotateUv8p0NA(degrees$iv, pivot$iv);
        DrawScope.m3480drawPathLG529CI$default($this$drawArrow_u2dBx497Mc, arrow, color, alpha, null, null, 0, 56, null);
        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv$iv.mo3415setSizeuvyYCjk(previousSize$iv$iv);
    }
}

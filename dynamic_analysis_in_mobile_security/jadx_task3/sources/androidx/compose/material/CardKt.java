...
public final class CardKt {
    ...
    public static final void m1010CardFjzlyU(Modifier modifier, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        long backgroundColor2 = (i & 4) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1038getSurface0d7_KjU() : backgroundColor;
        long contentColor2 = (i & 8) != 0 ? ColorsKt.m1052contentColorForek8zF_U(backgroundColor2, $composer, ($changed >> 6) & 14) : contentColor;
        BorderStroke border2 = (i & 16) != 0 ? null : border;
        float elevation2 = (i & 32) != 0 ? Dp.m5212constructorimpl(1) : elevation;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1956755640, $changed, -1, "androidx.compose.material.Card (Card.kt:58)");
        }
        SurfaceKt.m1196SurfaceFjzlyU(modifier2, shape2, backgroundColor2, contentColor2, border2, elevation2, content, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1011CardLPr_se0(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        long backgroundColor2 = (i & 16) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1038getSurface0d7_KjU() : backgroundColor;
        long contentColor2 = (i & 32) != 0 ? ColorsKt.m1052contentColorForek8zF_U(backgroundColor2, $composer, ($changed >> 12) & 14) : contentColor;
        BorderStroke border2 = (i & 64) != 0 ? null : border;
        float elevation2 = (i & 128) != 0 ? Dp.m5212constructorimpl(1) : elevation;
        if ((i & 256) != 0) {
        ...
        SurfaceKt.m1197SurfaceLPr_se0(onClick, modifier2, enabled2, shape2, backgroundColor2, contentColor2, border2, elevation2, interactionSource2, content, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed) | (29360128 & $changed) | (234881024 & $changed) | (1879048192 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final void m1009Card9VG74zQ(Function0<Unit> onClick, Modifier modifier, Shape shape, long backgroundColor, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Indication indication, boolean enabled, String onClickLabel, Role role, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long backgroundColor2 = (i & 8) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m1038getSurface0d7_KjU() : backgroundColor;
        long contentColor2 = (i & 16) != 0 ? ColorsKt.m1052contentColorForek8zF_U(backgroundColor2, $composer, ($changed >> 9) & 14) : contentColor;
        BorderStroke border2 = (i & 32) != 0 ? null : border;
        float elevation2 = (i & 64) != 0 ? Dp.m5212constructorimpl(1) : elevation;
        if ((i & 128) != 0) {
            $composer.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation($composer, "CC(remember):Composables.kt#9igjgp");
            Object it$iv$iv = $composer.rememberedValue();
        ...
        SurfaceKt.m1195Surface9VG74zQ(onClick, modifier2, shape2, backgroundColor2, contentColor2, border2, elevation2, interactionSource2, indication2, enabled2, onClickLabel2, role2, content, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed) | (3670016 & $changed) | (29360128 & $changed) | (234881024 & $changed) | (1879048192 & $changed), ($changed1 & 14) | ($changed1 & 112) | ($changed1 & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

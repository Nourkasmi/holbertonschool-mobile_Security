...
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(Icons.Outlined $this$Place) {
        ...
        ImageVector.Builder $this$_get_Place__u24lambda_u241 = new ImageVector.Builder("Outlined.Place", Dp.m5212constructorimpl(24.0f), Dp.m5212constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3570addPathoIyEayM$default($this$_get_Place__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

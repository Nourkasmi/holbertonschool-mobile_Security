...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.thumbColor : this.disabledThumbColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2948equalsimpl0(this.thumbColor, ((DefaultSliderColors) other).thumbColor) && Color.m2948equalsimpl0(this.disabledThumbColor, ((DefaultSliderColors) other).disabledThumbColor) && Color.m2948equalsimpl0(this.activeTrackColor, ((DefaultSliderColors) other).activeTrackColor) && Color.m2948equalsimpl0(this.inactiveTrackColor, ((DefaultSliderColors) other).inactiveTrackColor) && Color.m2948equalsimpl0(this.disabledActiveTrackColor, ((DefaultSliderColors) other).disabledActiveTrackColor) && Color.m2948equalsimpl0(this.disabledInactiveTrackColor, ((DefaultSliderColors) other).disabledInactiveTrackColor) && Color.m2948equalsimpl0(this.activeTickColor, ((DefaultSliderColors) other).activeTickColor) && Color.m2948equalsimpl0(this.inactiveTickColor, ((DefaultSliderColors) other).inactiveTickColor) && Color.m2948equalsimpl0(this.disabledActiveTickColor, ((DefaultSliderColors) other).disabledActiveTickColor) && Color.m2948equalsimpl0(this.disabledInactiveTickColor, ((DefaultSliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.thumbColor);
        return (((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2954hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2954hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2954hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2954hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2954hashCodeimpl(this.activeTickColor)) * 31) + Color.m2954hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2954hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2954hashCodeimpl(this.disabledInactiveTickColor);
    }
}

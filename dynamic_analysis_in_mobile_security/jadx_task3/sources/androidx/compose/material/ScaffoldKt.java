...
public final class ScaffoldKt {
    ...
    */
    public static final void m1167Scaffold27mzLpw(androidx.compose.ui.Modifier r54, androidx.compose.material.ScaffoldState r55, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r56, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r57, kotlin.jvm.functions.Function3<? super androidx.compose.material.SnackbarHostState, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r58, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r59, int r60, boolean r61, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r62, boolean r63, androidx.compose.ui.graphics.Shape r64, float r65, long r66, long r68, long r70, long r72, long r74, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.PaddingValues, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r76, androidx.compose.runtime.Composer r77, final int r78, final int r79, final int r80) {
        /*
            Method dump skipped, instruction units count: 1377
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ScaffoldKt.m1167Scaffold27mzLpw(androidx.compose.ui.Modifier, androidx.compose.material.ScaffoldState, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, int, boolean, kotlin.jvm.functions.Function3, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: ScaffoldLayout-MDYNRJg, reason: not valid java name */
    public static final void m1168ScaffoldLayoutMDYNRJg(final boolean isFabDocked, final int fabPosition, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, Composer $composer, final int $changed) {
        int i;
        ...
        if ((2995931 & $dirty) != 599186 || !$composer2.getSkipping()) {
            ...
            Object[] keys$iv = {function2, function22, function23, FabPosition.m1097boximpl(fabPosition), Boolean.valueOf(isFabDocked), function24, function3};
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m1170invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m1170invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                        final int layoutWidth = Constraints.m5168getMaxWidthimpl(constraints);
                        final int layoutHeight = Constraints.m5167getMaxHeightimpl(constraints);
                        final long looseConstraints = Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : 0);
                        ...
                        return MeasureScope.layout$default(SubcomposeLayout, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                                    ...
                                    target$iv.add(it.mo4183measureBRTryo0(j));
                                }
                                ...
                                for (int index$iv$iv2 = 0; index$iv$iv2 < size2; index$iv$iv2++) {
                                    ...
                                    target$iv2.add(it4.mo4183measureBRTryo0(j2));
                                }
                                ...
                                while (index$iv$iv3 < size3) {
                                    ...
                                    target$iv3.add(measurable.mo4183measureBRTryo0(j3));
                                    index$iv$iv3++;
                                ...
                                if (!fabPlaceables.isEmpty()) {
                                    ...
                                    if (fabWidth == 0 || fabHeight == 0) {
                                        ...
                                        int fabLeftOffset = FabPosition.m1100equalsimpl0(i3, FabPosition.INSTANCE.m1105getEnd5ygKITE()) ? SubcomposeLayout.getLayoutDirection() == LayoutDirection.Ltr ? (layoutWidth - SubcomposeLayout.mo320roundToPx0680j_4(ScaffoldKt.FabSpacing)) - fabWidth : SubcomposeLayout.mo320roundToPx0680j_4(ScaffoldKt.FabSpacing) : (layoutWidth - fabWidth) / 2;
                                ...
                                List<Measurable> listSubcompose4 = subcomposeMeasureScope.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(1529070963, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(fabPlacement2)}, function29, $composer3, ((i5 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                while (index$iv$iv4 < size4) {
                                    ...
                                    target$iv4.add(it11.mo4183measureBRTryo0(j4));
                                    index$iv$iv4++;
                                    size4 = size4;
                                ...
                                if (fabPlacement2 != null) {
                                    ...
                                    numValueOf = Integer.valueOf(bottomBarHeight == 0 ? fabPlacement2.getHeight() + subcomposeMeasureScope2.mo320roundToPx0680j_4(ScaffoldKt.FabSpacing) : z ? bottomBarHeight + (fabPlacement2.getHeight() / 2) : fabPlacement2.getHeight() + bottomBarHeight + subcomposeMeasureScope2.mo320roundToPx0680j_4(ScaffoldKt.FabSpacing));
                                } else {
                                    numValueOf = null;
                                }
                                ...
                                List<Measurable> listSubcompose5 = subcomposeMeasureScope3.subcompose(scaffoldLayoutContent2, ComposableLambdaKt.composableLambdaInstance(-1132241596, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$1$1$1$bodyContentPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            PaddingValues innerPadding = PaddingKt.m478PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, subcomposeMeasureScope4.mo323toDpu2uoSUM(bottomBarHeight), 7, null);
                                            function33.invoke(innerPadding, $composer3, Integer.valueOf((i6 >> 6) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                while ($i$f$fastMap5 < size5) {
                                    ...
                                    long j6 = j5;
                                    target$iv5.add(it14.mo4183measureBRTryo0(Constraints.m5158copyZbe2FdA(j6, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(j6) : 0, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(j6) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(j6) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(j6) : bodyContentHeight)));
                                    $i$f$fastMap5++;
                                    size5 = size5;
                                    list = list2;
                                    j5 = j5;
                                ...
                                while (index$iv3 < size8) {
                                    ...
                                    Placeable.PlacementScope.place$default(layout, it17, 0, i7 - snackbarOffsetFromBottom, 0.0f, 4, null);
                                    index$iv3++;
                                    size8 = size8;
                                ...
                                while (index$iv4 < size9) {
                                    ...
                                    Placeable.PlacementScope.place$default(layout, it18, 0, i8 - bottomBarHeight2, 0.0f, 4, null);
                                    index$iv4++;
                                    size9 = size9;
                                ...
                                while (index$iv5 < size10) {
                                    ...
                                    Placeable.PlacementScope.place$default(layout, it19, fabPlacement2 != null ? fabPlacement2.getLeft() : 0, i9 - (fabOffsetFromBottom != null ? fabOffsetFromBottom.intValue() : 0), 0.0f, 4, null);
                                    index$iv5++;
                                    size10 = size10;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ScaffoldKt$ScaffoldLayout$2
            ...
            public final void invoke(Composer composer, int i3) {
                ScaffoldKt.m1168ScaffoldLayoutMDYNRJg(isFabDocked, fabPosition, function2, function3, function22, function23, function24, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }

...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5210boximpl(m1094invokeD9Ej5fM());
        }

        /* JADX INFO: renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1094invokeD9Ej5fM() {
    ...
    public static final long m1093calculateForegroundColorCLU3JFs(long backgroundColor, float elevation, Composer $composer, int $changed) {
        ...
        long baseForegroundColor = ColorsKt.m1052contentColorForek8zF_U(backgroundColor, $composer, $changed & 14);
        long jM2945copywmQWz5c = Color.m2945copywmQWz5c(baseForegroundColor, (14 & 1) != 0 ? Color.m2949getAlphaimpl(baseForegroundColor) : alpha, (14 & 2) != 0 ? Color.m2953getRedimpl(baseForegroundColor) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(baseForegroundColor) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(baseForegroundColor) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {

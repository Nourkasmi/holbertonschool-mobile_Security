...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1068apply7g2Lkgo(long color, float elevation, Composer $composer, int $changed) {
        ...
        int $this$dp$iv = Dp.m5211compareTo0680j_4(elevation, Dp.m5212constructorimpl(0));
        if ($this$dp$iv > 0 && !colors.isLight()) {
            long foregroundColor2 = ElevationOverlayKt.m1093calculateForegroundColorCLU3JFs(color, elevation, $composer, ($changed & 14) | ($changed & 112));
            foregroundColor = ColorKt.m2992compositeOverOWjLjI(foregroundColor2, color);
        } else {

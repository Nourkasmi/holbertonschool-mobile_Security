...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final int width = Math.max(placeable.getWidth(), measure.mo320roundToPx0680j_4(DpSize.m5310getWidthD9Ej5fM(this.size)));
        final int height = Math.max(placeable.getHeight(), measure.mo320roundToPx0680j_4(DpSize.m5308getHeightD9Ej5fM(this.size)));
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5307equalsimpl0(this.size, otherModifier.size);
    }

    public int hashCode() {
        return DpSize.m5312hashCodeimpl(this.size);
    }
}

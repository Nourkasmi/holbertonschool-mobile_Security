...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.backgroundColor : this.disabledBackgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.contentColor : this.disabledContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> leadingIconContentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2948equalsimpl0(this.backgroundColor, ((DefaultChipColors) other).backgroundColor) && Color.m2948equalsimpl0(this.contentColor, ((DefaultChipColors) other).contentColor) && Color.m2948equalsimpl0(this.leadingIconContentColor, ((DefaultChipColors) other).leadingIconContentColor) && Color.m2948equalsimpl0(this.disabledBackgroundColor, ((DefaultChipColors) other).disabledBackgroundColor) && Color.m2948equalsimpl0(this.disabledContentColor, ((DefaultChipColors) other).disabledContentColor) && Color.m2948equalsimpl0(this.disabledLeadingIconContentColor, ((DefaultChipColors) other).disabledLeadingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.backgroundColor);
        return (((((((((result * 31) + Color.m2954hashCodeimpl(this.contentColor)) * 31) + Color.m2954hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}

...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo209createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m2777getWidthimpl(size), Size.m2774getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo2841opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.INSTANCE.m3231getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        float cutoutOffset = density.mo326toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m2777getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m2774getHeightimpl(cutoutSize) / 2.0f;
        ...
        $this$addCutoutShape.mo2844translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            float edgeRadius = density.mo326toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius);

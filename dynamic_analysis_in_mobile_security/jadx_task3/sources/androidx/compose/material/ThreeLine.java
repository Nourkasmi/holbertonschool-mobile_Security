...
final class ThreeLine {
    ...
    private static final float MinHeight = Dp.m5212constructorimpl(88);
    ...
    private static final float IconThreeLineVerticalPadding = Dp.m5212constructorimpl(16);
    ...
    private static final float ThreeLineBaselineFirstOffset = Dp.m5212constructorimpl(28);
    private static final float ThreeLineBaselineSecondOffset = Dp.m5212constructorimpl(20);
    private static final float ThreeLineBaselineThirdOffset = Dp.m5212constructorimpl(20);
    private static final float ThreeLineTrailingTopPadding = Dp.m5212constructorimpl(16);

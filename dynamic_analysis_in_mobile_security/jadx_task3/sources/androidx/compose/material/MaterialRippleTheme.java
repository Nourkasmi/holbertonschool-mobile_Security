...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1119defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1286defaultRippleColor5vOe2sY = companion.m1286defaultRippleColor5vOe2sY(((Color) objConsume).m2957unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return jM1286defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object objConsume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha rippleAlphaM1285defaultRippleAlphaDxMtmZc = companion.m1285defaultRippleAlphaDxMtmZc(((Color) objConsume).m2957unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return rippleAlphaM1285defaultRippleAlphaDxMtmZc;
    }
}

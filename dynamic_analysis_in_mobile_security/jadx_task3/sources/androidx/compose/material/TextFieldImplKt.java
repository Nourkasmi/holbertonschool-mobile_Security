...
public final class TextFieldImplKt {
    ...
    private static final float TextFieldPadding = Dp.m5212constructorimpl(16);
    private static final float HorizontalIconPadding = Dp.m5212constructorimpl(12);
    private static final Modifier IconDefaultSizeModifier = SizeKt.m512defaultMinSizeVpY3zN4(Modifier.INSTANCE, Dp.m5212constructorimpl(48), Dp.m5212constructorimpl(48));
    ...
    public static final void CommonDecorationBox(final TextFieldType type, final String value, final Function2<? super Composer, ? super Integer, Unit> innerTextField, final VisualTransformation visualTransformation, final Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean singleLine, boolean enabled, boolean isError, final InteractionSource interactionSource, final PaddingValues contentPadding, final TextFieldColors colors, Function2<? super Composer, ? super Integer, Unit> function25, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 1533916891) == 306783378 && (46811 & $dirty1) == 9362 && $composer3.getSkipping()) {
            ...
            Function2<? super Composer, ? super Integer, Unit> function210 = i2 != 0 ? null : function22;
            Function2<? super Composer, ? super Integer, Unit> function211 = i3 != 0 ? null : function23;
            Function2<? super Composer, ? super Integer, Unit> function212 = i4 != 0 ? null : function24;
            ...
            Function3<InputPhase, Composer, Integer, Color> function3 = new Function3<InputPhase, Composer, Integer, Color>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$labelColor$1
                ...
                public /* bridge */ /* synthetic */ Color invoke(InputPhase inputPhase2, Composer composer, Integer num) {
                    return Color.m2937boximpl(m1249invokeXeAY9LY(inputPhase2, composer, num.intValue()));
                }

                /* JADX INFO: renamed from: invoke-XeAY9LY, reason: not valid java name */
                public final long m1249invokeXeAY9LY(InputPhase it, Composer $composer4, int $changed2) {
                    ...
                    int i11 = $dirty12;
                    long jM2957unboximpl = textFieldColors.labelColor(z4, z5, interactionSource2, $composer4, i10 | ((i11 << 3) & 896) | (i11 & 7168)).getValue().m2957unboximpl();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    $composer4.endReplaceableGroup();
                    return jM2957unboximpl;
                }
            };
            ...
            final boolean shouldOverrideTextStyleColor = (Color.m2948equalsimpl0(subtitle1.m4742getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU()) && !Color.m2948equalsimpl0(caption.m4742getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU())) || (!Color.m2948equalsimpl0(subtitle1.m4742getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU()) && Color.m2948equalsimpl0(caption.m4742getColor0d7_KjU(), Color.INSTANCE.m2983getUnspecified0d7_KjU()));
            TextFieldTransitionScope textFieldTransitionScope = TextFieldTransitionScope.INSTANCE;
            $composer3.startReplaceableGroup(2129141006);
            ComposerKt.sourceInformation($composer3, "*110@4363L10,111@4455L22");
            long $this$CommonDecorationBox_u24lambda_u242 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getCaption().m4742getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
                    $this$takeOrElse_u2dDxMtmZc$iv = function3.invoke(inputState, $composer3, 0).m2957unboximpl();
                }
            ...
            long $this$CommonDecorationBox_u24lambda_u244 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getSubtitle1().m4742getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                    ...
                    z = false;
                    $this$takeOrElse_u2dDxMtmZc$iv2 = function3.invoke(inputState, $composer3, 0).m2957unboximpl();
                }
            ...
            $composer2 = $composer3;
            textFieldTransitionScope.m1254TransitionDTcfvLk(inputState, j, j2, function3, z4, ComposableLambdaKt.composableLambda($composer2, 341865432, true, new Function6<Float, Color, Color, Float, Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt.CommonDecorationBox.3
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Color color, Color color2, Float f2, Composer composer, Integer num) {
                    m1247invokeRIQooxk(f.floatValue(), color.m2957unboximpl(), color2.m2957unboximpl(), f2.floatValue(), composer, num.intValue());
                ...
                */
                public final void m1247invokeRIQooxk(final float r34, final long r35, final long r37, final float r39, androidx.compose.runtime.Composer r40, int r41) {
                    /*
                        Method dump skipped, instruction units count: 1026
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldImplKt.AnonymousClass3.m1247invokeRIQooxk(float, long, long, float, androidx.compose.runtime.Composer, int):void");
                }
            }), $composer2, 1769472);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt.CommonDecorationBox.4
            ...
            public final void invoke(Composer composer, int i10) {
                TextFieldImplKt.CommonDecorationBox(type, value, innerTextField, visualTransformation, function2, function218, function219, function220, z8, z9, z10, interactionSource, contentPadding, colors, function221, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

    /* JADX INFO: renamed from: Decoration-euL9pac, reason: not valid java name */
    public static final void m1246DecorationeuL9pac(final long contentColor, TextStyle typography, Float contentAlpha, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        TextStyle textStyle;
        Float f;
            ...
            Function2 colorAndEmphasis = ComposableLambdaKt.composableLambda($composer2, 494684590, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$colorAndEmphasis$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor))};
                        final Float f3 = f2;
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    if (f3 != null) {
                                        ...
                                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2949getAlphaimpl(j)))}, function2, $composer4, ((i4 >> 6) & 112) | 8);
                                        $composer4.endReplaceableGroup();
                                    }
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$1
            ...
            public final void invoke(Composer composer, int i4) {
                TextFieldImplKt.m1246DecorationeuL9pac(contentColor, textStyle2, f3, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

...
public final class SnackbarHostState {
    ...
    /* JADX WARN: Removed duplicated region for block: B:29:0x00f5 A[Catch: all -> 0x010b, TRY_LEAVE, TryCatch #3 {all -> 0x010b, blocks: (B:27:0x00df, B:29:0x00f5), top: B:58:0x00df }] */
    ...
    */
    public final java.lang.Object showSnackbar(java.lang.String r21, java.lang.String r22, androidx.compose.material.SnackbarDuration r23, kotlin.coroutines.Continuation<? super androidx.compose.material.SnackbarResult> r24) throws java.lang.Throwable {
        /*
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m5499constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m5499constructorimpl(SnackbarResult.Dismissed));
            }
        }
    }
}

...
public class SwipeableState<T> {
    ...
    */
    ...
    static final class C03182 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03182(float f, SwipeableState<T> swipeableState, Continuation<? super C03182> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03182 c03182 = new C03182(this.$target, this.this$0, continuation);
            c03182.L$0 = obj;
            return c03182;
        }
        ...
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C03182) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapInternalToOffset(float target, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.drag$default(this.draggableState, null, new C03182(target, this, null), continuation, 1, null);
    ...
    static final class C03192 implements FlowCollector<Map<Float, ? extends T>> {
        final /* synthetic */ T $targetValue;
        final /* synthetic */ SwipeableState<T> this$0;

        C03192(T t, SwipeableState<T> swipeableState) {
            this.$targetValue = t;
            this.this$0 = swipeableState;
        }
        ...
        */
        public final java.lang.Object emit(java.util.Map<java.lang.Float, ? extends T> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
            ...
            L2d:
                ...
                androidx.compose.material.SwipeableState$snapTo$2 r7 = (androidx.compose.material.SwipeableState.C03192) r7
                kotlin.ResultKt.throwOnFailure(r0)
                goto L54
            L35:
                kotlin.ResultKt.throwOnFailure(r0)
            ...
            L5e:
                ...
                throw r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableState.C03192.emit(java.util.Map, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }

    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objCollect = this.latestNonEmptyAnchorsFlow.collect(new C03192(t, this), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }
    ...
    /* JADX INFO: compiled from: Swipeable.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0010\u0007\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, d2 = {"<anonymous>", "", "T", "anchors", "", ""}, k = 3, mv = {1, 8, 0}, xi = 48)
    static final class C03162 implements FlowCollector<Map<Float, ? extends T>> {
        final /* synthetic */ AnimationSpec<Float> $anim;
        final /* synthetic */ T $targetValue;
        final /* synthetic */ SwipeableState<T> this$0;

        C03162(T t, SwipeableState<T> swipeableState, AnimationSpec<Float> animationSpec) {
            this.$targetValue = t;
            this.this$0 = swipeableState;
        ...
        */
        public final java.lang.Object emit(java.util.Map<java.lang.Float, ? extends T> r17, kotlin.coroutines.Continuation<? super kotlin.Unit> r18) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableState.C03162.emit(java.util.Map, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }
    ...
    public final Object animateTo(T t, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        Object objCollect = this.latestNonEmptyAnchorsFlow.collect(new C03162(t, this, animationSpec), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

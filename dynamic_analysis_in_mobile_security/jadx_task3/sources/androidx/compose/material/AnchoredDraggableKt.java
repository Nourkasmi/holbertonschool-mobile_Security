...
public final class AnchoredDraggableKt {
    public static final <T> Modifier anchoredDraggable(Modifier $this$anchoredDraggable, AnchoredDraggableState<T> state, Orientation orientation, boolean enabled, boolean reverseDirection, MutableInteractionSource interactionSource) {
        ...
        return DraggableKt.draggable($this$anchoredDraggable, state.getDraggableState(), orientation, (188 & 4) != 0 ? true : enabled, (188 & 8) != 0 ? null : interactionSource, (188 & 16) != 0 ? false : state.isAnimationRunning(), (188 & 32) != 0 ? new DraggableKt.C01831(null) : null, (188 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : new AnonymousClass1(state, null), (188 & 128) != 0 ? false : reverseDirection);
    }
    ...
    static final class C02722<T> extends SuspendLambda implements Function3<AnchoredDragScope, Map<T, ? extends Float>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02722(T t, Continuation<? super C02722> continuation) {
            super(3, continuation);
            this.$targetValue = t;
        }
        ...
        public final Object invoke(AnchoredDragScope anchoredDragScope, Map<T, Float> map, Continuation<? super Unit> continuation) {
            C02722 c02722 = new C02722(this.$targetValue, continuation);
            c02722.L$0 = anchoredDragScope;
            c02722.L$1 = map;
            return c02722.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object snapTo(AnchoredDraggableState<T> anchoredDraggableState, T t, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C02722(t, null), continuation, 2, null);

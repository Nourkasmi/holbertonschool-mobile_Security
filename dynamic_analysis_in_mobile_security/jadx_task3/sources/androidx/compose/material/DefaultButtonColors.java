...
final class DefaultButtonColors implements ButtonColors {
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m2954hashCodeimpl(this.contentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContentColor);
    }
}

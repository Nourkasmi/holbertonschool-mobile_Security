...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m5212constructorimpl(1);
    private static final float IndicatorHeight = Dp.m5212constructorimpl(2);
    ...
    public final void m1220Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long color2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    $dirty &= -897;
                    color2 = Color.m2945copywmQWz5c(jM2957unboximpl, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM2957unboximpl) : 0.12f, (14 & 2) != 0 ? Color.m2953getRedimpl(jM2957unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM2957unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM2957unboximpl) : 0.0f);
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
            ...
            DividerKt.m1069DivideroMI9zvI(modifier3, color2, thickness2, 0.0f, $composer2, ($dirty & 14) | (($dirty >> 3) & 112) | (($dirty << 3) & 896), 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Divider$1
            ...
            public final void invoke(Composer composer, int i5) {
                this.$tmp0_rcvr.m1220Divider9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* JADX INFO: renamed from: Indicator-9IZ8Weo, reason: not valid java name */
    public final void m1221Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long color2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $dirty &= -897;
                    color2 = ((Color) objConsume).m2957unboximpl();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Indicator$1
            ...
            public final void invoke(Composer composer, int i5) {
                this.$tmp0_rcvr.m1221Indicator9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

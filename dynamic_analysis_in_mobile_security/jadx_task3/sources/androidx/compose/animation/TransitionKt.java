...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String label, Function3<? super S, ? super Composer, ? super Integer, Color> targetValueByState, Composer $composer, int $changed, int i) {
        ...
        Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function32 = (i & 1) != 0 ? new Function3<Transition.Segment<S>, Composer, Integer, SpringSpec<Color>>() { // from class: androidx.compose.animation.TransitionKt.animateColor.1
        ...
        ColorSpace colorSpace = Color.m2951getColorSpaceimpl(targetValueByState.invoke(transition.getTargetState(), $composer, Integer.valueOf(($changed >> 6) & 112)).m2957unboximpl());
        ...
        State<Color> stateCreateTransitionAnimation = androidx.compose.animation.core.TransitionKt.createTransitionAnimation(transition, initialValue$iv, targetValue$iv, function32.invoke(transition.getSegment(), $composer, Integer.valueOf(($changed$iv >> 3) & 112)), typeConverter, label2, $composer, ($changed$iv & 14) | (57344 & ($changed$iv << 9)) | (458752 & ($changed$iv << 6)));
        $composer.endReplaceableGroup();
        $composer.endReplaceableGroup();
    ...
    public static final State<Color> m79animateColorDTcfvLk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> animationSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m2951getColorSpaceimpl(targetValue));
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
        ...
        State<Color> stateAnimateValue = InfiniteTransitionKt.animateValue(animateColor, Color.m2937boximpl(initialValue), Color.m2937boximpl(targetValue), converter, animationSpec, label2, $composer, InfiniteTransition.$stable | 4096 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 12) | (($changed << 3) & 57344) | (458752 & ($changed << 3)), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m80animateColorRIQooxk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        Intrinsics.checkNotNullParameter(animateColor, "$this$animateColor");
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        ...
        State<Color> stateM79animateColorDTcfvLk = m79animateColorDTcfvLk(animateColor, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 9) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

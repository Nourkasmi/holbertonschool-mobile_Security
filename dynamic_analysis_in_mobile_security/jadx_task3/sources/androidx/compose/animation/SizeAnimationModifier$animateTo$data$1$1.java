    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                IntSize intSizeM5364boximpl = IntSize.m5364boximpl(sizeAnimationModifier$animateTo$data$1$1.$targetSize);
                ...
                Object objAnimateTo = anim.animateTo(intSizeM5364boximpl, (4 & 2) != 0 ? anim.defaultSpringSpec : animSpec, (4 & 4) != 0 ? anim.getVelocity() : null, (4 & 8) != 0 ? null : null, sizeAnimationModifier$animateTo$data$1$1);
        ...
        if (result.getEndReason() == AnimationEndReason.Finished && (listener = sizeAnimationModifier$animateTo$data$1$1.this$0.getListener()) != 0) {
            listener.invoke(IntSize.m5364boximpl(sizeAnimationModifier$animateTo$data$1$1.$this_apply.m74getStartSizeYbymL2g()), result.getEndState().getValue());
        }

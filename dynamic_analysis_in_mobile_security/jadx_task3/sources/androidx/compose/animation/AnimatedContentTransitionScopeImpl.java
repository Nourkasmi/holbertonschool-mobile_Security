...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5364boximpl(IntSize.INSTANCE.m5377getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo15slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        return m34isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m5372getWidthimpl(this.m33getCurrentSizeYbymL2g()) - IntOffset.m5330getXimpl(this.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m33getCurrentSizeYbymL2g()))));
            }
        }) : m35isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5330getXimpl(this.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m33getCurrentSizeYbymL2g()))) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m29getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m5371getHeightimpl(this.m33getCurrentSizeYbymL2g()) - IntOffset.m5331getYimpl(this.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m33getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m24getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5331getYimpl(this.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m33getCurrentSizeYbymL2g()))) - it));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* JADX INFO: renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m34isLeftgWo6LJ4(int $this$isLeft) {
        return AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m26getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0($this$isLeft, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m25getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* JADX INFO: renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m35isRightgWo6LJ4(int $this$isRight) {
        return AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m27getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0($this$isRight, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m25getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m32calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo2598alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* JADX INFO: renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo16slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(targetOffset, "targetOffset");
        return m34isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5330getXimpl(this.this$0.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
            }
        }) : m35isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5330getXimpl(this.this$0.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m5372getWidthimpl(targetSize)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m29getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5331getYimpl(this.this$0.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m20equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m24getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5331getYimpl(this.this$0.m32calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m5371getHeightimpl(targetSize)));
            }
    ...
    public final void m37setMeasuredSizeozmzZPI$animation_release(long j) {
        MutableState $this$setValue$iv = this.measuredSize;
        $this$setValue$iv.setValue(IntSize.m5364boximpl(j));
    }
    ...
    public final long m33getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().getPackedValue() : m36getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo38measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            Intrinsics.checkNotNullParameter(measure, "$this$measure");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            final Placeable placeableMo4183measureBRTryo0 = measurable.mo4183measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo76createAnimationSpecTemP2vQ;
                    ...
                    long initial = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long target = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo76createAnimationSpecTemP2vQ = value.mo76createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo76createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5364boximpl(m39invokeYEO4UFw(obj));
                }

                /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m39invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5377getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(stateAnimate);
            final long jMo2598alignKFBX0sM = this.this$0.getContentAlignment().mo2598alignKFBX0sM(IntSizeKt.IntSize(placeableMo4183measureBRTryo0.getWidth(), placeableMo4183measureBRTryo0.getHeight()), stateAnimate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m5372getWidthimpl(stateAnimate.getValue().getPackedValue()), IntSize.m5371getHeightimpl(stateAnimate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m4240place70tqf50$default(layout, placeableMo4183measureBRTryo0, jMo2598alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }

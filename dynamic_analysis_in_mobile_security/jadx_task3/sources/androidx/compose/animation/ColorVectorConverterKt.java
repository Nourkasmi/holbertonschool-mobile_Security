        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            ...
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m41invoke8_81llA(color.m2957unboximpl());
                }

                /* JADX INFO: renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m41invoke8_81llA(long color) {
                    long jM2944convertvNxB06k = Color.m2944convertvNxB06k(color, ColorSpaces.INSTANCE.getOklab());
                    float l = Color.m2938component1impl(jM2944convertvNxB06k);
                    float a = Color.m2939component2impl(jM2944convertvNxB06k);
                    float b = Color.m2940component3impl(jM2944convertvNxB06k);
                    float alpha = Color.m2941component4impl(jM2944convertvNxB06k);
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m2937boximpl(m42invokevNxB06k(animationVector4D));
                }

                /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m42invokevNxB06k(AnimationVector4D vector) {
                    Intrinsics.checkNotNullParameter(vector, "vector");
                    return Color.m2944convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(vector.getV2(), 0.0f, 1.0f), RangesKt.coerceIn(vector.getV3(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV4(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };

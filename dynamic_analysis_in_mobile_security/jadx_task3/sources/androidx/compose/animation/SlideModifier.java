...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m77targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long preEnter = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5340getZeronOccac() : slideOffset2.invoke(IntSize.m5364boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long postExit = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5340getZeronOccac() : slideOffset.invoke(IntSize.m5364boximpl(fullSize)).getPackedValue();
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4243placeWithLayeraW9wM$default(layout, placeable, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m5321boximpl(m78invokeBjo55l4(enterExitState));
                    }

                    /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m78invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return slideModifier.m77targetValueByStateoFUgxo0(it, j);
                    }

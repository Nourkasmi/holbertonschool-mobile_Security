...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        for (Object item$iv$iv : $this$map$iv) {
            ...
            destination$iv$iv.add(it.mo4183measureBRTryo0(constraints));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5364boximpl(IntSizeKt.IntSize(maxWidth, maxHeight)));

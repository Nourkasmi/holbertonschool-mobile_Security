...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m71copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m73copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m73copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m5370equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m5373hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m5375toStringimpl(this.startSize)) + ')';
        }
        ...
        public final void m75setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        long jM70animateTomzRDjE0 = m70animateTomzRDjE0(measuredSize);
        int width = IntSize.m5372getWidthimpl(jM70animateTomzRDjE0);
        int height = IntSize.m5371getHeightimpl(jM70animateTomzRDjE0);
    ...
    public final long m70animateTomzRDjE0(long targetSize) {
        AnimData $this$animateTo_mzRDjE0_u24lambda_u240 = getAnimData();
        if ($this$animateTo_mzRDjE0_u24lambda_u240 != null) {
            if (!IntSize.m5370equalsimpl0(targetSize, $this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getTargetValue().getPackedValue())) {
                $this$animateTo_mzRDjE0_u24lambda_u240.m75setStartSizeozmzZPI($this$animateTo_mzRDjE0_u24lambda_u240.getAnim().getValue().getPackedValue());
            ...
            $this$animateTo_mzRDjE0_u24lambda_u240 = new AnimData(new Animatable(IntSize.m5364boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m5364boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }

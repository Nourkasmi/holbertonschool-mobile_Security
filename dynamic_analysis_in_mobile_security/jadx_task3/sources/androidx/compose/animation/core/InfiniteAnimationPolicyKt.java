...
public final class InfiniteAnimationPolicyKt {
    public static final <R> Object withInfiniteAnimationFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        return policy == null ? MonotonicFrameClockKt.withFrameNanos(function1, continuation) : policy.onInfiniteOperation(new C01542(function1, null), continuation);
    }
    ...
    static final class C01542<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        final /* synthetic */ Function1<Long, R> $onFrame;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01542(Function1<? super Long, ? extends R> function1, Continuation<? super C01542> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01542(this.$onFrame, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super R> continuation) {
            return ((C01542) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }

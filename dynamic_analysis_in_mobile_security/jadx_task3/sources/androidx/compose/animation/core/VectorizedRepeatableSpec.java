...
public final class VectorizedRepeatableSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    private VectorizedRepeatableSpec(int iterations, VectorizedDurationBasedAnimationSpec<V> animation, RepeatMode repeatMode, long initialStartOffset) {
        ...
        this.durationNanos = ((long) (animation.getDelayMillis() + animation.getDurationMillis())) * AnimationKt.MillisToNanos;
    ...
    public /* synthetic */ VectorizedRepeatableSpec(int i, VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM112constructorimpl$default;
        if ((i2 & 4) == 0) {
        ...
        if ((i2 & 8) == 0) {
            jM112constructorimpl$default = j;
        } else {
            jM112constructorimpl$default = StartOffset.m112constructorimpl$default(0, 0, 2, null);
        }
        this(i, vectorizedDurationBasedAnimationSpec, repeatMode2, jM112constructorimpl$default, (DefaultConstructorMarker) null);
    }
    ...
    private final V repetitionStartVelocity(long playTimeNanos, V start, V startVelocity, V end) {
        ...
        if (j2 > j3) {
            return (V) getVelocityFromNanos(j3 - j, start, startVelocity, end);
        }

...
public final class RememberSaveableKt {
    ...
    public static final <T> T m2594rememberSaveable(Object[] inputs, Saver<T, ? extends Object> saver, String str, Function0<? extends T> init, Composer composer, int i, int i2) {
        final String string;
        T tRestore;
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] inputs, Saver<T, ? extends Object> stateSaver, String key, Function0<? extends MutableState<T>> init, Composer $composer, int $changed, int i) {
        ...
        MutableState<T> mutableState = (MutableState) m2594rememberSaveable(Arrays.copyOf(inputs, inputs.length), mutableStateSaver(stateSaver), key, (Function0) init, $composer, ($changed & 896) | 8 | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

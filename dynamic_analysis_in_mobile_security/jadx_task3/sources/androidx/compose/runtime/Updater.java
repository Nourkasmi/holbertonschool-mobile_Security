...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2580boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2581constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2582equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2583equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2584hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2589toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2582equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2584hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2589toStringimpl(this.composer);
    }
    ...
    public static final void m2587setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* JADX INFO: renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2588setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2590updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* JADX INFO: renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2591updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = arg0.getInserting();
    ...
    public static final void m2585initimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2586reconcileimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");

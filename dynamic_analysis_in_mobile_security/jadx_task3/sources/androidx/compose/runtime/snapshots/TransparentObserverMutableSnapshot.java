...
public final class TransparentObserverMutableSnapshot extends MutableSnapshot {
    ...
    public TransparentObserverMutableSnapshot(MutableSnapshot parentSnapshot, Function1<Object, Unit> function1, Function1<Object, Unit> function12, boolean mergeParentObservers, boolean ownsParentSnapshot) {
        ...
        super(0, SnapshotIdSet.INSTANCE.getEMPTY(), SnapshotKt.mergedReadObserver(function1, (parentSnapshot == null || (readObserver$runtime_release = parentSnapshot.getReadObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getReadObserver$runtime_release() : readObserver$runtime_release, mergeParentObservers), SnapshotKt.mergedWriteObserver(function12, (parentSnapshot == null || (writeObserver$runtime_release = parentSnapshot.getWriteObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getWriteObserver$runtime_release() : writeObserver$runtime_release));
    ...
    public void mo2597recordModified$runtime_release(StateObject state) {
        ...
        getCurrentSnapshot().mo2597recordModified$runtime_release(state);
    }

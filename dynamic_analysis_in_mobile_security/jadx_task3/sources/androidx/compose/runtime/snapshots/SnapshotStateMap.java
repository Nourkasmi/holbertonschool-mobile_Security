...
public final class SnapshotStateMap<K, V> implements Map<K, V>, StateObject, KMutableMap {
    ...
    public void clear() throws Throwable {
        ...
        if (persistentMapPersistentHashMapOf == $this$update_u24lambda_u2414$iv.getMap$runtime_release()) {
            return;
        }
        ...
        synchronized (lock$iv$iv$iv$iv$iv) {
            try {
                ...
                synchronized (lock$iv$iv) {
                    try {
                        $this$update_u24lambda_u2414_u24lambda_u2413$iv.setMap$runtime_release(persistentMapPersistentHashMapOf);
    ...
    public V put(K key, V value) throws Throwable {
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    Snapshot current = Snapshot.INSTANCE.getCurrent();
                    StateMapStateRecord $this$mutate_u24lambda_u2411$iv = (StateMapStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv, snapshotStateMap3, current);
                    ...
                    synchronized (lock$iv$iv2) {
                        try {
                            if ($this$mutate_u24lambda_u2411$iv.getModification() == currentModification$iv) {
                                ...
                                try {
                                    $this$mutate_u24lambda_u2411$iv.setMap$runtime_release(persistentMapBuild);
                                    z = true;
                    ...
                    synchronized (lock$iv2) {
                        try {
                            if ($this$mutate_u24lambda_u2411.getModification() == currentModification) {
                                try {
                                    $this$mutate_u24lambda_u2411.setMap$runtime_release(persistentMapBuild);

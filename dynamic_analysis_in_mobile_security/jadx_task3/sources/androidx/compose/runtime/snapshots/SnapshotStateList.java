...
public final class SnapshotStateList<T> implements List<T>, StateObject, KMutableList {
    ...
    */
            ...
            synchronized (lock$iv$iv$iv$iv$iv$iv) {
                try {
                    ...
                    try {
                        ...
                        try {
                            StateListStateRecord $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv$iv, snapshotStateList2, current);
                            ...
                            synchronized (lock$iv$iv$iv2) {
                                try {
                                    if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.getModification() == currentModification$iv$iv) {
                                        ...
                                        try {
                                            $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.setList$runtime_release(persistentListAdd);
                                            z = true;
    ...
    public boolean addAll(Collection<? extends T> elements) {
        ...
        while (true) {
            ...
            Intrinsics.checkNotNull(list$runtime_release);
            PersistentList<T> persistentListAddAll = list$runtime_release.addAll(elements2);
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                ...
                StateListStateRecord $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv, snapshotStateList, current);
                ...
                synchronized (lock$iv$iv2) {
                    try {
                        if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() == currentModification$iv) {
                            try {
                                $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setList$runtime_release(persistentListAddAll);
                                z = true;
    ...
    */
    ...
    public boolean removeAll(Collection<? extends Object> elements) {
        ...
        while (true) {
            ...
            Intrinsics.checkNotNull(list$runtime_release);
            PersistentList<? extends T> persistentListRemoveAll = list$runtime_release.removeAll((Collection) elements2);
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                ...
                synchronized (lock$iv$iv2) {
                    try {
                        if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() == currentModification$iv) {
                            try {
                                $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setList$runtime_release(persistentListRemoveAll);
                                z = true;
                                $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setModification$runtime_release($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() + 1);
                            } catch (Throwable th) {
                                th = th;
    ...
    public T removeAt(int index) throws Throwable {
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv) {
                Object it3 = it2;
                try {
                    it = snapshotStateList3.getFirstStateRecord();
                    i = i2;
                } catch (Throwable th) {
                    th = th;
                }
                try {
                    ...
                    StateRecord firstStateRecord = snapshotStateList3.getFirstStateRecord();
                    Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
                    ...
                    synchronized (lock$iv$iv$iv$iv$iv$iv) {
                        try {
                            Snapshot current = Snapshot.INSTANCE.getCurrent();
                            SnapshotStateList<T> snapshotStateList4 = snapshotStateList;
                            try {
                                int $i$f$update2 = $i$f$update;
                                try {
                                    StateListStateRecord $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv$iv, snapshotStateList3, current);
                                    Object lock$iv$iv$iv2 = SnapshotStateListKt.sync;
                                    synchronized (lock$iv$iv$iv2) {
                                        SnapshotStateList<T> snapshotStateList5 = snapshotStateList2;
                                        try {
                                            if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.getModification() == currentModification$iv$iv) {
                                                try {
                                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.setList$runtime_release(persistentListRemoveAt);
                                                    z = true;
                                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.setModification$runtime_release($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.getModification() + 1);
                                                } catch (Throwable th2) {
                                                    th = th2;
                                ...
                                try {
                                    ...
                                    synchronized (lock$iv$iv$iv2) {
                                        try {
                                            if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.getModification() == currentModification$iv$iv) {
                                                try {
                                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.setList$runtime_release(persistentList);
                                                    z = true;
                                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.setModification$runtime_release($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv$iv.getModification() + 1);
                                                } catch (Throwable th2) {
                                                    th = th2;
    ...
    */
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    ...
                    try {
                        try {
                            StateListStateRecord $this$mutate_u24lambda_u2418$iv = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv, snapshotStateList3, current);
                            Object lock$iv$iv2 = SnapshotStateListKt.sync;
                            synchronized (lock$iv$iv2) {
                                try {
                                    if ($this$mutate_u24lambda_u2418$iv.getModification() == currentModification$iv) {
                                        ...
                                        try {
                                            $this$mutate_u24lambda_u2418$iv.setList$runtime_release(persistentListBuild);
                                            z = true;
                    ...
                    synchronized (lock$iv2) {
                        try {
                            if ($this$mutate_u24lambda_u2418.getModification() == currentModification) {
                                try {
                                    $this$mutate_u24lambda_u2418.setList$runtime_release(persistentListBuild);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final void update(kotlin.jvm.functions.Function1<? super androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList<? extends T>, ? extends androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList<? extends T>> r27) throws java.lang.Throwable {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final boolean conditionalUpdate(kotlin.jvm.functions.Function1<? super androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList<? extends T>, ? extends androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentList<? extends T>> r26) throws java.lang.Throwable {
        /*

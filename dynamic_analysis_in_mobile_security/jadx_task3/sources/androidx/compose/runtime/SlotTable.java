...
public final class SlotTable implements CompositionData, Iterable<CompositionGroup>, KMappedMarker {
    ...
    private static final int verifyWellFormed$validateGroup(Ref.IntRef intRef, SlotTable slotTable, int i, int i2) {
        ...
        int iDataAnchor2 = i3 >= slotTable.groupsSize - 1 ? slotTable.slotsSize : SlotTableKt.dataAnchor(slotTable.groups, i3 + 1);
        ...
        if (!(iGroupSize2 == i4)) {
            throw new IllegalStateException(("Incorrect slot count detected at " + i3 + ", expected " + iGroupSize2 + ", received " + i4).toString());
        }
    ...
    public final String asString() {
        ...
        String string = $this$asString_u24lambda_u2433.toString();

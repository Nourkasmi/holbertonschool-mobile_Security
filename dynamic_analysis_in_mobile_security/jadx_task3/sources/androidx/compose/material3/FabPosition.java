...
public final class FabPosition {
    ...
    private static final int Center = m1516constructorimpl(0);
    private static final int End = m1516constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1515boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1522getCenterERTFSPs() {
            return FabPosition.Center;
        }

        /* JADX INFO: renamed from: getEnd-ERTFSPs, reason: not valid java name */
        public final int m1523getEndERTFSPs() {
    ...
    public static String m1520toStringimpl(int arg0) {
        return m1518equalsimpl0(arg0, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}

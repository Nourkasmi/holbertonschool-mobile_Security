...
public final class SnackbarHostKt {
    ...
    public static final void SnackbarHost(final SnackbarHostState hostState, Modifier modifier, Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 731) == 146 && $composer2.getSkipping()) {
            ...
            Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3M1443getLambda1$material3_release = i3 != 0 ? ComposableSingletons$SnackbarHostKt.INSTANCE.m1443getLambda1$material3_release() : function32;
            ...
            FadeInFadeOutWithScale(hostState.getCurrentSnackbarData(), modifier4, function3M1443getLambda1$material3_release, $composer2, ($dirty2 & 112) | ($dirty2 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier3 = modifier4;
            function33 = function3M1443getLambda1$material3_release;
        }
    ...
    public static final void FadeInFadeOutWithScale(final SnackbarData current, Modifier modifier, final Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 731) == 146 && $composer2.getSkipping()) {
                    ...
                    destination$iv.add(new FadeInFadeOutAnimationItem(key, ComposableLambdaKt.composableLambda($composer2, 1365430839, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarHostKt$FadeInFadeOutWithScale$1$1
                        ...
                        public final void invoke(Function2<? super Composer, ? super Integer, Unit> children, Composer $composer3, int $changed2) {
                            ...
                            if (($dirty4 & 91) != 18 || !$composer3.getSkipping()) {
                                ...
                                State opacity = SnackbarHostKt.animatedOpacity(tweenSpecTween, isVisible, new Function0<Unit>() { // from class: androidx.compose.material3.SnackbarHostKt$FadeInFadeOutWithScale$1$1$opacity$1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    {
                                        super(0);
                                    }
                                ...
                                Modifier modifier$iv = SemanticsModifierKt.semantics$default(modifierM3103graphicsLayerAp8cVGQ$default, false, (Function1) value$iv$iv2, 1, null);
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                function3Component2.invoke(ComposableLambdaKt.composableLambda($composer2, -1462081411, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SnackbarHostKt$FadeInFadeOutWithScale$2$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
    ...
    public static final State<Float> animatedOpacity(AnimationSpec<Float> animationSpec, boolean visible, Function0<Unit> function0, Composer $composer, int $changed, int i) {
        ...
        C04191 c04191 = (i & 4) != 0 ? new Function0<Unit>() { // from class: androidx.compose.material3.SnackbarHostKt.animatedOpacity.1
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Unit invoke() {
                invoke2();
                return Unit.INSTANCE;
        ...
        EffectsKt.LaunchedEffect(Boolean.valueOf(visible), new C04202(alpha, visible, animationSpec, c04191, null), $composer, (($changed >> 3) & 14) | 64);
    ...
    public static final State<Float> animatedScale(AnimationSpec<Float> animationSpec, boolean visible, Composer $composer, int $changed) {
        ...
        EffectsKt.LaunchedEffect(Boolean.valueOf(visible), new C04211(scale, visible, animationSpec, null), $composer, (($changed >> 3) & 14) | 64);
    ...
    static final class C04202 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04202(Animatable<Float, AnimationVector1D> animatable, boolean z, AnimationSpec<Float> animationSpec, Function0<Unit> function0, Continuation<? super C04202> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04202(this.$alpha, this.$visible, this.$animation, this.$onAnimationFinish, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C04202) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            c04202.$onAnimationFinish.invoke();
            return Unit.INSTANCE;
        }
    }
    ...
    static final class C04211 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04211(Animatable<Float, AnimationVector1D> animatable, boolean z, AnimationSpec<Float> animationSpec, Continuation<? super C04211> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04211(this.$scale, this.$visible, this.$animation, continuation);
        }

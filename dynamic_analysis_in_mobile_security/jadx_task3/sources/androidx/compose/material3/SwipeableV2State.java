...
public final class SwipeableV2State<T> {
    ...
    static final class C04361 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C04361(SwipeableV2State<T> swipeableV2State, Continuation<? super C04361> continuation) {
            super(continuation);
    ...
    static final class C04372 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ SwipeableV2State<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04372(SwipeableV2State<T> swipeableV2State, T t, Continuation<? super C04372> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04372(this.this$0, this.$targetValue, continuation);
        }
    ...
    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objSwipe$default = swipe$default(this, null, new C04372(this, t, null), continuation, 1, null);
    ...
    */
    ...
    static final class C04382 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04382(SwipeableV2State<T> swipeableV2State, MutatePriority mutatePriority, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C04382> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04382(this.this$0, this.$swipePriority, this.$action, continuation);
        }
    ...
    public final Object swipe(MutatePriority swipePriority, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04382(this, swipePriority, function1, null), continuation);

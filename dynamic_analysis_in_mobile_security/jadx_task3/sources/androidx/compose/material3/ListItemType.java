...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1585constructorimpl(1);
    private static final int TwoLine = m1585constructorimpl(2);
    private static final int ThreeLine = m1585constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m1583boximpl(int i) {
        return new ListItemType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m1585constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1586equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1588hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1589toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1590compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m1584compareToyh95HIg(int arg0, int other) {
        return Intrinsics.compare(arg0, other);
    }

    /* JADX INFO: renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m1590compareToyh95HIg(int other) {
        return m1584compareToyh95HIg(this.lines, other);
    }
    ...
    public static final class Companion {
        ...
        public final int m1593getOneLineAlXitO8() {
            return ListItemType.OneLine;
        }

        /* JADX INFO: renamed from: getTwoLine-AlXitO8, reason: not valid java name */
        public final int m1595getTwoLineAlXitO8() {
            return ListItemType.TwoLine;
        }

        /* JADX INFO: renamed from: getThreeLine-AlXitO8, reason: not valid java name */
        public final int m1594getThreeLineAlXitO8() {
            return ListItemType.ThreeLine;
        }

        /* JADX INFO: renamed from: getListItemType-7AlIA9s$material3_release, reason: not valid java name */
        public final int m1592getListItemType7AlIA9s$material3_release(boolean hasOverline, boolean hasSupporting) {
            if (hasOverline && hasSupporting) {
                return m1594getThreeLineAlXitO8();
            }
            if (hasOverline || hasSupporting) {
                return m1595getTwoLineAlXitO8();
            }
            return m1593getOneLineAlXitO8();
        }
    }
}

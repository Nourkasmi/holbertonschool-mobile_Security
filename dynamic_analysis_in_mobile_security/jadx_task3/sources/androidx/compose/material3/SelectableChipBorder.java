...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m187BorderStrokecXLIe8U(selected ? this.selectedBorderWidth : this.borderWidth, color), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2954hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m2954hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2954hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5218hashCodeimpl(this.borderWidth)) * 31) + Dp.m5218hashCodeimpl(this.selectedBorderWidth);
    }
}

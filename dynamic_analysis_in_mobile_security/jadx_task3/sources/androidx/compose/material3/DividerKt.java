...
public final class DividerKt {
    ...
    public static final void m1494Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        long j;
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                thickness2 = i3 != 0 ? DividerDefaults.INSTANCE.m1493getThicknessD9Ej5fM() : f;
                if ((i & 4) != 0) {
            ...
            BoxKt.Box(BackgroundKt.m160backgroundbw27NRU$default(SizeKt.m514height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3, 0.0f, 1, null), targetThickness), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer, int i5) {
                DividerKt.m1494Divider9IZ8Weo(modifier5, f2, j2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}

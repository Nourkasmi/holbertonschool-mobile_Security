...
final class TooltipSync {
    ...
    public final Object show(final TooltipState state, boolean persistent, Continuation<? super Unit> continuation) {
        ...
        if (state instanceof PlainTooltipState) {
            Function1 runBlock2 = new C04692(state, null);
            runBlock = runBlock2;
    ...
    static final class C04692 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        C04692(TooltipState tooltipState, Continuation<? super C04692> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04692(this.$state, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C04692) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }

...
public final class AlertDialogKt {
    private static final float DialogMinWidth = Dp.m5212constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m5212constructorimpl(560);
    private static final PaddingValues DialogPadding = PaddingKt.m474PaddingValues0680j_4(Dp.m5212constructorimpl(24));
    private static final PaddingValues IconPadding = PaddingKt.m478PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5212constructorimpl(16), 7, null);
    private static final PaddingValues TitlePadding = PaddingKt.m478PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5212constructorimpl(16), 7, null);
    private static final PaddingValues TextPadding = PaddingKt.m478PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5212constructorimpl(24), 7, null);
    ...
    public static final void m1292AlertDialogFlowRowixp7dh8(final float mainAxisSpacing, final float crossAxisSpacing, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                ...
                public final MeasureResult mo12measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    for (Measurable measurable : measurables) {
                        Placeable placeable = measurable.mo4183measureBRTryo0(constraints);
                    ...
                    final int mainAxisLayoutSize = Math.max(mainAxisSpace.element, Constraints.m5170getMinWidthimpl(constraints));
                    ...
                    return MeasureScope.layout$default(Layout, mainAxisLayoutSize, crossAxisLayoutSize, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$measure$1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            for (Object item$iv : $this$forEachIndexed$iv) {
                                ...
                                int i3 = 0;
                                while (i3 < size) {
                                    childrenMainAxisSizes[i3] = ((Placeable) placeables.get(i3)).getWidth() + (i3 < CollectionsKt.getLastIndex(placeables) ? measureScope.mo320roundToPx0680j_4(f2) : 0);
                                    i3++;
                                }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
            ...
            public final void invoke(Composer composer, int i) {
                AlertDialogKt.m1292AlertDialogFlowRowixp7dh8(mainAxisSpacing, crossAxisSpacing, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }

    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (Selection.m1693equalsimpl0(this.this$0.m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1697getHourJiIwxys())) {
                    this.this$0.setHourAngle$material3_release((r2.toHour(this.$value) % 12) * 0.5235988f);
                } else if (this.$fromTap) {
                    this.this$0.setMinuteAngle$material3_release((r2.toMinute(this.$value) - (this.this$0.toMinute(this.$value) % 5)) * 0.10471976f);
                } else {
                    this.this$0.setMinuteAngle$material3_release(r2.toMinute(this.$value) * 0.10471976f);
                }
                if (!this.$fromTap) {
                    this.label = 2;

...
public final class TextFieldColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(j), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> indicatorColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = indicatorColor$lambda$2(stateCollectIsFocusedAsState) ? this.focusedIndicatorColor : this.unfocusedIndicatorColor;
        }
        if (enabled) {
            $composer.startReplaceableGroup(715788864);
            ComposerKt.sourceInformation($composer, "1814@99574L75");
            stateRememberUpdatedState = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, $composer, 48, 12);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(715788969);
            ComposerKt.sourceInformation($composer, "1816@99679L33");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(targetValue), $composer, 0);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = containerColor$lambda$3(stateCollectIsFocusedAsState) ? this.focusedContainerColor : this.unfocusedContainerColor;
        }
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> placeholderColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = placeholderColor$lambda$4(stateCollectIsFocusedAsState) ? this.focusedPlaceholderColor : this.unfocusedPlaceholderColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(targetValue), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> labelColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = labelColor$lambda$5(stateCollectIsFocusedAsState) ? this.focusedLabelColor : this.unfocusedLabelColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(targetValue), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> textColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = textColor$lambda$6(stateCollectIsFocusedAsState) ? this.focusedTextColor : this.unfocusedTextColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(targetValue), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> prefixColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = prefixColor$lambda$8(stateCollectIsFocusedAsState) ? this.focusedPrefixColor : this.unfocusedPrefixColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(targetValue), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> suffixColor$material3_release(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (!enabled) {
            ...
            targetValue = suffixColor$lambda$9(stateCollectIsFocusedAsState) ? this.focusedSuffixColor : this.unfocusedSuffixColor;
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(targetValue), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> cursorColor$material3_release(boolean isError, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(isError ? this.errorCursorColor : this.cursorColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TextFieldColors) && Color.m2948equalsimpl0(this.focusedTextColor, ((TextFieldColors) other).focusedTextColor) && Color.m2948equalsimpl0(this.unfocusedTextColor, ((TextFieldColors) other).unfocusedTextColor) && Color.m2948equalsimpl0(this.disabledTextColor, ((TextFieldColors) other).disabledTextColor) && Color.m2948equalsimpl0(this.errorTextColor, ((TextFieldColors) other).errorTextColor) && Color.m2948equalsimpl0(this.focusedContainerColor, ((TextFieldColors) other).focusedContainerColor) && Color.m2948equalsimpl0(this.unfocusedContainerColor, ((TextFieldColors) other).unfocusedContainerColor) && Color.m2948equalsimpl0(this.disabledContainerColor, ((TextFieldColors) other).disabledContainerColor) && Color.m2948equalsimpl0(this.errorContainerColor, ((TextFieldColors) other).errorContainerColor) && Color.m2948equalsimpl0(this.cursorColor, ((TextFieldColors) other).cursorColor) && Color.m2948equalsimpl0(this.errorCursorColor, ((TextFieldColors) other).errorCursorColor) && Intrinsics.areEqual(this.textSelectionColors, ((TextFieldColors) other).textSelectionColors) && Color.m2948equalsimpl0(this.focusedIndicatorColor, ((TextFieldColors) other).focusedIndicatorColor) && Color.m2948equalsimpl0(this.unfocusedIndicatorColor, ((TextFieldColors) other).unfocusedIndicatorColor) && Color.m2948equalsimpl0(this.disabledIndicatorColor, ((TextFieldColors) other).disabledIndicatorColor) && Color.m2948equalsimpl0(this.errorIndicatorColor, ((TextFieldColors) other).errorIndicatorColor) && Color.m2948equalsimpl0(this.focusedLeadingIconColor, ((TextFieldColors) other).focusedLeadingIconColor) && Color.m2948equalsimpl0(this.unfocusedLeadingIconColor, ((TextFieldColors) other).unfocusedLeadingIconColor) && Color.m2948equalsimpl0(this.disabledLeadingIconColor, ((TextFieldColors) other).disabledLeadingIconColor) && Color.m2948equalsimpl0(this.errorLeadingIconColor, ((TextFieldColors) other).errorLeadingIconColor) && Color.m2948equalsimpl0(this.focusedTrailingIconColor, ((TextFieldColors) other).focusedTrailingIconColor) && Color.m2948equalsimpl0(this.unfocusedTrailingIconColor, ((TextFieldColors) other).unfocusedTrailingIconColor) && Color.m2948equalsimpl0(this.disabledTrailingIconColor, ((TextFieldColors) other).disabledTrailingIconColor) && Color.m2948equalsimpl0(this.errorTrailingIconColor, ((TextFieldColors) other).errorTrailingIconColor) && Color.m2948equalsimpl0(this.focusedLabelColor, ((TextFieldColors) other).focusedLabelColor) && Color.m2948equalsimpl0(this.unfocusedLabelColor, ((TextFieldColors) other).unfocusedLabelColor) && Color.m2948equalsimpl0(this.disabledLabelColor, ((TextFieldColors) other).disabledLabelColor) && Color.m2948equalsimpl0(this.errorLabelColor, ((TextFieldColors) other).errorLabelColor) && Color.m2948equalsimpl0(this.focusedPlaceholderColor, ((TextFieldColors) other).focusedPlaceholderColor) && Color.m2948equalsimpl0(this.unfocusedPlaceholderColor, ((TextFieldColors) other).unfocusedPlaceholderColor) && Color.m2948equalsimpl0(this.disabledPlaceholderColor, ((TextFieldColors) other).disabledPlaceholderColor) && Color.m2948equalsimpl0(this.errorPlaceholderColor, ((TextFieldColors) other).errorPlaceholderColor) && Color.m2948equalsimpl0(this.focusedSupportingTextColor, ((TextFieldColors) other).focusedSupportingTextColor) && Color.m2948equalsimpl0(this.unfocusedSupportingTextColor, ((TextFieldColors) other).unfocusedSupportingTextColor) && Color.m2948equalsimpl0(this.disabledSupportingTextColor, ((TextFieldColors) other).disabledSupportingTextColor) && Color.m2948equalsimpl0(this.errorSupportingTextColor, ((TextFieldColors) other).errorSupportingTextColor) && Color.m2948equalsimpl0(this.focusedPrefixColor, ((TextFieldColors) other).focusedPrefixColor) && Color.m2948equalsimpl0(this.unfocusedPrefixColor, ((TextFieldColors) other).unfocusedPrefixColor) && Color.m2948equalsimpl0(this.disabledPrefixColor, ((TextFieldColors) other).disabledPrefixColor) && Color.m2948equalsimpl0(this.errorPrefixColor, ((TextFieldColors) other).errorPrefixColor) && Color.m2948equalsimpl0(this.focusedSuffixColor, ((TextFieldColors) other).focusedSuffixColor) && Color.m2948equalsimpl0(this.unfocusedSuffixColor, ((TextFieldColors) other).unfocusedSuffixColor) && Color.m2948equalsimpl0(this.disabledSuffixColor, ((TextFieldColors) other).disabledSuffixColor) && Color.m2948equalsimpl0(this.errorSuffixColor, ((TextFieldColors) other).errorSuffixColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.focusedTextColor);
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m2954hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2954hashCodeimpl(this.errorTextColor)) * 31) + Color.m2954hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2954hashCodeimpl(this.errorContainerColor)) * 31) + Color.m2954hashCodeimpl(this.cursorColor)) * 31) + Color.m2954hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m2954hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2954hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2954hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m2954hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m2954hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m2954hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m2954hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m2954hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m2954hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m2954hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m2954hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m2954hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m2954hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m2954hashCodeimpl(this.errorSuffixColor);
    }
}

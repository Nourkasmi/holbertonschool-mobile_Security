...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState state, Composer $composer, int $changed) {
        ...
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean enabled, ToggleableState state, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            int duration = state == ToggleableState.Off ? 100 : 50;
            stateRememberUpdatedState = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CheckboxColors) && Color.m2948equalsimpl0(this.checkedCheckmarkColor, ((CheckboxColors) other).checkedCheckmarkColor) && Color.m2948equalsimpl0(this.uncheckedCheckmarkColor, ((CheckboxColors) other).uncheckedCheckmarkColor) && Color.m2948equalsimpl0(this.checkedBoxColor, ((CheckboxColors) other).checkedBoxColor) && Color.m2948equalsimpl0(this.uncheckedBoxColor, ((CheckboxColors) other).uncheckedBoxColor) && Color.m2948equalsimpl0(this.disabledCheckedBoxColor, ((CheckboxColors) other).disabledCheckedBoxColor) && Color.m2948equalsimpl0(this.disabledUncheckedBoxColor, ((CheckboxColors) other).disabledUncheckedBoxColor) && Color.m2948equalsimpl0(this.disabledIndeterminateBoxColor, ((CheckboxColors) other).disabledIndeterminateBoxColor) && Color.m2948equalsimpl0(this.checkedBorderColor, ((CheckboxColors) other).checkedBorderColor) && Color.m2948equalsimpl0(this.uncheckedBorderColor, ((CheckboxColors) other).uncheckedBorderColor) && Color.m2948equalsimpl0(this.disabledBorderColor, ((CheckboxColors) other).disabledBorderColor) && Color.m2948equalsimpl0(this.disabledIndeterminateBorderColor, ((CheckboxColors) other).disabledIndeterminateBorderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.checkedCheckmarkColor);
        return (((((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m2954hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m2954hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m2954hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m2954hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m2954hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m2954hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m2954hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m2954hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2954hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}

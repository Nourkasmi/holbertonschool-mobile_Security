...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m5212constructorimpl(22);
    private static final float BottomSheetMaxWidth = Dp.m5212constructorimpl(640);
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection.1
            ...
            public long mo335onPreScrollOzD1aCk(long available, int source) {
                ...
                if (delta < 0.0f && NestedScrollSource.m3957equalsimpl0(source, NestedScrollSource.INSTANCE.m3962getDragWNlRxjI())) {
                    return toOffset(sheetState.getSwipeableState$material3_release().dispatchRawDelta(delta));
                }
            ...
            public Object mo558onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
                long jM5448getZero9UxMQ8M;
                float toFling = velocityToFloat(available);
                float currentOffset = sheetState.requireOffset();
                if (toFling < 0.0f && currentOffset > sheetState.getSwipeableState$material3_release().getMinOffset()) {
                    onFling.invoke(Boxing.boxFloat(toFling));
                    jM5448getZero9UxMQ8M = available;
                } else {
                    jM5448getZero9UxMQ8M = Velocity.INSTANCE.m5448getZero9UxMQ8M();
                }
                return Velocity.m5428boximpl(jM5448getZero9UxMQ8M);
            }
            ...
            public Object mo333onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
                ...
                return Velocity.m5428boximpl(available);
            }
            ...
            private final float velocityToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Velocity.m5437getXimpl($this$toFloat) : Velocity.m5438getYimpl($this$toFloat);
            }

            private final float offsetToFloat(long $this$toFloat) {
                return orientation == Orientation.Horizontal ? Offset.m2708getXimpl($this$toFloat) : Offset.m2709getYimpl($this$toFloat);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean skipPartiallyExpanded, Function1<? super SheetValue, Boolean> function1, SheetValue initialValue, boolean skipHiddenState, Composer $composer, int $changed, int i) {
        ...
        Object[] objArr = {Boolean.valueOf(skipPartiallyExpanded2), function12};
        Saver<SheetState, SheetValue> Saver = SheetState.INSTANCE.Saver(skipPartiallyExpanded2, function12);
        Object[] keys$iv = {Boolean.valueOf(skipPartiallyExpanded2), initialValue2, function12, Boolean.valueOf(skipHiddenState2)};
        ...
        if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = (Function0) new Function0<SheetState>() { // from class: androidx.compose.material3.SheetDefaultsKt$rememberSheetState$2$1
                ...
                public final SheetState invoke() {
                    return new SheetState(skipPartiallyExpanded2, initialValue2, function12, skipHiddenState2);
                }
            };
        ...
        SheetState sheetState = (SheetState) RememberSaveableKt.m2594rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) value$iv$iv, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {

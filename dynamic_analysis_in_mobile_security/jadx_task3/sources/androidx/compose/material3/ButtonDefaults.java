...
public final class ButtonDefaults {
    ...
    static {
        float fM5212constructorimpl = Dp.m5212constructorimpl(24);
        ...
        float fM5212constructorimpl3 = Dp.m5212constructorimpl(16);
        ButtonWithIconHorizontalStartPadding = fM5212constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m477PaddingValuesa9UjIt4(fM5212constructorimpl3, fM5212constructorimpl2, fM5212constructorimpl, fM5212constructorimpl2);
        float fM5212constructorimpl4 = Dp.m5212constructorimpl(12);
        TextButtonHorizontalPadding = fM5212constructorimpl4;
        TextButtonContentPadding = PaddingKt.m477PaddingValuesa9UjIt4(fM5212constructorimpl4, paddingValuesM477PaddingValuesa9UjIt4.getTop(), fM5212constructorimpl4, paddingValuesM477PaddingValuesa9UjIt4.getBottom());
        float fM5212constructorimpl5 = Dp.m5212constructorimpl(16);
        TextButtonWithIconHorizontalEndPadding = fM5212constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m477PaddingValuesa9UjIt4(fM5212constructorimpl4, paddingValuesM477PaddingValuesa9UjIt4.getTop(), fM5212constructorimpl5, paddingValuesM477PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m5212constructorimpl(58);
        MinHeight = Dp.m5212constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m2208getIconSizeD9Ej5fM();
    ...
    public final ButtonColors m1330outlinedButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 8) != 0) {
            ...
            disabledContentColor2 = Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1325filledTonalButtonElevationR_JCAzs(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float disabledElevation2 = (i & 16) != 0 ? Dp.m5212constructorimpl(0) : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer $composer, int $changed) {
        ...
        BorderStroke borderStrokeM187BorderStrokecXLIe8U = BorderStrokeKt.m187BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m2311getOutlineWidthD9Ej5fM(), ColorSchemeKt.toColor(OutlinedButtonTokens.INSTANCE.getOutlineColor(), $composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

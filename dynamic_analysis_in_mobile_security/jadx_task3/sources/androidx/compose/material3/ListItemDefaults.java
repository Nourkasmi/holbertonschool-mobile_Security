...
public final class ListItemDefaults {
    ...
    private static final float Elevation = ListTokens.INSTANCE.m2264getListItemContainerElevationD9Ej5fM();

    private ListItemDefaults() {
    }

    /* JADX INFO: renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m1573getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final ListItemColors m1572colorsJ08w3E(long containerColor, long headlineColor, long leadingIconColor, long overlineColor, long supportingColor, long trailingIconColor, long disabledHeadlineColor, long disabledLeadingIconColor, long disabledTrailingIconColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 64) != 0) {
            long color = ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledLabelTextColor(), $composer, 6);
            disabledHeadlineColor2 = Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : ListTokens.INSTANCE.getListItemDisabledLabelTextOpacity(), (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
        } else {
            disabledHeadlineColor2 = disabledHeadlineColor;
        }
        if ((i & 128) != 0) {
            long color2 = ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledLeadingIconColor(), $composer, 6);
            disabledLeadingIconColor2 = Color.m2945copywmQWz5c(color2, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color2) : ListTokens.INSTANCE.getListItemDisabledLeadingIconOpacity(), (14 & 2) != 0 ? Color.m2953getRedimpl(color2) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color2) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color2) : 0.0f);
        } else {
            disabledLeadingIconColor2 = disabledLeadingIconColor;
        }
        if ((i & 256) != 0) {
            long color3 = ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledTrailingIconColor(), $composer, 6);
            disabledTrailingIconColor2 = Color.m2945copywmQWz5c(color3, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color3) : ListTokens.INSTANCE.getListItemDisabledTrailingIconOpacity(), (14 & 2) != 0 ? Color.m2953getRedimpl(color3) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color3) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color3) : 0.0f);
        } else {

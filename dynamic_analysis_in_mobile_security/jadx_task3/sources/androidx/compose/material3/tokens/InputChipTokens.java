...
public final class InputChipTokens {
    ...
    private static final float UnselectedOutlineWidth = Dp.m5212constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m5212constructorimpl((float) 24.0d);
    ...
    private static final float TrailingIconSize = Dp.m5212constructorimpl((float) 18.0d);
    ...
    public final float m2255getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2256getContainerHeightD9Ej5fM() {
    ...
    public final float m2257getDraggedContainerElevationD9Ej5fM() {
    ...
    public final float m2259getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m2261getUnselectedOutlineWidthD9Ej5fM() {
    ...
    public final float m2254getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m2258getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2260getTrailingIconSizeD9Ej5fM() {

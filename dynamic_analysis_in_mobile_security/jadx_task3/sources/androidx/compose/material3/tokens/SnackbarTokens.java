...
public final class SnackbarTokens {
    ...
    private static final float SingleLineContainerHeight = Dp.m5212constructorimpl((float) 48.0d);
    private static final float TwoLinesContainerHeight = Dp.m5212constructorimpl((float) 68.0d);
    ...
    public final float m2441getContainerElevationD9Ej5fM() {
    ...
    public final float m2442getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2443getSingleLineContainerHeightD9Ej5fM() {
        return SingleLineContainerHeight;
    }

    /* JADX INFO: renamed from: getTwoLinesContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2444getTwoLinesContainerHeightD9Ej5fM() {

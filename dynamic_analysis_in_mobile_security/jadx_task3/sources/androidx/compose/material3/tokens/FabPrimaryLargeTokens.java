...
public final class FabPrimaryLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m5212constructorimpl((float) 96.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerExtraLarge;
    private static final float ContainerWidth = Dp.m5212constructorimpl((float) 96.0d);
    ...
    private static final float IconSize = Dp.m5212constructorimpl((float) 36.0d);
    ...
    public final float m2151getContainerWidthD9Ej5fM() {
    ...
    public final float m2155getLoweredContainerElevationD9Ej5fM() {
    ...
    public final float m2156getLoweredFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2157getLoweredHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2158getLoweredPressedContainerElevationD9Ej5fM() {
    ...
    public final float m2159getPressedContainerElevationD9Ej5fM() {

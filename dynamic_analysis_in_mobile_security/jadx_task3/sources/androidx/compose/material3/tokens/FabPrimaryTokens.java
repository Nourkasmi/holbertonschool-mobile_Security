...
public final class FabPrimaryTokens {
    ...
    private static final float ContainerHeight = Dp.m5212constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerLarge;
    private static final float ContainerWidth = Dp.m5212constructorimpl((float) 56.0d);
    ...
    public final float m2174getFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2175getHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2176getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* JADX INFO: renamed from: getLoweredContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2177getLoweredContainerElevationD9Ej5fM() {
    ...
    public final float m2178getLoweredFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2179getLoweredHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2180getLoweredPressedContainerElevationD9Ej5fM() {
    ...
    public final float m2181getPressedContainerElevationD9Ej5fM() {

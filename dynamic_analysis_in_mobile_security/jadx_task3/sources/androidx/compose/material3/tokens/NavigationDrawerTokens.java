...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5212constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5212constructorimpl((float) 336.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m2133getLevel0D9Ej5fM();
    ...
    public final float m2286getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2287getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2288getContainerWidthD9Ej5fM() {
    ...
    public final float m2289getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2290getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* JADX INFO: renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2291getStandardContainerElevationD9Ej5fM() {

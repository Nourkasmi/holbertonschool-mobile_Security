...
public final class ElevatedButtonTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    ...
    private static final float FocusContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final ColorSchemeKeyTokens FocusLabelTextColor = ColorSchemeKeyTokens.Primary;
    private static final float HoverContainerElevation = ElevationTokens.INSTANCE.m2135getLevel2D9Ej5fM();
    ...
    private static final float PressedContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    ...
    public final float m2119getContainerElevationD9Ej5fM() {
    ...
    public final float m2121getDisabledContainerElevationD9Ej5fM() {
    ...
    public final float m2122getFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2123getHoverContainerElevationD9Ej5fM() {

...
public final class SelectableChipElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m5217equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m5217equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m5217equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m5217equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m5217equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.SelectableChipElevation$animateElevation$2, reason: invalid class name */
    /* JADX INFO: compiled from: Chip.kt */
    ...
    /* JADX INFO: renamed from: androidx.compose.material3.SelectableChipElevation$animateElevation$3, reason: invalid class name */
    /* JADX INFO: compiled from: Chip.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)

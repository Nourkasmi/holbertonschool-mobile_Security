...
public final class SelectableChipColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(target), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipColors) && Color.m2948equalsimpl0(this.containerColor, ((SelectableChipColors) other).containerColor) && Color.m2948equalsimpl0(this.labelColor, ((SelectableChipColors) other).labelColor) && Color.m2948equalsimpl0(this.leadingIconColor, ((SelectableChipColors) other).leadingIconColor) && Color.m2948equalsimpl0(this.trailingIconColor, ((SelectableChipColors) other).trailingIconColor) && Color.m2948equalsimpl0(this.disabledContainerColor, ((SelectableChipColors) other).disabledContainerColor) && Color.m2948equalsimpl0(this.disabledLabelColor, ((SelectableChipColors) other).disabledLabelColor) && Color.m2948equalsimpl0(this.disabledLeadingIconColor, ((SelectableChipColors) other).disabledLeadingIconColor) && Color.m2948equalsimpl0(this.disabledTrailingIconColor, ((SelectableChipColors) other).disabledTrailingIconColor) && Color.m2948equalsimpl0(this.selectedContainerColor, ((SelectableChipColors) other).selectedContainerColor) && Color.m2948equalsimpl0(this.disabledSelectedContainerColor, ((SelectableChipColors) other).disabledSelectedContainerColor) && Color.m2948equalsimpl0(this.selectedLabelColor, ((SelectableChipColors) other).selectedLabelColor) && Color.m2948equalsimpl0(this.selectedLeadingIconColor, ((SelectableChipColors) other).selectedLeadingIconColor) && Color.m2948equalsimpl0(this.selectedTrailingIconColor, ((SelectableChipColors) other).selectedTrailingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.labelColor)) * 31) + Color.m2954hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m2954hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.selectedTrailingIconColor);
    }
}

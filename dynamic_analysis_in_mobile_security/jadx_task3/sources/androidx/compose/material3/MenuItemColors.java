...
public final class MenuItemColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.leadingIconColor : this.disabledLeadingIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> trailingIconColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.trailingIconColor : this.disabledTrailingIconColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof MenuItemColors) && Color.m2948equalsimpl0(this.textColor, ((MenuItemColors) other).textColor) && Color.m2948equalsimpl0(this.leadingIconColor, ((MenuItemColors) other).leadingIconColor) && Color.m2948equalsimpl0(this.trailingIconColor, ((MenuItemColors) other).trailingIconColor) && Color.m2948equalsimpl0(this.disabledTextColor, ((MenuItemColors) other).disabledTextColor) && Color.m2948equalsimpl0(this.disabledLeadingIconColor, ((MenuItemColors) other).disabledLeadingIconColor) && Color.m2948equalsimpl0(this.disabledTrailingIconColor, ((MenuItemColors) other).disabledTrailingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2954hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledTrailingIconColor);
    }
}

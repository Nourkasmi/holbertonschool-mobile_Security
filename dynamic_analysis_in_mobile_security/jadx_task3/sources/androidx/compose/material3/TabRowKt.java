...
public final class TabRowKt {
    private static final float ScrollableTabRowMinimumTabWidth = Dp.m5212constructorimpl(90);
    private static final float ScrollableTabRowPadding = Dp.m5212constructorimpl(52);
    ...
    */
    public static final void m1827TabRowpAZo6Ak(final int r28, androidx.compose.ui.Modifier r29, long r30, long r32, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material3.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instruction units count: 492
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabRowKt.m1827TabRowpAZo6Ak(int, androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: renamed from: ScrollableTabRow-sKfQg0A, reason: not valid java name */
    public static final void m1826ScrollableTabRowsKfQg0A(final int selectedTabIndex, Modifier modifier, long containerColor, long contentColor, float edgePadding, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, final int $changed, final int i) {
        long containerColor2;
        long contentColor2;
        float edgePadding2;
        Modifier.Companion modifier2;
        ComposableLambda composableLambda;
        Function2<? super Composer, ? super Integer, Unit> function2M1446getLambda2$material3_release;
        Modifier modifier3;
        ...
        if ((23967451 & $dirty) == 4793490 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                composableLambda = i6 != 0 ? ComposableLambdaKt.composableLambda($composer2, -913748678, true, new Function3<List<? extends TabPosition>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$1
                    ...
                    public final void invoke(List<TabPosition> tabPositions, Composer $composer3, int $changed2) {
                        ...
                        TabRowDefaults.INSTANCE.m1825Indicator9IZ8Weo(TabRowDefaults.INSTANCE.tabIndicatorOffset(Modifier.INSTANCE, tabPositions.get(selectedTabIndex)), 0.0f, 0L, $composer3, 3072, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
                }) : function3;
                function2M1446getLambda2$material3_release = i7 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m1446getLambda2$material3_release() : function2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
                ...
                if ((i & 8) != 0) {
                    ...
                    function2M1446getLambda2$material3_release = function2;
                    $dirty &= -7169;
                    modifier2 = modifier;
                } else {
                    modifier2 = modifier;
            ...
            final Function2<? super Composer, ? super Integer, Unit> function23 = function2M1446getLambda2$material3_release;
            final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function33 = composableLambda;
            final int i8 = $dirty;
            SurfaceKt.m1792SurfaceT9BRK9s(modifier2, null, containerColor2, contentColor2, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda($composer2, 286469328, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(modifierClipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$2.1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m1828invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                            }

                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1828invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, final long constraints) {
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                int minTabWidth = SubcomposeLayout.mo320roundToPx0680j_4(TabRowKt.ScrollableTabRowMinimumTabWidth);
                                final int padding = SubcomposeLayout.mo320roundToPx0680j_4(f2);
                                Iterable iterableSubcompose = SubcomposeLayout.subcompose(TabSlots.Tabs, function24);
                                ...
                                long tabConstraints = Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : minTabWidth, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : accumulator$iv, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : accumulator$iv);
                                Iterable $this$map$iv = iterableSubcompose;
                                Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
                                for (Object item$iv$iv : $this$map$iv) {
                                    Measurable it = (Measurable) item$iv$iv;
                                    destination$iv$iv.add(it.mo4183measureBRTryo0(tabConstraints));
                                }
                                ...
                                return MeasureScope.layout$default(SubcomposeLayout, accumulator$iv2, accumulator$iv, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabRowKt.ScrollableTabRow.2.1.1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        for (Object element$iv3 : $this$forEach$iv) {
                                            ...
                                            tabPositions.add(new TabPosition(subcomposeMeasureScope.mo323toDpu2uoSUM(left2), subcomposeMeasureScope.mo323toDpu2uoSUM(it2.getWidth()), null));
                                            left2 += it2.getWidth();
                                        }
                                        Iterable $this$forEach$iv2 = SubcomposeLayout.subcompose(TabSlots.Divider, function26);
                                        long j = constraints;
                                        int i14 = accumulator$iv2;
                                        int i15 = i13;
                                        for (Object element$iv4 : $this$forEach$iv2) {
                                            Measurable it3 = (Measurable) element$iv4;
                                            Placeable placeable = it3.mo4183measureBRTryo0(Constraints.m5158copyZbe2FdA(j, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(j) : i14, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(j) : i14, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(j) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(j) : 0));
                                        ...
                                        Iterable $this$forEach$iv3 = subcomposeMeasureScope2.subcompose(tabSlots, ComposableLambdaKt.composableLambdaInstance(963343607, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt.ScrollableTabRow.2.1.1.3
                                            ...
                                            public final void invoke(Composer $composer4, int $changed3) {
                                                ...
                                                function36.invoke(tabPositions, $composer4, Integer.valueOf(((i16 >> 12) & 112) | 8));
                                                if (ComposerKt.isTraceInProgress()) {
                                                    ComposerKt.traceEventEnd();
                                                }
                                            }
                                        ...
                                        for (Object element$iv5 : $this$forEach$iv3) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, it4.mo4183measureBRTryo0(Constraints.INSTANCE.m5176fixedJhjzzOo(i17, i18)), 0, 0, 0.0f, 4, null);
                                        }
            ...
            function22 = function2M1446getLambda2$material3_release;
            containerColor3 = containerColor2;
            contentColor3 = contentColor2;
            edgePadding3 = edgePadding2;
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabRowKt.m1826ScrollableTabRowsKfQg0A(selectedTabIndex, modifier4, j, j2, f2, function34, function24, tabs, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}

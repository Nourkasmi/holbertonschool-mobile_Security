...
public final class AndroidAlertDialog_androidKt {
    private static final float ButtonsMainAxisSpacing = Dp.m5212constructorimpl(8);
    private static final float ButtonsCrossAxisSpacing = Dp.m5212constructorimpl(12);

    /* JADX INFO: renamed from: AlertDialog-Oix01E0, reason: not valid java name */
    public static final void m1293AlertDialogOix01E0(final Function0<Unit> onDismissRequest, final Function2<? super Composer, ? super Integer, Unit> confirmButton, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, Shape shape, long containerColor, long iconContentColor, long titleContentColor, long textContentColor, float tonalElevation, DialogProperties properties, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed & 234881024) == 0) {
            $dirty2 |= ((i & 256) == 0 && $composer2.changed(containerColor)) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
        }
        if ((1879048192 & $changed) == 0) {
            $dirty2 |= ((i & 512) == 0 && $composer2.changed(iconContentColor)) ? 536870912 : 268435456;
        }
        if (($changed1 & 14) == 0) {
            $dirty12 |= ((i & 1024) == 0 && $composer2.changed(titleContentColor)) ? 4 : 2;
        }
        if (($changed1 & 112) == 0) {
            $dirty12 |= ((i & 2048) == 0 && $composer2.changed(textContentColor)) ? 32 : 16;
        }
        int i8 = i & 4096;
        if (i8 != 0) {
            $dirty12 |= 384;
        ...
        if (($dirty2 & 1533916891) == 306783378 && ($dirty12 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                Function2<? super Composer, ? super Integer, Unit> function213 = i4 != 0 ? null : function22;
                if (i5 != 0) {
                    function25 = null;
                }
                if (i6 != 0) {
                ...
                float tonalElevation3 = i8 != 0 ? AlertDialogDefaults.INSTANCE.m1290getTonalElevationD9Ej5fM() : tonalElevation;
                if (i9 != 0) {
            ...
            AlertDialog(onDismissRequest, modifier2, properties2, ComposableLambdaKt.composableLambda($composer2, 741647174, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer3, -1873210524, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1.1
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    float f2 = AndroidAlertDialog_androidKt.ButtonsMainAxisSpacing;
                                    float f3 = AndroidAlertDialog_androidKt.ButtonsCrossAxisSpacing;
                                    ...
                                    AlertDialogKt.m1292AlertDialogFlowRowixp7dh8(f2, f3, ComposableLambdaKt.composableLambda($composer4, 628285581, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1.1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
                                        ...
                                        public final void invoke(Composer $composer5, int $changed4) {
                                            ...
                                            if (($changed4 & 11) != 2 || !$composer5.getSkipping()) {
                                                ...
                                                if (function223 != null) {
                                                    function223.invoke($composer5, Integer.valueOf((i14 >> 9) & 14));
                                                    Unit unit = Unit.INSTANCE;
                                                }
                                                $composer5.endReplaceableGroup();
                                                function222.invoke($composer5, Integer.valueOf((i14 >> 3) & 14));
                                                if (ComposerKt.isTraceInProgress()) {
                        ...
                        int i14 = i11;
                        int i15 = i12;
                        AlertDialogKt.m1291AlertDialogContent4hvqGtA(composableLambda, null, function221, function222, function223, shape5, j5, f2, color, j6, j7, j8, $composer3, ((i14 >> 6) & 7168) | ((i14 >> 6) & 896) | 6 | ((i14 >> 6) & 57344) | ((i14 >> 6) & 458752) | ((i14 >> 6) & 3670016) | ((i15 << 15) & 29360128) | (i14 & 1879048192), (i15 & 14) | (i15 & 112), 2);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.2
            ...
            public final void invoke(Composer composer, int i13) {
                AndroidAlertDialog_androidKt.m1293AlertDialogOix01E0(onDismissRequest, confirmButton, modifier6, function219, function220, function221, function222, shape5, j5, j6, j7, j8, f2, dialogProperties, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void AlertDialog(final Function0<Unit> onDismissRequest, Modifier modifier, DialogProperties properties, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
            ...
            AndroidDialog_androidKt.Dialog(onDismissRequest, properties3, ComposableLambdaKt.composableLambda($composer2, 823217604, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.3
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        final String dialogPaneDescription = Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1759getDialogadMyvUU(), $composer3, 6);
                        Modifier modifierM532sizeInqDBjuR0$default = SizeKt.m532sizeInqDBjuR0$default(modifier4, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
                        ...
                        Modifier modifier$iv = modifierM532sizeInqDBjuR0$default.then(SemanticsModifierKt.semantics$default(companion, false, (Function1) value$iv$iv, 1, null));
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);

...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m2594rememberSaveable(new Object[0], (Saver) SwipeableState.INSTANCE.Saver(animationSpec, function1), (String) null, (Function0) new Function0<SwipeableState<T>>() { // from class: androidx.compose.material3.SwipeableKt.rememberSwipeableState.2
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T value, final Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        EffectsKt.LaunchedEffect(value, forceAnimationCheck.getValue(), new C04291(value, swipeableState, null), $composer, ($changed & 8) | 512 | ($changed & 14));
    ...
    public static final <T> Modifier m1804swipeablepPrIpRY(Modifier swipeable, final SwipeableState<T> state, final Map<Float, ? extends T> anchors, final Orientation orientation, final boolean enabled, final boolean reverseDirection, final MutableInteractionSource interactionSource, final Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, final ResistanceConfig resistance, final float velocityThreshold) {
        ...
        return ComposedModifierKt.composed(swipeable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1169892884, $changed, -1, "androidx.compose.material3.swipeable.<anonymous> (Swipeable.kt:581)");
                }
                if (!(!anchors.isEmpty())) {
                ...
                $composer.endReplaceableGroup();
                Modifier modifierDraggable = DraggableKt.draggable(companion2, draggableState, orientation2, (188 & 4) != 0 ? true : z, (188 & 8) != 0 ? null : mutableInteractionSource, (188 & 16) != 0 ? false : zIsAnimationRunning, (188 & 32) != 0 ? new DraggableKt.C01831(null) : null, (188 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : (Function3) value$iv$iv, (188 & 128) != 0 ? false : reverseDirection);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.$state.setVelocityThreshold$material3_release($this$invokeSuspend_u24lambda_u240.mo326toPx0680j_4(this.$velocityThreshold));
                            this.label = 1;
    ...
    static final class C04291 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04291(T t, SwipeableState<T> swipeableState, Continuation<? super C04291> continuation) {
            super(2, continuation);
            this.$value = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04291(this.$value, this.$swipeableState, continuation);
        }

...
public final class SliderColors {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SliderColors) && Color.m2948equalsimpl0(this.thumbColor, ((SliderColors) other).thumbColor) && Color.m2948equalsimpl0(this.activeTrackColor, ((SliderColors) other).activeTrackColor) && Color.m2948equalsimpl0(this.activeTickColor, ((SliderColors) other).activeTickColor) && Color.m2948equalsimpl0(this.inactiveTrackColor, ((SliderColors) other).inactiveTrackColor) && Color.m2948equalsimpl0(this.inactiveTickColor, ((SliderColors) other).inactiveTickColor) && Color.m2948equalsimpl0(this.disabledThumbColor, ((SliderColors) other).disabledThumbColor) && Color.m2948equalsimpl0(this.disabledActiveTrackColor, ((SliderColors) other).disabledActiveTrackColor) && Color.m2948equalsimpl0(this.disabledActiveTickColor, ((SliderColors) other).disabledActiveTickColor) && Color.m2948equalsimpl0(this.disabledInactiveTrackColor, ((SliderColors) other).disabledInactiveTrackColor) && Color.m2948equalsimpl0(this.disabledInactiveTickColor, ((SliderColors) other).disabledInactiveTickColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.activeTrackColor)) * 31) + Color.m2954hashCodeimpl(this.activeTickColor)) * 31) + Color.m2954hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m2954hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m2954hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m2954hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m2954hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m2954hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m2954hashCodeimpl(this.disabledInactiveTickColor);
    }
}

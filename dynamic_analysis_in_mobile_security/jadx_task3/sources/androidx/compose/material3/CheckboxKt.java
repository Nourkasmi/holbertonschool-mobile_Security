...
public final class CheckboxKt {
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    colors2 = CheckboxDefaults.INSTANCE.m1338colors5tl4gsc(0L, 0L, 0L, 0L, 0L, 0L, $composer2, 1572864, 63);
                }
                if (i5 != 0) {
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                ...
                int iM4564getCheckboxo7Vup1c = Role.INSTANCE.m4564getCheckboxo7Vup1c();
                float arg0$iv = CheckboxTokens.INSTANCE.m2025getStateLayerSizeD9Ej5fM();
                $dirty2 = $dirty;
                companionM713triStateToggleableO2vRcR0 = ToggleableKt.m713triStateToggleableO2vRcR0(companion, state, interactionSource2, RippleKt.m1284rememberRipple9IZ8Weo(false, Dp.m5212constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4), enabled2, Role.m4556boximpl(iM4564getCheckboxo7Vup1c), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m481padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors3, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.CheckboxKt.TriStateCheckbox.2
            ...
            public final void invoke(Composer composer, int i6) {
                CheckboxKt.TriStateCheckbox(state, function0, modifier5, z2, checkboxColors2, mutableInteractionSource, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    final State<Color> stateCheckmarkColor$material3_release = colors.checkmarkColor$material3_release(value, $composer2, (($dirty2 >> 3) & 14) | (($dirty2 >> 6) & 112));
                    final State<Color> stateBoxColor$material3_release = colors.boxColor$material3_release(enabled, value, $composer2, ($dirty2 & 14) | ($dirty2 & 112) | (($dirty2 >> 3) & 896));
                    final State<Color> stateBorderColor$material3_release = colors.borderColor$material3_release(enabled, value, $composer2, ($dirty2 & 14) | ($dirty2 & 112) | (($dirty2 >> 3) & 896));
                    ...
                    Object[] keys$iv = {stateBoxColor$material3_release, stateBorderColor$material3_release, stateCheckmarkColor$material3_release, checkDrawFraction, checkCenterGravitationShiftFraction, checkCache};
                    ...
                    if (invalid$iv || value$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                CheckboxKt.m1341drawBox1wkBAMs(Canvas, stateBoxColor$material3_release.getValue().m2957unboximpl(), stateBorderColor$material3_release.getValue().m2957unboximpl(), Canvas.mo326toPx0680j_4(CheckboxKt.RadiusSize), strokeWidthPx);
                                CheckboxKt.m1342drawCheck3IgeMak(Canvas, stateCheckmarkColor$material3_release.getValue().m2957unboximpl(), checkDrawFraction.getValue().floatValue(), checkCenterGravitationShiftFraction.getValue().floatValue(), strokeWidthPx, checkCache);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    }
    ...
    public static final void m1341drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
    ...
    public static final void m1342drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {

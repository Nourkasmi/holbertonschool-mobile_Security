...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape $this$top) {
        ...
        return CornerBasedShape.copy$default($this$top, null, null, CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), 3, null);
    }
    ...
    public static final CornerBasedShape bottom(CornerBasedShape $this$bottom) {
        ...
        return CornerBasedShape.copy$default($this$bottom, CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape $this$start) {
        Intrinsics.checkNotNullParameter($this$start, "<this>");
        return CornerBasedShape.copy$default($this$start, null, CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape $this$end) {
        Intrinsics.checkNotNullParameter($this$end, "<this>");
        return CornerBasedShape.copy$default($this$end, CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), null, null, CornerSizeKt.m726CornerSize0680j_4(Dp.m5212constructorimpl((float) 0.0d)), 6, null);
    }
    ...
    public static final Shape toShape(ShapeKeyTokens $this$toShape, Composer $composer, int $changed) {
        ...
        Shape shapeFromToken = fromToken(MaterialTheme.INSTANCE.getShapes($composer, 6), $this$toShape);
        if (ComposerKt.isTraceInProgress()) {

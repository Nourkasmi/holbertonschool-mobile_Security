...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m5212constructorimpl(12);
    ...
    public static final void DropdownMenuContent(final MutableTransitionState<Boolean> expandedStates, final MutableState<TransformOrigin> transformOriginState, Modifier modifier, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            SurfaceKt.m1792SurfaceT9BRK9s(GraphicsLayerModifierKt.graphicsLayer(companion, (Function1) value$iv$iv), ShapesKt.toShape(MenuTokens.INSTANCE.getContainerShape(), $composer2, 6), ColorSchemeKt.fromToken(MaterialTheme.INSTANCE.getColorScheme($composer2, 6), MenuTokens.INSTANCE.getContainerColor()), 0L, MenuTokens.INSTANCE.m2277getContainerElevationD9Ej5fM(), MenuTokens.INSTANCE.m2277getContainerElevationD9Ej5fM(), null, ComposableLambdaKt.composableLambda($composer2, -1651673913, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt.DropdownMenuContent.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer3, int $changed6) {
                    ...
                    if (($changed6 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifier$iv = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m483paddingVpY3zN4$default(modifier6, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), ScrollKt.rememberScrollState(0, $composer3, 0, 1), false, null, false, 14, null);
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> text, final Function0<Unit> onClick, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final boolean enabled, final MenuItemColors colors, final PaddingValues contentPadding, final MutableInteractionSource interactionSource, Composer $composer, final int $changed) {
        ...
        if ((191739611 & $dirty2) != 38347922 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            Modifier modifier$iv = PaddingKt.padding(SizeKt.m532sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m190clickableO2vRcR0(modifier, interactionSource, RippleKt.m1284rememberRipple9IZ8Weo(true, 0.0f, 0L, $composer3, 6, 6), (24 & 4) != 0 ? true : enabled, (24 & 8) != 0 ? null : null, (24 & 16) != 0 ? null : null, onClick), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuTokens.INSTANCE.m2278getListItemContainerHeightD9Ej5fM(), DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), contentPadding);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda($composer4, 2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer $composer5, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                        ...
                                        Modifier modifier$iv2 = SizeKt.m513defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m2279getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr2, ComposableLambdaKt.composableLambda($composer4, -1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer $composer5, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                    ...
                                    if (function24 != null) {
                                        fM5212constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        fM5212constructorimpl = Dp.m5212constructorimpl(0);
                                    }
                                    if (function25 != null) {
                                        fM5212constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        fM5212constructorimpl2 = Dp.m5212constructorimpl(0);
                                    }
                                    Modifier modifier$iv2 = PaddingKt.m485paddingqDBjuR0$default(modifierWeight$default, fM5212constructorimpl, 0.0f, fM5212constructorimpl2, 0.0f, 10, null);
                            ...
                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr3, ComposableLambdaKt.composableLambda($composer4, 580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer $composer5, int $changed3) {
                                    ...
                                    if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                        ...
                                        Modifier modifier$iv2 = SizeKt.m513defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, MenuTokens.INSTANCE.m2280getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);

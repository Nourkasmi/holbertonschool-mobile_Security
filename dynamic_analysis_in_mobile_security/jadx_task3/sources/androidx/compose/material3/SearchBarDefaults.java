...
public final class SearchBarDefaults {
    ...
    private static final float Elevation = SearchBarTokens.INSTANCE.m2420getContainerElevationD9Ej5fM();
    private static final float InputFieldHeight = SearchBarTokens.INSTANCE.m2421getContainerHeightD9Ej5fM();

    private SearchBarDefaults() {
    }

    /* JADX INFO: renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m1681getElevationD9Ej5fM() {
        return Elevation;
    }

    /* JADX INFO: renamed from: getInputFieldHeight-D9Ej5fM, reason: not valid java name */
    public final float m1682getInputFieldHeightD9Ej5fM() {
    ...
    public final SearchBarColors m1680colorsKlgxPg(long containerColor, long dividerColor, TextFieldColors inputFieldColors, Composer $composer, int $changed, int i) {
        ...
        TextFieldColors inputFieldColors2 = (i & 4) != 0 ? m1684inputFieldColorsITpI4ow(0L, 0L, 0L, 0L, null, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, $composer, 0, ($changed << 3) & 57344, 16383) : inputFieldColors;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TextFieldColors m1684inputFieldColorsITpI4ow(long focusedTextColor, long unfocusedTextColor, long disabledTextColor, long cursorColor, SelectionColors selectionColors, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long focusedPlaceholderColor, long unfocusedPlaceholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i & 8192) != 0) {
            ...
            disabledPlaceholderColor2 = Color.m2945copywmQWz5c(color4, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color4) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(color4) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color4) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color4) : 0.0f);
        } else {
    ...
    public final /* synthetic */ TextFieldColors m1683inputFieldColorsuKgnY(long textColor, long disabledTextColor, long cursorColor, SelectionColors selectionColors, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int i) {
        long disabledTextColor2;
        SelectionColors selectionColors2;
        long disabledLeadingIconColor2;
        long disabledTrailingIconColor2;

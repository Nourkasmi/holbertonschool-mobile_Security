...
public final class ButtonColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.containerColor : this.disabledContainerColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonColors) && Color.m2948equalsimpl0(this.containerColor, ((ButtonColors) other).containerColor) && Color.m2948equalsimpl0(this.contentColor, ((ButtonColors) other).contentColor) && Color.m2948equalsimpl0(this.disabledContainerColor, ((ButtonColors) other).disabledContainerColor) && Color.m2948equalsimpl0(this.disabledContentColor, ((ButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m2954hashCodeimpl(this.contentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2954hashCodeimpl(this.disabledContentColor);
    }
}

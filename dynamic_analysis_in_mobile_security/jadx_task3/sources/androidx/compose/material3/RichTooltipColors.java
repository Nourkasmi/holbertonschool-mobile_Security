...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof RichTooltipColors) && Color.m2948equalsimpl0(this.containerColor, ((RichTooltipColors) other).containerColor) && Color.m2948equalsimpl0(this.contentColor, ((RichTooltipColors) other).contentColor) && Color.m2948equalsimpl0(this.titleContentColor, ((RichTooltipColors) other).titleContentColor) && Color.m2948equalsimpl0(this.actionContentColor, ((RichTooltipColors) other).actionContentColor);
    }

    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.containerColor);
        return (((((result * 31) + Color.m2954hashCodeimpl(this.contentColor)) * 31) + Color.m2954hashCodeimpl(this.titleContentColor)) * 31) + Color.m2954hashCodeimpl(this.actionContentColor);
    }
}

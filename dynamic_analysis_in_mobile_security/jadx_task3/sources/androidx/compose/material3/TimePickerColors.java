...
public final class TimePickerColors {
    ...
    /* JADX INFO: renamed from: getClockDialColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    public final long getClockDialColor() {
        return this.clockDialColor;
    }

    /* JADX INFO: renamed from: getSelectorColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    ...
    /* JADX INFO: renamed from: getPeriodSelectorBorderColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    ...
    public final long m1878periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1879periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1880timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1881timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1873clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2948equalsimpl0(this.clockDialColor, ((TimePickerColors) other).clockDialColor) && Color.m2948equalsimpl0(this.selectorColor, ((TimePickerColors) other).selectorColor) && Color.m2948equalsimpl0(this.containerColor, ((TimePickerColors) other).containerColor) && Color.m2948equalsimpl0(this.periodSelectorBorderColor, ((TimePickerColors) other).periodSelectorBorderColor) && Color.m2948equalsimpl0(this.periodSelectorSelectedContainerColor, ((TimePickerColors) other).periodSelectorSelectedContainerColor) && Color.m2948equalsimpl0(this.periodSelectorUnselectedContainerColor, ((TimePickerColors) other).periodSelectorUnselectedContainerColor) && Color.m2948equalsimpl0(this.periodSelectorSelectedContentColor, ((TimePickerColors) other).periodSelectorSelectedContentColor) && Color.m2948equalsimpl0(this.periodSelectorUnselectedContentColor, ((TimePickerColors) other).periodSelectorUnselectedContentColor) && Color.m2948equalsimpl0(this.timeSelectorSelectedContainerColor, ((TimePickerColors) other).timeSelectorSelectedContainerColor) && Color.m2948equalsimpl0(this.timeSelectorUnselectedContainerColor, ((TimePickerColors) other).timeSelectorUnselectedContainerColor) && Color.m2948equalsimpl0(this.timeSelectorSelectedContentColor, ((TimePickerColors) other).timeSelectorSelectedContentColor) && Color.m2948equalsimpl0(this.timeSelectorUnselectedContentColor, ((TimePickerColors) other).timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.clockDialColor);
        return (((((((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.selectorColor)) * 31) + Color.m2954hashCodeimpl(this.containerColor)) * 31) + Color.m2954hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2954hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2954hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2954hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2954hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2954hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}

...
public final class DisplayMode {
    ...
    private static final int Picker = m1485constructorimpl(0);
    private static final int Input = m1485constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1484boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1492getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* JADX INFO: renamed from: getInput-jFl-4v0, reason: not valid java name */
        public final int m1491getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1489toStringimpl(int arg0) {
        return m1487equalsimpl0(arg0, Picker) ? "Picker" : m1487equalsimpl0(arg0, Input) ? "Input" : "Unknown";
    }

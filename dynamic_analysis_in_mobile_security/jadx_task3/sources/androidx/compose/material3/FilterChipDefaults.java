...
public final class FilterChipDefaults {
    ...
    public final SelectableChipColors m1527filterChipColorsXqyqHi0(long containerColor, long labelColor, long iconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i & 16) != 0) {
            long color = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), $composer, 6);
        ...
        if ((i & 32) != 0) {
            long color2 = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), $composer, 6);
        ...
        if ((i & 256) != 0) {
            long color3 = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor(), $composer, 6);
            disabledSelectedContainerColor2 = Color.m2945copywmQWz5c(color3, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color3) : 0.12f, (14 & 2) != 0 ? Color.m2953getRedimpl(color3) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color3) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color3) : 0.0f);
        } else {
    ...
    public final SelectableChipElevation m1528filterChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? FilterChipTokens.INSTANCE.m2242getFlatContainerElevationD9Ej5fM() : elevation;
        float pressedElevation2 = (i & 2) != 0 ? FilterChipTokens.INSTANCE.m2246getFlatSelectedPressedContainerElevationD9Ej5fM() : pressedElevation;
        float focusedElevation2 = (i & 4) != 0 ? FilterChipTokens.INSTANCE.m2243getFlatSelectedFocusContainerElevationD9Ej5fM() : focusedElevation;
        float hoveredElevation2 = (i & 8) != 0 ? FilterChipTokens.INSTANCE.m2244getFlatSelectedHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float draggedElevation2 = (i & 16) != 0 ? FilterChipTokens.INSTANCE.m2236getDraggedContainerElevationD9Ej5fM() : draggedElevation;
    ...
    public final SelectableChipBorder m1526filterChipBordergHcDVlo(long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        long selectedBorderColor2 = (i & 2) != 0 ? Color.INSTANCE.m2982getTransparent0d7_KjU() : selectedBorderColor;
        if ((i & 4) != 0) {
            long color = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), $composer, 6);
        ...
        long disabledSelectedBorderColor2 = (i & 8) != 0 ? Color.INSTANCE.m2982getTransparent0d7_KjU() : disabledSelectedBorderColor;
        float borderWidth2 = (i & 16) != 0 ? FilterChipTokens.INSTANCE.m2249getFlatUnselectedOutlineWidthD9Ej5fM() : borderWidth;
        float selectedBorderWidth2 = (i & 32) != 0 ? FilterChipTokens.INSTANCE.m2245getFlatSelectedOutlineWidthD9Ej5fM() : selectedBorderWidth;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipColors m1524elevatedFilterChipColorsXqyqHi0(long containerColor, long labelColor, long iconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        long iconColor2 = (i & 4) != 0 ? ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getLeadingIconUnselectedColor(), $composer, 6) : iconColor;
        if ((i & 8) != 0) {
            long color = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedDisabledContainerColor(), $composer, 6);
        ...
        if ((i & 16) != 0) {
            long color2 = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), $composer, 6);
        ...
        if ((i & 32) != 0) {
            long color3 = ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLeadingIconColor(), $composer, 6);
    ...
    public final SelectableChipElevation m1525elevatedFilterChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? FilterChipTokens.INSTANCE.m2237getElevatedContainerElevationD9Ej5fM() : elevation;
        float pressedElevation2 = (i & 2) != 0 ? FilterChipTokens.INSTANCE.m2241getElevatedPressedContainerElevationD9Ej5fM() : pressedElevation;
        float focusedElevation2 = (i & 4) != 0 ? FilterChipTokens.INSTANCE.m2239getElevatedFocusContainerElevationD9Ej5fM() : focusedElevation;
        float hoveredElevation2 = (i & 8) != 0 ? FilterChipTokens.INSTANCE.m2240getElevatedHoverContainerElevationD9Ej5fM() : hoveredElevation;
        float draggedElevation2 = (i & 16) != 0 ? FilterChipTokens.INSTANCE.m2236getDraggedContainerElevationD9Ej5fM() : draggedElevation;
        float disabledElevation2 = (i & 32) != 0 ? FilterChipTokens.INSTANCE.m2238getElevatedDisabledContainerElevationD9Ej5fM() : disabledElevation;
        if (ComposerKt.isTraceInProgress()) {

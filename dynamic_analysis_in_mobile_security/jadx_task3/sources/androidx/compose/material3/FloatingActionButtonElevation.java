...
public class FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof FloatingActionButtonElevation) && Dp.m5217equalsimpl0(this.defaultElevation, ((FloatingActionButtonElevation) other).defaultElevation) && Dp.m5217equalsimpl0(this.pressedElevation, ((FloatingActionButtonElevation) other).pressedElevation) && Dp.m5217equalsimpl0(this.focusedElevation, ((FloatingActionButtonElevation) other).focusedElevation) && Dp.m5217equalsimpl0(this.hoveredElevation, ((FloatingActionButtonElevation) other).hoveredElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Dp.m5218hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5218hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5218hashCodeimpl(this.hoveredElevation);
    }

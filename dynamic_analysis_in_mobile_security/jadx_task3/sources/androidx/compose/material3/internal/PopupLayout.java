...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(Function0<Unit> function0, String testTag, View composeView, Density density, PopupPositionProvider initialPositionProvider, UUID popupId) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material3.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m1997getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        float fM5212constructorimpl = Dp.m5212constructorimpl(8);
        this.maxSupportedElevation = fM5212constructorimpl;
        ...
        this.dismissOnOutsideClick = new Function2<Offset, IntRect, Boolean>() { // from class: androidx.compose.material3.internal.PopupLayout$dismissOnOutsideClick$1
            ...
            public final Boolean invoke(Offset offset, IntRect bounds) {
                ...
                boolean z = false;
                if (offset != null && (Offset.m2708getXimpl(offset.getPackedValue()) < bounds.getLeft() || Offset.m2708getXimpl(offset.getPackedValue()) > bounds.getRight() || Offset.m2709getYimpl(offset.getPackedValue()) < bounds.getTop() || Offset.m2709getYimpl(offset.getPackedValue()) > bounds.getBottom())) {
                    z = true;
                }
        ...
        setElevation(density.mo326toPx0680j_4(fM5212constructorimpl));
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopupKt.INSTANCE.m1995getLambda1$material3_release(), null, 2, null);
    }
    ...
    public final IntSize m1997getPopupContentSizebOM6tXw() {
        State $this$getValue$iv = this.popupContentSize;
        return (IntSize) $this$getValue$iv.getValue();
    }

    /* JADX INFO: renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m1998setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize intSizeM1997getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM1997getPopupContentSizebOM6tXw = m1997getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long popupContentSize = intSizeM1997getPopupContentSizebOM6tXw.getPackedValue();
        ...
        long popupPosition = this.positionProvider.mo875calculatePositionllwVHH4(parentBounds, windowSize, this.parentLayoutDirection, popupContentSize);
        this.params.x = IntOffset.m5330getXimpl(popupPosition);
        this.params.y = IntOffset.m5331getYimpl(popupPosition);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        L67:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m2697boximpl(r6)
        L83:

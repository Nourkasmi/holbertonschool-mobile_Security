...
public final class ModalBottomSheet_androidKt {
    ...
    public static final void m1598ModalBottomSheetEP0qOeE(final Function0<Unit> onDismissRequest, Modifier modifier, SheetState sheetState, Shape shape, long containerColor, long contentColor, float tonalElevation, long scrimColor, Function2<? super Composer, ? super Integer, Unit> function2, WindowInsets windowInsets, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((1533916891 & $dirty5) == 306783378 && ($dirty12 & 11) == 2 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    contentColor2 = ColorSchemeKt.m1412contentColorForek8zF_U(containerColor2, $composer2, ($dirty5 >> 12) & 14);
                    $dirty5 &= -458753;
                } else {
                    contentColor2 = contentColor;
                }
                float tonalElevation4 = i5 != 0 ? BottomSheetDefaults.INSTANCE.m1311getElevationD9Ej5fM() : tonalElevation2;
                if ((i & 128) != 0) {
                ...
                Function2<? super Composer, ? super Integer, Unit> function2M1435getLambda1$material3_release = i7 != 0 ? ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m1435getLambda1$material3_release() : function2;
                if ((i & 512) != 0) {
                    ...
                    function22 = function2M1435getLambda1$material3_release;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$4
            ...
            public final void invoke(Composer composer, int i11) {
                ModalBottomSheet_androidKt.m1598ModalBottomSheetEP0qOeE(onDismissRequest, modifier6, sheetState6, shape7, j4, j5, f2, j6, function25, windowInsets5, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final /* synthetic */ void m1599ModalBottomSheetxOkiWaM(final kotlin.jvm.functions.Function0 r33, androidx.compose.ui.Modifier r34, androidx.compose.material3.SheetState r35, androidx.compose.ui.graphics.Shape r36, long r37, long r39, float r41, long r42, kotlin.jvm.functions.Function2 r44, final kotlin.jvm.functions.Function3 r45, androidx.compose.runtime.Composer r46, final int r47, final int r48) {
        /*
            Method dump skipped, instruction units count: 764
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ModalBottomSheet_androidKt.m1599ModalBottomSheetxOkiWaM(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, androidx.compose.material3.SheetState, androidx.compose.ui.graphics.Shape, long, long, float, long, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1600Scrim3JVO9M(final long color, final Function0<Unit> function0, final boolean visible, Composer $composer, final int $changed) {
            ...
            if (color != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                ...
                value$iv$iv2 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$Scrim$1$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        DrawScope.m3484drawRectnJ9OG0$default(Canvas, color, 0L, 0L, ModalBottomSheet_androidKt.Scrim_3J_VO9M$lambda$2(stateAnimateFloatAsState), null, null, 0, 118, null);
                    }
                };
                $composer2.updateRememberedValue(value$iv$iv2);
                $composer2.endReplaceableGroup();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$Scrim$2
            ...
            public final void invoke(Composer composer, int i3) {
                ModalBottomSheet_androidKt.m1600Scrim3JVO9M(color, function0, visible, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final Modifier modalBottomSheetSwipeable(Modifier $this$modalBottomSheetSwipeable, final SheetState sheetState, AnchorChangeHandler<SheetValue> anchorChangeHandler, final float screenHeight, Function2<? super CoroutineScope, ? super Float, Unit> function2) {
        return SwipeableV2Kt.swipeAnchors(DraggableKt.draggable($this$modalBottomSheetSwipeable, sheetState.getSwipeableState$material3_release().getSwipeDraggableState(), Orientation.Vertical, (188 & 4) != 0 ? true : sheetState.isVisible(), (188 & 8) != 0 ? null : null, (188 & 16) != 0 ? false : sheetState.getSwipeableState$material3_release().isAnimationRunning(), (188 & 32) != 0 ? new DraggableKt.C01831(null) : null, (188 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : new C03951(function2), (188 & 128) != 0 ? false : false), sheetState.getSwipeableState$material3_release(), SetsKt.setOf((Object[]) new SheetValue[]{SheetValue.Hidden, SheetValue.PartiallyExpanded, SheetValue.Expanded}), anchorChangeHandler, new Function2<SheetValue, IntSize, Float>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt.modalBottomSheetSwipeable.2
            ...
            public /* bridge */ /* synthetic */ Float invoke(SheetValue sheetValue, IntSize intSize) {
                return m1604invokeO0kMr_c(sheetValue, intSize.getPackedValue());
            }

            /* JADX INFO: renamed from: invoke-O0kMr_c, reason: not valid java name */
            public final Float m1604invokeO0kMr_c(SheetValue value, long sheetSize) {
                Intrinsics.checkNotNullParameter(value, "value");
                switch (WhenMappings.$EnumSwitchMapping$0[value.ordinal()]) {
                    case 1:
                        return Float.valueOf(screenHeight);
                    case 2:
                        if (IntSize.m5371getHeightimpl(sheetSize) >= screenHeight / 2 && !sheetState.getSkipPartiallyExpanded()) {
                            return Float.valueOf(screenHeight / 2.0f);
                        }
                        return null;
                    case 3:
                        if (IntSize.m5371getHeightimpl(sheetSize) != 0) {
                            return Float.valueOf(Math.max(0.0f, screenHeight - IntSize.m5371getHeightimpl(sheetSize)));
                        }
                        return null;
                    default:
    ...
    /* JADX INFO: compiled from: ModalBottomSheet.android.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* synthetic */ class C03951 extends FunctionReferenceImpl implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object>, SuspendFunction {
        C03951(Object obj) {
    ...
    public static final void ModalBottomSheetPopup(final Function0<Unit> onDismissRequest, final WindowInsets windowInsets, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            UUID id = (UUID) RememberSaveableKt.m2594rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheetPopup$id$1
                @Override // kotlin.jvm.functions.Function0

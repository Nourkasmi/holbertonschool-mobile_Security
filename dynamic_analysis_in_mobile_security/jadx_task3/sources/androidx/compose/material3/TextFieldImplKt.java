...
public final class TextFieldImplKt {
    ...
    private static final float SupportingTopPadding = Dp.m5212constructorimpl(4);
    private static final float PrefixSuffixTextPadding = Dp.m5212constructorimpl(2);
    private static final float MinTextLineHeight = Dp.m5212constructorimpl(24);
    private static final float MinFocusedLabelLineHeight = Dp.m5212constructorimpl(16);
    private static final float MinSupportingTextLineHeight = Dp.m5212constructorimpl(16);
    ...
    /* JADX WARN: Removed duplicated region for block: B:281:0x04be  */
    ...
    */
    ...
    public static final void m1860DecorationKTwxG1Y(final long contentColor, TextStyle typography, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        TextStyle textStyle;
            ...
            Function2 contentWithColor = ComposableLambdaKt.composableLambda($composer2, 1449369305, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldImplKt$Decoration$contentWithColor$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor))}, content, $composer3, (($dirty2 >> 3) & 112) | 8);
                        if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldImplKt$Decoration$1
            ...
            public final void invoke(Composer composer, int i3) {
                TextFieldImplKt.m1860DecorationKTwxG1Y(contentColor, textStyle2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m7034debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m6989toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m6989toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    static final class C06542<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06542(long j, Flow<? extends T> flow, Continuation<? super C06542> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C06542 c06542 = new C06542(this.$periodMillis, this.$this_sample, continuation);
            c06542.L$0 = coroutineScope;
            c06542.L$1 = flowCollector;
            return c06542.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c06542 = this;
                    CoroutineScope $this$scopedFlow = (CoroutineScope) c06542.L$0;
                    FlowCollector downstream2 = (FlowCollector) c06542.L$1;
                    ReceiveChannel values2 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(c06542.$this_sample, null), 1, null);
                    Ref.ObjectRef lastValue2 = new Ref.ObjectRef();
                    ticker = FlowKt__DelayKt.fixedPeriodTicker$default($this$scopedFlow, c06542.$periodMillis, 0L, 2, null);
                ...
                case 1:
                    c06542 = this;
                    ticker = (ReceiveChannel) c06542.L$3;
                    lastValue = (Ref.ObjectRef) c06542.L$2;
                    values = (ReceiveChannel) c06542.L$1;
                    downstream = (FlowCollector) c06542.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
            ...
            while (lastValue.element != NullSurrogateKt.DONE) {
                SelectImplementation $this$select_u24lambda_u241$iv = new SelectImplementation(c06542.get$context());
                ...
                c06542.L$0 = downstream;
                c06542.L$1 = values;
                c06542.L$2 = lastValue;
                c06542.L$3 = ticker;
                c06542.label = 1;
                if ($this$select_u24lambda_u241$iv.doSelect(c06542) == coroutine_suspended) {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new C06542(periodMillis, flow, null));
        }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return ProduceKt.produce$default($this$fixedPeriodTicker, null, 0, new C06533(initialDelayMillis, delayMillis, null), 1, null);
    }
    ...
    static final class C06533 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06533(long j, long j2, Continuation<? super C06533> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06533 c06533 = new C06533(this.$initialDelayMillis, this.$delayMillis, continuation);
            c06533.L$0 = obj;
            return c06533;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C06533) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L6c:
                goto L46
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C06533.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* JADX INFO: renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m7035sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m6989toDelayMillisLRDsOJo(period));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m7036timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m7037timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m7037timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {

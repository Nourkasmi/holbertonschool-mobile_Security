...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM5499constructorimpl = Result.m5499constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5505isFailureimpl(objM5499constructorimpl) ? null : objM5499constructorimpl);

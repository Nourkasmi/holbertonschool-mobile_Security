...
public interface SendChannel<E> {
    ...
    Object mo7001trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo7001trySendJP2dKIU(e);
            if (ChannelResult.m7021isSuccessimpl(result)) {
                return true;
            }
            Throwable thM7015exceptionOrNullimpl = ChannelResult.m7015exceptionOrNullimpl(result);

...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo7005receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m7003receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    */
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(exception$iv)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo7001trySendJP2dKIU(E element) {
            ...
            while (true) {
                ...
                if (segment$iv3.id != id$iv) {
                    ...
                    if (segment$iv4 != null) {
                        ...
                        return ChannelResult.INSTANCE.m7024closedJP2dKIU(getSendException());
                    }
                } else {
                ...
                switch (updateCellSend(segment$iv, i$iv, element, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                    case 0:
                        ...
                        return ChannelResult.INSTANCE.m7026successJP2dKIU(Unit.INSTANCE);
                    case 1:
                        return ChannelResult.INSTANCE.m7026successJP2dKIU(Unit.INSTANCE);
                    case 2:
                        if (closed$iv) {
                        ...
                        segm.onSlotCleaned();
                        return ChannelResult.INSTANCE.m7025failurePtdJZtk();
                    case 3:
        ...
        while (true) {
            ...
            if (segment$iv2.id != id$iv) {
                ...
                if (segment$iv3 != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m5499constructorimpl(Boxing.boxBoolean(false)));
                } else {
            ...
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                case 0:
                    ...
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m5499constructorimpl(Boxing.boxBoolean(true)));
                    break;
                case 1:
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM7011boximpl = ChannelResult.m7011boximpl(ChannelResult.INSTANCE.m7026successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM7011boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
        }
                    ...
                    try {
                        if (updCellResult$iv != BufferedChannelKt.FAILED) {
                            ...
                            while (!isClosedForReceive()) {
                                ...
                                try {
                                    int i$iv$iv2 = (int) (r$iv$iv % ((long) BufferedChannelKt.SEGMENT_SIZE));
                                    int i2 = i;
                                    ...
                                    Object updCellResult$iv$iv = updateCellReceive(segment$iv$iv, i$iv$iv2, r$iv$iv, (Waiter) orCreateCancellableContinuation);
                                    if (updCellResult$iv$iv != BufferedChannelKt.SUSPEND) {
                                        if (updCellResult$iv$iv == BufferedChannelKt.FAILED) {
                                            ...
                                            segment$iv$iv.cleanPrev();
                                            Function1<E, Unit> function12 = this.onUndeliveredElement;
                                            orCreateCancellableContinuation.resume(updCellResult$iv$iv, function12 != null ? OnUndeliveredElementKt.bindCancellationFun(function12, updCellResult$iv$iv, orCreateCancellableContinuation.getContext()) : null);
                                        }
                                    } else {
                                        ?? r7 = ((Waiter) orCreateCancellableContinuation) instanceof Waiter ? (Waiter) orCreateCancellableContinuation : null;
                                        if (r7 != 0) {
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static /* synthetic */ <E> java.lang.Object m7003receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r17, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r18) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 240
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m7003receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m7004receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r28, int r29, long r30, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r32) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 444
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m7004receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m5499constructorimpl(ChannelResult.m7011boximpl(ChannelResult.INSTANCE.m7024closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo7006tryReceivePtdJZtk() {
        ChannelSegment segment$iv;
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m7024closedJP2dKIU(getCloseCause());
        }
        long $this$sendersCounter$iv = sendersAndCloseStatusCur & 1152921504606846975L;
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != BufferedChannelKt.SUSPEND) {
                if (updCellResult$iv != BufferedChannelKt.FAILED) {
                    ...
                    segment$iv4.cleanPrev();
                    return ChannelResult.INSTANCE.m7026successJP2dKIU(updCellResult$iv);
                }
    ...
    private final void expandBuffer() {
        ...
        while (true) {
            ...
            long id2 = b / ((long) BufferedChannelKt.SEGMENT_SIZE);
            long s = getSendersCounter$kotlinx_coroutines_core();
            if (s <= b) {
                if (channelSegment.id < id2 && channelSegment.getNext() != 0) {
                    moveSegmentBufferEndToSpecifiedOrLast(id2, channelSegment);
                }
            ...
            if (channelSegment.id != id2) {
                id = 0;
                ChannelSegment<E> channelSegmentFindSegmentBufferEnd = findSegmentBufferEnd(id2, channelSegment, b);
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m7011boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m7024closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m7026successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
                            ...
                            if (updCellResult$iv != BufferedChannelKt.FAILED) {
                                ...
                                while (!bufferedChannel.isClosedForReceive()) {
                                    ...
                                    try {
                                        ...
                                        Object updCellResult$iv$iv = bufferedChannel.updateCellReceive(segment$iv$iv, i$iv$iv2, r$iv$iv, this);
                                        if (updCellResult$iv$iv != BufferedChannelKt.SUSPEND) {
                                            if (updCellResult$iv$iv == BufferedChannelKt.FAILED) {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m5499constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
        }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Object suspendedReceivers = InlineList.m7047constructorimpl$default(null, 1, null);
            ...
            for (int index = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < index; index--) {
                ...
                while (true) {
                    ...
                    if (state == null || state == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (channelSegment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m7052plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                        ...
                        if (channelSegment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            suspendedReceivers = InlineList.m7052plusFjFbRPM(suspendedReceivers, state);
                            channelSegment.onCancelledRequest(index, true);
                            break;
                        }
                    }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m5499constructorimpl(ChannelResult.m7011boximpl(ChannelResult.INSTANCE.m7024closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
        CancellableContinuation<Boolean> cont = ((SendBroadcast) $this$resumeWaiterOnClosedChannel).getCont();
        Result.Companion companion3 = Result.INSTANCE;
        cont.resumeWith(Result.m5499constructorimpl(false));
    }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        while (true) {
            ...
            if (SegmentOrClosed.m7064isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m7062getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m7062getSegmentimpl(s$iv);
        if (channelSegment.id > id) {
    ...
    public final ChannelSegment<E> findSegmentReceive(long id, ChannelSegment<E> startFrom) {
        ...
        Object it = s$iv;
        if (SegmentOrClosed.m7064isClosedimpl(it)) {
            completeCloseOrCancel();
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m7062getSegmentimpl(it);

...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m7029trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m7015exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m7029trySendImplMj0NB7M(e, true);
    ...
    public Object mo7001trySendJP2dKIU(E element) {
        return m7029trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m7029trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m7027trySendDropLatestMj0NB7M(element, isSendOp) : m7028trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m7027trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo7001trySendJP2dKIU(element);
        if (ChannelResult.m7021isSuccessimpl(result) || ChannelResult.m7019isClosedimpl(result)) {
            return result;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0099, code lost:
        ...
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m7024closedJP2dKIU(getSendException());
     */
    ...
    */
    private final java.lang.Object m7028trySendDropOldestJP2dKIU(E r21) {
        /*
            Method dump skipped, instruction units count: 260
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.ConflatedBufferedChannel.m7028trySendDropOldestJP2dKIU(java.lang.Object):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.BufferedChannel
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object it = mo7001trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m7015exceptionOrNullimpl(it);

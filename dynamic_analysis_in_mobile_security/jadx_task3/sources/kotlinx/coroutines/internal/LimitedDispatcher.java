...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo7057scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo7057scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    public void mo7056dispatch(CoroutineContext context, Runnable block) {
        Runnable task$iv;
        ...
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo7056dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo7056dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }

...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM5499constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM5499constructorimpl = Result.m5499constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m5505isFailureimpl(objM5499constructorimpl)) {
                objM5499constructorimpl = null;
            }
            return (E) objM5499constructorimpl;
        }
        ...
        while (true) {
            ...
            switch (parameterTypes.length) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (Intrinsics.areEqual(parameterTypes[c2], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    objM5499constructorimpl = Result.m5499constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m5505isFailureimpl(objM5499constructorimpl) ? null : objM5499constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM5499constructorimpl = Result.m5499constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5505isFailureimpl(objM5499constructorimpl)) {
            objM5499constructorimpl = numValueOf;
        }
        return ((Number) objM5499constructorimpl).intValue();
    }

...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C05811<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C05811(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C05811> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05811 c05811 = new C05811(this.$this_ifEmpty, this.$defaultValue, continuation);
            c05811.L$0 = obj;
            return c05811;
        }
        ...
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C05811) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C05811(sequence, defaultValue, null));
    }
    ...
    static final class C05821<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05821(Sequence<? extends T> sequence, Random random, Continuation<? super C05821> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05821 c05821 = new C05821(this.$this_shuffled, this.$random, continuation);
            c05821.L$0 = obj;
            return c05821;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C05821) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c05821 = this;
                    sequenceScope = (SequenceScope) c05821.L$0;
                    mutableList = SequencesKt.toMutableList(c05821.$this_shuffled);
                    break;
                case 1:
                    c05821 = this;
                    mutableList = (List) c05821.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c05821.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c05821.$random.nextInt(mutableList.size());
                ...
                c05821.L$0 = sequenceScope;
                c05821.L$1 = mutableList;
                c05821.label = 1;
                if (sequenceScope.yield(objRemoveLast, c05821) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C05821(sequence, random, null));
    }
    ...
    static final class C05771<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05771(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C05771> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05771 c05771 = new C05771(this.$source, this.$transform, this.$iterator, continuation);
            c05771.L$0 = obj;
            return c05771;
        }
        ...
        public final Object invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C05771) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c05771 = this;
                    sequenceScope = (SequenceScope) c05771.L$0;
                    i = 0;
                    it = c05771.$source.iterator();
                    break;
                case 1:
                    c05771 = this;
                    i = c05771.I$0;
                    it = (Iterator) c05771.L$1;
                    sequenceScope = (SequenceScope) c05771.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c05771.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c05771.L$0 = sequenceScope;
                c05771.L$1 = it;
                c05771.I$0 = i2;
                c05771.label = 1;
                if (sequenceScope.yieldAll(c05771.$iterator.invoke((C) objInvoke), c05771) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C05771(source, transform, iterator, null));
    }

...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo6815minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m6819minusLRDsOJo(this, duration);
        }
        ...
        public ComparableTimeMark mo6817plusLRDsOJo(long duration) {
            DurationUnit unit = this.timeSource.getUnit();
            if (Duration.m6856isInfiniteimpl(duration)) {
                return new LongTimeMark(LongSaturatedMathKt.m6953saturatingAddNuflL3o(this.startedAt, unit, duration), this.timeSource, Duration.INSTANCE.m6927getZEROUwyO8pc(), null);
            }
            long durationInUnit = Duration.m6876truncateToUwyO8pc$kotlin_stdlib(duration, unit);
            long rest = Duration.m6860plusLRDsOJo(Duration.m6859minusLRDsOJo(duration, durationInUnit), this.offset);
            long sum = LongSaturatedMathKt.m6953saturatingAddNuflL3o(this.startedAt, unit, durationInUnit);
            long restInUnit = Duration.m6876truncateToUwyO8pc$kotlin_stdlib(rest, unit);
            long sum2 = LongSaturatedMathKt.m6953saturatingAddNuflL3o(sum, unit, restInUnit);
            long restUnderUnit = Duration.m6859minusLRDsOJo(rest, restInUnit);
            long restUnderUnitNs = Duration.m6844getInWholeNanosecondsimpl(restUnderUnit);
            if (sum2 != 0 && restUnderUnitNs != 0 && (sum2 ^ restUnderUnitNs) < 0) {
                ...
                sum2 = LongSaturatedMathKt.m6953saturatingAddNuflL3o(sum2, unit, correction);
                restUnderUnit = Duration.m6859minusLRDsOJo(restUnderUnit, correction);
            }
            long newValue = sum2;
            long newOffset = (((newValue - 1) | 1) > Long.MAX_VALUE ? 1 : (((newValue - 1) | 1) == Long.MAX_VALUE ? 0 : -1)) == 0 ? Duration.INSTANCE.m6927getZEROUwyO8pc() : restUnderUnit;
        ...
        public long mo6816minusUwyO8pc(ComparableTimeMark other) {
            ...
            return Duration.m6860plusLRDsOJo(startedAtDiff, Duration.m6859minusLRDsOJo(this.offset, ((LongTimeMark) other).offset));
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof LongTimeMark) && Intrinsics.areEqual(this.timeSource, ((LongTimeMark) other).timeSource) && Duration.m6829equalsimpl0(mo6816minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m6927getZEROUwyO8pc());
        }
        ...
        public String toString() {
            return "LongTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m6873toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new LongTimeMark(adjustedRead(), this, Duration.INSTANCE.m6927getZEROUwyO8pc(), null);
    }
}

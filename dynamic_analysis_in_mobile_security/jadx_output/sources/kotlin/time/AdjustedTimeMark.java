...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo6815minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m6961minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo6814elapsedNowUwyO8pc() {
        return Duration.m6859minusLRDsOJo(this.mark.mo6814elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo6817plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m6860plusLRDsOJo(this.adjustment, duration), null);
    }
}

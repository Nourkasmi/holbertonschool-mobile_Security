...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo6817plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m6860plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo6816minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m6829equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m6856isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m6927getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m6859minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m6829equalsimpl0(startedAtDiff, Duration.m6877unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m6927getZEROUwyO8pc() : Duration.m6860plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m6829equalsimpl0(mo6816minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m6927getZEROUwyO8pc());
        }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m6873toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m6927getZEROUwyO8pc(), null);
    }
}

...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C06551<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06551(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C06551> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        @Override // kotlin.jvm.functions.Function3
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C06551 c06551 = new C06551(this.$transform, continuation);
            c06551.L$0 = flowCollector;
            c06551.L$1 = t;
            return c06551.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L51:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__MergeKt.C06551.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C06551(function2, null));
    }
}

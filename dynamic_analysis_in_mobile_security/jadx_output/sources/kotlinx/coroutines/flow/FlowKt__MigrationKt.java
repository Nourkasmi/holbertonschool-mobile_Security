...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    static final class C06561<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06561(long j, Continuation<? super C06561> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06561(this.$timeMillis, continuation);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long timeMillis) {
        return FlowKt.onStart(flow, new C06561(timeMillis, null));
    }

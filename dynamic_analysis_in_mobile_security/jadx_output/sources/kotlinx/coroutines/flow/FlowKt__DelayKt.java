...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    static final class C06522<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06522(long j, Flow<? extends T> flow, Continuation<? super C06522> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C06522 c06522 = new C06522(this.$periodMillis, this.$this_sample, continuation);
            c06522.L$0 = coroutineScope;
            c06522.L$1 = flowCollector;
            return c06522.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c06522 = this;
                    CoroutineScope $this$scopedFlow = (CoroutineScope) c06522.L$0;
                    FlowCollector downstream2 = (FlowCollector) c06522.L$1;
                    ReceiveChannel values2 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(c06522.$this_sample, null), 1, null);
                    Ref.ObjectRef lastValue2 = new Ref.ObjectRef();
                    ticker = FlowKt__DelayKt.fixedPeriodTicker$default($this$scopedFlow, c06522.$periodMillis, 0L, 2, null);
                ...
                case 1:
                    c06522 = this;
                    ticker = (ReceiveChannel) c06522.L$3;
                    lastValue = (Ref.ObjectRef) c06522.L$2;
                    values = (ReceiveChannel) c06522.L$1;
                    downstream = (FlowCollector) c06522.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
            ...
            while (lastValue.element != NullSurrogateKt.DONE) {
                SelectImplementation $this$select_u24lambda_u241$iv = new SelectImplementation(c06522.get$context());
                ...
                c06522.L$0 = downstream;
                c06522.L$1 = values;
                c06522.L$2 = lastValue;
                c06522.L$3 = ticker;
                c06522.label = 1;
                if ($this$select_u24lambda_u241$iv.doSelect(c06522) == coroutine_suspended) {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new C06522(periodMillis, flow, null));
        }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return ProduceKt.produce$default($this$fixedPeriodTicker, null, 0, new C06513(initialDelayMillis, delayMillis, null), 1, null);
    }
    ...
    static final class C06513 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06513(long j, long j2, Continuation<? super C06513> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06513 c06513 = new C06513(this.$initialDelayMillis, this.$delayMillis, continuation);
            c06513.L$0 = obj;
            return c06513;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C06513) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L6c:
                goto L46
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C06513.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

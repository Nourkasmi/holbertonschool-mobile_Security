...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM5499constructorimpl2;
        ...
        try {
            ...
            objM5499constructorimpl = Result.m5499constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5502exceptionOrNullimpl(objM5499constructorimpl) == null) {
            obj2 = objM5499constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM5499constructorimpl2 = Result.m5499constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM5499constructorimpl2 = Result.m5499constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5502exceptionOrNullimpl(objM5499constructorimpl2) == null) {
            obj = objM5499constructorimpl2;
        }

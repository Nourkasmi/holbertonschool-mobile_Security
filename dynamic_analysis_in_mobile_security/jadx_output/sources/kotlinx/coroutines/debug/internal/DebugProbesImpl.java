...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM5499constructorimpl = Result.m5499constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
        ...
        return (Function1) objM5499constructorimpl;
    }
    ...
    private final void dumpCoroutinesSynchronized(PrintStream out) {
        ...
        for (Object element$iv : SequencesKt.sortedWith($this$sortedBy$iv, new Comparator() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$$inlined$sortedBy$1
            ...
            List<StackTraceElement> listEnhanceStackTraceWithThreadDumpImpl = debugProbesImpl.enhanceStackTraceWithThreadDumpImpl(info.get_state(), info.lastObservedThread, listLastObservedStackTrace$kotlinx_coroutines_core);
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM5499constructorimpl = Result.m5499constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) objM5499constructorimpl;
        if (actualTrace == null) {
            return coroutineTrace;
        }
        int index$iv = 0;

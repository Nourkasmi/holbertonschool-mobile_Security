...
public interface ReceiveChannel<E> {
    ...
    Object mo7005receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo7006tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo7006tryReceivePtdJZtk = receiveChannel.mo7006tryReceivePtdJZtk();
            if (ChannelResult.m7021isSuccessimpl(objMo7006tryReceivePtdJZtk)) {
                return (E) ChannelResult.m7017getOrThrowimpl(objMo7006tryReceivePtdJZtk);
            }
            Throwable thM7015exceptionOrNullimpl = ChannelResult.m7015exceptionOrNullimpl(objMo7006tryReceivePtdJZtk);
            if (thM7015exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM7015exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m7016getOrNullimpl(r3)
                return r3
            */

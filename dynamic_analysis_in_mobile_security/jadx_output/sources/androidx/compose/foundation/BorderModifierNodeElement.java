...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5217equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5218hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m5223toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("width", Dp.m5210boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            $this$inspectableProperties.getProperties().set("color", Color.m2937boximpl(((SolidColor) this.brush).getValue()));
            $this$inspectableProperties.setValue(Color.m2937boximpl(((SolidColor) this.brush).getValue()));
        } else {

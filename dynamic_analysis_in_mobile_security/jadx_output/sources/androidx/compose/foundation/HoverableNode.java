...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo143onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m4015equalsimpl0(type, PointerEventType.INSTANCE.m4019getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m4015equalsimpl0(type, PointerEventType.INSTANCE.m4020getExit7fucELk())) {
    ...
    */
    public final java.lang.Object emitExit(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r8 = this;
            boolean r0 = r9 instanceof androidx.compose.foundation.HoverableNode.C01681
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.foundation.HoverableNode$emitExit$1 r0 = (androidx.compose.foundation.HoverableNode.C01681) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14

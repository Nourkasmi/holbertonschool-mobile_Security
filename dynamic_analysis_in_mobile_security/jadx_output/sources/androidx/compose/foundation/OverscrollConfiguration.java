...
public final class OverscrollConfiguration {
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m476PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2948equalsimpl0(this.glowColor, ((OverscrollConfiguration) other).glowColor) && Intrinsics.areEqual(this.drawPadding, ((OverscrollConfiguration) other).drawPadding);
    }

    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.glowColor);
        return (result * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m2955toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}

...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfig) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.setColor(ColorKt.m3001toArgb8_81llA(this.overscrollConfig.getGlowColor()));
        }
        this.redrawSignal = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.INSTANCE.m2786getZeroNHjbRc();
        Function1<IntSize, Unit> function1 = new Function1<IntSize, Unit>() { // from class: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect$onNewSize$1
            ...
            public final void m156invokeozmzZPI(long size2) {
                boolean differentSize = !Size.m2773equalsimpl0(IntSizeKt.m5382toSizeozmzZPI(size2), this.this$0.containerSize);
                this.this$0.containerSize = IntSizeKt.m5382toSizeozmzZPI(size2);
                if (differentSize) {
                    this.this$0.topEffect.setSize(IntSize.m5372getWidthimpl(size2), IntSize.m5371getHeightimpl(size2));
                    this.this$0.bottomEffect.setSize(IntSize.m5372getWidthimpl(size2), IntSize.m5371getHeightimpl(size2));
                    this.this$0.leftEffect.setSize(IntSize.m5371getHeightimpl(size2), IntSize.m5372getWidthimpl(size2));
                    this.this$0.rightEffect.setSize(IntSize.m5371getHeightimpl(size2), IntSize.m5372getWidthimpl(size2));
                    this.this$0.topEffectNegation.setSize(IntSize.m5372getWidthimpl(size2), IntSize.m5371getHeightimpl(size2));
                    this.this$0.bottomEffectNegation.setSize(IntSize.m5372getWidthimpl(size2), IntSize.m5371getHeightimpl(size2));
                    this.this$0.leftEffectNegation.setSize(IntSize.m5371getHeightimpl(size2), IntSize.m5372getWidthimpl(size2));
                    this.this$0.rightEffectNegation.setSize(IntSize.m5371getHeightimpl(size2), IntSize.m5372getWidthimpl(size2));
                }
                if (differentSize) {
    ...
    public long mo155applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        ...
        if (Size.m2779isEmptyimpl(this.containerSize)) {
            return performScroll.invoke(Offset.m2697boximpl(delta)).getPackedValue();
        }
        ...
        long pointer = offset != null ? offset.getPackedValue() : SizeKt.m2787getCenteruvyYCjk(this.containerSize);
        float consumedPixelsX = 0.0f;
        if (Offset.m2709getYimpl(delta) == 0.0f) {
        ...
        if (!(Offset.m2708getXimpl(delta) == 0.0f)) {
        ...
        if (!Offset.m2705equalsimpl0(consumedOffset, Offset.INSTANCE.m2724getZeroF1C5BW0())) {
            invalidateOverscroll();
        }
        long leftForDelta = Offset.m2712minusMKHz9U(delta, consumedOffset);
        long consumedByDelta = performScroll.invoke(Offset.m2697boximpl(leftForDelta)).getPackedValue();
        long leftForOverscroll = Offset.m2712minusMKHz9U(leftForDelta, consumedByDelta);
        ...
        return Offset.m2713plusMKHz9U(consumedOffset, consumedByDelta);
    }
    ...
    */
    ...
    private final boolean stopOverscrollAnimation() {
        ...
        long fakeDisplacement = SizeKt.m2787getCenteruvyYCjk(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
            m150pullLeft0a9Yr6o(Offset.INSTANCE.m2724getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
            m151pullRight0a9Yr6o(Offset.INSTANCE.m2724getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
            m152pullTop0a9Yr6o(Offset.INSTANCE.m2724getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f)) {
            m149pullBottom0a9Yr6o(Offset.INSTANCE.m2724getZeroF1C5BW0(), fakeDisplacement);
            return true;
        }
        return stopped;
    }
    ...
    private final boolean drawLeft(DrawScope $this$drawLeft, EdgeEffect left, android.graphics.Canvas canvas) {
        ...
        canvas.translate(-Size.m2774getHeightimpl(this.containerSize), $this$drawLeft.mo326toPx0680j_4(this.overscrollConfig.getDrawPadding().mo432calculateLeftPaddingu2uoSUM($this$drawLeft.getLayoutDirection())));
    ...
    private final boolean drawTop(DrawScope $this$drawTop, EdgeEffect top, android.graphics.Canvas canvas) {
        int restore = canvas.save();
        canvas.translate(0.0f, $this$drawTop.mo326toPx0680j_4(this.overscrollConfig.getDrawPadding().getTop()));
    ...
    private final boolean drawRight(DrawScope $this$drawRight, EdgeEffect right, android.graphics.Canvas canvas) {
        int restore = canvas.save();
        int width = MathKt.roundToInt(Size.m2777getWidthimpl(this.containerSize));
        float rightPadding = this.overscrollConfig.getDrawPadding().mo433calculateRightPaddingu2uoSUM($this$drawRight.getLayoutDirection());
        canvas.rotate(90.0f);
        canvas.translate(0.0f, (-width) + $this$drawRight.mo326toPx0680j_4(rightPadding));
    ...
    private final boolean drawBottom(DrawScope $this$drawBottom, EdgeEffect bottom, android.graphics.Canvas canvas) {
        ...
        float bottomPadding = $this$drawBottom.mo326toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom());
        canvas.translate(-Size.m2777getWidthimpl(this.containerSize), (-Size.m2774getHeightimpl(this.containerSize)) + bottomPadding);
    ...
    private final boolean m153releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean needsInvalidation = false;
        if (!this.leftEffect.isFinished() && Offset.m2708getXimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.leftEffect, Offset.m2708getXimpl(delta));
            needsInvalidation = this.leftEffect.isFinished();
        }
        if (!this.rightEffect.isFinished() && Offset.m2708getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.rightEffect, Offset.m2708getXimpl(delta));
            needsInvalidation = needsInvalidation || this.rightEffect.isFinished();
        }
        if (!this.topEffect.isFinished() && Offset.m2709getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.topEffect, Offset.m2709getYimpl(delta));
            needsInvalidation = needsInvalidation || this.topEffect.isFinished();
        }
        if (!this.bottomEffect.isFinished() && Offset.m2709getYimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.bottomEffect, Offset.m2709getYimpl(delta));
    ...
    private final float m152pullTop0a9Yr6o(long scroll, long displacement) {
        float displacementX = Offset.m2708getXimpl(displacement) / Size.m2777getWidthimpl(this.containerSize);
        float pullY = Offset.m2709getYimpl(scroll) / Size.m2774getHeightimpl(this.containerSize);
        float consumed = EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.topEffect, pullY, displacementX) * Size.m2774getHeightimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
            return Offset.m2709getYimpl(scroll);
        }
        return consumed;
    }
    ...
    private final float m149pullBottom0a9Yr6o(long scroll, long displacement) {
        float displacementX = Offset.m2708getXimpl(displacement) / Size.m2777getWidthimpl(this.containerSize);
        float pullY = Offset.m2709getYimpl(scroll) / Size.m2774getHeightimpl(this.containerSize);
        float consumed = (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.bottomEffect, -pullY, 1 - displacementX)) * Size.m2774getHeightimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f)) {
            return Offset.m2709getYimpl(scroll);
        }
        return consumed;
    ...
    private final float m150pullLeft0a9Yr6o(long scroll, long displacement) {
        float displacementY = Offset.m2709getYimpl(displacement) / Size.m2774getHeightimpl(this.containerSize);
        float pullX = Offset.m2708getXimpl(scroll) / Size.m2777getWidthimpl(this.containerSize);
        float consumed = EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.leftEffect, pullX, 1 - displacementY) * Size.m2777getWidthimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
            return Offset.m2708getXimpl(scroll);
        }
        return consumed;
    }
    ...
    private final float m151pullRight0a9Yr6o(long scroll, long displacement) {
        float displacementY = Offset.m2709getYimpl(displacement) / Size.m2774getHeightimpl(this.containerSize);
        float pullX = Offset.m2708getXimpl(scroll) / Size.m2777getWidthimpl(this.containerSize);
        float consumed = (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.rightEffect, -pullX, displacementY)) * Size.m2777getWidthimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
            return Offset.m2708getXimpl(scroll);
        }
        return consumed;

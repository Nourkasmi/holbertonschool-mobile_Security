...
public final class ToggleableKt {
    ...
    public static /* synthetic */ Modifier m712toggleableXHw0xAI$default(Modifier modifier, boolean z, boolean z2, Role role, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        if ((i & 4) != 0) {
        ...
        return m711toggleableXHw0xAI(modifier, z, z2, role, function1);
    }

    /* JADX INFO: renamed from: toggleable-XHw0xAI, reason: not valid java name */
    public static final Modifier m711toggleableXHw0xAI(Modifier toggleable, final boolean value, final boolean enabled, final Role role, final Function1<? super Boolean, Unit> onValueChange) {
        ...
        return ComposedModifierKt.composed(toggleable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Modifier modifierM709toggleableO2vRcR0 = ToggleableKt.m709toggleableO2vRcR0(companion, z, (MutableInteractionSource) value$iv$iv, (Indication) objConsume, enabled, role, onValueChange);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return modifierM709toggleableO2vRcR0;
            }
        });
    }

    /* JADX INFO: renamed from: toggleable-O2vRcR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m710toggleableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function1 function1, int i, Object obj) {
        boolean z3;
        Role role2;
        if ((i & 8) == 0) {
            z3 = z2;
        ...
        return m709toggleableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role2, function1);
    }

    /* JADX INFO: renamed from: toggleable-O2vRcR0, reason: not valid java name */
    public static final Modifier m709toggleableO2vRcR0(Modifier toggleable, final boolean value, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function1<? super Boolean, Unit> onValueChange) {
        Intrinsics.checkNotNullParameter(toggleable, "$this$toggleable");
        ...
        Modifier.Companion companion = Modifier.INSTANCE;
        Modifier $this$toggleable_O2vRcR0_u24lambda_u242 = m713triStateToggleableO2vRcR0(Modifier.INSTANCE, ToggleableStateKt.ToggleableState(value), interactionSource, indication, enabled, role, new Function0<Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleable$4$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(0);
        ...
        return InspectableValueKt.inspectableWrapper(toggleable, noInspectorInfo, $this$toggleable_O2vRcR0_u24lambda_u242);
    }

    /* JADX INFO: renamed from: triStateToggleable-XHw0xAI$default, reason: not valid java name */
    public static /* synthetic */ Modifier m716triStateToggleableXHw0xAI$default(Modifier modifier, ToggleableState toggleableState, boolean z, Role role, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        if ((i & 4) != 0) {
        ...
        return m715triStateToggleableXHw0xAI(modifier, toggleableState, z, role, function0);
    }

    /* JADX INFO: renamed from: triStateToggleable-XHw0xAI, reason: not valid java name */
    public static final Modifier m715triStateToggleableXHw0xAI(Modifier triStateToggleable, final ToggleableState state, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(triStateToggleable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$triStateToggleable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Object objConsume = $composer.consume(localIndication);
                ComposerKt.sourceInformationMarkerEnd($composer);
                Modifier modifierM713triStateToggleableO2vRcR0 = ToggleableKt.m713triStateToggleableO2vRcR0(companion, toggleableState, (MutableInteractionSource) value$iv$iv, (Indication) objConsume, enabled, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return modifierM713triStateToggleableO2vRcR0;
            }
        });
    }

    /* JADX INFO: renamed from: triStateToggleable-O2vRcR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m714triStateToggleableO2vRcR0$default(Modifier modifier, ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z, Role role, Function0 function0, int i, Object obj) {
        boolean z2;
        Role role2;
        if ((i & 8) == 0) {
            z2 = z;
        ...
        return m713triStateToggleableO2vRcR0(modifier, toggleableState, mutableInteractionSource, indication, z2, role2, function0);
    }

    /* JADX INFO: renamed from: triStateToggleable-O2vRcR0, reason: not valid java name */
    public static final Modifier m713triStateToggleableO2vRcR0(Modifier triStateToggleable, final ToggleableState state, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(triStateToggleable, "$this$triStateToggleable");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        ...
        return InspectableValueKt.inspectableWrapper(triStateToggleable, noInspectorInfo, SemanticsModifierKt.semantics$default(ClickableKt.m190clickableO2vRcR0($this$triStateToggleable_O2vRcR0_u24lambda_u245, interactionSource, indication, (24 & 4) != 0 ? true : enabled, (24 & 8) != 0 ? null : null, (24 & 16) != 0 ? null : role, onClick), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$triStateToggleable$4$1
            {
                super(1);
            }

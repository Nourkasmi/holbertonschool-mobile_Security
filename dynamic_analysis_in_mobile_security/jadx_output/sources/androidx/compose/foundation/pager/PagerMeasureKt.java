...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m698measurePagerntgEbfI(final LazyLayoutMeasureScope measurePager, int pageCount, final PagerLazyLayoutItemProvider pagerItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenPages, int firstVisiblePage, int firstVisiblePageOffset, float scrollToBeConsumed, long constraints, final Orientation orientation, final Alignment.Vertical verticalAlignment, final Alignment.Horizontal horizontalAlignment, final boolean reverseLayout, final long visualPageOffset, final int pageAvailableSize, int beyondBoundsPageCount, List<Integer> pinnedPages, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (pageCount <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), 0, pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, -beforeContentPadding, mainAxisAvailableSize + afterContentPadding, false, 0.0f, null, null, 0, false, layout.invoke(Integer.valueOf(Constraints.m5170getMinWidthimpl(constraints)), Integer.valueOf(Constraints.m5169getMinHeightimpl(constraints)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$2
        ...
        final long childConstraints = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m5168getMaxWidthimpl(constraints) : pageAvailableSize, 0, orientation != Orientation.Vertical ? Constraints.m5167getMaxHeightimpl(constraints) : pageAvailableSize, 5, null);
        ...
        while (maxCrossAxis2 < 0 && currentFirstPage3 > 0) {
            ...
            MeasuredPage measuredPage = m697getAndMeasureSGf7dI0(measurePager, previous, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, measurePager.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        while (true) {
            ...
            MeasuredPage measuredPage2 = m697getAndMeasureSGf7dI0(measurePager, i3, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, measurePager.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        if (index < maxOffset7) {
            ...
            while (true) {
                ...
                MeasuredPage measuredPage3 = m697getAndMeasureSGf7dI0(measurePager, previousIndex, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, measurePager.getLayoutDirection(), reverseLayout, pageAvailableSize);
        ...
        List<MeasuredPage> listCreatePagesBeforeList = createPagesBeforeList(currentFirstPage, beyondBoundsPageCount, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int it) {
                ...
                return PagerMeasureKt.m697getAndMeasureSGf7dI0(lazyLayoutMeasureScope, it, childConstraints, pagerItemProvider, visualPageOffset, orientation, horizontalAlignment, verticalAlignment, lazyLayoutMeasureScope.getLayoutDirection(), reverseLayout, pageAvailableSize);
            }
        });
        ...
        List<MeasuredPage> listCreatePagesAfterList = createPagesAfterList(((MeasuredPage) visiblePages2.last()).getIndex(), pageCount, beyondBoundsPageCount, pinnedPages, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        boolean noExtraPages = Intrinsics.areEqual(firstPage3, visiblePages9.first()) && listCreatePagesBeforeList.isEmpty() && listCreatePagesAfterList.isEmpty();
        int layoutWidth = ConstraintsKt.m5182constrainWidthK40F9xA(constraints, orientation == Orientation.Vertical ? maxCrossAxis12 : currentMainAxisOffset4);
        int layoutHeight = ConstraintsKt.m5181constrainHeightK40F9xA(constraints, orientation == Orientation.Vertical ? currentMainAxisOffset4 : maxCrossAxis12);
        final List<MeasuredPage> listCalculatePagesOffsets = calculatePagesOffsets(measurePager, visiblePages9, listCreatePagesBeforeList, listCreatePagesAfterList, layoutWidth, layoutHeight, currentMainAxisOffset4, maxOffset3, visiblePagesScrollOffset, orientation, reverseLayout, measurePager, spaceBetweenPages, pageAvailableSize);
        if (noExtraPages) {
        ...
        return new PagerMeasureResult(list, pageCount, pageAvailableSize, spaceBetweenPages, afterContentPadding, orientation, -beforeContentPadding, maxOffset8 + afterContentPadding, reverseLayout, consumedScroll, firstPage3, closestPageToSnapPosition, currentFirstPageScrollOffset2, (index2 < pageCount || currentMainAxisOffset4 > maxOffset8) ? true : z, layout.invoke(Integer.valueOf(layoutWidth), Integer.valueOf(layoutHeight), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$6
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final MeasuredPage m697getAndMeasureSGf7dI0(LazyLayoutMeasureScope $this$getAndMeasure_u2dSGf7dI0, int index, long childConstraints, PagerLazyLayoutItemProvider pagerItemProvider, long visualPageOffset, Orientation orientation, Alignment.Horizontal horizontalAlignment, Alignment.Vertical verticalAlignment, LayoutDirection layoutDirection, boolean reverseLayout, int pageAvailableSize) {
        Object key = pagerItemProvider.getKey(index);
        return new MeasuredPage(index, pageAvailableSize, $this$getAndMeasure_u2dSGf7dI0.mo639measure0kLqBqw(index, childConstraints), visualPageOffset, key, orientation, horizontalAlignment, verticalAlignment, layoutDirection, reverseLayout, null);
    }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope $this$calculatePagesOffsets, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int layoutWidth, int layoutHeight, int finalMainAxisOffset, int maxOffset, int pagesScrollOffset, Orientation orientation, boolean reverseLayout, Density density, int spaceBetweenPages, int pageAvailableSize) {
        ...
        if (hasSpareSpace) {
            ...
            Arrangement.HorizontalOrVertical arrangement = Arrangement.Absolute.INSTANCE.m395spacedBy0680j_4($this$calculatePagesOffsets.mo323toDpu2uoSUM(pageAvailableSize));

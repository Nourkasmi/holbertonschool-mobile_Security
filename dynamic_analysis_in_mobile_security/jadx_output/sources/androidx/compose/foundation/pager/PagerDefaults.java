...
public final class PagerDefaults {
    ...
    public final SnapFlingBehavior m690flingBehaviorPfoAEA0(PagerState state, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, float snapVelocityThreshold, float snapPositionalThreshold, Composer $composer, int $changed, int i) {
        ...
        TweenSpec tweenSpecTween$default = (i & 4) != 0 ? AnimationSpecKt.tween$default(500, 0, EasingKt.getLinearEasing(), 2, null) : animationSpec;
        ...
        SpringSpec springSpecSpring$default = (i & 16) != 0 ? AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null) : animationSpec2;
        ...
        Object[] keys$iv = {state, tweenSpecTween$default, decayAnimationSpecRememberSplineBasedDecay, springSpecSpring$default, pagerSnapDistance2, density};
        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new SnapFlingBehavior(snapLayoutInfoProvider, tweenSpecTween$default, decayAnimationSpecRememberSplineBasedDecay, springSpecSpring$default, density, snapPositionalThreshold3, null);

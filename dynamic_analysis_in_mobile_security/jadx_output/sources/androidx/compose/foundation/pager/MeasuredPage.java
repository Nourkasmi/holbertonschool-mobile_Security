...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < size) {
            ...
            long offset = m688getOffsetBjo55l4(index);
            if (!this.reverseLayout) {
                i = i2;
            } else {
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m5330getXimpl(offset);
                    i = i2;
                } else {
                    int mainAxisOffset2 = IntOffset.m5330getXimpl(offset);
                    i = i2;
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m5331getYimpl(offset);
                    iM5331getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    iM5331getYimpl = IntOffset.m5331getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(mainAxisOffset, iM5331getYimpl);
            }
            long other$iv = this.visualOffset;
            long other$iv2 = IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(offset) + IntOffset.m5330getXimpl(other$iv), IntOffset.m5331getYimpl(offset) + IntOffset.m5331getYimpl(other$iv));
            if (this.isVertical) {
                Placeable.PlacementScope.m4243placeWithLayeraW9wM$default(scope, placeable, other$iv2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4242placeRelativeWithLayeraW9wM$default(scope, placeable, other$iv2, 0.0f, null, 6, null);
            }
            i3++;
            i2 = i;
        }
    ...
    private final long m688getOffsetBjo55l4(int index) {
    ...
    private final long m687copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {

        ...
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedPages(), ComposableLambdaKt.composableLambda($composer2, 1142237095, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.1
            ...
            public final void invoke(Composer $composer3, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                    ...
                    LazyLayoutIntervalContent this_$iv = PagerLazyLayoutItemProvider.this.intervalContent;
                    ...
                    content.getItem().invoke(pagerLazyLayoutItemProvider.pagerScopeImpl, Integer.valueOf(localIntervalIndex$iv), $composer3, 0);
                    if (ComposerKt.isTraceInProgress()) {

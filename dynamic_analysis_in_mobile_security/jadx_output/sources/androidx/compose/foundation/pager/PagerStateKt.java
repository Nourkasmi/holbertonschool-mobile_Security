...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m5212constructorimpl(56);
    private static final PagerLayoutInfo EmptyLayoutInfo = new PagerLayoutInfo() { // from class: androidx.compose.foundation.pager.PagerStateKt$EmptyLayoutInfo$1
        ...
        private final long viewportSize = IntSize.INSTANCE.m5377getZeroYbymL2g();
    ...
    public static final PagerState rememberPagerState(int initialPage, float initialPageOffsetFraction, final Function0<Integer> pageCount, Composer $composer, int $changed, int i) {
        ...
        Object objM2594rememberSaveable = RememberSaveableKt.m2594rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) key1$iv2, $composer, 72, 4);
        PagerStateImpl $this$rememberPagerState_u24lambda_u241 = (PagerStateImpl) objM2594rememberSaveable;
        $this$rememberPagerState_u24lambda_u241.getPageCountState().setValue(pageCount);
        PagerStateImpl pagerStateImpl = (PagerStateImpl) objM2594rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final PagerState rememberPagerState(int initialPage, float initialPageOffsetFraction, Composer $composer, int $changed, int i) {
        ...
        $composer.endReplaceableGroup();
        Object key1$iv2 = value$iv$iv;
        PagerStateImpl pagerStateImpl = (PagerStateImpl) RememberSaveableKt.m2594rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) key1$iv2, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

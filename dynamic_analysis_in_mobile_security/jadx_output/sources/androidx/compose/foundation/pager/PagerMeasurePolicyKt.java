...
public final class PagerMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, MeasureResult> m699rememberPagerMeasurePolicyBxUkNYg(final Function0<PagerLazyLayoutItemProvider> itemProviderLambda, final PagerState state, final PaddingValues contentPadding, final boolean reverseLayout, final Orientation orientation, final int beyondBoundsPageCount, final float pageSpacing, final PageSize pageSize, final Alignment.Horizontal horizontalAlignment, final Alignment.Vertical verticalAlignment, final Function0<Integer> pageCount, Composer $composer, int $changed, int $changed1) {
        ...
        Object[] keys$iv = {contentPadding, Dp.m5210boximpl(pageSpacing), pageSize, state, contentPadding, Boolean.valueOf(reverseLayout), orientation, horizontalAlignment, verticalAlignment, pageCount};
        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new Function2<LazyLayoutMeasureScope, Constraints, PagerMeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ PagerMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m700invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final PagerMeasureResult m700invoke0kLqBqw(final LazyLayoutMeasureScope $this$null, final long containerConstraints) throws Throwable {
                    int i;
                    int i2;
                    int i3;
                    int iM5168getMaxWidthimpl;
                    long visualItemOffset;
                    int iM5168getMaxWidthimpl2;
                    int iM5167getMaxHeightimpl;
                    ...
                    if (isVertical) {
                        i = $this$null.mo320roundToPx0680j_4(contentPadding.mo432calculateLeftPaddingu2uoSUM($this$null.getLayoutDirection()));
                    } else {
                        i = $this$null.mo320roundToPx0680j_4(PaddingKt.calculateStartPadding(contentPadding, $this$null.getLayoutDirection()));
                    }
                    int startPadding = i;
                    if (isVertical) {
                        i2 = $this$null.mo320roundToPx0680j_4(contentPadding.mo433calculateRightPaddingu2uoSUM($this$null.getLayoutDirection()));
                    } else {
                        i2 = $this$null.mo320roundToPx0680j_4(PaddingKt.calculateEndPadding(contentPadding, $this$null.getLayoutDirection()));
                    }
                    int endPadding = i2;
                    int topPadding = $this$null.mo320roundToPx0680j_4(contentPadding.getTop());
                    int bottomPadding = $this$null.mo320roundToPx0680j_4(contentPadding.getBottom());
                    ...
                    long contentConstraints = ConstraintsKt.m5184offsetNN6EwU(containerConstraints, -totalHorizontalPadding, -totalVerticalPadding);
                    state.setDensity$foundation_release($this$null);
                    int spaceBetweenPages = $this$null.mo320roundToPx0680j_4(pageSpacing);
                    if (isVertical) {
                        iM5168getMaxWidthimpl = Constraints.m5167getMaxHeightimpl(containerConstraints) - totalVerticalPadding;
                    } else {
                        iM5168getMaxWidthimpl = Constraints.m5168getMaxWidthimpl(containerConstraints) - totalHorizontalPadding;
                    }
                    int mainAxisAvailableSize = iM5168getMaxWidthimpl;
                    ...
                    if (orientation == Orientation.Vertical) {
                        iM5168getMaxWidthimpl2 = Constraints.m5168getMaxWidthimpl(contentConstraints);
                    } else {
                        iM5168getMaxWidthimpl2 = iCalculateMainAxisPageSize;
                    }
                    if (orientation != Orientation.Vertical) {
                        iM5167getMaxHeightimpl = Constraints.m5167getMaxHeightimpl(contentConstraints);
                    } else {
                        iM5167getMaxHeightimpl = iCalculateMainAxisPageSize;
                    }
                    pagerState.m703setPremeasureConstraintsBRTryo0$foundation_release(ConstraintsKt.Constraints$default(0, iM5168getMaxWidthimpl2, 0, iM5167getMaxHeightimpl, 5, null));
                            ...
                            try {
                                try {
                                    if (Intrinsics.areEqual(pagerState2.getLayoutInfo$foundation_release(), PagerStateKt.getEmptyLayoutInfo())) {
                                        try {
                                            firstVisiblePageOffset = MathKt.roundToInt(pagerState2.getInitialPageOffsetFraction() * iCalculateMainAxisPageSize);
                                        } catch (Throwable th) {
                                            th = th;
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            PagerMeasureResult it = PagerMeasureKt.m698measurePagerntgEbfI($this$null, pageCount.invoke().intValue(), itemProvider, mainAxisAvailableSize, beforeContentPadding, afterContentPadding, spaceBetweenPages, firstVisiblePage, firstVisiblePageOffset, state.getScrollToBeConsumed(), contentConstraints, orientation, verticalAlignment, horizontalAlignment, reverseLayout, visualItemOffset, iCalculateMainAxisPageSize, beyondBoundsPageCount, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(itemProvider, state.getPinnedPages(), state.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.pager.PagerMeasurePolicyKt$rememberPagerMeasurePolicy$1$1.2
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(3);
                                                }
                                                ...
                                                public final MeasureResult invoke(int width, int height, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                                    ...
                                                    return $this$null.layout(ConstraintsKt.m5182constrainWidthK40F9xA(containerConstraints, totalHorizontalPadding + width), ConstraintsKt.m5181constrainHeightK40F9xA(containerConstraints, totalVerticalPadding + height), MapsKt.emptyMap(), placement);
                                                }
                                            });

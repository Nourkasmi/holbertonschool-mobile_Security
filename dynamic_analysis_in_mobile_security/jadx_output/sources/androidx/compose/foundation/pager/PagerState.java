...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int initialPage, float initialPageOffsetFraction) {
        ...
        this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2697boximpl(Offset.INSTANCE.m2724getZeroF1C5BW0()), null, 2, null);
    ...
    public final long m702getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m704setUpDownDifferencek4lQ0M$foundation_release(long j) {
    ...
    public final float getPositionThresholdFraction() {
        ...
        float minThreshold = Math.min($this$_get_positionThresholdFraction__u24lambda_u241.mo326toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f);
    ...
    public final void m703setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    */
    static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            boolean r0 = r8 instanceof androidx.compose.foundation.pager.PagerState.C02501
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.pager.PagerState$scroll$1 r0 = (androidx.compose.foundation.pager.PagerState.C02501) r0
            int r1 = r0.label
        ...
        if (!info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (indexToPrefetch != this.indexToPrefetch) {
                if (indexToPrefetch >= 0 && indexToPrefetch < info.getPagesCount()) {
                    ...
                    this.currentPrefetchHandle = this.prefetchState.m640schedulePrefetch0kLqBqw(indexToPrefetch, this.premeasureConstraints);
                }
            }
        }
    }

...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m588measureLazyListCD5nmq0(int itemsCount, LazyListMeasuredItemProvider measuredItemProvider, int mainAxisAvailableSize, int beforeContentPadding, int afterContentPadding, int spaceBetweenItems, int firstVisibleItemIndex, int firstVisibleItemScrollOffset, float scrollToBeConsumed, long constraints, boolean isVertical, List<Integer> headerIndexes, Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, boolean reverseLayout, Density density, LazyListItemPlacementAnimator placementAnimator, int beyondBoundsItemCount, List<Integer> pinnedItems, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (itemsCount <= 0) {
            return new LazyListMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m5170getMinWidthimpl(constraints)), Integer.valueOf(Constraints.m5169getMinHeightimpl(constraints)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$1
        ...
        while (maxCrossAxis9 < $i$f$fastForEach2) {
            Object item$iv3 = list3.get(maxCrossAxis9);
        ...
        int layoutWidth = ConstraintsKt.m5182constrainWidthK40F9xA(constraints, isVertical ? maxCrossAxis8 : maxCrossAxis2);
        int layoutHeight = ConstraintsKt.m5181constrainHeightK40F9xA(constraints, isVertical ? maxCrossAxis2 : maxCrossAxis8);
        ...
        return new LazyListMeasureResult(firstItem, currentFirstItemScrollOffset, z, consumedScroll, measureResultInvoke, list4, i, maxOffset, itemsCount, reverseLayout, isVertical ? Orientation.Vertical : Orientation.Horizontal, afterContentPadding, spaceBetweenItems);
    }

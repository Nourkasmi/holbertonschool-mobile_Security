...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo {
    ...
    public LazyStaggeredGridMeasuredItem(int index, Object key, List<? extends Placeable> placeables, boolean isVertical, int spacing, int lane, int span, int beforeContentPadding, int afterContentPadding, Object contentType) {
        ...
        if (list.isEmpty()) {
            ...
            if (1 <= lastIndex) {
                while (true) {
                    Placeable placeable2 = list.get(i$iv);
                    Integer numValueOf3 = Integer.valueOf(this.isVertical ? placeable2.getHeight() : placeable2.getWidth());
        ...
        this.sizeWithSpacings = RangesKt.coerceAtLeast(iIntValue + spacing, 0);
        List<Placeable> list2 = this.placeables;
        if (list2.isEmpty()) {
            numValueOf2 = null;
        } else {
            Placeable it = list2.get(0);
            numValueOf2 = Integer.valueOf(this.isVertical ? it.getWidth() : it.getHeight());
            int i$iv2 = 1;
            int lastIndex2 = CollectionsKt.getLastIndex(list2);
            if (1 <= lastIndex2) {
                while (true) {
                    Placeable it2 = list2.get(i$iv2);
        ...
        this.size = jIntSize;
        this.offset = IntOffset.INSTANCE.m5340getZeronOccac();
    }
    ...
    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m5330getXimpl(getOffset()) : IntOffset.m5331getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        int index$iv = 0;
        for (int size = list.size(); index$iv < size; size = i) {
            ...
            if (animateNode != null) {
                long other$iv = animateNode.m626getPlacementDeltanOccac();
                i = size;
                long animatedOffset = IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(offset) + IntOffset.m5330getXimpl(other$iv), IntOffset.m5331getYimpl(offset) + IntOffset.m5331getYimpl(other$iv));
                if ((lazyStaggeredGridMeasuredItem.m671getMainAxisgyyYBs(offset) <= minOffset2 && lazyStaggeredGridMeasuredItem.m671getMainAxisgyyYBs(animatedOffset) <= minOffset2) || (lazyStaggeredGridMeasuredItem.m671getMainAxisgyyYBs(offset) >= maxOffset2 && lazyStaggeredGridMeasuredItem.m671getMainAxisgyyYBs(animatedOffset) >= maxOffset2)) {
            ...
            if (context.getReverseLayout()) {
                ...
                if (this.isVertical) {
                    height = IntOffset.m5330getXimpl($this$copy_u2d4Tuh3kE$iv);
                    minOffset = minOffset2;
                } else {
                    int mainAxisOffset = IntOffset.m5330getXimpl($this$copy_u2d4Tuh3kE$iv);
                    minOffset = minOffset2;
                ...
                if (this.isVertical) {
                    int mainAxisOffset2 = IntOffset.m5331getYimpl($this$copy_u2d4Tuh3kE$iv);
                    iM5331getYimpl = (lazyStaggeredGridMeasuredItem.mainAxisLayoutSize - mainAxisOffset2) - (this.isVertical ? placeable.getHeight() : placeable.getWidth());
                } else {
                    iM5331getYimpl = IntOffset.m5331getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(height, iM5331getYimpl);
            } else {
                maxOffset = maxOffset2;
                minOffset = minOffset2;
            }
            long other$iv2 = context.getContentOffset();
            Placeable.PlacementScope.m4242placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(offset) + IntOffset.m5330getXimpl(other$iv2), IntOffset.m5331getYimpl(offset) + IntOffset.m5331getYimpl(other$iv2)), 0.0f, null, 6, null);
    ...
    private final int m671getMainAxisgyyYBs(long $this$mainAxis) {
        return this.isVertical ? IntOffset.m5331getYimpl($this$mainAxis) : IntOffset.m5330getXimpl($this$mainAxis);
    }
    ...
    private final long m670copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m5330getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m5330getXimpl($this$copy_u2d4Tuh3kE))).intValue(), this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m5331getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m5331getYimpl($this$copy_u2d4Tuh3kE));
    }

        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m585invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyListMeasureResult m585invoke0kLqBqw(final LazyLayoutMeasureScope $this$null, final long containerConstraints) throws Throwable {
                    int i2;
                    int i3;
                    int i4;
                    float spacing;
                    ...
                    final long contentConstraints = ConstraintsKt.m5184offsetNN6EwU(containerConstraints, -totalHorizontalPadding, -totalVerticalPadding);
                    state.setDensity$foundation_release($this$null);
                    final LazyListItemProvider itemProvider = function0.invoke();
                    itemProvider.getItemScope().setMaxSize(Constraints.m5168getMaxWidthimpl(contentConstraints), Constraints.m5167getMaxHeightimpl(contentConstraints));
                    if (isVertical) {
                    ...
                    final int spaceBetweenItems = $this$null.mo320roundToPx0680j_4(spaceBetweenItemsDp);
                    ...
                    state.m594setPremeasureConstraintsBRTryo0$foundation_release(lazyListMeasuredItemProvider.getChildConstraints());

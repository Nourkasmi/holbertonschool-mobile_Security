...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long constraints, boolean isVertical, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, isVertical ? Constraints.m5168getMaxWidthimpl(constraints) : Integer.MAX_VALUE, 0, isVertical ? Integer.MAX_VALUE : Constraints.m5167getMaxHeightimpl(constraints), 5, null);
    }
    ...
    public final LazyListMeasuredItem getAndMeasure(int index) {
        ...
        return createItem(index, key, contentType, this.measureScope.mo639measure0kLqBqw(index, this.childConstraints));
    }

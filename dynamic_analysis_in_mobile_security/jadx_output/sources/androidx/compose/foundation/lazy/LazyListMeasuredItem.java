...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final long m591getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < placeablesCount) {
            ...
            long offset = m591getOffsetBjo55l4(index);
            ...
            if (animateNode == null) {
                ...
                if ((m590getMainAxisgyyYBs(offset) <= minOffset && m590getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m590getMainAxisgyyYBs(offset) >= maxOffset && m590getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
    ...
    private final int m590getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m589copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {

...
public final class LazyGridState implements ScrollableState {
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r7, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r6 = this;
            boolean r0 = r9 instanceof androidx.compose.foundation.lazy.grid.LazyGridState.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r9
    ...
    private final void notifyPrefetch(float delta) {
        ...
        if (!info.getVisibleItemsInfo().isEmpty()) {
            ...
            if (lineToPrefetch != closestNextItemToPrefetch2) {
                ...
                if (z) {
                    if (this.wasScrollingForward != scrollingForward && (size$iv = (mutableVector = this.currentLinePrefetchHandles).getSize()) > 0) {
                        int i$iv = 0;
                    ...
                    List<Pair<Integer, Constraints>> listInvoke = getPrefetchInfoRetriever$foundation_release().invoke(Integer.valueOf(lineToPrefetch));
                    int index$iv = 0;
                    int size = listInvoke.size();
                    while (index$iv < size) {
                        Object item$iv = listInvoke.get(index$iv);
                        Pair<Integer, Constraints> pair = (Pair) item$iv;
                        this.currentLinePrefetchHandles.add(prefetchState.m640schedulePrefetch0kLqBqw(pair.getFirst().intValue(), pair.getSecond().getValue()));
                        index$iv++;
                        info = info;

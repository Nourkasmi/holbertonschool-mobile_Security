...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m619getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m620getAndMeasure3p2s80s(i, i2, j);
    }

    /* JADX INFO: renamed from: getAndMeasure-3p2s80s, reason: not valid java name */
    public final LazyGridMeasuredItem m620getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        int crossAxisSize;
        Object key = this.itemProvider.getKey(index);
        Object contentType = this.itemProvider.getContentType(index);
        List<Placeable> listMo639measure0kLqBqw = this.measureScope.mo639measure0kLqBqw(index, constraints);
        if (Constraints.m5166getHasFixedWidthimpl(constraints)) {
            crossAxisSize = Constraints.m5170getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m5165getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            crossAxisSize = Constraints.m5169getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, crossAxisSize, mainAxisSpacing, listMo639measure0kLqBqw);
    }

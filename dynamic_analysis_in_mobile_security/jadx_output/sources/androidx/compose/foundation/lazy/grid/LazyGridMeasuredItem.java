...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < placeablesCount) {
            ...
            if (animateNode == null) {
                ...
                if ((m618getMainAxisgyyYBs(offset) <= minOffset && m618getMainAxisgyyYBs(animatedOffset) <= minOffset) || (m618getMainAxisgyyYBs(offset) >= maxOffset && m618getMainAxisgyyYBs(animatedOffset) >= maxOffset)) {
            ...
            if (this.reverseLayout) {
                ...
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m5330getXimpl($this$copy_u2d4Tuh3kE$iv);
                } else {
                    int mainAxisOffset2 = IntOffset.m5330getXimpl($this$copy_u2d4Tuh3kE$iv);
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m5331getYimpl($this$copy_u2d4Tuh3kE$iv);
                    iM5331getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    iM5331getYimpl = IntOffset.m5331getYimpl($this$copy_u2d4Tuh3kE$iv);
                }
                offset = IntOffsetKt.IntOffset(mainAxisOffset, iM5331getYimpl);
            }
            long other$iv2 = this.visualOffset;
            long other$iv3 = IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(offset) + IntOffset.m5330getXimpl(other$iv2), IntOffset.m5331getYimpl(offset) + IntOffset.m5331getYimpl(other$iv2));
            if (this.isVertical) {
                Placeable.PlacementScope.m4243placeWithLayeraW9wM$default(scope, placeable, other$iv3, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4242placeRelativeWithLayeraW9wM$default(scope, placeable, other$iv3, 0.0f, null, 6, null);
            }
            i3++;
            i2 = i;
        }
    ...
    private final int m618getMainAxisgyyYBs(long $this$mainAxis) {
    ...
    private final long m617copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {

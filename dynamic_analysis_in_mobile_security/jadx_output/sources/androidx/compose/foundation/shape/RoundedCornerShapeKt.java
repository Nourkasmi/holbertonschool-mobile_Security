...
public final class RoundedCornerShapeKt {
    ...
    public static final RoundedCornerShape m734RoundedCornerShape0680j_4(float size) {
        return RoundedCornerShape(CornerSizeKt.m726CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ RoundedCornerShape m736RoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m735RoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: RoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final RoundedCornerShape m735RoundedCornerShapea9UjIt4(float topStart, float topEnd, float bottomEnd, float bottomStart) {
        return new RoundedCornerShape(CornerSizeKt.m726CornerSize0680j_4(topStart), CornerSizeKt.m726CornerSize0680j_4(topEnd), CornerSizeKt.m726CornerSize0680j_4(bottomEnd), CornerSizeKt.m726CornerSize0680j_4(bottomStart));
    }

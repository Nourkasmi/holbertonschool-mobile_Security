...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo717createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2777getWidthimpl(size) - topEnd, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2777getWidthimpl(size), topEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2777getWidthimpl(size), Size.m2774getHeightimpl(size) - bottomEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2777getWidthimpl(size) - bottomEnd, Size.m2774getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(bottomStart, Size.m2774getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m2774getHeightimpl(size) - bottomStart);

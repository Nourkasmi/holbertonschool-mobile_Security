...
public final class ClipScrollableContainerKt {
    private static final float MaxSupportedElevation = Dp.m5212constructorimpl(30);
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo209createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            float inflateSize = density.mo320roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -inflateSize, Size.m2777getWidthimpl(size), Size.m2774getHeightimpl(size) + inflateSize));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo209createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float inflateSize = density.mo320roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-inflateSize, 0.0f, Size.m2777getWidthimpl(size) + inflateSize, Size.m2774getHeightimpl(size)));
        }
    });

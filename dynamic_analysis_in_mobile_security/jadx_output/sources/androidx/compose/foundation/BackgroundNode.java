...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m2948equalsimpl0(this.color, Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
            DrawScope.m3484drawRectnJ9OG0$default($this$drawRect, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.m3483drawRectAsUm42w$default($this$drawRect, it, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        Outline outline;
        if (Size.m2772equalsimpl($this$drawOutline.mo3489getSizeNHjbRc(), this.lastSize) && $this$drawOutline.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outline = this.lastOutline;
            Intrinsics.checkNotNull(outline);
        } else {
            outline = this.shape.mo209createOutlinePq9zytI($this$drawOutline.mo3489getSizeNHjbRc(), $this$drawOutline.getLayoutDirection(), $this$drawOutline);
        }
        if (!Color.m2948equalsimpl0(this.color, Color.INSTANCE.m2983getUnspecified0d7_KjU())) {
            OutlineKt.m3198drawOutlinewDX37Ww($this$drawOutline, outline, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m3490getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m3196drawOutlinehn5TExg($this$drawOutline, outline, it, (56 & 4) != 0 ? 1.0f : this.alpha, (56 & 8) != 0 ? Fill.INSTANCE : null, (56 & 16) != 0 ? null : null, (56 & 32) != 0 ? DrawScope.INSTANCE.m3490getDefaultBlendMode0nO6VwU() : 0);
        }
        this.lastOutline = outline;
        this.lastSize = Size.m2765boximpl($this$drawOutline.mo3489getSizeNHjbRc());

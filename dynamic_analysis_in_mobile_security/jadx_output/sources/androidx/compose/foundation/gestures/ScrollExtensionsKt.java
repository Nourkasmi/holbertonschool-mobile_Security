...
public final class ScrollExtensionsKt {
    ...
    */
    public static final java.lang.Object scrollBy(androidx.compose.foundation.gestures.ScrollableState r8, float r9, kotlin.coroutines.Continuation<? super java.lang.Float> r10) {
        /*
            boolean r0 = r10 instanceof androidx.compose.foundation.gestures.ScrollExtensionsKt.C01881
            if (r0 == 0) goto L14
            r0 = r10
            androidx.compose.foundation.gestures.ScrollExtensionsKt$scrollBy$1 r0 = (androidx.compose.foundation.gestures.ScrollExtensionsKt.C01881) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    static final class C01892 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01892(Ref.FloatRef floatRef, float f, Continuation<? super C01892> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01892 c01892 = new C01892(this.$consumed, this.$value, continuation);
            c01892.L$0 = obj;
            return c01892;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ScrollScope scrollScope, Continuation<? super Unit> continuation) {
            return ((C01892) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C01902 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        ...
        C01902(Continuation<? super C01902> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01902(continuation);
        }
    ...
    public static final Object stopScroll(ScrollableState $this$stopScroll, MutatePriority scrollPriority, Continuation<? super Unit> continuation) {
        Object objScroll = $this$stopScroll.scroll(scrollPriority, new C01902(null), continuation);

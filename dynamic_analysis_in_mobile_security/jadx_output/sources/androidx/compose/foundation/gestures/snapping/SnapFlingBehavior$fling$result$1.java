        ...
        switch (this.label) {
            case 0:
                ...
                if (Math.abs(this.$initialVelocity) <= Math.abs(this.this$0.velocityThreshold)) {
                    this.label = 1;
                    Object objShortSnap = this.this$0.shortSnap(this.$this_fling, this.$initialVelocity, this.$onRemainingScrollOffsetUpdate, this);
                    if (objShortSnap == coroutine_suspended) {
                ...
                this.label = 2;
                Object objLongSnap = this.this$0.longSnap(this.$this_fling, this.$initialVelocity, this.$onRemainingScrollOffsetUpdate, this);
                if (objLongSnap == coroutine_suspended) {
                    return coroutine_suspended;
                }
                $result = objLongSnap;
                return (AnimationResult) $result;

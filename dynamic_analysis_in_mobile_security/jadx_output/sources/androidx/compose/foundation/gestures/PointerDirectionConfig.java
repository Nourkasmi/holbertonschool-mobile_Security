...
public interface PointerDirectionConfig {
    ...
    float mo277crossAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: mainAxisDelta-k-4lQ0M */
    float mo278mainAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: offsetFromChanges-dBAh8RU */
    long mo279offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}

...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m759cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3925equalsimpl0(KeyEvent_androidKt.m3933getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m3930getKeyUpCS__XNY());
    }

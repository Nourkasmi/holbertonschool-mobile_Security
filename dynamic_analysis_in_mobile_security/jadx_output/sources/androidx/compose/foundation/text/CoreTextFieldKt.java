...
public final class CoreTextFieldKt {
    ...
    public static final void TextFieldCursorHandle(final TextFieldSelectionManager manager, Composer $composer, final int $changed) {
        ...
        if (state != null && state.getShowCursorHandle()) {
            ...
            Modifier modifierPointerInput = SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, observer, new C02541(observer, null));
    ...
    static final class C02541 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ TextDragObserver $observer;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02541(TextDragObserver textDragObserver, Continuation<? super C02541> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02541 c02541 = new C02541(this.$observer, continuation);
            c02541.L$0 = obj;
            return c02541;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C02541) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

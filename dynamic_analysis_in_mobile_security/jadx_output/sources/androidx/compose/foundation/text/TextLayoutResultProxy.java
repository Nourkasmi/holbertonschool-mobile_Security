...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m834getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m836getOffsetForPosition3MmeM6k(j, z);
    }

    /* JADX INFO: renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m836getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long it = position;
        if (coerceInVisibleBounds) {
            it = m833coercedInVisibleBoundsOfInputTextMKHz9U(it);
        }
        long relativePosition = m835relativeToInputTextMKHz9U(it);
        return this.value.m4693getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        float relativeVertical = Offset.m2709getYimpl(m835relativeToInputTextMKHz9U(m833coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical))));
    ...
    public final boolean m837isPositionOnTextk4lQ0M(long offset) {
        long relativeOffset = m835relativeToInputTextMKHz9U(m833coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int line = this.value.getLineForVerticalPosition(Offset.m2709getYimpl(relativeOffset));
        return Offset.m2708getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m2708getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }
    ...
    private final long m835relativeToInputTextMKHz9U(long $this$relativeToInputText_u2dMK_u2dHz9U) {
        Offset offsetM2697boximpl;
        long jMo4191localPositionOfR5De75A;
        ...
        if (innerTextFieldCoordinates != null) {
            ...
            if (decorationBoxCoordinates != null) {
                if (innerTextFieldCoordinates.isAttached() && decorationBoxCoordinates.isAttached()) {
                    jMo4191localPositionOfR5De75A = innerTextFieldCoordinates.mo4191localPositionOfR5De75A(decorationBoxCoordinates, $this$relativeToInputText_u2dMK_u2dHz9U);
                } else {
                    jMo4191localPositionOfR5De75A = $this$relativeToInputText_u2dMK_u2dHz9U;
                }
                offsetM2697boximpl = Offset.m2697boximpl(jMo4191localPositionOfR5De75A);
            } else {
                offsetM2697boximpl = null;
            }
            if (offsetM2697boximpl != null) {
                return offsetM2697boximpl.getPackedValue();
            }
        }
    ...
    */
    private final long m833coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L26:
            r0 = r3
            long r1 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m838access$coerceIn3MmeM6k(r7, r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m833coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}

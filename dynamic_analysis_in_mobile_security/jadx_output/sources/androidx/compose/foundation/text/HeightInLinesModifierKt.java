        ...
        return ComposedModifierKt.composed($this$heightInLines, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    int iM4820unboximpl = fontStyleM4744getFontStyle4Lr2A7w != null ? fontStyleM4744getFontStyle4Lr2A7w.m4820unboximpl() : FontStyle.INSTANCE.m4822getNormal_LCdwA();
                    FontSynthesis fontSynthesisM4745getFontSynthesisZQGJjVo = resolvedStyle.m4745getFontSynthesisZQGJjVo();
                    int $changed$iv = fontSynthesisM4745getFontSynthesisZQGJjVo != null ? fontSynthesisM4745getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4832getAllGVVA2EU();
                    value$iv$iv2 = fontFamilyResolver.mo4792resolveDPcqOEQ(fontFamily, fontWeight2, iM4820unboximpl, $changed$iv);
                ...
                if (invalid$iv || it$iv$iv3 == Composer.INSTANCE.getEmpty()) {
                    value$iv$iv3 = Integer.valueOf(IntSize.m5371getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (invalid$iv2 || it$iv$iv4 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv$iv4 = Integer.valueOf(IntSize.m5371getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, twoLines, 2)));
                ...
                Modifier modifierM515heightInVpY3zN4 = SizeKt.m515heightInVpY3zN4(Modifier.INSTANCE, precomputedMinLinesHeight != null ? density.mo323toDpu2uoSUM(precomputedMinLinesHeight.intValue()) : Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM(), precomputedMaxLinesHeight != null ? density.mo323toDpu2uoSUM(precomputedMaxLinesHeight.intValue()) : Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return modifierM515heightInVpY3zN4;
            }
        });
    }

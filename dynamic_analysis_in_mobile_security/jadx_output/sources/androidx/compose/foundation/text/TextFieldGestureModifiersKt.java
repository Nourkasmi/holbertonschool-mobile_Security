...
public final class TextFieldGestureModifiersKt {
    ...
    static final class C02631 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ MouseSelectionObserver $observer;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02631(MouseSelectionObserver mouseSelectionObserver, Continuation<? super C02631> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02631 c02631 = new C02631(this.$observer, continuation);
            c02631.L$0 = obj;
            return c02631;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C02631) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Modifier mouseDragGestureDetector(Modifier $this$mouseDragGestureDetector, MouseSelectionObserver observer, boolean enabled) {
        ...
        Intrinsics.checkNotNullParameter(observer, "observer");
        return enabled ? SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, observer, new C02631(observer, null)) : $this$mouseDragGestureDetector;
    }
}

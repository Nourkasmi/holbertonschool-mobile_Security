...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo875calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[this.handleReferencePoint.ordinal()]) {
            case 1:
                return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m5330getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m5331getYimpl(this.offset));
            case 2:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5330getXimpl(this.offset)) - IntSize.m5372getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m5331getYimpl(this.offset));
            case 3:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5330getXimpl(this.offset)) - (IntSize.m5372getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m5331getYimpl(this.offset));
            default:

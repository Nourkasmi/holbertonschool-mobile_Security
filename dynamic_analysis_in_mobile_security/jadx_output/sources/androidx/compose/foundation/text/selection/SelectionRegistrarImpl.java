...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl.sort.1
                ...
                public final Integer invoke(Selectable a, Selectable b) {
                    ...
                    if (layoutCoordinatesA != null) {
                        positionA = containerLayoutCoordinates.mo4191localPositionOfR5De75A(layoutCoordinatesA, Offset.INSTANCE.m2724getZeroF1C5BW0());
                    } else {
                        positionA = Offset.INSTANCE.m2724getZeroF1C5BW0();
                    }
                    if (layoutCoordinatesB != null) {
                        positionB = containerLayoutCoordinates.mo4191localPositionOfR5De75A(layoutCoordinatesB, Offset.INSTANCE.m2724getZeroF1C5BW0());
                    } else {
                        positionB = Offset.INSTANCE.m2724getZeroF1C5BW0();
                    }
                    if (Offset.m2709getYimpl(positionA) == Offset.m2709getYimpl(positionB)) {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m2708getXimpl(positionA)), Float.valueOf(Offset.m2708getXimpl(positionB)));
                    } else {
                        iCompareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m2709getYimpl(positionA)), Float.valueOf(Offset.m2709getYimpl(positionB)));
                    }
    ...
    public void mo936notifySelectionUpdateStartd4ec7I(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment) {
        ...
        if (function3 != null) {
            function3.invoke(layoutCoordinates, Offset.m2697boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo935notifySelectionUpdate5iVPX68(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        ...
        if (function5 != null) {
            return function5.invoke(layoutCoordinates, Offset.m2697boximpl(newPosition), Offset.m2697boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }

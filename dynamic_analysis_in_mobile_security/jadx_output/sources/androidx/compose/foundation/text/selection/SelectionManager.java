...
public final class SelectionManager {
    ...
    static final class C02662 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        C02662(Function1<? super Offset, Unit> function1, Continuation<? super C02662> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02662 c02662 = new C02662(this.$onTap, continuation);
            c02662.L$0 = obj;
            return c02662;
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c02662 = this;
                    AwaitPointerEventScope $this$awaitEachGesture = (AwaitPointerEventScope) c02662.L$0;
                    c02662.label = 1;
                    Object objWaitForUpOrCancellation$default = TapGestureDetectorKt.waitForUpOrCancellation$default($this$awaitEachGesture, null, c02662, 1, null);
            ...
            if (it != null) {
                c02662.$onTap.invoke(Offset.m2697boximpl(it.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope $this$detectNonConsumingTap, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture($this$detectNonConsumingTap, new C02662(function1, null), continuation);
    ...
    static final class C02681 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02681(Function0<Unit> function0, Continuation<? super C02681> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02681 c02681 = SelectionManager.this.new C02681(this.$block, continuation);
            c02681.L$0 = obj;
            return c02681;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C02681) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    private final Modifier onClearSelectionRequested(Modifier $this$onClearSelectionRequested, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput($this$onClearSelectionRequested, Unit.INSTANCE, new C02681(function0, null)) : $this$onClearSelectionRequested;
    }

...
public interface Selectable {
    ...
    long mo876getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo877getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo878updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection);

    /* JADX INFO: renamed from: updateSelection-qCDeeow$default, reason: not valid java name */
    static /* synthetic */ Pair m884updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        boolean z2;
        ...
        return selectable.mo878updateSelectionqCDeeow(j, j2, offset, z2, layoutCoordinates, selectionAdjustment, selection2);
    }
}

...
public final class SelectionContainerKt {
    public static final void SelectionContainer(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 91) != 18 || !$composer2.getSkipping()) {
            ...
            $composer2.endReplaceableGroup();
            SelectionContainer(modifier3, selectionSelectionContainer$lambda$1, (Function1) value$iv$iv2, content, $composer2, ($dirty2 & 14) | (($dirty2 << 6) & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt.SelectionContainer.2
            ...
            public final void invoke(Composer composer, int i3) {
                SelectionContainerKt.SelectionContainer(modifier3, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void SelectionContainer(Modifier modifier, final Selection selection, final Function1<? super Selection, Unit> onSelectionChange, final Function2<? super Composer, ? super Integer, Unit> children, Composer $composer, final int $changed, final int i) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        SimpleLayoutKt.SimpleLayout(modifierThen, ComposableLambdaKt.composableLambda($composer3, 1375295262, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1.1
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                Selection it;
                                Object value$iv$iv3;
                                Offset offsetM919getEndHandlePosition_m7T9E;
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    if (TouchMode_androidKt.isInTouchMode() && selectionManager.getHasFocus() && (it = selectionManager.getSelection()) != null) {
                                        ...
                                        while (index$iv2 < size) {
                                            ...
                                            if (isStartHandle) {
                                                offsetM919getEndHandlePosition_m7T9E = selectionManager2.m920getStartHandlePosition_m7T9E();
                                            } else {
                                                offsetM919getEndHandlePosition_m7T9E = selectionManager2.m919getEndHandlePosition_m7T9E();
                                            }
                                            Offset position = offsetM919getEndHandlePosition_m7T9E;
                                            if (isStartHandle) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt.SelectionContainer.5
            ...
            public final void invoke(Composer composer, int i4) {
                SelectionContainerKt.SelectionContainer(modifier5, selection, onSelectionChange, children, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}

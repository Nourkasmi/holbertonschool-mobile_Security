    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Offset offsetM2697boximpl = Offset.m2697boximpl(this.$targetValue);
                SpringSpec springSpec = SelectionMagnifierKt.MagnifierSpringSpec;
                this.label = 1;
                if (animatable.animateTo(offsetM2697boximpl, (4 & 2) != 0 ? animatable.defaultSpringSpec : springSpec, (4 & 4) != 0 ? animatable.getVelocity() : null, (4 & 8) != 0 ? null : null, this) == coroutine_suspended) {

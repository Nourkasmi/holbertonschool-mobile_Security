            ...
            switch (this.label) {
                case 0:
                    ...
                    if (PointerMoveDetectorKt.detectMoves(pointerInputScope, pointerEventPass, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt.ClickableText.pointerInputModifier.1.1.1
                        ...
                        public final void m748invokek4lQ0M(long pos) {
        ...
        switch (this.label) {
            case 0:
                ...
                Function1<Offset, Unit> function12 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$pointerInputModifier$1.2
                    ...
                    /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m749invokek4lQ0M(long pos) {
                        Integer numClickableText_03UYbkw$getOffset = ClickableTextKt.ClickableText_03UYbkw$getOffset(mutableState, pos);
                ...
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures($this$pointerInput, (3 & 1) != 0 ? null : null, (3 & 2) != 0 ? null : null, (3 & 4) != 0 ? TapGestureDetectorKt.NoPressGesture : null, (3 & 8) != 0 ? null : function12, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:

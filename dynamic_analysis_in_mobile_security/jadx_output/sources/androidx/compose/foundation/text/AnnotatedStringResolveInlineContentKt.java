    ...
    public static final void InlineChildren(final AnnotatedString text, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> inlineContents, Composer $composer, final int $changed) {
        ...
        while (index$iv < size) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                ...
                public final MeasureResult mo12measure3p2s80s(MeasureScope Layout, List<? extends Measurable> children, long constrains) {
                    ...
                    for (int index$iv$iv = 0; index$iv$iv < size2; index$iv$iv++) {
                        ...
                        target$iv.add(it.mo4183measureBRTryo0(constrains));
                    }
                    final List placeables = target$iv;
                    return MeasureScope.layout$default(Layout, Constraints.m5168getMaxWidthimpl(constrains), Constraints.m5167getMaxHeightimpl(constrains), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2$measure$1
            ...
            function3Component1.invoke(text.subSequence(start, end).getText(), $composer2, 0);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt.InlineChildren.2
            ...
            public final void invoke(Composer composer, int i3) {
                AnnotatedStringResolveInlineContentKt.InlineChildren(text, inlineContents, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
}

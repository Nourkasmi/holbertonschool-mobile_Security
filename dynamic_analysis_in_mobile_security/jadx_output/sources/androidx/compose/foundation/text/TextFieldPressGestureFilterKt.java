    ...
    public static final Modifier tapPressTextFieldModifier(Modifier $this$tapPressTextFieldModifier, final MutableInteractionSource interactionSource, boolean enabled, final Function1<? super Offset, Unit> onTap) {
        ...
        return enabled ? ComposedModifierKt.composed$default($this$tapPressTextFieldModifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.tapPressTextFieldModifier.1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                    ...
                    value$iv$iv2 = (Function1) new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$1$1
                        ...
                        public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
                            ...
                            return new DisposableEffectResult() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$1$1$invoke$$inlined$onDispose$1
                                ...
                                public void dispose() {
                                    PressInteraction.Press oldValue = (PressInteraction.Press) mutableState.getValue();
                                    if (oldValue == null) {
                                        return;
                                    }
                ...
                Modifier modifierPointerInput = SuspendingPointerInputFilterKt.pointerInput(Modifier.INSTANCE, interactionSource, new AnonymousClass2(scope, pressedInteraction, interactionSource, onTapState, null));
                if (ComposerKt.isTraceInProgress()) {
            ...
            static final class AnonymousClass2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
                ...
                static final class C00281 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
                    final /* synthetic */ MutableInteractionSource $interactionSource;
                    final /* synthetic */ MutableState<PressInteraction.Press> $pressedInteraction;
                    final /* synthetic */ CoroutineScope $scope;
                    /* synthetic */ long J$0;
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00281(CoroutineScope coroutineScope, MutableState<PressInteraction.Press> mutableState, MutableInteractionSource mutableInteractionSource, Continuation<? super C00281> continuation) {
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                        return m820invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
                    }

                    /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
                    public final Object m820invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
                        C00281 c00281 = new C00281(this.$scope, this.$pressedInteraction, this.$interactionSource, continuation);
                        c00281.L$0 = pressGestureScope;
                        c00281.J$0 = j;
                    ...
                    static final class C00291 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        C00291(MutableState<PressInteraction.Press> mutableState, long j, MutableInteractionSource mutableInteractionSource, Continuation<? super C00291> continuation) {
                            super(2, continuation);
                            this.$pressedInteraction = mutableState;
                            this.$it = j;
                            this.$interactionSource = mutableInteractionSource;
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00291(this.$pressedInteraction, this.$it, this.$interactionSource, continuation);
                        }
                        ...
                        */
                        public final java.lang.Object invokeSuspend(java.lang.Object r10) {
                            ...
                            L7b:
                                ...
                                return r0
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.AnonymousClass1.AnonymousClass2.C00281.C00291.invokeSuspend(java.lang.Object):java.lang.Object");
                        }
                    }
                    ...
                    static final class C00302 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        C00302(MutableState<PressInteraction.Press> mutableState, boolean z, MutableInteractionSource mutableInteractionSource, Continuation<? super C00302> continuation) {
                            super(2, continuation);
                            this.$pressedInteraction = mutableState;
                            this.$success = z;
                            this.$interactionSource = mutableInteractionSource;
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00302(this.$pressedInteraction, this.$success, this.$interactionSource, continuation);
                        }
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                ...
                                case 1:
                                    c00302 = this;
                                    c003022 = null;
                                    mutableState2 = (MutableState) c00302.L$0;
                                    ResultKt.throwOnFailure($result);
                                    mutableState = mutableState2;
                                    mutableState.setValue(null);
                                    return Unit.INSTANCE;
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        switch (this.label) {
                            case 0:
                                ...
                                long it = this.J$0;
                                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new C00291(this.$pressedInteraction, it, this.$interactionSource, null), 3, null);
                                this.label = 1;
                        ...
                        BuildersKt__Builders_commonKt.launch$default(c00281.$scope, null, null, new C00302(c00281.$pressedInteraction, success, c00281.$interactionSource, null), 3, null);
                        return Unit.INSTANCE;
                    }
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            C00281 c00281 = new C00281(this.$scope, this.$pressedInteraction, this.$interactionSource, null);
                            final State<Function1<Offset, Unit>> state = this.$onTapState;
                            this.label = 1;
                            if (TapGestureDetectorKt.detectTapAndPress($this$pointerInput, c00281, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.tapPressTextFieldModifier.1.2.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(1);
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                                    m821invokek4lQ0M(offset.getPackedValue());
                                    return Unit.INSTANCE;
                                }

                                /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                                public final void m821invokek4lQ0M(long it) {
                                    state.getValue().invoke(Offset.m2697boximpl(it));
                                }

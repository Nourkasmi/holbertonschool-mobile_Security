...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i, boolean z, int i2, int i3, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? null : function1, (i4 & 16) != 0 ? TextOverflow.INSTANCE.m5131getClipgIe3tQ8() : i, (i4 & 32) != 0 ? true : z, (i4 & 64) != 0 ? Integer.MAX_VALUE : i2, (i4 & 128) != 0 ? 1 : i3, (i4 & 256) != 0 ? null : list, (i4 & 512) != 0 ? null : function12, (i4 & 1024) != 0 ? null : selectionController, (i4 & 2048) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m868updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        ...
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m850updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode.applySemantics.1
                ...
                public final Boolean invoke(List<TextLayoutResult> textLayoutResult) {
                    ...
                    TextLayoutResult layout = TextAnnotatedStringNode.this.getLayoutCache().getLayoutCache();
                    if (layout != null) {
    ...
    public final MeasureResult m867measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(measureScope, "measureScope");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return mo238measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo238measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        boolean didChangeLayout = layoutCache.m849layoutWithConstraintsK40F9xA(constraints, measure.getLayoutDirection());
        ...
        final Placeable placeable = measurable.mo4183measureBRTryo0(Constraints.INSTANCE.m5176fixedJhjzzOo(IntSize.m5372getWidthimpl(textLayoutResult.getSize()), IntSize.m5371getHeightimpl(textLayoutResult.getSize())));
        int iM5372getWidthimpl = IntSize.m5372getWidthimpl(textLayoutResult.getSize());
        int iM5371getHeightimpl = IntSize.m5371getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(iM5372getWidthimpl, iM5371getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x0092 A[Catch: all -> 0x0084, TRY_ENTER, TRY_LEAVE, TryCatch #1 {all -> 0x0084, blocks: (B:17:0x007d, B:24:0x0092, B:28:0x00a1, B:32:0x00ae, B:37:0x00d5, B:52:0x010d), top: B:77:0x007d }] */
    /* JADX WARN: Removed duplicated region for block: B:28:0x00a1 A[Catch: all -> 0x0084, TRY_ENTER, TRY_LEAVE, TryCatch #1 {all -> 0x0084, blocks: (B:17:0x007d, B:24:0x0092, B:28:0x00a1, B:32:0x00ae, B:37:0x00d5, B:52:0x010d), top: B:77:0x007d }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00ae A[Catch: all -> 0x0084, TRY_ENTER, TRY_LEAVE, TryCatch #1 {all -> 0x0084, blocks: (B:17:0x007d, B:24:0x0092, B:28:0x00a1, B:32:0x00ae, B:37:0x00d5, B:52:0x010d), top: B:77:0x007d }] */
    ...
    */
    public void draw(androidx.compose.ui.graphics.drawscope.ContentDrawScope r30) throws java.lang.Throwable {
        /*

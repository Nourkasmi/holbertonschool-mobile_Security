...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        ...
        this.prevConstraints = Constraints.INSTANCE.m5176fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m5131getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void m855setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* JADX INFO: renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m854layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            finalConstraints = localMin.m843coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        } else {
            finalConstraints = constraints;
        }
        boolean z2 = false;
        if (!m852newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection)) {
            if (!Constraints.m5161equalsimpl0(finalConstraints, this.prevConstraints)) {
                Paragraph localParagraph = this.paragraph;
                Intrinsics.checkNotNull(localParagraph);
                long localSize = ConstraintsKt.m5179constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(localParagraph.getWidth()), TextDelegateKt.ceilToIntPx(localParagraph.getHeight())));
                this.layoutSize = localSize;
                if (TextOverflow.m5124equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5133getVisiblegIe3tQ8()) || (IntSize.m5372getWidthimpl(localSize) >= localParagraph.getWidth() && IntSize.m5371getHeightimpl(localSize) >= localParagraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
            }
        ...
        Paragraph it = m851layoutTextK40F9xA(finalConstraints, layoutDirection);
        this.prevConstraints = finalConstraints;
        long localSize2 = ConstraintsKt.m5179constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(it.getWidth()), TextDelegateKt.ceilToIntPx(it.getHeight())));
        this.layoutSize = localSize2;
        if (!TextOverflow.m5124equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5133getVisiblegIe3tQ8()) && (IntSize.m5372getWidthimpl(localSize2) < it.getWidth() || IntSize.m5371getHeightimpl(localSize2) < it.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = it;
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = TextDelegateKt.ceilToIntPx(m851layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m856updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        this.text = text;
    ...
    private final Paragraph m851layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return ParagraphKt.m4621Paragraph_EkL_Y(localParagraphIntrinsics, LayoutUtilsKt.m840finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m841finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m5124equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5132getEllipsisgIe3tQ8()));
    }

    /* JADX INFO: renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m852newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m5161equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m5168getMaxWidthimpl(constraints) != Constraints.m5168getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m5167getMaxHeightimpl(constraints)) < localParagraph.getHeight() || localParagraph.getDidExceedMaxLines();
    }

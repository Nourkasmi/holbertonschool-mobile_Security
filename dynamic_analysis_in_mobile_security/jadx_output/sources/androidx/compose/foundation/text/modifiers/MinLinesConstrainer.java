...
public final class MinLinesConstrainer {
    ...
    public final long m843coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        int minHeight;
        ...
        if (Float.isNaN(oneLineHeight) || Float.isNaN(lineHeight)) {
            oneLineHeight = ParagraphKt.m4619ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? false : false).getHeight();
            float twoLineHeight = ParagraphKt.m4619ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? false : false).getHeight();
            lineHeight = twoLineHeight - oneLineHeight;
            this.oneLineHeightCache = oneLineHeight;
            this.lineHeightCache = lineHeight;
        }
        if (minLines != 1) {
            minHeight = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(((minLines - 1) * lineHeight) + oneLineHeight), 0), Constraints.m5167getMaxHeightimpl(inConstraints));
        } else {
            minHeight = Constraints.m5169getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m5170getMinWidthimpl(inConstraints), Constraints.m5168getMaxWidthimpl(inConstraints), minHeight, Constraints.m5167getMaxHeightimpl(inConstraints));
    }
}

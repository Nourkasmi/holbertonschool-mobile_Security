...
public final class SelectionController implements RememberObserver {
    ...
    public /* synthetic */ SelectionController(SelectionRegistrar selectionRegistrar, long j, StaticTextSelectionParams staticTextSelectionParams, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(selectionRegistrar, j, empty, null);
    }
    ...
    public final void draw(DrawScope drawScope) {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.m3480drawPathLG529CI$default(drawScope, selectionPath, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        float right$iv = Size.m2777getWidthimpl(drawScope.mo3489getSizeNHjbRc());
        float bottom$iv = Size.m2774getHeightimpl(drawScope.mo3489getSizeNHjbRc());

...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow textOverflowM5121boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m5121boximpl(layoutInput.getOverflow());
        int iM5133getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m5133getVisiblegIe3tQ8();
        if (textOverflowM5121boximpl == null) {
            return false;
        }
        return TextOverflow.m5124equalsimpl0(textOverflowM5121boximpl.getValue(), iM5133getVisiblegIe3tQ8);
    }

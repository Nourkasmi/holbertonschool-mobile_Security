...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m5168getMaxWidthimpl(constraints), Constraints.m5167getMaxHeightimpl(constraints), null, placementBlock, 4, null);
    }
}

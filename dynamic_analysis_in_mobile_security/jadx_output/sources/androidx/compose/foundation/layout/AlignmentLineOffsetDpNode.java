...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m375setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m374setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo238measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return AlignmentLineKt.m361alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, constraints);
    }
}

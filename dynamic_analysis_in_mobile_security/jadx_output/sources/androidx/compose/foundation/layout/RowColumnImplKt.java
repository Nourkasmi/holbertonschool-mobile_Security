    ...
    public static final MeasurePolicy m506rowColumnMeasurePolicyTDGSqEk(final LayoutOrientation orientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> arrangement, final float arrangementSpacing, final SizeMode crossAxisSize, final CrossAxisAlignment crossAxisAlignment) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1
            ...
            public MeasureResult mo12measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                final RowColumnMeasurementHelper rowColumnMeasureHelper = new RowColumnMeasurementHelper(orientation, arrangement, arrangementSpacing, crossAxisSize, crossAxisAlignment, measurables, placeables, null);
                final RowColumnMeasureHelperResult measureResult = rowColumnMeasureHelper.m508measureWithoutPlacing_EkL_Y(measure, constraints, 0, measurables.size());
                ...
                return MeasureScope.layout$default(measure, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1$measure$1
                    ...
                    public final void invoke2(Placeable.PlacementScope layout) {
                        ...
                        rowColumnMeasureHelper.placeHelper(layout, measureResult, 0, measure.getLayoutDirection());
                    }
                }, 4, null);
            }
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MinIntrinsicWidthMeasureBlock(orientation).invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$minIntrinsicWidth.mo320roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MinIntrinsicHeightMeasureBlock(orientation).invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$minIntrinsicHeight.mo320roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MaxIntrinsicWidthMeasureBlock(orientation).invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$maxIntrinsicWidth.mo320roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MaxIntrinsicHeightMeasureBlock(orientation).invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$maxIntrinsicHeight.mo320roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
        };
    }
    ...
    private static final int intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> list, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function22, int mainAxisAvailable, int mainAxisSpacing) {
        ...
        if (!(totalWeight == 0.0f)) {
            if (mainAxisAvailable == Integer.MAX_VALUE) {
                ...
                iRoundToInt = MathKt.roundToInt(Math.max(mainAxisAvailable - fixedSpace, 0) / totalWeight);
            }
        }
        int weightUnitSpace = iRoundToInt;
        int index$iv2 = 0;
        int size2 = list.size();
        while (index$iv2 < size2) {
            ...
            if (weight2 > f) {
                if (weightUnitSpace != Integer.MAX_VALUE) {
                    iRoundToInt2 = MathKt.roundToInt(weightUnitSpace * weight2);
                } else {
                    iRoundToInt2 = Integer.MAX_VALUE;
                }
                crossAxisMax = Math.max(crossAxisMax, function22.invoke(child2, Integer.valueOf(iRoundToInt2)).intValue());
            }
            index$iv2++;
            f = 0.0f;
        }

...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m554onlybOOhFvg(WindowInsets only, int sides) {
    ...
    public static /* synthetic */ WindowInsets m553WindowInsetsa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m552WindowInsetsa9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: WindowInsets-a9UjIt4, reason: not valid java name */
    public static final WindowInsets m552WindowInsetsa9UjIt4(float left, float top, float right, float bottom) {

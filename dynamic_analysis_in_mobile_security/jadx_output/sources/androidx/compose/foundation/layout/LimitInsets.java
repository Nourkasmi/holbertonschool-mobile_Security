...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m569getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m570getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowLeft = WindowInsetsSides.m563hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowLeft) {
    ...
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m563hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m579getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m571getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m572getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowRight = WindowInsetsSides.m563hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowRight) {
    ...
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m563hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m573getBottomJoeWqyM())) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof LimitInsets) {
            return Intrinsics.areEqual(this.insets, ((LimitInsets) other).insets) && WindowInsetsSides.m562equalsimpl0(this.sides, ((LimitInsets) other).sides);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (result * 31) + WindowInsetsSides.m564hashCodeimpl(this.sides);
    }

    public String toString() {
        return '(' + this.insets + " only " + ((Object) WindowInsetsSides.m566toStringimpl(this.sides)) + ')';
    }
}

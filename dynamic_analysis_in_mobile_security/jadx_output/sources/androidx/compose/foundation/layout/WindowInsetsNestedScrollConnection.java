...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo335onPreScrollOzD1aCk(long available, int source) {
        return m557scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m2708getXimpl(available), Offset.m2709getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostScroll-DzOQY0M */
    public long mo334onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m557scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m2708getXimpl(available), Offset.m2709getYimpl(available)));
    }

    /* JADX INFO: renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m557scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (!(scrollAmount == 0.0f)) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || animationController != null) {
                if (animationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo509consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo558onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m556flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m5437getXimpl(available), Velocity.m5438getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* JADX INFO: renamed from: onPostFling-RZ2iAVY */
    public Object mo333onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m556flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m5437getXimpl(available), Velocity.m5438getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m556flinghuYlsQE(long r27, float r29, boolean r30, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r31) {
        /*
            Method dump skipped, instruction units count: 468
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m556flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }

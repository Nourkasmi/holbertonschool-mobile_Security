...
public final class OffsetKt {
    ...
    public static final Modifier m441offsetVpY3zN4(Modifier offset, final float x, final float y) {
        ...
        return offset.then(new OffsetModifierElement(x, y, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.offset.1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("x", Dp.m5210boximpl(x));
                $receiver.getProperties().set("y", Dp.m5210boximpl(y));
            }
        }, null));
    }

    /* JADX INFO: renamed from: offset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m442offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m441offsetVpY3zN4(modifier, f, f2);
    }

    /* JADX INFO: renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m439absoluteOffsetVpY3zN4(Modifier absoluteOffset, final float x, final float y) {
    ...
    public static /* synthetic */ Modifier m440absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5212constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m439absoluteOffsetVpY3zN4(modifier, f, f2);
    }

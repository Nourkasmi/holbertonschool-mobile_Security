    ...
    public static final void BoxWithConstraints(Modifier modifier, Alignment contentAlignment, boolean propagateMinConstraints, final Function3<? super BoxWithConstraintsScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.foundation.layout.BoxWithConstraintsKt$BoxWithConstraints$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m418invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m418invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        final int i6 = $dirty2;
                        List<Measurable> listSubcompose = SubcomposeLayout.subcompose(unit, ComposableLambdaKt.composableLambdaInstance(-1945019079, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.BoxWithConstraintsKt$BoxWithConstraints$1$1$measurables$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                        ...
                        return $this$invoke_0kLqBqw_u24lambda_u240.mo12measure3p2s80s(SubcomposeLayout, listSubcompose, constraints);
                    }
                };
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.BoxWithConstraintsKt.BoxWithConstraints.2
            ...
            public final void invoke(Composer composer, int i6) {
                BoxWithConstraintsKt.BoxWithConstraints(modifier5, alignment2, z, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}

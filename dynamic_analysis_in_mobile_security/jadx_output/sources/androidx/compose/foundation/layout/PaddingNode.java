...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m5212constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5212constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5212constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5212constructorimpl(0) : f4, z, null);
    }
    ...
    public final void m492setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m493setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m491setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m490setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo238measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int horizontal = measure.mo320roundToPx0680j_4(this.start) + measure.mo320roundToPx0680j_4(this.end);
        int vertical = measure.mo320roundToPx0680j_4(this.top) + measure.mo320roundToPx0680j_4(this.bottom);
        ...
        return MeasureScope.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable, measure.mo320roundToPx0680j_4(this.this$0.getStart()), measure.mo320roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeable, measure.mo320roundToPx0680j_4(this.this$0.getStart()), measure.mo320roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }

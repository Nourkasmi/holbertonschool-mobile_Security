...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final Modifier imeNestedScroll(Modifier $this$imeNestedScroll) {
        ...
        return ComposedModifierKt.composed($this$imeNestedScroll, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                NestedScrollConnection nestedScrollConnection = WindowInsetsConnection_androidKt.m551rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.INSTANCE.current($composer, 8).getIme(), WindowInsetsSides.INSTANCE.m573getBottomJoeWqyM(), $composer, 48);
                Modifier modifierNestedScroll$default = NestedScrollModifierKt.nestedScroll$default(composed, nestedScrollConnection, null, 2, null);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection m551rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int side, Composer $composer, int $changed) {
        Object value$iv$iv;
        ...
        SideCalculator sideCalculator = SideCalculator.INSTANCE.m511chooseCalculatorni1skBw(side, layoutDirection);
        ...
        EffectsKt.DisposableEffect(connection, new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$rememberWindowInsetsConnection$1
            ...
            public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
                ...
                final WindowInsetsNestedScrollConnection windowInsetsNestedScrollConnection = connection;

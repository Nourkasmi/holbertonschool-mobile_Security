...
interface SideCalculator {
    ...
    long mo509consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo510consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo509consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m2708getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo510consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m5437getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedOffsets-MK-Hz9U */
            public long mo509consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m2709getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo510consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m5438getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m511chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m562equalsimpl0(side, WindowInsetsSides.INSTANCE.m576getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m562equalsimpl0(side, WindowInsetsSides.INSTANCE.m579getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m562equalsimpl0(side, WindowInsetsSides.INSTANCE.m577getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m562equalsimpl0(side, WindowInsetsSides.INSTANCE.m573getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m562equalsimpl0(side, WindowInsetsSides.INSTANCE.m578getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (!WindowInsetsSides.m562equalsimpl0(side, WindowInsetsSides.INSTANCE.m574getEndJoeWqyM())) {

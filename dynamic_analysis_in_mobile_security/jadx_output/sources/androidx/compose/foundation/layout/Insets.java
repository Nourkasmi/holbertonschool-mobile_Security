...
final class Insets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo320roundToPx0680j_4(this.left);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo320roundToPx0680j_4(this.top);
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo320roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo320roundToPx0680j_4(this.bottom);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m5223toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5223toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5223toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5223toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Insets) {
            return Dp.m5217equalsimpl0(this.left, ((Insets) other).left) && Dp.m5217equalsimpl0(this.top, ((Insets) other).top) && Dp.m5217equalsimpl0(this.right, ((Insets) other).right) && Dp.m5217equalsimpl0(this.bottom, ((Insets) other).bottom);
        }
        return false;
    }

    public int hashCode() {
        int result = Dp.m5218hashCodeimpl(this.left);
        return (((((result * 31) + Dp.m5218hashCodeimpl(this.top)) * 31) + Dp.m5218hashCodeimpl(this.right)) * 31) + Dp.m5218hashCodeimpl(this.bottom);
    }
}

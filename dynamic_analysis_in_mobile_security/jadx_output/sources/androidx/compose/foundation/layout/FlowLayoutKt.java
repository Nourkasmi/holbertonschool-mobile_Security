...
public final class FlowLayoutKt {
    ...
    public static final Function5<Integer, int[], LayoutDirection, Density, int[], Unit> getVerticalArrangement(final Arrangement.Vertical verticalArrangement) {
        return new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt.getVerticalArrangement.1
            ...
            public final void invoke(int totalSize, int[] size, LayoutDirection layoutDirection, Density density, int[] outPosition) {
                ...
                Arrangement.Vertical $this$invoke_u24lambda_u240 = verticalArrangement;
    ...
    public static final Function5<Integer, int[], LayoutDirection, Density, int[], Unit> getHorizontalArrangement(final Arrangement.Horizontal horizontalArrangement) {
        return new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt.getHorizontalArrangement.1
            ...
            public final void invoke(int totalSize, int[] size, LayoutDirection layoutDirection, Density density, int[] outPosition) {
                ...
                Intrinsics.checkNotNullParameter(density, "density");
                Intrinsics.checkNotNullParameter(outPosition, "outPosition");
                Arrangement.Horizontal $this$invoke_u24lambda_u240 = horizontalArrangement;
    ...
    public static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int maxItemsInMainAxis, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = m429flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), maxItemsInMainAxis);
    ...
    public static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, int maxItemsInMainAxis, Composer $composer, int $changed) {
        ...
        Object it$iv$iv = $composer.rememberedValue();
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = m429flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), maxItemsInMainAxis);
            $composer.updateRememberedValue(value$iv$iv);
        } else {
            value$iv$iv = it$iv$iv;
        }
    ...
    public static final MeasurePolicy m429flowMeasurePolicybs7tms(final LayoutOrientation orientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float mainAxisArrangementSpacing, final SizeMode crossAxisSize, final CrossAxisAlignment crossAxisAlignment, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function52, final float crossAxisArrangementSpacing, final int maxItemsInMainAxis) {
        return new MeasurePolicy(function5, mainAxisArrangementSpacing, crossAxisSize, crossAxisAlignment, maxItemsInMainAxis, crossAxisArrangementSpacing, function52) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo12measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                int layoutWidth;
                int layoutHeight;
                ...
                final RowColumnMeasurementHelper measureHelper = new RowColumnMeasurementHelper(this.$orientation, this.$mainAxisArrangement, this.$mainAxisArrangementSpacing, this.$crossAxisSize, this.$crossAxisAlignment, measurables, placeables, null);
                long orientationIndependentConstraints = OrientationIndependentConstraints.m450constructorimpl(constraints, this.$orientation);
                final FlowResult flowResult = FlowLayoutKt.m428breakDownItemsw1Onq5I(measure, measureHelper, this.$orientation, orientationIndependentConstraints, this.$maxItemsInMainAxis);
                ...
                int totalCrossAxisSpacing = measure.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing) * (items.getSize() - 1);
                ...
                return MeasureScope.layout$default(measure, ConstraintsKt.m5182constrainWidthK40F9xA(constraints, layoutWidth), ConstraintsKt.m5181constrainHeightK40F9xA(constraints, layoutHeight), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$2
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (this.$orientation == LayoutOrientation.Horizontal) {
                    return minIntrinsicMainAxisSize(measurables, height, $this$minIntrinsicWidth.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicWidth.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
                }
                return intrinsicCrossAxisSize(measurables, height, $this$minIntrinsicWidth.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicWidth.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (this.$orientation == LayoutOrientation.Horizontal) {
                    return intrinsicCrossAxisSize(measurables, width, $this$minIntrinsicHeight.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicHeight.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
                }
                return minIntrinsicMainAxisSize(measurables, width, $this$minIntrinsicHeight.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$minIntrinsicHeight.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (this.$orientation == LayoutOrientation.Horizontal) {
                    return intrinsicCrossAxisSize(measurables, width, $this$maxIntrinsicHeight.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$maxIntrinsicHeight.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
                }
                return maxIntrinsicMainAxisSize(measurables, width, $this$maxIntrinsicHeight.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing));
            }
            ...
            public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (this.$orientation == LayoutOrientation.Horizontal) {
                    return maxIntrinsicMainAxisSize(measurables, height, $this$maxIntrinsicWidth.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing));
                }
                return intrinsicCrossAxisSize(measurables, height, $this$maxIntrinsicWidth.mo320roundToPx0680j_4(this.$mainAxisArrangementSpacing), $this$maxIntrinsicWidth.mo320roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
    ...
    */
    public static final androidx.compose.foundation.layout.FlowResult m428breakDownItemsw1Onq5I(androidx.compose.ui.layout.MeasureScope r30, androidx.compose.foundation.layout.RowColumnMeasurementHelper r31, androidx.compose.foundation.layout.LayoutOrientation r32, long r33, int r35) {
        /*
            Method dump skipped, instruction units count: 435
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.FlowLayoutKt.m428breakDownItemsw1Onq5I(androidx.compose.ui.layout.MeasureScope, androidx.compose.foundation.layout.RowColumnMeasurementHelper, androidx.compose.foundation.layout.LayoutOrientation, long, int):androidx.compose.foundation.layout.FlowResult");
    }
    ...
    private static final int m430measureAndCache6m2dt9o(Measurable $this$measureAndCache_u2d6m2dt9o, long constraints, LayoutOrientation orientation, Function1<? super Placeable, Unit> function1) {
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData($this$measureAndCache_u2d6m2dt9o)) == 0.0f) {
            Placeable placeable = $this$measureAndCache_u2d6m2dt9o.mo4183measureBRTryo0(OrientationIndependentConstraints.m463toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m451copyyUG9Ft0(constraints, (8 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : 0, (8 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : 0, (8 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : 0, (8 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : 0), orientation));

...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        if (height != 0) {
            long childConstraints = Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : height, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : height);

...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo238measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return AlignmentLineKt.m361alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, !TextUnitKt.m5411isUnspecifiedR2X_6o(this.before) ? measure.mo321toDpGaN1DYA(this.before) : Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM(), !TextUnitKt.m5411isUnspecifiedR2X_6o(this.after) ? measure.mo321toDpGaN1DYA(this.after) : Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM(), measurable, constraints);
    }
}

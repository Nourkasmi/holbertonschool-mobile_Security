...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m445setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m446setY0680j_4(float f) {
        this.y = f;
    }
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable, measure.mo320roundToPx0680j_4(this.this$0.getX()), measure.mo320roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeable, measure.mo320roundToPx0680j_4(this.this$0.getX()), measure.mo320roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }

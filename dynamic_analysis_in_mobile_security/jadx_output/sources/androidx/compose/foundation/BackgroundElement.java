...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public /* synthetic */ BackgroundElement(long j, Brush brush, float f, Shape shape, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM2983getUnspecified0d7_KjU;
        Brush brush2;
        if ((i & 1) == 0) {
            jM2983getUnspecified0d7_KjU = j;
        } else {
            jM2983getUnspecified0d7_KjU = Color.INSTANCE.m2983getUnspecified0d7_KjU();
        }
        if ((i & 2) == 0) {
            brush2 = brush;
        } else {
        ...
        this(jM2983getUnspecified0d7_KjU, brush2, f, shape, function1, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (otherModifier != null && Color.m2948equalsimpl0(this.color, otherModifier.color) && Intrinsics.areEqual(this.brush, otherModifier.brush)) {

...
public final class BorderKt {
    ...
    public static final DrawResult m174drawRectBorderNsqcLGU(CacheDrawScope $this$drawRectBorder_u2dNsqcLGU, final Brush brush, long topLeft, long borderSize, boolean fillArea, float strokeWidthPx) {
        final long rectTopLeft = fillArea ? Offset.INSTANCE.m2724getZeroF1C5BW0() : topLeft;
        final long size = fillArea ? $this$drawRectBorder_u2dNsqcLGU.m2614getSizeNHjbRc() : borderSize;
        ...
        return $this$drawRectBorder_u2dNsqcLGU.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.m3483drawRectAsUm42w$default(onDrawWithContent, brush, rectTopLeft, size, 0.0f, style, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            ...
            targetPath.mo2841opN5in7k0(targetPath, insetPath, PathOperation.INSTANCE.m3231getDifferenceb3I0S0c());
        }
        return targetPath;
    }

    private static final RoundRect createInsetRoundedRect(float widthPx, RoundRect roundedRect) {
        return new RoundRect(widthPx, widthPx, roundedRect.getWidth() - widthPx, roundedRect.getHeight() - widthPx, m175shrinkKibmq7A(roundedRect.m2758getTopLeftCornerRadiuskKHJgLs(), widthPx), m175shrinkKibmq7A(roundedRect.m2759getTopRightCornerRadiuskKHJgLs(), widthPx), m175shrinkKibmq7A(roundedRect.m2757getBottomRightCornerRadiuskKHJgLs(), widthPx), m175shrinkKibmq7A(roundedRect.m2756getBottomLeftCornerRadiuskKHJgLs(), widthPx), null);
    }
    ...
    public static final long m175shrinkKibmq7A(long $this$shrink_u2dKibmq7A, float value) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m2683getXimpl($this$shrink_u2dKibmq7A) - value), Math.max(0.0f, CornerRadius.m2684getYimpl($this$shrink_u2dKibmq7A) - value));
    }
}

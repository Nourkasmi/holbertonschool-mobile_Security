...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.dispatcher.getCoroutineScope(), null, null, new C05451(toBeConsumed, null), 3, null);
        return false;
    }
    ...
    static final class C05451 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05451(long j, Continuation<? super C05451> continuation) {
            super(2, continuation);
            this.$toBeConsumed = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidViewHolder.this.new C05451(this.$toBeConsumed, continuation);
        }

...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, boolean ellipsis) {
        ...
        int i = 0;
        if (!(Constraints.m5170getMinWidthimpl(constraints) == 0 && Constraints.m5169getMinHeightimpl(constraints) == 0)) {
        ...
        while (index < size) {
            ParagraphIntrinsicInfo paragraphInfo = infoList$ui_text_release.get(index);
            ...
            if (Constraints.m5163getHasBoundedHeightimpl(constraints)) {
                iM5167getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m5167getMaxHeightimpl(constraints) - ParagraphKt.ceilToInt(currentHeight), i);
            } else {
                iM5167getMaxHeightimpl = Constraints.m5167getMaxHeightimpl(constraints);
            }
            Paragraph paragraph = ParagraphKt.m4621Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, iM5168getMaxWidthimpl, 0, iM5167getMaxHeightimpl, 5, null), this.maxLines - currentLineCount2, ellipsis);
        ...
        this.width = Constraints.m5168getMaxWidthimpl(constraints);
        ...
        while (index$iv$iv < size2) {
            ...
            List<Rect> placeholderRects = $this$lambda_u244_u24lambda_u2432.getParagraph().getPlaceholderRects();
            Iterable target$iv2 = new ArrayList(placeholderRects.size());
            int size3 = placeholderRects.size();
            float currentHeight2 = currentHeight;
            int index$iv$iv2 = 0;
            while (index$iv$iv2 < size3) {
                Object item$iv$iv2 = placeholderRects.get(index$iv$iv2);
                int i2 = size3;
    ...
    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(multiParagraphIntrinsics, j, i3, z2, null);
    }
    ...
    public final /* synthetic */ void m4612paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.getParagraph().mo4584paintRPmYEkk(canvas, color, shadow, decoration);
    ...
    public final void m4611paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = list.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo4583paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m4613painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        AndroidMultiParagraphDrawKt.m4945drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(int start, int end) {
        ...
        for (int i = paragraphIndex; i < size; i++) {
            ...
            if (p.getStartIndex() != p.getEndIndex()) {
                Path.m3210addPathUv8p0NA$default(path, p.toGlobal(p.getParagraph().getPathForRange(p.toLocalIndex(start), p.toLocalIndex(end))), 0L, 2, null);
            }
        }
        return path;
    }
    ...
    public final int m4609getOffsetForPositionk4lQ0M(long position) {
        int paragraphIndex;
        if (Offset.m2709getYimpl(position) <= 0.0f) {
            paragraphIndex = 0;
        } else {
            paragraphIndex = Offset.m2709getYimpl(position) >= this.height ? CollectionsKt.getLastIndex(this.paragraphInfoList) : MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m2709getYimpl(position));
        }
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.getParagraph().mo4581getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.m4618toLocalMKHz9U(position)));
    }
    ...
    public final long m4610getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            paragraphIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        return $this$getWordBoundary__jx7JFs_u24lambda_u2417.m4617toGlobalGEjPoXI($this$getWordBoundary__jx7JFs_u24lambda_u2417.getParagraph().mo4582getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u2417.toLocalIndex(offset)));
    }

...
public final class TextPainterKt {
    ...
    public static final void m4700drawTextJFhB2K4(DrawScope drawText, TextMeasurer textMeasurer, AnnotatedString text, long topLeft, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long size, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(placeholders, "placeholders");
        TextLayoutResult textLayoutResult = TextMeasurer.m4697measurexDpz5zY$default(textMeasurer, text, style, overflow, softWrap, maxLines, placeholders, m4708textLayoutConstraintsv_w8tDc(drawText, size, topLeft), drawText.getLayoutDirection(), drawText, null, false, 1536, null);
        DrawContext $this$withTransform_u24lambda_u246$iv = drawText.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
        ...
        $this$drawText_JFhB2K4_u24lambda_u240.translate(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft));
        clip($this$drawText_JFhB2K4_u24lambda_u240, textLayoutResult);
        textLayoutResult.getMultiParagraph().m4611paintLG529CI(drawText.getDrawContext().getCanvas(), (32 & 2) != 0 ? Color.INSTANCE.m2983getUnspecified0d7_KjU() : 0L, (32 & 4) != 0 ? null : null, (32 & 8) != 0 ? null : null, (32 & 16) == 0 ? null : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m3490getDefaultBlendMode0nO6VwU() : blendMode);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3415setSizeuvyYCjk(previousSize$iv);
    }

    /* JADX INFO: renamed from: drawText-TPWCCtM, reason: not valid java name */
    public static final void m4704drawTextTPWCCtM(DrawScope drawText, TextMeasurer textMeasurer, String text, long topLeft, TextStyle style, int overflow, boolean softWrap, int maxLines, long size, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        Intrinsics.checkNotNullParameter(textMeasurer, "textMeasurer");
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        TextLayoutResult textLayoutResult = TextMeasurer.m4697measurexDpz5zY$default(textMeasurer, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, m4708textLayoutConstraintsv_w8tDc(drawText, size, topLeft), drawText.getLayoutDirection(), drawText, null, false, 1568, null);
        DrawContext $this$withTransform_u24lambda_u246$iv = drawText.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        DrawTransform $this$drawText_TPWCCtM_u24lambda_u242 = $this$withTransform_u24lambda_u246$iv.getTransform();
        $this$drawText_TPWCCtM_u24lambda_u242.translate(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft));
    ...
    */
    ...
    public static final void m4702drawTextLVfH_YU(DrawScope drawText, TextLayoutResult textLayoutResult, Brush brush, long topLeft, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(drawText, "$this$drawText");
        ...
        $this$drawText_LVfH_YU_u24lambda_u247.translate(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft));
        clip($this$drawText_LVfH_YU_u24lambda_u247, textLayoutResult);
        textLayoutResult.getMultiParagraph().m4613painthn5TExg(drawText.getDrawContext().getCanvas(), brush, !Float.isNaN(alpha) ? alpha : textLayoutResult.getLayoutInput().getStyle().getAlpha(), newShadow, newTextDecoration, newDrawStyle, blendMode);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3415setSizeuvyYCjk(previousSize$iv);
    }

    private static final void clip(DrawTransform $this$clip, TextLayoutResult textLayoutResult) {
        if (textLayoutResult.getHasVisualOverflow() && !TextOverflow.m5124equalsimpl0(textLayoutResult.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m5133getVisiblegIe3tQ8())) {
            DrawTransform.m3540clipRectN_I0leg$default($this$clip, 0.0f, 0.0f, IntSize.m5372getWidthimpl(textLayoutResult.getSize()), IntSize.m5371getHeightimpl(textLayoutResult.getSize()), 0, 16, null);
        }
    }

    /* JADX INFO: renamed from: textLayoutConstraints-v_w8tDc, reason: not valid java name */
    private static final long m4708textLayoutConstraintsv_w8tDc(DrawScope $this$textLayoutConstraints_u2dv_w8tDc, long size, long topLeft) {
        int minWidth;
        int maxWidth;
        int minHeight;
        int maxHeight;
        boolean z = true;
        boolean isWidthNaN = ((size > Size.INSTANCE.m2785getUnspecifiedNHjbRc() ? 1 : (size == Size.INSTANCE.m2785getUnspecifiedNHjbRc() ? 0 : -1)) == 0) || Float.isNaN(Size.m2777getWidthimpl(size));
        if (isWidthNaN) {
            minWidth = 0;
            maxWidth = MathKt.roundToInt((float) Math.ceil(Size.m2777getWidthimpl($this$textLayoutConstraints_u2dv_w8tDc.mo3489getSizeNHjbRc()) - Offset.m2708getXimpl(topLeft)));
        } else {
            int fixedWidth = MathKt.roundToInt((float) Math.ceil(Size.m2777getWidthimpl(size)));
            minWidth = fixedWidth;
            maxWidth = fixedWidth;
        }
        if ((size == Size.INSTANCE.m2785getUnspecifiedNHjbRc() ? 1 : 0) == 0 && !Float.isNaN(Size.m2774getHeightimpl(size))) {
            z = false;
        }
        boolean isHeightNaN = z;
        if (isHeightNaN) {
            minHeight = 0;
            maxHeight = MathKt.roundToInt((float) Math.ceil(Size.m2774getHeightimpl($this$textLayoutConstraints_u2dv_w8tDc.mo3489getSizeNHjbRc()) - Offset.m2709getYimpl(topLeft)));
        } else {
            int fixedHeight = MathKt.roundToInt((float) Math.ceil(Size.m2774getHeightimpl(size)));

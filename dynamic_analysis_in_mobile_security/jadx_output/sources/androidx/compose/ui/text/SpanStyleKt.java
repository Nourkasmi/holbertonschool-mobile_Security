...
public final class SpanStyleKt {
    ...
    private static final long DefaultBackgroundColor = Color.INSTANCE.m2982getTransparent0d7_KjU();
    private static final long DefaultColor = Color.INSTANCE.m2973getBlack0d7_KjU();

    /* JADX INFO: renamed from: lerpTextUnitInheritable-C3pnCVY, reason: not valid java name */
    public static final long m4686lerpTextUnitInheritableC3pnCVY(long a, long b, float t) {
        if (TextUnitKt.m5411isUnspecifiedR2X_6o(a) || TextUnitKt.m5411isUnspecifiedR2X_6o(b)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m5383boximpl(a), TextUnit.m5383boximpl(b), t)).getPackedValue();
        }
        return TextUnitKt.m5413lerpC3pnCVY(a, b, t);
    }
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float fraction) {
        ...
        long jM4686lerpTextUnitInheritableC3pnCVY = m4686lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), fraction);
        ...
        long jM4686lerpTextUnitInheritableC3pnCVY2 = m4686lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), fraction);
        BaselineShift baselineShift = start.getBaselineShift();
        float fM4983unboximpl = baselineShift != null ? baselineShift.m4983unboximpl() : BaselineShift.m4978constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float fM4990lerpjWV1Mfo = BaselineShiftKt.m4990lerpjWV1Mfo(fM4983unboximpl, baselineShift2 != null ? baselineShift2.m4983unboximpl() : BaselineShift.m4978constructorimpl(0.0f), fraction);
        ...
        long jM2998lerpjxsXWHM = ColorKt.m2998lerpjxsXWHM(start.getBackground(), stop.getBackground(), fraction);
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        TextForegroundStyle textForegroundStyleTakeOrElse = style.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt.resolveSpanStyleDefaults.1
            ...
            public final TextForegroundStyle invoke() {
                return TextForegroundStyle.INSTANCE.m5103from8_81llA(SpanStyleKt.DefaultColor);
            }
        });
        long fontSize = TextUnitKt.m5411isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis fontSynthesisM4823boximpl = FontSynthesis.m4823boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4832getAllGVVA2EU());
        ...
        if (TextUnitKt.m5411isUnspecifiedR2X_6o(style.getLetterSpacing())) {
            letterSpacing = DefaultLetterSpacing;
        } else {
            letterSpacing = style.getLetterSpacing();
        }
        BaselineShift baselineShift = style.getBaselineShift();
        BaselineShift baselineShiftM4977boximpl = BaselineShift.m4977boximpl(baselineShift != null ? baselineShift.m4983unboximpl() : BaselineShift.INSTANCE.m4987getNoney9eOQZs());
        ...
        long j = ($this$takeOrElse_u2dDxMtmZc$iv > Color.INSTANCE.m2983getUnspecified0d7_KjU() ? 1 : ($this$takeOrElse_u2dDxMtmZc$iv == Color.INSTANCE.m2983getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? $this$takeOrElse_u2dDxMtmZc$iv : DefaultBackgroundColor;
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM4814boximpl, fontSynthesisM4823boximpl, fontFamily2, str, letterSpacing, baselineShiftM4977boximpl, textGeometricTransform2, localeList2, j, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Removed duplicated region for block: B:116:0x01fc A[RETURN] */
    ...
    */
    public static final androidx.compose.ui.text.SpanStyle m4685fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle r39, long r40, androidx.compose.ui.graphics.Brush r42, float r43, long r44, androidx.compose.ui.text.font.FontWeight r46, androidx.compose.ui.text.font.FontStyle r47, androidx.compose.ui.text.font.FontSynthesis r48, androidx.compose.ui.text.font.FontFamily r49, java.lang.String r50, long r51, androidx.compose.ui.text.style.BaselineShift r53, androidx.compose.ui.text.style.TextGeometricTransform r54, androidx.compose.ui.text.intl.LocaleList r55, long r56, androidx.compose.ui.text.style.TextDecoration r58, androidx.compose.ui.graphics.Shadow r59, androidx.compose.ui.text.PlatformSpanStyle r60, androidx.compose.ui.graphics.drawscope.DrawStyle r61) {
        /*
            Method dump skipped, instruction units count: 751
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.SpanStyleKt.m4685fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle, long, androidx.compose.ui.graphics.Brush, float, long, androidx.compose.ui.text.font.FontWeight, androidx.compose.ui.text.font.FontStyle, androidx.compose.ui.text.font.FontSynthesis, androidx.compose.ui.text.font.FontFamily, java.lang.String, long, androidx.compose.ui.text.style.BaselineShift, androidx.compose.ui.text.style.TextGeometricTransform, androidx.compose.ui.text.intl.LocaleList, long, androidx.compose.ui.text.style.TextDecoration, androidx.compose.ui.graphics.Shadow, androidx.compose.ui.text.PlatformSpanStyle, androidx.compose.ui.graphics.drawscope.DrawStyle):androidx.compose.ui.text.SpanStyle");
    }

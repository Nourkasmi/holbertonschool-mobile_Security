...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m5062getProportionalPIaL0Z0(), Trim.INSTANCE.m5073getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LineHeightStyle) && Alignment.m5056equalsimpl0(this.alignment, ((LineHeightStyle) other).alignment) && Trim.m5067equalsimpl0(this.trim, ((LineHeightStyle) other).trim);
    }

    public int hashCode() {
        int result = Alignment.m5057hashCodeimpl(this.alignment);
        return (result * 31) + Trim.m5068hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m5058toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m5071toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m5065constructorimpl(1);
        private static final int LastLineBottom = m5065constructorimpl(16);
        private static final int Both = m5065constructorimpl(17);
        private static final int None = m5065constructorimpl(0);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m5064boximpl(int i) {
            return new Trim(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        private static int m5065constructorimpl(int i) {
            return i;
        }
        ...
        public boolean equals(Object obj) {
            return m5066equalsimpl(this.value, obj);
        }
        ...
        public static String m5071toStringimpl(int arg0) {
    ...
    public static final class Alignment {
        ...
        /* JADX INFO: renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m5054constructorimpl(0.0f);
        private static final float Center = m5054constructorimpl(0.5f);
        private static final float Proportional = m5054constructorimpl(-1.0f);
        private static final float Bottom = m5054constructorimpl(1.0f);

        /* JADX INFO: renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m5053boximpl(float f) {
            return new Alignment(f);
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m5055equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5056equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m5057hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object obj) {
            return m5055equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m5057hashCodeimpl(this.topRatio);
        }
        ...
        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static float m5054constructorimpl(float topRatio) {
            boolean z = true;
        ...
        public String toString() {
            return m5058toStringimpl(this.topRatio);
        }

        /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
        public static String m5058toStringimpl(float arg0) {
            if (arg0 == Top) {

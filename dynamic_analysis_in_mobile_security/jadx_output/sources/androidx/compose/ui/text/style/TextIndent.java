...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m5104copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m5105copyNB67dxo(j, j2);
    }

    /* JADX INFO: renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m5105copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextIndent) && TextUnit.m5390equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m5390equalsimpl0(this.restLine, ((TextIndent) other).restLine);
    }

    public int hashCode() {
        int result = TextUnit.m5394hashCodeimpl(this.firstLine);
        return (result * 31) + TextUnit.m5394hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m5400toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m5400toStringimpl(this.restLine)) + ')';
    }
}

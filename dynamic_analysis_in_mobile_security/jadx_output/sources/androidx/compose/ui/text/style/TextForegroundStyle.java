...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo4991getColor0d7_KjU() {
            return Color.INSTANCE.m2983getUnspecified0d7_KjU();
        }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m5103from8_81llA(long color) {
            return (color > Color.INSTANCE.m2983getUnspecified0d7_KjU() ? 1 : (color == Color.INSTANCE.m2983getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m5103from8_81llA(TextDrawStyleKt.m5102modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }

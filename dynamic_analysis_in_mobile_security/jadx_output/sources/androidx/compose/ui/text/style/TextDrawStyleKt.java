...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        ...
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m5103from8_81llA(ColorKt.m2998lerpjxsXWHM(start.mo4991getColor0d7_KjU(), stop.mo4991getColor0d7_KjU(), fraction));
        }
        if ((start instanceof BrushStyle) && (stop instanceof BrushStyle)) {
    ...
    public static final long m5102modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        return Color.m2945copywmQWz5c($this$modulate_u2dDxMtmZc, (14 & 1) != 0 ? Color.m2949getAlphaimpl($this$modulate_u2dDxMtmZc) : Color.m2949getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, (14 & 2) != 0 ? Color.m2953getRedimpl($this$modulate_u2dDxMtmZc) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl($this$modulate_u2dDxMtmZc) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl($this$modulate_u2dDxMtmZc) : 0.0f);
    }

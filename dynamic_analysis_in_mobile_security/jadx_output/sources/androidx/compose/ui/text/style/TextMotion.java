...
public final class TextMotion {
    ...
    static {
        ...
        Static = new TextMotion(Linearity.INSTANCE.m5118getFontHinting4e0Vf04(), false, defaultConstructorMarker);
        Animated = new TextMotion(Linearity.INSTANCE.m5119getLinear4e0Vf04(), true, defaultConstructorMarker);
    }

    /* JADX INFO: renamed from: copy-JdDtMQo$ui_text_release$default, reason: not valid java name */
    public static /* synthetic */ TextMotion m5108copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m5109copyJdDtMQo$ui_text_release(i, z);
    }

    /* JADX INFO: renamed from: copy-JdDtMQo$ui_text_release, reason: not valid java name */
    public final TextMotion m5109copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m5114equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m5115hashCodeimpl(this.linearity);
    ...
    public static final class Linearity {
        ...
        public static final /* synthetic */ Linearity m5111boximpl(int i) {
            return new Linearity(i);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        private static int m5112constructorimpl(int i) {
            return i;
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m5113equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).getValue();
        }

        /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5114equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
        public static int m5115hashCodeimpl(int i) {
        ...
        public static String m5116toStringimpl(int arg0) {
            return m5114equalsimpl0(arg0, Linear) ? "Linearity.Linear" : m5114equalsimpl0(arg0, FontHinting) ? "Linearity.FontHinting" : m5114equalsimpl0(arg0, None) ? "Linearity.None" : "Invalid";
        }

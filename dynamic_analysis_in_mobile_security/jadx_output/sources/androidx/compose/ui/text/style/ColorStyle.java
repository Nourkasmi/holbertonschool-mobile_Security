...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4992copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m4994copy8_81llA(j);
    }
    ...
    public final ColorStyle m4994copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m2948equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m2955toStringimpl(this.value)) + ')';
    }
    ...
    public final long m4995getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* JADX INFO: renamed from: getColor-0d7_KjU */
    public long mo4991getColor0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m2949getAlphaimpl(mo4991getColor0d7_KjU());
    }
}

...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public float toVariationValue(Density density) {
            if (density != null) {
                return TextUnit.m5393getValueimpl(this.value) * density.getFontScale();
            }
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof SettingTextUnit) && Intrinsics.areEqual(getAxisName(), ((SettingTextUnit) other).getAxisName()) && TextUnit.m5390equalsimpl0(this.value, ((SettingTextUnit) other).value);
        }

        public int hashCode() {
            int result = getAxisName().hashCode();
            return (result * 31) + TextUnit.m5394hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m5400toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m4838opticalSizingR2X_6o(long textSize) {
        if (!TextUnit.m5396isSpimpl(textSize)) {
    ...
    public final Settings m4837Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {

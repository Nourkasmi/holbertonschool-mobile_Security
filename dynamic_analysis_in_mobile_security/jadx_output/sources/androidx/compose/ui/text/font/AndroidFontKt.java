...
public final class AndroidFontKt {
    ...
    public static /* synthetic */ Font m4770FontMuC2MFs$default(String str, AssetManager assetManager, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 16) != 0) {
            settings = FontVariation.INSTANCE.m4837Settings6EWAqTQ(fontWeight, i, new FontVariation.Setting[0]);
        }
        return m4769FontMuC2MFs(str, assetManager, fontWeight, i, settings);
    }

    /* JADX INFO: renamed from: Font-MuC2MFs, reason: not valid java name */
    public static final Font m4769FontMuC2MFs(String path, AssetManager assetManager, FontWeight weight, int style, FontVariation.Settings variationSettings) {
    ...
    public static /* synthetic */ Font m4768FontEj4NQ78$default(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m4766FontEj4NQ78(file, fontWeight, i, settings);
    }

    /* JADX INFO: renamed from: Font-Ej4NQ78, reason: not valid java name */
    public static final Font m4766FontEj4NQ78(File file, FontWeight weight, int style, FontVariation.Settings variationSettings) {
    ...
    /* JADX INFO: renamed from: Font-Ej4NQ78$default, reason: not valid java name */
    public static /* synthetic */ Font m4767FontEj4NQ78$default(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m4765FontEj4NQ78(parcelFileDescriptor, fontWeight, i, settings);
    }

    /* JADX INFO: renamed from: Font-Ej4NQ78, reason: not valid java name */
    public static final Font m4765FontEj4NQ78(ParcelFileDescriptor fileDescriptor, FontWeight weight, int style, FontVariation.Settings variationSettings) {

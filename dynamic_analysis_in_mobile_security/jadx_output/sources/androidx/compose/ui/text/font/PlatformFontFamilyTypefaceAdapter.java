...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo4842createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4860getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo4843createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4860getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo4943getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4860getFontStyle_LCdwA(), typefaceRequest.m4861getFontSynthesisGVVA2EU());
        }

...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m4836synthesizeTypefaceFxwP2eA(int $this$synthesizeTypeface_u2dFxwP2eA, Object typeface, Font font, FontWeight requestedWeight, int requestedStyle) {
        int finalFontWeight;
        ...
        boolean synthesizeStyle = FontSynthesis.m4828isStyleOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !FontStyle.m4817equalsimpl0(requestedStyle, font.getStyle());
        if (!synthesizeStyle && !synthesizeWeight) {
            return typeface;
        }
        if (Build.VERSION.SDK_INT < 28) {
            int targetStyle = AndroidFontUtils_androidKt.getAndroidTypefaceStyle(synthesizeWeight, synthesizeStyle && FontStyle.m4817equalsimpl0(requestedStyle, FontStyle.INSTANCE.m4821getItalic_LCdwA()));
            ...
            if (synthesizeStyle) {
                finalFontStyle = FontStyle.m4817equalsimpl0(requestedStyle, FontStyle.INSTANCE.m4821getItalic_LCdwA());
            } else {
                finalFontStyle = FontStyle.m4817equalsimpl0(font.getStyle(), FontStyle.INSTANCE.m4821getItalic_LCdwA());
            }

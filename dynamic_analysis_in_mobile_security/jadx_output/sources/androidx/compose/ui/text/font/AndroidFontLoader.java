...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        } else if (FontLoadingStrategy.m4804equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4810getOptionalLocalPKNRLFQ())) {
            try {
                ...
                objM5499constructorimpl = Result.m5499constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, context3));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m5505isFailureimpl(objM5499constructorimpl) ? null : objM5499constructorimpl);
        } else {
            if (FontLoadingStrategy.m4804equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m4808getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4806toStringimpl(font.getLoadingStrategy())));
        }

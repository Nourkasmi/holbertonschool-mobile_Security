...
public final class Font extends AndroidPreloadedFont {
    ...
    public /* synthetic */ Font(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i2 & 4) == 0) {
            iM4822getNormal_LCdwA = i;
        } else {
            iM4822getNormal_LCdwA = FontStyle.INSTANCE.m4822getNormal_LCdwA();
        }
        this(file, normal, iM4822getNormal_LCdwA, settings, null);
    }
    ...
    public String toString() {
        return "Font(file=" + this.file + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4819toStringimpl(getStyle())) + ')';
    }
}

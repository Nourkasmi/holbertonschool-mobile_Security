...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view, InputMethodManager inputMethodManager, PlatformTextInput platformTextInput, Executor inputCommandProcessorExecutor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m4941invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m4941invokeKlQnJC8(int it) {
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m4726getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection it = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.createInputConnection.1
            ...
            public void mo4894onImeActionKlQnJC8(int imeAction) {
                TextInputServiceAndroid.this.onImeActionPerformed.invoke(ImeAction.m4865boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.stopInput.2
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m4942invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m4942invokeKlQnJC8(int it) {
            }
        };
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        boolean needUpdateSelection = (TextRange.m4714equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (needUpdateSelection) {
                ...
                int iM4719getMinimpl = TextRange.m4719getMinimpl(newValue.getSelection());
                int iM4718getMaximpl = TextRange.m4718getMaximpl(newValue.getSelection());
                TextRange composition = this.state.getComposition();
                int iM4719getMinimpl2 = composition != null ? TextRange.m4719getMinimpl(composition.getPackedValue()) : -1;
                TextRange composition2 = this.state.getComposition();
                inputMethodManager.updateSelection(iM4719getMinimpl, iM4718getMaximpl, iM4719getMinimpl2, composition2 != null ? TextRange.m4718getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m4714equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            restartInput = true;
        }
        if (restartInput) {
            restartInputImmediately();

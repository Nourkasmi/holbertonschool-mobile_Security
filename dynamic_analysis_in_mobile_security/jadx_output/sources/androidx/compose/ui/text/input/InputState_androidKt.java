...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m4719getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m4718getMaximpl(textFieldValue.getSelection());

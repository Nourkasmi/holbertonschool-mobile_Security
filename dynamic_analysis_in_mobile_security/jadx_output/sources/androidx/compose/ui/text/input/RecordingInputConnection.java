...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int compositionStart = composition != null ? TextRange.m4719getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            int compositionEnd = composition2 != null ? TextRange.m4718getMaximpl(composition2.getPackedValue()) : -1;
            inputMethodManager.updateSelection(TextRange.m4719getMinimpl(state.getSelection()), TextRange.m4718getMaximpl(state.getSelection()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4715getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            switch (editorAction) {
                case 0:
                    imeAction = ImeAction.INSTANCE.m4880getDefaulteUduSuo();
                    break;
                case 1:
                default:
                    ...
                    break;
                case 2:
                    imeAction = ImeAction.INSTANCE.m4882getGoeUduSuo();
                    break;
                case 3:
                    imeAction = ImeAction.INSTANCE.m4886getSearcheUduSuo();
                    break;
                case 4:
                    imeAction = ImeAction.INSTANCE.m4887getSendeUduSuo();
                    break;
                case 5:
                    imeAction = ImeAction.INSTANCE.m4883getNexteUduSuo();
                    break;
                case 6:
                    imeAction = ImeAction.INSTANCE.m4881getDoneeUduSuo();
                    break;
                case 7:
                    imeAction = ImeAction.INSTANCE.m4885getPreviouseUduSuo();
                    break;
            }
            this.eventCallback.mo4894onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4719getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }

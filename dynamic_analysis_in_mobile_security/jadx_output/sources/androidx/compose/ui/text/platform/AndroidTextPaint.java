...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        if (shadow != null && !Intrinsics.areEqual(this.shadow, shadow)) {
            ...
            if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
                ...
                setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m2708getXimpl(this.shadow.getOffset()), Offset.m2709getYimpl(this.shadow.getOffset()), ColorKt.m3001toArgb8_81llA(this.shadow.getColor()));
            }
        }
    }

    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m4958setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
            this.composePaint.mo2828setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }

    /* JADX INFO: renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m4954setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m4957setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:15:0x002f, code lost:
    
        if ((r9 != androidx.compose.ui.geometry.Size.INSTANCE.m2785getUnspecifiedNHjbRc()) != false) goto L17;
     */
    ...
    */
    public final void m4957setBrush12SF9DM(androidx.compose.ui.graphics.Brush r8, long r9, float r11) {
        /*
            r7 = this;
        ...
        L1d:
            ...
            long r5 = r5.m2785getUnspecifiedNHjbRc()
            int r5 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r5 == 0) goto L2e
            goto L2f
        L2e:
        ...
        L49:
            r8.mo2894applyToPq9zytI(r9, r0, r1)
            goto L55
        L4d:
            if (r8 != 0) goto L55
            androidx.compose.ui.graphics.Paint r0 = r7.composePaint
        ...
        L55:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m4957setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        if (drawStyle != null && !Intrinsics.areEqual(this.drawStyle, drawStyle)) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                this.composePaint.mo2832setStylek9PVt8s(PaintingStyle.INSTANCE.m3207getFillTiuSbCo());
                return;
            }
            if (drawStyle instanceof Stroke) {
                this.composePaint.mo2832setStylek9PVt8s(PaintingStyle.INSTANCE.m3208getStrokeTiuSbCo());
                ...
                this.composePaint.mo2831setStrokeJoinWw9F2mQ(((Stroke) drawStyle).getJoin());
                this.composePaint.mo2830setStrokeCapBeK7IIE(((Stroke) drawStyle).getCap());
    ...
    public final int m4955getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* JADX INFO: renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m4956setBlendModes9anfk8(int i) {
        this.composePaint.mo2827setBlendModes9anfk8(i);
    }
}

...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString $this$toAccessibilitySpannableString, Density density, FontFamily.Resolver fontFamilyResolver, URLSpanCache urlSpanCache) {
        ...
        List<AnnotatedString.Range<SpanStyle>> spanStylesOrNull$ui_text_release = $this$toAccessibilitySpannableString.getSpanStylesOrNull$ui_text_release();
        if (spanStylesOrNull$ui_text_release != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                SpanStyle noFontStyle = SpanStyle.m4671copyGSF8kmg$default(style, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null);
    ...
    private static final void setSpanStyle(SpannableString $this$setSpanStyle, SpanStyle spanStyle, int start, int end, Density density, FontFamily.Resolver fontFamilyResolver) {
        SpannableExtensions_androidKt.m4968setColorRPmYEkk($this$setSpanStyle, spanStyle.m4680getColor0d7_KjU(), start, end);
        SpannableExtensions_androidKt.m4969setFontSizeKmRG4DE($this$setSpanStyle, spanStyle.getFontSize(), density, start, end);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            int fontStyle2 = fontStyle != null ? fontStyle.m4820unboximpl() : FontStyle.INSTANCE.m4822getNormal_LCdwA();
            $this$setSpanStyle.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m4771getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle2)), start, end, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m4791resolveDPcqOEQ$default(fontFamilyResolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4832getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m4966setBackgroundRPmYEkk($this$setSpanStyle, spanStyle.getBackground(), start, end);
    }
}

...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    */
    ...
    public Typeface mo4943getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m4813matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object objM4836synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m4836synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(objM4836synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) objM4836synthesizeTypefaceFxwP2eA;
    }
}

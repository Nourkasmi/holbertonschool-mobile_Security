...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        ...
        if (textIndent != null) {
            if ((!TextUnit.m5390equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m5390equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m5411isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m5411isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long jM5392getTypeUIouoOA = TextUnit.m5392getTypeUIouoOA(textIndent.getFirstLine());
                float fM5393getValueimpl = 0.0f;
                if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5426getSpUIouoOA())) {
                    firstLine = density.mo325toPxR2X_6o(textIndent.getFirstLine());
                } else {
                    firstLine = TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5425getEmUIouoOA()) ? TextUnit.m5393getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long jM5392getTypeUIouoOA2 = TextUnit.m5392getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA2, TextUnitType.INSTANCE.m5426getSpUIouoOA())) {
                    fM5393getValueimpl = density.mo325toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA2, TextUnitType.INSTANCE.m5425getEmUIouoOA())) {
                    fM5393getValueimpl = TextUnit.m5393getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
                float restLine = fM5393getValueimpl;
    ...
    public static final void m4970setLineHeightKmRG4DE(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float resolvedLineHeight = m4965resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
            ...
            setSpan(setLineHeight, new LineHeightStyleSpan(resolvedLineHeight, 0, endIndex, LineHeightStyle.Trim.m5069isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m5070isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
        }
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m4971setLineHeightr9BaKPg(Spannable setLineHeight, long lineHeight, float contextFontSize, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float resolvedLineHeight = m4965resolveLineHeightInPxo2QH7mI(lineHeight, contextFontSize, density);
        if (!Float.isNaN(resolvedLineHeight)) {
    ...
    private static final float m4965resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long jM5392getTypeUIouoOA = TextUnit.m5392getTypeUIouoOA(lineHeight);
        if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5426getSpUIouoOA())) {
            return density.mo325toPxR2X_6o(lineHeight);
        }
        if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5425getEmUIouoOA())) {
            return TextUnit.m5393getValueimpl(lineHeight) * contextFontSize;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable $this$setSpanStyles, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        ...
        if (hasLetterSpacing) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < $this$setSpanStyles.length() && end2 > start2 && end2 <= $this$setSpanStyles.length() && (it = m4964createLetterSpacingSpaneAf_CNQ(style.getLetterSpacing(), density)) != null) {
    ...
    private static final void setSpanStyle(Spannable $this$setSpanStyle, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m4967setBaselineShift0ocSgnM($this$setSpanStyle, style.getBaselineShift(), start, end);
        m4968setColorRPmYEkk($this$setSpanStyle, style.m4680getColor0d7_KjU(), start, end);
        ...
        m4969setFontSizeKmRG4DE($this$setSpanStyle, style.getFontSize(), density, start, end);
        ...
        m4966setBackgroundRPmYEkk($this$setSpanStyle, style.getBackground(), start, end);
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(contextTextStyle)) {
            contextFontSpanStyle = new SpanStyle(0L, 0L, contextTextStyle.getFontWeight(), contextTextStyle.m4744getFontStyle4Lr2A7w(), contextTextStyle.m4745getFontSynthesisZQGJjVo(), contextTextStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                FontStyle fontStyleM4814boximpl = FontStyle.m4814boximpl(fontStyle != null ? fontStyle.m4820unboximpl() : FontStyle.INSTANCE.m4822getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM4814boximpl, FontSynthesis.m4823boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4832getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
        ...
        while (i < length) {
            ...
            if (transitionOffset == lastTransitionOffsets) {
                ...
                while (index$iv2 < size2) {
                    Object item$iv2 = spanStyles.get(index$iv2);
    ...
    private static final MetricAffectingSpan m4964createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long jM5392getTypeUIouoOA = TextUnit.m5392getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5426getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo325toPxR2X_6o(letterSpacing));
        }
        if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5425getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5393getValueimpl(letterSpacing));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle $this$needsLetterSpacingSpan) {
        return TextUnitType.m5421equalsimpl0(TextUnit.m5392getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m5426getSpUIouoOA()) || TextUnitType.m5421equalsimpl0(TextUnit.m5392getTypeUIouoOA($this$needsLetterSpacingSpan.getLetterSpacing()), TextUnitType.INSTANCE.m5425getEmUIouoOA());
    }

    private static final void setShadow(Spannable $this$setShadow, Shadow shadow, int start, int end) {
        if (shadow != null) {
            setSpan($this$setShadow, new ShadowSpan(ColorKt.m3001toArgb8_81llA(shadow.getColor()), Offset.m2708getXimpl(shadow.getOffset()), Offset.m2709getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), start, end);
        }
    }
    ...
    public static final void m4966setBackgroundRPmYEkk(Spannable setBackground, long color, int start, int end) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (color != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m3001toArgb8_81llA(color)), start, end);
        }
    }
    ...
    public static final void m4969setFontSizeKmRG4DE(Spannable setFontSize, long fontSize, Density density, int start, int end) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long jM5392getTypeUIouoOA = TextUnit.m5392getTypeUIouoOA(fontSize);
        if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5426getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo325toPxR2X_6o(fontSize)), false), start, end);
        } else if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5425getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5393getValueimpl(fontSize)), start, end);
        }
    }
    ...
    public static final void m4968setColorRPmYEkk(Spannable setColor, long color, int start, int end) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (color != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m3001toArgb8_81llA(color)), start, end);
        }
    }

    /* JADX INFO: renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m4967setBaselineShift0ocSgnM(Spannable $this$setBaselineShift_u2d0ocSgnM, BaselineShift baselineShift, int start, int end) {
        if (baselineShift != null) {
            float it = baselineShift.m4983unboximpl();
    ...
    private static final void setBrush(Spannable $this$setBrush, Brush brush, float alpha, int start, int end) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m4968setColorRPmYEkk($this$setBrush, ((SolidColor) brush).getValue(), start, end);
    ...
    private static final boolean hasFontAttributes(TextStyle $this$hasFontAttributes) {
        return TextPaintExtensions_androidKt.hasFontAttributes($this$hasFontAttributes.toSpanStyle()) || $this$hasFontAttributes.m4745getFontSynthesisZQGJjVo() != null;
    }

...
public final class PlaceholderExtensions_androidKt {
    ...
    private static /* synthetic */ void m4961getSpanUnitR2X_6o$annotations(long j) {
    }

    /* JADX INFO: renamed from: getSpanVerticalAlign-do9X-Gg$annotations, reason: not valid java name */
    private static /* synthetic */ void m4963getSpanVerticalAligndo9XGg$annotations(int i) {
    }
    ...
    private static final void setPlaceholder(Spannable $this$setPlaceholder, Placeholder placeholder, int start, int end, Density density) {
        ...
        SpannableExtensions_androidKt.setSpan($this$setPlaceholder, new PlaceholderSpan(TextUnit.m5393getValueimpl(placeholder.getWidth()), m4960getSpanUnitR2X_6o(placeholder.getWidth()), TextUnit.m5393getValueimpl(placeholder.getHeight()), m4960getSpanUnitR2X_6o(placeholder.getHeight()), density.getDensity() * density.getFontScale(), m4962getSpanVerticalAligndo9XGg(placeholder.getPlaceholderVerticalAlign())), start, end);
    }

    /* JADX INFO: renamed from: getSpanUnit--R2X_6o, reason: not valid java name */
    private static final int m4960getSpanUnitR2X_6o(long $this$spanUnit) {
        long jM5392getTypeUIouoOA = TextUnit.m5392getTypeUIouoOA($this$spanUnit);
        if (TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5426getSpUIouoOA())) {
            return 0;
        }
        return TextUnitType.m5421equalsimpl0(jM5392getTypeUIouoOA, TextUnitType.INSTANCE.m5425getEmUIouoOA()) ? 1 : 2;
    }

    /* JADX INFO: renamed from: getSpanVerticalAlign-do9X-Gg, reason: not valid java name */
    private static final int m4962getSpanVerticalAligndo9XGg(int $this$spanVerticalAlign) {
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4652getAboveBaselineJ6kI3mc())) {
            return 0;
        }
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4658getTopJ6kI3mc())) {
            return 1;
        }
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4653getBottomJ6kI3mc())) {
            return 2;
        }
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4654getCenterJ6kI3mc())) {
            return 3;
        }
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4657getTextTopJ6kI3mc())) {
            return 4;
        }
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4655getTextBottomJ6kI3mc())) {
            return 5;
        }
        if (PlaceholderVerticalAlign.m4648equalsimpl0($this$spanVerticalAlign, PlaceholderVerticalAlign.INSTANCE.m4656getTextCenterJ6kI3mc())) {
            return 6;
        }

...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4943getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface typefaceDefaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m4771getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4817equalsimpl0(fontStyle, FontStyle.INSTANCE.m4821getItalic_LCdwA()));
    }
}

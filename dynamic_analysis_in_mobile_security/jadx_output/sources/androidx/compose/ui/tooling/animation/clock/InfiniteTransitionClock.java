...
/* JADX INFO: compiled from: InfiniteTransitionClock.kt */
...
public final class InfiniteTransitionClock implements ComposeAnimationClock<InfiniteTransitionComposeAnimation, TargetState<Object>> {
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = getAnimation().m5141getAnimationObject().getAnimations();
    ...
    public long getMaxDurationPerIteration() {
        Long l;
        Iterator<T> it = getAnimation().m5141getAnimationObject().getAnimations().iterator();
        if (it.hasNext()) {
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        InfiniteTransition transition = getAnimation().m5141getAnimationObject();
    ...
    private final <T, V extends AnimationVector> long getIterationDuration(InfiniteTransition.TransitionAnimationState<T, V> transitionAnimationState) {
        ...
        return UtilsKt.millisToNanos(((long) vectorizedDurationBasedAnimationSpecVectorize.getDelayMillis()) + ((long) (vectorizedDurationBasedAnimationSpecVectorize.getDurationMillis() * repeats)));
    }
}

...
/* JADX INFO: compiled from: AnimatedVisibilityState.kt */
...
public final class AnimatedVisibilityState implements ComposeAnimationState {
    ...
    private static final String Enter = m5148constructorimpl("Enter");
    private static final String Exit = m5148constructorimpl("Exit");
    private final String value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AnimatedVisibilityState m5147boximpl(String str) {
        return new AnimatedVisibilityState(str);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static String m5148constructorimpl(String str) {
        return str;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m5149equalsimpl(String str, Object obj) {
        return (obj instanceof AnimatedVisibilityState) && Intrinsics.areEqual(str, ((AnimatedVisibilityState) obj).m5153unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5150equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m5151hashCodeimpl(String str) {
        return str.hashCode();
    }

    public boolean equals(Object obj) {
        return m5149equalsimpl(this.value, obj);
    }
    ...
    public final /* synthetic */ String m5153unboximpl() {
        return this.value;
    }
    ...
    public static String m5152toStringimpl(String arg0) {
        return arg0;
    }

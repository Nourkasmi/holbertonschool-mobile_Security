...
/* JADX INFO: compiled from: AnimateXAsStateClock.kt */
...
public final class AnimateXAsStateClock<T, V extends AnimationVector> implements ComposeAnimationClock<AnimateXAsStateComposeAnimation<T, V>, TargetState<T>> {
    ...
    public AnimateXAsStateClock(AnimateXAsStateComposeAnimation<T, V> animation) {
        ...
        this.state = new TargetState<>(getAnimation().m5138getAnimationObject().getValue(), getAnimation().m5138getAnimationObject().getValue());
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        TargetState<T> parametersToValue = UtilsKt.parseParametersToValue(this.currentValue, par1, par2);
    ...
    private final TargetBasedAnimation<T, V> getCurrentAnimation() {
        return AnimationKt.TargetBasedAnimation(getAnimation().getAnimationSpec(), getAnimation().m5138getAnimationObject().getTypeConverter(), getState().getInitial(), getState().getTarget(), getAnimation().m5138getAnimationObject().getVelocity());
    }
}

...
/* JADX INFO: compiled from: AnimationSearch.kt */
...
public final class AnimationSearch {
    ...
    public final void findAll(Collection<? extends Group> slotTrees) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            List<Group> listFindAll = PreviewUtilsKt.findAll(tree, new Function1<Group, Boolean>() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$findAll$1$groupsWithLocation$1
                @Override // kotlin.jvm.functions.Function1
    ...
    public static final class InfiniteTransitionSearch extends Search<InfiniteTransitionSearchInfo> {
        ...
        private final List<InfiniteTransitionSearchInfo> findAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNullTo$iv$iv) {
                ...
                Collection<Group> children = $this$findData$iv.getChildren();
                Collection<Group> $this$flatMap$iv$iv2 = children;
                ...
                Iterable list$iv$iv$iv = CollectionsKt.plus((Collection) children, destination$iv$iv$iv2);
                Collection destination$iv$iv$iv3 = new ArrayList();
                for (Object element$iv$iv$iv4 : list$iv$iv$iv) {
                    Group it$iv2 = (Group) element$iv$iv$iv4;
    ...
    public static final class AnimateXAsStateSearch extends Search<AnimateXAsStateSearchInfo<?, ?>> {
        ...
        private final <T> List<AnimateXAsStateSearchInfo<T, AnimationVector>> findAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNullTo$iv$iv) {
                ...
                Iterable $this$mapNotNull$iv$iv = it.getChildren();
                Collection destination$iv$iv$iv = new ArrayList();
                Iterator<T> it2 = $this$mapNotNull$iv$iv.iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
                    }
                ...
                for (Object element$iv$iv$iv$iv2 : $this$mapNotNull$iv$iv2) {
                    Iterable $this$mapNotNull$iv$iv3 = $this$mapNotNull$iv$iv2;
                    ...
                    $this$mapNotNull$iv$iv2 = $this$mapNotNull$iv$iv3;
                    $this$mapNotNullTo$iv$iv = $this$mapNotNullTo$iv$iv2;
                }
                ...
                List $this$mapNotNull$iv$iv4 = rememberCalls$iv2;
                Collection destination$iv$iv$iv3 = new ArrayList();
                for (Object element$iv$iv$iv$iv3 : $this$mapNotNull$iv$iv4) {
                    ...
                    Iterable $this$firstOrNull$iv$iv3 = $this$mapNotNull$iv$iv4;
                    ...
                    $this$mapNotNull$iv$iv4 = $this$firstOrNull$iv$iv3;
                    rememberCalls$iv2 = rememberCalls$iv;
                }
                ...
                if (animatableFindAnimatable != null && animationSpecFindAnimationSpec != null && toolingOverride != null) {
                    if (toolingOverride.getValue() == null) {
                        toolingOverride.setValue(new ToolingState(animatableFindAnimatable.getValue()));
                    }
                    Object value = toolingOverride.getValue();
                ...
                if (animateXAsStateSearchInfo != null) {
                    Object it$iv$iv = animateXAsStateSearchInfo;
    ...
    public static final class TransitionSearch extends Search<Transition<?>> {
        ...
        public void addAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (Object element$iv$iv$iv$iv2 : $this$mapNotNull$iv$iv2) {
                ...
                Group groupFirstOrNull = PreviewUtilsKt.firstOrNull(it$iv2, AnimationSearchKt$findRememberedData$rememberCalls$1$1.INSTANCE);

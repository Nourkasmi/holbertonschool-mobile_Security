...
public final class RectKt {
    ...
    public static final Rect m2748Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m2708getXimpl(offset), Offset.m2709getYimpl(offset), Offset.m2708getXimpl(offset) + Size.m2777getWidthimpl(size), Offset.m2709getYimpl(offset) + Size.m2774getHeightimpl(size));
    }

    /* JADX INFO: renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m2746Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m2708getXimpl(topLeft), Offset.m2709getYimpl(topLeft), Offset.m2708getXimpl(bottomRight), Offset.m2709getYimpl(bottomRight));
    }

    /* JADX INFO: renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m2747Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m2708getXimpl(center) - radius, Offset.m2709getYimpl(center) - radius, Offset.m2708getXimpl(center) + radius, Offset.m2709getYimpl(center) + radius);
    }

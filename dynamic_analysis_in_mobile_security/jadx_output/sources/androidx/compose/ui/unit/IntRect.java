...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m5348getSizeYbymL2g$annotations() {
    }
    ...
    public final long m5356getSizeYbymL2g() {
    ...
    public final IntRect m5360translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5330getXimpl(offset), this.top + IntOffset.m5331getYimpl(offset), this.right + IntOffset.m5330getXimpl(offset), this.bottom + IntOffset.m5331getYimpl(offset));
    }
    ...
    public final long m5353getCenternOccac() {
    ...
    public final long m5355getCenterRightnOccac() {
    ...
    public final long m5351getBottomLeftnOccac() {
    ...
    public final long m5350getBottomCenternOccac() {
    ...
    public final long m5352getBottomRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.bottom);
    }

    /* JADX INFO: renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m5349containsgyyYBs(long offset) {
        return IntOffset.m5330getXimpl(offset) >= this.left && IntOffset.m5330getXimpl(offset) < this.right && IntOffset.m5331getYimpl(offset) >= this.top && IntOffset.m5331getYimpl(offset) < this.bottom;
    }

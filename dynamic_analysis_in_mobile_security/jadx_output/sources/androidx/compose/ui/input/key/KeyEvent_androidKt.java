...
public final class KeyEvent_androidKt {
    ...
    public static final long m3932getKeyZmokQxo(android.view.KeyEvent key) {
    ...
    public static final int m3934getUtf16CodePointZmokQxo(android.view.KeyEvent utf16CodePoint) {
    ...
    public static final int m3933getTypeZmokQxo(android.view.KeyEvent type) {
        Intrinsics.checkNotNullParameter(type, "$this$type");
        switch (type.getAction()) {
            case 0:
                return KeyEventType.INSTANCE.m3929getKeyDownCS__XNY();
            case 1:
                return KeyEventType.INSTANCE.m3930getKeyUpCS__XNY();
            default:
                return KeyEventType.INSTANCE.m3931getUnknownCS__XNY();
        }
    }

    /* JADX INFO: renamed from: isAltPressed-ZmokQxo, reason: not valid java name */
    public static final boolean m3935isAltPressedZmokQxo(android.view.KeyEvent isAltPressed) {
    ...
    public static final boolean m3936isCtrlPressedZmokQxo(android.view.KeyEvent isCtrlPressed) {
    ...
    public static final boolean m3937isMetaPressedZmokQxo(android.view.KeyEvent isMetaPressed) {
    ...
    public static final boolean m3938isShiftPressedZmokQxo(android.view.KeyEvent isShiftPressed) {

...
public final class NestedScrollSource {
    ...
    private static final int Drag = m3955constructorimpl(1);
    private static final int Fling = m3955constructorimpl(2);
    private static final int Relocate = m3955constructorimpl(3);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m3954boximpl(int i) {
    ...
    public static String m3959toStringimpl(int arg0) {
        if (m3957equalsimpl0(arg0, Drag)) {
            return "Drag";
        }
        if (m3957equalsimpl0(arg0, Fling)) {
            return "Fling";
        }
        if (m3957equalsimpl0(arg0, Relocate)) {
            return "Relocate";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3961getRelocateWNlRxjI$annotations() {
        }

...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> pointerInputHandler) {
        ...
        this.boundsSize = IntSize.INSTANCE.m5377getZeroYbymL2g();
    }
    ...
    public long mo4100getExtendedTouchPaddingNHjbRc() {
        long minimumTouchTargetSize = mo327toSizeXkaWNTQ(getViewConfiguration().mo4327getMinimumTouchTargetSizeMYxV2XQ());
        long size = getBoundsSize();
        float horizontal = Math.max(0.0f, Size.m2777getWidthimpl(minimumTouchTargetSize) - IntSize.m5372getWidthimpl(size)) / 2.0f;
        float vertical = Math.max(0.0f, Size.m2774getHeightimpl(minimumTouchTargetSize) - IntSize.m5371getHeightimpl(size)) / 2.0f;
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (lock$iv) {
            ...
            continuationCreateCoroutine.resumeWith(Result.m5499constructorimpl(Unit.INSTANCE));
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo3979getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* JADX INFO: renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo3978getExtendedTouchPaddingNHjbRc() {
            return this.this$0.mo4100getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            if (pass == this.awaitPass && (cancellableContinuation = this.pointerAwaiter) != null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m5499constructorimpl(event));
            }
        }
        ...
        */
        public <T> java.lang.Object withTimeout(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) throws java.lang.Throwable {
            ...
            L39:
                ...
                java.lang.Object r4 = kotlin.Result.m5499constructorimpl(r4)
                r3.resumeWith(r4)
            L5d:

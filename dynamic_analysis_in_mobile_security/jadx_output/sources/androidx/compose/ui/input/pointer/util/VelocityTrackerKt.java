...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker $this$addPointerInputChange, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            $this$addPointerInputChange.m4159setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.getPosition());
        ...
        while (index$iv < size) {
            ...
            long historicalDelta = Offset.m2712minusMKHz9U(it.getPosition(), previousPointerPosition);
            previousPointerPosition = it.getPosition();
            $this$addPointerInputChange.m4159setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2713plusMKHz9U($this$addPointerInputChange.getCurrentPointerPositionAccumulator(), historicalDelta));
            $this$addPointerInputChange.m4156addPositionUv8p0NA(it.getUptimeMillis(), $this$addPointerInputChange.getCurrentPointerPositionAccumulator());
            index$iv++;
            historical = historical;
        }
        long delta = Offset.m2712minusMKHz9U(event.getPosition(), previousPointerPosition);
        $this$addPointerInputChange.m4159setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2713plusMKHz9U($this$addPointerInputChange.getCurrentPointerPositionAccumulator(), delta));
        $this$addPointerInputChange.m4156addPositionUv8p0NA(event.getUptimeMillis(), $this$addPointerInputChange.getCurrentPointerPositionAccumulator());
    }

...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(PointerId.m4045boximpl(it.m4078getIdJ3iCeTQ()));
            if (previousData == null) {
                previousTime = it.getUptime();
                previousPosition = it.m4079getPositionF1C5BW0();
                previousDown = false;
                i = size;
            } else {
                ...
                i = size;
                previousPosition = positionCalculator2.mo4146screenToLocalMKHz9U(previousData.getPositionOnScreen());
            }
            changes.put(PointerId.m4045boximpl(it.m4078getIdJ3iCeTQ()), new PointerInputChange(it.m4078getIdJ3iCeTQ(), it.getUptime(), it.m4079getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m4082getTypeT8wyACA(), (List) it.getHistorical(), it.m4081getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (it.getDown()) {
                this.previousPointerInputData.put(PointerId.m4045boximpl(it.m4078getIdJ3iCeTQ()), new PointerInputData(it.getUptime(), it.m4080getPositionOnScreenF1C5BW0(), it.getDown(), it.m4082getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m4045boximpl(it.m4078getIdJ3iCeTQ()));
            }
            index$iv++;

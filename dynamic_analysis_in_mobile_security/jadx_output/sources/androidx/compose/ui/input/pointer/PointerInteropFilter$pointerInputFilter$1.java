...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    */
    public void mo4086onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r19, androidx.compose.ui.input.pointer.PointerEventPass r20, long r21) {
        /*
            r18 = this;
            r0 = r18
            r1 = r20
        ...
        La0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo4086onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
        ...
        if (z) {
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                ...
                if (layoutCoordinates$ui_release != null) {
                    long jMo4192localToRootMKHz9U = layoutCoordinates$ui_release.mo4192localToRootMKHz9U(Offset.INSTANCE.m2724getZeroF1C5BW0());
                    final PointerInteropFilter pointerInteropFilter = this.this$0;
                    PointerInteropUtils_androidKt.m4123toCancelMotionEventScoped4ec7I(pointerEvent, jMo4192localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                        {
                            super(1);
                        }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long jMo4192localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo4192localToRootMKHz9U(Offset.INSTANCE.m2724getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m4124toMotionEventScoped4ec7I(pointerEvent, jMo4192localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3

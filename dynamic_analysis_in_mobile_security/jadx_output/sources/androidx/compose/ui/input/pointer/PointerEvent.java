...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m3999constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m4127constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m4005calculatePointerEventType7fucELk();
    }
    ...
    public final void m4009setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* JADX INFO: renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m4005calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent$ui_release();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
            }
            return PointerEventType.INSTANCE.m4022getPress7fucELk();
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m4023getRelease7fucELk();
            }
            if (PointerEventKt.changedToDownIgnoreConsumed(it)) {
                return PointerEventType.INSTANCE.m4022getPress7fucELk();
            }
        }
        return PointerEventType.INSTANCE.m4021getMove7fucELk();
    }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            map.put(PointerId.m4045boximpl(change.getId()), change);
            ...
            if (internalPointerEvent != null) {
                ...
                z = true;
                if (internalPointerEvent.m3995issuesEnterExitEvent0FcD4WY(change.getId())) {
                }

...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m4083processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m4084processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* JADX INFO: renamed from: process-BIzXfog, reason: not valid java name */
    public final int m4084processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z;
        boolean z2;
        ...
        try {
            ...
            for (Object element$iv2 : $this$forEach$iv) {
                ...
                if (isHover || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
                    boolean isTouchEvent = PointerType.m4136equalsimpl0(pointerInputChange.getType(), PointerType.INSTANCE.m4143getTouchT8wyACA());
                    LayoutNode.m4319hitTestM_7yMNQ$ui_release$default(this.root, pointerInputChange.getPosition(), this.hitResult, isTouchEvent, false, 8, null);
                    if (this.hitResult.isEmpty() ^ z3) {
                        this.hitPathTracker.m3994addHitPathKNwqfcY(pointerInputChange.getId(), this.hitResult);

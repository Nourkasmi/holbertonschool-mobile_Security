...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int initialInputMode, Function1<? super InputMode, Boolean> onRequestInputModeChange) {
        ...
        this.inputMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3607boximpl(initialInputMode), null, 2, null);
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* JADX INFO: renamed from: getInputMode-aOaMEAU */
    public int mo3616getInputModeaOaMEAU() {
    ...
    public void m3618setInputModeiuPiT84(int i) {
        MutableState $this$setValue$iv = this.inputMode;
        $this$setValue$iv.setValue(InputMode.m3607boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* JADX INFO: renamed from: requestInputMode-iuPiT84 */
    public boolean mo3617requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m3607boximpl(inputMode)).booleanValue();
    }
}

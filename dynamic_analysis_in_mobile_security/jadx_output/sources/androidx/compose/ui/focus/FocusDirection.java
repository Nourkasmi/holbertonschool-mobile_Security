...
public final class FocusDirection {
    ...
    private static final int Next = m2625constructorimpl(1);
    private static final int Previous = m2625constructorimpl(2);
    private static final int Left = m2625constructorimpl(3);
    private static final int Right = m2625constructorimpl(4);
    private static final int Up = m2625constructorimpl(5);
    private static final int Down = m2625constructorimpl(6);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FocusDirection m2624boximpl(int i) {
        return new FocusDirection(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m2625constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2626equalsimpl(int i, Object obj) {
        return (obj instanceof FocusDirection) && i == ((FocusDirection) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2627equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2628hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2626equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2628hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m2629toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2629toStringimpl(int arg0) {
        if (m2627equalsimpl0(arg0, Next)) {
            return "Next";
        }
        if (m2627equalsimpl0(arg0, Previous)) {
            return "Previous";
        }
        if (m2627equalsimpl0(arg0, Left)) {
            return "Left";
        }
        if (m2627equalsimpl0(arg0, Right)) {
            return "Right";
        }
        if (m2627equalsimpl0(arg0, Up)) {
            return "Up";
        }
        if (m2627equalsimpl0(arg0, Down)) {
            return "Down";
        }
        if (m2627equalsimpl0(arg0, Enter)) {
            return "Enter";
        }
        if (m2627equalsimpl0(arg0, Exit)) {
            return "Exit";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2631getEnterdhqQ8s$annotations() {
        }

        /* JADX INFO: renamed from: getExit-dhqQ-8s$annotations, reason: not valid java name */
        public static /* synthetic */ void m2632getExitdhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m2633getIndhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m2634getOutdhqQ8s$annotations() {
        }
        ...
        public final int m2638getIndhqQ8s() {
            return FocusDirection.In;
        }

        /* JADX INFO: renamed from: getOut-dhqQ-8s, reason: not valid java name */
        public final int m2641getOutdhqQ8s() {
            return FocusDirection.Out;
        }
    }

    static {
        int iM2625constructorimpl = m2625constructorimpl(7);
        Enter = iM2625constructorimpl;
        int iM2625constructorimpl2 = m2625constructorimpl(8);
        Exit = iM2625constructorimpl2;
        In = iM2625constructorimpl;
        Out = iM2625constructorimpl2;
    }
}

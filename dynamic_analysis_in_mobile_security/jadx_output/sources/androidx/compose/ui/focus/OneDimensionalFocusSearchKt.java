...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m2664oneDimensionalFocusSearchOMvw8(FocusTargetNode oneDimensionalFocusSearch, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        Intrinsics.checkNotNullParameter(oneDimensionalFocusSearch, "$this$oneDimensionalFocusSearch");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2640getNextdhqQ8s())) {
            return forwardFocusSearch(oneDimensionalFocusSearch, onFound);
        }
        if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2642getPreviousdhqQ8s())) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$forwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                if (focusedChild != null) {
                    return forwardFocusSearch(focusedChild, function1) || m2663generateAndSearchChildren4C6V_qg($this$forwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m2640getNextdhqQ8s(), function1);
                }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$backwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                    case 1:
                        if (backwardFocusSearch(focusedChild, function1) || m2663generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m2642getPreviousdhqQ8s(), function1)) {
                            return true;
                        }
                        return focusedChild.fetchFocusProperties$ui_release().getCanFocus() && function1.invoke(focusedChild).booleanValue();
                    case 2:
                    case 3:
                        return m2663generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m2642getPreviousdhqQ8s(), function1);
                    case 4:
                        throw new IllegalStateException(NoActiveChild.toString());
                    default:
                        throw new NoWhenBranchMatchedException();
    ...
    private static final boolean m2663generateAndSearchChildren4C6V_qg(final FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, final FocusTargetNode focusedItem, final int direction, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m2665searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2623searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                ...
                Boolean boolValueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m2665searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1));
    ...
    public static final boolean m2665searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2640getNextdhqQ8s()) || !$this$searchChildren_u2d4C6V_qg.fetchFocusProperties$ui_release().getCanFocus() || isRoot($this$searchChildren_u2d4C6V_qg)) {
            return false;
        }
                    ...
                    if ((node$iv$iv.getKindSet() & iM4398constructorimpl) != 0) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof FocusTargetNode) {
                                ...
                                if (((this_$iv$iv$iv.getKindSet() & iM4398constructorimpl) != 0) && (nodePop instanceof DelegatingNode)) {
                                    int count$iv$iv = 0;
                ...
                while (node$iv$iv$iv != null) {
                    if ((node$iv$iv$iv.getKindSet() & type$iv4) != 0) {
                        ...
                        while (nodePop != null) {
                            ...
                            if (((this_$iv$iv$iv$iv.getKindSet() & type$iv4) != 0 ? z4 : false) && (nodePop instanceof DelegatingNode)) {

...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m2660customFocusSearchOMvw8(FocusTargetNode customFocusSearch, int focusDirection, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2640getNextdhqQ8s())) {
            return focusProperties.getNext();
        }
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2642getPreviousdhqQ8s())) {
            return focusProperties.getPrevious();
        }
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2644getUpdhqQ8s())) {
            return focusProperties.getUp();
        }
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2635getDowndhqQ8s())) {
            return focusProperties.getDown();
        }
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2639getLeftdhqQ8s())) {
        ...
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2643getRightdhqQ8s())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
        ...
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2636getEnterdhqQ8s())) {
            return focusProperties.getEnter().invoke(FocusDirection.m2624boximpl(focusDirection));
        }
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2637getExitdhqQ8s())) {
            return focusProperties.getExit().invoke(FocusDirection.m2624boximpl(focusDirection));
        }
        throw new IllegalStateException("invalid FocusDirection".toString());
    }

    /* JADX INFO: renamed from: focusSearch-sMXa3k8, reason: not valid java name */
    public static final boolean m2661focusSearchsMXa3k8(FocusTargetNode focusSearch, int focusDirection, LayoutDirection layoutDirection, Function1<? super FocusTargetNode, Boolean> onFound) {
        int direction;
        Boolean boolM2673twoDimensionalFocusSearchOMvw8;
        ...
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2640getNextdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2642getPreviousdhqQ8s())) {
            return OneDimensionalFocusSearchKt.m2664oneDimensionalFocusSearchOMvw8(focusSearch, focusDirection, onFound);
        }
        if (FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2639getLeftdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2643getRightdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2644getUpdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2635getDowndhqQ8s())) {
            Boolean boolM2673twoDimensionalFocusSearchOMvw82 = TwoDimensionalFocusSearchKt.m2673twoDimensionalFocusSearchOMvw8(focusSearch, focusDirection, onFound);
            if (boolM2673twoDimensionalFocusSearchOMvw82 != null) {
                return boolM2673twoDimensionalFocusSearchOMvw82.booleanValue();
            }
            return false;
        }
        if (!FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2636getEnterdhqQ8s())) {
            if (!FocusDirection.m2627equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2637getExitdhqQ8s())) {
                throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m2629toStringimpl(focusDirection))).toString());
            }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
            case 1:
                direction = FocusDirection.INSTANCE.m2643getRightdhqQ8s();
                break;
            case 2:
                direction = FocusDirection.INSTANCE.m2639getLeftdhqQ8s();
                break;
            default:
                throw new NoWhenBranchMatchedException();
        }
        FocusTargetNode focusTargetNodeFindActiveFocusNode2 = findActiveFocusNode(focusSearch);
        if (focusTargetNodeFindActiveFocusNode2 == null || (boolM2673twoDimensionalFocusSearchOMvw8 = TwoDimensionalFocusSearchKt.m2673twoDimensionalFocusSearchOMvw8(focusTargetNodeFindActiveFocusNode2, direction, onFound)) == null) {
            return false;
        }
        return boolM2673twoDimensionalFocusSearchOMvw8.booleanValue();
    }
    ...
    public static final FocusTargetNode getActiveChild(FocusTargetNode $this$activeChild) {
        ...
        int type$iv4 = NodeKind.m4398constructorimpl(1024);
                    ...
                    if (node$iv$iv == null) {
                        ...
                        while (nodePop != null) {
                            if (nodePop instanceof FocusTargetNode) {
                                ...
                                if (((this_$iv$iv$iv.getKindSet() & type$iv4) != 0 ? i2 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                                    $this$visitChildren_u2d6rFNWt0$iv = $this$visitChildren_u2d6rFNWt0$iv3;
                                    type$iv = type$iv4;
                                    i = i2;
                                    type$iv2 = 0;

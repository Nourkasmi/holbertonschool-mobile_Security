    ...
    public static final boolean requestFocus(FocusRequesterModifierNode $this$requestFocus) {
        ...
        while (true) {
                            ...
                            if ((node$iv$iv.getKindSet() & count$iv$iv2) != 0) {
                                ...
                                while (this_$iv$iv$iv2 != null) {
                                    if (this_$iv$iv$iv2 instanceof FocusTargetNode) {
                                        ...
                                        return focusProperties.getCanFocus() ? FocusTransactionsKt.requestFocus(focusTarget) : TwoDimensionalFocusSearchKt.m2669findChildCorrespondingToFocusEnterOMvw8(focusTarget, FocusDirection.INSTANCE.m2636getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
            ...
            if (nodePop instanceof FocusTargetNode) {
                ...
                return focusProperties2.getCanFocus() ? FocusTransactionsKt.requestFocus(focusTarget2) : TwoDimensionalFocusSearchKt.m2669findChildCorrespondingToFocusEnterOMvw8(focusTarget2, FocusDirection.INSTANCE.m2636getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                    @Override // kotlin.jvm.functions.Function1
                    public final Boolean invoke(FocusTargetNode it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return Boolean.valueOf(FocusTransactionsKt.requestFocus(it));
            ...
            if (((this_$iv$iv$iv4.getKindSet() & type$iv3) != 0) && (nodePop instanceof DelegatingNode)) {
                int count$iv$iv4 = 0;

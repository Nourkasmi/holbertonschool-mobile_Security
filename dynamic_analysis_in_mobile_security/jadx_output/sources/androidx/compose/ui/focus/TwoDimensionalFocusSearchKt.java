...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m2673twoDimensionalFocusSearchOMvw8(FocusTargetNode twoDimensionalFocusSearch, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[twoDimensionalFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                    case 1:
                        Boolean found = m2673twoDimensionalFocusSearchOMvw8(focusedChild, direction, onFound);
                        return !Intrinsics.areEqual((Object) found, (Object) false) ? found : Boolean.valueOf(m2670generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(focusedChild), direction, onFound));
                    case 2:
                    case 3:
                        return Boolean.valueOf(m2670generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, focusedChild, direction, onFound));
                    case 4:
                        throw new IllegalStateException(NoActiveChild.toString());
                    default:
            ...
            case 2:
            case 3:
                return Boolean.valueOf(m2669findChildCorrespondingToFocusEnterOMvw8(twoDimensionalFocusSearch, direction, onFound));
            case 4:
    ...
    public static final boolean m2669findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode findChildCorrespondingToFocusEnter, int direction, Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2636getEnterdhqQ8s())) {
            requestedDirection = FocusDirection.INSTANCE.m2643getRightdhqQ8s();
        } else {
            requestedDirection = direction;
        }
        if (FocusDirection.m2627equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m2643getRightdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m2635getDowndhqQ8s())) {
            initialFocusRect = topLeft(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        } else {
            if (!(FocusDirection.m2627equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m2639getLeftdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0(requestedDirection, FocusDirection.INSTANCE.m2644getUpdhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            initialFocusRect = bottomRight(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        }
        FocusTargetNode nextCandidate = m2668findBestCandidate4WY_MpI(focusableChildren, initialFocusRect, requestedDirection);
    ...
    private static final boolean m2670generateAndSearchChildren4C6V_qg(final FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, final FocusTargetNode focusedItem, final int direction, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m2672searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2623searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                ...
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m2672searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1));
    ...
    public static final boolean m2672searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        while (children.isNotEmpty() && (nextItem = m2668findBestCandidate4WY_MpI(children, FocusTraversalKt.focusRect(focusedItem), direction)) != null) {
            if (nextItem.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(nextItem).booleanValue();
            }
            if (m2670generateAndSearchChildren4C6V_qg(nextItem, focusedItem, direction, function1)) {
                return true;
            }
    ...
    private static final FocusTargetNode m2668findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect focusRect, int direction) {
        Rect rectTranslate;
        if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2639getLeftdhqQ8s())) {
            rectTranslate = focusRect.translate(focusRect.getWidth() + 1, 0.0f);
        } else if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2643getRightdhqQ8s())) {
            rectTranslate = focusRect.translate(-(focusRect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2644getUpdhqQ8s())) {
            rectTranslate = focusRect.translate(0.0f, focusRect.getHeight() + 1);
        } else {
            if (!FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2635getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectTranslate = focusRect.translate(0.0f, -(focusRect.getHeight() + 1));
        }
        ...
        if (size$iv > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(candidateNode)) {
                    ...
                    if (m2671isBetterCandidateI7lrPNg(candidateRect, rect, focusRect, direction)) {
                        rect = candidateRect;
    ...
    private static final boolean isBetterCandidate_I7lrPNg$isCandidate(Rect $this$isBetterCandidate_I7lrPNg_u24isCandidate, int $direction, Rect $focusedRect) {
        ...
        if (FocusDirection.m2627equalsimpl0($direction, FocusDirection.INSTANCE.m2643getRightdhqQ8s())) {
        ...
        if (FocusDirection.m2627equalsimpl0($direction, FocusDirection.INSTANCE.m2644getUpdhqQ8s())) {
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect $this$isBetterCandidate_I7lrPNg_u24minorAxisDistance, int $direction, Rect $focusedRect) {
        if (FocusDirection.m2627equalsimpl0($direction, FocusDirection.INSTANCE.m2639getLeftdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0($direction, FocusDirection.INSTANCE.m2643getRightdhqQ8s())) {
            float f = 2;
        ...
        if (!(FocusDirection.m2627equalsimpl0($direction, FocusDirection.INSTANCE.m2644getUpdhqQ8s()) ? true : FocusDirection.m2627equalsimpl0($direction, FocusDirection.INSTANCE.m2635getDowndhqQ8s()))) {
            throw new IllegalStateException(InvalidFocusDirection.toString());
        }
        float f2 = 2;
    ...
    private static final boolean m2671isBetterCandidateI7lrPNg(Rect proposedCandidate, Rect currentCandidate, Rect focusedRect, int direction) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(proposedCandidate, direction, focusedRect)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(currentCandidate, direction, focusedRect) && !m2667beamBeatsI7lrPNg(focusedRect, proposedCandidate, currentCandidate, direction)) {
            return !m2667beamBeatsI7lrPNg(focusedRect, currentCandidate, proposedCandidate, direction) && isBetterCandidate_I7lrPNg$weightedDistance(direction, focusedRect, proposedCandidate) < isBetterCandidate_I7lrPNg$weightedDistance(direction, focusedRect, currentCandidate);
        }
        return true;
    }
    ...
    private static final boolean m2667beamBeatsI7lrPNg(Rect source, Rect rect1, Rect rect2, int direction) {
        ...
        if (FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2639getLeftdhqQ8s()) || FocusDirection.m2627equalsimpl0(direction, FocusDirection.INSTANCE.m2643getRightdhqQ8s())) {
            return true;
        }

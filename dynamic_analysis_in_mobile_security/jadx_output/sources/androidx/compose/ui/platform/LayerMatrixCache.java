...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4515calculateMatrixGrdbGEg(T target) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m3171constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
        ...
        if (prevMatrix == null || !Intrinsics.areEqual(it2, prevMatrix)) {
            AndroidMatrixConversions_androidKt.m2820setFromtUYjHk(it, it2);
    ...
    public final float[] m4514calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m4515calculateMatrixGrdbGEg(target);
            this.isInverseValid = InvertMatrixKt.m4512invertToJiSxe2E(normalMatrix, it);

...
public final class AndroidComposeViewAccessibilityDelegateCompat_androidKt {
    ...
    private static final void getAllUncoveredSemanticsNodesToMap$findAllSemanticNodesRecursive(Region unaccountedSpace, SemanticsNode root, Map<Integer, SemanticsNodeWithAdjustedBounds> map, SemanticsNode currentNode) {
        ...
        if (!unaccountedSpace.isEmpty() || currentNode.getId() == root.getId()) {
            ...
            if (region.op(unaccountedSpace, region, Region.Op.INTERSECT)) {
                Integer numValueOf = Integer.valueOf(virtualViewId);
                android.graphics.Rect bounds = region.getBounds();
                Intrinsics.checkNotNullExpressionValue(bounds, "region.bounds");
                map.put(numValueOf, new SemanticsNodeWithAdjustedBounds(currentNode, bounds));
                ...
                for (int i = replacedChildren$ui_release.size() - 1; -1 < i; i--) {
                    getAllUncoveredSemanticsNodesToMap$findAllSemanticNodesRecursive(unaccountedSpace, root, map, replacedChildren$ui_release.get(i));
                }
            ...
            if (!currentNode.getIsFake()) {
                if (virtualViewId == -1) {
                    Integer numValueOf2 = Integer.valueOf(virtualViewId);
                    android.graphics.Rect bounds2 = region.getBounds();
                    Intrinsics.checkNotNullExpressionValue(bounds2, "region.bounds");
                    map.put(numValueOf2, new SemanticsNodeWithAdjustedBounds(currentNode, bounds2));
                    return;
                }
                return;
            }
    ...
    public static final String m4484toLegacyClassNameV4PA4sw(int $this$toLegacyClassName_u2dV4PA4sw) {
        if (Role.m4559equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m4563getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m4559equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m4564getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m4559equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m4567getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m4559equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m4566getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m4559equalsimpl0($this$toLegacyClassName_u2dV4PA4sw, Role.INSTANCE.m4565getDropdownListo7Vup1c())) {
    ...
    public static final View semanticsIdToView(AndroidViewsHandler $this$semanticsIdToView, int id) {
        ...
        Iterable iterableEntrySet = $this$semanticsIdToView.getLayoutNodeToHolder().entrySet();
        Intrinsics.checkNotNullExpressionValue(iterableEntrySet, "layoutNodeToHolder.entries");

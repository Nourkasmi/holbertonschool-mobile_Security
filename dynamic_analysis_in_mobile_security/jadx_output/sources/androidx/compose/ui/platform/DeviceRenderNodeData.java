...
public final /* data */ class DeviceRenderNodeData {
    ...
    public int hashCode() {
        ...
        return ((iHashCode2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.m3028hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append((Object) CompositingStrategy.m3029toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m4504getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* JADX INFO: renamed from: setCompositingStrategy-aDBOjCE, reason: not valid java name */
    public final void m4505setCompositingStrategyaDBOjCE(int i) {

...
public final class LayoutNodeSubcompositionsState {
    ...
    public LayoutNodeSubcompositionsState(LayoutNode root, SubcomposeSlotReusePolicy slotReusePolicy) {
        ...
        this.intermediateMeasurePolicy = new Function2<SubcomposeIntermediateMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$intermediateMeasurePolicy$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeIntermediateMeasureScope subcomposeIntermediateMeasureScope, Constraints constraints) {
                return m4203invoke0kLqBqw(subcomposeIntermediateMeasureScope, constraints.getValue());
            }

            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
            public final MeasureResult m4203invoke0kLqBqw(SubcomposeIntermediateMeasureScope $this$null, long it) {
                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                return $this$null.getLookaheadMeasurePolicy().invoke($this$null, Constraints.m5156boximpl(it));
            }
        };
    ...
    public final void setSlotReusePolicy(SubcomposeSlotReusePolicy value) throws Throwable {
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) throws Throwable {
        ...
        NodeState nodeState2 = map.get(node);
        if (nodeState2 == null) {
            nodeState = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m4173getLambda1$ui_release(), null, 4, null);
    ...
    private final Composition subcomposeInto(Composition existing, LayoutNode container, CompositionContext parent, Function2<? super Composer, ? super Integer, Unit> composable) {
        Composition compositionCreateSubcomposition;
        if (existing == null || existing.getDisposed()) {
            compositionCreateSubcomposition = Wrapper_androidKt.createSubcomposition(container, parent);
        } else {
            compositionCreateSubcomposition = existing;
        }
        Composition $this$subcomposeInto_u24lambda_u246 = compositionCreateSubcomposition;
        $this$subcomposeInto_u24lambda_u246.setContent(composable);
        return compositionCreateSubcomposition;
    }
    ...
    public final MeasurePolicy createMeasurePolicy(final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> block) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                if (isIntermediate) {
                    return LayoutNodeSubcompositionsState.this.getIntermediateMeasurePolicy$ui_release().invoke(LayoutNodeSubcompositionsState.this.intermediateMeasureScope, Constraints.m5156boximpl(constraints));
                }
                LayoutNodeSubcompositionsState.this.currentIndex = 0;
                LayoutNodeSubcompositionsState.this.intermediateMeasureScope.m4201setLookaheadConstraintsBRTryo0(constraints);
                final MeasureResult result = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m5156boximpl(constraints));
                final int indexAfterMeasure = LayoutNodeSubcompositionsState.this.currentIndex;
                LayoutNodeSubcompositionsState.this.intermediateMeasureScope.m4202setLookaheadSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) throws Throwable {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precompose.1
            ...
            public void mo4204premeasure0kLqBqw(int index, long constraints) {
                ...
                if (node2 != null && node2.isAttached()) {
                    ...
                    if (!node2.isPlaced()) {
                        ...
                        LayoutNodeKt.requireOwner(node2).mo4453measureAndLayout0kLqBqw(node2.getChildren$ui_release().get(index), constraints);
    ...
    private final class IntermediateMeasureScopeImpl implements SubcomposeIntermediateMeasureScope, MeasureScope {
        ...
        public int mo319roundToPxR2X_6o(long j) {
            return this.$$delegate_0.mo319roundToPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: roundToPx-0680j_4 */
        public int mo320roundToPx0680j_4(float f) {
            return this.$$delegate_0.mo320roundToPx0680j_4(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toDp-GaN1DYA */
        public float mo321toDpGaN1DYA(long j) {
            return this.$$delegate_0.mo321toDpGaN1DYA(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toDp-u2uoSUM */
        public float mo322toDpu2uoSUM(float f) {
            return this.$$delegate_0.mo322toDpu2uoSUM(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toDp-u2uoSUM */
        public float mo323toDpu2uoSUM(int i) {
            return this.$$delegate_0.mo323toDpu2uoSUM(i);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toDpSize-k-rfVVM */
        public long mo324toDpSizekrfVVM(long j) {
            return this.$$delegate_0.mo324toDpSizekrfVVM(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toPx--R2X_6o */
        public float mo325toPxR2X_6o(long j) {
            return this.$$delegate_0.mo325toPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toPx-0680j_4 */
        public float mo326toPx0680j_4(float f) {
            return this.$$delegate_0.mo326toPx0680j_4(f);
        }
        ...
        public long mo327toSizeXkaWNTQ(long j) {
            return this.$$delegate_0.mo327toSizeXkaWNTQ(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toSp-0xMU5do */
        public long mo328toSp0xMU5do(float f) {
            return this.$$delegate_0.mo328toSp0xMU5do(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toSp-kPz2Gy4 */
        public long mo329toSpkPz2Gy4(float f) {
            return this.$$delegate_0.mo329toSpkPz2Gy4(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* JADX INFO: renamed from: toSp-kPz2Gy4 */
        public long mo330toSpkPz2Gy4(int i) {
            return this.$$delegate_0.mo330toSpkPz2Gy4(i);
        }
        ...
        public void m4202setLookaheadSizeozmzZPI(long j) {
        ...
        public void m4201setLookaheadConstraintsBRTryo0(long j) {

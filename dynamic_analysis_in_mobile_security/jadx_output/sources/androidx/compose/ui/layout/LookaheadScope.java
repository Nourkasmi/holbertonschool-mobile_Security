...
public interface LookaheadScope {
    ...
    default long m4206localLookaheadPositionOfdBAh8RU(LayoutCoordinates localLookaheadPositionOf, LayoutCoordinates coordinates) {
        ...
        return toLookaheadCoordinates(localLookaheadPositionOf).mo4191localPositionOfR5De75A(toLookaheadCoordinates(coordinates), Offset.INSTANCE.m2724getZeroF1C5BW0());
    }
    ...
    default Modifier intermediateLayout(Modifier $this$intermediateLayout, final Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super IntSize, ? extends MeasureResult> measure) {
        ...
        return LookaheadScopeKt.intermediateLayout($this$intermediateLayout, new Function3<IntermediateMeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LookaheadScope.intermediateLayout.1
            ...
            public final MeasureResult m4207invoke3p2s80s(IntermediateMeasureScope intermediateLayout, Measurable measurable, long constraints) {
                Intrinsics.checkNotNullParameter(intermediateLayout, "$this$intermediateLayout");
                Intrinsics.checkNotNullParameter(measurable, "measurable");
                return measure.invoke(intermediateLayout, measurable, Constraints.m5156boximpl(constraints), IntSize.m5364boximpl(intermediateLayout.mo4186getLookaheadSizeYbymL2g()));
            }
        });
    }
}

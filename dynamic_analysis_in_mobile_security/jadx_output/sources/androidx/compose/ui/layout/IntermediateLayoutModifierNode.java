...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (closestLookaheadRoot != null && closestLookaheadRoot.getIsVirtualLookaheadRoot()) {
            lookaheadScopeImpl2 = new LookaheadScopeImpl(new Function0<LayoutCoordinates>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode.onAttach.1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final LayoutCoordinates invoke() {
                    LayoutNode parent$ui_release = closestLookaheadRoot.getParent$ui_release();
            ...
            int iM4398constructorimpl = NodeKind.m4398constructorimpl(512);
            ...
            while (layout$iv$iv != null) {
                ...
                if ((head$iv$iv.getAggregateChildKindSet() & iM4398constructorimpl) != 0) {
                        ...
                        if ((node$iv$iv.getKindSet() & iM4398constructorimpl) != 0) {
                            ...
                            while (nodePop != null) {
                                if (nodePop instanceof IntermediateLayoutModifierNode) {
                                    IntermediateLayoutModifierNode it = (IntermediateLayoutModifierNode) nodePop;
                                    ...
                                    if (((this_$iv$iv$iv.getKindSet() & iM4398constructorimpl) != 0 ? i3 : 0) == 0 || !(nodePop instanceof DelegatingNode)) {
                                        layoutNode2 = layoutNode4;
                                        coordinates2 = coordinates4;
                                        i2 = i3;
                                    } else {
                                        ...
                                        while (node$iv$iv$iv != null) {
                                            ...
                                            if (((next$iv$iv.getKindSet() & iM4398constructorimpl) != 0 ? i3 : 0) != 0) {
                                                count$iv$iv++;
                                                if (count$iv$iv == i3) {
                                                    nodePop = next$iv$iv;
    ...
    public MeasureResult mo238measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        final Placeable $this$measure_3p2s80s_u24lambda_u241 = measurable.mo4183measureBRTryo0(constraints);
        return MeasureScope.layout$default(measure, $this$measure_3p2s80s_u24lambda_u241.getWidth(), $this$measure_3p2s80s_u24lambda_u241.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, $this$measure_3p2s80s_u24lambda_u241, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }

    /* JADX INFO: renamed from: intermediateMeasure-Te-uZzU, reason: not valid java name */
    public final MeasureResult m4185intermediateMeasureTeuZzU(MeasureScope intermediateMeasure, Measurable measurable, long constraints, long lookaheadSize, long lookaheadConstraints) {
        Intrinsics.checkNotNullParameter(intermediateMeasure, "$this$intermediateMeasure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        this.intermediateMeasureScope.m4187setLookaheadSizeozmzZPI(lookaheadSize);
        this.lookaheadConstraints = Constraints.m5156boximpl(lookaheadConstraints);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, wrappedMeasurable, Constraints.m5156boximpl(constraints));
    }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope $this$minIntermediateIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo4188measure3p2s80s(MeasureScope minWidth, Measurable intrinsicMeasurable, long constraints) {
                Intrinsics.checkNotNullParameter(minWidth, "$this$minWidth");
                Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
                return this.this$0.getMeasureBlock$ui_release().invoke(this.this$0.intermediateMeasureScope, intrinsicMeasurable, Constraints.m5156boximpl(constraints));
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope $this$minIntermediateIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo4188measure3p2s80s(MeasureScope minHeight, Measurable intrinsicMeasurable, long constraints) {
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope $this$maxIntermediateIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* JADX INFO: renamed from: measure-3p2s80s */
            public final MeasureResult mo4188measure3p2s80s(MeasureScope maxWidth, Measurable intrinsicMeasurable, long constraints) {
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope $this$maxIntermediateIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo4188measure3p2s80s(MeasureScope maxHeight, Measurable intrinsicMeasurable, long constraints) {
    ...
    private final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo4183measureBRTryo0(long constraints) {
            ...
            if (this.this$0.getIsIntermediateChangeActive()) {
                it = this.wrappedMeasurable.mo4183measureBRTryo0(constraints);
                m4239setMeasurementConstraintsBRTryo0(constraints);
                m4238setMeasuredSizeozmzZPI(IntSizeKt.IntSize(it.getWidth(), it.getHeight()));
            } else {
                ...
                it = measurable.mo4183measureBRTryo0(constraints2.getValue());
                ...
                m4239setMeasurementConstraintsBRTryo0(constraints3.getValue());
                ...
                m4238setMeasuredSizeozmzZPI(lookaheadSize);
            }
        ...
        public void mo4184placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            long offset = this.this$0.getIsIntermediateChangeActive() ? position : IntOffset.INSTANCE.m5340getZeronOccac();
            if (layerBlock != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    Placeable.PlacementScope.INSTANCE.m4249placeWithLayeraW9wM(placeable, offset, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                Placeable.PlacementScope.INSTANCE.m4244place70tqf50(placeable2, offset, zIndex);
    ...
    final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        private long lookaheadSize = IntSize.INSTANCE.m5377getZeroYbymL2g();
        ...
        public void m4187setLookaheadSizeozmzZPI(long j) {

...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.INSTANCE.m5340getZeronOccac();

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public abstract void mo4184placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);
    ...
    public int getMeasuredWidth() {
        return IntSize.m5372getWidthimpl(this.measuredSize);
    }

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredHeight() {
        return IntSize.m5371getHeightimpl(this.measuredSize);
    }
    ...
    protected final void m4238setMeasuredSizeozmzZPI(long value) {
        if (!IntSize.m5370equalsimpl0(this.measuredSize, value)) {
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m5372getWidthimpl(this.measuredSize), Constraints.m5170getMinWidthimpl(this.measurementConstraints), Constraints.m5168getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m5371getHeightimpl(this.measuredSize), Constraints.m5169getMinHeightimpl(this.measurementConstraints), Constraints.m5167getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m5372getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m5371getHeightimpl(this.measuredSize)) / 2);
    }
    ...
    public final void m4239setMeasurementConstraintsBRTryo0(long value) {
        if (!Constraints.m5161equalsimpl0(this.measurementConstraints, value)) {
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m4241placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4247placeRelative70tqf50(placeable, j, f);
        }

        /* JADX INFO: renamed from: placeRelative-70tqf50, reason: not valid java name */
        public final void m4247placeRelative70tqf50(Placeable placeRelative, long position, float zIndex) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long other$iv$iv$iv = placeRelative.apparentToRealOffset;
                placeRelative.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv$iv$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv$iv$iv)), zIndex, null);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m5330getXimpl(position), IntOffset.m5331getYimpl(position));
                long other$iv$iv$iv2 = placeRelative.apparentToRealOffset;
                placeRelative.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv$iv) + IntOffset.m5330getXimpl(other$iv$iv$iv2), IntOffset.m5331getYimpl(position$iv$iv) + IntOffset.m5331getYimpl(other$iv$iv$iv2)), zIndex, null);
            }
        }
        ...
        public final void placeRelative(Placeable $this$placeRelative, int x, int y, float zIndex) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                $this$placeRelative.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv) + IntOffset.m5330getXimpl(other$iv$iv$iv), IntOffset.m5331getYimpl(position$iv) + IntOffset.m5331getYimpl(other$iv$iv$iv)), zIndex, null);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeRelative.getWidth()) - IntOffset.m5330getXimpl(position$iv), IntOffset.m5331getYimpl(position$iv));
                long other$iv$iv$iv2 = $this$placeRelative.apparentToRealOffset;
                $this$placeRelative.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv$iv) + IntOffset.m5330getXimpl(other$iv$iv$iv2), IntOffset.m5331getYimpl(position$iv$iv) + IntOffset.m5331getYimpl(other$iv$iv$iv2)), zIndex, null);
            }
        }
        ...
        public final void place(Placeable $this$place, int x, int y, float zIndex) {
            ...
            $this$place.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv) + IntOffset.m5330getXimpl(other$iv$iv), IntOffset.m5331getYimpl(position$iv) + IntOffset.m5331getYimpl(other$iv$iv)), zIndex, null);
        }

        /* JADX INFO: renamed from: place-70tqf50$default, reason: not valid java name */
        public static /* synthetic */ void m4240place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4244place70tqf50(placeable, j, f);
        }

        /* JADX INFO: renamed from: place-70tqf50, reason: not valid java name */
        public final void m4244place70tqf50(Placeable place, long position, float zIndex) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long other$iv$iv = place.apparentToRealOffset;
            place.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv$iv)), zIndex, null);
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX INFO: renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4242placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            ...
            placementScope.m4248placeRelativeWithLayeraW9wM(placeable, j, f2, function12);
        }

        /* JADX INFO: renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4248placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long other$iv$iv$iv = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv$iv$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m5330getXimpl(position), IntOffset.m5331getYimpl(position));
                long other$iv$iv$iv2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv$iv) + IntOffset.m5330getXimpl(other$iv$iv$iv2), IntOffset.m5331getYimpl(position$iv$iv) + IntOffset.m5331getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
            }
        }
        ...
        public final void placeRelativeWithLayer(Placeable $this$placeRelativeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                $this$placeRelativeWithLayer.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv) + IntOffset.m5330getXimpl(other$iv$iv$iv), IntOffset.m5331getYimpl(position$iv) + IntOffset.m5331getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeRelativeWithLayer.getWidth()) - IntOffset.m5330getXimpl(position$iv), IntOffset.m5331getYimpl(position$iv));
                long other$iv$iv$iv2 = $this$placeRelativeWithLayer.apparentToRealOffset;
                $this$placeRelativeWithLayer.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv$iv) + IntOffset.m5330getXimpl(other$iv$iv$iv2), IntOffset.m5331getYimpl(position$iv$iv) + IntOffset.m5331getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
            }
        }
        ...
        public final void placeWithLayer(Placeable $this$placeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            $this$placeWithLayer.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv) + IntOffset.m5330getXimpl(other$iv$iv), IntOffset.m5331getYimpl(position$iv) + IntOffset.m5331getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX INFO: renamed from: placeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4243placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            Function1 function12;
            if (obj != null) {
            ...
            placementScope.m4249placeWithLayeraW9wM(placeable, j, f2, function12);
        }

        /* JADX INFO: renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4249placeWithLayeraW9wM(Placeable placeWithLayer, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long other$iv$iv = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* JADX INFO: renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4246placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeAutoMirrored.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv$iv)), zIndex, function1);
            } else {
                long position$iv = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m5330getXimpl(position), IntOffset.m5331getYimpl(position));
                long other$iv$iv2 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position$iv) + IntOffset.m5330getXimpl(other$iv$iv2), IntOffset.m5331getYimpl(position$iv) + IntOffset.m5331getYimpl(other$iv$iv2)), zIndex, function1);
            }
        }

        /* JADX INFO: renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4245placeApparentToRealOffsetaW9wM$ui_release(Placeable placeApparentToRealOffset, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo4184placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv)), zIndex, function1);
        }

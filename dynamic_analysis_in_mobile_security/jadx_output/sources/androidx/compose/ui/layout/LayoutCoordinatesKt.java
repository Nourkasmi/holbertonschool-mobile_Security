...
public final class LayoutCoordinatesKt {
    public static final long positionInRoot(LayoutCoordinates $this$positionInRoot) {
        ...
        return $this$positionInRoot.mo4192localToRootMKHz9U(Offset.INSTANCE.m2724getZeroF1C5BW0());
    }
    ...
    public static final long positionInWindow(LayoutCoordinates $this$positionInWindow) {
        ...
        return $this$positionInWindow.mo4193localToWindowMKHz9U(Offset.INSTANCE.m2724getZeroF1C5BW0());
    }
    ...
    public static final Rect boundsInWindow(LayoutCoordinates $this$boundsInWindow) {
        ...
        float rootWidth = IntSize.m5372getWidthimpl(root.mo4190getSizeYbymL2g());
        float rootHeight = IntSize.m5371getHeightimpl(root.mo4190getSizeYbymL2g());
        ...
        if (!(boundsLeft == boundsRight)) {
            if (!(boundsTop == boundsBottom)) {
                long topLeft = root.mo4193localToWindowMKHz9U(OffsetKt.Offset(boundsLeft, boundsTop));
                long topRight = root.mo4193localToWindowMKHz9U(OffsetKt.Offset(boundsRight, boundsTop));
                long bottomRight = root.mo4193localToWindowMKHz9U(OffsetKt.Offset(boundsRight, boundsBottom));
                long bottomLeft = root.mo4193localToWindowMKHz9U(OffsetKt.Offset(boundsLeft, boundsBottom));
                float left = ComparisonsKt.minOf(Offset.m2708getXimpl(topLeft), Offset.m2708getXimpl(topRight), Offset.m2708getXimpl(bottomLeft), Offset.m2708getXimpl(bottomRight));
                float top = ComparisonsKt.minOf(Offset.m2709getYimpl(topLeft), Offset.m2709getYimpl(topRight), Offset.m2709getYimpl(bottomLeft), Offset.m2709getYimpl(bottomRight));
                float right = ComparisonsKt.maxOf(Offset.m2708getXimpl(topLeft), Offset.m2708getXimpl(topRight), Offset.m2708getXimpl(bottomLeft), Offset.m2708getXimpl(bottomRight));
                float bottom = ComparisonsKt.maxOf(Offset.m2709getYimpl(topLeft), Offset.m2709getYimpl(topRight), Offset.m2709getYimpl(bottomLeft), Offset.m2709getYimpl(bottomRight));
    ...
    public static final long positionInParent(LayoutCoordinates $this$positionInParent) {
        ...
        return parentLayoutCoordinates != null ? parentLayoutCoordinates.mo4191localPositionOfR5De75A($this$positionInParent, Offset.INSTANCE.m2724getZeroF1C5BW0()) : Offset.INSTANCE.m2724getZeroF1C5BW0();
    }
    ...
    public static final Rect boundsInParent(LayoutCoordinates $this$boundsInParent) {
        ...
        return (parentLayoutCoordinates == null || (rectLocalBoundingBoxOf$default = LayoutCoordinates.localBoundingBoxOf$default(parentLayoutCoordinates, $this$boundsInParent, false, 2, null)) == null) ? new Rect(0.0f, 0.0f, IntSize.m5372getWidthimpl($this$boundsInParent.mo4190getSizeYbymL2g()), IntSize.m5371getHeightimpl($this$boundsInParent.mo4190getSizeYbymL2g())) : rectLocalBoundingBoxOf$default;
    }

...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            C05111 c05111 = new Function0<LayoutNode>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt.LookaheadScope.1
            ...
            if (composerStartRestartGroup.getInserting()) {
                composerStartRestartGroup.createNode(c05111);
            } else {
                composerStartRestartGroup.useNode();
            }
            Composer composerM2581constructorimpl = Updater.m2581constructorimpl(composerStartRestartGroup);
            Updater.m2585initimpl(composerM2581constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m2588setimpl(composerM2581constructorimpl, lookaheadScopeImpl2, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2

...
public final class OutlineKt {
    public static final void addOutline(Path $this$addOutline, Outline outline) {
        ...
        if (!(outline instanceof Outline.Rectangle)) {
            if (!(outline instanceof Outline.Rounded)) {
                ...
                Path.m3210addPathUv8p0NA$default($this$addOutline, ((Outline.Generic) outline).getPath(), 0L, 2, null);
                return;
            }
    ...
    public static final void m3198drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        Intrinsics.checkNotNullParameter(style, "style");
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3406drawRectnJ9OG0(color, topLeft(rect), size(rect), alpha, style, colorFilter, blendMode);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Path path$iv = ((Outline.Rounded) outline).getRoundRectPath();
            if (path$iv != null) {
                drawOutline.mo3402drawPathLG529CI(path$iv, color, alpha, style, colorFilter, blendMode);
                return;
            }
            RoundRect rrect = ((Outline.Rounded) outline).getRoundRect();
            float radius = CornerRadius.m2683getXimpl(rrect.m2756getBottomLeftCornerRadiuskKHJgLs());
            drawOutline.mo3408drawRoundRectuAw5IA(color, topLeft(rrect), size(rrect), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), style, alpha, colorFilter, blendMode);
            return;
        }
        if (outline instanceof Outline.Generic) {
            Path path = ((Outline.Generic) outline).getPath();
            drawOutline.mo3402drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
            return;
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    public static final void m3196drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3405drawRectAsUm42w(brush, topLeft(rect), size(rect), alpha, style, colorFilter, blendMode);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Path path$iv = ((Outline.Rounded) outline).getRoundRectPath();
            if (path$iv != null) {
                drawOutline.mo3401drawPathGBMwjPU(path$iv, brush, alpha, style, colorFilter, blendMode);
                return;
            }
            RoundRect rrect = ((Outline.Rounded) outline).getRoundRect();
            float radius = CornerRadius.m2683getXimpl(rrect.m2756getBottomLeftCornerRadiuskKHJgLs());
            drawOutline.mo3407drawRoundRectZuiqVtQ(brush, topLeft(rrect), size(rrect), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), alpha, style, colorFilter, blendMode);
            return;
        }
        if (outline instanceof Outline.Generic) {
            Path path = ((Outline.Generic) outline).getPath();
            drawOutline.mo3401drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
            return;
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    */
    public static final boolean hasSameCornerRadius(androidx.compose.ui.geometry.RoundRect r6) {
        /*
            long r0 = r6.m2756getBottomLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r0)
            long r1 = r6.m2757getBottomRightCornerRadiuskKHJgLs()
            float r1 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r1)
        ...
        L19:
            if (r0 == 0) goto L4f
            long r3 = r6.m2757getBottomRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r3)
            long r3 = r6.m2759getTopRightCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r3)
        ...
        L32:
            ...
            long r3 = r6.m2759getTopRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r3)
            long r3 = r6.m2758getTopLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m2683getXimpl(r3)
            int r0 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
            if (r0 != 0) goto L4a
            r0 = r1
        ...
        L4f:
            r0 = r2
        L50:
            long r3 = r6.m2756getBottomLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m2684getYimpl(r3)
            long r4 = r6.m2757getBottomRightCornerRadiuskKHJgLs()
            float r4 = androidx.compose.ui.geometry.CornerRadius.m2684getYimpl(r4)

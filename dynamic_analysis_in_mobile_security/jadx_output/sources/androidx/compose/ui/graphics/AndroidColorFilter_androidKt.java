...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2815actualTintColorFilterxETnrds(long color, int blendMode) {
        PorterDuffColorFilter androidColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m2893BlendModeColorFilterxETnrds(color, blendMode);
        } else {
            androidColorFilter = new PorterDuffColorFilter(ColorKt.m3001toArgb8_81llA(color), AndroidBlendMode_androidKt.m2801toPorterDuffModes9anfk8(blendMode));
        }
    ...
    public static final ColorFilter m2813actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
    ...
    public static final ColorFilter m2814actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m3001toArgb8_81llA(multiply), ColorKt.m3001toArgb8_81llA(add)));
    }
}

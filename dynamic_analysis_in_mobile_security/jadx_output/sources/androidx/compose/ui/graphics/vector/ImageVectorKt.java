...
public final class ImageVectorKt {
    ...
    public static /* synthetic */ ImageVector.Builder m3573pathR_LF3I$default(ImageVector.Builder path, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, int pathFillType, Function1 pathBuilder, int i, Object obj) {
        ...
        return ImageVector.Builder.m3570addPathoIyEayM$default(path, $this$PathData_u24lambda_u240$iv.getNodes(), pathFillType2, name2, fill2, fillAlpha2, stroke2, strokeAlpha2, strokeLineWidth2, strokeLineCap2, strokeLineJoin2, strokeLineMiter2, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* JADX INFO: renamed from: path-R_LF-3I, reason: not valid java name */
    public static final ImageVector.Builder m3572pathR_LF3I(ImageVector.Builder path, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, int pathFillType, Function1<? super PathBuilder, Unit> pathBuilder) {
        Intrinsics.checkNotNullParameter(path, "$this$path");
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(pathBuilder, "pathBuilder");
        PathBuilder $this$PathData_u24lambda_u240$iv = new PathBuilder();
        pathBuilder.invoke($this$PathData_u24lambda_u240$iv);
        return ImageVector.Builder.m3570addPathoIyEayM$default(path, $this$PathData_u24lambda_u240$iv.getNodes(), pathFillType, name, fill, fillAlpha, stroke, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeLineMiter, 0.0f, 0.0f, 0.0f, 14336, null);
    }
    ...
    public static /* synthetic */ ImageVector.Builder group$default(ImageVector.Builder builder, String name, float rotate, float pivotX, float pivotY, float scaleX, float scaleY, float translationX, float translationY, List clipPathData, Function1 block, int i, Object obj) {
        ...
        builder.addGroup(name2, rotate2, pivotX2, pivotY2, scaleX2, scaleY2, translationX2, translationY2, clipPathData2);

...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3586rememberVectorPaintermlNsNFs(float defaultWidth, float defaultHeight, float viewportWidth, float viewportHeight, String name, long tintColor, int tintBlendMode, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        long tintColor2 = (i & 32) != 0 ? Color.INSTANCE.m2983getUnspecified0d7_KjU() : tintColor;
        int tintBlendMode2 = (i & 64) != 0 ? BlendMode.INSTANCE.m2889getSrcIn0nO6VwU() : tintBlendMode;
    ...
    public static final VectorPainter m3587rememberVectorPaintervIP8VLU(float defaultWidth, float defaultHeight, float viewportWidth, float viewportHeight, String name, long tintColor, int tintBlendMode, boolean autoMirror, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        float widthPx = density.mo326toPx0680j_4(defaultWidth);
        float heightPx = density.mo326toPx0680j_4(defaultHeight);
        ...
        Object key1$iv = Color.m2937boximpl(tintColor2);
        Object key2$iv = BlendMode.m2857boximpl(tintBlendMode2);
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = !Color.m2948equalsimpl0(tintColor2, Color.INSTANCE.m2983getUnspecified0d7_KjU()) ? ColorFilter.INSTANCE.m2991tintxETnrds(tintColor2, tintBlendMode2) : null;
        ...
        $this$rememberVectorPainter_vIP8VLU_u24lambda_u244.m3585setSizeuvyYCjk$ui_release(SizeKt.Size(widthPx, heightPx));
    ...
    private static final void mirror(DrawScope $this$mirror, Function1<? super DrawScope, Unit> function1) {
        long pivot$iv = $this$mirror.mo3488getCenterF1C5BW0();

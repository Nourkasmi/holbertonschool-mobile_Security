...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m3171constructorimpl$default(null, 1, null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m3180resetimpl(matrix);
        }
        Matrix.m3191translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3183rotateZimpl(matrix, this.rotation);
        Matrix.m3184scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3191translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        if (fArr != null) {
            float[] it = (fArr != null ? Matrix.m3169boximpl(fArr) : null).m3192unboximpl();
            $this$draw_u24lambda_u245.mo3422transform58bKbWc(it);
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.m3539clipPathmtrdDE$default($this$draw_u24lambda_u245, targetClip, 0, 2, null);
        }
        List<VNode> list = this.children;
        int size = list.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {

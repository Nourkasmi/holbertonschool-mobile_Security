...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m2785getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope $this$draw, float alpha, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2773equalsimpl0(this.previousDrawSize, $this$draw.mo3489getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2777getWidthimpl($this$draw.mo3489getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2774getHeightimpl($this$draw.mo3489getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3565drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2777getWidthimpl($this$draw.mo3489getSizeNHjbRc())), (int) Math.ceil(Size.m2774getHeightimpl($this$draw.mo3489getSizeNHjbRc()))), $this$draw, $this$draw.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = $this$draw.mo3489getSizeNHjbRc();
        }

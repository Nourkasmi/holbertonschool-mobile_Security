...
public final class ImageVector {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m2983getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m2889getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.INSTANCE.m2983getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m2889getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public static /* synthetic */ Builder m3570addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            return builder.m3571addPathoIyEayM(list, (i4 & 2) != 0 ? VectorKt.getDefaultFillType() : i, (i4 & 4) != 0 ? "" : str, (i4 & 8) != 0 ? null : brush, (i4 & 16) != 0 ? 1.0f : f, (i4 & 32) == 0 ? brush2 : null, (i4 & 64) != 0 ? 1.0f : f2, (i4 & 128) != 0 ? 0.0f : f3, (i4 & 256) != 0 ? VectorKt.getDefaultStrokeLineCap() : i2, (i4 & 512) != 0 ? VectorKt.getDefaultStrokeLineJoin() : i3, (i4 & 1024) != 0 ? 4.0f : f4, (i4 & 2048) != 0 ? 0.0f : f5, (i4 & 4096) == 0 ? f6 : 1.0f, (i4 & 8192) == 0 ? f7 : 0.0f);
        }

        /* JADX INFO: renamed from: addPath-oIyEayM, reason: not valid java name */
        public final Builder m3571addPathoIyEayM(List<? extends PathNode> pathData, int pathFillType, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ImageVector) || !Intrinsics.areEqual(this.name, ((ImageVector) other).name) || !Dp.m5217equalsimpl0(this.defaultWidth, ((ImageVector) other).defaultWidth) || !Dp.m5217equalsimpl0(this.defaultHeight, ((ImageVector) other).defaultHeight)) {
            return false;
        }
        if (this.viewportWidth == ((ImageVector) other).viewportWidth) {
            return ((this.viewportHeight > ((ImageVector) other).viewportHeight ? 1 : (this.viewportHeight == ((ImageVector) other).viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, ((ImageVector) other).root) && Color.m2948equalsimpl0(this.tintColor, ((ImageVector) other).tintColor) && BlendMode.m2860equalsimpl0(this.tintBlendMode, ((ImageVector) other).tintBlendMode) && this.autoMirror == ((ImageVector) other).autoMirror;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Dp.m5218hashCodeimpl(this.defaultWidth)) * 31) + Dp.m5218hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m2954hashCodeimpl(this.tintColor)) * 31) + BlendMode.m2861hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}

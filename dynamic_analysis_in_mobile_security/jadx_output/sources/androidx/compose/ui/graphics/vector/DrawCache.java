...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m5377getZeroYbymL2g();
    ...
    public final void m3565drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (targetImage == null || targetCanvas == null || IntSize.m5372getWidthimpl(size) > targetImage.getWidth() || IntSize.m5371getHeightimpl(size) > targetImage.getHeight()) {
            targetImage = ImageBitmapKt.m3168ImageBitmapx__hDU$default(IntSize.m5372getWidthimpl(size), IntSize.m5371getHeightimpl(size), 0, false, null, 28, null);
        ...
        long size$iv = IntSizeKt.m5382toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m3473drawImageAZ2fEMs$default(target, targetImage, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope $this$clear) {
        DrawScope.m3484drawRectnJ9OG0$default($this$clear, Color.INSTANCE.m2973getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m2864getClear0nO6VwU(), 62, null);
    }
}

...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iHashCode = ((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m3327hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31;
        boolean z = this.clip;
        ?? r2 = z;
        if (z) {
            r2 = 1;
        ...
        return ((((((i + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m2954hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m2954hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m3028hashCodeimpl(this.compositingStrategy);
    }
    ...
    public final long m3099getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m3273setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m3270setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m3272setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m3271setCompositingStrategyaDBOjCE(this.compositingStrategy);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("transformOrigin", TransformOrigin.m3317boximpl(this.transformOrigin));
        ...
        $this$inspectableProperties.getProperties().set("ambientShadowColor", Color.m2937boximpl(this.ambientShadowColor));
        $this$inspectableProperties.getProperties().set("spotShadowColor", Color.m2937boximpl(this.spotShadowColor));
        $this$inspectableProperties.getProperties().set("compositingStrategy", CompositingStrategy.m3024boximpl(this.compositingStrategy));
    }
}

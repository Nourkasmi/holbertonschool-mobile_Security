...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2988tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m2889getSrcIn0nO6VwU();
            }
            return companion.m2991tintxETnrds(j, i);
        }

        /* JADX INFO: renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m2991tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m2815actualTintColorFilterxETnrds(color, blendMode);
        }

        /* JADX INFO: renamed from: colorMatrix-jHG-Opc, reason: not valid java name */
        public final ColorFilter m2989colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m2813actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* JADX INFO: renamed from: lighting--OWjLjI, reason: not valid java name */
        public final ColorFilter m2990lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m2814actualLightingColorFilterOWjLjI(multiply, add);
        }
    }

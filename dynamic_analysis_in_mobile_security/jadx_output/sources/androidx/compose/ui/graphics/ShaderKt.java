...
public final class ShaderKt {
    ...
    public static /* synthetic */ Shader m3255LinearGradientShaderVjE6UOU$default(long j, long j2, List list, List list2, int i, int i2, Object obj) {
        List list3;
        ...
        return m3254LinearGradientShaderVjE6UOU(j, j2, list, list3, iM3312getClamp3opZhB0);
    }

    /* JADX INFO: renamed from: LinearGradientShader-VjE6UOU, reason: not valid java name */
    public static final Shader m3254LinearGradientShaderVjE6UOU(long from, long to, List<Color> colors, List<Float> list, int tileMode) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        return AndroidShader_androidKt.m2850ActualLinearGradientShaderVjE6UOU(from, to, colors, list, tileMode);
    }

    /* JADX INFO: renamed from: RadialGradientShader-8uybcMk$default, reason: not valid java name */
    public static /* synthetic */ Shader m3257RadialGradientShader8uybcMk$default(long j, float f, List list, List list2, int i, int i2, Object obj) {
        List list3;
        int iM3312getClamp3opZhB0;
        if ((i2 & 8) == 0) {
            list3 = list2;
        ...
        return m3256RadialGradientShader8uybcMk(j, f, list, list3, iM3312getClamp3opZhB0);
    }

    /* JADX INFO: renamed from: RadialGradientShader-8uybcMk, reason: not valid java name */
    public static final Shader m3256RadialGradientShader8uybcMk(long center, float radius, List<Color> colors, List<Float> list, int tileMode) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        return AndroidShader_androidKt.m2851ActualRadialGradientShader8uybcMk(center, radius, colors, list, tileMode);
    }

    /* JADX INFO: renamed from: SweepGradientShader-9KIMszo$default, reason: not valid java name */
    public static /* synthetic */ Shader m3259SweepGradientShader9KIMszo$default(long j, List list, List list2, int i, Object obj) {
        if ((i & 4) != 0) {
            list2 = null;
        }
        return m3258SweepGradientShader9KIMszo(j, list, list2);
    }

    /* JADX INFO: renamed from: SweepGradientShader-9KIMszo, reason: not valid java name */
    public static final Shader m3258SweepGradientShader9KIMszo(long center, List<Color> colors, List<Float> list) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        return AndroidShader_androidKt.m2852ActualSweepGradientShader9KIMszo(center, colors, list);
    }

    /* JADX INFO: renamed from: ImageShader-F49vj9s$default, reason: not valid java name */
    public static /* synthetic */ Shader m3253ImageShaderF49vj9s$default(ImageBitmap imageBitmap, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = TileMode.INSTANCE.m3312getClamp3opZhB0();
        }
        if ((i3 & 4) != 0) {
            i2 = TileMode.INSTANCE.m3312getClamp3opZhB0();
        }
        return m3252ImageShaderF49vj9s(imageBitmap, i, i2);
    }

    /* JADX INFO: renamed from: ImageShader-F49vj9s, reason: not valid java name */
    public static final Shader m3252ImageShaderF49vj9s(ImageBitmap image, int tileModeX, int tileModeY) {
        Intrinsics.checkNotNullParameter(image, "image");
        return AndroidShader_androidKt.m2849ActualImageShaderF49vj9s(image, tileModeX, tileModeY);
    }
}

...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2916createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2729isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m2787getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset((Offset.m2708getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m2708getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m2777getWidthimpl(size) : Offset.m2708getXimpl(this.center), Offset.m2709getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2774getHeightimpl(size) : Offset.m2709getYimpl(this.center));
        }
        return ShaderKt.m3258SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m2705equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m2710hashCodeimpl(this.center);

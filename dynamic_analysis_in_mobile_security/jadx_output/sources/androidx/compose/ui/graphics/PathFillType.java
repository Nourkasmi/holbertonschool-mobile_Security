...
public final class PathFillType {
    ...
    private static final int NonZero = m3216constructorimpl(0);
    private static final int EvenOdd = m3216constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m3215boximpl(int i) {
        return new PathFillType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3216constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3217equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3218equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3219hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3217equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3219hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3223getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* JADX INFO: renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m3222getEvenOddRgk1Os() {
    ...
    public static String m3220toStringimpl(int arg0) {
        return m3218equalsimpl0(arg0, NonZero) ? "NonZero" : m3218equalsimpl0(arg0, EvenOdd) ? "EvenOdd" : "Unknown";
    }

    public String toString() {
        return m3220toStringimpl(this.value);
    }
}

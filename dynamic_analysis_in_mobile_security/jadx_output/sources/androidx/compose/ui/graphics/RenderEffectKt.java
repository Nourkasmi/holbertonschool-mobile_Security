...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m3248BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m3312getClamp3opZhB0();
        }
        return m3247BlurEffect3YTHUZs(f, f2, i);
    }

    /* JADX INFO: renamed from: BlurEffect-3YTHUZs, reason: not valid java name */
    public static final BlurEffect m3247BlurEffect3YTHUZs(float radiusX, float radiusY, int edgeTreatment) {

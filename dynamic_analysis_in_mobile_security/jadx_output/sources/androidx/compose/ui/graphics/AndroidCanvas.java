...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo2804concat58bKbWc(float[] matrix) {
        ...
        if (!MatrixKt.m3195isIdentity58bKbWc(matrix)) {
    ...
    public void mo2807drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m5330getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m5331getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m5330getXimpl(srcOffset) + IntSize.m5372getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m5331getYimpl(srcOffset) + IntSize.m5371getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect $this$drawImageRect_HPBpro0_u24lambda_u241 = this.dstRect;
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m5330getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m5331getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m5330getXimpl(dstOffset) + IntSize.m5372getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m5331getYimpl(dstOffset) + IntSize.m5371getHeightimpl(dstSize);
    ...
    public void mo2809drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        ...
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (!PointMode.m3240equalsimpl0(pointMode, PointMode.INSTANCE.m3244getLinesr_lszbg())) {
            if (!PointMode.m3240equalsimpl0(pointMode, PointMode.INSTANCE.m3246getPolygonr_lszbg())) {
                if (PointMode.m3240equalsimpl0(pointMode, PointMode.INSTANCE.m3245getPointsr_lszbg())) {

...
public interface Path {
    ...
    void mo2839addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo2841opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo2842setFillTypeoQ8Xj4U(int i);

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo2844translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3213transform58bKbWc(Path $this, float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            Path.super.mo2843transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m3210addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: addPath-Uv8p0NA");
        }
        if ((i & 2) != 0) {
            j = Offset.INSTANCE.m2724getZeroF1C5BW0();
        }
        path.mo2839addPathUv8p0NA(path2, j);
    }
    ...
    default void mo2843transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
    }
    ...
    public static final class Companion {
        ...
        public final Path m3211combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path path = AndroidPath_androidKt.Path();
            if (path.mo2841opN5in7k0(path1, path2, operation)) {
                return path;
            }

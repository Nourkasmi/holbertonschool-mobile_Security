...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m2820setFromtUYjHk(float[] setFrom, android.graphics.Matrix matrix) {
    ...
    */
    public static final void m2819setFromEL8BTi8(android.graphics.Matrix r24, float[] r25) {
        /*
            Method dump skipped, instruction units count: 244
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.AndroidMatrixConversions_androidKt.m2819setFromEL8BTi8(android.graphics.Matrix, float[]):void");
    }
}

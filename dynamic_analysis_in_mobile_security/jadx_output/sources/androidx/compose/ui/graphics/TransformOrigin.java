...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m3317boximpl(long j) {
    ...
    public static boolean m3323equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3324equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m3327hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3328toStringimpl(long j) {
    ...
    public int hashCode() {
        return m3327hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m3328toStringimpl(this.packedValue);
    }
    ...
    public static final float m3325getPivotFractionXimpl(long arg0) {
    ...
    public static final float m3326getPivotFractionYimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* JADX INFO: renamed from: component1-impl, reason: not valid java name */
    public static final float m3318component1impl(long arg0) {
        return m3325getPivotFractionXimpl(arg0);
    }

    /* JADX INFO: renamed from: component2-impl, reason: not valid java name */
    public static final float m3319component2impl(long arg0) {
        return m3326getPivotFractionYimpl(arg0);
    }

    /* JADX INFO: renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m3322copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m3325getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m3326getPivotFractionYimpl(j);
        }
        return m3321copyzey9I6w(j, f, f2);
    }

    /* JADX INFO: renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m3321copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m3330getCenterSzJe1aQ() {

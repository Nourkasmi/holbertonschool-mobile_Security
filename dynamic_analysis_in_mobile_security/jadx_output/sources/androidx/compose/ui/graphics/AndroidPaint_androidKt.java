...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2833setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int mode) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3342setBlendModeGB0RdKg(setNativeBlendMode, mode);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2801toPorterDuffModes9anfk8(mode)));
        }
    }
    ...
    public static final void m2834setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long value) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m3001toArgb8_81llA(value));
    }

    /* JADX INFO: renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m2838setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int value) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m3203equalsimpl0(value, PaintingStyle.INSTANCE.m3208getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint $this$getNativeStyle) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m3208getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m3207getFillTiuSbCo();
    }
    ...
    public static final void m2836setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int value) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m3288equalsimpl0(value, StrokeCap.INSTANCE.m3294getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m3288equalsimpl0(value, StrokeCap.INSTANCE.m3293getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m3288equalsimpl0(value, StrokeCap.INSTANCE.m3292getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final void m2837setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int value) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m3298equalsimpl0(value, StrokeJoin.INSTANCE.m3303getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m3298equalsimpl0(value, StrokeJoin.INSTANCE.m3302getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m3298equalsimpl0(value, StrokeJoin.INSTANCE.m3304getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint $this$getNativeFilterQuality) {
        ...
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m3044getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m3042getLowfv9h1I();
    }

    /* JADX INFO: renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m2835setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int value) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m3037equalsimpl0(value, FilterQuality.INSTANCE.m3044getNonefv9h1I()));
    }

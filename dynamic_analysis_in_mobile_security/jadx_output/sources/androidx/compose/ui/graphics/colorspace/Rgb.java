...
public final class Rgb extends ColorSpace {
    ...
    public Rgb(String name, float[] primaries, WhitePoint whitePoint, float[] transform, DoubleFunction oetf, DoubleFunction eotf, float min, float max, TransferParameters transferParameters, int id) {
        super(name, ColorModel.INSTANCE.m3353getRgbxdoWZVw(), id, null);
        ...
        this.isWideGamut = companion.isWideGamut(fArrXyPrimaries, min, max);
        this.isSrgb = companion.isSrgb(fArrXyPrimaries, whitePoint, oetf, eotf, min, max, id);
    }
    ...
    public Rgb(String name, float[] toXYZ, final Function1<? super Double, Double> oetf, final Function1<? super Double, Double> eotf) {
        ...
        Intrinsics.checkNotNullParameter(eotf, "eotf");
        Companion companion = INSTANCE;
        this(name, companion.computePrimaries$ui_graphics_release(toXYZ), companion.computeWhitePoint(toXYZ), null, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda5
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
                return Rgb._init_$lambda$2(oetf, d);
            }
        }, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda6
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
                return Rgb._init_$lambda$3(eotf, d);
            }
        }, 0.0f, 1.0f, null, -1);
    }
    ...
    public Rgb(String name, float[] primaries, WhitePoint whitePoint, final Function1<? super Double, Double> oetf, final Function1<? super Double, Double> eotf, float min, float max) {
        this(name, primaries, whitePoint, null, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.Rgb$$ExternalSyntheticLambda0
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d) {
                return Rgb._init_$lambda$4(oetf, d);
            }
    ...
    */
    ...
    public long mo3356xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");

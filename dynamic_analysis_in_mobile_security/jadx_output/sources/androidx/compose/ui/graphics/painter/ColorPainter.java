...
public final class ColorPainter extends Painter {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        ...
        DrawScope.m3484drawRectnJ9OG0$default($this$onDraw, this.color, 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m2948equalsimpl0(this.color, ((ColorPainter) other).color);
    }

    public int hashCode() {
        return Color.m2954hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m2955toStringimpl(this.color)) + ')';
    }

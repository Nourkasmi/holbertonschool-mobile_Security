...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m3292getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m3303getMiterLxFBmk8();
    ...
    public boolean equals(Object other) {
        ...
        if (this.width == ((Stroke) other).width) {
            return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m3288equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m3298equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m3289hashCodeimpl(this.cap)) * 31) + StrokeJoin.m3299hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m3290toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m3300toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}

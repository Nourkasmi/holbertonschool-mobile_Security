...
public interface DrawTransform {
    ...
    void mo3416clipPathmtrdDE(Path path, int clipOp);

    /* JADX INFO: renamed from: clipRect-N_I0leg */
    void mo3417clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);
    ...
    void mo3420rotateUv8p0NA(float degrees, long pivot);

    /* JADX INFO: renamed from: scale-0AR0LA0 */
    void mo3421scale0AR0LA0(float scaleX, float scaleY, long pivot);

    /* JADX INFO: renamed from: transform-58bKbWc */
    void mo3422transform58bKbWc(float[] matrix);
    ...
    public static final class DefaultImpls {
        ...
        public static long m3545getCenterF1C5BW0(DrawTransform $this) {
            return DrawTransform.super.mo3418getCenterF1C5BW0();
        }
    }

    /* JADX INFO: renamed from: getCenter-F1C5BW0 */
    default long mo3418getCenterF1C5BW0() {
        float f = 2;
        return OffsetKt.Offset(Size.m2777getWidthimpl(mo3419getSizeNHjbRc()) / f, Size.m2774getHeightimpl(mo3419getSizeNHjbRc()) / f);
    }

    /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m3540clipRectN_I0leg$default(DrawTransform drawTransform, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        if ((i2 & 4) != 0) {
            f3 = Size.m2777getWidthimpl(drawTransform.mo3419getSizeNHjbRc());
        }
        if ((i2 & 8) != 0) {
            f4 = Size.m2774getHeightimpl(drawTransform.mo3419getSizeNHjbRc());
        }
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m2936getIntersectrtfAjoo();
        }
        drawTransform.mo3417clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m3539clipPathmtrdDE$default(DrawTransform drawTransform, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        drawTransform.mo3416clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m3541rotateUv8p0NA$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if (obj != null) {
        ...
        if ((i & 2) != 0) {
            j = drawTransform.mo3418getCenterF1C5BW0();
        }
        drawTransform.mo3420rotateUv8p0NA(f, j);
    }

    /* JADX INFO: renamed from: scale-0AR0LA0$default, reason: not valid java name */
    static /* synthetic */ void m3542scale0AR0LA0$default(DrawTransform drawTransform, float f, float f2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        drawTransform.mo3421scale0AR0LA0(f, f2, j);
    }
}

...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3531rotateRg1IO4c$default(DrawScope rotate, float degrees, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = rotate.mo3488getCenterF1C5BW0();
        }
        ...
        $this$rotate_Rg1IO4c_u24lambda_u240.mo3420rotateUv8p0NA(degrees, pivot);
        block.invoke(rotate);
    ...
    public static final void m3530rotateRg1IO4c(DrawScope rotate, float degrees, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = rotate.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3533rotateRadRg1IO4c$default(DrawScope rotateRad, float radians, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = rotateRad.mo3488getCenterF1C5BW0();
        }
        ...
        $this$rotateRad_Rg1IO4c_u24lambda_u241.mo3420rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    ...
    public static final void m3532rotateRadRg1IO4c(DrawScope rotateRad, float radians, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = rotateRad.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3535scaleFgt4K4Q$default(DrawScope scale, float scaleX, float scaleY, long pivot, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            pivot = scale.mo3488getCenterF1C5BW0();
        }
        ...
        $this$scale_Fgt4K4Q_u24lambda_u242.mo3421scale0AR0LA0(scaleX, scaleY, pivot);
        block.invoke(scale);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3415setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3534scaleFgt4K4Q(DrawScope scale, float scaleX, float scaleY, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = scale.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3537scaleRg1IO4c$default(DrawScope scale, float scale2, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = scale.mo3488getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        ...
        $this$scale_Rg1IO4c_u24lambda_u243.mo3421scale0AR0LA0(scale2, scale2, pivot);
        block.invoke(scale);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3415setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3536scaleRg1IO4c(DrawScope scale, float scale2, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = scale.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3529clipRectrOu3jXo$default(DrawScope clipRect, float left, float top, float right, float bottom, int clipOp, Function1 block, int i, Object obj) {
        float left2 = (i & 1) != 0 ? 0.0f : left;
        float top2 = (i & 2) != 0 ? 0.0f : top;
        float right2 = (i & 4) != 0 ? Size.m2777getWidthimpl(clipRect.mo3489getSizeNHjbRc()) : right;
        float bottom2 = (i & 8) != 0 ? Size.m2774getHeightimpl(clipRect.mo3489getSizeNHjbRc()) : bottom;
        int clipOp2 = (i & 16) != 0 ? ClipOp.INSTANCE.m2936getIntersectrtfAjoo() : clipOp;
        ...
        $this$clipRect_rOu3jXo_u24lambda_u244.mo3417clipRectN_I0leg(left2, top2, right2, bottom2, clipOp2);
    ...
    public static final void m3528clipRectrOu3jXo(DrawScope clipRect, float left, float top, float right, float bottom, int clipOp, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = clipRect.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3414getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        DrawTransform $this$clipRect_rOu3jXo_u24lambda_u244 = $this$withTransform_u24lambda_u246$iv.getTransform();
        $this$clipRect_rOu3jXo_u24lambda_u244.mo3417clipRectN_I0leg(left, top, right, bottom, clipOp);
        block.invoke(clipRect);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3415setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static /* synthetic */ void m3527clipPathKD09W0M$default(DrawScope clipPath, Path path, int clipOp, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            clipOp = ClipOp.INSTANCE.m2936getIntersectrtfAjoo();
        }
        ...
        $this$clipPath_KD09W0M_u24lambda_u245.mo3416clipPathmtrdDE(path, clipOp);
    ...
    public static final void m3526clipPathKD09W0M(DrawScope clipPath, Path path, int clipOp, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = clipPath.getDrawContext();
    ...
    public static final void withTransform(DrawScope $this$withTransform, Function1<? super DrawTransform, Unit> transformBlock, Function1<? super DrawScope, Unit> drawBlock) {
        ...
        long previousSize = $this$withTransform_u24lambda_u246.mo3414getSizeNHjbRc();
        ...
        $this$withTransform_u24lambda_u246.mo3415setSizeuvyYCjk(previousSize);
    }
}

...
public final class OffsetEffect extends RenderEffect {
    ...
    protected android.graphics.RenderEffect getAndroidRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m3250createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof OffsetEffect) && Intrinsics.areEqual(this.renderEffect, ((OffsetEffect) other).renderEffect) && Offset.m2705equalsimpl0(this.offset, ((OffsetEffect) other).offset);
    }

    public int hashCode() {
        RenderEffect renderEffect = this.renderEffect;
        int result = renderEffect != null ? renderEffect.hashCode() : 0;
        return (result * 31) + Offset.m2710hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + ((Object) Offset.m2716toStringimpl(this.offset)) + ')';
    }
}

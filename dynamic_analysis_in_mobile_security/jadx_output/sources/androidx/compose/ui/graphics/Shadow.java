...
public final class Shadow {
    ...
    public static /* synthetic */ void m3261getColor0d7_KjU$annotations() {
    }

    /* JADX INFO: renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m3262getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m2724getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shadow) && Color.m2948equalsimpl0(this.color, ((Shadow) other).color) && Offset.m2705equalsimpl0(this.offset, ((Shadow) other).offset)) {
    ...
    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.color);
        return (((result * 31) + Offset.m2710hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m2955toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m2716toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* JADX INFO: renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m3263copyqcb84PM(long color, long offset, float blurRadius) {

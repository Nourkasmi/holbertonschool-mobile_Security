...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((((iHashCode + r2) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.hashCode(this.alpha)) * 31;
    ...
    public void update(PainterModifier node) {
        ...
        boolean z = this.sizeToIntrinsics;
        boolean intrinsicsChanged = sizeToIntrinsics != z || (z && !Size.m2773equalsimpl0(node.getPainter().mo3558getIntrinsicSizeNHjbRc(), this.painter.mo3558getIntrinsicSizeNHjbRc()));

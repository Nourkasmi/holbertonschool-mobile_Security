...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m4339getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m4345getLastConstraintsDWUhwKw();
    }

    /* JADX INFO: renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m4340getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.INSTANCE.m5340getZeronOccac();
        ...
        /* JADX INFO: renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m4345getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m5156boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo4183measureBRTryo0(long constraints) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                $this$measure_BRTryo0_u24lambda_u2412.mo4183measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m4346remeasureBRTryo0(constraints);
            return this;
        }

        /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m4346remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m5161equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            this.measuredOnce = true;
            long outerPreviousMeasuredSize = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4190getSizeYbymL2g();
            m4239setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m4338performMeasureBRTryo0(constraints);
            if (IntSize.m5370equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4190getSizeYbymL2g(), outerPreviousMeasuredSize) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                sizeChanged = false;
            }
            m4238setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return sizeChanged;
        }
        ...
        public void mo4184placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            if (!IntOffset.m5329equalsimpl0(position, this.lastPosition)) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default($this$placeAt_f8xVGno_u24lambda_u2416, it, IntOffset.m5330getXimpl(position), IntOffset.m5331getYimpl(position), 0.0f, 4, null);
            }
            m4344placeOuterCoordinatorf8xVGno(position, zIndex, layerBlock);
        }

        /* JADX INFO: renamed from: placeOuterCoordinator-f8xVGno, reason: not valid java name */
        private final void m4344placeOuterCoordinatorf8xVGno(final long position, final float zIndex, final Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LayingOut;
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m4388placeSelfApparentToRealOffsetf8xVGno(position, zIndex, layerBlock);
                ...
                snapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1
                    ...
                    public final void invoke2() {
                        ...
                        float f = zIndex;
                        if (function1 == null) {
                            $this$invoke_u24lambda_u240.m4244place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f);
                        } else {
                            $this$invoke_u24lambda_u240.m4249placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f, function1);
                        }
                    }
                });
            }
        ...
        public final void replace() {
            try {
                ...
                m4344placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
            } finally {
        ...
        private final void onBeforeLayoutChildren() {
            ...
            do {
                LayoutNode it = (LayoutNode) content$iv$iv[i$iv$iv];
                if (it.getMeasurePending$ui_release() && it.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m4322remeasure_Sx5XlM$ui_release$default(it, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                ...
                mo4183measureBRTryo0(lookaheadConstraints.getValue());
                ...
                mo4183measureBRTryo0(lookaheadConstraints2.getValue());
            }
        }
        ...
        public final void placeBasedOnLookahead() {
            ...
            mo4184placeAtf8xVGno(lookaheadDelegate.getLastPosition(), lookaheadDelegate.getLastZIndex(), lookaheadDelegate.getLastLayerBlock$ui_release());
        }
    }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public Placeable mo4183measureBRTryo0(long constraints) {
            ...
            m4343remeasureBRTryo0(constraints);
            return this;
        }
        ...
        /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m4343remeasureBRTryo0(long constraints) {
            LayoutNode parent = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            boolean z = true;
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure() || (parent != null && parent.getCanMultiMeasure()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m5161equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m5156boximpl(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m4337performLookaheadMeasureBRTryo0(constraints);
            m4238setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            if (IntSize.m5372getWidthimpl(lastLookaheadSize) == lookaheadDelegate.getWidth() && IntSize.m5371getHeightimpl(lastLookaheadSize) == lookaheadDelegate.getHeight()) {
                z = false;
            }
        ...
        @Override // androidx.compose.ui.layout.Placeable
        /* JADX INFO: renamed from: placeAt-f8xVGno */
        public void mo4184placeAtf8xVGno(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m5329equalsimpl0(position, this.lastPosition)) {
                if (LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringModifierPlacement() || LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringPlacement()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeAt$1
                    ...
                    public final void invoke2() {
                        ...
                        Intrinsics.checkNotNull(lookaheadDelegate);
                        Placeable.PlacementScope.m4240place70tqf50$default($this$invoke_u24lambda_u240, lookaheadDelegate, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
        ...
        private final void onBeforeLayoutChildren() {
            ...
            do {
                ...
                if (it.getLookaheadMeasurePending$ui_release() && it.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                    ...
                    Intrinsics.checkNotNull(lookaheadConstraints);
                    if (lookaheadPassDelegate.m4343remeasureBRTryo0(lookaheadConstraints.getValue())) {
        ...
        public final void replace() {
            try {
                ...
                mo4184placeAtf8xVGno(this.lastPosition, 0.0f, null);
            } finally {
                this.relayoutWithoutParentInProgress = false;
            }
        }
    ...
    public final void m4338performMeasureBRTryo0(final long constraints) {
        ...
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                this.this$0.getOuterCoordinator().mo4183measureBRTryo0(constraints);
            }
        });
    ...
    public final void m4337performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo4183measureBRTryo0(constraints);
            }
        }, 2, null);

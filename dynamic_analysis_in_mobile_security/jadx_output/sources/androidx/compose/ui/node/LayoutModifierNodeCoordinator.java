...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4183measureBRTryo0(long constraints) {
            ...
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5156boximpl(constraints);
            ...
            this_$iv.set_measureResult($this$measure_BRTryo0_u24lambda_u241_u24lambda_u240.mo238measure3p2s80s(this, lookaheadDelegate, constraints));
            return this_$iv;
        }
    ...
    /* JADX INFO: renamed from: measure-BRTryo0 */
    public Placeable mo4183measureBRTryo0(long constraints) {
        MeasureResult measureResultMo238measure3p2s80s;
        ...
        if ($this$measure_BRTryo0_u24lambda_u242_u24lambda_u241 instanceof IntermediateLayoutModifierNode) {
            ...
            long jIntSize = IntSizeKt.IntSize(it.getWidth(), it.getHeight());
            Constraints constraints2 = this.lookaheadConstraints;
            Intrinsics.checkNotNull(constraints2);
            measureResultMo238measure3p2s80s = ((IntermediateLayoutModifierNode) $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241).m4185intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, jIntSize, constraints2.getValue());
        } else {
            measureResultMo238measure3p2s80s = $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241.mo238measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(measureResultMo238measure3p2s80s);
        onMeasured();
        return this;
    }
    ...
    protected void mo4184placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int parentWidth$iv = IntSize.m5372getWidthimpl(getMeasuredSize());
    ...
    static {
        ...
        paint.mo2828setColor8_81llA(Color.INSTANCE.m2974getBlue0d7_KjU());

...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope, Function1<Canvas, Unit> {
    ...
    private static final float[] tmpMatrix = Matrix.m3171constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public int mo4394entityTypeOLwlOKw() {
        ...
        public void mo4393childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
            layoutNode.m4323hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public void mo4393childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
            Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
            layoutNode.m4324hitTestSemanticsM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    ...
    public interface HitTestSource {
        /* JADX INFO: renamed from: childHitTest-YqVAtuI */
        void mo4393childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* JADX INFO: renamed from: entityType-OLwlOKw */
        int mo4394entityTypeOLwlOKw();
    ...
    public NodeCoordinator(LayoutNode layoutNode) {
        ...
        this.position = IntOffset.INSTANCE.m5340getZeronOccac();
    ...
    public final /* synthetic */ <T> void m4391visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        int i;
        ...
        int i4 = 0;
        boolean includeTail$iv4 = NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(type);
    ...
    private final boolean m4371hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m4294has64DMado(nodeHeadNode, type);
    }

    /* JADX INFO: renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m4384headH91voCI(int type) {
        boolean includeTail$iv = NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(type);
    ...
    public final long mo4190getSizeYbymL2g() {
    ...
    public void replace$ui_release() {
        mo4184placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (layer4 != null) {
            layer4.mo4447resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            if (nodeCoordinator != null) {
        ...
        m4238setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        NodeCoordinator nodeCoordinator2 = null;
        updateLayerParameters(false);
        int type$iv4 = NodeKind.m4398constructorimpl(4);
        NodeCoordinator this_$iv5 = this;
        boolean includeTail$iv$iv = NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(type$iv4);
    ...
    protected void m4389setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        ...
        MutableVector mutableVector;
        int i = 64;
        if (!getLayoutNode().getNodes().m4361hasH91voCI$ui_release(NodeKind.m4398constructorimpl(64))) {
            return null;
        }
        ...
        while (node$iv != null) {
            ...
            int kind$iv = (node.getKindSet() & NodeKind.m4398constructorimpl(i)) != 0 ? 1 : 0;
            if (kind$iv != 0) {
    ...
    public final long m4382getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return getMeasurementConstraints();
    }

    /* JADX INFO: renamed from: performingMeasure-K40F9xA, reason: not valid java name */
    protected final Placeable m4387performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m4239setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
    ...
    public final void onMeasured() throws Throwable {
        ...
        MutableVector mutableVector;
        if (!m4371hasNodeH91voCI(NodeKind.m4398constructorimpl(128))) {
            return;
        }
        ...
        try {
            try {
                int type$iv4 = NodeKind.m4398constructorimpl(128);
                NodeCoordinator this_$iv5 = this;
                int i3 = 0;
                boolean includeTail$iv$iv = NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(type$iv4);
                                    ...
                                    try {
                                        if (nodePop instanceof LayoutAwareModifierNode) {
                                            try {
                                                ...
                                                this_$iv3 = this_$iv5;
                                                i2 = i3;
                                                it.mo4281onRemeasuredozmzZPI(getMeasuredSize());
                                                type$iv2 = type$iv4;
    ...
    protected void mo4184placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m4375placeSelff8xVGno(position, zIndex, layerBlock);
    }

    /* JADX INFO: renamed from: placeSelf-f8xVGno, reason: not valid java name */
    private final void m4375placeSelff8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        updateLayerBlock$default(this, layerBlock, false, 2, null);
        if (!IntOffset.m5329equalsimpl0(getPosition(), position)) {
            m4389setPositiongyyYBs(position);
            ...
            if (layer != null) {
                layer.mo4446movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m4388placeSelfApparentToRealOffsetf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        long other$iv = getApparentToRealOffset();
        m4375placeSelff8xVGno(IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(position) + IntOffset.m5330getXimpl(other$iv), IntOffset.m5331getYimpl(position) + IntOffset.m5331getYimpl(other$iv)), zIndex, layerBlock);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float x = IntOffset.m5330getXimpl(getPosition());
        float y = IntOffset.m5331getYimpl(getPosition());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas) {
        Modifier.Node head = m4384headH91voCI(NodeKind.m4398constructorimpl(4));
        if (head == null) {
            performDraw(canvas);
        } else {
            LayoutNodeDrawScope drawScope = getLayoutNode().getMDrawScope$ui_release();
            drawScope.m4333drawx_KDEd0$ui_release(canvas, IntSizeKt.m5382toSizeozmzZPI(mo4190getSizeYbymL2g()), this, head);
        }
    }
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (isAttached() && layerBlock != null) {
            if (this.layer == null) {
                ...
                $this$updateLayerBlock_u24lambda_u2413.mo4447resizeozmzZPI(getMeasuredSize());
                $this$updateLayerBlock_u24lambda_u2413.mo4446movegyyYBs(getPosition());
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        reusableGraphicsLayerScope.m3251setSizeuvyYCjk(IntSizeKt.m5382toSizeozmzZPI(mo4190getSizeYbymL2g()));
    ...
    public final long m4383getMinimumTouchTargetSizeNHjbRc() {
        Density $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2416 = this.layerDensity;
        return $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2416.mo327toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo4327getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* JADX INFO: renamed from: hitTest-YqVAtuI, reason: not valid java name */
    public final void m4385hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        Modifier.Node head = m4384headH91voCI(hitTestSource.mo4394entityTypeOLwlOKw());
        if (!m4392withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                float distanceFromEdge = m4380distanceInMinimumTouchTargettz77jQw(pointerPosition, m4383getMinimumTouchTargetSizeNHjbRc());
                if (((Float.isInfinite(distanceFromEdge) || Float.isNaN(distanceFromEdge)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge, false)) {
                    m4373hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, distanceFromEdge);
                    return;
                }
                return;
            }
        ...
        if (head == null) {
            mo4317hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m4386isPointerInBoundsk4lQ0M(pointerPosition)) {
            m4372hit1hIXUjU(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float distanceFromEdge2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m4380distanceInMinimumTouchTargettz77jQw(pointerPosition, m4383getMinimumTouchTargetSizeNHjbRc());
        if (((Float.isInfinite(distanceFromEdge2) || Float.isNaN(distanceFromEdge2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge2, isInLayer)) {
            m4373hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        } else {
            m4376speculativeHitJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: hit-1hIXUjU, reason: not valid java name */
    public final void m4372hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m4372hit1hIXUjU(NodeCoordinatorKt.m4396nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
    ...
    public final void m4373hitNearJHbHoSQ(final Modifier.Node $this$hitNear_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m4373hitNearJHbHoSQ(NodeCoordinatorKt.m4396nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public final void m4376speculativeHitJHbHoSQ(final Modifier.Node $this$speculativeHit_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$speculativeHit_u2dJHbHoSQ != null) {
            if (hitTestSource.interceptOutOfBoundsChildEvents($this$speculativeHit_u2dJHbHoSQ)) {
                hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                    ...
                    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        this.this$0.m4376speculativeHitJHbHoSQ(NodeCoordinatorKt.m4396nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                    }
                });
                return;
            } else {
                m4376speculativeHitJHbHoSQ(NodeCoordinatorKt.m4396nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4394entityTypeOLwlOKw(), NodeKind.m4398constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                return;
            }
        }
        mo4317hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
    ...
    public void mo4317hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestSource, "hitTestSource");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        NodeCoordinator wrapped = this.wrapped;
        if (wrapped != null) {
            long positionInWrapped = wrapped.m4381fromParentPositionMKHz9U(pointerPosition);
            wrapped.m4385hitTestYqVAtuI(hitTestSource, positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long padding = m4379calculateMinimumTouchTargetPaddingE7KxVPU(m4383getMinimumTouchTargetSizeNHjbRc());
        bounds.setLeft(-Size.m2777getWidthimpl(padding));
        bounds.setTop(-Size.m2774getHeightimpl(padding));
        bounds.setRight(getMeasuredWidth() + Size.m2777getWidthimpl(padding));
        bounds.setBottom(getMeasuredHeight() + Size.m2774getHeightimpl(padding));
    ...
    public long mo4195windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        long positionInRoot = Offset.m2712minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo4450calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(root));
        return mo4191localPositionOfR5De75A(root, positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToWindow-MK-Hz9U */
    public long mo4193localToWindowMKHz9U(long relativeToLocal) {
        long positionInRoot = mo4192localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo4451calculatePositionInWindowMKHz9U(positionInRoot);
    }
    ...
    public long mo4191localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            return Offset.m2717unaryMinusF1C5BW0(sourceCoordinates.mo4191localPositionOfR5De75A(this, Offset.m2717unaryMinusF1C5BW0(relativeToSource)));
        }
        ...
        while (coordinator != commonAncestor) {
            position = coordinator.m4390toParentPositionMKHz9U(position);
            NodeCoordinator nodeCoordinator2 = coordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator2);
            coordinator = nodeCoordinator2;
        }
        return m4370ancestorToLocalR5De75A(commonAncestor, position);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: transformFrom-EL8BTi8 */
    public void mo4194transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
        ...
        Matrix.m3180resetimpl(matrix);
        coordinator.m4378transformToAncestorEL8BTi8(commonAncestor, matrix);
        m4377transformFromAncestorEL8BTi8(commonAncestor, matrix);
    }

    /* JADX INFO: renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m4378transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator wrapper = this;
        while (!Intrinsics.areEqual(wrapper, ancestor)) {
            OwnedLayer ownedLayer = wrapper.layer;
            if (ownedLayer != null) {
                ownedLayer.mo4448transform58bKbWc(matrix);
            }
            long position = wrapper.getPosition();
            if (!IntOffset.m5329equalsimpl0(position, IntOffset.INSTANCE.m5340getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m3180resetimpl(fArr);
                Matrix.m3191translateimpl$default(fArr, IntOffset.m5330getXimpl(position), IntOffset.m5331getYimpl(position), 0.0f, 4, null);
                Matrix.m3188timesAssign58bKbWc(matrix, fArr);
            }
    ...
    private final void m4377transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual(ancestor, this)) {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
            nodeCoordinator.m4377transformFromAncestorEL8BTi8(ancestor, matrix);
            if (!IntOffset.m5329equalsimpl0(getPosition(), IntOffset.INSTANCE.m5340getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m3180resetimpl(fArr);
                Matrix.m3191translateimpl$default(fArr, -IntOffset.m5330getXimpl(getPosition()), -IntOffset.m5331getYimpl(getPosition()), 0.0f, 4, null);
                Matrix.m3188timesAssign58bKbWc(matrix, fArr);
            }
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo4443inverseTransform58bKbWc(matrix);
            }
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        bounds.setLeft(0.0f);
        bounds.setTop(0.0f);
        bounds.setRight(IntSize.m5372getWidthimpl(sourceCoordinates.mo4190getSizeYbymL2g()));
        bounds.setBottom(IntSize.m5371getHeightimpl(sourceCoordinates.mo4190getSizeYbymL2g()));
    ...
    private final long m4370ancestorToLocalR5De75A(NodeCoordinator ancestor, long offset) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator wrappedBy = this.wrappedBy;
        if (wrappedBy == null || Intrinsics.areEqual(ancestor, wrappedBy)) {
            return m4381fromParentPositionMKHz9U(offset);
        }
        return m4381fromParentPositionMKHz9U(wrappedBy.m4370ancestorToLocalR5De75A(ancestor, offset));
    }
    ...
    public long mo4192localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        onCoordinatesUsed$ui_release();
    ...
    public long m4390toParentPositionMKHz9U(long position) {
        OwnedLayer layer = this.layer;
        long targetPosition = layer != null ? layer.mo4445mapOffset8S9VItk(position, false) : position;
        return IntOffsetKt.m5344plusNvtHpc(targetPosition, getPosition());
    }

    /* JADX INFO: renamed from: fromParentPosition-MK-Hz9U, reason: not valid java name */
    public long m4381fromParentPositionMKHz9U(long position) {
        long relativeToPosition = IntOffsetKt.m5342minusNvtHpc(position, getPosition());
        OwnedLayer layer = this.layer;
        return layer != null ? layer.mo4445mapOffset8S9VItk(relativeToPosition, true) : relativeToPosition;
    }

    protected final void drawBorder(Canvas canvas, Paint paint) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(paint, "paint");
        Rect rect = new Rect(0.5f, 0.5f, IntSize.m5372getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m5371getHeightimpl(getMeasuredSize()) - 0.5f);
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long minTouch = m4383getMinimumTouchTargetSizeNHjbRc();
                    float horz = Size.m2777getWidthimpl(minTouch) / 2.0f;
                    float vert = Size.m2774getHeightimpl(minTouch) / 2.0f;
                    bounds.intersect(-horz, -vert, IntSize.m5372getWidthimpl(mo4190getSizeYbymL2g()) + horz, IntSize.m5371getHeightimpl(mo4190getSizeYbymL2g()) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m5372getWidthimpl(mo4190getSizeYbymL2g()), IntSize.m5371getHeightimpl(mo4190getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m5330getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + x);
        bounds.setRight(bounds.getRight() + x);
        int y = IntOffset.m5331getYimpl(getPosition());
    ...
    protected final boolean m4392withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m2725isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer layer = this.layer;
        return layer == null || !this.isClipping || layer.mo4444isInLayerk4lQ0M(pointerPosition);
    }

    /* JADX INFO: renamed from: isPointerInBounds-k-4lQ0M, reason: not valid java name */
    protected final boolean m4386isPointerInBoundsk4lQ0M(long pointerPosition) {
        float x = Offset.m2708getXimpl(pointerPosition);
        float y = Offset.m2709getYimpl(pointerPosition);
    ...
    static /* synthetic */ Object propagateRelocationRequest$suspendImpl(NodeCoordinator $this, Rect rect, Continuation<? super Unit> continuation) {
        ...
        Rect rectInParentBounds = rect.m2745translatek4lQ0M(boundingBoxInParentCoordinates.m2743getTopLeftF1C5BW0());
        Object objPropagateRelocationRequest = parent.propagateRelocationRequest(rectInParentBounds, continuation);
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int iM4398constructorimpl = NodeKind.m4398constructorimpl(2);
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int count$iv$iv;
        MutableVector mutableVector;
        Modifier.Node start = headNode(NodeKindKt.m4407getIncludeSelfInTraversalH91voCI(NodeKind.m4398constructorimpl(16)));
        if (start == null) {
            return false;
        }
        Modifier.Node $this$visitLocalDescendants_u2d6rFNWt0$iv = start;
        int type$iv3 = NodeKind.m4398constructorimpl(16);
    ...
    private final long m4374offsetFromEdgeMKHz9U(long pointerPosition) {
        float x = Offset.m2708getXimpl(pointerPosition);
    ...
    protected final long m4379calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        float widthDiff = Size.m2777getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth();
        float heightDiff = Size.m2774getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight();
    ...
    protected final float m4380distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m2777getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m2774getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long jM4379calculateMinimumTouchTargetPaddingE7KxVPU = m4379calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m2777getWidthimpl(jM4379calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m2774getHeightimpl(jM4379calculateMinimumTouchTargetPaddingE7KxVPU);
        long offsetFromEdge = m4374offsetFromEdgeMKHz9U(pointerPosition);
        if ((width > 0.0f || height > 0.0f) && Offset.m2708getXimpl(offsetFromEdge) <= width && Offset.m2709getYimpl(offsetFromEdge) <= height) {
            return Offset.m2707getDistanceSquaredimpl(offsetFromEdge);
        }
        return Float.POSITIVE_INFINITY;
    }

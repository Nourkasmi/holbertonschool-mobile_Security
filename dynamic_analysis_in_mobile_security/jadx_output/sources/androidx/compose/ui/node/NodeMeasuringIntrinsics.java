...
public final class NodeMeasuringIntrinsics {
    ...
    public interface MeasureBlock {
        ...
        MeasureResult mo4188measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        MeasureResult layoutResult = measureBlock.mo4188measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
        ...
        public Placeable mo4183measureBRTryo0(long constraints) {
            ...
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                if (this.minMax == IntrinsicMinMax.Max) {
                    width = this.measurable.maxIntrinsicWidth(Constraints.m5167getMaxHeightimpl(constraints));
                } else {
                    width = this.measurable.minIntrinsicWidth(Constraints.m5167getMaxHeightimpl(constraints));
                }
                return new EmptyPlaceable(width, Constraints.m5167getMaxHeightimpl(constraints));
            }
            if (this.minMax == IntrinsicMinMax.Max) {
                height = this.measurable.maxIntrinsicHeight(Constraints.m5168getMaxWidthimpl(constraints));
            } else {
                height = this.measurable.minIntrinsicHeight(Constraints.m5168getMaxWidthimpl(constraints));
            }
            return new EmptyPlaceable(Constraints.m5168getMaxWidthimpl(constraints), height);
        }

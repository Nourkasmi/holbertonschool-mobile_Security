...
public final class NodeKindKt {
    ...
    public static final int m4408or64DMado(int $this$or_u2d64DMado, int other) {
        return $this$or_u2d64DMado | other;
    }

    /* JADX INFO: renamed from: contains-64DMado, reason: not valid java name */
    public static final boolean m4406contains64DMado(int $this$contains_u2d64DMado, int value) {
    ...
    public static final boolean m4407getIncludeSelfInTraversalH91voCI(int $this$includeSelfInTraversal) {
        return (NodeKind.m4398constructorimpl(128) & $this$includeSelfInTraversal) != 0;
    }

    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        Intrinsics.checkNotNullParameter(element, "element");
        int mask = NodeKind.m4398constructorimpl(1);
        if (element instanceof LayoutModifier) {
            int other$iv = NodeKind.m4398constructorimpl(2) | mask;
            mask = other$iv;
        }
        if (element instanceof DrawModifier) {
            int $this$or_u2d64DMado$iv = mask;
            int other$iv2 = NodeKind.m4398constructorimpl(4) | $this$or_u2d64DMado$iv;
            mask = other$iv2;
        }
        if (element instanceof SemanticsModifier) {
            int $this$or_u2d64DMado$iv2 = mask;
            int other$iv3 = NodeKind.m4398constructorimpl(8) | $this$or_u2d64DMado$iv2;
            mask = other$iv3;
        }
        if (element instanceof PointerInputModifier) {
            int $this$or_u2d64DMado$iv3 = mask;
            int other$iv4 = NodeKind.m4398constructorimpl(16) | $this$or_u2d64DMado$iv3;
            mask = other$iv4;
        }
        if ((element instanceof ModifierLocalConsumer) || (element instanceof ModifierLocalProvider)) {
            int $this$or_u2d64DMado$iv4 = mask;
            int other$iv5 = NodeKind.m4398constructorimpl(32) | $this$or_u2d64DMado$iv4;
            mask = other$iv5;
        }
        if (element instanceof FocusEventModifier) {
            int $this$or_u2d64DMado$iv5 = mask;
            int other$iv6 = NodeKind.m4398constructorimpl(4096) | $this$or_u2d64DMado$iv5;
            mask = other$iv6;
        }
        if (element instanceof FocusOrderModifier) {
            int $this$or_u2d64DMado$iv6 = mask;
            int other$iv7 = NodeKind.m4398constructorimpl(2048) | $this$or_u2d64DMado$iv6;
            mask = other$iv7;
        }
        if (element instanceof OnGloballyPositionedModifier) {
            int $this$or_u2d64DMado$iv7 = mask;
            int other$iv8 = NodeKind.m4398constructorimpl(256) | $this$or_u2d64DMado$iv7;
            mask = other$iv8;
        }
        if (element instanceof ParentDataModifier) {
            int $this$or_u2d64DMado$iv8 = mask;
            int other$iv9 = NodeKind.m4398constructorimpl(64) | $this$or_u2d64DMado$iv8;
            mask = other$iv9;
        }
        if ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) {
            int $this$or_u2d64DMado$iv9 = mask;
            int other$iv10 = NodeKind.m4398constructorimpl(128) | $this$or_u2d64DMado$iv9;
            return other$iv10;
        }
        return mask;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        if (node instanceof ParentDataModifierNode) {
            int $this$or_u2d64DMado$iv5 = mask;
            int other$iv6 = NodeKind.m4398constructorimpl(64) | $this$or_u2d64DMado$iv5;
            mask = other$iv6;
        }
        if (node instanceof LayoutAwareModifierNode) {
            int $this$or_u2d64DMado$iv6 = mask;
            int other$iv7 = NodeKind.m4398constructorimpl(128) | $this$or_u2d64DMado$iv6;
            mask = other$iv7;
        }
        ...
        if (node instanceof IntermediateLayoutModifierNode) {
            int $this$or_u2d64DMado$iv8 = mask;
            int other$iv9 = NodeKind.m4398constructorimpl(512) | $this$or_u2d64DMado$iv8;
            mask = other$iv9;
        }
        if (node instanceof FocusTargetNode) {
            int $this$or_u2d64DMado$iv9 = mask;
            int other$iv10 = NodeKind.m4398constructorimpl(1024) | $this$or_u2d64DMado$iv9;
            mask = other$iv10;
        }
        if (node instanceof FocusPropertiesModifierNode) {
            int $this$or_u2d64DMado$iv10 = mask;
            int other$iv11 = NodeKind.m4398constructorimpl(2048) | $this$or_u2d64DMado$iv10;
            mask = other$iv11;
        }
        if (node instanceof FocusEventModifierNode) {
            int $this$or_u2d64DMado$iv11 = mask;
            int other$iv12 = NodeKind.m4398constructorimpl(4096) | $this$or_u2d64DMado$iv11;
            mask = other$iv12;
        }
        if (node instanceof KeyInputModifierNode) {
            int $this$or_u2d64DMado$iv12 = mask;
            int other$iv13 = NodeKind.m4398constructorimpl(8192) | $this$or_u2d64DMado$iv12;
            mask = other$iv13;
        }
        if (node instanceof RotaryInputModifierNode) {
            int $this$or_u2d64DMado$iv13 = mask;
            int other$iv14 = NodeKind.m4398constructorimpl(16384) | $this$or_u2d64DMado$iv13;
            mask = other$iv14;
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            int $this$or_u2d64DMado$iv14 = mask;
            int other$iv15 = NodeKind.m4398constructorimpl(32768) | $this$or_u2d64DMado$iv14;
            mask = other$iv15;
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            int $this$or_u2d64DMado$iv15 = mask;
            int other$iv16 = NodeKind.m4398constructorimpl(131072) | $this$or_u2d64DMado$iv15;
            return other$iv16;
        }
        return mask;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int selfKindSet, int phase) {
        if (phase != 0 || node.getShouldAutoInvalidate()) {
            int value$iv = (selfKindSet & NodeKind.m4398constructorimpl(2)) != 0 ? 1 : 0;
            if (value$iv != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (phase == 2) {
                    NodeCoordinator coordinator = DelegatableNodeKt.m4296requireCoordinator64DMado(node, NodeKind.m4398constructorimpl(2));
                    coordinator.onRelease();
                }
            }
            int value$iv2 = (selfKindSet & NodeKind.m4398constructorimpl(256)) != 0 ? 1 : 0;
            ...
            int value$iv3 = (selfKindSet & NodeKind.m4398constructorimpl(4)) != 0 ? 1 : 0;
            if (value$iv3 != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            int value$iv4 = (selfKindSet & NodeKind.m4398constructorimpl(8)) != 0 ? 1 : 0;
            ...
            int value$iv5 = (selfKindSet & NodeKind.m4398constructorimpl(64)) != 0 ? 1 : 0;
            ...
            int value$iv6 = (selfKindSet & NodeKind.m4398constructorimpl(1024)) != 0 ? 1 : 0;
            ...
            int value$iv7 = (selfKindSet & NodeKind.m4398constructorimpl(2048)) != 0 ? 1 : 0;
            ...
            if (((selfKindSet & NodeKind.m4398constructorimpl(4096)) != 0) && (node instanceof FocusEventModifierNode)) {

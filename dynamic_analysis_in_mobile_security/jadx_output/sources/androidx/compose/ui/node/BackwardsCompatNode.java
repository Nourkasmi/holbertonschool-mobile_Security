...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((this_$iv.getKindSet() & NodeKind.m4398constructorimpl(32)) != 0) {
        ...
        if ((this_$iv2.getKindSet() & NodeKind.m4398constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        BackwardsCompatNode this_$iv2 = this;
        if ((this_$iv2.getKindSet() & NodeKind.m4398constructorimpl(4)) != 0) {
        ...
        if ((this_$iv3.getKindSet() & NodeKind.m4398constructorimpl(2)) != 0) {
        ...
        if ((this_$iv4.getKindSet() & NodeKind.m4398constructorimpl(128)) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.2
                        ...
                        public void onLayoutComplete() {
                            if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                                ...
                                backwardsCompatNode.onPlaced(DelegatableNodeKt.m4296requireCoordinator64DMado(backwardsCompatNode, NodeKind.m4398constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if (((this_$iv5.getKindSet() & NodeKind.m4398constructorimpl(256)) != 0) && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if (((this_$iv6.getKindSet() & NodeKind.m4398constructorimpl(16)) != 0) && (element instanceof PointerInputModifier)) {
        ...
        if ((this_$iv7.getKindSet() & NodeKind.m4398constructorimpl(8)) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo2613getSizeNHjbRc() {
        return IntSizeKt.m5382toSizeozmzZPI(DelegatableNodeKt.m4296requireCoordinator64DMado(this, NodeKind.m4398constructorimpl(128)).mo4190getSizeYbymL2g());
    }
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        LayoutNode layoutNodeRequireLayoutNode = DelegatableNodeKt.requireLayoutNode(backwardsCompatNode3);
    ...
    public MeasureResult mo238measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return $this$measure_3p2s80s_u24lambda_u241.mo38measure3p2s80s(measure, measurable, constraints);
    }
    ...
    public void mo143onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        $this$onPointerEvent_H0pRuoY_u24lambda_u247.getPointerInputFilter().mo4086onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo4281onRemeasuredozmzZPI(long size) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo251onRemeasuredozmzZPI(size);
        }
    }

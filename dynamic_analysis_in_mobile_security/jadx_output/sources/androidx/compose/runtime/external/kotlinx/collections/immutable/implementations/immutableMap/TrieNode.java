...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m2593assert(this.nodeMap == 0);
        CommonFunctionsKt.m2593assert(this.dataMap == 0);
        CommonFunctionsKt.m2593assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m2593assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> otherNode, int positionMask, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (otherNode.hasNodeAt(positionMask)) {
            ...
            if (hasEntryAt$runtime_release(positionMask)) {
                ...
                if (!trieNodeNodeAtIndex$runtime_release2.containsKey(kKeyAtIndex2 != null ? kKeyAtIndex2.hashCode() : 0, kKeyAtIndex2, shift + 5)) {
                    return trieNodeNodeAtIndex$runtime_release2.mutablePut(kKeyAtIndex2 != null ? kKeyAtIndex2.hashCode() : 0, kKeyAtIndex2, valueAtKeyIndex(keyIndex2), shift + 5, mutator);
                }
                intersectionCounter.setCount(intersectionCounter.getCount() + 1);
        ...
        return makeNode(kKeyAtIndex3 != null ? kKeyAtIndex3.hashCode() : 0, kKeyAtIndex3, vValueAtKeyIndex2, kKeyAtIndex4 != null ? kKeyAtIndex4.hashCode() : 0, kKeyAtIndex4, otherNode.valueAtKeyIndex(otherKeyIndex), shift + 5, mutator.getOwnership());
    }
    ...
    public final boolean containsKey(int keyHash, K key, int shift) {
        ...
        if (hasNodeAt(keyPositionMask)) {
            TrieNode<K, V> trieNodeNodeAtIndex$runtime_release = nodeAtIndex$runtime_release(nodeIndex$runtime_release(keyPositionMask));
            if (shift == 30) {
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        return elementsIdentityEquals(trieNode2) ? this : otherNode.elementsIdentityEquals(trieNode2) ? otherNode : trieNode2;
    }
    ...
    public final ModificationResult<K, V> put(int keyHash, K key, V value, int shift) {
        ...
        if (hasNodeAt(keyPositionMask)) {
            ...
            TrieNode<K, V> trieNodeNodeAtIndex$runtime_release = nodeAtIndex$runtime_release(nodeIndex);
            if (shift == 30) {
    ...
    public final TrieNode<K, V> mutablePut(int keyHash, K key, V value, int shift, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (hasNodeAt(keyPositionMask)) {
            ...
            return trieNodeNodeAtIndex$runtime_release == trieNodeMutablePut ? this : mutableUpdateNodeAtIndex(nodeIndex, trieNodeMutablePut, mutator.getOwnership());
        }
        mutator.setSize(mutator.size() + 1);
    ...
    public final TrieNode<K, V> remove(int keyHash, K key, int shift) {
        ...
        if (hasNodeAt(keyPositionMask)) {
            ...
            return replaceNode(trieNodeNodeAtIndex$runtime_release, trieNodeRemove, nodeIndex, keyPositionMask);
        }
        return this;
    }
    ...
    public final TrieNode<K, V> mutableRemove(int keyHash, K key, int shift, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (hasNodeAt(keyPositionMask)) {
            ...
            return mutableReplaceNode(trieNodeNodeAtIndex$runtime_release, trieNodeMutableRemove, nodeIndex, keyPositionMask, mutator.getOwnership());
        }
        return this;
    }
    ...
    private final void accept(Function5<? super TrieNode<K, V>, ? super Integer, ? super Integer, ? super Integer, ? super Integer, Unit> visitor, int hash, int shift) {
        ...
        while (nodePositions != 0) {
            ...
            nodeAtIndex$runtime_release(nodeIndex$runtime_release(mask)).accept(visitor, (hashSegment << shift) + hash, shift + 5);
            nodePositions -= mask;
        }
    }

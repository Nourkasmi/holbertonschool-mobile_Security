...
public final class SnapshotWeakSet<T> {
    ...
    public final boolean add(T value) {
        ...
        if (size == capacity) {
            ...
            ArraysKt.copyInto(weakReferenceArr, weakReferenceArr2, insertIndex + 1, insertIndex, size);
            ArraysKt.copyInto$default(this.values, weakReferenceArr2, 0, 0, insertIndex, 6, (Object) null);
    ...
    public final void removeIf(Function1<? super T, Boolean> block) {
        ...
        while (true) {
            ...
            if (value != null && !block.invoke(value).booleanValue()) {
                if (currentUsed != i) {
                    getValues$runtime_release()[currentUsed] = weakReference;
    ...
    */
    private final int findExactIndex(int r5, T r6, int r7) {
        ...
        L2:
            ...
            goto L1d
        Ld:
            androidx.compose.runtime.WeakReference<T>[] r2 = r4.values
            r2 = r2[r0]
            if (r2 == 0) goto L17

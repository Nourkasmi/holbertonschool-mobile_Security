...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    public TransparentObserverSnapshot(Snapshot previousSnapshot, Function1<Object, Unit> function1, boolean mergeParentObservers, boolean ownsPreviousSnapshot) {
        ...
        this.readObserver = SnapshotKt.mergedReadObserver(function1, (previousSnapshot == null || (readObserver$runtime_release = previousSnapshot.getReadObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getReadObserver$runtime_release() : readObserver$runtime_release, mergeParentObservers);
        this.root = this;
    }

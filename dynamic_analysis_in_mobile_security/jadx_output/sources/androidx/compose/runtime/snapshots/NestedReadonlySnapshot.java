...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot(int id, SnapshotIdSet invalid, final Function1<Object, Unit> function1, Snapshot parent) {
        ...
        if (function1 != null) {
            final Function1<Object, Unit> readObserver$runtime_release2 = parent.getReadObserver$runtime_release();
            if (readObserver$runtime_release2 != null) {
                readObserver$runtime_release = new Function1<Object, Unit>() { // from class: androidx.compose.runtime.snapshots.NestedReadonlySnapshot$readObserver$1$1$1
                    ...
                    public final void invoke2(Object state) {
                        ...
                        readObserver$runtime_release2.invoke(state);
                    }
                };
            } else {

...
final class SnapshotMapEntrySet<K, V> extends SnapshotMapSet<K, V, Map.Entry<K, V>> {
    ...
    @Override // java.util.Set, java.util.Collection
    public boolean retainAll(Collection<? extends Object> elements) throws Throwable {
        ...
        while (true) {
            ...
            PersistentMap.Builder<K, V> it$iv = builder;
            ...
            while (true) {
                ...
                if ((r2.containsKey(next.getKey()) && Intrinsics.areEqual(r2.get(next.getKey()), next.getValue())) ? false : true) {
                    it$iv.remove(next.getKey());
                    removed$iv = true;
                }
            }
            ...
            synchronized (lock$iv$iv$iv$iv$iv$iv) {
                try {
                    ...
                    try {
                        ?? r22 = r2;
                        try {
                            SnapshotStateMap.StateMapStateRecord $this$mutate_u24lambda_u2411$iv$iv = (SnapshotStateMap.StateMapStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv$iv, map, current);
                            Object lock$iv$iv$iv2 = SnapshotStateMapKt.sync;
                            synchronized (lock$iv$iv$iv2) {
                                try {
                                    if ($this$mutate_u24lambda_u2411$iv$iv.getModification() == currentModification$iv$iv) {
                                        ...
                                        try {
                                            $this$mutate_u24lambda_u2411$iv$iv.setMap$runtime_release(persistentMapBuild);

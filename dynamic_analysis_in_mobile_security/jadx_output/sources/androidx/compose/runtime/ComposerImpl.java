...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m2559startBaiHCIY(key, null, GroupKind.INSTANCE.m2569getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m2559startBaiHCIY(-127, null, GroupKind.INSTANCE.m2569getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m2559startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m2569getGroupULZAiWs(), null);
    }
    ...
    public void startNode() {
        m2559startBaiHCIY(125, null, GroupKind.INSTANCE.m2570getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2559startBaiHCIY(125, null, GroupKind.INSTANCE.m2571getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m2559startBaiHCIY(key, null, GroupKind.INSTANCE.m2569getGroupULZAiWs(), dataKey);
    }
        ...
        Function3<Applier<?>, SlotWriter, RememberManager, Unit> function3 = new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$apply$operation$1
            ...
            public final void invoke2(androidx.compose.runtime.Applier<?> r2, androidx.compose.runtime.SlotWriter r3, androidx.compose.runtime.RememberManager r4) {
                /*
                    ...
                    kotlin.jvm.functions.Function2<T, V, kotlin.Unit> r3 = r2
                    java.lang.Object r4 = r2.getCurrent()
                    V r0 = r3
                    r3.invoke(r4, r0)
                    return
                */
        ...
        if (getInserting() && this.writerHasAProvider) {
            ...
            while (current > 0) {
                if (this.writer.groupKey(current) == 202 && Intrinsics.areEqual(this.writer.groupObjectKey(current), ComposerKt.getCompositionLocalMap())) {
                    ...
                    PersistentCompositionLocalMap providers = (PersistentCompositionLocalMap) objGroupAux;
    ...
    private final PersistentCompositionLocalMap updateProviderMapGroup(PersistentCompositionLocalMap parentScope, PersistentCompositionLocalMap currentProviders) {
        ...
        PersistentMap.Builder<CompositionLocal<Object>, State<? extends Object>> it = builderBuilder2;
    ...
    public void startProviders(final ProvidedValue<?>[] values) {
        ...
        PersistentCompositionLocalMap currentProviders = (PersistentCompositionLocalMap) ActualJvm_jvmKt.invokeComposableForResult(this, new Function2<Composer, Integer, PersistentCompositionLocalMap>() { // from class: androidx.compose.runtime.ComposerImpl$startProviders$currentProviders$1
            ...
            public final PersistentCompositionLocalMap invoke(Composer $composer, int $changed) {
                ...
                PersistentCompositionLocalMap persistentCompositionLocalMapCompositionLocalMapOf = CompositionLocalMapKt.compositionLocalMapOf(values, parentScope, $composer, 8);
                if (ComposerKt.isTraceInProgress()) {
        ...
        this.providerCache = providers;
        m2559startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2569getGroupULZAiWs(), providers);
    }
    ...
    public CompositionContext buildContext() {
        ...
        CompositionContextHolder holder = objNextSlot instanceof CompositionContextHolder ? (CompositionContextHolder) objNextSlot : null;
        if (holder == null) {
    ...
    private final void m2559startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        Pending newPending;
        validateNodeNotExpected();
        updateCompoundKeyWhenWeEnterGroup(key, objectKey, data);
        boolean isNode = kind != GroupKind.INSTANCE.m2569getGroupULZAiWs();
        if (getInserting()) {
        ...
        boolean forceReplace = (kind != GroupKind.INSTANCE.m2570getNodeULZAiWs() ? 1 : 0) == 0 && this.reusing;
    ...
    private final void recomposeToGroupEnd() {
        ...
        int oldGroup = parent;
        Invalidation firstInRange = ComposerKt.firstInRange(this.invalidations, this.reader.getCurrent(), end);
        ...
        if (updatedNodeCount(group) != count) {
            if (group < 0) {
                ...
                if (map == null) {
                    ...
                    $this$updateNodeCount_u24lambda_u2414.nodeCountVirtualOverrides = map2;
                    map = map2;
                }
            ...
            if (nodeCounts == null) {
                ...
                int[] newCounts = new int[$this$updateNodeCount_u24lambda_u2415.reader.getGroupsSize()];
                ArraysKt.fill$default(newCounts, -1, 0, 0, 6, (Object) null);
                $this$updateNodeCount_u24lambda_u2415.nodeCountOverrides = newCounts;
                nodeCounts = newCounts;
            }
    ...
    private final void recordUpsAndDowns(int oldGroup, int newGroup, int commonRoot) {
        SlotReader reader = this.reader;
        int nearestCommonRoot = ComposerKt.nearestCommonRootOf(reader, oldGroup, newGroup, commonRoot);
    ...
    public ScopeUpdateScope endRestartGroup() {
        ...
        if (scope != null && (function1End = scope.end(this.compositionToken)) != null) {
    ...
    public final void invokeMovableContentLambda(final MovableContent<Object> content, PersistentCompositionLocalMap locals, final Object parameter, boolean force) {
        ...
        try {
            ...
            m2559startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m2569getGroupULZAiWs(), locals);
    ...
    private final void insertMovableContentGuarded(List<Pair<MovableContentStateReference, MovableContentStateReference>> references) throws Throwable {
        ...
        int $i$f$withChanges;
        List<Pair<MovableContentStateReference, MovableContentStateReference>> list2;
        int i2;
        SlotTable slotTable;
        Anchor anchor;
        Anchor anchor2;
        ...
        try {
            ...
            List<Pair<MovableContentStateReference, MovableContentStateReference>> list4 = references;
            int size = list4.size();
            int index$iv2 = 0;
            while (index$iv2 < size) {
                Object item$iv = list4.get(index$iv2);
                ...
                record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$1
                    ...
                    public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                        ...
                        Intrinsics.checkNotNullParameter(slots, "slots");
                        Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                        effectiveNodeIndex.element = ComposerImpl.insertMovableContentGuarded$positionToInsert(slots, anchor3, applier);
                    }
                });
                if (from == null) {
                    try {
                        ...
                        try {
                            ...
                            final List offsetChanges = new ArrayList();
                            try {
                                index$iv = index$iv2;
                                i = size;
                                try {
                                    recomposeMovableContent$default(this, null, null, null, null, new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$2$1
                                        ...
                                        public final void invoke2() {
                                            ComposerImpl this_$iv = this.this$0;
                                            List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list5 = offsetChanges;
                                        ...
                                        try {
                                            record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$2$2
                                                ...
                                                public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                                                    ...
                                                    Intrinsics.checkNotNullParameter(slots, "slots");
                                                    Intrinsics.checkNotNullParameter(rememberManager, "rememberManager");
                                                    OffsetApplier offsetApplier = effectiveNodeIndex.element > 0 ? new OffsetApplier(applier, effectiveNodeIndex.element) : applier;
                                                    List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list5 = offsetChanges;
                                                    int size2 = list5.size();
                                                    for (int index$iv3 = 0; index$iv3 < size2; index$iv3++) {
                                                        Object item$iv2 = list5.get(index$iv3);
                                                        ((Function3) item$iv2).invoke(offsetApplier, slots, rememberManager);
                                                    }
                                                }
                                            });
                                        } catch (Throwable th) {
                    ...
                    final List nodesToInsert = ComposerKt.collectNodesFrom(fromTable, fromAnchor);
                    if (!nodesToInsert.isEmpty()) {
                        record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$3
                            ...
                            public final void invoke2(Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
                                ...
                                Intrinsics.checkNotNullParameter(slotWriter, "<anonymous parameter 1>");
                                Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                                int base = effectiveNodeIndex.element;
                                List<Object> list5 = nodesToInsert;
                                int size2 = list5.size();
                                for (int index$iv3 = 0; index$iv3 < size2; index$iv3++) {
                                    Object item$iv2 = list5.get(index$iv3);
                                    int i4 = index$iv3;
                    ...
                    record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$4
                        ...
                        public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                            ...
                            Intrinsics.checkNotNullParameter(slots, "slots");
                            Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                            MovableContentState state = resolvedState;
                            if (state == null && (state = this.parentContext.movableContentStateResolve$runtime_release(from)) == null) {
                                ComposerKt.composeRuntimeError("Could not resolve state for movable content");
                                throw new KotlinNothingValueException();
                            }
                            List<Anchor> listMoveIntoGroupFrom = slots.moveIntoGroupFrom(1, state.getSlotTable(), 2);
                                    ...
                                    try {
                                        ...
                                        try {
                                            recomposeMovableContent(from.getComposition(), to.getComposition(), Integer.valueOf(reader$iv2.getCurrent()), from.getInvalidations$runtime_release(), new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$5$1$1$1
                                                ...
                                                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                                                public final void invoke2() {
                                                    this.this$0.invokeMovableContentLambda(to.getContent$runtime_release(), to.getLocals(), to.getParameter(), true);
                                                }
                                            });
                                            Unit unit2 = Unit.INSTANCE;
                                            try {
                                                    ...
                                                    try {
                                                        record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$5$1$2
                                                            ...
                                                            public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                                                                ...
                                                                Intrinsics.checkNotNullParameter(rememberManager, "rememberManager");
                                                                OffsetApplier offsetApplier = effectiveNodeIndex.element > 0 ? new OffsetApplier(applier, effectiveNodeIndex.element) : applier;
                                                                List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list5 = offsetChanges2;
                                                                int size2 = list5.size();
                                                                for (int index$iv3 = 0; index$iv3 < size2; index$iv3++) {
                                                                    Object item$iv2 = list5.get(index$iv3);
                                                                    ((Function3) item$iv2).invoke(offsetApplier, slots, rememberManager);
    ...
    private final <R> R recomposeMovableContent(ControlledComposition from, ControlledComposition to, Integer index, List<Pair<RecomposeScopeImpl, IdentityArraySet<Object>>> invalidations, Function0<? extends R> block) throws Throwable {
        R rInvoke;
    ...
    public void sourceInformationMarkerStart(int key, String sourceInformation) {
        ...
        if (this.sourceInformationEnabled) {
            m2559startBaiHCIY(key, null, GroupKind.INSTANCE.m2569getGroupULZAiWs(), sourceInformation);
        }
    }
    ...
    private final void recordInsert(final Anchor anchor) {
        if (this.insertFixups.isEmpty()) {
            ...
            recordSlotEditingOperation(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl.recordInsert.1
                ...
                public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                    ...
                    Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                    slots.beginInsert();
                    SlotTable slotTable = insertTable;
        ...
        recordSlotEditingOperation(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl.recordInsert.2
            ...
            public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                ...
                Intrinsics.checkNotNullParameter(slots, "slots");
                Intrinsics.checkNotNullParameter(rememberManager, "rememberManager");
                SlotTable this_$iv = insertTable2;
                List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list = fixups;
                SlotWriter writer$iv = this_$iv.openWriter();
                try {
                    int size = list.size();
                    for (int index$iv = 0; index$iv < size; index$iv++) {
                        Object item$iv = list.get(index$iv);
                        ((Function3) item$iv).invoke(applier, writer$iv, rememberManager);
                    }
                    Unit unit = Unit.INSTANCE;
                    writer$iv.close();
                    slots.beginInsert();
                    SlotTable slotTable = insertTable2;
                    slots.moveFrom(slotTable, anchor.toIndexFor(slotTable), false);
                    slots.endInsert();
                } catch (Throwable th) {
                    writer$iv.close();
    ...
    private static final int reportFreeMovableContent$reportGroup(final ComposerImpl this$0, int group, boolean needsNodeDelete, int nodeIndex) {
        if (this$0.reader.hasMark(group)) {
            ...
            if (key == 126665345 && (objectKey instanceof MovableContent)) {
                ...
                List $this$fastMap$iv = ComposerKt.filterToRange(this$0.invalidations, group, end);
                ...
                this$0.record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$reportFreeMovableContent$reportGroup$1
                    ...
                    public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                        ...
                        Intrinsics.checkNotNullParameter(slots, "slots");
                        Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                        this.this$0.releaseMovableGroupAtCurrent(reference, slots);
                    }
                });
                if (needsNodeDelete) {
            ...
            if (key == 206 && Intrinsics.areEqual(objectKey, ComposerKt.getReference())) {
                Object objGroupGet = this$0.reader.groupGet(group, 0);
                CompositionContextHolder contextHolder = objGroupGet instanceof CompositionContextHolder ? (CompositionContextHolder) objGroupGet : null;
    ...
    public final void releaseMovableGroupAtCurrent(final MovableContentStateReference reference, SlotWriter slots) {
        ...
        try {
            ...
            List<Anchor> listMoveTo = slots.moveTo(reference.getAnchor(), 1, writer$iv);
            writer$iv.skipGroup();
            writer$iv.endGroup();
            writer$iv.endInsert();
            writer$iv.close();
            ...
            if (RecomposeScopeImpl.INSTANCE.hasAnchoredRecomposeScopes$runtime_release(slotTable, listMoveTo)) {
                ...
                try {
                    RecomposeScopeImpl.INSTANCE.adoptAnchoredScopes$runtime_release(writer$iv, listMoveTo, recomposeScopeOwner);
                    Unit unit = Unit.INSTANCE;
                } finally {
                }
            }
            ...
            if (!this.composers.isEmpty()) {
                ...
                if (set != null) {
                    for (ComposerImpl composer : this.composers) {
                        ...
                        while (it.hasNext()) {
                            it.next().remove(composer.slotTable);
                        }
                    }
                }

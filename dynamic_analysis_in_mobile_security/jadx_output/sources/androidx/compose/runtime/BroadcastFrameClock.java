    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM5499constructorimpl = Result.m5499constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM5499constructorimpl = Result.m5499constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(objM5499constructorimpl);
        }
    }
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) throws Throwable {
        ...
        synchronized (lock$iv) {
            try {
                ...
                if (cause != null) {
                    Result.Companion companion = Result.INSTANCE;
                    co.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(cause)));
                } else {
                    try {
    ...
    public final void fail(Throwable cause) {
        ...
        synchronized (lock$iv) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                Continuation<?> continuation = ((FrameAwaiter) item$iv).getContinuation();
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m5499constructorimpl(ResultKt.createFailure(cause)));
            }
            this.awaiters.clear();
            Unit unit = Unit.INSTANCE;
        }

...
public final class SurfaceKt {
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material3.SurfaceKt$LocalAbsoluteTonalElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5210boximpl(m1800invokeD9Ej5fM());
        }

        /* JADX INFO: renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1800invokeD9Ej5fM() {
            return Dp.m5212constructorimpl(0);
        }
    }, 1, null);

    /* JADX INFO: renamed from: Surface-T9BRK9s, reason: not valid java name */
    public static final void m1792SurfaceT9BRK9s(Modifier modifier, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, int i) {
        ...
        long color2 = (i & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme($composer, 6).m1376getSurface0d7_KjU() : color;
        long contentColor2 = (i & 8) != 0 ? ColorSchemeKt.m1412contentColorForek8zF_U(color2, $composer, ($changed >> 6) & 14) : contentColor;
        float tonalElevation2 = (i & 16) != 0 ? Dp.m5212constructorimpl(0) : tonalElevation;
        float shadowElevation2 = (i & 32) != 0 ? Dp.m5212constructorimpl(0) : shadowElevation;
        ...
        float arg0$iv = ((Dp) objConsume).m5226unboximpl();
        final float absoluteElevation = Dp.m5212constructorimpl(arg0$iv + tonalElevation2);
        final Modifier modifier3 = modifier2;
        final Shape shape3 = shape2;
        final long j = color2;
        final BorderStroke borderStroke = border2;
        final float f = shadowElevation2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), providableCompositionLocal.provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, -70914509, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Modifier modifier$iv = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(SurfaceKt.m1798surface8ww4TTg(modifier3, shape3, SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 6) & 14), borderStroke, f), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.1
    ...
    public static final void m1795Surfaceo_FOJdg(final Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, int i) {
        ...
        long color2 = (i & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme($composer, 6).m1376getSurface0d7_KjU() : color;
        long contentColor2 = (i & 32) != 0 ? ColorSchemeKt.m1412contentColorForek8zF_U(color2, $composer, ($changed >> 12) & 14) : contentColor;
        float tonalElevation2 = (i & 64) != 0 ? Dp.m5212constructorimpl(0) : tonalElevation;
        float shadowElevation2 = (i & 128) != 0 ? Dp.m5212constructorimpl(0) : shadowElevation;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), providableCompositionLocal.provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, 1279702876, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Modifier modifier$iv = ClickableKt.m190clickableO2vRcR0(SurfaceKt.m1798surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier3), shape3, SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 12) & 14), borderStroke, f), mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7), (24 & 4) != 0 ? true : z, (24 & 8) != 0 ? null : null, (24 & 16) != 0 ? null : null, onClick);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i2 = $changed1;
                    $composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final void m1793Surfaced85dljk(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, int i) {
        MutableInteractionSource interactionSource2;
        Object value$iv$iv;
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        long color2 = (i & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme($composer, 6).m1376getSurface0d7_KjU() : color;
        long contentColor2 = (i & 64) != 0 ? ColorSchemeKt.m1412contentColorForek8zF_U(color2, $composer, ($changed >> 15) & 14) : contentColor;
        float tonalElevation2 = (i & 128) != 0 ? Dp.m5212constructorimpl(0) : tonalElevation;
        float shadowElevation2 = (i & 256) != 0 ? Dp.m5212constructorimpl(0) : shadowElevation;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), providableCompositionLocal.provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, -1164547968, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$5
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Modifier modifier$iv = SelectableKt.m706selectableO2vRcR0$default(SurfaceKt.m1798surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier3), shape3, SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 15) & 14), borderStroke, f), selected, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7), z, null, onClick, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i2 = $changed1;
                    $composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    /* JADX INFO: renamed from: Surface-d85dljk, reason: not valid java name */
    public static final void m1794Surfaced85dljk(final boolean checked, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, float tonalElevation, float shadowElevation, BorderStroke border, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, int i) {
        MutableInteractionSource interactionSource2;
        Object value$iv$iv;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), providableCompositionLocal.provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer, 712720927, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$7
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if (($changed2 & 11) != 2 || !$composer2.getSkipping()) {
                    ...
                    Modifier modifier$iv = ToggleableKt.m710toggleableO2vRcR0$default(SurfaceKt.m1798surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier3), shape3, SurfaceKt.m1799surfaceColorAtElevationCLU3JFs(j, absoluteElevation, $composer2, ($changed >> 15) & 14), borderStroke, f), checked, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer2, 0, 7), z, null, onCheckedChange, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i2 = $changed1;
                    $composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
    ...
    public static final Modifier m1798surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float shadowElevation) {
        Modifier modifierM2619shadows4CzXII = ShadowKt.m2619shadows4CzXII($this$surface_u2d8ww4TTg, shadowElevation, (24 & 2) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (24 & 4) != 0 ? Dp.m5211compareTo0680j_4(24, Dp.m5212constructorimpl((float) 0)) > 0 : false, (24 & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (24 & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L);
        Modifier.Companion companionBorder = Modifier.INSTANCE;
        if (border != null) {
            companionBorder = BorderKt.border(companionBorder, border, shape);
        }
        return ClipKt.clip(BackgroundKt.m159backgroundbw27NRU(modifierM2619shadows4CzXII.then(companionBorder), backgroundColor, shape), shape);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: surfaceColorAtElevation-CLU3JFs, reason: not valid java name */
    public static final long m1799surfaceColorAtElevationCLU3JFs(long color, float elevation, Composer $composer, int $changed) {
        long jM1417surfaceColorAtElevation3ABfNKs;
        ...
        if (Color.m2948equalsimpl0(color, MaterialTheme.INSTANCE.getColorScheme($composer, 6).m1376getSurface0d7_KjU())) {
            jM1417surfaceColorAtElevation3ABfNKs = ColorSchemeKt.m1417surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), elevation);
        } else {
            jM1417surfaceColorAtElevation3ABfNKs = color;
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return jM1417surfaceColorAtElevation3ABfNKs;
    }

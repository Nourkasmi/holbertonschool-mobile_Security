...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1859animateBorderStrokeAsStateNuRrP5Q(boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, float focusedBorderThickness, float unfocusedBorderThickness, Composer $composer, int $changed) {
        ...
        State<Color> stateIndicatorColor$material3_release = colors.indicatorColor$material3_release(enabled, isError, interactionSource, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168));
        ...
        State<BorderStroke> stateRememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(stateRememberUpdatedState.getValue().m5226unboximpl(), new SolidColor(stateIndicatorColor$material3_release.getValue().m2957unboximpl(), null), null), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {

...
public final class ScaffoldKt {
    ...
    */
    public static final void m1674ScaffoldTvnljyQ(androidx.compose.ui.Modifier r29, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r30, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, int r34, long r35, long r37, androidx.compose.foundation.layout.WindowInsets r39, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.PaddingValues, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r40, androidx.compose.runtime.Composer r41, final int r42, final int r43) {
        /*
            Method dump skipped, instruction units count: 749
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ScaffoldKt.m1674ScaffoldTvnljyQ(androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, int, long, long, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: ScaffoldLayout-FMILGgc, reason: not valid java name */
    public static final void m1675ScaffoldLayoutFMILGgc(final int fabPosition, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final WindowInsets contentWindowInsets, final Function2<? super Composer, ? super Integer, Unit> function24, Composer $composer, final int $changed) {
        int i;
        ...
        if ((2995931 & $dirty) != 599186 || !$composer2.getSkipping()) {
            ...
            Object[] keys$iv = {function2, function22, contentWindowInsets, function23, FabPosition.m1515boximpl(fabPosition), function24, function3};
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m1677invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m1677invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long constraints) {
                        ...
                        return MeasureScope.layout$default(SubcomposeLayout, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                for (Object item$iv$iv : $this$map$iv) {
                                    ...
                                    destination$iv$iv.add(it.mo4183measureBRTryo0(j));
                                }
                                ...
                                for (Object item$iv$iv2 : $this$map$iv2) {
                                    ...
                                    destination$iv$iv2.add(it4.mo4183measureBRTryo0(ConstraintsKt.m5184offsetNN6EwU(j2, i5, leftInset2)));
                                ...
                                while (true) {
                                    ...
                                    Placeable it10 = measurable.mo4183measureBRTryo0(ConstraintsKt.m5184offsetNN6EwU(j3, (-leftInset3) - rightInset2, -bottomInset2));
                                ...
                                Iterable $this$map$iv4 = subcomposeMeasureScope6.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(-1455477816, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(fabPlacement2)}, function29, $composer3, ((i6 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                for (Object item$iv$iv3 : $this$map$iv4) {
                                    ...
                                    destination$iv$iv4.add(it15.mo4183measureBRTryo0(j4));
                                }
                                ...
                                if (fabPlacement2 != null) {
                                    ...
                                    numValueOf = Integer.valueOf(bottomBarHeight == null ? fabPlacement2.getHeight() + subcomposeMeasureScope7.mo320roundToPx0680j_4(ScaffoldKt.FabSpacing) + windowInsets.getBottom(subcomposeMeasureScope7) : bottomBarHeight.intValue() + fabPlacement2.getHeight() + subcomposeMeasureScope7.mo320roundToPx0680j_4(ScaffoldKt.FabSpacing));
                                } else {
                                    numValueOf = null;
                                }
                                    ...
                                    public final void invoke(Composer $composer3, int $changed2) {
                                        ...
                                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                            ...
                                            if (topBarPlaceables.isEmpty()) {
                                                ...
                                                top = subcomposeMeasureScope9.mo323toDpu2uoSUM(topBarHeight);
                                            }
                                            if (bottomBarPlaceables.isEmpty() || (num = bottomBarHeight) == null) {
                                                bottom = insets.getBottom();
                                            } else {
                                                bottom = subcomposeMeasureScope9.mo323toDpu2uoSUM(num.intValue());
                                            }
                                            PaddingValues innerPadding = PaddingKt.m477PaddingValuesa9UjIt4(PaddingKt.calculateStartPadding(insets, subcomposeMeasureScope9.getLayoutDirection()), top, PaddingKt.calculateEndPadding(insets, subcomposeMeasureScope9.getLayoutDirection()), bottom);
                                            function33.invoke(innerPadding, $composer3, Integer.valueOf((i7 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                for (Object item$iv$iv4 : $this$map$iv5) {
                                    ...
                                    destination$iv$iv5.add(it18.mo4183measureBRTryo0(j5));
                                }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$2
            ...
            public final void invoke(Composer composer, int i3) {
                ScaffoldKt.m1675ScaffoldLayoutFMILGgc(fabPosition, function2, function3, function22, function23, contentWindowInsets, function24, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }

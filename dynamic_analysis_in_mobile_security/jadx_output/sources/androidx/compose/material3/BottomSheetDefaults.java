...
public final class BottomSheetDefaults {
    ...
    private static final float Elevation = SheetBottomTokens.INSTANCE.m2427getDockedModalContainerElevationD9Ej5fM();
    private static final float SheetPeekHeight = Dp.m5212constructorimpl(56);
    ...
    public final float m1311getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        long color = ColorSchemeKt.toColor(ScrimTokens.INSTANCE.getContainerColor(), $composer, 6);
        long jM2945copywmQWz5c = Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : 0.32f, (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final float m1312getSheetPeekHeightD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets windowInsetsM554onlybOOhFvg = WindowInsetsKt.m554onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.INSTANCE.m580getVerticalJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return windowInsetsM554onlybOOhFvg;
    }

    /* JADX INFO: renamed from: DragHandle-lgZ2HuY, reason: not valid java name */
    public final void m1310DragHandlelgZ2HuY(Modifier modifier, float width, float height, Shape shape, long color, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        float f;
        final float height2;
        Shape shape2;
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                width2 = i3 != 0 ? SheetBottomTokens.INSTANCE.m2426getDockedDragHandleWidthD9Ej5fM() : f;
                if (i4 != 0) {
                    height2 = SheetBottomTokens.INSTANCE.m2425getDockedDragHandleHeightD9Ej5fM();
                }
                if ((i & 8) != 0) {
                    $dirty &= -7169;
                ...
                if ((i & 16) != 0) {
                    long color4 = ColorSchemeKt.toColor(SheetBottomTokens.INSTANCE.getDockedDragHandleColor(), $composer2, 6);
                    color2 = Color.m2945copywmQWz5c(color4, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color4) : 0.4f, (14 & 2) != 0 ? Color.m2953getRedimpl(color4) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color4) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color4) : 0.0f);
                    $dirty &= -57345;
                } else {
                    color2 = j;
                }
            ...
            final String dragHandleDescription = Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1721getBottomSheetDragHandleDescriptionadMyvUU(), $composer2, 6);
            Modifier modifierM483paddingVpY3zN4$default = PaddingKt.m483paddingVpY3zN4$default(modifier3, 0.0f, SheetDefaultsKt.DragHandleVerticalPadding, 1, null);
            ...
            SurfaceKt.m1792SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(modifierM483paddingVpY3zN4$default, false, (Function1) value$iv$iv, 1, null), shape2, color2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda($composer2, -1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        BoxKt.Box(SizeKt.m530sizeVpY3zN4(Modifier.INSTANCE, width2, height2), $composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$3
            ...
            public final void invoke(Composer composer, int i7) {
                this.$tmp0_rcvr.m1310DragHandlelgZ2HuY(modifier6, f2, f3, shape4, j2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}

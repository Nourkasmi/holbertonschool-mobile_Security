...
public final class TopAppBarColors {
    ...
    public final long m1986containerColorXeAY9LY$material3_release(float colorTransitionFraction, Composer $composer, int $changed) {
        ...
        long jM2998lerpjxsXWHM = ColorKt.m2998lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return jM2998lerpjxsXWHM;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m2954hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2954hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2954hashCodeimpl(this.titleContentColor)) * 31) + Color.m2954hashCodeimpl(this.actionIconContentColor);
    }
}

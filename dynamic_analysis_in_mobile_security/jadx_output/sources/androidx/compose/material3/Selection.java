...
public final class Selection {
    ...
    private static final int Hour = m1691constructorimpl(0);
    private static final int Minute = m1691constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Selection m1690boximpl(int i) {
        return new Selection(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m1691constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1692equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1696unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1692equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1694hashCodeimpl(this.value);
    }

    public String toString() {
        return m1695toStringimpl(this.value);
    }

...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            return new SelectedRangeInfo(new Pair(IntOffset.m5321boximpl(startCoordinates), IntOffset.m5321boximpl(endCoordinates)), firstIsSelectionStart, lastIsSelectionEnd);
        }
    }
}

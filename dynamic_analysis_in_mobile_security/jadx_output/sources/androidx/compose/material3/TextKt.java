    ...
    public static final void m1870Text4IGK_g(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 1533916891) == 306783378 && (2995931 & $dirty12) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                lineHeight2 = i12 != 0 ? TextUnit.INSTANCE.m5404getUnspecifiedXSAIIZE() : lineHeight;
                int overflow4 = i13 != 0 ? TextOverflow.INSTANCE.m5131getClipgIe3tQ8() : overflow;
                softWrap2 = i14 != 0 ? true : softWrap;
                maxLines2 = i15 != 0 ? Integer.MAX_VALUE : maxLines;
                minLines2 = i2 != 0 ? 1 : minLines;
                textKt$Text$1 = i17 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$1
            ...
            if ($this$takeOrElse_u2dDxMtmZc$iv != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                ...
                long $this$takeOrElse_u2dDxMtmZc$iv2 = style2.m4742getColor0d7_KjU();
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.INSTANCE.m2983getUnspecified0d7_KjU()) {
                    color3 = color2;
                } else {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $this$takeOrElse_u2dDxMtmZc$iv2 = ((Color) objConsume2).m2957unboximpl();
                }
            ...
            BasicTextKt.m739BasicText4YKlhWE(text, modifier2, mergedStyle, textKt$Text$1, overflow2, softWrap2, maxLines2, minLines3, $composer2, ($dirty & 14) | ($dirty & 112) | (($dirty1 >> 6) & 7168) | (($dirty1 << 9) & 57344) | (($dirty1 << 9) & 458752) | (($dirty1 << 9) & 3670016) | (29360128 & ($dirty1 << 9)), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$2
            ...
            public final void invoke(Composer composer, int i22) {
                TextKt.m1870Text4IGK_g(text, modifier7, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration7, textAlign4, j4, i19, z, i20, i21, function13, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1872TextfLXpl1I(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$4
            ...
            public final void invoke(Composer composer, int i19) {
                TextKt.m1872TextfLXpl1I(text, modifier4, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration5, textAlign4, j4, i17, z, i18, function1, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

    /* JADX INFO: renamed from: Text-IbK3jfQ, reason: not valid java name */
    public static final void m1871TextIbK3jfQ(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, int minLines, Map<String, InlineTextContent> map, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        int i2;
        int i3;
        long color2;
        long fontSize2;
        ...
        if (i18 == 32768 && (1533916891 & $dirty) == 306783378 && (23967451 & $dirty12) == 4793490 && $composer2.getSkipping()) {
            $composer2.skipToGroupEnd();
            modifier3 = modifier;
            color3 = color;
            fontSize3 = fontSize;
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                lineHeight2 = i13 != 0 ? TextUnit.INSTANCE.m5404getUnspecifiedXSAIIZE() : lineHeight;
                int overflow4 = i14 != 0 ? TextOverflow.INSTANCE.m5131getClipgIe3tQ8() : overflow;
                softWrap2 = i15 != 0 ? true : softWrap;
                maxLines2 = i3 != 0 ? Integer.MAX_VALUE : maxLines;
                minLines2 = i2 != 0 ? 1 : minLines;
                mapEmptyMap = i18 != 0 ? MapsKt.emptyMap() : map;
                textKt$Text$5 = i19 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$5
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(TextLayoutResult textLayoutResult) {
                        invoke2(textLayoutResult);
                        return Unit.INSTANCE;
            ...
            $composer2.endReplaceableGroup();
            TextStyle mergedStyle = style2.merge(new TextStyle(textColor, fontSize2, fontWeight2, fontStyle2, (FontSynthesis) null, fontFamily2, (String) null, letterSpacing2, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, textDecoration2, (Shadow) null, textAlign2, (TextDirection) null, lineHeight2, (TextIndent) null, (PlatformTextStyle) null, (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, 4108112, (DefaultConstructorMarker) null));
            BasicTextKt.m742BasicTextVhcvRP8(text, modifier2, mergedStyle, textKt$Text$5, overflow2, softWrap2, maxLines2, minLines3, map2, $composer2, 134217728 | ($dirty & 14) | ($dirty & 112) | (($dirty1 >> 9) & 7168) | (($dirty1 << 9) & 57344) | (($dirty1 << 9) & 458752) | (($dirty1 << 9) & 3670016) | (($dirty1 << 9) & 29360128), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            map3 = map2;
        ...
        final int i23 = minLines4;
        final Map<String, InlineTextContent> map4 = map3;
        final Function1<? super TextLayoutResult, Unit> function13 = function12;
        final TextStyle textStyle = style3;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$6
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer composer, int i24) {
                TextKt.m1871TextIbK3jfQ(text, modifier7, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration7, textAlign4, j4, i21, z, i22, i23, map4, function13, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1869Text4IGK_g(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Map inlineContent, Function1 onTextLayout, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i16 == 16384 && (1533916891 & $dirty) == 306783378 && (2995931 & $dirty12) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                TextKt$Text$7 onTextLayout3 = i17 != 0 ? new Function1<TextLayoutResult, Unit>() { // from class: androidx.compose.material3.TextKt$Text$7
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(TextLayoutResult textLayoutResult) {
                        invoke2(textLayoutResult);
                        return Unit.INSTANCE;
        ...
        final Function1 function1 = onTextLayout2;
        final TextStyle textStyle = style2;
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$8
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer composer, int i20) {
                TextKt.m1869Text4IGK_g(text, modifier5, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration5, textAlign4, j4, i18, z, i19, map, function1, textStyle, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

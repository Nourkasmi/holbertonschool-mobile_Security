...
public final class SliderKt {
    ...
    public static final void SliderImpl(final Modifier modifier, final boolean enabled, final MutableInteractionSource interactionSource, final Function1<? super Float, Unit> function1, final Function0<Unit> function0, final int steps, final float value, final ClosedFloatingPointRange<Float> closedFloatingPointRange, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function3, final Function3<? super SliderPositions, ? super Composer, ? super Integer, Unit> function32, Composer $composer, final int $changed) {
        ...
        if ((1533916891 & $dirty2) == 306783378 && $composer3.getSkipping()) {
            ...
            boolean z = isRtl;
            $composer2 = $composer3;
            Modifier drag = DraggableKt.draggable(companion2, sliderDraggableState, orientation, (188 & 4) != 0 ? true : enabled, (188 & 8) != 0 ? null : interactionSource, (188 & 16) != 0 ? false : zIsDragging, (188 & 32) != 0 ? new DraggableKt.C01821(null) : null, (188 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : (Function3) value$iv$iv9, (188 & 128) != 0 ? false : z);
    ...
    */
    ...
    static final class C04152 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04152(float f, float f2, float f3, Continuation<? super C04152> continuation) {
            super(2, continuation);
            this.$current = f;
            this.$target = f2;
            this.$velocity = f3;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04152 c04152 = new C04152(this.$current, this.$target, this.$velocity, continuation);
            c04152.L$0 = obj;
            return c04152;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C04152) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Object animateToTarget(DraggableState draggableState, float current, float target, float velocity, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.drag$default(draggableState, null, new C04152(current, target, velocity, null), continuation, 1, null);

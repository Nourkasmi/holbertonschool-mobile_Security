...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T value, final Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        EffectsKt.LaunchedEffect(value, forceAnimationCheck.getValue(), new C04281(value, swipeableState, null), $composer, ($changed & 8) | 512 | ($changed & 14));
    ...
    static final class C04281 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04281(T t, SwipeableState<T> swipeableState, Continuation<? super C04281> continuation) {
            super(2, continuation);
            this.$value = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04281(this.$value, this.$swipeableState, continuation);
        }

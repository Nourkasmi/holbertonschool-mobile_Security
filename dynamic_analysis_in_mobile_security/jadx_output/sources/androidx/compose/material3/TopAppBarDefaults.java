...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1994topAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        ...
        long scrolledContainerColor2 = (i & 2) != 0 ? ColorSchemeKt.m1410applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme($composer, 6), containerColor2, TopAppBarSmallTokens.INSTANCE.m2508getOnScrollContainerElevationD9Ej5fM()) : scrolledContainerColor;
    ...
    public final TopAppBarColors m1993smallTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        ...
        TopAppBarColors topAppBarColorsM1994topAppBarColorszjMxDiM = m1994topAppBarColorszjMxDiM(containerColor2, scrolledContainerColor2, navigationIconContentColor2, titleContentColor2, actionIconContentColor2, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896) | ($changed & 7168) | (57344 & $changed) | (458752 & $changed), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return topAppBarColorsM1994topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets windowInsetsM554onlybOOhFvg = WindowInsetsKt.m554onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.m565plusgK_yJZ4(WindowInsetsSides.INSTANCE.m575getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m579getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final TopAppBarColors m1990centerAlignedTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
    ...
    public final TopAppBarColors m1992mediumTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
    ...
    public final TopAppBarColors m1991largeTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {

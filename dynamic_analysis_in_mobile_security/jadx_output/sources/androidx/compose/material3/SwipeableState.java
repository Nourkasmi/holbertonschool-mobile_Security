...
public class SwipeableState<T> {
    ...
    */
    ...
    static final class C04302 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04302(float f, SwipeableState<T> swipeableState, Continuation<? super C04302> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04302 c04302 = new C04302(this.$target, this.this$0, continuation);
            c04302.L$0 = obj;
            return c04302;
        }
        ...
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C04302) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapInternalToOffset(float target, Continuation<? super Unit> continuation) {
        Object objDrag$default = DraggableState.drag$default(this.draggableState, null, new C04302(target, this, null), continuation, 1, null);

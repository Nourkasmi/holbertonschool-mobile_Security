...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors m1548iconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        if ((i & 2) != 0) {
            ...
            contentColor2 = ((Color) objConsume).m2957unboximpl();
        } else {
        ...
        if ((i & 8) != 0) {
            ...
            disabledContentColor2 = Color.m2945copywmQWz5c(j, (14 & 1) != 0 ? Color.m2949getAlphaimpl(j) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(j) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(j) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(j) : 0.0f);
        } else {
    ...
    public final IconToggleButtonColors m1549iconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
        ...
        long checkedContainerColor2 = (i & 16) != 0 ? Color.INSTANCE.m2982getTransparent0d7_KjU() : checkedContainerColor;
    ...
    public final IconButtonColors m1544filledIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            long color = ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), $composer, 6);
        ...
        if ((i & 8) != 0) {
            long color2 = ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledColor(), $composer, 6);
            disabledContentColor2 = Color.m2945copywmQWz5c(color2, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color2) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(color2) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color2) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color2) : 0.0f);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1545filledIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long disabledContainerColor2;
        long disabledContentColor2;
        ...
        long checkedContentColor2 = (i & 32) != 0 ? ColorSchemeKt.m1412contentColorForek8zF_U(checkedContainerColor2, $composer, ($changed >> 12) & 14) : checkedContentColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconButtonColors m1546filledTonalIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long disabledContainerColor2;
        long disabledContentColor2;
        ...
        long contentColor2 = (i & 2) != 0 ? ColorSchemeKt.m1412contentColorForek8zF_U(containerColor2, $composer, $changed & 14) : contentColor;
        if ((i & 4) != 0) {
            long color = ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), $composer, 6);
            disabledContainerColor2 = Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : 0.12f, (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            long color2 = ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), $composer, 6);
            disabledContentColor2 = Color.m2945copywmQWz5c(color2, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color2) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(color2) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color2) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color2) : 0.0f);
        } else {
            disabledContentColor2 = disabledContentColor;
        }
    ...
    public final IconToggleButtonColors m1547filledTonalIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long disabledContainerColor2;
        long disabledContentColor2;
    ...
    public final IconButtonColors m1550outlinedIconButtonColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
    ...
    public final IconToggleButtonColors m1551outlinedIconToggleButtonColors5tl4gsc(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean enabled, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            Object objConsume = $composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd($composer);
            color = ((Color) objConsume).m2957unboximpl();
            $composer.endReplaceableGroup();
        } else {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            long jM2957unboximpl = ((Color) objConsume2).m2957unboximpl();
            color = Color.m2945copywmQWz5c(jM2957unboximpl, (14 & 1) != 0 ? Color.m2949getAlphaimpl(jM2957unboximpl) : 0.12f, (14 & 2) != 0 ? Color.m2953getRedimpl(jM2957unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(jM2957unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(jM2957unboximpl) : 0.0f);
            $composer.endReplaceableGroup();
        }
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = BorderStrokeKt.m187BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m2322getUnselectedOutlineWidthD9Ej5fM(), color);

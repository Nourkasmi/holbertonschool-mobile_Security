...
public final class TabKt {
    ...
    private static final float SmallTabHeight = PrimaryNavigationTabTokens.INSTANCE.m2412getContainerHeightD9Ej5fM();
    ...
    public static final void m1819TabwqdebIU(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, long selectedContentColor, long unselectedContentColor, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 191739611) == 38347922 && $composer3.getSkipping()) {
            ...
            final Function2 styledText = function24 != null ? ComposableLambdaKt.composableLambda($composer3, 708874428, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$styledText$1$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        TextStyle style = TextStyle.m4729copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer4, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5077boximpl(TextAlign.INSTANCE.m5084getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177919, null);
            ...
            $composer2 = $composer3;
            m1818TabbogVsAg(selected, onClick, modifier3, enabled2, selectedContentColor3, unselectedContentColor3, interactionSource2, ComposableLambdaKt.composableLambda($composer3, 1540996038, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(3);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$3
            ...
            public final void invoke(Composer composer, int i8) {
                TabKt.m1819TabwqdebIU(selected, onClick, modifier5, z, function210, function211, j, j2, mutableInteractionSource, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* JADX INFO: renamed from: LeadingIconTab-wqdebIU, reason: not valid java name */
    public static final void m1817LeadingIconTabwqdebIU(final boolean selected, final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> text, final Function2<? super Composer, ? super Integer, Unit> icon, Modifier modifier, boolean enabled, long selectedContentColor, long unselectedContentColor, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        boolean enabled2;
        long selectedContentColor2;
        int $dirty;
        ...
        if (($dirty & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            final Indication ripple = RippleKt.m1284rememberRipple9IZ8Weo(true, 0.0f, selectedContentColor3, $composer2, (($dirty2 >> 12) & 896) | 6, 2);
            final Modifier modifier4 = modifier3;
            final MutableInteractionSource mutableInteractionSource = interactionSource2;
            final boolean z = enabled3;
            int $dirty5 = $dirty2;
            m1820TabTransitionKlgxPg(selectedContentColor3, unselectedContentColor3, selected, ComposableLambdaKt.composableLambda($composer2, -429037564, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        TextStyle style = TextStyle.m4729copyCXVQc50$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m5077boximpl(TextAlign.INSTANCE.m5084getCentere0LSkKk()), null, 0L, null, null, null, null, null, 4177919, null);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$3
            ...
            public final void invoke(Composer composer, int i7) {
                TabKt.m1817LeadingIconTabwqdebIU(selected, onClick, text, icon, modifier5, z2, j, j2, mutableInteractionSource2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    ...
    public static final void m1820TabTransitionKlgxPg(final long activeColor, final long inactiveColor, final boolean selected, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            $composer2.endReplaceableGroup();
            ColorSpace colorSpace$iv = Color.m2951getColorSpaceimpl(j2);
            ...
            $composer2.endReplaceableGroup();
            Object initialValue$iv$iv = Color.m2937boximpl(j3);
            ...
            $composer2.endReplaceableGroup();
            Object targetValue$iv$iv = Color.m2937boximpl(j4);
            ...
            $composer2.endReplaceableGroup();
            $composer2.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(TabTransition_Klgx_Pg$lambda$5(color$delegate)))}, function2, $composer2, (($dirty >> 6) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$TabTransition$1
            ...
            public final void invoke(Composer composer, int i) {
                TabKt.m1820TabTransitionKlgxPg(activeColor, inactiveColor, selected, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
        ...
        if (($dirty & 91) != 18 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt.TabBaselineLayout.2
                ...
                public final MeasureResult mo12measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    int specHeight = Layout.mo320roundToPx0680j_4((textPlaceable == null || iconPlaceable == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
                    final int tabHeight = Math.max(specHeight, (iconPlaceable != null ? iconPlaceable.getHeight() : 0) + (textPlaceable != null ? textPlaceable.getHeight() : 0) + Layout.mo319roundToPxR2X_6o(TabKt.IconDistanceFromBaseline));
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo320roundToPx0680j_4(baselineOffset) + density.mo320roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2410getActiveIndicatorHeightD9Ej5fM());

...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m1669colorsro_MJ88(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            long color = ColorSchemeKt.toColor(RadioButtonTokens.INSTANCE.getDisabledSelectedIconColor(), $composer, 6);
            disabledSelectedColor2 = Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
        } else {
            disabledSelectedColor2 = disabledSelectedColor;
        }
        if ((i & 8) != 0) {
            long color2 = ColorSchemeKt.toColor(RadioButtonTokens.INSTANCE.getDisabledUnselectedIconColor(), $composer, 6);
            disabledUnselectedColor2 = Color.m2945copywmQWz5c(color2, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color2) : 0.38f, (14 & 2) != 0 ? Color.m2953getRedimpl(color2) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color2) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color2) : 0.0f);
        } else {

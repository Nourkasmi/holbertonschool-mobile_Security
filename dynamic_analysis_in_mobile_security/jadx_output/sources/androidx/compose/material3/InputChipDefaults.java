...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m2256getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m2258getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m2254getAvatarSizeD9Ej5fM();

    private InputChipDefaults() {
    }

    /* JADX INFO: renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m1557getHeightD9Ej5fM() {
        return Height;
    }
    ...
    public final SelectableChipColors m1560inputChipColorskwJvTHA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i & 32) != 0) {
            long color = ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLabelTextColor(), $composer, 6);
        ...
        if ((i & 64) != 0) {
            long color2 = ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledLeadingIconColor(), $composer, 6);
        ...
        if ((i & 128) != 0) {
            long color3 = ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledTrailingIconColor(), $composer, 6);
        ...
        if ((i & 512) != 0) {
            long color4 = ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledSelectedContainerColor(), $composer, 6);
            disabledSelectedContainerColor2 = Color.m2945copywmQWz5c(color4, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color4) : 0.12f, (14 & 2) != 0 ? Color.m2953getRedimpl(color4) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color4) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color4) : 0.0f);
        } else {
    ...
    public final SelectableChipElevation m1561inputChipElevationaqJV_2Y(float elevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float elevation2 = (i & 1) != 0 ? InputChipTokens.INSTANCE.m2255getContainerElevationD9Ej5fM() : elevation;
        ...
        float draggedElevation2 = (i & 16) != 0 ? InputChipTokens.INSTANCE.m2257getDraggedContainerElevationD9Ej5fM() : draggedElevation;
    ...
    public final SelectableChipBorder m1559inputChipBordergHcDVlo(long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            long color = ColorSchemeKt.toColor(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), $composer, 6);
        ...
        float borderWidth2 = (i & 16) != 0 ? InputChipTokens.INSTANCE.m2261getUnselectedOutlineWidthD9Ej5fM() : borderWidth;
        float selectedBorderWidth2 = (i & 32) != 0 ? InputChipTokens.INSTANCE.m2259getSelectedOutlineWidthD9Ej5fM() : selectedBorderWidth;
        if (ComposerKt.isTraceInProgress()) {

...
public final class DatePickerColors {
    ...
    /* JADX INFO: renamed from: getContainerColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    ...
    /* JADX INFO: renamed from: getHeadlineContentColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    public final long getHeadlineContentColor() {
        return this.headlineContentColor;
    }

    /* JADX INFO: renamed from: getWeekdayContentColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    public final long getWeekdayContentColor() {
        return this.weekdayContentColor;
    }

    /* JADX INFO: renamed from: getSubheadContentColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    public final long getSubheadContentColor() {
        return this.subheadContentColor;
    }

    /* JADX INFO: renamed from: getTodayDateBorderColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    public final long getTodayDateBorderColor() {
        return this.todayDateBorderColor;
    }

    /* JADX INFO: renamed from: getDayInSelectionRangeContainerColor-0d7_KjU$material3_release, reason: not valid java name and from getter */
    ...
    public final State<Color> dayContentColor$material3_release(boolean isToday, boolean selected, boolean inRange, boolean enabled, Composer $composer, int $changed) {
        ...
        if (inRange) {
            ...
            stateM69animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(target), $composer, 0);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(379006329);
            ComposerKt.sourceInformation($composer, "596@26492L134");
            stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean selected, boolean enabled, boolean animate, Composer $composer, int $changed) {
        ...
        if (selected) {
            ...
            target = Color.INSTANCE.m2982getTransparent0d7_KjU();
        }
        if (animate) {
            $composer.startReplaceableGroup(1577406023);
            ComposerKt.sourceInformation($composer, "622@27316L134");
            stateRememberUpdatedState = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(1577406187);
            ComposerKt.sourceInformation($composer, "627@27480L28");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(target), $composer, 0);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean currentYear, boolean selected, Composer $composer, int $changed) {
        ...
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean selected, Composer $composer, int $changed) {
        ...
        long target = selected ? this.selectedYearContainerColor : Color.INSTANCE.m2982getTransparent0d7_KjU();
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public boolean equals(Object other) {
        return (other instanceof DatePickerColors) && Color.m2948equalsimpl0(this.containerColor, ((DatePickerColors) other).containerColor) && Color.m2948equalsimpl0(this.titleContentColor, ((DatePickerColors) other).titleContentColor) && Color.m2948equalsimpl0(this.headlineContentColor, ((DatePickerColors) other).headlineContentColor) && Color.m2948equalsimpl0(this.weekdayContentColor, ((DatePickerColors) other).weekdayContentColor) && Color.m2948equalsimpl0(this.subheadContentColor, ((DatePickerColors) other).subheadContentColor) && Color.m2948equalsimpl0(this.yearContentColor, ((DatePickerColors) other).yearContentColor) && Color.m2948equalsimpl0(this.currentYearContentColor, ((DatePickerColors) other).currentYearContentColor) && Color.m2948equalsimpl0(this.selectedYearContentColor, ((DatePickerColors) other).selectedYearContentColor) && Color.m2948equalsimpl0(this.selectedYearContainerColor, ((DatePickerColors) other).selectedYearContainerColor) && Color.m2948equalsimpl0(this.dayContentColor, ((DatePickerColors) other).dayContentColor) && Color.m2948equalsimpl0(this.disabledDayContentColor, ((DatePickerColors) other).disabledDayContentColor) && Color.m2948equalsimpl0(this.selectedDayContentColor, ((DatePickerColors) other).selectedDayContentColor) && Color.m2948equalsimpl0(this.disabledSelectedDayContentColor, ((DatePickerColors) other).disabledSelectedDayContentColor) && Color.m2948equalsimpl0(this.selectedDayContainerColor, ((DatePickerColors) other).selectedDayContainerColor) && Color.m2948equalsimpl0(this.disabledSelectedDayContainerColor, ((DatePickerColors) other).disabledSelectedDayContainerColor) && Color.m2948equalsimpl0(this.todayContentColor, ((DatePickerColors) other).todayContentColor) && Color.m2948equalsimpl0(this.todayDateBorderColor, ((DatePickerColors) other).todayDateBorderColor) && Color.m2948equalsimpl0(this.dayInSelectionRangeContainerColor, ((DatePickerColors) other).dayInSelectionRangeContainerColor) && Color.m2948equalsimpl0(this.dayInSelectionRangeContentColor, ((DatePickerColors) other).dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.containerColor);
        return (((((((((((((((((((((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.titleContentColor)) * 31) + Color.m2954hashCodeimpl(this.headlineContentColor)) * 31) + Color.m2954hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m2954hashCodeimpl(this.subheadContentColor)) * 31) + Color.m2954hashCodeimpl(this.yearContentColor)) * 31) + Color.m2954hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m2954hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m2954hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m2954hashCodeimpl(this.dayContentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m2954hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m2954hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m2954hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m2954hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m2954hashCodeimpl(this.todayContentColor)) * 31) + Color.m2954hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m2954hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m2954hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}

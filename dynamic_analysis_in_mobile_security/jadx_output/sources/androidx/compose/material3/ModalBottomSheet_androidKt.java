...
public final class ModalBottomSheet_androidKt {
    ...
    */
    ...
    public static final Modifier modalBottomSheetSwipeable(Modifier $this$modalBottomSheetSwipeable, final SheetState sheetState, AnchorChangeHandler<SheetValue> anchorChangeHandler, final float screenHeight, Function2<? super CoroutineScope, ? super Float, Unit> function2) {
        return SwipeableV2Kt.swipeAnchors(DraggableKt.draggable($this$modalBottomSheetSwipeable, sheetState.getSwipeableState$material3_release().getSwipeDraggableState(), Orientation.Vertical, (188 & 4) != 0 ? true : sheetState.isVisible(), (188 & 8) != 0 ? null : null, (188 & 16) != 0 ? false : sheetState.getSwipeableState$material3_release().isAnimationRunning(), (188 & 32) != 0 ? new DraggableKt.C01821(null) : null, (188 & 64) != 0 ? new DraggableKt.AnonymousClass2(null) : new C03941(function2), (188 & 128) != 0 ? false : false), sheetState.getSwipeableState$material3_release(), SetsKt.setOf((Object[]) new SheetValue[]{SheetValue.Hidden, SheetValue.PartiallyExpanded, SheetValue.Expanded}), anchorChangeHandler, new Function2<SheetValue, IntSize, Float>() { // from class: androidx.compose.material3.ModalBottomSheet_androidKt.modalBottomSheetSwipeable.2
    ...
    /* JADX INFO: compiled from: ModalBottomSheet.android.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* synthetic */ class C03941 extends FunctionReferenceImpl implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object>, SuspendFunction {
        C03941(Object obj) {

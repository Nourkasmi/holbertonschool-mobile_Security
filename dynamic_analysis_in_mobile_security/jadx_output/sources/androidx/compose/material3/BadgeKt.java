...
public final class BadgeKt {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "anchor")) {
                                    ...
                                    return Layout.layout(totalWidth, totalHeight, MapsKt.mapOf(TuplesKt.to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(firstBaseline)), TuplesKt.to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(lastBaseline))), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.BadgeKt$BadgedBox$2$measure$1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                                            boolean hasContent = badgePlaceable.getWidth() > Layout.mo320roundToPx0680j_4(BadgeTokens.INSTANCE.m2011getSizeD9Ej5fM());
                                            ...
                                            int badgeY = ((-badgePlaceable.getHeight()) / 2) + Layout.mo320roundToPx0680j_4(badgeVerticalOffset);
    ...
    public static final void m1308BadgeeopBjH0(Modifier modifier, long containerColor, long contentColor, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long contentColor2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    long contentColor4 = ColorSchemeKt.m1412contentColorForek8zF_U(containerColor2, $composer2, ($dirty >> 3) & 14);
                    $dirty &= -897;
            ...
            float size = function32 != null ? badgeTokens.m2010getLargeSizeD9Ej5fM() : badgeTokens.m2011getSizeD9Ej5fM();
            if (function32 != null) {
            ...
            Modifier modifierThen = ClipKt.clip(BackgroundKt.m159backgroundbw27NRU(SizeKt.m512defaultMinSizeVpY3zN4(modifier3, size, size), containerColor2, shape), shape).then(function32 != null ? PaddingKt.m483paddingVpY3zN4$default(Modifier.INSTANCE, BadgeWithContentHorizontalPadding, 0.0f, 2, null) : Modifier.INSTANCE);
            ...
            if (function32 != null) {
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2))}, ComposableLambdaKt.composableLambda($composer2, 5609066, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BadgeKt$Badge$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BadgeKt$Badge$2
            ...
            public final void invoke(Composer composer, int i7) {
                BadgeKt.m1308BadgeeopBjH0(modifier5, j2, j3, function34, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    static {
        float arg0$iv = Dp.m5212constructorimpl(4);
        BadgeWithContentHorizontalOffset = Dp.m5212constructorimpl(-arg0$iv);
        float arg0$iv2 = Dp.m5212constructorimpl(4);
        BadgeWithContentVerticalOffset = Dp.m5212constructorimpl(-arg0$iv2);
        BadgeOffset = Dp.m5212constructorimpl(0);
    }

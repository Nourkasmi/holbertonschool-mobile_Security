...
public final class DateRangePickerKt {
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m478PaddingValuesa9UjIt4$default(Dp.m5212constructorimpl(24), Dp.m5212constructorimpl(20), 0.0f, Dp.m5212constructorimpl(8), 4, null);
    private static final PaddingValues DateRangePickerTitlePadding = PaddingKt.m478PaddingValuesa9UjIt4$default(Dp.m5212constructorimpl(64), 0.0f, Dp.m5212constructorimpl(12), 0.0f, 10, null);
    private static final PaddingValues DateRangePickerHeadlinePadding = PaddingKt.m478PaddingValuesa9UjIt4$default(Dp.m5212constructorimpl(64), 0.0f, Dp.m5212constructorimpl(12), Dp.m5212constructorimpl(12), 2, null);
    private static final float HeaderHeightOffset = Dp.m5212constructorimpl(60);
    ...
    public static final void DateRangePicker(final DateRangePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> function1, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean showModeToggle, DatePickerColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i4 != 0) {
                    function12 = new Function1<Long, Boolean>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.2
                ...
                if (i5 != 0) {
                    z = true;
                    composableLambda = ComposableLambdaKt.composableLambda($composer2, 492752701, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.3
                        ...
                        public final void invoke(Composer $composer3, int $changed2) {
                            ...
                            if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                                ...
                                DateRangePickerDefaults.INSTANCE.DateRangePickerTitle(state, PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.DateRangePickerTitlePadding), $composer3, ($dirty & 14) | 432, 0);
                                if (ComposerKt.isTraceInProgress()) {
                ...
                composableLambda2 = i6 != 0 ? ComposableLambdaKt.composableLambda($composer2, -204181785, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.4
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
                    }
                    ...
                    public final void invoke(Composer $composer3, int $changed2) {
                        ...
                        if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                            ...
                            Modifier modifierPadding = PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.DateRangePickerHeadlinePadding);
                            int i8 = $dirty;
                            dateRangePickerDefaults.DateRangePickerHeadline(dateRangePickerState, datePickerFormatter, modifierPadding, $composer3, (i8 & 14) | 3456 | ((i8 >> 3) & 112), 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            ComposableLambda composableLambda3 = showModeToggle2 ? ComposableLambdaKt.composableLambda($composer2, -1062265737, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.5
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv2 = new Function1<DisplayMode, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$5$1$1
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode) {
                                    m1472invokevCnGnXg(displayMode.getValue());
                                    return Unit.INSTANCE;
                                }

                                /* JADX INFO: renamed from: invoke-vCnGnXg, reason: not valid java name */
                                public final void m1472invokevCnGnXg(int displayMode) {
                                    dateRangePickerState.getStateData().m1711switchDisplayModevCnGnXg(displayMode);
                                }
                            };
                        ...
                        DatePickerKt.m1464DisplayModeToggleButtontER2X8s(modifierPadding, iM1474getDisplayModejFl4v0, (Function1) value$iv$iv2, $composer3, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            TextStyle textStyleFromToken = TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionHeaderHeadlineFont());
            float arg0$iv = DatePickerModalTokens.INSTANCE.m2111getRangeSelectionHeaderContainerHeightD9Ej5fM();
            ...
            DatePickerKt.m1462DateEntryContainerau3_HiA(modifier2, composableLambda, composableLambda2, composableLambda3, colors2, textStyleFromToken, Dp.m5212constructorimpl(arg0$iv - other$iv), ComposableLambdaKt.composableLambda($composer2, -186850856, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.6
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int i9 = i8;
                        DateRangePickerKt.SwitchableDateEntryContent(dateRangePickerState, datePickerFormatter2, function15, datePickerColors2, $composer3, (i9 & 14) | ((i9 >> 3) & 112) | ((i9 >> 3) & 896) | ((i9 >> 12) & 7168));
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.7
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
            ...
            public final void invoke(Composer composer, int i9) {
                DateRangePickerKt.DateRangePicker(state, modifier4, datePickerFormatter2, function15, function27, function28, z2, datePickerColors2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* JADX INFO: renamed from: rememberDateRangePickerState-pMw4iz8, reason: not valid java name */
    public static final DateRangePickerState m1471rememberDateRangePickerStatepMw4iz8(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, Composer $composer, int $changed, int i) {
        ...
        int initialDisplayMode2 = (i & 16) != 0 ? DisplayMode.INSTANCE.m1492getPickerjFl4v0() : initialDisplayMode;
        if (ComposerKt.isTraceInProgress()) {
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2594rememberSaveable(new Object[0], (Saver) DateRangePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState state, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int iM1474getDisplayModejFl4v0 = state.m1474getDisplayModejFl4v0();
            final int i = $dirty;
            CrossfadeKt.Crossfade(DisplayMode.m1484boximpl(iM1474getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.SwitchableDateEntryContent.1
                @Override // kotlin.jvm.functions.Function1
                ...
                public final void m1473invokeQujVXRc(int mode, Composer $composer3, int $changed2) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.SwitchableDateEntryContent.3
            ...
            public final void invoke(Composer composer, int i2) {
                DateRangePickerKt.SwitchableDateEntryContent(state, dateFormatter, function1, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                value$iv$iv = (Function1) new Function1<Long, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePickerContent$onDateSelected$1$1
                    ...
                    public final void invoke(long dateInMillis) {
                        DateRangePickerKt.updateDateSelection(stateData, dateInMillis);
                    }
                };
                $composer2.updateRememberedValue(value$iv$iv);
            } else {
            ...
            Modifier modifier$iv = PaddingKt.m483paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePickerContent.2
            ...
            public final void invoke(Composer composer, int i4) {
                DateRangePickerKt.DateRangePickerContent(stateData, dateFormatter, function1, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer2, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda($composer2, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        $composer3.endReplaceableGroup();
                        final String scrollToPreviousMonthLabel = Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1755getDateRangePickerScrollToShowPreviousMonthadMyvUU(), $composer3, 6);
                        final String scrollToNextMonthLabel = Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1754getDateRangePickerScrollToShowNextMonthadMyvUU(), $composer3, 6);
                                ...
                                LazyListScope.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int it, Composer $composer4, int $changed3) {
                                        ...
                                        if (($dirty3 & 731) != 146 || !$composer4.getSkipping()) {
                                            ...
                                            CalendarMonth month = stateData3.getCalendarModel().plusMonths(calendarMonth2, it);
                                            ...
                                            String monthYear$material3_release = datePickerFormatter3.formatMonthYear$material3_release(month, stateData4.getCalendarModel(), CalendarModel_androidKt.defaultLocale($composer4, 0));
                                            if (monthYear$material3_release != null) {
                                                str3 = monthYear$material3_release;
                                            } else {
                                                str3 = "-";
                                            }
                                            TextKt.m1870Text4IGK_g(str3, SemanticsModifierKt.semantics$default(ClickableKt.m193clickableXHw0xAI$default(PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1
                                                @Override // kotlin.jvm.functions.Function0
                                                ...
                                                public final void invoke2(SemanticsPropertyReceiver semantics) {
                                                    Intrinsics.checkNotNullParameter(semantics, "$this$semantics");
                                                    SemanticsPropertiesKt.setCustomActions(semantics, DateRangePickerKt.customScrollActions(lazyListState5, coroutineScope3, str4, str5));
                                                }
    ...
    public static final void m1470drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long color) {
        float fM2777getWidthimpl;
        ...
        float itemContainerWidth = drawRangeBackground.mo326toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemContainerHeight = drawRangeBackground.mo326toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float itemStateLayerHeight = drawRangeBackground.mo326toPx0680j_4(DatePickerModalTokens.INSTANCE.m2104getDateStateLayerHeightD9Ej5fM());
        float f = 2;
        float stateLayerVerticalPadding = (itemContainerHeight - itemStateLayerHeight) / f;
        float f2 = 7;
        float horizontalSpaceBetweenItems = (Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc()) - (f2 * itemContainerWidth)) / f2;
        long packedValue = selectedRangeInfo.getGridCoordinates().getFirst().getPackedValue();
        int x1 = IntOffset.m5322component1impl(packedValue);
        int y1 = IntOffset.m5323component2impl(packedValue);
        long packedValue2 = selectedRangeInfo.getGridCoordinates().getSecond().getPackedValue();
        int x2 = IntOffset.m5322component1impl(packedValue2);
        int y2 = IntOffset.m5323component2impl(packedValue2);
        ...
        if (isRtl) {
            startX = Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc()) - startX;
            endX = Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc()) - endX;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long jOffset = OffsetKt.Offset(startX, startY);
        if (y1 == y2) {
            fM2777getWidthimpl = endX - startX;
        } else {
            fM2777getWidthimpl = isRtl ? -startX : Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc()) - startX;
        }
        DrawScope.m3484drawRectnJ9OG0$default(contentDrawScope, color, jOffset, SizeKt.Size(fM2777getWidthimpl, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        if (y1 != y2) {
            int y = (y2 - y1) - 1;
            while (y > 0) {
                DrawScope.m3484drawRectnJ9OG0$default(drawRangeBackground, color, OffsetKt.Offset(0.0f, (y * itemContainerHeight) + startY), SizeKt.Size(Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc()), itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
                y--;
                itemContainerHeight = itemContainerHeight;
            }
            float topLeftX = drawRangeBackground.getLayoutDirection() == LayoutDirection.Ltr ? 0.0f : Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc());
            DrawScope.m3484drawRectnJ9OG0$default(drawRangeBackground, color, OffsetKt.Offset(topLeftX, endY), SizeKt.Size(isRtl ? endX - Size.m2777getWidthimpl(drawRangeBackground.mo3489getSizeNHjbRc()) : endX, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        }
    }

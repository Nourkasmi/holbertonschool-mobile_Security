...
public final class ExposedDropdownMenuKt {
    private static final float ExposedDropdownMenuItemHorizontalPadding = Dp.m5212constructorimpl(16);
    ...
    public static final void ExposedDropdownMenuBox(final boolean expanded, final Function1<? super Boolean, Unit> onExpandedChange, Modifier modifier, final Function3<? super ExposedDropdownMenuBoxScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty3 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            int verticalMarginInPx2 = density.mo320roundToPx0680j_4(MenuKt.getMenuVerticalMargin());
            $composer2.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation($composer2, "CC(remember):Composables.kt#9igjgp");
            ...
            if (invalid$iv || value$iv$iv6 == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv6 = new ExposedDropdownMenuBoxScope() { // from class: androidx.compose.material3.ExposedDropdownMenuKt$ExposedDropdownMenuBox$scope$1$1
                            ...
                            public final Modifier invoke(Modifier composed, Composer $composer3, int $changed2) {
                                ...
                                Modifier modifierOnGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(composed, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuKt$ExposedDropdownMenuBox$scope$1$1$menuAnchor$2.1
                                    ...
                                    public final void invoke2(LayoutCoordinates it) {
                                        ...
                                        ExposedDropdownMenuKt.ExposedDropdownMenuBox$lambda$2(mutableState3, IntSize.m5372getWidthimpl(it.mo4190getSizeYbymL2g()));
                                        ref2.setValue(it);
                                ...
                                Modifier modifierFocusRequester = FocusRequesterModifierKt.focusRequester(ExposedDropdownMenuKt.expandable(modifierOnGloballyPositioned, z2, (Function0) key1$iv2, null, null, null, $composer3, (i4 << 3) & 112, 28), focusRequester3);
                                if (ComposerKt.isTraceInProgress()) {
                    ...
                    public Modifier exposedDropdownSize(Modifier $this$exposedDropdownSize, boolean matchTextFieldWidth) {
                        ...
                        Modifier it = SizeKt.m516heightInVpY3zN4$default($this$exposedDropdownSize, 0.0f, $this$exposedDropdownSize_u24lambda_u242.mo323toDpu2uoSUM(ExposedDropdownMenuKt.ExposedDropdownMenuBox$lambda$4(mutableState)), 1, null);
                        if (matchTextFieldWidth) {
                            return SizeKt.m533width3ABfNKs(it, $this$exposedDropdownSize_u24lambda_u242.mo323toDpu2uoSUM(ExposedDropdownMenuKt.ExposedDropdownMenuBox$lambda$1(mutableState2)));
                        }
                        return it;
                    }
                };
    ...
    public static final Modifier expandable(Modifier $this$expandable, final boolean expanded, final Function0<Unit> function0, String menuDescription, String expandedDescription, String collapsedDescription, Composer $composer, int $changed, int i) {
        ...
        String menuDescription2 = (i & 4) != 0 ? Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1760getExposedDropdownMenuadMyvUU(), $composer, 6) : menuDescription;
        String expandedDescription2 = (i & 8) != 0 ? Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1762getMenuExpandedadMyvUU(), $composer, 6) : expandedDescription;
        String collapsedDescription2 = (i & 16) != 0 ? Strings_androidKt.m1783getStringNWtq28(Strings.INSTANCE.m1761getMenuCollapsedadMyvUU(), $composer, 6) : collapsedDescription;
        if (ComposerKt.isTraceInProgress()) {
        ...
        $composer.endReplaceableGroup();
        Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(modifierPointerInput, z, (Function1) value$iv$iv2, 1, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();

...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m1563constructorimpl(0);
    private static final int StartDateInput = m1563constructorimpl(1);
    private static final int EndDateInput = m1563constructorimpl(2);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1562boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m1563constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m1570getSingleDateInputJ2x2o4M() {
            return InputIdentifier.SingleDateInput;
        }

        /* JADX INFO: renamed from: getStartDateInput-J2x2o4M, reason: not valid java name */
        public final int m1571getStartDateInputJ2x2o4M() {
            return InputIdentifier.StartDateInput;
        }

        /* JADX INFO: renamed from: getEndDateInput-J2x2o4M, reason: not valid java name */
        public final int m1569getEndDateInputJ2x2o4M() {
            return InputIdentifier.EndDateInput;
        }
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1567toStringimpl(int arg0) {
        return m1565equalsimpl0(arg0, SingleDateInput) ? "SingleDateInput" : m1565equalsimpl0(arg0, StartDateInput) ? "StartDateInput" : m1565equalsimpl0(arg0, EndDateInput) ? "EndDateInput" : "Unknown";
    }

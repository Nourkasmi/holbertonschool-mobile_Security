...
public final class NavigationBarItemColors {
    ...
    public final State<Color> iconColor$material3_release(boolean selected, boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateM69animateColorAsStateeuL9pac = SingleValueAnimationKt.m69animateColorAsStateeuL9pac(targetValue, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationBarItemColors) && Color.m2948equalsimpl0(this.selectedIconColor, ((NavigationBarItemColors) other).selectedIconColor) && Color.m2948equalsimpl0(this.unselectedIconColor, ((NavigationBarItemColors) other).unselectedIconColor) && Color.m2948equalsimpl0(this.selectedTextColor, ((NavigationBarItemColors) other).selectedTextColor) && Color.m2948equalsimpl0(this.unselectedTextColor, ((NavigationBarItemColors) other).unselectedTextColor) && Color.m2948equalsimpl0(this.selectedIndicatorColor, ((NavigationBarItemColors) other).selectedIndicatorColor) && Color.m2948equalsimpl0(this.disabledIconColor, ((NavigationBarItemColors) other).disabledIconColor) && Color.m2948equalsimpl0(this.disabledTextColor, ((NavigationBarItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }

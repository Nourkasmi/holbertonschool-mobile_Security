...
public final class TimePickerKt {
    ...
    */
    ...
    static final class C04652 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        final /* synthetic */ boolean $autoSwitchToMinute;
        final /* synthetic */ TimePickerState $state;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04652(TimePickerState timePickerState, boolean z) {
            super(3);
            this.$state = timePickerState;
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            long it = this.J$0;
                            C04652.invoke$lambda$2(this.$offsetX$delegate, Offset.m2708getXimpl(it));
                            C04652.invoke$lambda$5(this.$offsetY$delegate, Offset.m2709getYimpl(it));
                            return Unit.INSTANCE;
                        default:
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    ...
                    case 0:
                        ...
                        if (DragGestureDetectorKt.detectDragGestures($this$pointerInput, (5 & 1) != 0 ? DragGestureDetectorKt.AnonymousClass2.INSTANCE : null, (5 & 2) != 0 ? DragGestureDetectorKt.AnonymousClass3.INSTANCE : function0, (5 & 4) != 0 ? DragGestureDetectorKt.AnonymousClass4.INSTANCE : null, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.material3.TimePickerKt.clockDial.2.3.2
                            ...
                            public final void m1899invokeUv8p0NA(PointerInputChange pointerInputChange, long dragAmount) {
                                ...
                                timePickerState2.moveSelector$material3_release(C04652.invoke$lambda$1(mutableState), C04652.invoke$lambda$4(mutableState2), f);
                            }
                                ...
                                public final Object invokeSuspend(Object $result) {
                                    ...
                                    switch (this.label) {
                                        case 0:
                                            ...
                                            C04652.invoke$lambda$2(mutableState, C04652.invoke$lambda$1(mutableState) + Offset.m2708getXimpl(this.$dragAmount));
                                            MutableState<Float> mutableState2 = this.$offsetY$delegate;
                                            C04652.invoke$lambda$5(mutableState2, C04652.invoke$lambda$4(mutableState2) + Offset.m2709getYimpl(this.$dragAmount));
                                            this.label = 1;
                                            if (TimePickerState.update$material3_release$default(this.$state, TimePickerKt.atan(C04652.invoke$lambda$4(this.$offsetY$delegate) - IntOffset.m5331getYimpl(this.$state.m1909getCenternOccac$material3_release()), C04652.invoke$lambda$1(this.$offsetX$delegate) - IntOffset.m5330getXimpl(this.$state.m1909getCenternOccac$material3_release())), false, this, 2, null) == coroutine_suspended) {
                                                return coroutine_suspended;
                                            }
                                            break;
                                        case 1:
    ...
    public static final Modifier clockDial(Modifier $this$clockDial, final TimePickerState state, boolean autoSwitchToMinute) {
        ...
        } : InspectableValueKt.getNoInspectorInfo(), new C04652(state, autoSwitchToMinute));
    }

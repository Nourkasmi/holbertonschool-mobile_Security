...
final class TooltipSync {
    ...
    public final Object show(final TooltipState state, boolean persistent, Continuation<? super Unit> continuation) {
        ...
        if (state instanceof PlainTooltipState) {
            Function1 runBlock2 = new C04682(state, null);
            runBlock = runBlock2;
    ...
    static final class C04682 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ TooltipState $state;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04682(TooltipState tooltipState, Continuation<? super C04682> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C04682(this.$state, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C04682) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }

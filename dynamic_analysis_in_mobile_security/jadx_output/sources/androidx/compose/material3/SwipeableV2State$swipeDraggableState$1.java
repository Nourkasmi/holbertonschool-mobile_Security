...
public final class SwipeableV2State$swipeDraggableState$1 implements DraggableState {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [androidx.compose.material3.SwipeableV2State$swipeDraggableState$1$dragScope$1, androidx.compose.material3.SwipeableV2State$swipeDraggableState$1$dragScope$1<T>] */
    ...
    public Object drag(MutatePriority dragPriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object objSwipe = this.this$0.swipe(dragPriority, new SwipeableV2State$swipeDraggableState$1$drag$2(function2, this, null), continuation);

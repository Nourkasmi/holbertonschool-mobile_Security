...
public final class FabPrimarySmallTokens {
    ...
    private static final float ContainerHeight = Dp.m5212constructorimpl((float) 40.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerMedium;
    private static final float ContainerWidth = Dp.m5212constructorimpl((float) 40.0d);
    private static final float FocusContainerElevation = ElevationTokens.INSTANCE.m2136getLevel3D9Ej5fM();
    private static final ColorSchemeKeyTokens FocusIconColor = ColorSchemeKeyTokens.OnPrimaryContainer;
    private static final float HoverContainerElevation = ElevationTokens.INSTANCE.m2137getLevel4D9Ej5fM();
    ...
    private static final float IconSize = Dp.m5212constructorimpl((float) 24.0d);
    private static final float LoweredContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final float LoweredFocusContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final float LoweredHoverContainerElevation = ElevationTokens.INSTANCE.m2135getLevel2D9Ej5fM();
    private static final float LoweredPressedContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final float PressedContainerElevation = ElevationTokens.INSTANCE.m2136getLevel3D9Ej5fM();
    ...
    public final float m2160getContainerElevationD9Ej5fM() {
    ...
    public final float m2162getContainerWidthD9Ej5fM() {
        return ContainerWidth;
    }

    /* JADX INFO: renamed from: getFocusContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2163getFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2164getHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2166getLoweredContainerElevationD9Ej5fM() {
    ...
    public final float m2167getLoweredFocusContainerElevationD9Ej5fM() {
    ...
    public final float m2168getLoweredHoverContainerElevationD9Ej5fM() {
    ...
    public final float m2169getLoweredPressedContainerElevationD9Ej5fM() {
    ...
    public final float m2170getPressedContainerElevationD9Ej5fM() {

...
public final class SliderTokens {
    ...
    private static final float ActiveTrackHeight = Dp.m5212constructorimpl((float) 4.0d);
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2133getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final float HandleHeight = Dp.m5212constructorimpl((float) 20.0d);
    private static final ShapeKeyTokens HandleShape = ShapeKeyTokens.CornerFull;
    private static final float HandleWidth = Dp.m5212constructorimpl((float) 20.0d);
    ...
    private static final float InactiveTrackHeight = Dp.m5212constructorimpl((float) 4.0d);
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2133getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5212constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2133getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m5212constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5212constructorimpl((float) 2.0d);
    ...
    public final float m2429getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2430getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2431getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* JADX INFO: renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2432getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2433getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2434getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2435getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* JADX INFO: renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2436getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2438getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* JADX INFO: renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m2440getTrackElevationD9Ej5fM() {
    ...
    public final float m2437getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2439getTickMarksContainerSizeD9Ej5fM() {

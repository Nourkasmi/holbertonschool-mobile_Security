...
public final class TopAppBarSmallCenteredTokens {
    ...
    private static final float AvatarSize = Dp.m5212constructorimpl((float) 30.0d);
    private static final ColorSchemeKeyTokens ContainerColor = ColorSchemeKeyTokens.Surface;
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2133getLevel0D9Ej5fM();
    private static final float ContainerHeight = Dp.m5212constructorimpl((float) 64.0d);
    ...
    private static final float OnScrollContainerElevation = ElevationTokens.INSTANCE.m2135getLevel2D9Ej5fM();
    ...
    public final float m2499getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m2500getContainerElevationD9Ej5fM() {
    ...
    public final float m2502getLeadingIconSizeD9Ej5fM() {
        return LeadingIconSize;
    }

    /* JADX INFO: renamed from: getOnScrollContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2503getOnScrollContainerElevationD9Ej5fM() {

...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5212constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5212constructorimpl((float) 4.0d);
    ...
    public final float m2262getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2263getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }

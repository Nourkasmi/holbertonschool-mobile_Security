...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5212constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5212constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2134getLevel1D9Ej5fM();
    ...
    public final float m2425getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m2426getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2427getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m2428getDockedStandardContainerElevationD9Ej5fM() {

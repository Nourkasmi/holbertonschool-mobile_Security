...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5212constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5212constructorimpl((float) 24.0d);
    ...
    public final float m2320getContainerSizeD9Ej5fM() {
    ...
    public final float m2321getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2322getUnselectedOutlineWidthD9Ej5fM() {

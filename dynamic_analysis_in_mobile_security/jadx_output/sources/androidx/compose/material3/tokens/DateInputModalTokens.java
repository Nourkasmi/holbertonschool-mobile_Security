...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m5212constructorimpl((float) 512.0d);
    ...
    private static final float ContainerWidth = Dp.m5212constructorimpl((float) 328.0d);
    private static final float HeaderContainerHeight = Dp.m5212constructorimpl((float) 120.0d);
    private static final float HeaderContainerWidth = Dp.m5212constructorimpl((float) 328.0d);
    ...
    public final float m2094getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2095getContainerHeightD9Ej5fM() {

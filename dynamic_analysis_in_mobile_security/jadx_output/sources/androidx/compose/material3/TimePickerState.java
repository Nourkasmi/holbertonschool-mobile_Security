...
public final class TimePickerState {
    ...
    public TimePickerState(int initialHour, int initialMinute, final boolean is24Hour) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m5267boximpl(m1914invokeRKDOV3M());
            }

            /* JADX INFO: renamed from: invoke-RKDOV3M, reason: not valid java name */
            public final long m1914invokeRKDOV3M() {
                boolean inInnerCircle = this.this$0.isInnerCircle$material3_release();
                float arg0$iv = Dp.m5212constructorimpl(TimePickerTokens.INSTANCE.m2480getClockDialSelectorHandleContainerSizeD9Ej5fM() / 2);
                float length = Dp.m5212constructorimpl(Dp.m5212constructorimpl(((is24Hour && inInnerCircle && Selection.m1693equalsimpl0(this.this$0.m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1697getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - arg0$iv) + arg0$iv);
                float other$iv = (float) Math.cos(this.this$0.getCurrentAngle$material3_release().getValue().floatValue());
                float arg0$iv2 = Dp.m5212constructorimpl(Dp.m5212constructorimpl(length * other$iv) + Dp.m5212constructorimpl(TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM() / 2));
                float other$iv2 = (float) Math.sin(this.this$0.getCurrentAngle$material3_release().getValue().floatValue());
                return DpKt.m5233DpOffsetYgX7TsA(arg0$iv2, Dp.m5212constructorimpl(Dp.m5212constructorimpl(length * other$iv2) + Dp.m5212constructorimpl(TimePickerTokens.INSTANCE.m2478getClockDialContainerSizeD9Ej5fM() / 2)));
            }
        });
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5321boximpl(IntOffset.INSTANCE.m5340getZeronOccac()), null, 2, null);
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m1690boximpl(Selection.INSTANCE.m1697getHourJiIwxys()), null, 2, null);
    ...
    public final long m1911getSelectorPosRKDOV3M$material3_release() {
    ...
    public final long m1909getCenternOccac$material3_release() {
    ...
    public final void m1912setCentergyyYBs$material3_release(long j) {
    ...
    public final List<Integer> getValues$material3_release() {
        return Selection.m1693equalsimpl0(m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1698getMinuteJiIwxys()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }

    /* JADX INFO: renamed from: getSelection-JiIwxys$material3_release, reason: not valid java name */
    public final int m1910getSelectionJiIwxys$material3_release() {
        State $this$getValue$iv = this.selection;
        return ((Selection) $this$getValue$iv.getValue()).m1696unboximpl();
    }

    /* JADX INFO: renamed from: setSelection-iHAOin8$material3_release, reason: not valid java name */
    public final void m1913setSelectioniHAOin8$material3_release(int i) {
        MutableState $this$setValue$iv = this.selection;
        $this$setValue$iv.setValue(Selection.m1690boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        if (!Selection.m1693equalsimpl0(m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1697getHourJiIwxys()) || !this.is24hour) {
            return;
        }
        setInnerCircle$material3_release(TimePickerKt.dist(x, y, IntOffset.m5330getXimpl(m1909getCenternOccac$material3_release()), IntOffset.m5331getYimpl(m1909getCenternOccac$material3_release())) < maxDist);
    }

    public final boolean isSelected$material3_release(int value) {
        if (Selection.m1693equalsimpl0(m1910getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1698getMinuteJiIwxys())) {
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L3e:
            kotlin.ResultKt.throwOnFailure(r8)
            r1 = r12
            int r0 = r1.m1910getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r2 = androidx.compose.material3.Selection.INSTANCE
            int r2 = r2.m1697getHourJiIwxys()
            boolean r0 = androidx.compose.material3.Selection.m1693equalsimpl0(r0, r2)
            if (r0 == 0) goto L5f

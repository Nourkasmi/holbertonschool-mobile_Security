...
public final class ComposableSingletons$ScaffoldKt {
    ...
    public final Function2<Composer, Integer, Unit> m1060getLambda1$material_release() {
        return f8lambda1;
    }

    /* JADX INFO: renamed from: getLambda-2$material_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1061getLambda2$material_release() {
        return f9lambda2;
    }

    /* JADX INFO: renamed from: getLambda-3$material_release, reason: not valid java name */
    public final Function3<SnackbarHostState, Composer, Integer, Unit> m1062getLambda3$material_release() {
        return f10lambda3;
    }

    /* JADX INFO: renamed from: getLambda-4$material_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1063getLambda4$material_release() {
        return f11lambda4;
    }
}

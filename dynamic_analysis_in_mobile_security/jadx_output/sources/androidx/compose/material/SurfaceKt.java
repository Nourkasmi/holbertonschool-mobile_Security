...
public final class SurfaceKt {
    ...
    */
    ...
    public static final void m1198SurfaceNy5ogXk(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        boolean z;
        int i2;
        int $dirty;
        long color2;
        ...
        if (($dirty & 1533916891) == 306783378 && ($dirty1 & 11) == 2 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    $dirty &= -458753;
                    color2 = MaterialTheme.INSTANCE.getColors($composer3, 6).m1038getSurface0d7_KjU();
                } else {
                    color2 = color;
                }
                if ((i & 64) != 0) {
                    contentColor2 = ColorsKt.m1052contentColorForek8zF_U(color2, $composer3, ($dirty >> 15) & 14);
                    $dirty &= -3670017;
                } else {
                ...
                if (i9 != 0) {
                    border2 = border4;
                    elevation2 = Dp.m5212constructorimpl(0);
                } else {
                    border2 = border4;
            ...
            final float absoluteElevation = Dp.m5212constructorimpl(arg0$iv + elevation3);
            ...
            $composer2 = $composer3;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor3)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer2, -1391199439, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$7
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        Modifier modifier$iv = SelectableKt.m706selectableO2vRcR0$default(SurfaceKt.m1202surface8ww4TTg(modifierMinimumInteractiveComponentSize, shape5, SurfaceKt.m1203surfaceColorAtElevationcq6XJ1M(j2, (ElevationOverlay) objConsume2, absoluteElevation, $composer4, (i11 >> 15) & 14), borderStroke, f), selected, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer4, 0, 7), z2, null, onClick, 16, null);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$8
            ...
            public final void invoke(Composer composer, int i12) {
                SurfaceKt.m1198SurfaceNy5ogXk(selected, onClick, modifier5, z3, shape5, j2, j3, borderStroke2, f2, mutableInteractionSource2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }

    /* JADX INFO: renamed from: Surface-Ny5ogXk, reason: not valid java name */
    public static final void m1199SurfaceNy5ogXk(final boolean checked, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        boolean z;
        int i2;
        int $dirty;
        long color2;
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor3)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer2, -311657392, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$10
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        Object objConsume2 = $composer4.consume(localElevationOverlay);
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        Modifier modifier$iv = ToggleableKt.m710toggleableO2vRcR0$default(SurfaceKt.m1202surface8ww4TTg(modifierMinimumInteractiveComponentSize, shape5, SurfaceKt.m1203surfaceColorAtElevationcq6XJ1M(j2, (ElevationOverlay) objConsume2, absoluteElevation, $composer4, (i11 >> 15) & 14), borderStroke, f), checked, mutableInteractionSource, RippleKt.m1284rememberRipple9IZ8Weo(false, 0.0f, 0L, $composer4, 0, 7), z2, null, onCheckedChange, 16, null);
                        Function2<Composer, Integer, Unit> function2 = content;
                        int i12 = $dirty12;
                        $composer4.startReplaceableGroup(733328855);
                        ComposerKt.sourceInformation($composer4, "CC(Box)P(2,1,3)69@3214L67,70@3286L130:Box.kt#2w3rfo");
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$11
            ...
            public final void invoke(Composer composer, int i12) {
                SurfaceKt.m1199SurfaceNy5ogXk(checked, onCheckedChange, modifier5, z3, shape5, j2, j3, borderStroke2, f2, mutableInteractionSource2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m1195Surface9VG74zQ(final Function0<Unit> onClick, Modifier modifier, Shape shape, long color, long contentColor, BorderStroke border, float elevation, MutableInteractionSource interactionSource, Indication indication, boolean enabled, String onClickLabel, Role role, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if ((1533916891 & $dirty3) == 306783378 && ($dirty12 & 731) == 146 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    contentColor2 = ColorsKt.m1052contentColorForek8zF_U(color2, $composer3, ($dirty >> 9) & 14);
                    $dirty &= -57345;
                } else {
                    contentColor2 = contentColor;
                }
            ...
            final float absoluteElevation = Dp.m5212constructorimpl(arg0$iv + elevation4);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2937boximpl(contentColor2)), ElevationOverlayKt.getLocalAbsoluteElevation().provides(Dp.m5210boximpl(absoluteElevation))}, ComposableLambdaKt.composableLambda($composer2, 149594672, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$13
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd($composer4);
                        Modifier modifier$iv = SurfaceKt.m1202surface8ww4TTg(modifierMinimumInteractiveComponentSize, shape6, SurfaceKt.m1203surfaceColorAtElevationcq6XJ1M(j2, (ElevationOverlay) objConsume3, absoluteElevation, $composer4, (i10 >> 9) & 14), borderStroke, f).then(ClickableKt.m190clickableO2vRcR0(Modifier.INSTANCE, mutableInteractionSource, indication5, z, str, role4, onClick));
                        Function2<Composer, Integer, Unit> function2 = content;
                        int i11 = $dirty12;
                        $composer4.startReplaceableGroup(733328855);
                        ComposerKt.sourceInformation($composer4, "CC(Box)P(2,1,3)69@3214L67,70@3286L130:Box.kt#2w3rfo");
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SurfaceKt$Surface$14
            ...
            public final void invoke(Composer composer, int i11) {
                SurfaceKt.m1195Surface9VG74zQ(onClick, modifier7, shape6, j2, j3, borderStroke2, f2, mutableInteractionSource2, indication6, z2, str2, role5, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final Modifier m1202surface8ww4TTg(Modifier $this$surface_u2d8ww4TTg, Shape shape, long backgroundColor, BorderStroke border, float elevation) {
        Modifier modifierM2619shadows4CzXII = ShadowKt.m2619shadows4CzXII($this$surface_u2d8ww4TTg, elevation, (24 & 2) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (24 & 4) != 0 ? Dp.m5211compareTo0680j_4(24, Dp.m5212constructorimpl((float) 0)) > 0 : false, (24 & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (24 & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L);
    ...
    public static final long m1203surfaceColorAtElevationcq6XJ1M(long color, ElevationOverlay elevationOverlay, float absoluteElevation, Composer $composer, int $changed) {
        long jMo1068apply7g2Lkgo;
        ...
        if (Color.m2948equalsimpl0(color, MaterialTheme.INSTANCE.getColors($composer, 6).m1038getSurface0d7_KjU()) && elevationOverlay != null) {
            jMo1068apply7g2Lkgo = elevationOverlay.mo1068apply7g2Lkgo(color, absoluteElevation, $composer, ($changed & 14) | (($changed >> 3) & 112) | (($changed << 3) & 896));
        } else {
            jMo1068apply7g2Lkgo = color;
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return jMo1068apply7g2Lkgo;
    }
}

...
public final class PullRefreshStateKt {
    ...
    public static final PullRefreshState m1274rememberPullRefreshStateUuyPYSY(final boolean refreshing, Function0<Unit> onRefresh, float refreshThreshold, float refreshingOffset, Composer $composer, int $changed, int i) {
        ...
        float refreshThreshold2 = (i & 4) != 0 ? PullRefreshDefaults.INSTANCE.m1267getRefreshThresholdD9Ej5fM() : refreshThreshold;
        float refreshingOffset2 = (i & 8) != 0 ? PullRefreshDefaults.INSTANCE.m1268getRefreshingOffsetD9Ej5fM() : refreshingOffset;
        ...
        int $this$dp$iv = Dp.m5211compareTo0680j_4(refreshThreshold2, Dp.m5212constructorimpl(0));
        if (!($this$dp$iv > 0)) {
        ...
        thresholdPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.mo326toPx0680j_4(refreshThreshold2);
        refreshingOffsetPx.element = $this$rememberPullRefreshState_UuyPYSY_u24lambda_u241.mo326toPx0680j_4(refreshingOffset2);

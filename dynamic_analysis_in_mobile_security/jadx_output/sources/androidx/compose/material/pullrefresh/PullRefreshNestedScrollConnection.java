...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo335onPreScrollOzD1aCk(long available, int source) {
        return !this.enabled ? Offset.INSTANCE.m2724getZeroF1C5BW0() : (!NestedScrollSource.m3957equalsimpl0(source, NestedScrollSource.INSTANCE.m3962getDragWNlRxjI()) || Offset.m2709getYimpl(available) >= 0.0f) ? Offset.INSTANCE.m2724getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m2709getYimpl(available))).floatValue());
    }
    ...
    */
    public java.lang.Object mo558onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L35:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m5438getYimpl(r8)
        ...
        L50:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m5428boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo558onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}

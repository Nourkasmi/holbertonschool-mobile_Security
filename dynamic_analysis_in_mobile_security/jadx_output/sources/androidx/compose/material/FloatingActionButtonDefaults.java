...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1109elevationixp7dh8(float defaultElevation, float pressedElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = Dp.m5212constructorimpl(6);
        }
        if ((i & 2) != 0) {
            pressedElevation = Dp.m5212constructorimpl(12);
        }
        ...
        FloatingActionButtonElevation floatingActionButtonElevationM1110elevationxZ9QkE = m1110elevationxZ9QkE(defaultElevation, pressedElevation, Dp.m5212constructorimpl(8), Dp.m5212constructorimpl(8), $composer, $this$dp$iv | 3456 | ($changed & 112) | (($changed << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return floatingActionButtonElevationM1110elevationxZ9QkE;
    }

    /* JADX INFO: renamed from: elevation-xZ9-QkE, reason: not valid java name */
    public final FloatingActionButtonElevation m1110elevationxZ9QkE(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m5212constructorimpl(6) : defaultElevation;
        float pressedElevation2 = (i & 2) != 0 ? Dp.m5212constructorimpl(12) : pressedElevation;
        float hoveredElevation2 = (i & 4) != 0 ? Dp.m5212constructorimpl(8) : hoveredElevation;
        float focusedElevation2 = (i & 8) != 0 ? Dp.m5212constructorimpl(8) : focusedElevation;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object[] keys$iv = {Dp.m5210boximpl(defaultElevation2), Dp.m5210boximpl(pressedElevation2), Dp.m5210boximpl(hoveredElevation2), Dp.m5210boximpl(focusedElevation2)};

...
public final class ShoppingCartKt {
    ...
    public static final ImageVector getShoppingCart(Icons.TwoTone $this$ShoppingCart) {
        ...
        ImageVector.Builder $this$_get_ShoppingCart__u24lambda_u242 = new ImageVector.Builder("TwoTone.ShoppingCart", Dp.m5212constructorimpl(24.0f), Dp.m5212constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        ImageVector.Builder.m3570addPathoIyEayM$default($this$_get_ShoppingCart__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 0.3f, null, 0.3f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv2.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv2.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3570addPathoIyEayM$default($this$_get_ShoppingCart__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

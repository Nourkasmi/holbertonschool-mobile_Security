...
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m5212constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m5212constructorimpl(8);
    private static final PaddingValues ContentPadding = PaddingKt.m478PaddingValuesa9UjIt4$default(AppBarKt.AppBarHorizontalPadding, 0.0f, AppBarKt.AppBarHorizontalPadding, 0.0f, 10, null);

    private AppBarDefaults() {
    }

    /* JADX INFO: renamed from: getTopAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m962getTopAppBarElevationD9Ej5fM() {
        return TopAppBarElevation;
    }

    /* JADX INFO: renamed from: getBottomAppBarElevation-D9Ej5fM, reason: not valid java name */
    public final float m961getBottomAppBarElevationD9Ej5fM() {

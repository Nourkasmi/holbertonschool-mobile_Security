...
public final class RippleKt {
    ...
    public static final Indication m1284rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        float radius2 = (i & 2) != 0 ? Dp.INSTANCE.m5232getUnspecifiedD9Ej5fM() : radius;
        long color2 = (i & 4) != 0 ? Color.INSTANCE.m2983getUnspecified0d7_KjU() : color;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:76)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(color2), $composer, ($changed >> 6) & 14);
        Object key1$iv = Boolean.valueOf(bounded2);
        Object key2$iv = Dp.m5210boximpl(radius2);

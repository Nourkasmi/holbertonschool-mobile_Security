...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5212constructorimpl(10);
    ...
    public static final float m1279getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m2777getWidthimpl(size), Size.m2774getHeightimpl(size)) * 0.3f;
    }

    /* JADX INFO: renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m1278getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean bounded, long size) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float radiusCoveringBounds = Offset.m2706getDistanceimpl(OffsetKt.Offset(Size.m2777getWidthimpl(size), Size.m2774getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return getRippleEndRadius.mo326toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }

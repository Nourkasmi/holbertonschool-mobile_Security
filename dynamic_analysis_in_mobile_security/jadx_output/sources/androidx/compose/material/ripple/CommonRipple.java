...
public final class CommonRipple extends Ripple {
    ...
    public RippleIndicationInstance mo1275rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean bounded, float radius, State<Color> color, State<RippleAlpha> rippleAlpha, Composer $composer, int $changed) {

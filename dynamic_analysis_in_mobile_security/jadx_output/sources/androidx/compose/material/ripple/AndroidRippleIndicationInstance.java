...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean bounded, float radius, State<Color> color, State<RippleAlpha> rippleAlpha, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.INSTANCE.m2786getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        this.rippleSize = $this$drawIndication.mo3489getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m1278getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo3489getSizeNHjbRc()));
        } else {
            iRoundToInt = $this$drawIndication.mo320roundToPx0680j_4(this.radius);
        }
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1282updateRipplePropertiesbiQXAtU($this$drawIndication.mo3489getSizeNHjbRc(), this.rippleRadius, color, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m1281addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m2957unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);

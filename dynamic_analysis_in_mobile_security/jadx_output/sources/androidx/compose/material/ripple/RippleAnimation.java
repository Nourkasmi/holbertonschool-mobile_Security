...
public final class RippleAnimation {
    ...
    */
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new C00682(RippleAnimation.this, null), 3, null);
    ...
    static final class C03252 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C03252(Continuation<? super C03252> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03252 c03252 = RippleAnimation.this.new C03252(continuation);
            c03252.L$0 = obj;
            return c03252;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Job> continuation) {
            return ((C03252) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C03252(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m1277draw4WTKRHQ(DrawScope draw, long color) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1279getRippleStartRadiusuvyYCjk(draw.mo3489getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            float $this$isUnspecified$iv = this.radius;
            this.targetRadius = Float.isNaN($this$isUnspecified$iv) ? Float.valueOf(RippleAnimationKt.m1278getRippleEndRadiuscSwnlzA(draw, this.bounded, draw.mo3489getSizeNHjbRc())) : Float.valueOf(draw.mo326toPx0680j_4(this.radius));
        }
        if (this.origin == null) {
            this.origin = Offset.m2697boximpl(draw.mo3488getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m2697boximpl(OffsetKt.Offset(Size.m2777getWidthimpl(draw.mo3489getSizeNHjbRc()) / 2.0f, Size.m2774getHeightimpl(draw.mo3489getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM2708getXimpl = Offset.m2708getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp = MathHelpersKt.lerp(fM2708getXimpl, Offset.m2708getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM2709getYimpl = Offset.m2709getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(fLerp, MathHelpersKt.lerp(fM2709getYimpl, Offset.m2709getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long modulatedColor = Color.m2945copywmQWz5c(color, (14 & 1) != 0 ? Color.m2949getAlphaimpl(color) : Color.m2949getAlphaimpl(color) * alpha, (14 & 2) != 0 ? Color.m2953getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(color) : 0.0f);
        if (!this.bounded) {
            DrawScope.m3471drawCircleVaOC9Bg$default(draw, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float right$iv = Size.m2777getWidthimpl(draw.mo3489getSizeNHjbRc());
        float bottom$iv = Size.m2774getHeightimpl(draw.mo3489getSizeNHjbRc());

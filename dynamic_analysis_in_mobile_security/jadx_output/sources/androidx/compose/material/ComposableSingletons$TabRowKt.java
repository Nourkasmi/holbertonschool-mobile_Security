...
public final class ComposableSingletons$TabRowKt {
    ...
    public static Function2<Composer, Integer, Unit> f13lambda1 = ComposableLambdaKt.composableLambdaInstance(182187156, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$TabRowKt$lambda-1$1
        ...
        public final void invoke(Composer $composer, int $changed) {
            ...
            TabRowDefaults.INSTANCE.m1220Divider9IZ8Weo(null, 0.0f, 0L, $composer, 3072, 7);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function2<Composer, Integer, Unit> m1065getLambda1$material_release() {
        return f13lambda1;
    }

    /* JADX INFO: renamed from: getLambda-2$material_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1066getLambda2$material_release() {
        return f14lambda2;
    }
}

...
public final class Colors {
    ...
    private Colors(long primary, long primaryVariant, long secondary, long secondaryVariant, long background, long surface, long error, long onPrimary, long onSecondary, long onBackground, long onSurface, long onError, boolean isLight) {
        ...
        this.primaryVariant = SnapshotStateKt.mutableStateOf(Color.m2937boximpl(primaryVariant), SnapshotStateKt.structuralEqualityPolicy());
        this.secondary = SnapshotStateKt.mutableStateOf(Color.m2937boximpl(secondary), SnapshotStateKt.structuralEqualityPolicy());
        this.secondaryVariant = SnapshotStateKt.mutableStateOf(Color.m2937boximpl(secondaryVariant), SnapshotStateKt.structuralEqualityPolicy());
    ...
    public final long m1034getPrimary0d7_KjU() {
    ...
    public final void m1046setPrimary8_81llA$material_release(long j) {
    ...
    public final long m1035getPrimaryVariant0d7_KjU() {
    ...
    public final void m1048setSecondary8_81llA$material_release(long j) {
    ...
    public final long m1037getSecondaryVariant0d7_KjU() {
    ...
    public final void m1049setSecondaryVariant8_81llA$material_release(long j) {
    ...
    public final long m1027getBackground0d7_KjU() {
    ...
    public final Colors m1026copypvPzIIM(long primary, long primaryVariant, long secondary, long secondaryVariant, long background, long surface, long error, long onPrimary, long onSecondary, long onBackground, long onSurface, long onError, boolean isLight) {
    ...
    public String toString() {
        ...
        sb.append("Colors(primary=").append((Object) Color.m2955toStringimpl(m1034getPrimary0d7_KjU())).append(", primaryVariant=").append((Object) Color.m2955toStringimpl(m1035getPrimaryVariant0d7_KjU())).append(", secondary=").append((Object) Color.m2955toStringimpl(m1036getSecondary0d7_KjU())).append(", secondaryVariant=").append((Object) Color.m2955toStringimpl(m1037getSecondaryVariant0d7_KjU())).append(", background=").append((Object) Color.m2955toStringimpl(m1027getBackground0d7_KjU())).append(", surface=").append((Object) Color.m2955toStringimpl(m1038getSurface0d7_KjU())).append(", error=").append((Object) Color.m2955toStringimpl(m1028getError0d7_KjU())).append(", onPrimary=").append((Object) Color.m2955toStringimpl(m1031getOnPrimary0d7_KjU())).append(", onSecondary=").append((Object) Color.m2955toStringimpl(m1032getOnSecondary0d7_KjU())).append(", onBackground=").append((Object) Color.m2955toStringimpl(m1029getOnBackground0d7_KjU())).append(", onSurface=").append((Object) Color.m2955toStringimpl(m1033getOnSurface0d7_KjU())).append(", onError=");
        sb.append((Object) Color.m2955toStringimpl(m1030getOnError0d7_KjU())).append(", isLight=").append(isLight()).append(')');
        return sb.toString();
    }
}

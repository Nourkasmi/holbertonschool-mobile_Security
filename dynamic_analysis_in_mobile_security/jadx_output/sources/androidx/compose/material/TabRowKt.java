...
public final class TabRowKt {
    ...
    public static final void m1226TabRowpAZo6Ak(final int selectedTabIndex, Modifier modifier, long backgroundColor, long contentColor, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 2995931) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    long contentColor4 = ColorsKt.m1052contentColorForek8zF_U(backgroundColor2, $composer2, ($dirty >> 6) & 14);
                    $dirty &= -7169;
                ...
                if (i5 != 0) {
                    function3ComposableLambda = ComposableLambdaKt.composableLambda($composer2, -553782708, true, new Function3<List<? extends TabPosition>, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$1
                        ...
                        public final void invoke(List<TabPosition> tabPositions, Composer $composer3, int $changed2) {
                            ...
                            TabRowDefaults.INSTANCE.m1221Indicator9IZ8Weo(TabRowDefaults.INSTANCE.tabIndicatorOffset(Modifier.INSTANCE, tabPositions.get(selectedTabIndex)), 0.0f, 0L, $composer3, 3072, 6);
                            if (ComposerKt.isTraceInProgress()) {
                ...
                function2M1065getLambda1$material_release = i6 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m1065getLambda1$material_release() : function22;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
                ...
                if ((i & 8) != 0) {
                    $dirty &= -7169;
                    function2M1065getLambda1$material_release = function22;
                    modifier2 = modifier;
                } else {
                    modifier2 = modifier;
                    function2M1065getLambda1$material_release = function22;
            ...
            SurfaceKt.m1196SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, backgroundColor2, contentColor2, null, 0.0f, ComposableLambdaKt.composableLambda($composer2, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    Object key1$iv = tabs;
                    Object key2$iv = function2M1065getLambda1$material_release;
                    Object key3$iv = function3ComposableLambda;
                    final Function2<Composer, Integer, Unit> function24 = tabs;
                    final Function2<Composer, Integer, Unit> function25 = function2M1065getLambda1$material_release;
                    ...
                    if (invalid$iv$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m1228invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                            }

                            /* JADX INFO: renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m1228invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, final long constraints) {
                                Object maxElem$iv;
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                final int tabRowWidth = Constraints.m5168getMaxWidthimpl(constraints);
                                ...
                                for (Object item$iv$iv : $this$map$iv) {
                                    ...
                                    destination$iv$iv.add(it.mo4183measureBRTryo0(Constraints.m5158copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(constraints) : tabWidth, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(constraints) : tabWidth, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(constraints) : 0)));
                                ...
                                for (int i9 = 0; i9 < tabCount; i9++) {
                                    int index = i9;
                                    float arg0$iv = SubcomposeLayout.mo323toDpu2uoSUM(tabWidth);
                                    arrayList.add(new TabPosition(Dp.m5212constructorimpl(index * arg0$iv), SubcomposeLayout.mo323toDpu2uoSUM(tabWidth), null));
                                }
                                ...
                                return MeasureScope.layout$default(SubcomposeLayout, tabRowWidth, tabRowHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        Iterable $this$forEach$iv = SubcomposeLayout.subcompose(TabSlots.Divider, function26);
                                        long j = constraints;
                                        int i12 = tabRowHeight;
                                        for (Object element$iv : $this$forEach$iv) {
                                            Measurable it4 = (Measurable) element$iv;
                                            long j2 = j;
                                            Placeable placeable2 = it4.mo4183measureBRTryo0(Constraints.m5158copyZbe2FdA(j2, (11 & 1) != 0 ? Constraints.m5170getMinWidthimpl(j2) : 0, (11 & 2) != 0 ? Constraints.m5168getMaxWidthimpl(j2) : 0, (11 & 4) != 0 ? Constraints.m5169getMinHeightimpl(j2) : 0, (11 & 8) != 0 ? Constraints.m5167getMaxHeightimpl(j2) : 0));
                                        ...
                                        Iterable $this$forEach$iv2 = subcomposeMeasureScope.subcompose(tabSlots, ComposableLambdaKt.composableLambdaInstance(-1341594997, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt.TabRow.2.1.1.1.3
                                            ...
                                            public final void invoke(Composer $composer4, int $changed3) {
                                                ...
                                                function35.invoke(list, $composer4, Integer.valueOf(((i13 >> 9) & 112) | 8));
                                                if (ComposerKt.isTraceInProgress()) {
                                                    ComposerKt.traceEventEnd();
                                                }
                                            }
                                        ...
                                        for (Object element$iv2 : $this$forEach$iv2) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, it5.mo4183measureBRTryo0(Constraints.INSTANCE.m5176fixedJhjzzOo(i14, i15)), 0, 0, 0.0f, 4, null);
                                        }
                                    }
                                }, 4, null);
                            }
            ...
            modifier3 = modifier2;
            function23 = function2M1065getLambda1$material_release;
            backgroundColor3 = backgroundColor2;
            contentColor3 = contentColor2;
            function32 = function3ComposableLambda;
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
            ...
            public final void invoke(Composer composer, int i7) {
                TabRowKt.m1226TabRowpAZo6Ak(selectedTabIndex, modifier4, j, j2, function33, function24, tabs, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    public static final void m1225ScrollableTabRowsKfQg0A(final int r28, androidx.compose.ui.Modifier r29, long r30, long r32, float r34, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r37, androidx.compose.runtime.Composer r38, final int r39, final int r40) {
        /*
            Method dump skipped, instruction units count: 575
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TabRowKt.m1225ScrollableTabRowsKfQg0A(int, androidx.compose.ui.Modifier, long, long, float, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
}

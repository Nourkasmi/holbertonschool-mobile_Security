...
public final class FabPosition {
    ...
    private static final int Center = m1098constructorimpl(0);
    private static final int End = m1098constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1097boximpl(int i) {
    ...
    public static boolean m1099equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1100equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1101hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m1099equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1101hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1104getCenter5ygKITE() {
            return FabPosition.Center;
        }

        /* JADX INFO: renamed from: getEnd-5ygKITE, reason: not valid java name */
        public final int m1105getEnd5ygKITE() {
    ...
    public static String m1102toStringimpl(int arg0) {
        return m1100equalsimpl0(arg0, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}

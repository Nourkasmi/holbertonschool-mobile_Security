...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColorsWithIcons {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(this.backgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> placeholderColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.placeholderColor : this.disabledPlaceholderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> textColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2937boximpl(enabled ? this.textColor : this.disabledTextColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2948equalsimpl0(this.textColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).textColor) && Color.m2948equalsimpl0(this.disabledTextColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTextColor) && Color.m2948equalsimpl0(this.cursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).cursorColor) && Color.m2948equalsimpl0(this.errorCursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorCursorColor) && Color.m2948equalsimpl0(this.focusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedIndicatorColor) && Color.m2948equalsimpl0(this.unfocusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedIndicatorColor) && Color.m2948equalsimpl0(this.errorIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorIndicatorColor) && Color.m2948equalsimpl0(this.disabledIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledIndicatorColor) && Color.m2948equalsimpl0(this.leadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).leadingIconColor) && Color.m2948equalsimpl0(this.disabledLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLeadingIconColor) && Color.m2948equalsimpl0(this.errorLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLeadingIconColor) && Color.m2948equalsimpl0(this.trailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).trailingIconColor) && Color.m2948equalsimpl0(this.focusedTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedTrailingIconColor) && Color.m2948equalsimpl0(this.disabledTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTrailingIconColor) && Color.m2948equalsimpl0(this.errorTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorTrailingIconColor) && Color.m2948equalsimpl0(this.backgroundColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).backgroundColor) && Color.m2948equalsimpl0(this.focusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedLabelColor) && Color.m2948equalsimpl0(this.unfocusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedLabelColor) && Color.m2948equalsimpl0(this.disabledLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLabelColor) && Color.m2948equalsimpl0(this.errorLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLabelColor) && Color.m2948equalsimpl0(this.placeholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).placeholderColor) && Color.m2948equalsimpl0(this.disabledPlaceholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledPlaceholderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2954hashCodeimpl(this.textColor);
        return (((((((((((((((((((((((((((((((((((((((((result * 31) + Color.m2954hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2954hashCodeimpl(this.cursorColor)) * 31) + Color.m2954hashCodeimpl(this.errorCursorColor)) * 31) + Color.m2954hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2954hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2954hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2954hashCodeimpl(this.backgroundColor)) * 31) + Color.m2954hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2954hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2954hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2954hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2954hashCodeimpl(this.placeholderColor)) * 31) + Color.m2954hashCodeimpl(this.disabledPlaceholderColor);
    }
}

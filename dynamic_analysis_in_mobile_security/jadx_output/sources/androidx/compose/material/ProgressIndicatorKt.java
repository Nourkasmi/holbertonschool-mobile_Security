...
public final class ProgressIndicatorKt {
    ...
    private static final float LinearIndicatorHeight = ProgressIndicatorDefaults.INSTANCE.m1146getStrokeWidthD9Ej5fM();
    private static final float LinearIndicatorWidth = Dp.m5212constructorimpl(240);
    private static final float CircularIndicatorDiameter = Dp.m5212constructorimpl(40);
    ...
    public static final void m1153LinearProgressIndicator_5eSRE(final float progress, Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    color2 = MaterialTheme.INSTANCE.getColors($composer2, 6).m1034getPrimary0d7_KjU();
                    $dirty &= -897;
                } else {
                    color2 = j;
                }
                if ((i & 8) != 0) {
                    long j2 = color2;
                    $dirty &= -7169;
                    backgroundColor2 = Color.m2945copywmQWz5c(j2, (14 & 1) != 0 ? Color.m2949getAlphaimpl(j2) : 0.24f, (14 & 2) != 0 ? Color.m2953getRedimpl(j2) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(j2) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(j2) : 0.0f);
                }
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    strokeCap2 = StrokeCap.INSTANCE.m3292getButtKaPHkGw();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
            ...
            Object[] keys$iv = {Color.m2937boximpl(backgroundColor2), StrokeCap.m3285boximpl(strokeCap2), Float.valueOf(coercedProgress), Color.m2937boximpl(color2)};
            ...
            if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$1$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        ProgressIndicatorKt.m1165drawLinearIndicatorBackgroundAZGd3zU(Canvas, j3, strokeWidth, i8);
                        ProgressIndicatorKt.m1164drawLinearIndicatorqYKTg0g(Canvas, 0.0f, coercedProgress, j4, strokeWidth, i8);
                    }
                };
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$2
            ...
            public final void invoke(Composer composer, int i10) {
                ProgressIndicatorKt.m1153LinearProgressIndicator_5eSRE(progress, modifier5, j5, j6, i9, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* JADX INFO: renamed from: LinearProgressIndicator-2cYBFYY, reason: not valid java name */
    public static final void m1151LinearProgressIndicator2cYBFYY(Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        int i2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    long j3 = color2;
                    backgroundColor2 = Color.m2945copywmQWz5c(j3, (14 & 1) != 0 ? Color.m2949getAlphaimpl(j3) : 0.24f, (14 & 2) != 0 ? Color.m2953getRedimpl(j3) : 0.0f, (14 & 4) != 0 ? Color.m2952getGreenimpl(j3) : 0.0f, (14 & 8) != 0 ? Color.m2950getBlueimpl(j3) : 0.0f);
                    $dirty &= -897;
                } else {
                    backgroundColor2 = j2;
                }
            ...
            Object[] keys$iv = {Color.m2937boximpl(backgroundColor3), StrokeCap.m3285boximpl(strokeCap2), stateAnimateFloat, stateAnimateFloat2, Color.m2937boximpl(color3), stateAnimateFloat3, stateAnimateFloat4};
            $composer2.startReplaceableGroup(-568225417);
            ComposerKt.sourceInformation($composer2, "CC(remember)P(1):Composables.kt#9igjgp");
            boolean invalid$iv = false;
            ...
            if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$3$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        Intrinsics.checkNotNullParameter(Canvas, "$this$Canvas");
                        float strokeWidth = Size.m2774getHeightimpl(Canvas.mo3489getSizeNHjbRc());
                        ProgressIndicatorKt.m1165drawLinearIndicatorBackgroundAZGd3zU(Canvas, j4, strokeWidth, i9);
                        if (ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$1(stateAnimateFloat) - ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$2(stateAnimateFloat2) > 0.0f) {
                            ProgressIndicatorKt.m1164drawLinearIndicatorqYKTg0g(Canvas, ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$1(stateAnimateFloat), ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$2(stateAnimateFloat2), j5, strokeWidth, i9);
                        }
                        if (ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$3(stateAnimateFloat3) - ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$4(stateAnimateFloat4) > 0.0f) {
                            ProgressIndicatorKt.m1164drawLinearIndicatorqYKTg0g(Canvas, ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$3(stateAnimateFloat3), ProgressIndicatorKt.LinearProgressIndicator_2cYBFYY$lambda$4(stateAnimateFloat4), j5, strokeWidth, i9);
                        }
                    }
                };
                $composer2.updateRememberedValue(value$iv$iv);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i11) {
                ProgressIndicatorKt.m1151LinearProgressIndicator2cYBFYY(modifier5, j6, j7, i10, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1154LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            m1153LinearProgressIndicator_5eSRE(progress, modifier3, color2, backgroundColor2, StrokeCap.INSTANCE.m3292getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$5
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1154LinearProgressIndicatoreaDK9VM(progress, modifier5, j4, j5, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1152LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1151LinearProgressIndicator2cYBFYY(modifier3, color2, backgroundColor2, StrokeCap.INSTANCE.m3292getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1152LinearProgressIndicatorRIQooxk(modifier5, j4, j5, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void m1164drawLinearIndicatorqYKTg0g(DrawScope $this$drawLinearIndicator_u2dqYKTg0g, float startFraction, float endFraction, long color, float strokeWidth, int strokeCap) {
    ...
    public static final void m1165drawLinearIndicatorBackgroundAZGd3zU(DrawScope $this$drawLinearIndicatorBackground_u2dAZGd3zU, long color, float strokeWidth, int strokeCap) {
        m1164drawLinearIndicatorqYKTg0g($this$drawLinearIndicatorBackground_u2dAZGd3zU, 0.0f, 1.0f, color, strokeWidth, strokeCap);
    }

    /* JADX INFO: renamed from: CircularProgressIndicator-DUhRLBM, reason: not valid java name */
    public static final void m1147CircularProgressIndicatorDUhRLBM(final float progress, Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float strokeWidth2;
        long backgroundColor2;
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    strokeWidth2 = ProgressIndicatorDefaults.INSTANCE.m1146getStrokeWidthD9Ej5fM();
                }
                if (i6 != 0) {
                    backgroundColor2 = Color.INSTANCE.m2982getTransparent0d7_KjU();
                }
                if ((i & 32) != 0) {
                    $dirty = $dirty2 & (-458753);
                    strokeCap2 = StrokeCap.INSTANCE.m3292getButtKaPHkGw();
            ...
            final Stroke stroke = new Stroke($this$CircularProgressIndicator_DUhRLBM_u24lambda_u246.mo326toPx0680j_4(strokeWidth3), 0.0f, strokeCap2, 0, null, 26, null);
            Modifier modifier5 = modifier3;
            final long j2 = backgroundColor3;
            final long j3 = color3;
            CanvasKt.Canvas(SizeKt.m528size3ABfNKs(ProgressSemanticsKt.progressSemantics$default(modifier5, coercedProgress, null, 0, 6, null), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(DrawScope Canvas) {
                    ...
                    ProgressIndicatorKt.m1161drawCircularIndicatorBackgroundbw27NRU(Canvas, j2, stroke);
                    ProgressIndicatorKt.m1162drawDeterminateCircularIndicator42QJj7c(Canvas, 270.0f, sweep, j3, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$2
            ...
            public final void invoke(Composer composer, int i9) {
                ProgressIndicatorKt.m1147CircularProgressIndicatorDUhRLBM(progress, modifier6, j4, f, j5, i8, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* JADX INFO: renamed from: CircularProgressIndicator-LxG7B9w, reason: not valid java name */
    public static final void m1148CircularProgressIndicatorLxG7B9w(Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float strokeWidth2;
        long backgroundColor2;
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    ...
                    modifier3 = modifier4;
                    color3 = color2;
                    strokeCap2 = StrokeCap.INSTANCE.m3294getSquareKaPHkGw();
                    backgroundColor3 = backgroundColor2;
                    strokeWidth3 = strokeWidth2;
                } else {
                    modifier3 = modifier4;
            ...
            final Stroke stroke = new Stroke($this$CircularProgressIndicator_LxG7B9w_u24lambda_u247.mo326toPx0680j_4(strokeWidth3), 0.0f, strokeCap2, 0, null, 26, null);
            ...
            final long j2 = backgroundColor3;
            final long j3 = color3;
            CanvasKt.Canvas(SizeKt.m528size3ABfNKs(ProgressSemanticsKt.progressSemantics(modifier3), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(DrawScope Canvas) {
                    ...
                    ProgressIndicatorKt.m1163drawIndeterminateCircularIndicatorhrjfTZI(Canvas, ProgressIndicatorKt.CircularProgressIndicator_LxG7B9w$lambda$11(stateAnimateFloat3) + offset, strokeWidth5, sweep, j3, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$4
            ...
            public final void invoke(Composer composer, int i11) {
                ProgressIndicatorKt.m1148CircularProgressIndicatorLxG7B9w(modifier5, j4, f, j5, i10, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1149CircularProgressIndicatorMBs18nI(final float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                strokeWidth2 = i4 != 0 ? ProgressIndicatorDefaults.INSTANCE.m1146getStrokeWidthD9Ej5fM() : f;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            m1147CircularProgressIndicatorDUhRLBM(progress, modifier3, color2, strokeWidth2, Color.INSTANCE.m2982getTransparent0d7_KjU(), StrokeCap.INSTANCE.m3292getButtKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$5
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1149CircularProgressIndicatorMBs18nI(progress, modifier5, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final /* synthetic */ void m1150CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        Modifier.Companion modifier3;
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1148CircularProgressIndicatorLxG7B9w(modifier3, color2, strokeWidth2, Color.INSTANCE.m2982getTransparent0d7_KjU(), StrokeCap.INSTANCE.m3294getSquareKaPHkGw(), $composer2, ($dirty & 14) | 3072 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$6
            ...
            public final void invoke(Composer composer, int i5) {
                ProgressIndicatorKt.m1150CircularProgressIndicatoraMcp0Q(modifier5, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }

    /* JADX INFO: renamed from: drawCircularIndicator-42QJj7c, reason: not valid java name */
    private static final void m1160drawCircularIndicator42QJj7c(DrawScope $this$drawCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        float f = 2;
    ...
    public static final void m1161drawCircularIndicatorBackgroundbw27NRU(DrawScope $this$drawCircularIndicatorBackground_u2dbw27NRU, long color, Stroke stroke) {
        m1160drawCircularIndicator42QJj7c($this$drawCircularIndicatorBackground_u2dbw27NRU, 0.0f, 360.0f, color, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: drawDeterminateCircularIndicator-42QJj7c, reason: not valid java name */
    public static final void m1162drawDeterminateCircularIndicator42QJj7c(DrawScope $this$drawDeterminateCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        m1160drawCircularIndicator42QJj7c($this$drawDeterminateCircularIndicator_u2d42QJj7c, startAngle, sweep, color, stroke);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: drawIndeterminateCircularIndicator-hrjfTZI, reason: not valid java name */
    public static final void m1163drawIndeterminateCircularIndicatorhrjfTZI(DrawScope $this$drawIndeterminateCircularIndicator_u2dhrjfTZI, float startAngle, float strokeWidth, float sweep, long color, Stroke stroke) {
        ...
        m1160drawCircularIndicator42QJj7c($this$drawIndeterminateCircularIndicator_u2dhrjfTZI, adjustedStartAngle, adjustedSweep, color, stroke);
    }
}

...
public final class TabPosition {
    ...
    public final float m1218getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m5217equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m5217equalsimpl0(this.width, ((TabPosition) other).width);
    }

    public int hashCode() {
        int result = Dp.m5218hashCodeimpl(this.left);
        return (result * 31) + Dp.m5218hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5223toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5223toStringimpl(m1218getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5223toStringimpl(this.width)) + ')';
    }
}

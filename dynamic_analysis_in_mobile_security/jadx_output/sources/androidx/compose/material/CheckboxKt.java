...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m5212constructorimpl(24);
    private static final float CheckboxDefaultPadding = Dp.m5212constructorimpl(2);
    private static final float CheckboxSize = Dp.m5212constructorimpl(20);
    private static final float StrokeWidth = Dp.m5212constructorimpl(2);
    private static final float RadiusSize = Dp.m5212constructorimpl(2);
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors3 = CheckboxDefaults.INSTANCE.m1012colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty &= -458753;
                } else {
                    colors3 = colors;
                }
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        Object value$iv$iv;
        int $dirty2;
        Modifier.Companion companionM713triStateToggleableO2vRcR0;
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors2 = CheckboxDefaults.INSTANCE.m1012colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty = $dirty3 & (-458753);
                    modifier3 = modifier4;
                    enabled2 = enabled3;
                    interactionSource3 = interactionSource2;
            ...
            if (function0 != null) {
                $dirty2 = $dirty;
                companionM713triStateToggleableO2vRcR0 = ToggleableKt.m713triStateToggleableO2vRcR0(Modifier.INSTANCE, state, interactionSource3, RippleKt.m1284rememberRipple9IZ8Weo(false, CheckboxRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m4556boximpl(Role.INSTANCE.m4564getCheckboxo7Vup1c()), function0);
            } else {
                $dirty2 = $dirty;
                companionM713triStateToggleableO2vRcR0 = Modifier.INSTANCE;
            }
            $composer2.endReplaceableGroup();
            Modifier toggleableModifier = companionM713triStateToggleableO2vRcR0;
            CheckboxImpl(enabled2, state, PaddingKt.m481padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.CheckboxKt.TriStateCheckbox.2
            ...
            public final void invoke(Composer composer, int i6) {
                CheckboxKt.TriStateCheckbox(state, function0, modifier5, z2, mutableInteractionSource, checkboxColors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    final State<Color> stateCheckmarkColor = colors.checkmarkColor(value, $composer2, (($dirty2 >> 3) & 14) | (($dirty2 >> 6) & 112));
                    final State<Color> stateBoxColor = colors.boxColor(enabled, value, $composer2, ($dirty2 & 14) | ($dirty2 & 112) | (($dirty2 >> 3) & 896));
                    final State<Color> stateBorderColor = colors.borderColor(enabled, value, $composer2, ($dirty2 & 14) | ($dirty2 & 112) | (($dirty2 >> 3) & 896));
                    Modifier modifierM520requiredSize3ABfNKs = SizeKt.m520requiredSize3ABfNKs(SizeKt.wrapContentSize$default(modifier, Alignment.INSTANCE.getCenter(), false, 2, null), CheckboxSize);
                    Object[] keys$iv = {stateBoxColor, stateBorderColor, stateCheckmarkColor, checkDrawFraction$delegate, checkCenterGravitationShiftFraction$delegate, checkCache};
                    ...
                    if (invalid$iv || value$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                float strokeWidthPx = (float) Math.floor(Canvas.mo326toPx0680j_4(CheckboxKt.StrokeWidth));
                                CheckboxKt.m1015drawBox1wkBAMs(Canvas, CheckboxKt.CheckboxImpl$lambda$9(stateBoxColor), CheckboxKt.CheckboxImpl$lambda$10(stateBorderColor), Canvas.mo326toPx0680j_4(CheckboxKt.RadiusSize), strokeWidthPx);
                                CheckboxKt.m1016drawCheck3IgeMak(Canvas, CheckboxKt.CheckboxImpl$lambda$8(stateCheckmarkColor), CheckboxKt.CheckboxImpl$lambda$4(checkDrawFraction$delegate), CheckboxKt.CheckboxImpl$lambda$6(checkCenterGravitationShiftFraction$delegate), strokeWidthPx, checkCache);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    }
    ...
    public static final void m1015drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        float halfStrokeWidth = strokeWidth / 2.0f;
        Stroke stroke = new Stroke(strokeWidth, 0.0f, 0, 0, null, 30, null);
        float checkboxSize = Size.m2777getWidthimpl($this$drawBox_u2d1wkBAMs.mo3489getSizeNHjbRc());
        if (Color.m2948equalsimpl0(boxColor, borderColor)) {
            DrawScope.m3486drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, 0L, androidx.compose.ui.geometry.SizeKt.Size(checkboxSize, checkboxSize), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f = 2;
        DrawScope.m3486drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, OffsetKt.Offset(strokeWidth, strokeWidth), androidx.compose.ui.geometry.SizeKt.Size(checkboxSize - (strokeWidth * f), checkboxSize - (f * strokeWidth)), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, radius - strokeWidth), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
    ...
    public static final void m1016drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
        Stroke stroke = new Stroke(strokeWidthPx, 0.0f, StrokeCap.INSTANCE.m3294getSquareKaPHkGw(), 0, null, 26, null);
        float width = Size.m2777getWidthimpl($this$drawCheck_u2d3IgeMak.mo3489getSizeNHjbRc());
        ...
        DrawScope.m3480drawPathLG529CI$default($this$drawCheck_u2d3IgeMak, drawingCache.getPathToDraw(), checkColor, 0.0f, stroke, null, 0, 52, null);
    }
}

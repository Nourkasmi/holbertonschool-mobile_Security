...
final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo12measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        while (true) {
            ...
            if (z) {
                placeables[index] = measurable.mo4183measureBRTryo0(constraints);
            }
            index$iv++;
        }
        ...
        for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
            ...
            if (placeables[index2] == null) {
                placeables[index2] = measurable2.mo4183measureBRTryo0(constraints);
            }
        }
        ...
        this.rootScope.m37setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(maxWidth, maxHeight));
        return MeasureScope.layout$default(measure, maxWidth, maxHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr) {
                    if (placeable5 != null) {
                        long offset = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo2598alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i, i2), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m5330getXimpl(offset), IntOffset.m5331getYimpl(offset), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);

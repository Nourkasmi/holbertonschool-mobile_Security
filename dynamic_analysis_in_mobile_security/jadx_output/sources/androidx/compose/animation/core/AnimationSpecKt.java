...
public final class AnimationSpecKt {
    ...
    public static /* synthetic */ RepeatableSpec m94repeatable91I0pcU$default(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i2, Object obj) {
        if ((i2 & 4) != 0) {
        ...
        return m93repeatable91I0pcU(i, durationBasedAnimationSpec, repeatMode, j);
    }

    /* JADX INFO: renamed from: repeatable-91I0pcU, reason: not valid java name */
    public static final <T> RepeatableSpec<T> m93repeatable91I0pcU(int iterations, DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long initialStartOffset) {
    ...
    public static /* synthetic */ InfiniteRepeatableSpec m92infiniteRepeatable9IiC70o$default(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i & 4) != 0) {
        ...
        return m91infiniteRepeatable9IiC70o(durationBasedAnimationSpec, repeatMode, j);
    }

    /* JADX INFO: renamed from: infiniteRepeatable-9IiC70o, reason: not valid java name */
    public static final <T> InfiniteRepeatableSpec<T> m91infiniteRepeatable9IiC70o(DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long initialStartOffset) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");

...
public final class Animatable<T, V extends AnimationVector> {
    ...
    private final V createVector(T t, float value) {
        ...
        for (int i = 0; i < size; i++) {
            vInvoke.set$animation_core_release(i, value);
        }
        return vInvoke;
    }
            ...
            try {
                switch (anonymousClass2) {
                    case 0:
                        ...
                        anonymousClass22.this$0.getInternalState$animation_core_release().setVelocityVector$animation_core_release(anonymousClass22.this$0.getTypeConverter().getConvertToVector().invoke(anonymousClass22.$initialVelocity));
                        anonymousClass22.this$0.setTargetValue(anonymousClass22.$animation.getTargetValue());
                        anonymousClass22.this$0.setRunning(true);
                        animationStateCopy$default = AnimationStateKt.copy$default((AnimationState) anonymousClass22.this$0.getInternalState$animation_core_release(), (Object) null, (AnimationVector) null, 0L, Long.MIN_VALUE, false, 23, (Object) null);
                        final Ref.BooleanRef booleanRef2 = new Ref.BooleanRef();
                        Animation<T, V> animation = anonymousClass22.$animation;
                        long j = anonymousClass22.$startTime;
                        final Animatable<T, V> animatable = anonymousClass22.this$0;
                        final Function1<Animatable<T, V>, Unit> function1 = anonymousClass22.$block;
                        anonymousClass22.L$0 = animationStateCopy$default;
                        anonymousClass22.L$1 = booleanRef2;
                        ...
                        }, anonymousClass22) == coroutine_suspended) {
                    ...
                    case 1:
                        ...
                        booleanRef = (Ref.BooleanRef) anonymousClass23.L$1;
                        animationStateCopy$default = (AnimationState) anonymousClass23.L$0;
                        ResultKt.throwOnFailure(obj);
                ...
                anonymousClass2.this$0.endAnimation();
    ...
    static final class C01512 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01512(Animatable<T, V> animatable, T t, Continuation<? super C01512> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
            this.$targetValue = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01512(this.this$0, this.$targetValue, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C01512) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C01512(this, t, null), continuation, 1, null);
    ...
    static final class C01522 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01522(Animatable<T, V> animatable, Continuation<? super C01522> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01522(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C01522) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object stop(Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C01522(this, null), continuation, 1, null);
        return objMutate$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate$default : Unit.INSTANCE;
    }

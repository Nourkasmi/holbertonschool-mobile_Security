...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m59sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        ChangeSize it = this.expand.getValue();
        long preEnterSize = it != null ? it.getSize().invoke(IntSize.m5364boximpl(fullSize)).getPackedValue() : fullSize;
        ChangeSize it2 = this.shrink.getValue();
        long postExitSize = it2 != null ? it2.getSize().invoke(IntSize.m5364boximpl(fullSize)).getPackedValue() : fullSize;
    ...
    public final long m60targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        if (this.currentAlignment != null && this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
                case 1:
                    return IntOffset.INSTANCE.m5340getZeronOccac();
                case 2:
                    return IntOffset.INSTANCE.m5340getZeronOccac();
                case 3:
                    ChangeSize it = this.shrink.getValue();
                    if (it != null) {
                        long endSize = it.getSize().invoke(IntSize.m5364boximpl(fullSize)).getPackedValue();
                        Alignment value = this.alignment.getValue();
                        Intrinsics.checkNotNull(value);
                        long targetOffset = value.mo2598alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                        Alignment alignment = this.currentAlignment;
                        Intrinsics.checkNotNull(alignment);
                        long currentOffset = alignment.mo2598alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                        return IntOffsetKt.IntOffset(IntOffset.m5330getXimpl(targetOffset) - IntOffset.m5330getXimpl(currentOffset), IntOffset.m5331getYimpl(targetOffset) - IntOffset.m5331getYimpl(currentOffset));
                    }
                    return IntOffset.INSTANCE.m5340getZeronOccac();
                default:
                    throw new NoWhenBranchMatchedException();
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        long currentSize = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m5364boximpl(m61invokeYEO4UFw(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m61invokeYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return this.this$0.m59sizeByStateUzc_VyU(it, measuredSize);
            }
        ...
        final long offsetDelta = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5321boximpl(m62invokeBjo55l4(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m62invokeBjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return this.this$0.m60targetOffsetByStateoFUgxo0(it, measuredSize);
            }
        }).getValue().getPackedValue();
        Alignment alignment = this.currentAlignment;
        final long offset = alignment != null ? alignment.mo2598alignKFBX0sM(measuredSize, currentSize, LayoutDirection.Ltr) : IntOffset.INSTANCE.m5340getZeronOccac();
        return MeasureScope.layout$default(measure, IntSize.m5372getWidthimpl(currentSize), IntSize.m5371getHeightimpl(currentSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeable, IntOffset.m5330getXimpl(offset) + IntOffset.m5330getXimpl(offsetDelta), IntOffset.m5331getYimpl(offset) + IntOffset.m5331getYimpl(offsetDelta), 0.0f, 4, null);
            }
        }, 4, null);
    }
}

...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m69animateColorAsStateeuL9pac(long targetValue, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> function1, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        AnimationSpec<Color> animationSpec2 = (i & 2) != 0 ? colorDefaultSpring : animationSpec;
        String label2 = (i & 4) != 0 ? "ColorAnimation" : label;
        Function1<? super Color, Unit> function12 = (i & 8) != 0 ? null : function1;
        ...
        Object key1$iv = Color.m2951getColorSpaceimpl(targetValue);
        ...
        State<Color> stateAnimateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m2937boximpl(targetValue), converter, animationSpec2, null, label2, function12, $composer, ($changed & 14) | 576 | (($changed << 6) & 57344) | (458752 & ($changed << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m68animateColorAsStateKTwxG1Y(long targetValue, AnimationSpec animationSpec, Function1 finishedListener, Composer $composer, int $changed, int i) {
        ...
        State<Color> stateM69animateColorAsStateeuL9pac = m69animateColorAsStateeuL9pac(targetValue, animationSpec, null, finishedListener, $composer, ($changed & 14) | 64 | (($changed << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final Animatable<Color, AnimationVector4D> m67Animatable8_81llA(long initialValue) {
        return new Animatable<>(Color.m2937boximpl(initialValue), ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(Color.m2951getColorSpaceimpl(initialValue)), null, null, 12, null);
    }
}
